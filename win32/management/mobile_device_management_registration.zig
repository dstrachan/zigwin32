...
// TODO: this type is limited to platform 'windows8.1'
pub extern "mdmregistration" fn RegisterDeviceWithManagementUsingAADDeviceCredentials() callconv(.winapi) HRESULT;
...
pub extern "mdmlocalmanagement" fn UnregisterDeviceWithLocalManagement() callconv(.winapi) HRESULT;
