...
pub extern "esent" fn JetStopService() callconv(.winapi) i32;
...
pub extern "esent" fn JetStopBackup() callconv(.winapi) i32;
...
pub extern "esent" fn JetTruncateLog() callconv(.winapi) i32;

pub extern "esent" fn JetTruncateLogInstance(
    instance: JET_INSTANCE,
) callconv(.winapi) i32;

pub extern "esent" fn JetEndExternalBackup() callconv(.winapi) i32;
