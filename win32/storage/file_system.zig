...
pub const IDiskQuotaUser = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetID(self: *const IDiskQuotaUser, pulID: ?*u32) HRESULT {
        return self.vtable.GetID(self, pulID);
    }
    pub inline fn GetName(self: *const IDiskQuotaUser, pszAccountContainer: ?PWSTR, cchAccountContainer: u32, pszLogonName: ?PWSTR, cchLogonName: u32, pszDisplayName: ?PWSTR, cchDisplayName: u32) HRESULT {
    ...
    pub inline fn GetSidLength(self: *const IDiskQuotaUser, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetSidLength(self, pdwLength);
    }
    pub inline fn GetSid(self: *const IDiskQuotaUser, pbSidBuffer: ?*u8, cbSidBuffer: u32) HRESULT {
        return self.vtable.GetSid(self, pbSidBuffer, cbSidBuffer);
    }
    pub inline fn GetQuotaThreshold(self: *const IDiskQuotaUser, pllThreshold: ?*i64) HRESULT {
        return self.vtable.GetQuotaThreshold(self, pllThreshold);
    }
    pub inline fn GetQuotaThresholdText(self: *const IDiskQuotaUser, pszText: ?PWSTR, cchText: u32) HRESULT {
        return self.vtable.GetQuotaThresholdText(self, pszText, cchText);
    }
    pub inline fn GetQuotaLimit(self: *const IDiskQuotaUser, pllLimit: ?*i64) HRESULT {
        return self.vtable.GetQuotaLimit(self, pllLimit);
    }
    pub inline fn GetQuotaLimitText(self: *const IDiskQuotaUser, pszText: ?PWSTR, cchText: u32) HRESULT {
        return self.vtable.GetQuotaLimitText(self, pszText, cchText);
    }
    pub inline fn GetQuotaUsed(self: *const IDiskQuotaUser, pllUsed: ?*i64) HRESULT {
        return self.vtable.GetQuotaUsed(self, pllUsed);
    }
    pub inline fn GetQuotaUsedText(self: *const IDiskQuotaUser, pszText: ?PWSTR, cchText: u32) HRESULT {
        return self.vtable.GetQuotaUsedText(self, pszText, cchText);
    }
    pub inline fn GetQuotaInformation(self: *const IDiskQuotaUser, pbQuotaInfo: ?*anyopaque, cbQuotaInfo: u32) HRESULT {
        return self.vtable.GetQuotaInformation(self, pbQuotaInfo, cbQuotaInfo);
    }
    pub inline fn SetQuotaThreshold(self: *const IDiskQuotaUser, llThreshold: i64, fWriteThrough: BOOL) HRESULT {
        return self.vtable.SetQuotaThreshold(self, llThreshold, fWriteThrough);
    }
    pub inline fn SetQuotaLimit(self: *const IDiskQuotaUser, llLimit: i64, fWriteThrough: BOOL) HRESULT {
        return self.vtable.SetQuotaLimit(self, llLimit, fWriteThrough);
    }
    pub inline fn Invalidate(self: *const IDiskQuotaUser) HRESULT {
        return self.vtable.Invalidate(self);
    }
    pub inline fn GetAccountStatus(self: *const IDiskQuotaUser, pdwStatus: ?*u32) HRESULT {
...
pub const IEnumDiskQuotaUsers = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumDiskQuotaUsers, cUsers: u32, rgUsers: ?*?*IDiskQuotaUser, pcUsersFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, cUsers, rgUsers, pcUsersFetched);
    }
    pub inline fn Skip(self: *const IEnumDiskQuotaUsers, cUsers: u32) HRESULT {
        return self.vtable.Skip(self, cUsers);
    }
    pub inline fn Reset(self: *const IEnumDiskQuotaUsers) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumDiskQuotaUsers, ppEnum: ?*?*IEnumDiskQuotaUsers) HRESULT {
...
pub const IDiskQuotaUserBatch = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Add(self: *const IDiskQuotaUserBatch, pUser: ?*IDiskQuotaUser) HRESULT {
        return self.vtable.Add(self, pUser);
    }
    pub inline fn Remove(self: *const IDiskQuotaUserBatch, pUser: ?*IDiskQuotaUser) HRESULT {
        return self.vtable.Remove(self, pUser);
    }
    pub inline fn RemoveAll(self: *const IDiskQuotaUserBatch) HRESULT {
        return self.vtable.RemoveAll(self);
    }
    pub inline fn FlushToDisk(self: *const IDiskQuotaUserBatch) HRESULT {
...
pub const IDiskQuotaControl = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IDiskQuotaControl, pszPath: ?[*:0]const u16, bReadWrite: BOOL) HRESULT {
        return self.vtable.Initialize(self, pszPath, bReadWrite);
    }
    pub inline fn SetQuotaState(self: *const IDiskQuotaControl, dwState: u32) HRESULT {
        return self.vtable.SetQuotaState(self, dwState);
    }
    pub inline fn GetQuotaState(self: *const IDiskQuotaControl, pdwState: ?*u32) HRESULT {
        return self.vtable.GetQuotaState(self, pdwState);
    }
    pub inline fn SetQuotaLogFlags(self: *const IDiskQuotaControl, dwFlags: u32) HRESULT {
        return self.vtable.SetQuotaLogFlags(self, dwFlags);
    }
    pub inline fn GetQuotaLogFlags(self: *const IDiskQuotaControl, pdwFlags: ?*u32) HRESULT {
        return self.vtable.GetQuotaLogFlags(self, pdwFlags);
    }
    pub inline fn SetDefaultQuotaThreshold(self: *const IDiskQuotaControl, llThreshold: i64) HRESULT {
        return self.vtable.SetDefaultQuotaThreshold(self, llThreshold);
    }
    pub inline fn GetDefaultQuotaThreshold(self: *const IDiskQuotaControl, pllThreshold: ?*i64) HRESULT {
        return self.vtable.GetDefaultQuotaThreshold(self, pllThreshold);
    }
    pub inline fn GetDefaultQuotaThresholdText(self: *const IDiskQuotaControl, pszText: ?PWSTR, cchText: u32) HRESULT {
        return self.vtable.GetDefaultQuotaThresholdText(self, pszText, cchText);
    }
    pub inline fn SetDefaultQuotaLimit(self: *const IDiskQuotaControl, llLimit: i64) HRESULT {
        return self.vtable.SetDefaultQuotaLimit(self, llLimit);
    }
    pub inline fn GetDefaultQuotaLimit(self: *const IDiskQuotaControl, pllLimit: ?*i64) HRESULT {
        return self.vtable.GetDefaultQuotaLimit(self, pllLimit);
    }
    pub inline fn GetDefaultQuotaLimitText(self: *const IDiskQuotaControl, pszText: ?PWSTR, cchText: u32) HRESULT {
        return self.vtable.GetDefaultQuotaLimitText(self, pszText, cchText);
    }
    pub inline fn AddUserSid(self: *const IDiskQuotaControl, pUserSid: ?PSID, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: ?*?*IDiskQuotaUser) HRESULT {
        return self.vtable.AddUserSid(self, pUserSid, fNameResolution, ppUser);
    }
    pub inline fn AddUserName(self: *const IDiskQuotaControl, pszLogonName: ?[*:0]const u16, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: ?*?*IDiskQuotaUser) HRESULT {
        return self.vtable.AddUserName(self, pszLogonName, fNameResolution, ppUser);
    }
    pub inline fn DeleteUser(self: *const IDiskQuotaControl, pUser: ?*IDiskQuotaUser) HRESULT {
        return self.vtable.DeleteUser(self, pUser);
    }
    pub inline fn FindUserSid(self: *const IDiskQuotaControl, pUserSid: ?PSID, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppUser: ?*?*IDiskQuotaUser) HRESULT {
        return self.vtable.FindUserSid(self, pUserSid, fNameResolution, ppUser);
    }
    pub inline fn FindUserName(self: *const IDiskQuotaControl, pszLogonName: ?[*:0]const u16, ppUser: ?*?*IDiskQuotaUser) HRESULT {
        return self.vtable.FindUserName(self, pszLogonName, ppUser);
    }
    pub inline fn CreateEnumUsers(self: *const IDiskQuotaControl, rgpUserSids: ?*?PSID, cpSids: u32, fNameResolution: DISKQUOTA_USERNAME_RESOLVE, ppEnum: ?*?*IEnumDiskQuotaUsers) HRESULT {
        return self.vtable.CreateEnumUsers(self, rgpUserSids, cpSids, fNameResolution, ppEnum);
    }
    pub inline fn CreateUserBatch(self: *const IDiskQuotaControl, ppBatch: ?*?*IDiskQuotaUserBatch) HRESULT {
        return self.vtable.CreateUserBatch(self, ppBatch);
    }
    pub inline fn InvalidateSidNameCache(self: *const IDiskQuotaControl) HRESULT {
        return self.vtable.InvalidateSidNameCache(self);
    }
    pub inline fn GiveUserNameResolutionPriority(self: *const IDiskQuotaControl, pUser: ?*IDiskQuotaUser) HRESULT {
        return self.vtable.GiveUserNameResolutionPriority(self, pUser);
    }
    pub inline fn ShutdownNameResolution(self: *const IDiskQuotaControl) HRESULT {
...
pub const IDiskQuotaEvents = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnUserNameChanged(self: *const IDiskQuotaEvents, pUser: ?*IDiskQuotaUser) HRESULT {
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn GetLogicalDrives() callconv(.winapi) u32;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn AreFileApisANSI() callconv(.winapi) BOOL;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn SetFileApisToOEM() callconv(.winapi) void;

// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn SetFileApisToANSI() callconv(.winapi) void;
...
pub extern "kernel32" fn LZStart() callconv(.winapi) i32;

pub extern "kernel32" fn LZDone() callconv(.winapi) void;
