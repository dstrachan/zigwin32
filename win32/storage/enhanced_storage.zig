...
pub const IEnumEnhancedStorageACT = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetACTs(self: *const IEnumEnhancedStorageACT, pppIEnhancedStorageACTs: [*]?*?*IEnhancedStorageACT, pcEnhancedStorageACTs: ?*u32) HRESULT {
        return self.vtable.GetACTs(self, pppIEnhancedStorageACTs, pcEnhancedStorageACTs);
    }
    pub inline fn GetMatchingACT(self: *const IEnumEnhancedStorageACT, szVolume: ?[*:0]const u16, ppIEnhancedStorageACT: ?*?*IEnhancedStorageACT) HRESULT {
...
pub const IEnhancedStorageACT = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Authorize(self: *const IEnhancedStorageACT, hwndParent: u32, dwFlags: u32) HRESULT {
        return self.vtable.Authorize(self, hwndParent, dwFlags);
    }
    pub inline fn Unauthorize(self: *const IEnhancedStorageACT) HRESULT {
        return self.vtable.Unauthorize(self);
    }
    pub inline fn GetAuthorizationState(self: *const IEnhancedStorageACT, pState: ?*ACT_AUTHORIZATION_STATE) HRESULT {
        return self.vtable.GetAuthorizationState(self, pState);
    }
    pub inline fn GetMatchingVolume(self: *const IEnhancedStorageACT, ppwszVolume: ?*?PWSTR) HRESULT {
        return self.vtable.GetMatchingVolume(self, ppwszVolume);
    }
    pub inline fn GetUniqueIdentity(self: *const IEnhancedStorageACT, ppwszIdentity: ?*?PWSTR) HRESULT {
        return self.vtable.GetUniqueIdentity(self, ppwszIdentity);
    }
    pub inline fn GetSilos(self: *const IEnhancedStorageACT, pppIEnhancedStorageSilos: [*]?*?*IEnhancedStorageSilo, pcEnhancedStorageSilos: ?*u32) HRESULT {
...
pub const IEnhancedStorageACT2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetDeviceName(self: *const IEnhancedStorageACT2, ppwszDeviceName: ?*?PWSTR) HRESULT {
        return self.vtable.GetDeviceName(self, ppwszDeviceName);
    }
    pub inline fn IsDeviceRemovable(self: *const IEnhancedStorageACT2, pIsDeviceRemovable: ?*BOOL) HRESULT {
...
pub const IEnhancedStorageACT3 = extern union {
    ...
    IEnhancedStorageACT: IEnhancedStorageACT,
    IUnknown: IUnknown,
    pub inline fn UnauthorizeEx(self: *const IEnhancedStorageACT3, dwFlags: u32) HRESULT {
        return self.vtable.UnauthorizeEx(self, dwFlags);
    }
    pub inline fn IsQueueFrozen(self: *const IEnhancedStorageACT3, pIsQueueFrozen: ?*BOOL) HRESULT {
        return self.vtable.IsQueueFrozen(self, pIsQueueFrozen);
    }
    pub inline fn GetShellExtSupport(self: *const IEnhancedStorageACT3, pShellExtSupport: ?*BOOL) HRESULT {
...
pub const IEnhancedStorageSilo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetInfo(self: *const IEnhancedStorageSilo, pSiloInfo: ?*SILO_INFO) HRESULT {
        return self.vtable.GetInfo(self, pSiloInfo);
    }
    pub inline fn GetActions(self: *const IEnhancedStorageSilo, pppIEnhancedStorageSiloActions: [*]?*?*IEnhancedStorageSiloAction, pcEnhancedStorageSiloActions: ?*u32) HRESULT {
        return self.vtable.GetActions(self, pppIEnhancedStorageSiloActions, pcEnhancedStorageSiloActions);
    }
    pub inline fn SendCommand(self: *const IEnhancedStorageSilo, Command: u8, pbCommandBuffer: [*:0]u8, cbCommandBuffer: u32, pbResponseBuffer: [*:0]u8, pcbResponseBuffer: ?*u32) HRESULT {
        return self.vtable.SendCommand(self, Command, pbCommandBuffer, cbCommandBuffer, pbResponseBuffer, pcbResponseBuffer);
    }
    pub inline fn GetPortableDevice(self: *const IEnhancedStorageSilo, ppIPortableDevice: ?*?*IPortableDevice) HRESULT {
        return self.vtable.GetPortableDevice(self, ppIPortableDevice);
    }
    pub inline fn GetDevicePath(self: *const IEnhancedStorageSilo, ppwszSiloDevicePath: ?*?PWSTR) HRESULT {
...
pub const IEnhancedStorageSiloAction = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetName(self: *const IEnhancedStorageSiloAction, ppwszActionName: ?*?PWSTR) HRESULT {
        return self.vtable.GetName(self, ppwszActionName);
    }
    pub inline fn GetDescription(self: *const IEnhancedStorageSiloAction, ppwszActionDescription: ?*?PWSTR) HRESULT {
        return self.vtable.GetDescription(self, ppwszActionDescription);
    }
    pub inline fn Invoke(self: *const IEnhancedStorageSiloAction) HRESULT {
