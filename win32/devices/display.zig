...
pub const ICloneViewHelper = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetConnectedIDs(self: *const ICloneViewHelper, wszAdaptorName: ?[*:0]const u16, pulCount: ?*u32, pulID: ?*u32, ulFlags: u32) HRESULT {
        return self.vtable.GetConnectedIDs(self, wszAdaptorName, pulCount, pulID, ulFlags);
    }
    pub inline fn GetActiveTopology(self: *const ICloneViewHelper, wszAdaptorName: ?[*:0]const u16, ulSourceID: u32, pulCount: ?*u32, pulTargetID: ?*u32) HRESULT {
        return self.vtable.GetActiveTopology(self, wszAdaptorName, ulSourceID, pulCount, pulTargetID);
    }
    pub inline fn SetActiveTopology(self: *const ICloneViewHelper, wszAdaptorName: ?[*:0]const u16, ulSourceID: u32, ulCount: u32, pulTargetID: ?*u32) HRESULT {
        return self.vtable.SetActiveTopology(self, wszAdaptorName, ulSourceID, ulCount, pulTargetID);
    }
    pub inline fn Commit(self: *const ICloneViewHelper, fFinalCall: BOOL) HRESULT {
...
pub const IViewHelper = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetConnectedIDs(self: *const IViewHelper, wszAdaptorName: ?[*:0]const u16, pulCount: ?*u32, pulID: ?*u32, ulFlags: u32) HRESULT {
        return self.vtable.GetConnectedIDs(self, wszAdaptorName, pulCount, pulID, ulFlags);
    }
    pub inline fn GetActiveTopology(self: *const IViewHelper, wszAdaptorName: ?[*:0]const u16, ulSourceID: u32, pulCount: ?*u32, pulTargetID: ?*u32) HRESULT {
        return self.vtable.GetActiveTopology(self, wszAdaptorName, ulSourceID, pulCount, pulTargetID);
    }
    pub inline fn SetActiveTopology(self: *const IViewHelper, wszAdaptorName: ?[*:0]const u16, ulSourceID: u32, ulCount: u32, pulTargetID: ?*u32) HRESULT {
        return self.vtable.SetActiveTopology(self, wszAdaptorName, ulSourceID, ulCount, pulTargetID);
    }
    pub inline fn Commit(self: *const IViewHelper) HRESULT {
        return self.vtable.Commit(self);
    }
    pub inline fn SetConfiguration(self: *const IViewHelper, pIStream: ?*IStream, pulStatus: ?*u32) HRESULT {
        return self.vtable.SetConfiguration(self, pIStream, pulStatus);
    }
    pub inline fn GetProceedOnNewConfiguration(self: *const IViewHelper) HRESULT {
...
pub const PFN = *const fn () callconv(.winapi) isize;
...
pub const PFN_DrvDisableDriver = *const fn () callconv(.winapi) void;
...
// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn EngCreateClip() callconv(.winapi) ?*CLIPOBJ;
...
// TODO: this type is limited to platform 'windows5.0'
pub extern "gdi32" fn EngCreateSemaphore() callconv(.winapi) ?HSEMAPHORE;
