...
pub const PFAXDEVSHUTDOWN = *const fn () callconv(.winapi) HRESULT;
...
pub const IFaxJobStatus = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const IFaxJobStatus, pStatus: ?*FAX_JOB_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_Pages(self: *const IFaxJobStatus, plPages: ?*i32) HRESULT {
        return self.vtable.get_Pages(self, plPages);
    }
    pub inline fn get_Size(self: *const IFaxJobStatus, plSize: ?*i32) HRESULT {
        return self.vtable.get_Size(self, plSize);
    }
    pub inline fn get_CurrentPage(self: *const IFaxJobStatus, plCurrentPage: ?*i32) HRESULT {
        return self.vtable.get_CurrentPage(self, plCurrentPage);
    }
    pub inline fn get_DeviceId(self: *const IFaxJobStatus, plDeviceId: ?*i32) HRESULT {
        return self.vtable.get_DeviceId(self, plDeviceId);
    }
    pub inline fn get_CSID(self: *const IFaxJobStatus, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxJobStatus, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn get_ExtendedStatusCode(self: *const IFaxJobStatus, pExtendedStatusCode: ?*FAX_JOB_EXTENDED_STATUS_ENUM) HRESULT {
        return self.vtable.get_ExtendedStatusCode(self, pExtendedStatusCode);
    }
    pub inline fn get_ExtendedStatus(self: *const IFaxJobStatus, pbstrExtendedStatus: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtendedStatus(self, pbstrExtendedStatus);
    }
    pub inline fn get_AvailableOperations(self: *const IFaxJobStatus, pAvailableOperations: ?*FAX_JOB_OPERATIONS_ENUM) HRESULT {
        return self.vtable.get_AvailableOperations(self, pAvailableOperations);
    }
    pub inline fn get_Retries(self: *const IFaxJobStatus, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn get_JobType(self: *const IFaxJobStatus, pJobType: ?*FAX_JOB_TYPE_ENUM) HRESULT {
        return self.vtable.get_JobType(self, pJobType);
    }
    pub inline fn get_ScheduledTime(self: *const IFaxJobStatus, pdateScheduledTime: ?*f64) HRESULT {
        return self.vtable.get_ScheduledTime(self, pdateScheduledTime);
    }
    pub inline fn get_TransmissionStart(self: *const IFaxJobStatus, pdateTransmissionStart: ?*f64) HRESULT {
        return self.vtable.get_TransmissionStart(self, pdateTransmissionStart);
    }
    pub inline fn get_TransmissionEnd(self: *const IFaxJobStatus, pdateTransmissionEnd: ?*f64) HRESULT {
        return self.vtable.get_TransmissionEnd(self, pdateTransmissionEnd);
    }
    pub inline fn get_CallerId(self: *const IFaxJobStatus, pbstrCallerId: ?*?BSTR) HRESULT {
        return self.vtable.get_CallerId(self, pbstrCallerId);
    }
    pub inline fn get_RoutingInformation(self: *const IFaxJobStatus, pbstrRoutingInformation: ?*?BSTR) HRESULT {
...
pub const IFaxServer = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Connect(self: *const IFaxServer, bstrServerName: ?BSTR) HRESULT {
        return self.vtable.Connect(self, bstrServerName);
    }
    pub inline fn get_ServerName(self: *const IFaxServer, pbstrServerName: ?*?BSTR) HRESULT {
        return self.vtable.get_ServerName(self, pbstrServerName);
    }
    pub inline fn GetDeviceProviders(self: *const IFaxServer, ppFaxDeviceProviders: ?*?*IFaxDeviceProviders) HRESULT {
        return self.vtable.GetDeviceProviders(self, ppFaxDeviceProviders);
    }
    pub inline fn GetDevices(self: *const IFaxServer, ppFaxDevices: ?*?*IFaxDevices) HRESULT {
        return self.vtable.GetDevices(self, ppFaxDevices);
    }
    pub inline fn get_InboundRouting(self: *const IFaxServer, ppFaxInboundRouting: ?*?*IFaxInboundRouting) HRESULT {
        return self.vtable.get_InboundRouting(self, ppFaxInboundRouting);
    }
    pub inline fn get_Folders(self: *const IFaxServer, pFaxFolders: ?*?*IFaxFolders) HRESULT {
        return self.vtable.get_Folders(self, pFaxFolders);
    }
    pub inline fn get_LoggingOptions(self: *const IFaxServer, ppFaxLoggingOptions: ?*?*IFaxLoggingOptions) HRESULT {
        return self.vtable.get_LoggingOptions(self, ppFaxLoggingOptions);
    }
    pub inline fn get_MajorVersion(self: *const IFaxServer, plMajorVersion: ?*i32) HRESULT {
        return self.vtable.get_MajorVersion(self, plMajorVersion);
    }
    pub inline fn get_MinorVersion(self: *const IFaxServer, plMinorVersion: ?*i32) HRESULT {
        return self.vtable.get_MinorVersion(self, plMinorVersion);
    }
    pub inline fn get_MajorBuild(self: *const IFaxServer, plMajorBuild: ?*i32) HRESULT {
        return self.vtable.get_MajorBuild(self, plMajorBuild);
    }
    pub inline fn get_MinorBuild(self: *const IFaxServer, plMinorBuild: ?*i32) HRESULT {
        return self.vtable.get_MinorBuild(self, plMinorBuild);
    }
    pub inline fn get_Debug(self: *const IFaxServer, pbDebug: ?*i16) HRESULT {
        return self.vtable.get_Debug(self, pbDebug);
    }
    pub inline fn get_Activity(self: *const IFaxServer, ppFaxActivity: ?*?*IFaxActivity) HRESULT {
        return self.vtable.get_Activity(self, ppFaxActivity);
    }
    pub inline fn get_OutboundRouting(self: *const IFaxServer, ppFaxOutboundRouting: ?*?*IFaxOutboundRouting) HRESULT {
        return self.vtable.get_OutboundRouting(self, ppFaxOutboundRouting);
    }
    pub inline fn get_ReceiptOptions(self: *const IFaxServer, ppFaxReceiptOptions: ?*?*IFaxReceiptOptions) HRESULT {
        return self.vtable.get_ReceiptOptions(self, ppFaxReceiptOptions);
    }
    pub inline fn get_Security(self: *const IFaxServer, ppFaxSecurity: ?*?*IFaxSecurity) HRESULT {
        return self.vtable.get_Security(self, ppFaxSecurity);
    }
    pub inline fn Disconnect(self: *const IFaxServer) HRESULT {
        return self.vtable.Disconnect(self);
    }
    pub inline fn GetExtensionProperty(self: *const IFaxServer, bstrGUID: ?BSTR, pvProperty: ?*VARIANT) HRESULT {
        return self.vtable.GetExtensionProperty(self, bstrGUID, pvProperty);
    }
    pub inline fn SetExtensionProperty(self: *const IFaxServer, bstrGUID: ?BSTR, vProperty: VARIANT) HRESULT {
        return self.vtable.SetExtensionProperty(self, bstrGUID, vProperty);
    }
    pub inline fn ListenToServerEvents(self: *const IFaxServer, EventTypes: FAX_SERVER_EVENTS_TYPE_ENUM) HRESULT {
        return self.vtable.ListenToServerEvents(self, EventTypes);
    }
    pub inline fn RegisterDeviceProvider(self: *const IFaxServer, bstrGUID: ?BSTR, bstrFriendlyName: ?BSTR, bstrImageName: ?BSTR, TspName: ?BSTR, lFSPIVersion: i32) HRESULT {
        return self.vtable.RegisterDeviceProvider(self, bstrGUID, bstrFriendlyName, bstrImageName, TspName, lFSPIVersion);
    }
    pub inline fn UnregisterDeviceProvider(self: *const IFaxServer, bstrUniqueName: ?BSTR) HRESULT {
        return self.vtable.UnregisterDeviceProvider(self, bstrUniqueName);
    }
    pub inline fn RegisterInboundRoutingExtension(self: *const IFaxServer, bstrExtensionName: ?BSTR, bstrFriendlyName: ?BSTR, bstrImageName: ?BSTR, vMethods: VARIANT) HRESULT {
        return self.vtable.RegisterInboundRoutingExtension(self, bstrExtensionName, bstrFriendlyName, bstrImageName, vMethods);
    }
    pub inline fn UnregisterInboundRoutingExtension(self: *const IFaxServer, bstrExtensionUniqueName: ?BSTR) HRESULT {
        return self.vtable.UnregisterInboundRoutingExtension(self, bstrExtensionUniqueName);
    }
    pub inline fn get_RegisteredEvents(self: *const IFaxServer, pEventTypes: ?*FAX_SERVER_EVENTS_TYPE_ENUM) HRESULT {
        return self.vtable.get_RegisteredEvents(self, pEventTypes);
    }
    pub inline fn get_APIVersion(self: *const IFaxServer, pAPIVersion: ?*FAX_SERVER_APIVERSION_ENUM) HRESULT {
...
pub const IFaxDeviceProviders = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxDeviceProviders, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxDeviceProviders, vIndex: VARIANT, pFaxDeviceProvider: ?*?*IFaxDeviceProvider) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxDeviceProvider);
    }
    pub inline fn get_Count(self: *const IFaxDeviceProviders, plCount: ?*i32) HRESULT {
...
pub const IFaxDevices = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxDevices, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxDevices, vIndex: VARIANT, pFaxDevice: ?*?*IFaxDevice) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxDevice);
    }
    pub inline fn get_Count(self: *const IFaxDevices, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get_ItemById(self: *const IFaxDevices, lId: i32, ppFaxDevice: ?*?*IFaxDevice) HRESULT {
...
pub const IFaxInboundRouting = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetExtensions(self: *const IFaxInboundRouting, pFaxInboundRoutingExtensions: ?*?*IFaxInboundRoutingExtensions) HRESULT {
        return self.vtable.GetExtensions(self, pFaxInboundRoutingExtensions);
    }
    pub inline fn GetMethods(self: *const IFaxInboundRouting, pFaxInboundRoutingMethods: ?*?*IFaxInboundRoutingMethods) HRESULT {
...
pub const IFaxFolders = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_OutgoingQueue(self: *const IFaxFolders, pFaxOutgoingQueue: ?*?*IFaxOutgoingQueue) HRESULT {
        return self.vtable.get_OutgoingQueue(self, pFaxOutgoingQueue);
    }
    pub inline fn get_IncomingQueue(self: *const IFaxFolders, pFaxIncomingQueue: ?*?*IFaxIncomingQueue) HRESULT {
        return self.vtable.get_IncomingQueue(self, pFaxIncomingQueue);
    }
    pub inline fn get_IncomingArchive(self: *const IFaxFolders, pFaxIncomingArchive: ?*?*IFaxIncomingArchive) HRESULT {
        return self.vtable.get_IncomingArchive(self, pFaxIncomingArchive);
    }
    pub inline fn get_OutgoingArchive(self: *const IFaxFolders, pFaxOutgoingArchive: ?*?*IFaxOutgoingArchive) HRESULT {
...
pub const IFaxLoggingOptions = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventLogging(self: *const IFaxLoggingOptions, pFaxEventLogging: ?*?*IFaxEventLogging) HRESULT {
        return self.vtable.get_EventLogging(self, pFaxEventLogging);
    }
    pub inline fn get_ActivityLogging(self: *const IFaxLoggingOptions, pFaxActivityLogging: ?*?*IFaxActivityLogging) HRESULT {
...
pub const IFaxActivity = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_IncomingMessages(self: *const IFaxActivity, plIncomingMessages: ?*i32) HRESULT {
        return self.vtable.get_IncomingMessages(self, plIncomingMessages);
    }
    pub inline fn get_RoutingMessages(self: *const IFaxActivity, plRoutingMessages: ?*i32) HRESULT {
        return self.vtable.get_RoutingMessages(self, plRoutingMessages);
    }
    pub inline fn get_OutgoingMessages(self: *const IFaxActivity, plOutgoingMessages: ?*i32) HRESULT {
        return self.vtable.get_OutgoingMessages(self, plOutgoingMessages);
    }
    pub inline fn get_QueuedMessages(self: *const IFaxActivity, plQueuedMessages: ?*i32) HRESULT {
        return self.vtable.get_QueuedMessages(self, plQueuedMessages);
    }
    pub inline fn Refresh(self: *const IFaxActivity) HRESULT {
...
pub const IFaxOutboundRouting = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetGroups(self: *const IFaxOutboundRouting, pFaxOutboundRoutingGroups: ?*?*IFaxOutboundRoutingGroups) HRESULT {
        return self.vtable.GetGroups(self, pFaxOutboundRoutingGroups);
    }
    pub inline fn GetRules(self: *const IFaxOutboundRouting, pFaxOutboundRoutingRules: ?*?*IFaxOutboundRoutingRules) HRESULT {
...
pub const IFaxReceiptOptions = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_AuthenticationType(self: *const IFaxReceiptOptions, pType: ?*FAX_SMTP_AUTHENTICATION_TYPE_ENUM) HRESULT {
        return self.vtable.get_AuthenticationType(self, pType);
    }
    pub inline fn put_AuthenticationType(self: *const IFaxReceiptOptions, Type: FAX_SMTP_AUTHENTICATION_TYPE_ENUM) HRESULT {
        return self.vtable.put_AuthenticationType(self, Type);
    }
    pub inline fn get_SMTPServer(self: *const IFaxReceiptOptions, pbstrSMTPServer: ?*?BSTR) HRESULT {
        return self.vtable.get_SMTPServer(self, pbstrSMTPServer);
    }
    pub inline fn put_SMTPServer(self: *const IFaxReceiptOptions, bstrSMTPServer: ?BSTR) HRESULT {
        return self.vtable.put_SMTPServer(self, bstrSMTPServer);
    }
    pub inline fn get_SMTPPort(self: *const IFaxReceiptOptions, plSMTPPort: ?*i32) HRESULT {
        return self.vtable.get_SMTPPort(self, plSMTPPort);
    }
    pub inline fn put_SMTPPort(self: *const IFaxReceiptOptions, lSMTPPort: i32) HRESULT {
        return self.vtable.put_SMTPPort(self, lSMTPPort);
    }
    pub inline fn get_SMTPSender(self: *const IFaxReceiptOptions, pbstrSMTPSender: ?*?BSTR) HRESULT {
        return self.vtable.get_SMTPSender(self, pbstrSMTPSender);
    }
    pub inline fn put_SMTPSender(self: *const IFaxReceiptOptions, bstrSMTPSender: ?BSTR) HRESULT {
        return self.vtable.put_SMTPSender(self, bstrSMTPSender);
    }
    pub inline fn get_SMTPUser(self: *const IFaxReceiptOptions, pbstrSMTPUser: ?*?BSTR) HRESULT {
        return self.vtable.get_SMTPUser(self, pbstrSMTPUser);
    }
    pub inline fn put_SMTPUser(self: *const IFaxReceiptOptions, bstrSMTPUser: ?BSTR) HRESULT {
        return self.vtable.put_SMTPUser(self, bstrSMTPUser);
    }
    pub inline fn get_AllowedReceipts(self: *const IFaxReceiptOptions, pAllowedReceipts: ?*FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.get_AllowedReceipts(self, pAllowedReceipts);
    }
    pub inline fn put_AllowedReceipts(self: *const IFaxReceiptOptions, AllowedReceipts: FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.put_AllowedReceipts(self, AllowedReceipts);
    }
    pub inline fn get_SMTPPassword(self: *const IFaxReceiptOptions, pbstrSMTPPassword: ?*?BSTR) HRESULT {
        return self.vtable.get_SMTPPassword(self, pbstrSMTPPassword);
    }
    pub inline fn put_SMTPPassword(self: *const IFaxReceiptOptions, bstrSMTPPassword: ?BSTR) HRESULT {
        return self.vtable.put_SMTPPassword(self, bstrSMTPPassword);
    }
    pub inline fn Refresh(self: *const IFaxReceiptOptions) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxReceiptOptions) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn get_UseForInboundRouting(self: *const IFaxReceiptOptions, pbUseForInboundRouting: ?*i16) HRESULT {
        return self.vtable.get_UseForInboundRouting(self, pbUseForInboundRouting);
    }
    pub inline fn put_UseForInboundRouting(self: *const IFaxReceiptOptions, bUseForInboundRouting: i16) HRESULT {
...
pub const IFaxSecurity = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Descriptor(self: *const IFaxSecurity, pvDescriptor: ?*VARIANT) HRESULT {
        return self.vtable.get_Descriptor(self, pvDescriptor);
    }
    pub inline fn put_Descriptor(self: *const IFaxSecurity, vDescriptor: VARIANT) HRESULT {
        return self.vtable.put_Descriptor(self, vDescriptor);
    }
    pub inline fn get_GrantedRights(self: *const IFaxSecurity, pGrantedRights: ?*FAX_ACCESS_RIGHTS_ENUM) HRESULT {
        return self.vtable.get_GrantedRights(self, pGrantedRights);
    }
    pub inline fn Refresh(self: *const IFaxSecurity) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxSecurity) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn get_InformationType(self: *const IFaxSecurity, plInformationType: ?*i32) HRESULT {
        return self.vtable.get_InformationType(self, plInformationType);
    }
    pub inline fn put_InformationType(self: *const IFaxSecurity, lInformationType: i32) HRESULT {
...
pub const IFaxDocument = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Body(self: *const IFaxDocument, pbstrBody: ?*?BSTR) HRESULT {
        return self.vtable.get_Body(self, pbstrBody);
    }
    pub inline fn put_Body(self: *const IFaxDocument, bstrBody: ?BSTR) HRESULT {
        return self.vtable.put_Body(self, bstrBody);
    }
    pub inline fn get_Sender(self: *const IFaxDocument, ppFaxSender: ?*?*IFaxSender) HRESULT {
        return self.vtable.get_Sender(self, ppFaxSender);
    }
    pub inline fn get_Recipients(self: *const IFaxDocument, ppFaxRecipients: ?*?*IFaxRecipients) HRESULT {
        return self.vtable.get_Recipients(self, ppFaxRecipients);
    }
    pub inline fn get_CoverPage(self: *const IFaxDocument, pbstrCoverPage: ?*?BSTR) HRESULT {
        return self.vtable.get_CoverPage(self, pbstrCoverPage);
    }
    pub inline fn put_CoverPage(self: *const IFaxDocument, bstrCoverPage: ?BSTR) HRESULT {
        return self.vtable.put_CoverPage(self, bstrCoverPage);
    }
    pub inline fn get_Subject(self: *const IFaxDocument, pbstrSubject: ?*?BSTR) HRESULT {
        return self.vtable.get_Subject(self, pbstrSubject);
    }
    pub inline fn put_Subject(self: *const IFaxDocument, bstrSubject: ?BSTR) HRESULT {
        return self.vtable.put_Subject(self, bstrSubject);
    }
    pub inline fn get_Note(self: *const IFaxDocument, pbstrNote: ?*?BSTR) HRESULT {
        return self.vtable.get_Note(self, pbstrNote);
    }
    pub inline fn put_Note(self: *const IFaxDocument, bstrNote: ?BSTR) HRESULT {
        return self.vtable.put_Note(self, bstrNote);
    }
    pub inline fn get_ScheduleTime(self: *const IFaxDocument, pdateScheduleTime: ?*f64) HRESULT {
        return self.vtable.get_ScheduleTime(self, pdateScheduleTime);
    }
    pub inline fn put_ScheduleTime(self: *const IFaxDocument, dateScheduleTime: f64) HRESULT {
        return self.vtable.put_ScheduleTime(self, dateScheduleTime);
    }
    pub inline fn get_ReceiptAddress(self: *const IFaxDocument, pbstrReceiptAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_ReceiptAddress(self, pbstrReceiptAddress);
    }
    pub inline fn put_ReceiptAddress(self: *const IFaxDocument, bstrReceiptAddress: ?BSTR) HRESULT {
        return self.vtable.put_ReceiptAddress(self, bstrReceiptAddress);
    }
    pub inline fn get_DocumentName(self: *const IFaxDocument, pbstrDocumentName: ?*?BSTR) HRESULT {
        return self.vtable.get_DocumentName(self, pbstrDocumentName);
    }
    pub inline fn put_DocumentName(self: *const IFaxDocument, bstrDocumentName: ?BSTR) HRESULT {
        return self.vtable.put_DocumentName(self, bstrDocumentName);
    }
    pub inline fn get_CallHandle(self: *const IFaxDocument, plCallHandle: ?*i32) HRESULT {
        return self.vtable.get_CallHandle(self, plCallHandle);
    }
    pub inline fn put_CallHandle(self: *const IFaxDocument, lCallHandle: i32) HRESULT {
        return self.vtable.put_CallHandle(self, lCallHandle);
    }
    pub inline fn get_CoverPageType(self: *const IFaxDocument, pCoverPageType: ?*FAX_COVERPAGE_TYPE_ENUM) HRESULT {
        return self.vtable.get_CoverPageType(self, pCoverPageType);
    }
    pub inline fn put_CoverPageType(self: *const IFaxDocument, CoverPageType: FAX_COVERPAGE_TYPE_ENUM) HRESULT {
        return self.vtable.put_CoverPageType(self, CoverPageType);
    }
    pub inline fn get_ScheduleType(self: *const IFaxDocument, pScheduleType: ?*FAX_SCHEDULE_TYPE_ENUM) HRESULT {
        return self.vtable.get_ScheduleType(self, pScheduleType);
    }
    pub inline fn put_ScheduleType(self: *const IFaxDocument, ScheduleType: FAX_SCHEDULE_TYPE_ENUM) HRESULT {
        return self.vtable.put_ScheduleType(self, ScheduleType);
    }
    pub inline fn get_ReceiptType(self: *const IFaxDocument, pReceiptType: ?*FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.get_ReceiptType(self, pReceiptType);
    }
    pub inline fn put_ReceiptType(self: *const IFaxDocument, ReceiptType: FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.put_ReceiptType(self, ReceiptType);
    }
    pub inline fn get_GroupBroadcastReceipts(self: *const IFaxDocument, pbUseGrouping: ?*i16) HRESULT {
        return self.vtable.get_GroupBroadcastReceipts(self, pbUseGrouping);
    }
    pub inline fn put_GroupBroadcastReceipts(self: *const IFaxDocument, bUseGrouping: i16) HRESULT {
        return self.vtable.put_GroupBroadcastReceipts(self, bUseGrouping);
    }
    pub inline fn get_Priority(self: *const IFaxDocument, pPriority: ?*FAX_PRIORITY_TYPE_ENUM) HRESULT {
        return self.vtable.get_Priority(self, pPriority);
    }
    pub inline fn put_Priority(self: *const IFaxDocument, Priority: FAX_PRIORITY_TYPE_ENUM) HRESULT {
        return self.vtable.put_Priority(self, Priority);
    }
    pub inline fn get_TapiConnection(self: *const IFaxDocument, ppTapiConnection: ?*?*IDispatch) HRESULT {
        return self.vtable.get_TapiConnection(self, ppTapiConnection);
    }
    pub inline fn putref_TapiConnection(self: *const IFaxDocument, pTapiConnection: ?*IDispatch) HRESULT {
        return self.vtable.putref_TapiConnection(self, pTapiConnection);
    }
    pub inline fn Submit(self: *const IFaxDocument, bstrFaxServerName: ?BSTR, pvFaxOutgoingJobIDs: ?*VARIANT) HRESULT {
        return self.vtable.Submit(self, bstrFaxServerName, pvFaxOutgoingJobIDs);
    }
    pub inline fn ConnectedSubmit(self: *const IFaxDocument, pFaxServer: ?*IFaxServer, pvFaxOutgoingJobIDs: ?*VARIANT) HRESULT {
        return self.vtable.ConnectedSubmit(self, pFaxServer, pvFaxOutgoingJobIDs);
    }
    pub inline fn get_AttachFaxToReceipt(self: *const IFaxDocument, pbAttachFax: ?*i16) HRESULT {
        return self.vtable.get_AttachFaxToReceipt(self, pbAttachFax);
    }
    pub inline fn put_AttachFaxToReceipt(self: *const IFaxDocument, bAttachFax: i16) HRESULT {
...
pub const IFaxSender = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BillingCode(self: *const IFaxSender, pbstrBillingCode: ?*?BSTR) HRESULT {
        return self.vtable.get_BillingCode(self, pbstrBillingCode);
    }
    pub inline fn put_BillingCode(self: *const IFaxSender, bstrBillingCode: ?BSTR) HRESULT {
        return self.vtable.put_BillingCode(self, bstrBillingCode);
    }
    pub inline fn get_City(self: *const IFaxSender, pbstrCity: ?*?BSTR) HRESULT {
        return self.vtable.get_City(self, pbstrCity);
    }
    pub inline fn put_City(self: *const IFaxSender, bstrCity: ?BSTR) HRESULT {
        return self.vtable.put_City(self, bstrCity);
    }
    pub inline fn get_Company(self: *const IFaxSender, pbstrCompany: ?*?BSTR) HRESULT {
        return self.vtable.get_Company(self, pbstrCompany);
    }
    pub inline fn put_Company(self: *const IFaxSender, bstrCompany: ?BSTR) HRESULT {
        return self.vtable.put_Company(self, bstrCompany);
    }
    pub inline fn get_Country(self: *const IFaxSender, pbstrCountry: ?*?BSTR) HRESULT {
        return self.vtable.get_Country(self, pbstrCountry);
    }
    pub inline fn put_Country(self: *const IFaxSender, bstrCountry: ?BSTR) HRESULT {
        return self.vtable.put_Country(self, bstrCountry);
    }
    pub inline fn get_Department(self: *const IFaxSender, pbstrDepartment: ?*?BSTR) HRESULT {
        return self.vtable.get_Department(self, pbstrDepartment);
    }
    pub inline fn put_Department(self: *const IFaxSender, bstrDepartment: ?BSTR) HRESULT {
        return self.vtable.put_Department(self, bstrDepartment);
    }
    pub inline fn get_Email(self: *const IFaxSender, pbstrEmail: ?*?BSTR) HRESULT {
        return self.vtable.get_Email(self, pbstrEmail);
    }
    pub inline fn put_Email(self: *const IFaxSender, bstrEmail: ?BSTR) HRESULT {
        return self.vtable.put_Email(self, bstrEmail);
    }
    pub inline fn get_FaxNumber(self: *const IFaxSender, pbstrFaxNumber: ?*?BSTR) HRESULT {
        return self.vtable.get_FaxNumber(self, pbstrFaxNumber);
    }
    pub inline fn put_FaxNumber(self: *const IFaxSender, bstrFaxNumber: ?BSTR) HRESULT {
        return self.vtable.put_FaxNumber(self, bstrFaxNumber);
    }
    pub inline fn get_HomePhone(self: *const IFaxSender, pbstrHomePhone: ?*?BSTR) HRESULT {
        return self.vtable.get_HomePhone(self, pbstrHomePhone);
    }
    pub inline fn put_HomePhone(self: *const IFaxSender, bstrHomePhone: ?BSTR) HRESULT {
        return self.vtable.put_HomePhone(self, bstrHomePhone);
    }
    pub inline fn get_Name(self: *const IFaxSender, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IFaxSender, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_TSID(self: *const IFaxSender, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn put_TSID(self: *const IFaxSender, bstrTSID: ?BSTR) HRESULT {
        return self.vtable.put_TSID(self, bstrTSID);
    }
    pub inline fn get_OfficePhone(self: *const IFaxSender, pbstrOfficePhone: ?*?BSTR) HRESULT {
        return self.vtable.get_OfficePhone(self, pbstrOfficePhone);
    }
    pub inline fn put_OfficePhone(self: *const IFaxSender, bstrOfficePhone: ?BSTR) HRESULT {
        return self.vtable.put_OfficePhone(self, bstrOfficePhone);
    }
    pub inline fn get_OfficeLocation(self: *const IFaxSender, pbstrOfficeLocation: ?*?BSTR) HRESULT {
        return self.vtable.get_OfficeLocation(self, pbstrOfficeLocation);
    }
    pub inline fn put_OfficeLocation(self: *const IFaxSender, bstrOfficeLocation: ?BSTR) HRESULT {
        return self.vtable.put_OfficeLocation(self, bstrOfficeLocation);
    }
    pub inline fn get_State(self: *const IFaxSender, pbstrState: ?*?BSTR) HRESULT {
        return self.vtable.get_State(self, pbstrState);
    }
    pub inline fn put_State(self: *const IFaxSender, bstrState: ?BSTR) HRESULT {
        return self.vtable.put_State(self, bstrState);
    }
    pub inline fn get_StreetAddress(self: *const IFaxSender, pbstrStreetAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_StreetAddress(self, pbstrStreetAddress);
    }
    pub inline fn put_StreetAddress(self: *const IFaxSender, bstrStreetAddress: ?BSTR) HRESULT {
        return self.vtable.put_StreetAddress(self, bstrStreetAddress);
    }
    pub inline fn get_Title(self: *const IFaxSender, pbstrTitle: ?*?BSTR) HRESULT {
        return self.vtable.get_Title(self, pbstrTitle);
    }
    pub inline fn put_Title(self: *const IFaxSender, bstrTitle: ?BSTR) HRESULT {
        return self.vtable.put_Title(self, bstrTitle);
    }
    pub inline fn get_ZipCode(self: *const IFaxSender, pbstrZipCode: ?*?BSTR) HRESULT {
        return self.vtable.get_ZipCode(self, pbstrZipCode);
    }
    pub inline fn put_ZipCode(self: *const IFaxSender, bstrZipCode: ?BSTR) HRESULT {
        return self.vtable.put_ZipCode(self, bstrZipCode);
    }
    pub inline fn LoadDefaultSender(self: *const IFaxSender) HRESULT {
        return self.vtable.LoadDefaultSender(self);
    }
    pub inline fn SaveDefaultSender(self: *const IFaxSender) HRESULT {
...
pub const IFaxRecipient = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FaxNumber(self: *const IFaxRecipient, pbstrFaxNumber: ?*?BSTR) HRESULT {
        return self.vtable.get_FaxNumber(self, pbstrFaxNumber);
    }
    pub inline fn put_FaxNumber(self: *const IFaxRecipient, bstrFaxNumber: ?BSTR) HRESULT {
        return self.vtable.put_FaxNumber(self, bstrFaxNumber);
    }
    pub inline fn get_Name(self: *const IFaxRecipient, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IFaxRecipient, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
};
...
pub const IFaxRecipients = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxRecipients, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxRecipients, lIndex: i32, ppFaxRecipient: ?*?*IFaxRecipient) HRESULT {
        return self.vtable.get_Item(self, lIndex, ppFaxRecipient);
    }
    pub inline fn get_Count(self: *const IFaxRecipients, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn Add(self: *const IFaxRecipients, bstrFaxNumber: ?BSTR, bstrRecipientName: ?BSTR, ppFaxRecipient: ?*?*IFaxRecipient) HRESULT {
        return self.vtable.Add(self, bstrFaxNumber, bstrRecipientName, ppFaxRecipient);
    }
    pub inline fn Remove(self: *const IFaxRecipients, lIndex: i32) HRESULT {
...
pub const IFaxIncomingArchive = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_UseArchive(self: *const IFaxIncomingArchive, pbUseArchive: ?*i16) HRESULT {
        return self.vtable.get_UseArchive(self, pbUseArchive);
    }
    pub inline fn put_UseArchive(self: *const IFaxIncomingArchive, bUseArchive: i16) HRESULT {
        return self.vtable.put_UseArchive(self, bUseArchive);
    }
    pub inline fn get_ArchiveFolder(self: *const IFaxIncomingArchive, pbstrArchiveFolder: ?*?BSTR) HRESULT {
        return self.vtable.get_ArchiveFolder(self, pbstrArchiveFolder);
    }
    pub inline fn put_ArchiveFolder(self: *const IFaxIncomingArchive, bstrArchiveFolder: ?BSTR) HRESULT {
        return self.vtable.put_ArchiveFolder(self, bstrArchiveFolder);
    }
    pub inline fn get_SizeQuotaWarning(self: *const IFaxIncomingArchive, pbSizeQuotaWarning: ?*i16) HRESULT {
        return self.vtable.get_SizeQuotaWarning(self, pbSizeQuotaWarning);
    }
    pub inline fn put_SizeQuotaWarning(self: *const IFaxIncomingArchive, bSizeQuotaWarning: i16) HRESULT {
        return self.vtable.put_SizeQuotaWarning(self, bSizeQuotaWarning);
    }
    pub inline fn get_HighQuotaWaterMark(self: *const IFaxIncomingArchive, plHighQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_HighQuotaWaterMark(self, plHighQuotaWaterMark);
    }
    pub inline fn put_HighQuotaWaterMark(self: *const IFaxIncomingArchive, lHighQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_HighQuotaWaterMark(self, lHighQuotaWaterMark);
    }
    pub inline fn get_LowQuotaWaterMark(self: *const IFaxIncomingArchive, plLowQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_LowQuotaWaterMark(self, plLowQuotaWaterMark);
    }
    pub inline fn put_LowQuotaWaterMark(self: *const IFaxIncomingArchive, lLowQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_LowQuotaWaterMark(self, lLowQuotaWaterMark);
    }
    pub inline fn get_AgeLimit(self: *const IFaxIncomingArchive, plAgeLimit: ?*i32) HRESULT {
        return self.vtable.get_AgeLimit(self, plAgeLimit);
    }
    pub inline fn put_AgeLimit(self: *const IFaxIncomingArchive, lAgeLimit: i32) HRESULT {
        return self.vtable.put_AgeLimit(self, lAgeLimit);
    }
    pub inline fn get_SizeLow(self: *const IFaxIncomingArchive, plSizeLow: ?*i32) HRESULT {
        return self.vtable.get_SizeLow(self, plSizeLow);
    }
    pub inline fn get_SizeHigh(self: *const IFaxIncomingArchive, plSizeHigh: ?*i32) HRESULT {
        return self.vtable.get_SizeHigh(self, plSizeHigh);
    }
    pub inline fn Refresh(self: *const IFaxIncomingArchive) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxIncomingArchive) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetMessages(self: *const IFaxIncomingArchive, lPrefetchSize: i32, pFaxIncomingMessageIterator: ?*?*IFaxIncomingMessageIterator) HRESULT {
        return self.vtable.GetMessages(self, lPrefetchSize, pFaxIncomingMessageIterator);
    }
    pub inline fn GetMessage(self: *const IFaxIncomingArchive, bstrMessageId: ?BSTR, pFaxIncomingMessage: ?*?*IFaxIncomingMessage) HRESULT {
...
pub const IFaxIncomingQueue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Blocked(self: *const IFaxIncomingQueue, pbBlocked: ?*i16) HRESULT {
        return self.vtable.get_Blocked(self, pbBlocked);
    }
    pub inline fn put_Blocked(self: *const IFaxIncomingQueue, bBlocked: i16) HRESULT {
        return self.vtable.put_Blocked(self, bBlocked);
    }
    pub inline fn Refresh(self: *const IFaxIncomingQueue) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxIncomingQueue) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetJobs(self: *const IFaxIncomingQueue, pFaxIncomingJobs: ?*?*IFaxIncomingJobs) HRESULT {
        return self.vtable.GetJobs(self, pFaxIncomingJobs);
    }
    pub inline fn GetJob(self: *const IFaxIncomingQueue, bstrJobId: ?BSTR, pFaxIncomingJob: ?*?*IFaxIncomingJob) HRESULT {
...
pub const IFaxOutgoingArchive = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_UseArchive(self: *const IFaxOutgoingArchive, pbUseArchive: ?*i16) HRESULT {
        return self.vtable.get_UseArchive(self, pbUseArchive);
    }
    pub inline fn put_UseArchive(self: *const IFaxOutgoingArchive, bUseArchive: i16) HRESULT {
        return self.vtable.put_UseArchive(self, bUseArchive);
    }
    pub inline fn get_ArchiveFolder(self: *const IFaxOutgoingArchive, pbstrArchiveFolder: ?*?BSTR) HRESULT {
        return self.vtable.get_ArchiveFolder(self, pbstrArchiveFolder);
    }
    pub inline fn put_ArchiveFolder(self: *const IFaxOutgoingArchive, bstrArchiveFolder: ?BSTR) HRESULT {
        return self.vtable.put_ArchiveFolder(self, bstrArchiveFolder);
    }
    pub inline fn get_SizeQuotaWarning(self: *const IFaxOutgoingArchive, pbSizeQuotaWarning: ?*i16) HRESULT {
        return self.vtable.get_SizeQuotaWarning(self, pbSizeQuotaWarning);
    }
    pub inline fn put_SizeQuotaWarning(self: *const IFaxOutgoingArchive, bSizeQuotaWarning: i16) HRESULT {
        return self.vtable.put_SizeQuotaWarning(self, bSizeQuotaWarning);
    }
    pub inline fn get_HighQuotaWaterMark(self: *const IFaxOutgoingArchive, plHighQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_HighQuotaWaterMark(self, plHighQuotaWaterMark);
    }
    pub inline fn put_HighQuotaWaterMark(self: *const IFaxOutgoingArchive, lHighQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_HighQuotaWaterMark(self, lHighQuotaWaterMark);
    }
    pub inline fn get_LowQuotaWaterMark(self: *const IFaxOutgoingArchive, plLowQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_LowQuotaWaterMark(self, plLowQuotaWaterMark);
    }
    pub inline fn put_LowQuotaWaterMark(self: *const IFaxOutgoingArchive, lLowQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_LowQuotaWaterMark(self, lLowQuotaWaterMark);
    }
    pub inline fn get_AgeLimit(self: *const IFaxOutgoingArchive, plAgeLimit: ?*i32) HRESULT {
        return self.vtable.get_AgeLimit(self, plAgeLimit);
    }
    pub inline fn put_AgeLimit(self: *const IFaxOutgoingArchive, lAgeLimit: i32) HRESULT {
        return self.vtable.put_AgeLimit(self, lAgeLimit);
    }
    pub inline fn get_SizeLow(self: *const IFaxOutgoingArchive, plSizeLow: ?*i32) HRESULT {
        return self.vtable.get_SizeLow(self, plSizeLow);
    }
    pub inline fn get_SizeHigh(self: *const IFaxOutgoingArchive, plSizeHigh: ?*i32) HRESULT {
        return self.vtable.get_SizeHigh(self, plSizeHigh);
    }
    pub inline fn Refresh(self: *const IFaxOutgoingArchive) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxOutgoingArchive) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetMessages(self: *const IFaxOutgoingArchive, lPrefetchSize: i32, pFaxOutgoingMessageIterator: ?*?*IFaxOutgoingMessageIterator) HRESULT {
        return self.vtable.GetMessages(self, lPrefetchSize, pFaxOutgoingMessageIterator);
    }
    pub inline fn GetMessage(self: *const IFaxOutgoingArchive, bstrMessageId: ?BSTR, pFaxOutgoingMessage: ?*?*IFaxOutgoingMessage) HRESULT {
...
pub const IFaxOutgoingQueue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Blocked(self: *const IFaxOutgoingQueue, pbBlocked: ?*i16) HRESULT {
        return self.vtable.get_Blocked(self, pbBlocked);
    }
    pub inline fn put_Blocked(self: *const IFaxOutgoingQueue, bBlocked: i16) HRESULT {
        return self.vtable.put_Blocked(self, bBlocked);
    }
    pub inline fn get_Paused(self: *const IFaxOutgoingQueue, pbPaused: ?*i16) HRESULT {
        return self.vtable.get_Paused(self, pbPaused);
    }
    pub inline fn put_Paused(self: *const IFaxOutgoingQueue, bPaused: i16) HRESULT {
        return self.vtable.put_Paused(self, bPaused);
    }
    pub inline fn get_AllowPersonalCoverPages(self: *const IFaxOutgoingQueue, pbAllowPersonalCoverPages: ?*i16) HRESULT {
        return self.vtable.get_AllowPersonalCoverPages(self, pbAllowPersonalCoverPages);
    }
    pub inline fn put_AllowPersonalCoverPages(self: *const IFaxOutgoingQueue, bAllowPersonalCoverPages: i16) HRESULT {
        return self.vtable.put_AllowPersonalCoverPages(self, bAllowPersonalCoverPages);
    }
    pub inline fn get_UseDeviceTSID(self: *const IFaxOutgoingQueue, pbUseDeviceTSID: ?*i16) HRESULT {
        return self.vtable.get_UseDeviceTSID(self, pbUseDeviceTSID);
    }
    pub inline fn put_UseDeviceTSID(self: *const IFaxOutgoingQueue, bUseDeviceTSID: i16) HRESULT {
        return self.vtable.put_UseDeviceTSID(self, bUseDeviceTSID);
    }
    pub inline fn get_Retries(self: *const IFaxOutgoingQueue, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn put_Retries(self: *const IFaxOutgoingQueue, lRetries: i32) HRESULT {
        return self.vtable.put_Retries(self, lRetries);
    }
    pub inline fn get_RetryDelay(self: *const IFaxOutgoingQueue, plRetryDelay: ?*i32) HRESULT {
        return self.vtable.get_RetryDelay(self, plRetryDelay);
    }
    pub inline fn put_RetryDelay(self: *const IFaxOutgoingQueue, lRetryDelay: i32) HRESULT {
        return self.vtable.put_RetryDelay(self, lRetryDelay);
    }
    pub inline fn get_DiscountRateStart(self: *const IFaxOutgoingQueue, pdateDiscountRateStart: ?*f64) HRESULT {
        return self.vtable.get_DiscountRateStart(self, pdateDiscountRateStart);
    }
    pub inline fn put_DiscountRateStart(self: *const IFaxOutgoingQueue, dateDiscountRateStart: f64) HRESULT {
        return self.vtable.put_DiscountRateStart(self, dateDiscountRateStart);
    }
    pub inline fn get_DiscountRateEnd(self: *const IFaxOutgoingQueue, pdateDiscountRateEnd: ?*f64) HRESULT {
        return self.vtable.get_DiscountRateEnd(self, pdateDiscountRateEnd);
    }
    pub inline fn put_DiscountRateEnd(self: *const IFaxOutgoingQueue, dateDiscountRateEnd: f64) HRESULT {
        return self.vtable.put_DiscountRateEnd(self, dateDiscountRateEnd);
    }
    pub inline fn get_AgeLimit(self: *const IFaxOutgoingQueue, plAgeLimit: ?*i32) HRESULT {
        return self.vtable.get_AgeLimit(self, plAgeLimit);
    }
    pub inline fn put_AgeLimit(self: *const IFaxOutgoingQueue, lAgeLimit: i32) HRESULT {
        return self.vtable.put_AgeLimit(self, lAgeLimit);
    }
    pub inline fn get_Branding(self: *const IFaxOutgoingQueue, pbBranding: ?*i16) HRESULT {
        return self.vtable.get_Branding(self, pbBranding);
    }
    pub inline fn put_Branding(self: *const IFaxOutgoingQueue, bBranding: i16) HRESULT {
        return self.vtable.put_Branding(self, bBranding);
    }
    pub inline fn Refresh(self: *const IFaxOutgoingQueue) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxOutgoingQueue) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetJobs(self: *const IFaxOutgoingQueue, pFaxOutgoingJobs: ?*?*IFaxOutgoingJobs) HRESULT {
        return self.vtable.GetJobs(self, pFaxOutgoingJobs);
    }
    pub inline fn GetJob(self: *const IFaxOutgoingQueue, bstrJobId: ?BSTR, pFaxOutgoingJob: ?*?*IFaxOutgoingJob) HRESULT {
...
pub const IFaxIncomingMessageIterator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Message(self: *const IFaxIncomingMessageIterator, pFaxIncomingMessage: ?*?*IFaxIncomingMessage) HRESULT {
        return self.vtable.get_Message(self, pFaxIncomingMessage);
    }
    pub inline fn get_PrefetchSize(self: *const IFaxIncomingMessageIterator, plPrefetchSize: ?*i32) HRESULT {
        return self.vtable.get_PrefetchSize(self, plPrefetchSize);
    }
    pub inline fn put_PrefetchSize(self: *const IFaxIncomingMessageIterator, lPrefetchSize: i32) HRESULT {
        return self.vtable.put_PrefetchSize(self, lPrefetchSize);
    }
    pub inline fn get_AtEOF(self: *const IFaxIncomingMessageIterator, pbEOF: ?*i16) HRESULT {
        return self.vtable.get_AtEOF(self, pbEOF);
    }
    pub inline fn MoveFirst(self: *const IFaxIncomingMessageIterator) HRESULT {
        return self.vtable.MoveFirst(self);
    }
    pub inline fn MoveNext(self: *const IFaxIncomingMessageIterator) HRESULT {
...
pub const IFaxIncomingMessage = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Id(self: *const IFaxIncomingMessage, pbstrId: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, pbstrId);
    }
    pub inline fn get_Pages(self: *const IFaxIncomingMessage, plPages: ?*i32) HRESULT {
        return self.vtable.get_Pages(self, plPages);
    }
    pub inline fn get_Size(self: *const IFaxIncomingMessage, plSize: ?*i32) HRESULT {
        return self.vtable.get_Size(self, plSize);
    }
    pub inline fn get_DeviceName(self: *const IFaxIncomingMessage, pbstrDeviceName: ?*?BSTR) HRESULT {
        return self.vtable.get_DeviceName(self, pbstrDeviceName);
    }
    pub inline fn get_Retries(self: *const IFaxIncomingMessage, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn get_TransmissionStart(self: *const IFaxIncomingMessage, pdateTransmissionStart: ?*f64) HRESULT {
        return self.vtable.get_TransmissionStart(self, pdateTransmissionStart);
    }
    pub inline fn get_TransmissionEnd(self: *const IFaxIncomingMessage, pdateTransmissionEnd: ?*f64) HRESULT {
        return self.vtable.get_TransmissionEnd(self, pdateTransmissionEnd);
    }
    pub inline fn get_CSID(self: *const IFaxIncomingMessage, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxIncomingMessage, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn get_CallerId(self: *const IFaxIncomingMessage, pbstrCallerId: ?*?BSTR) HRESULT {
        return self.vtable.get_CallerId(self, pbstrCallerId);
    }
    pub inline fn get_RoutingInformation(self: *const IFaxIncomingMessage, pbstrRoutingInformation: ?*?BSTR) HRESULT {
        return self.vtable.get_RoutingInformation(self, pbstrRoutingInformation);
    }
    pub inline fn CopyTiff(self: *const IFaxIncomingMessage, bstrTiffPath: ?BSTR) HRESULT {
        return self.vtable.CopyTiff(self, bstrTiffPath);
    }
    pub inline fn Delete(self: *const IFaxIncomingMessage) HRESULT {
...
pub const IFaxOutgoingJobs = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxOutgoingJobs, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxOutgoingJobs, vIndex: VARIANT, pFaxOutgoingJob: ?*?*IFaxOutgoingJob) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxOutgoingJob);
    }
    pub inline fn get_Count(self: *const IFaxOutgoingJobs, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IFaxOutgoingJob = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Subject(self: *const IFaxOutgoingJob, pbstrSubject: ?*?BSTR) HRESULT {
        return self.vtable.get_Subject(self, pbstrSubject);
    }
    pub inline fn get_DocumentName(self: *const IFaxOutgoingJob, pbstrDocumentName: ?*?BSTR) HRESULT {
        return self.vtable.get_DocumentName(self, pbstrDocumentName);
    }
    pub inline fn get_Pages(self: *const IFaxOutgoingJob, plPages: ?*i32) HRESULT {
        return self.vtable.get_Pages(self, plPages);
    }
    pub inline fn get_Size(self: *const IFaxOutgoingJob, plSize: ?*i32) HRESULT {
        return self.vtable.get_Size(self, plSize);
    }
    pub inline fn get_SubmissionId(self: *const IFaxOutgoingJob, pbstrSubmissionId: ?*?BSTR) HRESULT {
        return self.vtable.get_SubmissionId(self, pbstrSubmissionId);
    }
    pub inline fn get_Id(self: *const IFaxOutgoingJob, pbstrId: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, pbstrId);
    }
    pub inline fn get_OriginalScheduledTime(self: *const IFaxOutgoingJob, pdateOriginalScheduledTime: ?*f64) HRESULT {
        return self.vtable.get_OriginalScheduledTime(self, pdateOriginalScheduledTime);
    }
    pub inline fn get_SubmissionTime(self: *const IFaxOutgoingJob, pdateSubmissionTime: ?*f64) HRESULT {
        return self.vtable.get_SubmissionTime(self, pdateSubmissionTime);
    }
    pub inline fn get_ReceiptType(self: *const IFaxOutgoingJob, pReceiptType: ?*FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.get_ReceiptType(self, pReceiptType);
    }
    pub inline fn get_Priority(self: *const IFaxOutgoingJob, pPriority: ?*FAX_PRIORITY_TYPE_ENUM) HRESULT {
        return self.vtable.get_Priority(self, pPriority);
    }
    pub inline fn get_Sender(self: *const IFaxOutgoingJob, ppFaxSender: ?*?*IFaxSender) HRESULT {
        return self.vtable.get_Sender(self, ppFaxSender);
    }
    pub inline fn get_Recipient(self: *const IFaxOutgoingJob, ppFaxRecipient: ?*?*IFaxRecipient) HRESULT {
        return self.vtable.get_Recipient(self, ppFaxRecipient);
    }
    pub inline fn get_CurrentPage(self: *const IFaxOutgoingJob, plCurrentPage: ?*i32) HRESULT {
        return self.vtable.get_CurrentPage(self, plCurrentPage);
    }
    pub inline fn get_DeviceId(self: *const IFaxOutgoingJob, plDeviceId: ?*i32) HRESULT {
        return self.vtable.get_DeviceId(self, plDeviceId);
    }
    pub inline fn get_Status(self: *const IFaxOutgoingJob, pStatus: ?*FAX_JOB_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_ExtendedStatusCode(self: *const IFaxOutgoingJob, pExtendedStatusCode: ?*FAX_JOB_EXTENDED_STATUS_ENUM) HRESULT {
        return self.vtable.get_ExtendedStatusCode(self, pExtendedStatusCode);
    }
    pub inline fn get_ExtendedStatus(self: *const IFaxOutgoingJob, pbstrExtendedStatus: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtendedStatus(self, pbstrExtendedStatus);
    }
    pub inline fn get_AvailableOperations(self: *const IFaxOutgoingJob, pAvailableOperations: ?*FAX_JOB_OPERATIONS_ENUM) HRESULT {
        return self.vtable.get_AvailableOperations(self, pAvailableOperations);
    }
    pub inline fn get_Retries(self: *const IFaxOutgoingJob, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn get_ScheduledTime(self: *const IFaxOutgoingJob, pdateScheduledTime: ?*f64) HRESULT {
        return self.vtable.get_ScheduledTime(self, pdateScheduledTime);
    }
    pub inline fn get_TransmissionStart(self: *const IFaxOutgoingJob, pdateTransmissionStart: ?*f64) HRESULT {
        return self.vtable.get_TransmissionStart(self, pdateTransmissionStart);
    }
    pub inline fn get_TransmissionEnd(self: *const IFaxOutgoingJob, pdateTransmissionEnd: ?*f64) HRESULT {
        return self.vtable.get_TransmissionEnd(self, pdateTransmissionEnd);
    }
    pub inline fn get_CSID(self: *const IFaxOutgoingJob, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxOutgoingJob, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn get_GroupBroadcastReceipts(self: *const IFaxOutgoingJob, pbGroupBroadcastReceipts: ?*i16) HRESULT {
        return self.vtable.get_GroupBroadcastReceipts(self, pbGroupBroadcastReceipts);
    }
    pub inline fn Pause(self: *const IFaxOutgoingJob) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn Resume(self: *const IFaxOutgoingJob) HRESULT {
        return self.vtable.Resume(self);
    }
    pub inline fn Restart(self: *const IFaxOutgoingJob) HRESULT {
        return self.vtable.Restart(self);
    }
    pub inline fn CopyTiff(self: *const IFaxOutgoingJob, bstrTiffPath: ?BSTR) HRESULT {
        return self.vtable.CopyTiff(self, bstrTiffPath);
    }
    pub inline fn Refresh(self: *const IFaxOutgoingJob) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Cancel(self: *const IFaxOutgoingJob) HRESULT {
...
pub const IFaxOutgoingMessageIterator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Message(self: *const IFaxOutgoingMessageIterator, pFaxOutgoingMessage: ?*?*IFaxOutgoingMessage) HRESULT {
        return self.vtable.get_Message(self, pFaxOutgoingMessage);
    }
    pub inline fn get_AtEOF(self: *const IFaxOutgoingMessageIterator, pbEOF: ?*i16) HRESULT {
        return self.vtable.get_AtEOF(self, pbEOF);
    }
    pub inline fn get_PrefetchSize(self: *const IFaxOutgoingMessageIterator, plPrefetchSize: ?*i32) HRESULT {
        return self.vtable.get_PrefetchSize(self, plPrefetchSize);
    }
    pub inline fn put_PrefetchSize(self: *const IFaxOutgoingMessageIterator, lPrefetchSize: i32) HRESULT {
        return self.vtable.put_PrefetchSize(self, lPrefetchSize);
    }
    pub inline fn MoveFirst(self: *const IFaxOutgoingMessageIterator) HRESULT {
        return self.vtable.MoveFirst(self);
    }
    pub inline fn MoveNext(self: *const IFaxOutgoingMessageIterator) HRESULT {
        return self.vtable.MoveNext(self);
    }
};
...
pub const IFaxOutgoingMessage = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_SubmissionId(self: *const IFaxOutgoingMessage, pbstrSubmissionId: ?*?BSTR) HRESULT {
        return self.vtable.get_SubmissionId(self, pbstrSubmissionId);
    }
    pub inline fn get_Id(self: *const IFaxOutgoingMessage, pbstrId: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, pbstrId);
    }
    pub inline fn get_Subject(self: *const IFaxOutgoingMessage, pbstrSubject: ?*?BSTR) HRESULT {
        return self.vtable.get_Subject(self, pbstrSubject);
    }
    pub inline fn get_DocumentName(self: *const IFaxOutgoingMessage, pbstrDocumentName: ?*?BSTR) HRESULT {
        return self.vtable.get_DocumentName(self, pbstrDocumentName);
    }
    pub inline fn get_Retries(self: *const IFaxOutgoingMessage, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn get_Pages(self: *const IFaxOutgoingMessage, plPages: ?*i32) HRESULT {
        return self.vtable.get_Pages(self, plPages);
    }
    pub inline fn get_Size(self: *const IFaxOutgoingMessage, plSize: ?*i32) HRESULT {
        return self.vtable.get_Size(self, plSize);
    }
    pub inline fn get_OriginalScheduledTime(self: *const IFaxOutgoingMessage, pdateOriginalScheduledTime: ?*f64) HRESULT {
        return self.vtable.get_OriginalScheduledTime(self, pdateOriginalScheduledTime);
    }
    pub inline fn get_SubmissionTime(self: *const IFaxOutgoingMessage, pdateSubmissionTime: ?*f64) HRESULT {
        return self.vtable.get_SubmissionTime(self, pdateSubmissionTime);
    }
    pub inline fn get_Priority(self: *const IFaxOutgoingMessage, pPriority: ?*FAX_PRIORITY_TYPE_ENUM) HRESULT {
        return self.vtable.get_Priority(self, pPriority);
    }
    pub inline fn get_Sender(self: *const IFaxOutgoingMessage, ppFaxSender: ?*?*IFaxSender) HRESULT {
        return self.vtable.get_Sender(self, ppFaxSender);
    }
    pub inline fn get_Recipient(self: *const IFaxOutgoingMessage, ppFaxRecipient: ?*?*IFaxRecipient) HRESULT {
        return self.vtable.get_Recipient(self, ppFaxRecipient);
    }
    pub inline fn get_DeviceName(self: *const IFaxOutgoingMessage, pbstrDeviceName: ?*?BSTR) HRESULT {
        return self.vtable.get_DeviceName(self, pbstrDeviceName);
    }
    pub inline fn get_TransmissionStart(self: *const IFaxOutgoingMessage, pdateTransmissionStart: ?*f64) HRESULT {
        return self.vtable.get_TransmissionStart(self, pdateTransmissionStart);
    }
    pub inline fn get_TransmissionEnd(self: *const IFaxOutgoingMessage, pdateTransmissionEnd: ?*f64) HRESULT {
        return self.vtable.get_TransmissionEnd(self, pdateTransmissionEnd);
    }
    pub inline fn get_CSID(self: *const IFaxOutgoingMessage, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxOutgoingMessage, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn CopyTiff(self: *const IFaxOutgoingMessage, bstrTiffPath: ?BSTR) HRESULT {
        return self.vtable.CopyTiff(self, bstrTiffPath);
    }
    pub inline fn Delete(self: *const IFaxOutgoingMessage) HRESULT {
        return self.vtable.Delete(self);
    }
};
...
pub const IFaxIncomingJobs = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxIncomingJobs, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxIncomingJobs, vIndex: VARIANT, pFaxIncomingJob: ?*?*IFaxIncomingJob) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxIncomingJob);
    }
    pub inline fn get_Count(self: *const IFaxIncomingJobs, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IFaxIncomingJob = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Size(self: *const IFaxIncomingJob, plSize: ?*i32) HRESULT {
        return self.vtable.get_Size(self, plSize);
    }
    pub inline fn get_Id(self: *const IFaxIncomingJob, pbstrId: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, pbstrId);
    }
    pub inline fn get_CurrentPage(self: *const IFaxIncomingJob, plCurrentPage: ?*i32) HRESULT {
        return self.vtable.get_CurrentPage(self, plCurrentPage);
    }
    pub inline fn get_DeviceId(self: *const IFaxIncomingJob, plDeviceId: ?*i32) HRESULT {
        return self.vtable.get_DeviceId(self, plDeviceId);
    }
    pub inline fn get_Status(self: *const IFaxIncomingJob, pStatus: ?*FAX_JOB_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_ExtendedStatusCode(self: *const IFaxIncomingJob, pExtendedStatusCode: ?*FAX_JOB_EXTENDED_STATUS_ENUM) HRESULT {
        return self.vtable.get_ExtendedStatusCode(self, pExtendedStatusCode);
    }
    pub inline fn get_ExtendedStatus(self: *const IFaxIncomingJob, pbstrExtendedStatus: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtendedStatus(self, pbstrExtendedStatus);
    }
    pub inline fn get_AvailableOperations(self: *const IFaxIncomingJob, pAvailableOperations: ?*FAX_JOB_OPERATIONS_ENUM) HRESULT {
        return self.vtable.get_AvailableOperations(self, pAvailableOperations);
    }
    pub inline fn get_Retries(self: *const IFaxIncomingJob, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn get_TransmissionStart(self: *const IFaxIncomingJob, pdateTransmissionStart: ?*f64) HRESULT {
        return self.vtable.get_TransmissionStart(self, pdateTransmissionStart);
    }
    pub inline fn get_TransmissionEnd(self: *const IFaxIncomingJob, pdateTransmissionEnd: ?*f64) HRESULT {
        return self.vtable.get_TransmissionEnd(self, pdateTransmissionEnd);
    }
    pub inline fn get_CSID(self: *const IFaxIncomingJob, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxIncomingJob, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn get_CallerId(self: *const IFaxIncomingJob, pbstrCallerId: ?*?BSTR) HRESULT {
        return self.vtable.get_CallerId(self, pbstrCallerId);
    }
    pub inline fn get_RoutingInformation(self: *const IFaxIncomingJob, pbstrRoutingInformation: ?*?BSTR) HRESULT {
        return self.vtable.get_RoutingInformation(self, pbstrRoutingInformation);
    }
    pub inline fn get_JobType(self: *const IFaxIncomingJob, pJobType: ?*FAX_JOB_TYPE_ENUM) HRESULT {
        return self.vtable.get_JobType(self, pJobType);
    }
    pub inline fn Cancel(self: *const IFaxIncomingJob) HRESULT {
        return self.vtable.Cancel(self);
    }
    pub inline fn Refresh(self: *const IFaxIncomingJob) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn CopyTiff(self: *const IFaxIncomingJob, bstrTiffPath: ?BSTR) HRESULT {
        return self.vtable.CopyTiff(self, bstrTiffPath);
    }
};
...
pub const IFaxDeviceProvider = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FriendlyName(self: *const IFaxDeviceProvider, pbstrFriendlyName: ?*?BSTR) HRESULT {
        return self.vtable.get_FriendlyName(self, pbstrFriendlyName);
    }
    pub inline fn get_ImageName(self: *const IFaxDeviceProvider, pbstrImageName: ?*?BSTR) HRESULT {
        return self.vtable.get_ImageName(self, pbstrImageName);
    }
    pub inline fn get_UniqueName(self: *const IFaxDeviceProvider, pbstrUniqueName: ?*?BSTR) HRESULT {
        return self.vtable.get_UniqueName(self, pbstrUniqueName);
    }
    pub inline fn get_TapiProviderName(self: *const IFaxDeviceProvider, pbstrTapiProviderName: ?*?BSTR) HRESULT {
        return self.vtable.get_TapiProviderName(self, pbstrTapiProviderName);
    }
    pub inline fn get_MajorVersion(self: *const IFaxDeviceProvider, plMajorVersion: ?*i32) HRESULT {
        return self.vtable.get_MajorVersion(self, plMajorVersion);
    }
    pub inline fn get_MinorVersion(self: *const IFaxDeviceProvider, plMinorVersion: ?*i32) HRESULT {
        return self.vtable.get_MinorVersion(self, plMinorVersion);
    }
    pub inline fn get_MajorBuild(self: *const IFaxDeviceProvider, plMajorBuild: ?*i32) HRESULT {
        return self.vtable.get_MajorBuild(self, plMajorBuild);
    }
    pub inline fn get_MinorBuild(self: *const IFaxDeviceProvider, plMinorBuild: ?*i32) HRESULT {
        return self.vtable.get_MinorBuild(self, plMinorBuild);
    }
    pub inline fn get_Debug(self: *const IFaxDeviceProvider, pbDebug: ?*i16) HRESULT {
        return self.vtable.get_Debug(self, pbDebug);
    }
    pub inline fn get_Status(self: *const IFaxDeviceProvider, pStatus: ?*FAX_PROVIDER_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_InitErrorCode(self: *const IFaxDeviceProvider, plInitErrorCode: ?*i32) HRESULT {
        return self.vtable.get_InitErrorCode(self, plInitErrorCode);
    }
    pub inline fn get_DeviceIds(self: *const IFaxDeviceProvider, pvDeviceIds: ?*VARIANT) HRESULT {
...
pub const IFaxDevice = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Id(self: *const IFaxDevice, plId: ?*i32) HRESULT {
        return self.vtable.get_Id(self, plId);
    }
    pub inline fn get_DeviceName(self: *const IFaxDevice, pbstrDeviceName: ?*?BSTR) HRESULT {
        return self.vtable.get_DeviceName(self, pbstrDeviceName);
    }
    pub inline fn get_ProviderUniqueName(self: *const IFaxDevice, pbstrProviderUniqueName: ?*?BSTR) HRESULT {
        return self.vtable.get_ProviderUniqueName(self, pbstrProviderUniqueName);
    }
    pub inline fn get_PoweredOff(self: *const IFaxDevice, pbPoweredOff: ?*i16) HRESULT {
        return self.vtable.get_PoweredOff(self, pbPoweredOff);
    }
    pub inline fn get_ReceivingNow(self: *const IFaxDevice, pbReceivingNow: ?*i16) HRESULT {
        return self.vtable.get_ReceivingNow(self, pbReceivingNow);
    }
    pub inline fn get_SendingNow(self: *const IFaxDevice, pbSendingNow: ?*i16) HRESULT {
        return self.vtable.get_SendingNow(self, pbSendingNow);
    }
    pub inline fn get_UsedRoutingMethods(self: *const IFaxDevice, pvUsedRoutingMethods: ?*VARIANT) HRESULT {
        return self.vtable.get_UsedRoutingMethods(self, pvUsedRoutingMethods);
    }
    pub inline fn get_Description(self: *const IFaxDevice, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IFaxDevice, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_SendEnabled(self: *const IFaxDevice, pbSendEnabled: ?*i16) HRESULT {
        return self.vtable.get_SendEnabled(self, pbSendEnabled);
    }
    pub inline fn put_SendEnabled(self: *const IFaxDevice, bSendEnabled: i16) HRESULT {
        return self.vtable.put_SendEnabled(self, bSendEnabled);
    }
    pub inline fn get_ReceiveMode(self: *const IFaxDevice, pReceiveMode: ?*FAX_DEVICE_RECEIVE_MODE_ENUM) HRESULT {
        return self.vtable.get_ReceiveMode(self, pReceiveMode);
    }
    pub inline fn put_ReceiveMode(self: *const IFaxDevice, ReceiveMode: FAX_DEVICE_RECEIVE_MODE_ENUM) HRESULT {
        return self.vtable.put_ReceiveMode(self, ReceiveMode);
    }
    pub inline fn get_RingsBeforeAnswer(self: *const IFaxDevice, plRingsBeforeAnswer: ?*i32) HRESULT {
        return self.vtable.get_RingsBeforeAnswer(self, plRingsBeforeAnswer);
    }
    pub inline fn put_RingsBeforeAnswer(self: *const IFaxDevice, lRingsBeforeAnswer: i32) HRESULT {
        return self.vtable.put_RingsBeforeAnswer(self, lRingsBeforeAnswer);
    }
    pub inline fn get_CSID(self: *const IFaxDevice, pbstrCSID: ?*?BSTR) HRESULT {
        return self.vtable.get_CSID(self, pbstrCSID);
    }
    pub inline fn put_CSID(self: *const IFaxDevice, bstrCSID: ?BSTR) HRESULT {
        return self.vtable.put_CSID(self, bstrCSID);
    }
    pub inline fn get_TSID(self: *const IFaxDevice, pbstrTSID: ?*?BSTR) HRESULT {
        return self.vtable.get_TSID(self, pbstrTSID);
    }
    pub inline fn put_TSID(self: *const IFaxDevice, bstrTSID: ?BSTR) HRESULT {
        return self.vtable.put_TSID(self, bstrTSID);
    }
    pub inline fn Refresh(self: *const IFaxDevice) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxDevice) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetExtensionProperty(self: *const IFaxDevice, bstrGUID: ?BSTR, pvProperty: ?*VARIANT) HRESULT {
        return self.vtable.GetExtensionProperty(self, bstrGUID, pvProperty);
    }
    pub inline fn SetExtensionProperty(self: *const IFaxDevice, bstrGUID: ?BSTR, vProperty: VARIANT) HRESULT {
        return self.vtable.SetExtensionProperty(self, bstrGUID, vProperty);
    }
    pub inline fn UseRoutingMethod(self: *const IFaxDevice, bstrMethodGUID: ?BSTR, bUse: i16) HRESULT {
        return self.vtable.UseRoutingMethod(self, bstrMethodGUID, bUse);
    }
    pub inline fn get_RingingNow(self: *const IFaxDevice, pbRingingNow: ?*i16) HRESULT {
        return self.vtable.get_RingingNow(self, pbRingingNow);
    }
    pub inline fn AnswerCall(self: *const IFaxDevice) HRESULT {
...
pub const IFaxActivityLogging = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_LogIncoming(self: *const IFaxActivityLogging, pbLogIncoming: ?*i16) HRESULT {
        return self.vtable.get_LogIncoming(self, pbLogIncoming);
    }
    pub inline fn put_LogIncoming(self: *const IFaxActivityLogging, bLogIncoming: i16) HRESULT {
        return self.vtable.put_LogIncoming(self, bLogIncoming);
    }
    pub inline fn get_LogOutgoing(self: *const IFaxActivityLogging, pbLogOutgoing: ?*i16) HRESULT {
        return self.vtable.get_LogOutgoing(self, pbLogOutgoing);
    }
    pub inline fn put_LogOutgoing(self: *const IFaxActivityLogging, bLogOutgoing: i16) HRESULT {
        return self.vtable.put_LogOutgoing(self, bLogOutgoing);
    }
    pub inline fn get_DatabasePath(self: *const IFaxActivityLogging, pbstrDatabasePath: ?*?BSTR) HRESULT {
        return self.vtable.get_DatabasePath(self, pbstrDatabasePath);
    }
    pub inline fn put_DatabasePath(self: *const IFaxActivityLogging, bstrDatabasePath: ?BSTR) HRESULT {
        return self.vtable.put_DatabasePath(self, bstrDatabasePath);
    }
    pub inline fn Refresh(self: *const IFaxActivityLogging) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxActivityLogging) HRESULT {
        return self.vtable.Save(self);
    }
};
...
pub const IFaxEventLogging = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_InitEventsLevel(self: *const IFaxEventLogging, pInitEventLevel: ?*FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.get_InitEventsLevel(self, pInitEventLevel);
    }
    pub inline fn put_InitEventsLevel(self: *const IFaxEventLogging, InitEventLevel: FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.put_InitEventsLevel(self, InitEventLevel);
    }
    pub inline fn get_InboundEventsLevel(self: *const IFaxEventLogging, pInboundEventLevel: ?*FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.get_InboundEventsLevel(self, pInboundEventLevel);
    }
    pub inline fn put_InboundEventsLevel(self: *const IFaxEventLogging, InboundEventLevel: FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.put_InboundEventsLevel(self, InboundEventLevel);
    }
    pub inline fn get_OutboundEventsLevel(self: *const IFaxEventLogging, pOutboundEventLevel: ?*FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.get_OutboundEventsLevel(self, pOutboundEventLevel);
    }
    pub inline fn put_OutboundEventsLevel(self: *const IFaxEventLogging, OutboundEventLevel: FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.put_OutboundEventsLevel(self, OutboundEventLevel);
    }
    pub inline fn get_GeneralEventsLevel(self: *const IFaxEventLogging, pGeneralEventLevel: ?*FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.get_GeneralEventsLevel(self, pGeneralEventLevel);
    }
    pub inline fn put_GeneralEventsLevel(self: *const IFaxEventLogging, GeneralEventLevel: FAX_LOG_LEVEL_ENUM) HRESULT {
        return self.vtable.put_GeneralEventsLevel(self, GeneralEventLevel);
    }
    pub inline fn Refresh(self: *const IFaxEventLogging) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxEventLogging) HRESULT {
        return self.vtable.Save(self);
    }
};
...
pub const IFaxOutboundRoutingGroups = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxOutboundRoutingGroups, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxOutboundRoutingGroups, vIndex: VARIANT, pFaxOutboundRoutingGroup: ?*?*IFaxOutboundRoutingGroup) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxOutboundRoutingGroup);
    }
    pub inline fn get_Count(self: *const IFaxOutboundRoutingGroups, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn Add(self: *const IFaxOutboundRoutingGroups, bstrName: ?BSTR, pFaxOutboundRoutingGroup: ?*?*IFaxOutboundRoutingGroup) HRESULT {
        return self.vtable.Add(self, bstrName, pFaxOutboundRoutingGroup);
    }
    pub inline fn Remove(self: *const IFaxOutboundRoutingGroups, vIndex: VARIANT) HRESULT {
...
pub const IFaxOutboundRoutingGroup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IFaxOutboundRoutingGroup, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn get_Status(self: *const IFaxOutboundRoutingGroup, pStatus: ?*FAX_GROUP_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_DeviceIds(self: *const IFaxOutboundRoutingGroup, pFaxDeviceIds: ?*?*IFaxDeviceIds) HRESULT {
...
pub const IFaxDeviceIds = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxDeviceIds, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxDeviceIds, lIndex: i32, plDeviceId: ?*i32) HRESULT {
        return self.vtable.get_Item(self, lIndex, plDeviceId);
    }
    pub inline fn get_Count(self: *const IFaxDeviceIds, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn Add(self: *const IFaxDeviceIds, lDeviceId: i32) HRESULT {
        return self.vtable.Add(self, lDeviceId);
    }
    pub inline fn Remove(self: *const IFaxDeviceIds, lIndex: i32) HRESULT {
        return self.vtable.Remove(self, lIndex);
    }
    pub inline fn SetOrder(self: *const IFaxDeviceIds, lDeviceId: i32, lNewOrder: i32) HRESULT {
...
pub const IFaxOutboundRoutingRules = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxOutboundRoutingRules, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxOutboundRoutingRules, lIndex: i32, pFaxOutboundRoutingRule: ?*?*IFaxOutboundRoutingRule) HRESULT {
        return self.vtable.get_Item(self, lIndex, pFaxOutboundRoutingRule);
    }
    pub inline fn get_Count(self: *const IFaxOutboundRoutingRules, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn ItemByCountryAndArea(self: *const IFaxOutboundRoutingRules, lCountryCode: i32, lAreaCode: i32, pFaxOutboundRoutingRule: ?*?*IFaxOutboundRoutingRule) HRESULT {
        return self.vtable.ItemByCountryAndArea(self, lCountryCode, lAreaCode, pFaxOutboundRoutingRule);
    }
    pub inline fn RemoveByCountryAndArea(self: *const IFaxOutboundRoutingRules, lCountryCode: i32, lAreaCode: i32) HRESULT {
        return self.vtable.RemoveByCountryAndArea(self, lCountryCode, lAreaCode);
    }
    pub inline fn Remove(self: *const IFaxOutboundRoutingRules, lIndex: i32) HRESULT {
        return self.vtable.Remove(self, lIndex);
    }
    pub inline fn Add(self: *const IFaxOutboundRoutingRules, lCountryCode: i32, lAreaCode: i32, bUseDevice: i16, bstrGroupName: ?BSTR, lDeviceId: i32, pFaxOutboundRoutingRule: ?*?*IFaxOutboundRoutingRule) HRESULT {
...
pub const IFaxOutboundRoutingRule = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_CountryCode(self: *const IFaxOutboundRoutingRule, plCountryCode: ?*i32) HRESULT {
        return self.vtable.get_CountryCode(self, plCountryCode);
    }
    pub inline fn get_AreaCode(self: *const IFaxOutboundRoutingRule, plAreaCode: ?*i32) HRESULT {
        return self.vtable.get_AreaCode(self, plAreaCode);
    }
    pub inline fn get_Status(self: *const IFaxOutboundRoutingRule, pStatus: ?*FAX_RULE_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_UseDevice(self: *const IFaxOutboundRoutingRule, pbUseDevice: ?*i16) HRESULT {
        return self.vtable.get_UseDevice(self, pbUseDevice);
    }
    pub inline fn put_UseDevice(self: *const IFaxOutboundRoutingRule, bUseDevice: i16) HRESULT {
        return self.vtable.put_UseDevice(self, bUseDevice);
    }
    pub inline fn get_DeviceId(self: *const IFaxOutboundRoutingRule, plDeviceId: ?*i32) HRESULT {
        return self.vtable.get_DeviceId(self, plDeviceId);
    }
    pub inline fn put_DeviceId(self: *const IFaxOutboundRoutingRule, DeviceId: i32) HRESULT {
        return self.vtable.put_DeviceId(self, DeviceId);
    }
    pub inline fn get_GroupName(self: *const IFaxOutboundRoutingRule, pbstrGroupName: ?*?BSTR) HRESULT {
        return self.vtable.get_GroupName(self, pbstrGroupName);
    }
    pub inline fn put_GroupName(self: *const IFaxOutboundRoutingRule, bstrGroupName: ?BSTR) HRESULT {
        return self.vtable.put_GroupName(self, bstrGroupName);
    }
    pub inline fn Refresh(self: *const IFaxOutboundRoutingRule) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxOutboundRoutingRule) HRESULT {
        return self.vtable.Save(self);
    }
};
...
pub const IFaxInboundRoutingExtensions = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxInboundRoutingExtensions, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxInboundRoutingExtensions, vIndex: VARIANT, pFaxInboundRoutingExtension: ?*?*IFaxInboundRoutingExtension) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxInboundRoutingExtension);
    }
    pub inline fn get_Count(self: *const IFaxInboundRoutingExtensions, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IFaxInboundRoutingExtension = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FriendlyName(self: *const IFaxInboundRoutingExtension, pbstrFriendlyName: ?*?BSTR) HRESULT {
        return self.vtable.get_FriendlyName(self, pbstrFriendlyName);
    }
    pub inline fn get_ImageName(self: *const IFaxInboundRoutingExtension, pbstrImageName: ?*?BSTR) HRESULT {
        return self.vtable.get_ImageName(self, pbstrImageName);
    }
    pub inline fn get_UniqueName(self: *const IFaxInboundRoutingExtension, pbstrUniqueName: ?*?BSTR) HRESULT {
        return self.vtable.get_UniqueName(self, pbstrUniqueName);
    }
    pub inline fn get_MajorVersion(self: *const IFaxInboundRoutingExtension, plMajorVersion: ?*i32) HRESULT {
        return self.vtable.get_MajorVersion(self, plMajorVersion);
    }
    pub inline fn get_MinorVersion(self: *const IFaxInboundRoutingExtension, plMinorVersion: ?*i32) HRESULT {
        return self.vtable.get_MinorVersion(self, plMinorVersion);
    }
    pub inline fn get_MajorBuild(self: *const IFaxInboundRoutingExtension, plMajorBuild: ?*i32) HRESULT {
        return self.vtable.get_MajorBuild(self, plMajorBuild);
    }
    pub inline fn get_MinorBuild(self: *const IFaxInboundRoutingExtension, plMinorBuild: ?*i32) HRESULT {
        return self.vtable.get_MinorBuild(self, plMinorBuild);
    }
    pub inline fn get_Debug(self: *const IFaxInboundRoutingExtension, pbDebug: ?*i16) HRESULT {
        return self.vtable.get_Debug(self, pbDebug);
    }
    pub inline fn get_Status(self: *const IFaxInboundRoutingExtension, pStatus: ?*FAX_PROVIDER_STATUS_ENUM) HRESULT {
        return self.vtable.get_Status(self, pStatus);
    }
    pub inline fn get_InitErrorCode(self: *const IFaxInboundRoutingExtension, plInitErrorCode: ?*i32) HRESULT {
        return self.vtable.get_InitErrorCode(self, plInitErrorCode);
    }
    pub inline fn get_Methods(self: *const IFaxInboundRoutingExtension, pvMethods: ?*VARIANT) HRESULT {
...
pub const IFaxInboundRoutingMethods = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxInboundRoutingMethods, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxInboundRoutingMethods, vIndex: VARIANT, pFaxInboundRoutingMethod: ?*?*IFaxInboundRoutingMethod) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxInboundRoutingMethod);
    }
    pub inline fn get_Count(self: *const IFaxInboundRoutingMethods, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IFaxInboundRoutingMethod = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IFaxInboundRoutingMethod, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn get_GUID(self: *const IFaxInboundRoutingMethod, pbstrGUID: ?*?BSTR) HRESULT {
        return self.vtable.get_GUID(self, pbstrGUID);
    }
    pub inline fn get_FunctionName(self: *const IFaxInboundRoutingMethod, pbstrFunctionName: ?*?BSTR) HRESULT {
        return self.vtable.get_FunctionName(self, pbstrFunctionName);
    }
    pub inline fn get_ExtensionFriendlyName(self: *const IFaxInboundRoutingMethod, pbstrExtensionFriendlyName: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtensionFriendlyName(self, pbstrExtensionFriendlyName);
    }
    pub inline fn get_ExtensionImageName(self: *const IFaxInboundRoutingMethod, pbstrExtensionImageName: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtensionImageName(self, pbstrExtensionImageName);
    }
    pub inline fn get_Priority(self: *const IFaxInboundRoutingMethod, plPriority: ?*i32) HRESULT {
        return self.vtable.get_Priority(self, plPriority);
    }
    pub inline fn put_Priority(self: *const IFaxInboundRoutingMethod, lPriority: i32) HRESULT {
        return self.vtable.put_Priority(self, lPriority);
    }
    pub inline fn Refresh(self: *const IFaxInboundRoutingMethod) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxInboundRoutingMethod) HRESULT {
        return self.vtable.Save(self);
    }
};
...
pub const IFaxDocument2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_SubmissionId(self: *const IFaxDocument2, pbstrSubmissionId: ?*?BSTR) HRESULT {
        return self.vtable.get_SubmissionId(self, pbstrSubmissionId);
    }
    pub inline fn get_Bodies(self: *const IFaxDocument2, pvBodies: ?*VARIANT) HRESULT {
        return self.vtable.get_Bodies(self, pvBodies);
    }
    pub inline fn put_Bodies(self: *const IFaxDocument2, vBodies: VARIANT) HRESULT {
        return self.vtable.put_Bodies(self, vBodies);
    }
    pub inline fn Submit2(self: *const IFaxDocument2, bstrFaxServerName: ?BSTR, pvFaxOutgoingJobIDs: ?*VARIANT, plErrorBodyFile: ?*i32) HRESULT {
        return self.vtable.Submit2(self, bstrFaxServerName, pvFaxOutgoingJobIDs, plErrorBodyFile);
    }
    pub inline fn ConnectedSubmit2(self: *const IFaxDocument2, pFaxServer: ?*IFaxServer, pvFaxOutgoingJobIDs: ?*VARIANT, plErrorBodyFile: ?*i32) HRESULT {
...
pub const IFaxConfiguration = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_UseArchive(self: *const IFaxConfiguration, pbUseArchive: ?*i16) HRESULT {
        return self.vtable.get_UseArchive(self, pbUseArchive);
    }
    pub inline fn put_UseArchive(self: *const IFaxConfiguration, bUseArchive: i16) HRESULT {
        return self.vtable.put_UseArchive(self, bUseArchive);
    }
    pub inline fn get_ArchiveLocation(self: *const IFaxConfiguration, pbstrArchiveLocation: ?*?BSTR) HRESULT {
        return self.vtable.get_ArchiveLocation(self, pbstrArchiveLocation);
    }
    pub inline fn put_ArchiveLocation(self: *const IFaxConfiguration, bstrArchiveLocation: ?BSTR) HRESULT {
        return self.vtable.put_ArchiveLocation(self, bstrArchiveLocation);
    }
    pub inline fn get_SizeQuotaWarning(self: *const IFaxConfiguration, pbSizeQuotaWarning: ?*i16) HRESULT {
        return self.vtable.get_SizeQuotaWarning(self, pbSizeQuotaWarning);
    }
    pub inline fn put_SizeQuotaWarning(self: *const IFaxConfiguration, bSizeQuotaWarning: i16) HRESULT {
        return self.vtable.put_SizeQuotaWarning(self, bSizeQuotaWarning);
    }
    pub inline fn get_HighQuotaWaterMark(self: *const IFaxConfiguration, plHighQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_HighQuotaWaterMark(self, plHighQuotaWaterMark);
    }
    pub inline fn put_HighQuotaWaterMark(self: *const IFaxConfiguration, lHighQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_HighQuotaWaterMark(self, lHighQuotaWaterMark);
    }
    pub inline fn get_LowQuotaWaterMark(self: *const IFaxConfiguration, plLowQuotaWaterMark: ?*i32) HRESULT {
        return self.vtable.get_LowQuotaWaterMark(self, plLowQuotaWaterMark);
    }
    pub inline fn put_LowQuotaWaterMark(self: *const IFaxConfiguration, lLowQuotaWaterMark: i32) HRESULT {
        return self.vtable.put_LowQuotaWaterMark(self, lLowQuotaWaterMark);
    }
    pub inline fn get_ArchiveAgeLimit(self: *const IFaxConfiguration, plArchiveAgeLimit: ?*i32) HRESULT {
        return self.vtable.get_ArchiveAgeLimit(self, plArchiveAgeLimit);
    }
    pub inline fn put_ArchiveAgeLimit(self: *const IFaxConfiguration, lArchiveAgeLimit: i32) HRESULT {
        return self.vtable.put_ArchiveAgeLimit(self, lArchiveAgeLimit);
    }
    pub inline fn get_ArchiveSizeLow(self: *const IFaxConfiguration, plSizeLow: ?*i32) HRESULT {
        return self.vtable.get_ArchiveSizeLow(self, plSizeLow);
    }
    pub inline fn get_ArchiveSizeHigh(self: *const IFaxConfiguration, plSizeHigh: ?*i32) HRESULT {
        return self.vtable.get_ArchiveSizeHigh(self, plSizeHigh);
    }
    pub inline fn get_OutgoingQueueBlocked(self: *const IFaxConfiguration, pbOutgoingBlocked: ?*i16) HRESULT {
        return self.vtable.get_OutgoingQueueBlocked(self, pbOutgoingBlocked);
    }
    pub inline fn put_OutgoingQueueBlocked(self: *const IFaxConfiguration, bOutgoingBlocked: i16) HRESULT {
        return self.vtable.put_OutgoingQueueBlocked(self, bOutgoingBlocked);
    }
    pub inline fn get_OutgoingQueuePaused(self: *const IFaxConfiguration, pbOutgoingPaused: ?*i16) HRESULT {
        return self.vtable.get_OutgoingQueuePaused(self, pbOutgoingPaused);
    }
    pub inline fn put_OutgoingQueuePaused(self: *const IFaxConfiguration, bOutgoingPaused: i16) HRESULT {
        return self.vtable.put_OutgoingQueuePaused(self, bOutgoingPaused);
    }
    pub inline fn get_AllowPersonalCoverPages(self: *const IFaxConfiguration, pbAllowPersonalCoverPages: ?*i16) HRESULT {
        return self.vtable.get_AllowPersonalCoverPages(self, pbAllowPersonalCoverPages);
    }
    pub inline fn put_AllowPersonalCoverPages(self: *const IFaxConfiguration, bAllowPersonalCoverPages: i16) HRESULT {
        return self.vtable.put_AllowPersonalCoverPages(self, bAllowPersonalCoverPages);
    }
    pub inline fn get_UseDeviceTSID(self: *const IFaxConfiguration, pbUseDeviceTSID: ?*i16) HRESULT {
        return self.vtable.get_UseDeviceTSID(self, pbUseDeviceTSID);
    }
    pub inline fn put_UseDeviceTSID(self: *const IFaxConfiguration, bUseDeviceTSID: i16) HRESULT {
        return self.vtable.put_UseDeviceTSID(self, bUseDeviceTSID);
    }
    pub inline fn get_Retries(self: *const IFaxConfiguration, plRetries: ?*i32) HRESULT {
        return self.vtable.get_Retries(self, plRetries);
    }
    pub inline fn put_Retries(self: *const IFaxConfiguration, lRetries: i32) HRESULT {
        return self.vtable.put_Retries(self, lRetries);
    }
    pub inline fn get_RetryDelay(self: *const IFaxConfiguration, plRetryDelay: ?*i32) HRESULT {
        return self.vtable.get_RetryDelay(self, plRetryDelay);
    }
    pub inline fn put_RetryDelay(self: *const IFaxConfiguration, lRetryDelay: i32) HRESULT {
        return self.vtable.put_RetryDelay(self, lRetryDelay);
    }
    pub inline fn get_DiscountRateStart(self: *const IFaxConfiguration, pdateDiscountRateStart: ?*f64) HRESULT {
        return self.vtable.get_DiscountRateStart(self, pdateDiscountRateStart);
    }
    pub inline fn put_DiscountRateStart(self: *const IFaxConfiguration, dateDiscountRateStart: f64) HRESULT {
        return self.vtable.put_DiscountRateStart(self, dateDiscountRateStart);
    }
    pub inline fn get_DiscountRateEnd(self: *const IFaxConfiguration, pdateDiscountRateEnd: ?*f64) HRESULT {
        return self.vtable.get_DiscountRateEnd(self, pdateDiscountRateEnd);
    }
    pub inline fn put_DiscountRateEnd(self: *const IFaxConfiguration, dateDiscountRateEnd: f64) HRESULT {
        return self.vtable.put_DiscountRateEnd(self, dateDiscountRateEnd);
    }
    pub inline fn get_OutgoingQueueAgeLimit(self: *const IFaxConfiguration, plOutgoingQueueAgeLimit: ?*i32) HRESULT {
        return self.vtable.get_OutgoingQueueAgeLimit(self, plOutgoingQueueAgeLimit);
    }
    pub inline fn put_OutgoingQueueAgeLimit(self: *const IFaxConfiguration, lOutgoingQueueAgeLimit: i32) HRESULT {
        return self.vtable.put_OutgoingQueueAgeLimit(self, lOutgoingQueueAgeLimit);
    }
    pub inline fn get_Branding(self: *const IFaxConfiguration, pbBranding: ?*i16) HRESULT {
        return self.vtable.get_Branding(self, pbBranding);
    }
    pub inline fn put_Branding(self: *const IFaxConfiguration, bBranding: i16) HRESULT {
        return self.vtable.put_Branding(self, bBranding);
    }
    pub inline fn get_IncomingQueueBlocked(self: *const IFaxConfiguration, pbIncomingBlocked: ?*i16) HRESULT {
        return self.vtable.get_IncomingQueueBlocked(self, pbIncomingBlocked);
    }
    pub inline fn put_IncomingQueueBlocked(self: *const IFaxConfiguration, bIncomingBlocked: i16) HRESULT {
        return self.vtable.put_IncomingQueueBlocked(self, bIncomingBlocked);
    }
    pub inline fn get_AutoCreateAccountOnConnect(self: *const IFaxConfiguration, pbAutoCreateAccountOnConnect: ?*i16) HRESULT {
        return self.vtable.get_AutoCreateAccountOnConnect(self, pbAutoCreateAccountOnConnect);
    }
    pub inline fn put_AutoCreateAccountOnConnect(self: *const IFaxConfiguration, bAutoCreateAccountOnConnect: i16) HRESULT {
        return self.vtable.put_AutoCreateAccountOnConnect(self, bAutoCreateAccountOnConnect);
    }
    pub inline fn get_IncomingFaxesArePublic(self: *const IFaxConfiguration, pbIncomingFaxesArePublic: ?*i16) HRESULT {
        return self.vtable.get_IncomingFaxesArePublic(self, pbIncomingFaxesArePublic);
    }
    pub inline fn put_IncomingFaxesArePublic(self: *const IFaxConfiguration, bIncomingFaxesArePublic: i16) HRESULT {
        return self.vtable.put_IncomingFaxesArePublic(self, bIncomingFaxesArePublic);
    }
    pub inline fn Refresh(self: *const IFaxConfiguration) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxConfiguration) HRESULT {
        return self.vtable.Save(self);
    }
};
...
pub const IFaxServer2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Configuration(self: *const IFaxServer2, ppFaxConfiguration: ?*?*IFaxConfiguration) HRESULT {
        return self.vtable.get_Configuration(self, ppFaxConfiguration);
    }
    pub inline fn get_CurrentAccount(self: *const IFaxServer2, ppCurrentAccount: ?*?*IFaxAccount) HRESULT {
        return self.vtable.get_CurrentAccount(self, ppCurrentAccount);
    }
    pub inline fn get_FaxAccountSet(self: *const IFaxServer2, ppFaxAccountSet: ?*?*IFaxAccountSet) HRESULT {
        return self.vtable.get_FaxAccountSet(self, ppFaxAccountSet);
    }
    pub inline fn get_Security2(self: *const IFaxServer2, ppFaxSecurity2: ?*?*IFaxSecurity2) HRESULT {
...
pub const IFaxAccountSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetAccounts(self: *const IFaxAccountSet, ppFaxAccounts: ?*?*IFaxAccounts) HRESULT {
        return self.vtable.GetAccounts(self, ppFaxAccounts);
    }
    pub inline fn GetAccount(self: *const IFaxAccountSet, bstrAccountName: ?BSTR, pFaxAccount: ?*?*IFaxAccount) HRESULT {
        return self.vtable.GetAccount(self, bstrAccountName, pFaxAccount);
    }
    pub inline fn AddAccount(self: *const IFaxAccountSet, bstrAccountName: ?BSTR, pFaxAccount: ?*?*IFaxAccount) HRESULT {
        return self.vtable.AddAccount(self, bstrAccountName, pFaxAccount);
    }
    pub inline fn RemoveAccount(self: *const IFaxAccountSet, bstrAccountName: ?BSTR) HRESULT {
...
pub const IFaxAccounts = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const IFaxAccounts, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppUnk);
    }
    pub inline fn get_Item(self: *const IFaxAccounts, vIndex: VARIANT, pFaxAccount: ?*?*IFaxAccount) HRESULT {
        return self.vtable.get_Item(self, vIndex, pFaxAccount);
    }
    pub inline fn get_Count(self: *const IFaxAccounts, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IFaxAccount = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_AccountName(self: *const IFaxAccount, pbstrAccountName: ?*?BSTR) HRESULT {
        return self.vtable.get_AccountName(self, pbstrAccountName);
    }
    pub inline fn get_Folders(self: *const IFaxAccount, ppFolders: ?*?*IFaxAccountFolders) HRESULT {
        return self.vtable.get_Folders(self, ppFolders);
    }
    pub inline fn ListenToAccountEvents(self: *const IFaxAccount, EventTypes: FAX_ACCOUNT_EVENTS_TYPE_ENUM) HRESULT {
        return self.vtable.ListenToAccountEvents(self, EventTypes);
    }
    pub inline fn get_RegisteredEvents(self: *const IFaxAccount, pRegisteredEvents: ?*FAX_ACCOUNT_EVENTS_TYPE_ENUM) HRESULT {
...
pub const IFaxOutgoingJob2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_HasCoverPage(self: *const IFaxOutgoingJob2, pbHasCoverPage: ?*i16) HRESULT {
        return self.vtable.get_HasCoverPage(self, pbHasCoverPage);
    }
    pub inline fn get_ReceiptAddress(self: *const IFaxOutgoingJob2, pbstrReceiptAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_ReceiptAddress(self, pbstrReceiptAddress);
    }
    pub inline fn get_ScheduleType(self: *const IFaxOutgoingJob2, pScheduleType: ?*FAX_SCHEDULE_TYPE_ENUM) HRESULT {
        return self.vtable.get_ScheduleType(self, pScheduleType);
    }
};
...
pub const IFaxAccountFolders = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_OutgoingQueue(self: *const IFaxAccountFolders, pFaxOutgoingQueue: ?*?*IFaxAccountOutgoingQueue) HRESULT {
        return self.vtable.get_OutgoingQueue(self, pFaxOutgoingQueue);
    }
    pub inline fn get_IncomingQueue(self: *const IFaxAccountFolders, pFaxIncomingQueue: ?*?*IFaxAccountIncomingQueue) HRESULT {
        return self.vtable.get_IncomingQueue(self, pFaxIncomingQueue);
    }
    pub inline fn get_IncomingArchive(self: *const IFaxAccountFolders, pFaxIncomingArchive: ?*?*IFaxAccountIncomingArchive) HRESULT {
        return self.vtable.get_IncomingArchive(self, pFaxIncomingArchive);
    }
    pub inline fn get_OutgoingArchive(self: *const IFaxAccountFolders, pFaxOutgoingArchive: ?*?*IFaxAccountOutgoingArchive) HRESULT {
        return self.vtable.get_OutgoingArchive(self, pFaxOutgoingArchive);
    }
};
...
pub const IFaxAccountIncomingQueue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetJobs(self: *const IFaxAccountIncomingQueue, pFaxIncomingJobs: ?*?*IFaxIncomingJobs) HRESULT {
        return self.vtable.GetJobs(self, pFaxIncomingJobs);
    }
    pub inline fn GetJob(self: *const IFaxAccountIncomingQueue, bstrJobId: ?BSTR, pFaxIncomingJob: ?*?*IFaxIncomingJob) HRESULT {
        return self.vtable.GetJob(self, bstrJobId, pFaxIncomingJob);
    }
};
...
pub const IFaxAccountOutgoingQueue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetJobs(self: *const IFaxAccountOutgoingQueue, pFaxOutgoingJobs: ?*?*IFaxOutgoingJobs) HRESULT {
        return self.vtable.GetJobs(self, pFaxOutgoingJobs);
    }
    pub inline fn GetJob(self: *const IFaxAccountOutgoingQueue, bstrJobId: ?BSTR, pFaxOutgoingJob: ?*?*IFaxOutgoingJob) HRESULT {
        return self.vtable.GetJob(self, bstrJobId, pFaxOutgoingJob);
    }
};
...
pub const IFaxOutgoingMessage2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_HasCoverPage(self: *const IFaxOutgoingMessage2, pbHasCoverPage: ?*i16) HRESULT {
        return self.vtable.get_HasCoverPage(self, pbHasCoverPage);
    }
    pub inline fn get_ReceiptType(self: *const IFaxOutgoingMessage2, pReceiptType: ?*FAX_RECEIPT_TYPE_ENUM) HRESULT {
        return self.vtable.get_ReceiptType(self, pReceiptType);
    }
    pub inline fn get_ReceiptAddress(self: *const IFaxOutgoingMessage2, pbstrReceiptAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_ReceiptAddress(self, pbstrReceiptAddress);
    }
    pub inline fn get_Read(self: *const IFaxOutgoingMessage2, pbRead: ?*i16) HRESULT {
        return self.vtable.get_Read(self, pbRead);
    }
    pub inline fn put_Read(self: *const IFaxOutgoingMessage2, bRead: i16) HRESULT {
        return self.vtable.put_Read(self, bRead);
    }
    pub inline fn Save(self: *const IFaxOutgoingMessage2) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn Refresh(self: *const IFaxOutgoingMessage2) HRESULT {
        return self.vtable.Refresh(self);
    }
};
...
pub const IFaxAccountIncomingArchive = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_SizeLow(self: *const IFaxAccountIncomingArchive, plSizeLow: ?*i32) HRESULT {
        return self.vtable.get_SizeLow(self, plSizeLow);
    }
    pub inline fn get_SizeHigh(self: *const IFaxAccountIncomingArchive, plSizeHigh: ?*i32) HRESULT {
        return self.vtable.get_SizeHigh(self, plSizeHigh);
    }
    pub inline fn Refresh(self: *const IFaxAccountIncomingArchive) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn GetMessages(self: *const IFaxAccountIncomingArchive, lPrefetchSize: i32, pFaxIncomingMessageIterator: ?*?*IFaxIncomingMessageIterator) HRESULT {
        return self.vtable.GetMessages(self, lPrefetchSize, pFaxIncomingMessageIterator);
    }
    pub inline fn GetMessage(self: *const IFaxAccountIncomingArchive, bstrMessageId: ?BSTR, pFaxIncomingMessage: ?*?*IFaxIncomingMessage) HRESULT {
        return self.vtable.GetMessage(self, bstrMessageId, pFaxIncomingMessage);
    }
};
...
pub const IFaxAccountOutgoingArchive = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_SizeLow(self: *const IFaxAccountOutgoingArchive, plSizeLow: ?*i32) HRESULT {
        return self.vtable.get_SizeLow(self, plSizeLow);
    }
    pub inline fn get_SizeHigh(self: *const IFaxAccountOutgoingArchive, plSizeHigh: ?*i32) HRESULT {
        return self.vtable.get_SizeHigh(self, plSizeHigh);
    }
    pub inline fn Refresh(self: *const IFaxAccountOutgoingArchive) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn GetMessages(self: *const IFaxAccountOutgoingArchive, lPrefetchSize: i32, pFaxOutgoingMessageIterator: ?*?*IFaxOutgoingMessageIterator) HRESULT {
        return self.vtable.GetMessages(self, lPrefetchSize, pFaxOutgoingMessageIterator);
    }
    pub inline fn GetMessage(self: *const IFaxAccountOutgoingArchive, bstrMessageId: ?BSTR, pFaxOutgoingMessage: ?*?*IFaxOutgoingMessage) HRESULT {
        return self.vtable.GetMessage(self, bstrMessageId, pFaxOutgoingMessage);
    }
};
...
pub const IFaxSecurity2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Descriptor(self: *const IFaxSecurity2, pvDescriptor: ?*VARIANT) HRESULT {
        return self.vtable.get_Descriptor(self, pvDescriptor);
    }
    pub inline fn put_Descriptor(self: *const IFaxSecurity2, vDescriptor: VARIANT) HRESULT {
        return self.vtable.put_Descriptor(self, vDescriptor);
    }
    pub inline fn get_GrantedRights(self: *const IFaxSecurity2, pGrantedRights: ?*FAX_ACCESS_RIGHTS_ENUM_2) HRESULT {
        return self.vtable.get_GrantedRights(self, pGrantedRights);
    }
    pub inline fn Refresh(self: *const IFaxSecurity2) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Save(self: *const IFaxSecurity2) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn get_InformationType(self: *const IFaxSecurity2, plInformationType: ?*i32) HRESULT {
        return self.vtable.get_InformationType(self, plInformationType);
    }
    pub inline fn put_InformationType(self: *const IFaxSecurity2, lInformationType: i32) HRESULT {
        return self.vtable.put_InformationType(self, lInformationType);
    }
};
...
pub const IFaxIncomingMessage2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Subject(self: *const IFaxIncomingMessage2, pbstrSubject: ?*?BSTR) HRESULT {
        return self.vtable.get_Subject(self, pbstrSubject);
    }
    pub inline fn put_Subject(self: *const IFaxIncomingMessage2, bstrSubject: ?BSTR) HRESULT {
        return self.vtable.put_Subject(self, bstrSubject);
    }
    pub inline fn get_SenderName(self: *const IFaxIncomingMessage2, pbstrSenderName: ?*?BSTR) HRESULT {
        return self.vtable.get_SenderName(self, pbstrSenderName);
    }
    pub inline fn put_SenderName(self: *const IFaxIncomingMessage2, bstrSenderName: ?BSTR) HRESULT {
        return self.vtable.put_SenderName(self, bstrSenderName);
    }
    pub inline fn get_SenderFaxNumber(self: *const IFaxIncomingMessage2, pbstrSenderFaxNumber: ?*?BSTR) HRESULT {
        return self.vtable.get_SenderFaxNumber(self, pbstrSenderFaxNumber);
    }
    pub inline fn put_SenderFaxNumber(self: *const IFaxIncomingMessage2, bstrSenderFaxNumber: ?BSTR) HRESULT {
        return self.vtable.put_SenderFaxNumber(self, bstrSenderFaxNumber);
    }
    pub inline fn get_HasCoverPage(self: *const IFaxIncomingMessage2, pbHasCoverPage: ?*i16) HRESULT {
        return self.vtable.get_HasCoverPage(self, pbHasCoverPage);
    }
    pub inline fn put_HasCoverPage(self: *const IFaxIncomingMessage2, bHasCoverPage: i16) HRESULT {
        return self.vtable.put_HasCoverPage(self, bHasCoverPage);
    }
    pub inline fn get_Recipients(self: *const IFaxIncomingMessage2, pbstrRecipients: ?*?BSTR) HRESULT {
        return self.vtable.get_Recipients(self, pbstrRecipients);
    }
    pub inline fn put_Recipients(self: *const IFaxIncomingMessage2, bstrRecipients: ?BSTR) HRESULT {
        return self.vtable.put_Recipients(self, bstrRecipients);
    }
    pub inline fn get_WasReAssigned(self: *const IFaxIncomingMessage2, pbWasReAssigned: ?*i16) HRESULT {
        return self.vtable.get_WasReAssigned(self, pbWasReAssigned);
    }
    pub inline fn get_Read(self: *const IFaxIncomingMessage2, pbRead: ?*i16) HRESULT {
        return self.vtable.get_Read(self, pbRead);
    }
    pub inline fn put_Read(self: *const IFaxIncomingMessage2, bRead: i16) HRESULT {
        return self.vtable.put_Read(self, bRead);
    }
    pub inline fn ReAssign(self: *const IFaxIncomingMessage2) HRESULT {
        return self.vtable.ReAssign(self);
    }
    pub inline fn Save(self: *const IFaxIncomingMessage2) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn Refresh(self: *const IFaxIncomingMessage2) HRESULT {
        return self.vtable.Refresh(self);
    }
};
...
pub const _IFaxServerNotify2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn OnIncomingJobAdded(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingJobAdded(self, pFaxServer, bstrJobId);
    }
    pub inline fn OnIncomingJobRemoved(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingJobRemoved(self, pFaxServer, bstrJobId);
    }
    pub inline fn OnIncomingJobChanged(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR, pJobStatus: ?*IFaxJobStatus) HRESULT {
        return self.vtable.OnIncomingJobChanged(self, pFaxServer, bstrJobId, pJobStatus);
    }
    pub inline fn OnOutgoingJobAdded(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingJobAdded(self, pFaxServer, bstrJobId);
    }
    pub inline fn OnOutgoingJobRemoved(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingJobRemoved(self, pFaxServer, bstrJobId);
    }
    pub inline fn OnOutgoingJobChanged(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrJobId: ?BSTR, pJobStatus: ?*IFaxJobStatus) HRESULT {
        return self.vtable.OnOutgoingJobChanged(self, pFaxServer, bstrJobId, pJobStatus);
    }
    pub inline fn OnIncomingMessageAdded(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingMessageAdded(self, pFaxServer, bstrMessageId);
    }
    pub inline fn OnIncomingMessageRemoved(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingMessageRemoved(self, pFaxServer, bstrMessageId);
    }
    pub inline fn OnOutgoingMessageAdded(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingMessageAdded(self, pFaxServer, bstrMessageId);
    }
    pub inline fn OnOutgoingMessageRemoved(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingMessageRemoved(self, pFaxServer, bstrMessageId);
    }
    pub inline fn OnReceiptOptionsChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnReceiptOptionsChange(self, pFaxServer);
    }
    pub inline fn OnActivityLoggingConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnActivityLoggingConfigChange(self, pFaxServer);
    }
    pub inline fn OnSecurityConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnSecurityConfigChange(self, pFaxServer);
    }
    pub inline fn OnEventLoggingConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnEventLoggingConfigChange(self, pFaxServer);
    }
    pub inline fn OnOutgoingQueueConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnOutgoingQueueConfigChange(self, pFaxServer);
    }
    pub inline fn OnOutgoingArchiveConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnOutgoingArchiveConfigChange(self, pFaxServer);
    }
    pub inline fn OnIncomingArchiveConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnIncomingArchiveConfigChange(self, pFaxServer);
    }
    pub inline fn OnDevicesConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnDevicesConfigChange(self, pFaxServer);
    }
    pub inline fn OnOutboundRoutingGroupsConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnOutboundRoutingGroupsConfigChange(self, pFaxServer);
    }
    pub inline fn OnOutboundRoutingRulesConfigChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnOutboundRoutingRulesConfigChange(self, pFaxServer);
    }
    pub inline fn OnServerActivityChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, lIncomingMessages: i32, lRoutingMessages: i32, lOutgoingMessages: i32, lQueuedMessages: i32) HRESULT {
    ...
    pub inline fn OnQueuesStatusChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, bOutgoingQueueBlocked: i16, bOutgoingQueuePaused: i16, bIncomingQueueBlocked: i16) HRESULT {
        return self.vtable.OnQueuesStatusChange(self, pFaxServer, bOutgoingQueueBlocked, bOutgoingQueuePaused, bIncomingQueueBlocked);
    }
    pub inline fn OnNewCall(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, lCallId: i32, lDeviceId: i32, bstrCallerId: ?BSTR) HRESULT {
        return self.vtable.OnNewCall(self, pFaxServer, lCallId, lDeviceId, bstrCallerId);
    }
    pub inline fn OnServerShutDown(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnServerShutDown(self, pFaxServer);
    }
    pub inline fn OnDeviceStatusChange(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2, lDeviceId: i32, bPoweredOff: i16, bSending: i16, bReceiving: i16, bRinging: i16) HRESULT {
        return self.vtable.OnDeviceStatusChange(self, pFaxServer, lDeviceId, bPoweredOff, bSending, bReceiving, bRinging);
    }
    pub inline fn OnGeneralServerConfigChanged(self: *const _IFaxServerNotify2, pFaxServer: ?*IFaxServer2) HRESULT {
...
pub const _IFaxAccountNotify = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn OnIncomingJobAdded(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingJobAdded(self, pFaxAccount, bstrJobId);
    }
    pub inline fn OnIncomingJobRemoved(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnIncomingJobRemoved(self, pFaxAccount, bstrJobId);
    }
    pub inline fn OnIncomingJobChanged(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR, pJobStatus: ?*IFaxJobStatus) HRESULT {
        return self.vtable.OnIncomingJobChanged(self, pFaxAccount, bstrJobId, pJobStatus);
    }
    pub inline fn OnOutgoingJobAdded(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingJobAdded(self, pFaxAccount, bstrJobId);
    }
    pub inline fn OnOutgoingJobRemoved(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingJobRemoved(self, pFaxAccount, bstrJobId);
    }
    pub inline fn OnOutgoingJobChanged(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrJobId: ?BSTR, pJobStatus: ?*IFaxJobStatus) HRESULT {
        return self.vtable.OnOutgoingJobChanged(self, pFaxAccount, bstrJobId, pJobStatus);
    }
    pub inline fn OnIncomingMessageAdded(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrMessageId: ?BSTR, fAddedToReceiveFolder: i16) HRESULT {
        return self.vtable.OnIncomingMessageAdded(self, pFaxAccount, bstrMessageId, fAddedToReceiveFolder);
    }
    pub inline fn OnIncomingMessageRemoved(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrMessageId: ?BSTR, fRemovedFromReceiveFolder: i16) HRESULT {
        return self.vtable.OnIncomingMessageRemoved(self, pFaxAccount, bstrMessageId, fRemovedFromReceiveFolder);
    }
    pub inline fn OnOutgoingMessageAdded(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingMessageAdded(self, pFaxAccount, bstrMessageId);
    }
    pub inline fn OnOutgoingMessageRemoved(self: *const _IFaxAccountNotify, pFaxAccount: ?*IFaxAccount, bstrMessageId: ?BSTR) HRESULT {
        return self.vtable.OnOutgoingMessageRemoved(self, pFaxAccount, bstrMessageId);
    }
    pub inline fn OnServerShutDown(self: *const _IFaxAccountNotify, pFaxServer: ?*IFaxServer2) HRESULT {
        return self.vtable.OnServerShutDown(self, pFaxServer);
    }
};
...
pub const IStillImageW = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IStillImageW, hinst: ?HINSTANCE, dwVersion: u32) HRESULT {
        return self.vtable.Initialize(self, hinst, dwVersion);
    }
    pub inline fn GetDeviceList(self: *const IStillImageW, dwType: u32, dwFlags: u32, pdwItemsReturned: ?*u32, ppBuffer: ?*?*anyopaque) HRESULT {
        return self.vtable.GetDeviceList(self, dwType, dwFlags, pdwItemsReturned, ppBuffer);
    }
    pub inline fn GetDeviceInfo(self: *const IStillImageW, pwszDeviceName: ?PWSTR, ppBuffer: ?*?*anyopaque) HRESULT {
        return self.vtable.GetDeviceInfo(self, pwszDeviceName, ppBuffer);
    }
    pub inline fn CreateDevice(self: *const IStillImageW, pwszDeviceName: ?PWSTR, dwMode: u32, pDevice: ?*?*IStiDevice, punkOuter: ?*IUnknown) HRESULT {
        return self.vtable.CreateDevice(self, pwszDeviceName, dwMode, pDevice, punkOuter);
    }
    pub inline fn GetDeviceValue(self: *const IStillImageW, pwszDeviceName: ?PWSTR, pValueName: ?PWSTR, pType: ?*u32, pData: ?*u8, cbData: ?*u32) HRESULT {
        return self.vtable.GetDeviceValue(self, pwszDeviceName, pValueName, pType, pData, cbData);
    }
    pub inline fn SetDeviceValue(self: *const IStillImageW, pwszDeviceName: ?PWSTR, pValueName: ?PWSTR, Type: u32, pData: ?*u8, cbData: u32) HRESULT {
        return self.vtable.SetDeviceValue(self, pwszDeviceName, pValueName, Type, pData, cbData);
    }
    pub inline fn GetSTILaunchInformation(self: *const IStillImageW, pwszDeviceName: *[128]u16, pdwEventCode: ?*u32, pwszEventName: *[128]u16) HRESULT {
        return self.vtable.GetSTILaunchInformation(self, pwszDeviceName, pdwEventCode, pwszEventName);
    }
    pub inline fn RegisterLaunchApplication(self: *const IStillImageW, pwszAppName: ?PWSTR, pwszCommandLine: ?PWSTR) HRESULT {
        return self.vtable.RegisterLaunchApplication(self, pwszAppName, pwszCommandLine);
    }
    pub inline fn UnregisterLaunchApplication(self: *const IStillImageW, pwszAppName: ?PWSTR) HRESULT {
        return self.vtable.UnregisterLaunchApplication(self, pwszAppName);
    }
    pub inline fn EnableHwNotifications(self: *const IStillImageW, pwszDeviceName: ?[*:0]const u16, bNewState: BOOL) HRESULT {
        return self.vtable.EnableHwNotifications(self, pwszDeviceName, bNewState);
    }
    pub inline fn GetHwNotificationState(self: *const IStillImageW, pwszDeviceName: ?[*:0]const u16, pbCurrentState: ?*BOOL) HRESULT {
        return self.vtable.GetHwNotificationState(self, pwszDeviceName, pbCurrentState);
    }
    pub inline fn RefreshDeviceBus(self: *const IStillImageW, pwszDeviceName: ?[*:0]const u16) HRESULT {
        return self.vtable.RefreshDeviceBus(self, pwszDeviceName);
    }
    pub inline fn LaunchApplicationForDevice(self: *const IStillImageW, pwszDeviceName: ?PWSTR, pwszAppName: ?PWSTR, pStiNotify: ?*STINOTIFY) HRESULT {
        return self.vtable.LaunchApplicationForDevice(self, pwszDeviceName, pwszAppName, pStiNotify);
    }
    pub inline fn SetupDeviceParameters(self: *const IStillImageW, param0: ?*STI_DEVICE_INFORMATIONW) HRESULT {
        return self.vtable.SetupDeviceParameters(self, param0);
    }
    pub inline fn WriteToErrorLog(self: *const IStillImageW, dwMessageType: u32, pszMessage: ?[*:0]const u16) HRESULT {
...
pub const IStiDevice = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IStiDevice, hinst: ?HINSTANCE, pwszDeviceName: ?[*:0]const u16, dwVersion: u32, dwMode: u32) HRESULT {
        return self.vtable.Initialize(self, hinst, pwszDeviceName, dwVersion, dwMode);
    }
    pub inline fn GetCapabilities(self: *const IStiDevice, pDevCaps: ?*STI_DEV_CAPS) HRESULT {
        return self.vtable.GetCapabilities(self, pDevCaps);
    }
    pub inline fn GetStatus(self: *const IStiDevice, pDevStatus: ?*STI_DEVICE_STATUS) HRESULT {
        return self.vtable.GetStatus(self, pDevStatus);
    }
    pub inline fn DeviceReset(self: *const IStiDevice) HRESULT {
        return self.vtable.DeviceReset(self);
    }
    pub inline fn Diagnostic(self: *const IStiDevice, pBuffer: ?*STI_DIAG) HRESULT {
        return self.vtable.Diagnostic(self, pBuffer);
    }
    pub inline fn Escape(self: *const IStiDevice, EscapeFunction: u32, lpInData: ?*anyopaque, cbInDataSize: u32, pOutData: ?*anyopaque, dwOutDataSize: u32, pdwActualData: ?*u32) HRESULT {
        return self.vtable.Escape(self, EscapeFunction, lpInData, cbInDataSize, pOutData, dwOutDataSize, pdwActualData);
    }
    pub inline fn GetLastError(self: *const IStiDevice, pdwLastDeviceError: ?*u32) HRESULT {
        return self.vtable.GetLastError(self, pdwLastDeviceError);
    }
    pub inline fn LockDevice(self: *const IStiDevice, dwTimeOut: u32) HRESULT {
        return self.vtable.LockDevice(self, dwTimeOut);
    }
    pub inline fn UnLockDevice(self: *const IStiDevice) HRESULT {
        return self.vtable.UnLockDevice(self);
    }
    pub inline fn RawReadData(self: *const IStiDevice, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadData(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteData(self: *const IStiDevice, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteData(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawReadCommand(self: *const IStiDevice, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadCommand(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteCommand(self: *const IStiDevice, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteCommand(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn Subscribe(self: *const IStiDevice, lpSubsribe: ?*STISUBSCRIBE) HRESULT {
        return self.vtable.Subscribe(self, lpSubsribe);
    }
    pub inline fn GetLastNotificationData(self: *const IStiDevice, lpNotify: ?*STINOTIFY) HRESULT {
        return self.vtable.GetLastNotificationData(self, lpNotify);
    }
    pub inline fn UnSubscribe(self: *const IStiDevice) HRESULT {
        return self.vtable.UnSubscribe(self);
    }
    pub inline fn GetLastErrorInfo(self: *const IStiDevice, pLastErrorInfo: ?*_ERROR_INFOW) HRESULT {
...
pub const IStiDeviceControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IStiDeviceControl, dwDeviceType: u32, dwMode: u32, pwszPortName: ?[*:0]const u16, dwFlags: u32) HRESULT {
        return self.vtable.Initialize(self, dwDeviceType, dwMode, pwszPortName, dwFlags);
    }
    pub inline fn RawReadData(self: *const IStiDeviceControl, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadData(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteData(self: *const IStiDeviceControl, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteData(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawReadCommand(self: *const IStiDeviceControl, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadCommand(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteCommand(self: *const IStiDeviceControl, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteCommand(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawDeviceControl(self: *const IStiDeviceControl, EscapeFunction: u32, lpInData: ?*anyopaque, cbInDataSize: u32, pOutData: ?*anyopaque, dwOutDataSize: u32, pdwActualData: ?*u32) HRESULT {
        return self.vtable.RawDeviceControl(self, EscapeFunction, lpInData, cbInDataSize, pOutData, dwOutDataSize, pdwActualData);
    }
    pub inline fn GetLastError(self: *const IStiDeviceControl, lpdwLastError: ?*u32) HRESULT {
        return self.vtable.GetLastError(self, lpdwLastError);
    }
    pub inline fn GetMyDevicePortName(self: *const IStiDeviceControl, lpszDevicePath: [*:0]u16, cwDevicePathSize: u32) HRESULT {
        return self.vtable.GetMyDevicePortName(self, lpszDevicePath, cwDevicePathSize);
    }
    pub inline fn GetMyDeviceHandle(self: *const IStiDeviceControl, lph: ?*?HANDLE) HRESULT {
        return self.vtable.GetMyDeviceHandle(self, lph);
    }
    pub inline fn GetMyDeviceOpenMode(self: *const IStiDeviceControl, pdwOpenMode: ?*u32) HRESULT {
        return self.vtable.GetMyDeviceOpenMode(self, pdwOpenMode);
    }
    pub inline fn WriteToErrorLog(self: *const IStiDeviceControl, dwMessageType: u32, pszMessage: ?[*:0]const u16, dwErrorCode: u32) HRESULT {
...
pub const IStiUSD = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IStiUSD, pHelDcb: ?*IStiDeviceControl, dwStiVersion: u32, hParametersKey: ?HKEY) HRESULT {
        return self.vtable.Initialize(self, pHelDcb, dwStiVersion, hParametersKey);
    }
    pub inline fn GetCapabilities(self: *const IStiUSD, pDevCaps: ?*STI_USD_CAPS) HRESULT {
        return self.vtable.GetCapabilities(self, pDevCaps);
    }
    pub inline fn GetStatus(self: *const IStiUSD, pDevStatus: ?*STI_DEVICE_STATUS) HRESULT {
        return self.vtable.GetStatus(self, pDevStatus);
    }
    pub inline fn DeviceReset(self: *const IStiUSD) HRESULT {
        return self.vtable.DeviceReset(self);
    }
    pub inline fn Diagnostic(self: *const IStiUSD, pBuffer: ?*STI_DIAG) HRESULT {
        return self.vtable.Diagnostic(self, pBuffer);
    }
    pub inline fn Escape(self: *const IStiUSD, EscapeFunction: u32, lpInData: ?*anyopaque, cbInDataSize: u32, pOutData: ?*anyopaque, cbOutDataSize: u32, pdwActualData: ?*u32) HRESULT {
        return self.vtable.Escape(self, EscapeFunction, lpInData, cbInDataSize, pOutData, cbOutDataSize, pdwActualData);
    }
    pub inline fn GetLastError(self: *const IStiUSD, pdwLastDeviceError: ?*u32) HRESULT {
        return self.vtable.GetLastError(self, pdwLastDeviceError);
    }
    pub inline fn LockDevice(self: *const IStiUSD) HRESULT {
        return self.vtable.LockDevice(self);
    }
    pub inline fn UnLockDevice(self: *const IStiUSD) HRESULT {
        return self.vtable.UnLockDevice(self);
    }
    pub inline fn RawReadData(self: *const IStiUSD, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadData(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteData(self: *const IStiUSD, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteData(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawReadCommand(self: *const IStiUSD, lpBuffer: ?*anyopaque, lpdwNumberOfBytes: ?*u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawReadCommand(self, lpBuffer, lpdwNumberOfBytes, lpOverlapped);
    }
    pub inline fn RawWriteCommand(self: *const IStiUSD, lpBuffer: ?*anyopaque, nNumberOfBytes: u32, lpOverlapped: ?*OVERLAPPED) HRESULT {
        return self.vtable.RawWriteCommand(self, lpBuffer, nNumberOfBytes, lpOverlapped);
    }
    pub inline fn SetNotificationHandle(self: *const IStiUSD, hEvent: ?HANDLE) HRESULT {
        return self.vtable.SetNotificationHandle(self, hEvent);
    }
    pub inline fn GetNotificationData(self: *const IStiUSD, lpNotify: ?*STINOTIFY) HRESULT {
        return self.vtable.GetNotificationData(self, lpNotify);
    }
    pub inline fn GetLastErrorInfo(self: *const IStiUSD, pLastErrorInfo: ?*_ERROR_INFOW) HRESULT {
        return self.vtable.GetLastErrorInfo(self, pLastErrorInfo);
    }
};
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "fxsutility" fn CanSendToFaxRecipient() callconv(.winapi) BOOL;
