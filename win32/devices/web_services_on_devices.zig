...
pub const IWSDAddress = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Serialize(self: *const IWSDAddress, pszBuffer: [*:0]u16, cchLength: u32, fSafe: BOOL) HRESULT {
        return self.vtable.Serialize(self, pszBuffer, cchLength, fSafe);
    }
    pub inline fn Deserialize(self: *const IWSDAddress, pszBuffer: ?[*:0]const u16) HRESULT {
...
pub const IWSDTransportAddress = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetPort(self: *const IWSDTransportAddress, pwPort: ?*u16) HRESULT {
        return self.vtable.GetPort(self, pwPort);
    }
    pub inline fn SetPort(self: *const IWSDTransportAddress, wPort: u16) HRESULT {
        return self.vtable.SetPort(self, wPort);
    }
    pub inline fn GetTransportAddress(self: *const IWSDTransportAddress, ppszAddress: ?*?PWSTR) HRESULT {
        return self.vtable.GetTransportAddress(self, ppszAddress);
    }
    pub inline fn GetTransportAddressEx(self: *const IWSDTransportAddress, fSafe: BOOL, ppszAddress: ?*?PWSTR) HRESULT {
        return self.vtable.GetTransportAddressEx(self, fSafe, ppszAddress);
    }
    pub inline fn SetTransportAddress(self: *const IWSDTransportAddress, pszAddress: ?[*:0]const u16) HRESULT {
...
pub const IWSDMessageParameters = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetLocalAddress(self: *const IWSDMessageParameters, ppAddress: ?*?*IWSDAddress) HRESULT {
        return self.vtable.GetLocalAddress(self, ppAddress);
    }
    pub inline fn SetLocalAddress(self: *const IWSDMessageParameters, pAddress: ?*IWSDAddress) HRESULT {
        return self.vtable.SetLocalAddress(self, pAddress);
    }
    pub inline fn GetRemoteAddress(self: *const IWSDMessageParameters, ppAddress: ?*?*IWSDAddress) HRESULT {
        return self.vtable.GetRemoteAddress(self, ppAddress);
    }
    pub inline fn SetRemoteAddress(self: *const IWSDMessageParameters, pAddress: ?*IWSDAddress) HRESULT {
        return self.vtable.SetRemoteAddress(self, pAddress);
    }
    pub inline fn GetLowerParameters(self: *const IWSDMessageParameters, ppTxParams: ?*?*IWSDMessageParameters) HRESULT {
...
pub const IWSDUdpMessageParameters = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetRetransmitParams(self: *const IWSDUdpMessageParameters, pParams: ?*const WSDUdpRetransmitParams) HRESULT {
        return self.vtable.SetRetransmitParams(self, pParams);
    }
    pub inline fn GetRetransmitParams(self: *const IWSDUdpMessageParameters, pParams: ?*WSDUdpRetransmitParams) HRESULT {
...
pub const IWSDUdpAddress = extern union {
    ...
    IWSDAddress: IWSDAddress,
    IUnknown: IUnknown,
    pub inline fn SetSockaddr(self: *const IWSDUdpAddress, pSockAddr: ?*const SOCKADDR_STORAGE) HRESULT {
        return self.vtable.SetSockaddr(self, pSockAddr);
    }
    pub inline fn GetSockaddr(self: *const IWSDUdpAddress, pSockAddr: ?*SOCKADDR_STORAGE) HRESULT {
        return self.vtable.GetSockaddr(self, pSockAddr);
    }
    pub inline fn SetExclusive(self: *const IWSDUdpAddress, fExclusive: BOOL) HRESULT {
        return self.vtable.SetExclusive(self, fExclusive);
    }
    pub inline fn GetExclusive(self: *const IWSDUdpAddress) HRESULT {
        return self.vtable.GetExclusive(self);
    }
    pub inline fn SetMessageType(self: *const IWSDUdpAddress, messageType: WSDUdpMessageType) HRESULT {
        return self.vtable.SetMessageType(self, messageType);
    }
    pub inline fn GetMessageType(self: *const IWSDUdpAddress, pMessageType: ?*WSDUdpMessageType) HRESULT {
        return self.vtable.GetMessageType(self, pMessageType);
    }
    pub inline fn SetTTL(self: *const IWSDUdpAddress, dwTTL: u32) HRESULT {
        return self.vtable.SetTTL(self, dwTTL);
    }
    pub inline fn GetTTL(self: *const IWSDUdpAddress, pdwTTL: ?*u32) HRESULT {
        return self.vtable.GetTTL(self, pdwTTL);
    }
    pub inline fn SetAlias(self: *const IWSDUdpAddress, pAlias: ?*const Guid) HRESULT {
        return self.vtable.SetAlias(self, pAlias);
    }
    pub inline fn GetAlias(self: *const IWSDUdpAddress, pAlias: ?*Guid) HRESULT {
...
pub const IWSDHttpMessageParameters = extern union {
    ...
    IWSDMessageParameters: IWSDMessageParameters,
    IUnknown: IUnknown,
    pub inline fn SetInboundHttpHeaders(self: *const IWSDHttpMessageParameters, pszHeaders: ?[*:0]const u16) HRESULT {
        return self.vtable.SetInboundHttpHeaders(self, pszHeaders);
    }
    pub inline fn GetInboundHttpHeaders(self: *const IWSDHttpMessageParameters, ppszHeaders: ?*?PWSTR) HRESULT {
        return self.vtable.GetInboundHttpHeaders(self, ppszHeaders);
    }
    pub inline fn SetOutboundHttpHeaders(self: *const IWSDHttpMessageParameters, pszHeaders: ?[*:0]const u16) HRESULT {
        return self.vtable.SetOutboundHttpHeaders(self, pszHeaders);
    }
    pub inline fn GetOutboundHttpHeaders(self: *const IWSDHttpMessageParameters, ppszHeaders: ?*?PWSTR) HRESULT {
        return self.vtable.GetOutboundHttpHeaders(self, ppszHeaders);
    }
    pub inline fn SetID(self: *const IWSDHttpMessageParameters, pszId: ?[*:0]const u16) HRESULT {
        return self.vtable.SetID(self, pszId);
    }
    pub inline fn GetID(self: *const IWSDHttpMessageParameters, ppszId: ?*?PWSTR) HRESULT {
        return self.vtable.GetID(self, ppszId);
    }
    pub inline fn SetContext(self: *const IWSDHttpMessageParameters, pContext: ?*IUnknown) HRESULT {
        return self.vtable.SetContext(self, pContext);
    }
    pub inline fn GetContext(self: *const IWSDHttpMessageParameters, ppContext: ?*?*IUnknown) HRESULT {
        return self.vtable.GetContext(self, ppContext);
    }
    pub inline fn Clear(self: *const IWSDHttpMessageParameters) HRESULT {
...
pub const IWSDHttpAddress = extern union {
    ...
    IWSDAddress: IWSDAddress,
    IUnknown: IUnknown,
    pub inline fn GetSecure(self: *const IWSDHttpAddress) HRESULT {
        return self.vtable.GetSecure(self);
    }
    pub inline fn SetSecure(self: *const IWSDHttpAddress, fSecure: BOOL) HRESULT {
        return self.vtable.SetSecure(self, fSecure);
    }
    pub inline fn GetPath(self: *const IWSDHttpAddress, ppszPath: ?*?PWSTR) HRESULT {
        return self.vtable.GetPath(self, ppszPath);
    }
    pub inline fn SetPath(self: *const IWSDHttpAddress, pszPath: ?[*:0]const u16) HRESULT {
...
pub const IWSDSSLClientCertificate = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetClientCertificate(self: *const IWSDSSLClientCertificate, ppCertContext: ?*?*CERT_CONTEXT) HRESULT {
        return self.vtable.GetClientCertificate(self, ppCertContext);
    }
    pub inline fn GetMappedAccessToken(self: *const IWSDSSLClientCertificate, phToken: ?*?HANDLE) HRESULT {
...
pub const IWSDHttpAuthParameters = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetClientAccessToken(self: *const IWSDHttpAuthParameters, phToken: ?*?HANDLE) HRESULT {
        return self.vtable.GetClientAccessToken(self, phToken);
    }
    pub inline fn GetAuthType(self: *const IWSDHttpAuthParameters, pAuthType: ?*u32) HRESULT {
...
pub const IWSDSignatureProperty = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsMessageSigned(self: *const IWSDSignatureProperty, pbSigned: ?*BOOL) HRESULT {
        return self.vtable.IsMessageSigned(self, pbSigned);
    }
    pub inline fn IsMessageSignatureTrusted(self: *const IWSDSignatureProperty, pbSignatureTrusted: ?*BOOL) HRESULT {
        return self.vtable.IsMessageSignatureTrusted(self, pbSignatureTrusted);
    }
    pub inline fn GetKeyInfo(self: *const IWSDSignatureProperty, pbKeyInfo: ?*u8, pdwKeyInfoSize: ?*u32) HRESULT {
        return self.vtable.GetKeyInfo(self, pbKeyInfo, pdwKeyInfoSize);
    }
    pub inline fn GetSignature(self: *const IWSDSignatureProperty, pbSignature: ?*u8, pdwSignatureSize: ?*u32) HRESULT {
        return self.vtable.GetSignature(self, pbSignature, pdwSignatureSize);
    }
    pub inline fn GetSignedInfoHash(self: *const IWSDSignatureProperty, pbSignedInfoHash: ?*u8, pdwHashSize: ?*u32) HRESULT {
...
pub const IWSDOutboundAttachment = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Write(self: *const IWSDOutboundAttachment, pBuffer: [*:0]const u8, dwBytesToWrite: u32, pdwNumberOfBytesWritten: ?*u32) HRESULT {
        return self.vtable.Write(self, pBuffer, dwBytesToWrite, pdwNumberOfBytesWritten);
    }
    pub inline fn Close(self: *const IWSDOutboundAttachment) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn Abort(self: *const IWSDOutboundAttachment) HRESULT {
...
pub const IWSDInboundAttachment = extern union {
    ...
    IWSDAttachment: IWSDAttachment,
    IUnknown: IUnknown,
    pub inline fn Read(self: *const IWSDInboundAttachment, pBuffer: [*:0]u8, dwBytesToRead: u32, pdwNumberOfBytesRead: ?*u32) HRESULT {
        return self.vtable.Read(self, pBuffer, dwBytesToRead, pdwNumberOfBytesRead);
    }
    pub inline fn Close(self: *const IWSDInboundAttachment) HRESULT {
        return self.vtable.Close(self);
    }
};
...
pub const IWSDXMLContext = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddNamespace(self: *const IWSDXMLContext, pszUri: ?[*:0]const u16, pszSuggestedPrefix: ?[*:0]const u16, ppNamespace: ?*?*WSDXML_NAMESPACE) HRESULT {
        return self.vtable.AddNamespace(self, pszUri, pszSuggestedPrefix, ppNamespace);
    }
    pub inline fn AddNameToNamespace(self: *const IWSDXMLContext, pszUri: ?[*:0]const u16, pszName: ?[*:0]const u16, ppName: ?*?*WSDXML_NAME) HRESULT {
        return self.vtable.AddNameToNamespace(self, pszUri, pszName, ppName);
    }
    pub inline fn SetNamespaces(self: *const IWSDXMLContext, pNamespaces: [*]const ?*const WSDXML_NAMESPACE, wNamespacesCount: u16, bLayerNumber: u8) HRESULT {
        return self.vtable.SetNamespaces(self, pNamespaces, wNamespacesCount, bLayerNumber);
    }
    pub inline fn SetTypes(self: *const IWSDXMLContext, pTypes: [*]const ?*const WSDXML_TYPE, dwTypesCount: u32, bLayerNumber: u8) HRESULT {
...
pub const IWSDiscoveryProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetAddressFamily(self: *const IWSDiscoveryProvider, dwAddressFamily: u32) HRESULT {
        return self.vtable.SetAddressFamily(self, dwAddressFamily);
    }
    pub inline fn Attach(self: *const IWSDiscoveryProvider, pSink: ?*IWSDiscoveryProviderNotify) HRESULT {
        return self.vtable.Attach(self, pSink);
    }
    pub inline fn Detach(self: *const IWSDiscoveryProvider) HRESULT {
        return self.vtable.Detach(self);
    }
    pub inline fn SearchById(self: *const IWSDiscoveryProvider, pszId: ?[*:0]const u16, pszTag: ?[*:0]const u16) HRESULT {
        return self.vtable.SearchById(self, pszId, pszTag);
    }
    pub inline fn SearchByAddress(self: *const IWSDiscoveryProvider, pszAddress: ?[*:0]const u16, pszTag: ?[*:0]const u16) HRESULT {
        return self.vtable.SearchByAddress(self, pszAddress, pszTag);
    }
    pub inline fn SearchByType(self: *const IWSDiscoveryProvider, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pszMatchBy: ?[*:0]const u16, pszTag: ?[*:0]const u16) HRESULT {
        return self.vtable.SearchByType(self, pTypesList, pScopesList, pszMatchBy, pszTag);
    }
    pub inline fn GetXMLContext(self: *const IWSDiscoveryProvider, ppContext: ?*?*IWSDXMLContext) HRESULT {
...
pub const IWSDiscoveryProviderNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Add(self: *const IWSDiscoveryProviderNotify, pService: ?*IWSDiscoveredService) HRESULT {
        return self.vtable.Add(self, pService);
    }
    pub inline fn Remove(self: *const IWSDiscoveryProviderNotify, pService: ?*IWSDiscoveredService) HRESULT {
        return self.vtable.Remove(self, pService);
    }
    pub inline fn SearchFailed(self: *const IWSDiscoveryProviderNotify, hr: HRESULT, pszTag: ?[*:0]const u16) HRESULT {
        return self.vtable.SearchFailed(self, hr, pszTag);
    }
    pub inline fn SearchComplete(self: *const IWSDiscoveryProviderNotify, pszTag: ?[*:0]const u16) HRESULT {
...
pub const IWSDiscoveredService = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetEndpointReference(self: *const IWSDiscoveredService, ppEndpointReference: ?*?*WSD_ENDPOINT_REFERENCE) HRESULT {
        return self.vtable.GetEndpointReference(self, ppEndpointReference);
    }
    pub inline fn GetTypes(self: *const IWSDiscoveredService, ppTypesList: ?*?*WSD_NAME_LIST) HRESULT {
        return self.vtable.GetTypes(self, ppTypesList);
    }
    pub inline fn GetScopes(self: *const IWSDiscoveredService, ppScopesList: ?*?*WSD_URI_LIST) HRESULT {
        return self.vtable.GetScopes(self, ppScopesList);
    }
    pub inline fn GetXAddrs(self: *const IWSDiscoveredService, ppXAddrsList: ?*?*WSD_URI_LIST) HRESULT {
        return self.vtable.GetXAddrs(self, ppXAddrsList);
    }
    pub inline fn GetMetadataVersion(self: *const IWSDiscoveredService, pullMetadataVersion: ?*u64) HRESULT {
        return self.vtable.GetMetadataVersion(self, pullMetadataVersion);
    }
    pub inline fn GetExtendedDiscoXML(self: *const IWSDiscoveredService, ppHeaderAny: ?*?*WSDXML_ELEMENT, ppBodyAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.GetExtendedDiscoXML(self, ppHeaderAny, ppBodyAny);
    }
    pub inline fn GetProbeResolveTag(self: *const IWSDiscoveredService, ppszTag: ?*?PWSTR) HRESULT {
        return self.vtable.GetProbeResolveTag(self, ppszTag);
    }
    pub inline fn GetRemoteTransportAddress(self: *const IWSDiscoveredService, ppszRemoteTransportAddress: ?*?PWSTR) HRESULT {
        return self.vtable.GetRemoteTransportAddress(self, ppszRemoteTransportAddress);
    }
    pub inline fn GetLocalTransportAddress(self: *const IWSDiscoveredService, ppszLocalTransportAddress: ?*?PWSTR) HRESULT {
        return self.vtable.GetLocalTransportAddress(self, ppszLocalTransportAddress);
    }
    pub inline fn GetLocalInterfaceGUID(self: *const IWSDiscoveredService, pGuid: ?*Guid) HRESULT {
        return self.vtable.GetLocalInterfaceGUID(self, pGuid);
    }
    pub inline fn GetInstanceId(self: *const IWSDiscoveredService, pullInstanceId: ?*u64) HRESULT {
...
pub const IWSDiscoveryPublisher = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetAddressFamily(self: *const IWSDiscoveryPublisher, dwAddressFamily: u32) HRESULT {
        return self.vtable.SetAddressFamily(self, dwAddressFamily);
    }
    pub inline fn RegisterNotificationSink(self: *const IWSDiscoveryPublisher, pSink: ?*IWSDiscoveryPublisherNotify) HRESULT {
        return self.vtable.RegisterNotificationSink(self, pSink);
    }
    pub inline fn UnRegisterNotificationSink(self: *const IWSDiscoveryPublisher, pSink: ?*IWSDiscoveryPublisherNotify) HRESULT {
        return self.vtable.UnRegisterNotificationSink(self, pSink);
    }
    pub inline fn Publish(self: *const IWSDiscoveryPublisher, pszId: ?[*:0]const u16, ullMetadataVersion: u64, ullInstanceId: u64, ullMessageNumber: u64, pszSessionId: ?[*:0]const u16, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pXAddrsList: ?*const WSD_URI_LIST) HRESULT {
    ...
    pub inline fn MatchResolve(self: *const IWSDiscoveryPublisher, pResolveMessage: ?*const WSD_SOAP_MESSAGE, pMessageParameters: ?*IWSDMessageParameters, pszId: ?[*:0]const u16, ullMetadataVersion: u64, ullInstanceId: u64, ullMessageNumber: u64, pszSessionId: ?[*:0]const u16, pTypesList: ?*const WSD_NAME_LIST, pScopesList: ?*const WSD_URI_LIST, pXAddrsList: ?*const WSD_URI_LIST) HRESULT {
    ...
    pub inline fn RegisterScopeMatchingRule(self: *const IWSDiscoveryPublisher, pScopeMatchingRule: ?*IWSDScopeMatchingRule) HRESULT {
        return self.vtable.RegisterScopeMatchingRule(self, pScopeMatchingRule);
    }
    pub inline fn UnRegisterScopeMatchingRule(self: *const IWSDiscoveryPublisher, pScopeMatchingRule: ?*IWSDScopeMatchingRule) HRESULT {
        return self.vtable.UnRegisterScopeMatchingRule(self, pScopeMatchingRule);
    }
    pub inline fn GetXMLContext(self: *const IWSDiscoveryPublisher, ppContext: ?*?*IWSDXMLContext) HRESULT {
        return self.vtable.GetXMLContext(self, ppContext);
    }
};
...
pub const IWSDiscoveryPublisherNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ProbeHandler(self: *const IWSDiscoveryPublisherNotify, pSoap: ?*const WSD_SOAP_MESSAGE, pMessageParameters: ?*IWSDMessageParameters) HRESULT {
        return self.vtable.ProbeHandler(self, pSoap, pMessageParameters);
    }
    pub inline fn ResolveHandler(self: *const IWSDiscoveryPublisherNotify, pSoap: ?*const WSD_SOAP_MESSAGE, pMessageParameters: ?*IWSDMessageParameters) HRESULT {
...
pub const IWSDScopeMatchingRule = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetScopeRule(self: *const IWSDScopeMatchingRule, ppszScopeMatchingRule: ?*?PWSTR) HRESULT {
        return self.vtable.GetScopeRule(self, ppszScopeMatchingRule);
    }
    pub inline fn MatchScopes(self: *const IWSDScopeMatchingRule, pszScope1: ?[*:0]const u16, pszScope2: ?[*:0]const u16, pfMatch: ?*BOOL) HRESULT {
...
pub const IWSDEndpointProxy = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SendOneWayRequest(self: *const IWSDEndpointProxy, pBody: ?*const anyopaque, pOperation: ?*const WSD_OPERATION) HRESULT {
        return self.vtable.SendOneWayRequest(self, pBody, pOperation);
    }
    pub inline fn SendTwoWayRequest(self: *const IWSDEndpointProxy, pBody: ?*const anyopaque, pOperation: ?*const WSD_OPERATION, pResponseContext: ?*const WSD_SYNCHRONOUS_RESPONSE_CONTEXT) HRESULT {
        return self.vtable.SendTwoWayRequest(self, pBody, pOperation, pResponseContext);
    }
    pub inline fn SendTwoWayRequestAsync(self: *const IWSDEndpointProxy, pBody: ?*const anyopaque, pOperation: ?*const WSD_OPERATION, pAsyncState: ?*IUnknown, pCallback: ?*IWSDAsyncCallback, pResult: ?*?*IWSDAsyncResult) HRESULT {
        return self.vtable.SendTwoWayRequestAsync(self, pBody, pOperation, pAsyncState, pCallback, pResult);
    }
    pub inline fn AbortAsyncOperation(self: *const IWSDEndpointProxy, pAsyncResult: ?*IWSDAsyncResult) HRESULT {
        return self.vtable.AbortAsyncOperation(self, pAsyncResult);
    }
    pub inline fn ProcessFault(self: *const IWSDEndpointProxy, pFault: ?*const WSD_SOAP_FAULT) HRESULT {
        return self.vtable.ProcessFault(self, pFault);
    }
    pub inline fn GetErrorInfo(self: *const IWSDEndpointProxy, ppszErrorInfo: ?*?PWSTR) HRESULT {
        return self.vtable.GetErrorInfo(self, ppszErrorInfo);
    }
    pub inline fn GetFaultInfo(self: *const IWSDEndpointProxy, ppFault: ?*?*WSD_SOAP_FAULT) HRESULT {
...
pub const IWSDMetadataExchange = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetMetadata(self: *const IWSDMetadataExchange, MetadataOut: ?*?*WSD_METADATA_SECTION_LIST) HRESULT {
...
pub const IWSDServiceProxy = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn BeginGetMetadata(self: *const IWSDServiceProxy, ppResult: ?*?*IWSDAsyncResult) HRESULT {
        return self.vtable.BeginGetMetadata(self, ppResult);
    }
    pub inline fn EndGetMetadata(self: *const IWSDServiceProxy, pResult: ?*IWSDAsyncResult, ppMetadata: ?*?*WSD_METADATA_SECTION_LIST) HRESULT {
        return self.vtable.EndGetMetadata(self, pResult, ppMetadata);
    }
    pub inline fn GetServiceMetadata(self: *const IWSDServiceProxy, ppServiceMetadata: ?*?*WSD_SERVICE_METADATA) HRESULT {
        return self.vtable.GetServiceMetadata(self, ppServiceMetadata);
    }
    pub inline fn SubscribeToOperation(self: *const IWSDServiceProxy, pOperation: ?*const WSD_OPERATION, pUnknown: ?*IUnknown, pAny: ?*const WSDXML_ELEMENT, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.SubscribeToOperation(self, pOperation, pUnknown, pAny, ppAny);
    }
    pub inline fn UnsubscribeToOperation(self: *const IWSDServiceProxy, pOperation: ?*const WSD_OPERATION) HRESULT {
        return self.vtable.UnsubscribeToOperation(self, pOperation);
    }
    pub inline fn SetEventingStatusCallback(self: *const IWSDServiceProxy, pStatus: ?*IWSDEventingStatus) HRESULT {
        return self.vtable.SetEventingStatusCallback(self, pStatus);
    }
    pub inline fn GetEndpointProxy(self: *const IWSDServiceProxy, ppProxy: ?*?*IWSDEndpointProxy) HRESULT {
...
pub const IWSDServiceProxyEventing = extern union {
    ...
    IWSDMetadataExchange: IWSDMetadataExchange,
    IUnknown: IUnknown,
    pub inline fn SubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pUnknown: ?*IUnknown, pExpires: ?*const WSD_EVENTING_EXPIRES, pAny: ?*const WSDXML_ELEMENT, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
    ...
    pub inline fn BeginSubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pUnknown: ?*IUnknown, pExpires: ?*const WSD_EVENTING_EXPIRES, pAny: ?*const WSDXML_ELEMENT, pAsyncState: ?*IUnknown, pAsyncCallback: ?*IWSDAsyncCallback, ppResult: ?*?*IWSDAsyncResult) HRESULT {
    ...
    pub inline fn EndSubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pResult: ?*IWSDAsyncResult, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.EndSubscribeToMultipleOperations(self, pOperations, dwOperationCount, pResult, ppExpires, ppAny);
    }
    pub inline fn UnsubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pAny: ?*const WSDXML_ELEMENT) HRESULT {
        return self.vtable.UnsubscribeToMultipleOperations(self, pOperations, dwOperationCount, pAny);
    }
    pub inline fn BeginUnsubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pAny: ?*const WSDXML_ELEMENT, pAsyncState: ?*IUnknown, pAsyncCallback: ?*IWSDAsyncCallback, ppResult: ?*?*IWSDAsyncResult) HRESULT {
    ...
    pub inline fn EndUnsubscribeToMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pResult: ?*IWSDAsyncResult) HRESULT {
        return self.vtable.EndUnsubscribeToMultipleOperations(self, pOperations, dwOperationCount, pResult);
    }
    pub inline fn RenewMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pExpires: ?*const WSD_EVENTING_EXPIRES, pAny: ?*const WSDXML_ELEMENT, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.RenewMultipleOperations(self, pOperations, dwOperationCount, pExpires, pAny, ppExpires, ppAny);
    }
    pub inline fn BeginRenewMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pExpires: ?*const WSD_EVENTING_EXPIRES, pAny: ?*const WSDXML_ELEMENT, pAsyncState: ?*IUnknown, pAsyncCallback: ?*IWSDAsyncCallback, ppResult: ?*?*IWSDAsyncResult) HRESULT {
    ...
    pub inline fn EndRenewMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pResult: ?*IWSDAsyncResult, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.EndRenewMultipleOperations(self, pOperations, dwOperationCount, pResult, ppExpires, ppAny);
    }
    pub inline fn GetStatusForMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pAny: ?*const WSDXML_ELEMENT, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
        return self.vtable.GetStatusForMultipleOperations(self, pOperations, dwOperationCount, pAny, ppExpires, ppAny);
    }
    pub inline fn BeginGetStatusForMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pAny: ?*const WSDXML_ELEMENT, pAsyncState: ?*IUnknown, pAsyncCallback: ?*IWSDAsyncCallback, ppResult: ?*?*IWSDAsyncResult) HRESULT {
    ...
    pub inline fn EndGetStatusForMultipleOperations(self: *const IWSDServiceProxyEventing, pOperations: [*]const WSD_OPERATION, dwOperationCount: u32, pResult: ?*IWSDAsyncResult, ppExpires: ?*?*WSD_EVENTING_EXPIRES, ppAny: ?*?*WSDXML_ELEMENT) HRESULT {
...
pub const IWSDDeviceProxy = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const IWSDDeviceProxy, pszDeviceId: ?[*:0]const u16, pDeviceAddress: ?*IWSDAddress, pszLocalId: ?[*:0]const u16, pContext: ?*IWSDXMLContext, pSponsor: ?*IWSDDeviceProxy) HRESULT {
        return self.vtable.Init(self, pszDeviceId, pDeviceAddress, pszLocalId, pContext, pSponsor);
    }
    pub inline fn BeginGetMetadata(self: *const IWSDDeviceProxy, ppResult: ?*?*IWSDAsyncResult) HRESULT {
        return self.vtable.BeginGetMetadata(self, ppResult);
    }
    pub inline fn EndGetMetadata(self: *const IWSDDeviceProxy, pResult: ?*IWSDAsyncResult) HRESULT {
        return self.vtable.EndGetMetadata(self, pResult);
    }
    pub inline fn GetHostMetadata(self: *const IWSDDeviceProxy, ppHostMetadata: ?*?*WSD_HOST_METADATA) HRESULT {
        return self.vtable.GetHostMetadata(self, ppHostMetadata);
    }
    pub inline fn GetThisModelMetadata(self: *const IWSDDeviceProxy, ppManufacturerMetadata: ?*?*WSD_THIS_MODEL_METADATA) HRESULT {
        return self.vtable.GetThisModelMetadata(self, ppManufacturerMetadata);
    }
    pub inline fn GetThisDeviceMetadata(self: *const IWSDDeviceProxy, ppThisDeviceMetadata: ?*?*WSD_THIS_DEVICE_METADATA) HRESULT {
        return self.vtable.GetThisDeviceMetadata(self, ppThisDeviceMetadata);
    }
    pub inline fn GetAllMetadata(self: *const IWSDDeviceProxy, ppMetadata: ?*?*WSD_METADATA_SECTION_LIST) HRESULT {
        return self.vtable.GetAllMetadata(self, ppMetadata);
    }
    pub inline fn GetServiceProxyById(self: *const IWSDDeviceProxy, pszServiceId: ?[*:0]const u16, ppServiceProxy: ?*?*IWSDServiceProxy) HRESULT {
        return self.vtable.GetServiceProxyById(self, pszServiceId, ppServiceProxy);
    }
    pub inline fn GetServiceProxyByType(self: *const IWSDDeviceProxy, pType: ?*const WSDXML_NAME, ppServiceProxy: ?*?*IWSDServiceProxy) HRESULT {
        return self.vtable.GetServiceProxyByType(self, pType, ppServiceProxy);
    }
    pub inline fn GetEndpointProxy(self: *const IWSDDeviceProxy, ppProxy: ?*?*IWSDEndpointProxy) HRESULT {
        return self.vtable.GetEndpointProxy(self, ppProxy);
    }
};
...
pub const IWSDAsyncResult = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetCallback(self: *const IWSDAsyncResult, pCallback: ?*IWSDAsyncCallback, pAsyncState: ?*IUnknown) HRESULT {
        return self.vtable.SetCallback(self, pCallback, pAsyncState);
    }
    pub inline fn SetWaitHandle(self: *const IWSDAsyncResult, hWaitHandle: ?HANDLE) HRESULT {
        return self.vtable.SetWaitHandle(self, hWaitHandle);
    }
    pub inline fn HasCompleted(self: *const IWSDAsyncResult) HRESULT {
        return self.vtable.HasCompleted(self);
    }
    pub inline fn GetAsyncState(self: *const IWSDAsyncResult, ppAsyncState: ?*?*IUnknown) HRESULT {
        return self.vtable.GetAsyncState(self, ppAsyncState);
    }
    pub inline fn Abort(self: *const IWSDAsyncResult) HRESULT {
        return self.vtable.Abort(self);
    }
    pub inline fn GetEvent(self: *const IWSDAsyncResult, pEvent: ?*WSD_EVENT) HRESULT {
        return self.vtable.GetEvent(self, pEvent);
    }
    pub inline fn GetEndpointProxy(self: *const IWSDAsyncResult, ppEndpoint: ?*?*IWSDEndpointProxy) HRESULT {
...
pub const IWSDAsyncCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AsyncOperationComplete(self: *const IWSDAsyncCallback, pAsyncResult: ?*IWSDAsyncResult, pAsyncState: ?*IUnknown) HRESULT {
...
pub const IWSDEventingStatus = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SubscriptionRenewed(self: *const IWSDEventingStatus, pszSubscriptionAction: ?[*:0]const u16) void {
        return self.vtable.SubscriptionRenewed(self, pszSubscriptionAction);
    }
    pub inline fn SubscriptionRenewalFailed(self: *const IWSDEventingStatus, pszSubscriptionAction: ?[*:0]const u16, hr: HRESULT) void {
        return self.vtable.SubscriptionRenewalFailed(self, pszSubscriptionAction, hr);
    }
    pub inline fn SubscriptionEnded(self: *const IWSDEventingStatus, pszSubscriptionAction: ?[*:0]const u16) void {
...
pub const IWSDDeviceHost = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const IWSDDeviceHost, pszLocalId: ?[*:0]const u16, pContext: ?*IWSDXMLContext, ppHostAddresses: ?[*]?*IWSDAddress, dwHostAddressCount: u32) HRESULT {
        return self.vtable.Init(self, pszLocalId, pContext, ppHostAddresses, dwHostAddressCount);
    }
    pub inline fn Start(self: *const IWSDDeviceHost, ullInstanceId: u64, pScopeList: ?*const WSD_URI_LIST, pNotificationSink: ?*IWSDDeviceHostNotify) HRESULT {
        return self.vtable.Start(self, ullInstanceId, pScopeList, pNotificationSink);
    }
    pub inline fn Stop(self: *const IWSDDeviceHost) HRESULT {
        return self.vtable.Stop(self);
    }
    pub inline fn Terminate(self: *const IWSDDeviceHost) HRESULT {
        return self.vtable.Terminate(self);
    }
    pub inline fn RegisterPortType(self: *const IWSDDeviceHost, pPortType: ?*const WSD_PORT_TYPE) HRESULT {
        return self.vtable.RegisterPortType(self, pPortType);
    }
    pub inline fn SetMetadata(self: *const IWSDDeviceHost, pThisModelMetadata: ?*const WSD_THIS_MODEL_METADATA, pThisDeviceMetadata: ?*const WSD_THIS_DEVICE_METADATA, pHostMetadata: ?*const WSD_HOST_METADATA, pCustomMetadata: ?*const WSD_METADATA_SECTION_LIST) HRESULT {
        return self.vtable.SetMetadata(self, pThisModelMetadata, pThisDeviceMetadata, pHostMetadata, pCustomMetadata);
    }
    pub inline fn RegisterService(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16, pService: ?*IUnknown) HRESULT {
        return self.vtable.RegisterService(self, pszServiceId, pService);
    }
    pub inline fn RetireService(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16) HRESULT {
        return self.vtable.RetireService(self, pszServiceId);
    }
    pub inline fn AddDynamicService(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16, pszEndpointAddress: ?[*:0]const u16, pPortType: ?*const WSD_PORT_TYPE, pPortName: ?*const WSDXML_NAME, pAny: ?*const WSDXML_ELEMENT, pService: ?*IUnknown) HRESULT {
        return self.vtable.AddDynamicService(self, pszServiceId, pszEndpointAddress, pPortType, pPortName, pAny, pService);
    }
    pub inline fn RemoveDynamicService(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16) HRESULT {
        return self.vtable.RemoveDynamicService(self, pszServiceId);
    }
    pub inline fn SetServiceDiscoverable(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16, fDiscoverable: BOOL) HRESULT {
        return self.vtable.SetServiceDiscoverable(self, pszServiceId, fDiscoverable);
    }
    pub inline fn SignalEvent(self: *const IWSDDeviceHost, pszServiceId: ?[*:0]const u16, pBody: ?*const anyopaque, pOperation: ?*const WSD_OPERATION) HRESULT {
...
pub const IWSDDeviceHostNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetService(self: *const IWSDDeviceHostNotify, pszServiceId: ?[*:0]const u16, ppService: ?*?*IUnknown) HRESULT {
...
pub const IWSDServiceMessaging = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SendResponse(self: *const IWSDServiceMessaging, pBody: ?*anyopaque, pOperation: ?*WSD_OPERATION, pMessageParameters: ?*IWSDMessageParameters) HRESULT {
        return self.vtable.SendResponse(self, pBody, pOperation, pMessageParameters);
    }
    pub inline fn FaultRequest(self: *const IWSDServiceMessaging, pRequestHeader: ?*WSD_SOAP_HEADER, pMessageParameters: ?*IWSDMessageParameters, pFault: ?*WSD_SOAP_FAULT) HRESULT {
