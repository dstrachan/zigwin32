...
pub const ILocationReport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSensorID(self: *const ILocationReport, pSensorID: ?*Guid) HRESULT {
        return self.vtable.GetSensorID(self, pSensorID);
    }
    pub inline fn GetTimestamp(self: *const ILocationReport, pCreationTime: ?*SYSTEMTIME) HRESULT {
        return self.vtable.GetTimestamp(self, pCreationTime);
    }
    pub inline fn GetValue(self: *const ILocationReport, pKey: ?*const PROPERTYKEY, pValue: ?*PROPVARIANT) HRESULT {
...
pub const ILatLongReport = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetLatitude(self: *const ILatLongReport, pLatitude: ?*f64) HRESULT {
        return self.vtable.GetLatitude(self, pLatitude);
    }
    pub inline fn GetLongitude(self: *const ILatLongReport, pLongitude: ?*f64) HRESULT {
        return self.vtable.GetLongitude(self, pLongitude);
    }
    pub inline fn GetErrorRadius(self: *const ILatLongReport, pErrorRadius: ?*f64) HRESULT {
        return self.vtable.GetErrorRadius(self, pErrorRadius);
    }
    pub inline fn GetAltitude(self: *const ILatLongReport, pAltitude: ?*f64) HRESULT {
        return self.vtable.GetAltitude(self, pAltitude);
    }
    pub inline fn GetAltitudeError(self: *const ILatLongReport, pAltitudeError: ?*f64) HRESULT {
...
pub const ICivicAddressReport = extern union {
    ...
    ILocationReport: ILocationReport,
    IUnknown: IUnknown,
    pub inline fn GetAddressLine1(self: *const ICivicAddressReport, pbstrAddress1: ?*?BSTR) HRESULT {
        return self.vtable.GetAddressLine1(self, pbstrAddress1);
    }
    pub inline fn GetAddressLine2(self: *const ICivicAddressReport, pbstrAddress2: ?*?BSTR) HRESULT {
        return self.vtable.GetAddressLine2(self, pbstrAddress2);
    }
    pub inline fn GetCity(self: *const ICivicAddressReport, pbstrCity: ?*?BSTR) HRESULT {
        return self.vtable.GetCity(self, pbstrCity);
    }
    pub inline fn GetStateProvince(self: *const ICivicAddressReport, pbstrStateProvince: ?*?BSTR) HRESULT {
        return self.vtable.GetStateProvince(self, pbstrStateProvince);
    }
    pub inline fn GetPostalCode(self: *const ICivicAddressReport, pbstrPostalCode: ?*?BSTR) HRESULT {
        return self.vtable.GetPostalCode(self, pbstrPostalCode);
    }
    pub inline fn GetCountryRegion(self: *const ICivicAddressReport, pbstrCountryRegion: ?*?BSTR) HRESULT {
        return self.vtable.GetCountryRegion(self, pbstrCountryRegion);
    }
    pub inline fn GetDetailLevel(self: *const ICivicAddressReport, pDetailLevel: ?*u32) HRESULT {
...
pub const ILocation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RegisterForReport(self: *const ILocation, pEvents: ?*ILocationEvents, reportType: ?*const Guid, dwRequestedReportInterval: u32) HRESULT {
        return self.vtable.RegisterForReport(self, pEvents, reportType, dwRequestedReportInterval);
    }
    pub inline fn UnregisterForReport(self: *const ILocation, reportType: ?*const Guid) HRESULT {
        return self.vtable.UnregisterForReport(self, reportType);
    }
    pub inline fn GetReport(self: *const ILocation, reportType: ?*const Guid, ppLocationReport: ?*?*ILocationReport) HRESULT {
        return self.vtable.GetReport(self, reportType, ppLocationReport);
    }
    pub inline fn GetReportStatus(self: *const ILocation, reportType: ?*const Guid, pStatus: ?*LOCATION_REPORT_STATUS) HRESULT {
        return self.vtable.GetReportStatus(self, reportType, pStatus);
    }
    pub inline fn GetReportInterval(self: *const ILocation, reportType: ?*const Guid, pMilliseconds: ?*u32) HRESULT {
        return self.vtable.GetReportInterval(self, reportType, pMilliseconds);
    }
    pub inline fn SetReportInterval(self: *const ILocation, reportType: ?*const Guid, millisecondsRequested: u32) HRESULT {
        return self.vtable.SetReportInterval(self, reportType, millisecondsRequested);
    }
    pub inline fn GetDesiredAccuracy(self: *const ILocation, reportType: ?*const Guid, pDesiredAccuracy: ?*LOCATION_DESIRED_ACCURACY) HRESULT {
        return self.vtable.GetDesiredAccuracy(self, reportType, pDesiredAccuracy);
    }
    pub inline fn SetDesiredAccuracy(self: *const ILocation, reportType: ?*const Guid, desiredAccuracy: LOCATION_DESIRED_ACCURACY) HRESULT {
        return self.vtable.SetDesiredAccuracy(self, reportType, desiredAccuracy);
    }
    pub inline fn RequestPermissions(self: *const ILocation, hParent: ?HWND, pReportTypes: [*]Guid, count: u32, fModal: BOOL) HRESULT {
...
pub const ILocationPower = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Connect(self: *const ILocationPower) HRESULT {
        return self.vtable.Connect(self);
    }
    pub inline fn Disconnect(self: *const ILocationPower) HRESULT {
...
pub const IDefaultLocation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetReport(self: *const IDefaultLocation, reportType: ?*const Guid, pLocationReport: ?*ILocationReport) HRESULT {
        return self.vtable.SetReport(self, reportType, pLocationReport);
    }
    pub inline fn GetReport(self: *const IDefaultLocation, reportType: ?*const Guid, ppLocationReport: ?*?*ILocationReport) HRESULT {
        return self.vtable.GetReport(self, reportType, ppLocationReport);
    }
};
...
pub const ILocationEvents = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnLocationChanged(self: *const ILocationEvents, reportType: ?*const Guid, pLocationReport: ?*ILocationReport) HRESULT {
        return self.vtable.OnLocationChanged(self, reportType, pLocationReport);
    }
    pub inline fn OnStatusChanged(self: *const ILocationEvents, reportType: ?*const Guid, newStatus: LOCATION_REPORT_STATUS) HRESULT {
...
pub const IDispLatLongReport = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Latitude(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_Latitude(self, pVal);
    }
    pub inline fn get_Longitude(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_Longitude(self, pVal);
    }
    pub inline fn get_ErrorRadius(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_ErrorRadius(self, pVal);
    }
    pub inline fn get_Altitude(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_Altitude(self, pVal);
    }
    pub inline fn get_AltitudeError(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_AltitudeError(self, pVal);
    }
    pub inline fn get_Timestamp(self: *const IDispLatLongReport, pVal: ?*f64) HRESULT {
...
pub const IDispCivicAddressReport = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_AddressLine1(self: *const IDispCivicAddressReport, pAddress1: ?*?BSTR) HRESULT {
        return self.vtable.get_AddressLine1(self, pAddress1);
    }
    pub inline fn get_AddressLine2(self: *const IDispCivicAddressReport, pAddress2: ?*?BSTR) HRESULT {
        return self.vtable.get_AddressLine2(self, pAddress2);
    }
    pub inline fn get_City(self: *const IDispCivicAddressReport, pCity: ?*?BSTR) HRESULT {
        return self.vtable.get_City(self, pCity);
    }
    pub inline fn get_StateProvince(self: *const IDispCivicAddressReport, pStateProvince: ?*?BSTR) HRESULT {
        return self.vtable.get_StateProvince(self, pStateProvince);
    }
    pub inline fn get_PostalCode(self: *const IDispCivicAddressReport, pPostalCode: ?*?BSTR) HRESULT {
        return self.vtable.get_PostalCode(self, pPostalCode);
    }
    pub inline fn get_CountryRegion(self: *const IDispCivicAddressReport, pCountryRegion: ?*?BSTR) HRESULT {
        return self.vtable.get_CountryRegion(self, pCountryRegion);
    }
    pub inline fn get_DetailLevel(self: *const IDispCivicAddressReport, pDetailLevel: ?*u32) HRESULT {
        return self.vtable.get_DetailLevel(self, pDetailLevel);
    }
    pub inline fn get_Timestamp(self: *const IDispCivicAddressReport, pVal: ?*f64) HRESULT {
        return self.vtable.get_Timestamp(self, pVal);
    }
};
...
pub const ILocationReportFactory = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn ListenForReports(self: *const ILocationReportFactory, requestedReportInterval: u32) HRESULT {
        return self.vtable.ListenForReports(self, requestedReportInterval);
    }
    pub inline fn StopListeningForReports(self: *const ILocationReportFactory) HRESULT {
        return self.vtable.StopListeningForReports(self);
    }
    pub inline fn get_Status(self: *const ILocationReportFactory, pVal: ?*u32) HRESULT {
        return self.vtable.get_Status(self, pVal);
    }
    pub inline fn get_ReportInterval(self: *const ILocationReportFactory, pMilliseconds: ?*u32) HRESULT {
        return self.vtable.get_ReportInterval(self, pMilliseconds);
    }
    pub inline fn put_ReportInterval(self: *const ILocationReportFactory, millisecondsRequested: u32) HRESULT {
        return self.vtable.put_ReportInterval(self, millisecondsRequested);
    }
    pub inline fn get_DesiredAccuracy(self: *const ILocationReportFactory, pDesiredAccuracy: ?*u32) HRESULT {
        return self.vtable.get_DesiredAccuracy(self, pDesiredAccuracy);
    }
    pub inline fn put_DesiredAccuracy(self: *const ILocationReportFactory, desiredAccuracy: u32) HRESULT {
        return self.vtable.put_DesiredAccuracy(self, desiredAccuracy);
    }
    pub inline fn RequestPermissions(self: *const ILocationReportFactory, hWnd: ?*u32) HRESULT {
...
pub const ILatLongReportFactory = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_LatLongReport(self: *const ILatLongReportFactory, pVal: ?*?*IDispLatLongReport) HRESULT {
...
pub const ICivicAddressReportFactory = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_CivicAddressReport(self: *const ICivicAddressReportFactory, pVal: ?*?*IDispCivicAddressReport) HRESULT {
