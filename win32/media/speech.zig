...
pub const ISpNotifyCallback = extern union {
    ...
    vtable: *const VTable,
    pub inline fn NotifyCallback(self: *const ISpNotifyCallback, wParam: WPARAM, lParam: LPARAM) HRESULT {
...
pub const ISpNotifySource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetNotifySink(self: *const ISpNotifySource, pNotifySink: ?*ISpNotifySink) HRESULT {
        return self.vtable.SetNotifySink(self, pNotifySink);
    }
    pub inline fn SetNotifyWindowMessage(self: *const ISpNotifySource, hWnd: ?HWND, Msg: u32, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.SetNotifyWindowMessage(self, hWnd, Msg, wParam, lParam);
    }
    pub inline fn SetNotifyCallbackFunction(self: *const ISpNotifySource, pfnCallback: ?*?SPNOTIFYCALLBACK, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.SetNotifyCallbackFunction(self, pfnCallback, wParam, lParam);
    }
    pub inline fn SetNotifyCallbackInterface(self: *const ISpNotifySource, pSpCallback: ?*ISpNotifyCallback, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.SetNotifyCallbackInterface(self, pSpCallback, wParam, lParam);
    }
    pub inline fn SetNotifyWin32Event(self: *const ISpNotifySource) HRESULT {
        return self.vtable.SetNotifyWin32Event(self);
    }
    pub inline fn WaitForNotifyEvent(self: *const ISpNotifySource, dwMilliseconds: u32) HRESULT {
        return self.vtable.WaitForNotifyEvent(self, dwMilliseconds);
    }
    pub inline fn GetNotifyEventHandle(self: *const ISpNotifySource) ?HANDLE {
...
pub const ISpNotifySink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Notify(self: *const ISpNotifySink) HRESULT {
...
pub const ISpNotifyTranslator = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn InitWindowMessage(self: *const ISpNotifyTranslator, hWnd: ?HWND, Msg: u32, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.InitWindowMessage(self, hWnd, Msg, wParam, lParam);
    }
    pub inline fn InitCallback(self: *const ISpNotifyTranslator, pfnCallback: ?*?SPNOTIFYCALLBACK, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.InitCallback(self, pfnCallback, wParam, lParam);
    }
    pub inline fn InitSpNotifyCallback(self: *const ISpNotifyTranslator, pSpCallback: ?*ISpNotifyCallback, wParam: WPARAM, lParam: LPARAM) HRESULT {
        return self.vtable.InitSpNotifyCallback(self, pSpCallback, wParam, lParam);
    }
    pub inline fn InitWin32Event(self: *const ISpNotifyTranslator, hEvent: ?HANDLE, fCloseHandleOnRelease: BOOL) HRESULT {
        return self.vtable.InitWin32Event(self, hEvent, fCloseHandleOnRelease);
    }
    pub inline fn Wait(self: *const ISpNotifyTranslator, dwMilliseconds: u32) HRESULT {
        return self.vtable.Wait(self, dwMilliseconds);
    }
    pub inline fn GetEventHandle(self: *const ISpNotifyTranslator) ?HANDLE {
...
pub const ISpDataKey = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetData(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, cbData: u32, pData: ?*const u8) HRESULT {
        return self.vtable.SetData(self, pszValueName, cbData, pData);
    }
    pub inline fn GetData(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, pcbData: ?*u32, pData: ?*u8) HRESULT {
        return self.vtable.GetData(self, pszValueName, pcbData, pData);
    }
    pub inline fn SetStringValue(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, pszValue: ?[*:0]const u16) HRESULT {
        return self.vtable.SetStringValue(self, pszValueName, pszValue);
    }
    pub inline fn GetStringValue(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, ppszValue: ?*?PWSTR) HRESULT {
        return self.vtable.GetStringValue(self, pszValueName, ppszValue);
    }
    pub inline fn SetDWORD(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, dwValue: u32) HRESULT {
        return self.vtable.SetDWORD(self, pszValueName, dwValue);
    }
    pub inline fn GetDWORD(self: *const ISpDataKey, pszValueName: ?[*:0]const u16, pdwValue: ?*u32) HRESULT {
        return self.vtable.GetDWORD(self, pszValueName, pdwValue);
    }
    pub inline fn OpenKey(self: *const ISpDataKey, pszSubKeyName: ?[*:0]const u16, ppSubKey: ?*?*ISpDataKey) HRESULT {
        return self.vtable.OpenKey(self, pszSubKeyName, ppSubKey);
    }
    pub inline fn CreateKey(self: *const ISpDataKey, pszSubKey: ?[*:0]const u16, ppSubKey: ?*?*ISpDataKey) HRESULT {
        return self.vtable.CreateKey(self, pszSubKey, ppSubKey);
    }
    pub inline fn DeleteKey(self: *const ISpDataKey, pszSubKey: ?[*:0]const u16) HRESULT {
        return self.vtable.DeleteKey(self, pszSubKey);
    }
    pub inline fn DeleteValue(self: *const ISpDataKey, pszValueName: ?[*:0]const u16) HRESULT {
        return self.vtable.DeleteValue(self, pszValueName);
    }
    pub inline fn EnumKeys(self: *const ISpDataKey, Index: u32, ppszSubKeyName: ?*?PWSTR) HRESULT {
        return self.vtable.EnumKeys(self, Index, ppszSubKeyName);
    }
    pub inline fn EnumValues(self: *const ISpDataKey, Index: u32, ppszValueName: ?*?PWSTR) HRESULT {
...
pub const ISpRegDataKey = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetKey(self: *const ISpRegDataKey, hkey: ?HKEY, fReadOnly: BOOL) HRESULT {
...
pub const ISpObjectTokenCategory = extern union {
    ...
    ISpDataKey: ISpDataKey,
    IUnknown: IUnknown,
    pub inline fn SetId(self: *const ISpObjectTokenCategory, pszCategoryId: ?[*:0]const u16, fCreateIfNotExist: BOOL) HRESULT {
        return self.vtable.SetId(self, pszCategoryId, fCreateIfNotExist);
    }
    pub inline fn GetId(self: *const ISpObjectTokenCategory, ppszCoMemCategoryId: ?*?PWSTR) HRESULT {
        return self.vtable.GetId(self, ppszCoMemCategoryId);
    }
    pub inline fn GetDataKey(self: *const ISpObjectTokenCategory, spdkl: SPDATAKEYLOCATION, ppDataKey: ?*?*ISpDataKey) HRESULT {
        return self.vtable.GetDataKey(self, spdkl, ppDataKey);
    }
    pub inline fn EnumTokens(self: *const ISpObjectTokenCategory, pzsReqAttribs: ?[*:0]const u16, pszOptAttribs: ?[*:0]const u16, ppEnum: ?*?*IEnumSpObjectTokens) HRESULT {
        return self.vtable.EnumTokens(self, pzsReqAttribs, pszOptAttribs, ppEnum);
    }
    pub inline fn SetDefaultTokenId(self: *const ISpObjectTokenCategory, pszTokenId: ?[*:0]const u16) HRESULT {
        return self.vtable.SetDefaultTokenId(self, pszTokenId);
    }
    pub inline fn GetDefaultTokenId(self: *const ISpObjectTokenCategory, ppszCoMemTokenId: ?*?PWSTR) HRESULT {
...
pub const ISpObjectToken = extern union {
    ...
    ISpDataKey: ISpDataKey,
    IUnknown: IUnknown,
    pub inline fn SetId(self: *const ISpObjectToken, pszCategoryId: ?[*:0]const u16, pszTokenId: ?[*:0]const u16, fCreateIfNotExist: BOOL) HRESULT {
        return self.vtable.SetId(self, pszCategoryId, pszTokenId, fCreateIfNotExist);
    }
    pub inline fn GetId(self: *const ISpObjectToken, ppszCoMemTokenId: ?*?PWSTR) HRESULT {
        return self.vtable.GetId(self, ppszCoMemTokenId);
    }
    pub inline fn GetCategory(self: *const ISpObjectToken, ppTokenCategory: ?*?*ISpObjectTokenCategory) HRESULT {
        return self.vtable.GetCategory(self, ppTokenCategory);
    }
    pub inline fn CreateInstance(self: *const ISpObjectToken, pUnkOuter: ?*IUnknown, dwClsContext: u32, riid: ?*const Guid, ppvObject: ?*?*anyopaque) HRESULT {
        return self.vtable.CreateInstance(self, pUnkOuter, dwClsContext, riid, ppvObject);
    }
    pub inline fn GetStorageFileName(self: *const ISpObjectToken, clsidCaller: ?*const Guid, pszValueName: ?[*:0]const u16, pszFileNameSpecifier: ?[*:0]const u16, nFolder: u32, ppszFilePath: ?*?PWSTR) HRESULT {
        return self.vtable.GetStorageFileName(self, clsidCaller, pszValueName, pszFileNameSpecifier, nFolder, ppszFilePath);
    }
    pub inline fn RemoveStorageFileName(self: *const ISpObjectToken, clsidCaller: ?*const Guid, pszKeyName: ?[*:0]const u16, fDeleteFile: BOOL) HRESULT {
        return self.vtable.RemoveStorageFileName(self, clsidCaller, pszKeyName, fDeleteFile);
    }
    pub inline fn Remove(self: *const ISpObjectToken, pclsidCaller: ?*const Guid) HRESULT {
        return self.vtable.Remove(self, pclsidCaller);
    }
    pub inline fn IsUISupported(self: *const ISpObjectToken, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, punkObject: ?*IUnknown, pfSupported: ?*BOOL) HRESULT {
        return self.vtable.IsUISupported(self, pszTypeOfUI, pvExtraData, cbExtraData, punkObject, pfSupported);
    }
    pub inline fn DisplayUI(self: *const ISpObjectToken, hwndParent: ?HWND, pszTitle: ?[*:0]const u16, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, punkObject: ?*IUnknown) HRESULT {
        return self.vtable.DisplayUI(self, hwndParent, pszTitle, pszTypeOfUI, pvExtraData, cbExtraData, punkObject);
    }
    pub inline fn MatchesAttributes(self: *const ISpObjectToken, pszAttributes: ?[*:0]const u16, pfMatches: ?*BOOL) HRESULT {
...
pub const ISpObjectTokenInit = extern union {
    ...
    ISpDataKey: ISpDataKey,
    IUnknown: IUnknown,
    pub inline fn InitFromDataKey(self: *const ISpObjectTokenInit, pszCategoryId: ?[*:0]const u16, pszTokenId: ?[*:0]const u16, pDataKey: ?*ISpDataKey) HRESULT {
...
pub const IEnumSpObjectTokens = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSpObjectTokens, celt: u32, pelt: ?*?*ISpObjectToken, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, pelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSpObjectTokens, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSpObjectTokens) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSpObjectTokens, ppEnum: ?*?*IEnumSpObjectTokens) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
    pub inline fn Item(self: *const IEnumSpObjectTokens, Index: u32, ppToken: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.Item(self, Index, ppToken);
    }
    pub inline fn GetCount(self: *const IEnumSpObjectTokens, pCount: ?*u32) HRESULT {
...
pub const ISpObjectWithToken = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetObjectToken(self: *const ISpObjectWithToken, pToken: ?*ISpObjectToken) HRESULT {
        return self.vtable.SetObjectToken(self, pToken);
    }
    pub inline fn GetObjectToken(self: *const ISpObjectWithToken, ppToken: ?*?*ISpObjectToken) HRESULT {
...
pub const ISpResourceManager = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetObject(self: *const ISpResourceManager, guidServiceId: ?*const Guid, pUnkObject: ?*IUnknown) HRESULT {
        return self.vtable.SetObject(self, guidServiceId, pUnkObject);
    }
    pub inline fn GetObject(self: *const ISpResourceManager, guidServiceId: ?*const Guid, ObjectCLSID: ?*const Guid, ObjectIID: ?*const Guid, fReleaseWhenLastExternalRefReleased: BOOL, ppObject: ?*?*anyopaque) HRESULT {
...
pub const ISpEventSource = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetInterest(self: *const ISpEventSource, ullEventInterest: u64, ullQueuedInterest: u64) HRESULT {
        return self.vtable.SetInterest(self, ullEventInterest, ullQueuedInterest);
    }
    pub inline fn GetEvents(self: *const ISpEventSource, ulCount: u32, pEventArray: ?*SPEVENT, pulFetched: ?*u32) HRESULT {
        return self.vtable.GetEvents(self, ulCount, pEventArray, pulFetched);
    }
    pub inline fn GetInfo(self: *const ISpEventSource, pInfo: ?*SPEVENTSOURCEINFO) HRESULT {
...
pub const ISpEventSource2 = extern union {
    ...
    ISpNotifySource: ISpNotifySource,
    IUnknown: IUnknown,
    pub inline fn GetEventsEx(self: *const ISpEventSource2, ulCount: u32, pEventArray: ?*SPEVENTEX, pulFetched: ?*u32) HRESULT {
...
pub const ISpEventSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddEvents(self: *const ISpEventSink, pEventArray: ?*const SPEVENT, ulCount: u32) HRESULT {
        return self.vtable.AddEvents(self, pEventArray, ulCount);
    }
    pub inline fn GetEventInterest(self: *const ISpEventSink, pullEventInterest: ?*u64) HRESULT {
...
pub const ISpStreamFormat = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetFormat(self: *const ISpStreamFormat, pguidFormatId: ?*Guid, ppCoMemWaveFormatEx: ?*?*WAVEFORMATEX) HRESULT {
...
pub const ISpStream = extern union {
    ...
    ISequentialStream: ISequentialStream,
    IUnknown: IUnknown,
    pub inline fn SetBaseStream(self: *const ISpStream, pStream: ?*IStream, rguidFormat: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX) HRESULT {
        return self.vtable.SetBaseStream(self, pStream, rguidFormat, pWaveFormatEx);
    }
    pub inline fn GetBaseStream(self: *const ISpStream, ppStream: ?*?*IStream) HRESULT {
        return self.vtable.GetBaseStream(self, ppStream);
    }
    pub inline fn BindToFile(self: *const ISpStream, pszFileName: ?[*:0]const u16, eMode: SPFILEMODE, pFormatId: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX, ullEventInterest: u64) HRESULT {
        return self.vtable.BindToFile(self, pszFileName, eMode, pFormatId, pWaveFormatEx, ullEventInterest);
    }
    pub inline fn Close(self: *const ISpStream) HRESULT {
...
pub const ISpStreamFormatConverter = extern union {
    ...
    ISequentialStream: ISequentialStream,
    IUnknown: IUnknown,
    pub inline fn SetBaseStream(self: *const ISpStreamFormatConverter, pStream: ?*ISpStreamFormat, fSetFormatToBaseStreamFormat: BOOL, fWriteToBaseStream: BOOL) HRESULT {
        return self.vtable.SetBaseStream(self, pStream, fSetFormatToBaseStreamFormat, fWriteToBaseStream);
    }
    pub inline fn GetBaseStream(self: *const ISpStreamFormatConverter, ppStream: ?*?*ISpStreamFormat) HRESULT {
        return self.vtable.GetBaseStream(self, ppStream);
    }
    pub inline fn SetFormat(self: *const ISpStreamFormatConverter, rguidFormatIdOfConvertedStream: ?*const Guid, pWaveFormatExOfConvertedStream: ?*const WAVEFORMATEX) HRESULT {
        return self.vtable.SetFormat(self, rguidFormatIdOfConvertedStream, pWaveFormatExOfConvertedStream);
    }
    pub inline fn ResetSeekPosition(self: *const ISpStreamFormatConverter) HRESULT {
        return self.vtable.ResetSeekPosition(self);
    }
    pub inline fn ScaleConvertedToBaseOffset(self: *const ISpStreamFormatConverter, ullOffsetConvertedStream: u64, pullOffsetBaseStream: ?*u64) HRESULT {
        return self.vtable.ScaleConvertedToBaseOffset(self, ullOffsetConvertedStream, pullOffsetBaseStream);
    }
    pub inline fn ScaleBaseToConvertedOffset(self: *const ISpStreamFormatConverter, ullOffsetBaseStream: u64, pullOffsetConvertedStream: ?*u64) HRESULT {
...
pub const ISpAudio = extern union {
    ...
    ISequentialStream: ISequentialStream,
    IUnknown: IUnknown,
    pub inline fn SetState(self: *const ISpAudio, NewState: SPAUDIOSTATE, ullReserved: u64) HRESULT {
        return self.vtable.SetState(self, NewState, ullReserved);
    }
    pub inline fn SetFormat(self: *const ISpAudio, rguidFmtId: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX) HRESULT {
        return self.vtable.SetFormat(self, rguidFmtId, pWaveFormatEx);
    }
    pub inline fn GetStatus(self: *const ISpAudio, pStatus: ?*SPAUDIOSTATUS) HRESULT {
        return self.vtable.GetStatus(self, pStatus);
    }
    pub inline fn SetBufferInfo(self: *const ISpAudio, pBuffInfo: ?*const SPAUDIOBUFFERINFO) HRESULT {
        return self.vtable.SetBufferInfo(self, pBuffInfo);
    }
    pub inline fn GetBufferInfo(self: *const ISpAudio, pBuffInfo: ?*SPAUDIOBUFFERINFO) HRESULT {
        return self.vtable.GetBufferInfo(self, pBuffInfo);
    }
    pub inline fn GetDefaultFormat(self: *const ISpAudio, pFormatId: ?*Guid, ppCoMemWaveFormatEx: ?*?*WAVEFORMATEX) HRESULT {
        return self.vtable.GetDefaultFormat(self, pFormatId, ppCoMemWaveFormatEx);
    }
    pub inline fn EventHandle(self: *const ISpAudio) ?HANDLE {
        return self.vtable.EventHandle(self);
    }
    pub inline fn GetVolumeLevel(self: *const ISpAudio, pLevel: ?*u32) HRESULT {
        return self.vtable.GetVolumeLevel(self, pLevel);
    }
    pub inline fn SetVolumeLevel(self: *const ISpAudio, Level: u32) HRESULT {
        return self.vtable.SetVolumeLevel(self, Level);
    }
    pub inline fn GetBufferNotifySize(self: *const ISpAudio, pcbSize: ?*u32) HRESULT {
        return self.vtable.GetBufferNotifySize(self, pcbSize);
    }
    pub inline fn SetBufferNotifySize(self: *const ISpAudio, cbSize: u32) HRESULT {
...
pub const ISpMMSysAudio = extern union {
    ...
    ISequentialStream: ISequentialStream,
    IUnknown: IUnknown,
    pub inline fn GetDeviceId(self: *const ISpMMSysAudio, puDeviceId: ?*u32) HRESULT {
        return self.vtable.GetDeviceId(self, puDeviceId);
    }
    pub inline fn SetDeviceId(self: *const ISpMMSysAudio, uDeviceId: u32) HRESULT {
        return self.vtable.SetDeviceId(self, uDeviceId);
    }
    pub inline fn GetMMHandle(self: *const ISpMMSysAudio, pHandle: ?*?*anyopaque) HRESULT {
        return self.vtable.GetMMHandle(self, pHandle);
    }
    pub inline fn GetLineId(self: *const ISpMMSysAudio, puLineId: ?*u32) HRESULT {
        return self.vtable.GetLineId(self, puLineId);
    }
    pub inline fn SetLineId(self: *const ISpMMSysAudio, uLineId: u32) HRESULT {
...
pub const ISpTranscript = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetTranscript(self: *const ISpTranscript, ppszTranscript: ?*?PWSTR) HRESULT {
        return self.vtable.GetTranscript(self, ppszTranscript);
    }
    pub inline fn AppendTranscript(self: *const ISpTranscript, pszTranscript: ?[*:0]const u16) HRESULT {
...
pub const ISpLexicon = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetPronunciations(self: *const ISpLexicon, pszWord: ?[*:0]const u16, LangID: u16, dwFlags: u32, pWordPronunciationList: ?*SPWORDPRONUNCIATIONLIST) HRESULT {
        return self.vtable.GetPronunciations(self, pszWord, LangID, dwFlags, pWordPronunciationList);
    }
    pub inline fn AddPronunciation(self: *const ISpLexicon, pszWord: ?[*:0]const u16, LangID: u16, ePartOfSpeech: SPPARTOFSPEECH, pszPronunciation: ?*u16) HRESULT {
        return self.vtable.AddPronunciation(self, pszWord, LangID, ePartOfSpeech, pszPronunciation);
    }
    pub inline fn RemovePronunciation(self: *const ISpLexicon, pszWord: ?[*:0]const u16, LangID: u16, ePartOfSpeech: SPPARTOFSPEECH, pszPronunciation: ?*u16) HRESULT {
        return self.vtable.RemovePronunciation(self, pszWord, LangID, ePartOfSpeech, pszPronunciation);
    }
    pub inline fn GetGeneration(self: *const ISpLexicon, pdwGeneration: ?*u32) HRESULT {
        return self.vtable.GetGeneration(self, pdwGeneration);
    }
    pub inline fn GetGenerationChange(self: *const ISpLexicon, dwFlags: u32, pdwGeneration: ?*u32, pWordList: ?*SPWORDLIST) HRESULT {
        return self.vtable.GetGenerationChange(self, dwFlags, pdwGeneration, pWordList);
    }
    pub inline fn GetWords(self: *const ISpLexicon, dwFlags: u32, pdwGeneration: ?*u32, pdwCookie: ?*u32, pWordList: ?*SPWORDLIST) HRESULT {
...
pub const ISpContainerLexicon = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn AddLexicon(self: *const ISpContainerLexicon, pAddLexicon: ?*ISpLexicon, dwFlags: u32) HRESULT {
...
pub const ISpShortcut = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddShortcut(self: *const ISpShortcut, pszDisplay: ?[*:0]const u16, LangID: u16, pszSpoken: ?[*:0]const u16, shType: SPSHORTCUTTYPE) HRESULT {
        return self.vtable.AddShortcut(self, pszDisplay, LangID, pszSpoken, shType);
    }
    pub inline fn RemoveShortcut(self: *const ISpShortcut, pszDisplay: ?[*:0]const u16, LangID: u16, pszSpoken: ?[*:0]const u16, shType: SPSHORTCUTTYPE) HRESULT {
        return self.vtable.RemoveShortcut(self, pszDisplay, LangID, pszSpoken, shType);
    }
    pub inline fn GetShortcuts(self: *const ISpShortcut, LangID: u16, pShortcutpairList: ?*SPSHORTCUTPAIRLIST) HRESULT {
        return self.vtable.GetShortcuts(self, LangID, pShortcutpairList);
    }
    pub inline fn GetGeneration(self: *const ISpShortcut, pdwGeneration: ?*u32) HRESULT {
        return self.vtable.GetGeneration(self, pdwGeneration);
    }
    pub inline fn GetWordsFromGenerationChange(self: *const ISpShortcut, pdwGeneration: ?*u32, pWordList: ?*SPWORDLIST) HRESULT {
        return self.vtable.GetWordsFromGenerationChange(self, pdwGeneration, pWordList);
    }
    pub inline fn GetWords(self: *const ISpShortcut, pdwGeneration: ?*u32, pdwCookie: ?*u32, pWordList: ?*SPWORDLIST) HRESULT {
        return self.vtable.GetWords(self, pdwGeneration, pdwCookie, pWordList);
    }
    pub inline fn GetShortcutsForGeneration(self: *const ISpShortcut, pdwGeneration: ?*u32, pdwCookie: ?*u32, pShortcutpairList: ?*SPSHORTCUTPAIRLIST) HRESULT {
        return self.vtable.GetShortcutsForGeneration(self, pdwGeneration, pdwCookie, pShortcutpairList);
    }
    pub inline fn GetGenerationChange(self: *const ISpShortcut, pdwGeneration: ?*u32, pShortcutpairList: ?*SPSHORTCUTPAIRLIST) HRESULT {
...
pub const ISpPhoneConverter = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn PhoneToId(self: *const ISpPhoneConverter, pszPhone: ?[*:0]const u16, pId: ?*u16) HRESULT {
        return self.vtable.PhoneToId(self, pszPhone, pId);
    }
    pub inline fn IdToPhone(self: *const ISpPhoneConverter, pId: ?*u16, pszPhone: ?PWSTR) HRESULT {
...
pub const ISpPhoneticAlphabetConverter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetLangId(self: *const ISpPhoneticAlphabetConverter, pLangID: ?*u16) HRESULT {
        return self.vtable.GetLangId(self, pLangID);
    }
    pub inline fn SetLangId(self: *const ISpPhoneticAlphabetConverter, LangID: u16) HRESULT {
        return self.vtable.SetLangId(self, LangID);
    }
    pub inline fn SAPI2UPS(self: *const ISpPhoneticAlphabetConverter, pszSAPIId: ?*const u16, pszUPSId: [*:0]u16, cMaxLength: u32) HRESULT {
        return self.vtable.SAPI2UPS(self, pszSAPIId, pszUPSId, cMaxLength);
    }
    pub inline fn UPS2SAPI(self: *const ISpPhoneticAlphabetConverter, pszUPSId: ?*const u16, pszSAPIId: [*:0]u16, cMaxLength: u32) HRESULT {
        return self.vtable.UPS2SAPI(self, pszUPSId, pszSAPIId, cMaxLength);
    }
    pub inline fn GetMaxConvertLength(self: *const ISpPhoneticAlphabetConverter, cSrcLength: u32, bSAPI2UPS: BOOL, pcMaxDestLength: ?*u32) HRESULT {
...
pub const ISpPhoneticAlphabetSelection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsAlphabetUPS(self: *const ISpPhoneticAlphabetSelection, pfIsUPS: ?*BOOL) HRESULT {
        return self.vtable.IsAlphabetUPS(self, pfIsUPS);
    }
    pub inline fn SetAlphabetToUPS(self: *const ISpPhoneticAlphabetSelection, fForceUPS: BOOL) HRESULT {
...
pub const ISpVoice = extern union {
    ...
    ISpNotifySource: ISpNotifySource,
    IUnknown: IUnknown,
    pub inline fn SetOutput(self: *const ISpVoice, pUnkOutput: ?*IUnknown, fAllowFormatChanges: BOOL) HRESULT {
        return self.vtable.SetOutput(self, pUnkOutput, fAllowFormatChanges);
    }
    pub inline fn GetOutputObjectToken(self: *const ISpVoice, ppObjectToken: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.GetOutputObjectToken(self, ppObjectToken);
    }
    pub inline fn GetOutputStream(self: *const ISpVoice, ppStream: ?*?*ISpStreamFormat) HRESULT {
        return self.vtable.GetOutputStream(self, ppStream);
    }
    pub inline fn Pause(self: *const ISpVoice) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn Resume(self: *const ISpVoice) HRESULT {
        return self.vtable.Resume(self);
    }
    pub inline fn SetVoice(self: *const ISpVoice, pToken: ?*ISpObjectToken) HRESULT {
        return self.vtable.SetVoice(self, pToken);
    }
    pub inline fn GetVoice(self: *const ISpVoice, ppToken: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.GetVoice(self, ppToken);
    }
    pub inline fn Speak(self: *const ISpVoice, pwcs: ?[*:0]const u16, dwFlags: u32, pulStreamNumber: ?*u32) HRESULT {
        return self.vtable.Speak(self, pwcs, dwFlags, pulStreamNumber);
    }
    pub inline fn SpeakStream(self: *const ISpVoice, pStream: ?*IStream, dwFlags: u32, pulStreamNumber: ?*u32) HRESULT {
        return self.vtable.SpeakStream(self, pStream, dwFlags, pulStreamNumber);
    }
    pub inline fn GetStatus(self: *const ISpVoice, pStatus: ?*SPVOICESTATUS, ppszLastBookmark: ?*?PWSTR) HRESULT {
        return self.vtable.GetStatus(self, pStatus, ppszLastBookmark);
    }
    pub inline fn Skip(self: *const ISpVoice, pItemType: ?[*:0]const u16, lNumItems: i32, pulNumSkipped: ?*u32) HRESULT {
        return self.vtable.Skip(self, pItemType, lNumItems, pulNumSkipped);
    }
    pub inline fn SetPriority(self: *const ISpVoice, ePriority: SPVPRIORITY) HRESULT {
        return self.vtable.SetPriority(self, ePriority);
    }
    pub inline fn GetPriority(self: *const ISpVoice, pePriority: ?*SPVPRIORITY) HRESULT {
        return self.vtable.GetPriority(self, pePriority);
    }
    pub inline fn SetAlertBoundary(self: *const ISpVoice, eBoundary: SPEVENTENUM) HRESULT {
        return self.vtable.SetAlertBoundary(self, eBoundary);
    }
    pub inline fn GetAlertBoundary(self: *const ISpVoice, peBoundary: ?*SPEVENTENUM) HRESULT {
        return self.vtable.GetAlertBoundary(self, peBoundary);
    }
    pub inline fn SetRate(self: *const ISpVoice, RateAdjust: i32) HRESULT {
        return self.vtable.SetRate(self, RateAdjust);
    }
    pub inline fn GetRate(self: *const ISpVoice, pRateAdjust: ?*i32) HRESULT {
        return self.vtable.GetRate(self, pRateAdjust);
    }
    pub inline fn SetVolume(self: *const ISpVoice, usVolume: u16) HRESULT {
        return self.vtable.SetVolume(self, usVolume);
    }
    pub inline fn GetVolume(self: *const ISpVoice, pusVolume: ?*u16) HRESULT {
        return self.vtable.GetVolume(self, pusVolume);
    }
    pub inline fn WaitUntilDone(self: *const ISpVoice, msTimeout: u32) HRESULT {
        return self.vtable.WaitUntilDone(self, msTimeout);
    }
    pub inline fn SetSyncSpeakTimeout(self: *const ISpVoice, msTimeout: u32) HRESULT {
        return self.vtable.SetSyncSpeakTimeout(self, msTimeout);
    }
    pub inline fn GetSyncSpeakTimeout(self: *const ISpVoice, pmsTimeout: ?*u32) HRESULT {
        return self.vtable.GetSyncSpeakTimeout(self, pmsTimeout);
    }
    pub inline fn SpeakCompleteEvent(self: *const ISpVoice) ?HANDLE {
        return self.vtable.SpeakCompleteEvent(self);
    }
    pub inline fn IsUISupported(self: *const ISpVoice, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, pfSupported: ?*BOOL) HRESULT {
        return self.vtable.IsUISupported(self, pszTypeOfUI, pvExtraData, cbExtraData, pfSupported);
    }
    pub inline fn DisplayUI(self: *const ISpVoice, hwndParent: ?HWND, pszTitle: ?[*:0]const u16, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32) HRESULT {
...
pub const ISpPhrase = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetPhrase(self: *const ISpPhrase, ppCoMemPhrase: ?*?*SPPHRASE) HRESULT {
        return self.vtable.GetPhrase(self, ppCoMemPhrase);
    }
    pub inline fn GetSerializedPhrase(self: *const ISpPhrase, ppCoMemPhrase: ?*?*SPSERIALIZEDPHRASE) HRESULT {
        return self.vtable.GetSerializedPhrase(self, ppCoMemPhrase);
    }
    pub inline fn GetText(self: *const ISpPhrase, ulStart: u32, ulCount: u32, fUseTextReplacements: BOOL, ppszCoMemText: ?*?PWSTR, pbDisplayAttributes: ?*u8) HRESULT {
        return self.vtable.GetText(self, ulStart, ulCount, fUseTextReplacements, ppszCoMemText, pbDisplayAttributes);
    }
    pub inline fn Discard(self: *const ISpPhrase, dwValueTypes: u32) HRESULT {
...
pub const ISpPhraseAlt = extern union {
    ...
    ISpPhrase: ISpPhrase,
    IUnknown: IUnknown,
    pub inline fn GetAltInfo(self: *const ISpPhraseAlt, ppParent: ?*?*ISpPhrase, pulStartElementInParent: ?*u32, pcElementsInParent: ?*u32, pcElementsInAlt: ?*u32) HRESULT {
        return self.vtable.GetAltInfo(self, ppParent, pulStartElementInParent, pcElementsInParent, pcElementsInAlt);
    }
    pub inline fn Commit(self: *const ISpPhraseAlt) HRESULT {
...
pub const ISpPhrase2 = extern union {
    ...
    ISpPhrase: ISpPhrase,
    IUnknown: IUnknown,
    pub inline fn GetXMLResult(self: *const ISpPhrase2, ppszCoMemXMLResult: ?*?PWSTR, Options: SPXMLRESULTOPTIONS) HRESULT {
        return self.vtable.GetXMLResult(self, ppszCoMemXMLResult, Options);
    }
    pub inline fn GetXMLErrorInfo(self: *const ISpPhrase2, pSemanticErrorInfo: ?*SPSEMANTICERRORINFO) HRESULT {
        return self.vtable.GetXMLErrorInfo(self, pSemanticErrorInfo);
    }
    pub inline fn GetAudio(self: *const ISpPhrase2, ulStartElement: u32, cElements: u32, ppStream: ?*?*ISpStreamFormat) HRESULT {
...
pub const ISpRecoResult = extern union {
    ...
    ISpPhrase: ISpPhrase,
    IUnknown: IUnknown,
    pub inline fn GetResultTimes(self: *const ISpRecoResult, pTimes: ?*SPRECORESULTTIMES) HRESULT {
        return self.vtable.GetResultTimes(self, pTimes);
    }
    pub inline fn GetAlternates(self: *const ISpRecoResult, ulStartElement: u32, cElements: u32, ulRequestCount: u32, ppPhrases: [*]?*ISpPhraseAlt, pcPhrasesReturned: ?*u32) HRESULT {
        return self.vtable.GetAlternates(self, ulStartElement, cElements, ulRequestCount, ppPhrases, pcPhrasesReturned);
    }
    pub inline fn GetAudio(self: *const ISpRecoResult, ulStartElement: u32, cElements: u32, ppStream: ?*?*ISpStreamFormat) HRESULT {
        return self.vtable.GetAudio(self, ulStartElement, cElements, ppStream);
    }
    pub inline fn SpeakAudio(self: *const ISpRecoResult, ulStartElement: u32, cElements: u32, dwFlags: u32, pulStreamNumber: ?*u32) HRESULT {
        return self.vtable.SpeakAudio(self, ulStartElement, cElements, dwFlags, pulStreamNumber);
    }
    pub inline fn Serialize(self: *const ISpRecoResult, ppCoMemSerializedResult: ?*?*SPSERIALIZEDRESULT) HRESULT {
        return self.vtable.Serialize(self, ppCoMemSerializedResult);
    }
    pub inline fn ScaleAudio(self: *const ISpRecoResult, pAudioFormatId: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX) HRESULT {
        return self.vtable.ScaleAudio(self, pAudioFormatId, pWaveFormatEx);
    }
    pub inline fn GetRecoContext(self: *const ISpRecoResult, ppRecoContext: ?*?*ISpRecoContext) HRESULT {
...
pub const ISpRecoResult2 = extern union {
    ...
    ISpPhrase: ISpPhrase,
    IUnknown: IUnknown,
    pub inline fn CommitAlternate(self: *const ISpRecoResult2, pPhraseAlt: ?*ISpPhraseAlt, ppNewResult: ?*?*ISpRecoResult) HRESULT {
        return self.vtable.CommitAlternate(self, pPhraseAlt, ppNewResult);
    }
    pub inline fn CommitText(self: *const ISpRecoResult2, ulStartElement: u32, cElements: u32, pszCorrectedData: ?[*:0]const u16, eCommitFlags: u32) HRESULT {
        return self.vtable.CommitText(self, ulStartElement, cElements, pszCorrectedData, eCommitFlags);
    }
    pub inline fn SetTextFeedback(self: *const ISpRecoResult2, pszFeedback: ?[*:0]const u16, fSuccessful: BOOL) HRESULT {
...
pub const ISpXMLRecoResult = extern union {
    ...
    ISpPhrase: ISpPhrase,
    IUnknown: IUnknown,
    pub inline fn GetXMLResult(self: *const ISpXMLRecoResult, ppszCoMemXMLResult: ?*?PWSTR, Options: SPXMLRESULTOPTIONS) HRESULT {
        return self.vtable.GetXMLResult(self, ppszCoMemXMLResult, Options);
    }
    pub inline fn GetXMLErrorInfo(self: *const ISpXMLRecoResult, pSemanticErrorInfo: ?*SPSEMANTICERRORINFO) HRESULT {
        return self.vtable.GetXMLErrorInfo(self, pSemanticErrorInfo);
    }
};
...
pub const ISpGrammarBuilder = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ResetGrammar(self: *const ISpGrammarBuilder, NewLanguage: u16) HRESULT {
        return self.vtable.ResetGrammar(self, NewLanguage);
    }
    pub inline fn GetRule(self: *const ISpGrammarBuilder, pszRuleName: ?[*:0]const u16, dwRuleId: u32, dwAttributes: u32, fCreateIfNotExist: BOOL, phInitialState: ?*?*SPSTATEHANDLE__) HRESULT {
        return self.vtable.GetRule(self, pszRuleName, dwRuleId, dwAttributes, fCreateIfNotExist, phInitialState);
    }
    pub inline fn ClearRule(self: *const ISpGrammarBuilder, hState: ?*SPSTATEHANDLE__) HRESULT {
        return self.vtable.ClearRule(self, hState);
    }
    pub inline fn CreateNewState(self: *const ISpGrammarBuilder, hState: ?*SPSTATEHANDLE__, phState: ?*?*SPSTATEHANDLE__) HRESULT {
        return self.vtable.CreateNewState(self, hState, phState);
    }
    pub inline fn AddWordTransition(self: *const ISpGrammarBuilder, hFromState: ?*SPSTATEHANDLE__, hToState: ?*SPSTATEHANDLE__, psz: ?[*:0]const u16, pszSeparators: ?[*:0]const u16, eWordType: SPGRAMMARWORDTYPE, Weight: f32, pPropInfo: ?*const SPPROPERTYINFO) HRESULT {
        return self.vtable.AddWordTransition(self, hFromState, hToState, psz, pszSeparators, eWordType, Weight, pPropInfo);
    }
    pub inline fn AddRuleTransition(self: *const ISpGrammarBuilder, hFromState: ?*SPSTATEHANDLE__, hToState: ?*SPSTATEHANDLE__, hRule: ?*SPSTATEHANDLE__, Weight: f32, pPropInfo: ?*const SPPROPERTYINFO) HRESULT {
        return self.vtable.AddRuleTransition(self, hFromState, hToState, hRule, Weight, pPropInfo);
    }
    pub inline fn AddResource(self: *const ISpGrammarBuilder, hRuleState: ?*SPSTATEHANDLE__, pszResourceName: ?[*:0]const u16, pszResourceValue: ?[*:0]const u16) HRESULT {
        return self.vtable.AddResource(self, hRuleState, pszResourceName, pszResourceValue);
    }
    pub inline fn Commit(self: *const ISpGrammarBuilder, dwReserved: u32) HRESULT {
...
pub const ISpRecoGrammar = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetGrammarId(self: *const ISpRecoGrammar, pullGrammarId: ?*u64) HRESULT {
        return self.vtable.GetGrammarId(self, pullGrammarId);
    }
    pub inline fn GetRecoContext(self: *const ISpRecoGrammar, ppRecoCtxt: ?*?*ISpRecoContext) HRESULT {
        return self.vtable.GetRecoContext(self, ppRecoCtxt);
    }
    pub inline fn LoadCmdFromFile(self: *const ISpRecoGrammar, pszFileName: ?[*:0]const u16, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadCmdFromFile(self, pszFileName, Options);
    }
    pub inline fn LoadCmdFromObject(self: *const ISpRecoGrammar, rcid: ?*const Guid, pszGrammarName: ?[*:0]const u16, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadCmdFromObject(self, rcid, pszGrammarName, Options);
    }
    pub inline fn LoadCmdFromResource(self: *const ISpRecoGrammar, hModule: ?HINSTANCE, pszResourceName: ?[*:0]const u16, pszResourceType: ?[*:0]const u16, wLanguage: u16, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadCmdFromResource(self, hModule, pszResourceName, pszResourceType, wLanguage, Options);
    }
    pub inline fn LoadCmdFromMemory(self: *const ISpRecoGrammar, pGrammar: ?*const SPBINARYGRAMMAR, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadCmdFromMemory(self, pGrammar, Options);
    }
    pub inline fn LoadCmdFromProprietaryGrammar(self: *const ISpRecoGrammar, rguidParam: ?*const Guid, pszStringParam: ?[*:0]const u16, pvDataPrarm: ?*const anyopaque, cbDataSize: u32, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadCmdFromProprietaryGrammar(self, rguidParam, pszStringParam, pvDataPrarm, cbDataSize, Options);
    }
    pub inline fn SetRuleState(self: *const ISpRecoGrammar, pszName: ?[*:0]const u16, pReserved: ?*anyopaque, NewState: SPRULESTATE) HRESULT {
        return self.vtable.SetRuleState(self, pszName, pReserved, NewState);
    }
    pub inline fn SetRuleIdState(self: *const ISpRecoGrammar, ulRuleId: u32, NewState: SPRULESTATE) HRESULT {
        return self.vtable.SetRuleIdState(self, ulRuleId, NewState);
    }
    pub inline fn LoadDictation(self: *const ISpRecoGrammar, pszTopicName: ?[*:0]const u16, Options: SPLOADOPTIONS) HRESULT {
        return self.vtable.LoadDictation(self, pszTopicName, Options);
    }
    pub inline fn UnloadDictation(self: *const ISpRecoGrammar) HRESULT {
        return self.vtable.UnloadDictation(self);
    }
    pub inline fn SetDictationState(self: *const ISpRecoGrammar, NewState: SPRULESTATE) HRESULT {
        return self.vtable.SetDictationState(self, NewState);
    }
    pub inline fn SetWordSequenceData(self: *const ISpRecoGrammar, pText: ?[*:0]const u16, cchText: u32, pInfo: ?*const SPTEXTSELECTIONINFO) HRESULT {
        return self.vtable.SetWordSequenceData(self, pText, cchText, pInfo);
    }
    pub inline fn SetTextSelection(self: *const ISpRecoGrammar, pInfo: ?*const SPTEXTSELECTIONINFO) HRESULT {
        return self.vtable.SetTextSelection(self, pInfo);
    }
    pub inline fn IsPronounceable(self: *const ISpRecoGrammar, pszWord: ?[*:0]const u16, pWordPronounceable: ?*SPWORDPRONOUNCEABLE) HRESULT {
        return self.vtable.IsPronounceable(self, pszWord, pWordPronounceable);
    }
    pub inline fn SetGrammarState(self: *const ISpRecoGrammar, eGrammarState: SPGRAMMARSTATE) HRESULT {
        return self.vtable.SetGrammarState(self, eGrammarState);
    }
    pub inline fn SaveCmd(self: *const ISpRecoGrammar, pStream: ?*IStream, ppszCoMemErrorText: ?*?PWSTR) HRESULT {
        return self.vtable.SaveCmd(self, pStream, ppszCoMemErrorText);
    }
    pub inline fn GetGrammarState(self: *const ISpRecoGrammar, peGrammarState: ?*SPGRAMMARSTATE) HRESULT {
...
pub const ISpGrammarBuilder2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddTextSubset(self: *const ISpGrammarBuilder2, hFromState: ?*SPSTATEHANDLE__, hToState: ?*SPSTATEHANDLE__, psz: ?[*:0]const u16, eMatchMode: SPMATCHINGMODE) HRESULT {
        return self.vtable.AddTextSubset(self, hFromState, hToState, psz, eMatchMode);
    }
    pub inline fn SetPhoneticAlphabet(self: *const ISpGrammarBuilder2, phoneticALphabet: PHONETICALPHABET) HRESULT {
...
pub const ISpRecoGrammar2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetRules(self: *const ISpRecoGrammar2, ppCoMemRules: ?*?*SPRULE, puNumRules: ?*u32) HRESULT {
        return self.vtable.GetRules(self, ppCoMemRules, puNumRules);
    }
    pub inline fn LoadCmdFromFile2(self: *const ISpRecoGrammar2, pszFileName: ?[*:0]const u16, Options: SPLOADOPTIONS, pszSharingUri: ?[*:0]const u16, pszBaseUri: ?[*:0]const u16) HRESULT {
        return self.vtable.LoadCmdFromFile2(self, pszFileName, Options, pszSharingUri, pszBaseUri);
    }
    pub inline fn LoadCmdFromMemory2(self: *const ISpRecoGrammar2, pGrammar: ?*const SPBINARYGRAMMAR, Options: SPLOADOPTIONS, pszSharingUri: ?[*:0]const u16, pszBaseUri: ?[*:0]const u16) HRESULT {
        return self.vtable.LoadCmdFromMemory2(self, pGrammar, Options, pszSharingUri, pszBaseUri);
    }
    pub inline fn SetRulePriority(self: *const ISpRecoGrammar2, pszRuleName: ?[*:0]const u16, ulRuleId: u32, nRulePriority: i32) HRESULT {
        return self.vtable.SetRulePriority(self, pszRuleName, ulRuleId, nRulePriority);
    }
    pub inline fn SetRuleWeight(self: *const ISpRecoGrammar2, pszRuleName: ?[*:0]const u16, ulRuleId: u32, flWeight: f32) HRESULT {
        return self.vtable.SetRuleWeight(self, pszRuleName, ulRuleId, flWeight);
    }
    pub inline fn SetDictationWeight(self: *const ISpRecoGrammar2, flWeight: f32) HRESULT {
        return self.vtable.SetDictationWeight(self, flWeight);
    }
    pub inline fn SetGrammarLoader(self: *const ISpRecoGrammar2, pLoader: ?*ISpeechResourceLoader) HRESULT {
        return self.vtable.SetGrammarLoader(self, pLoader);
    }
    pub inline fn SetSMLSecurityManager(self: *const ISpRecoGrammar2, pSMLSecurityManager: ?*IInternetSecurityManager) HRESULT {
...
pub const ISpeechResourceLoader = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn LoadResource(self: *const ISpeechResourceLoader, bstrResourceUri: ?BSTR, fAlwaysReload: i16, pStream: ?*?*IUnknown, pbstrMIMEType: ?*?BSTR, pfModified: ?*i16, pbstrRedirectUrl: ?*?BSTR) HRESULT {
        return self.vtable.LoadResource(self, bstrResourceUri, fAlwaysReload, pStream, pbstrMIMEType, pfModified, pbstrRedirectUrl);
    }
    pub inline fn GetLocalCopy(self: *const ISpeechResourceLoader, bstrResourceUri: ?BSTR, pbstrLocalPath: ?*?BSTR, pbstrMIMEType: ?*?BSTR, pbstrRedirectUrl: ?*?BSTR) HRESULT {
        return self.vtable.GetLocalCopy(self, bstrResourceUri, pbstrLocalPath, pbstrMIMEType, pbstrRedirectUrl);
    }
    pub inline fn ReleaseLocalCopy(self: *const ISpeechResourceLoader, pbstrLocalPath: ?BSTR) HRESULT {
...
pub const ISpRecoContext = extern union {
    ...
    ISpNotifySource: ISpNotifySource,
    IUnknown: IUnknown,
    pub inline fn GetRecognizer(self: *const ISpRecoContext, ppRecognizer: ?*?*ISpRecognizer) HRESULT {
        return self.vtable.GetRecognizer(self, ppRecognizer);
    }
    pub inline fn CreateGrammar(self: *const ISpRecoContext, ullGrammarId: u64, ppGrammar: ?*?*ISpRecoGrammar) HRESULT {
        return self.vtable.CreateGrammar(self, ullGrammarId, ppGrammar);
    }
    pub inline fn GetStatus(self: *const ISpRecoContext, pStatus: ?*SPRECOCONTEXTSTATUS) HRESULT {
        return self.vtable.GetStatus(self, pStatus);
    }
    pub inline fn GetMaxAlternates(self: *const ISpRecoContext, pcAlternates: ?*u32) HRESULT {
        return self.vtable.GetMaxAlternates(self, pcAlternates);
    }
    pub inline fn SetMaxAlternates(self: *const ISpRecoContext, cAlternates: u32) HRESULT {
        return self.vtable.SetMaxAlternates(self, cAlternates);
    }
    pub inline fn SetAudioOptions(self: *const ISpRecoContext, Options: SPAUDIOOPTIONS, pAudioFormatId: ?*const Guid, pWaveFormatEx: ?*const WAVEFORMATEX) HRESULT {
        return self.vtable.SetAudioOptions(self, Options, pAudioFormatId, pWaveFormatEx);
    }
    pub inline fn GetAudioOptions(self: *const ISpRecoContext, pOptions: ?*SPAUDIOOPTIONS, pAudioFormatId: ?*Guid, ppCoMemWFEX: ?*?*WAVEFORMATEX) HRESULT {
        return self.vtable.GetAudioOptions(self, pOptions, pAudioFormatId, ppCoMemWFEX);
    }
    pub inline fn DeserializeResult(self: *const ISpRecoContext, pSerializedResult: ?*const SPSERIALIZEDRESULT, ppResult: ?*?*ISpRecoResult) HRESULT {
        return self.vtable.DeserializeResult(self, pSerializedResult, ppResult);
    }
    pub inline fn Bookmark(self: *const ISpRecoContext, Options: SPBOOKMARKOPTIONS, ullStreamPosition: u64, lparamEvent: LPARAM) HRESULT {
        return self.vtable.Bookmark(self, Options, ullStreamPosition, lparamEvent);
    }
    pub inline fn SetAdaptationData(self: *const ISpRecoContext, pAdaptationData: ?[*:0]const u16, cch: u32) HRESULT {
        return self.vtable.SetAdaptationData(self, pAdaptationData, cch);
    }
    pub inline fn Pause(self: *const ISpRecoContext, dwReserved: u32) HRESULT {
        return self.vtable.Pause(self, dwReserved);
    }
    pub inline fn Resume(self: *const ISpRecoContext, dwReserved: u32) HRESULT {
        return self.vtable.Resume(self, dwReserved);
    }
    pub inline fn SetVoice(self: *const ISpRecoContext, pVoice: ?*ISpVoice, fAllowFormatChanges: BOOL) HRESULT {
        return self.vtable.SetVoice(self, pVoice, fAllowFormatChanges);
    }
    pub inline fn GetVoice(self: *const ISpRecoContext, ppVoice: ?*?*ISpVoice) HRESULT {
        return self.vtable.GetVoice(self, ppVoice);
    }
    pub inline fn SetVoicePurgeEvent(self: *const ISpRecoContext, ullEventInterest: u64) HRESULT {
        return self.vtable.SetVoicePurgeEvent(self, ullEventInterest);
    }
    pub inline fn GetVoicePurgeEvent(self: *const ISpRecoContext, pullEventInterest: ?*u64) HRESULT {
        return self.vtable.GetVoicePurgeEvent(self, pullEventInterest);
    }
    pub inline fn SetContextState(self: *const ISpRecoContext, eContextState: SPCONTEXTSTATE) HRESULT {
        return self.vtable.SetContextState(self, eContextState);
    }
    pub inline fn GetContextState(self: *const ISpRecoContext, peContextState: ?*SPCONTEXTSTATE) HRESULT {
...
pub const ISpRecoContext2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetGrammarOptions(self: *const ISpRecoContext2, eGrammarOptions: u32) HRESULT {
        return self.vtable.SetGrammarOptions(self, eGrammarOptions);
    }
    pub inline fn GetGrammarOptions(self: *const ISpRecoContext2, peGrammarOptions: ?*u32) HRESULT {
        return self.vtable.GetGrammarOptions(self, peGrammarOptions);
    }
    pub inline fn SetAdaptationData2(self: *const ISpRecoContext2, pAdaptationData: ?[*:0]const u16, cch: u32, pTopicName: ?[*:0]const u16, eAdaptationSettings: u32, eRelevance: SPADAPTATIONRELEVANCE) HRESULT {
...
pub const ISpProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetPropertyNum(self: *const ISpProperties, pName: ?[*:0]const u16, lValue: i32) HRESULT {
        return self.vtable.SetPropertyNum(self, pName, lValue);
    }
    pub inline fn GetPropertyNum(self: *const ISpProperties, pName: ?[*:0]const u16, plValue: ?*i32) HRESULT {
        return self.vtable.GetPropertyNum(self, pName, plValue);
    }
    pub inline fn SetPropertyString(self: *const ISpProperties, pName: ?[*:0]const u16, pValue: ?[*:0]const u16) HRESULT {
        return self.vtable.SetPropertyString(self, pName, pValue);
    }
    pub inline fn GetPropertyString(self: *const ISpProperties, pName: ?[*:0]const u16, ppCoMemValue: ?*?PWSTR) HRESULT {
...
pub const ISpRecognizer = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetRecognizer(self: *const ISpRecognizer, pRecognizer: ?*ISpObjectToken) HRESULT {
        return self.vtable.SetRecognizer(self, pRecognizer);
    }
    pub inline fn GetRecognizer(self: *const ISpRecognizer, ppRecognizer: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.GetRecognizer(self, ppRecognizer);
    }
    pub inline fn SetInput(self: *const ISpRecognizer, pUnkInput: ?*IUnknown, fAllowFormatChanges: BOOL) HRESULT {
        return self.vtable.SetInput(self, pUnkInput, fAllowFormatChanges);
    }
    pub inline fn GetInputObjectToken(self: *const ISpRecognizer, ppToken: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.GetInputObjectToken(self, ppToken);
    }
    pub inline fn GetInputStream(self: *const ISpRecognizer, ppStream: ?*?*ISpStreamFormat) HRESULT {
        return self.vtable.GetInputStream(self, ppStream);
    }
    pub inline fn CreateRecoContext(self: *const ISpRecognizer, ppNewCtxt: ?*?*ISpRecoContext) HRESULT {
        return self.vtable.CreateRecoContext(self, ppNewCtxt);
    }
    pub inline fn GetRecoProfile(self: *const ISpRecognizer, ppToken: ?*?*ISpObjectToken) HRESULT {
        return self.vtable.GetRecoProfile(self, ppToken);
    }
    pub inline fn SetRecoProfile(self: *const ISpRecognizer, pToken: ?*ISpObjectToken) HRESULT {
        return self.vtable.SetRecoProfile(self, pToken);
    }
    pub inline fn IsSharedInstance(self: *const ISpRecognizer) HRESULT {
        return self.vtable.IsSharedInstance(self);
    }
    pub inline fn GetRecoState(self: *const ISpRecognizer, pState: ?*SPRECOSTATE) HRESULT {
        return self.vtable.GetRecoState(self, pState);
    }
    pub inline fn SetRecoState(self: *const ISpRecognizer, NewState: SPRECOSTATE) HRESULT {
        return self.vtable.SetRecoState(self, NewState);
    }
    pub inline fn GetStatus(self: *const ISpRecognizer, pStatus: ?*SPRECOGNIZERSTATUS) HRESULT {
        return self.vtable.GetStatus(self, pStatus);
    }
    pub inline fn GetFormat(self: *const ISpRecognizer, WaveFormatType: SPWAVEFORMATTYPE, pFormatId: ?*Guid, ppCoMemWFEX: ?*?*WAVEFORMATEX) HRESULT {
        return self.vtable.GetFormat(self, WaveFormatType, pFormatId, ppCoMemWFEX);
    }
    pub inline fn IsUISupported(self: *const ISpRecognizer, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32, pfSupported: ?*BOOL) HRESULT {
        return self.vtable.IsUISupported(self, pszTypeOfUI, pvExtraData, cbExtraData, pfSupported);
    }
    pub inline fn DisplayUI(self: *const ISpRecognizer, hwndParent: ?HWND, pszTitle: ?[*:0]const u16, pszTypeOfUI: ?[*:0]const u16, pvExtraData: ?*anyopaque, cbExtraData: u32) HRESULT {
        return self.vtable.DisplayUI(self, hwndParent, pszTitle, pszTypeOfUI, pvExtraData, cbExtraData);
    }
    pub inline fn EmulateRecognition(self: *const ISpRecognizer, pPhrase: ?*ISpPhrase) HRESULT {
...
pub const ISpSerializeState = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSerializedState(self: *const ISpSerializeState, ppbData: ?*?*u8, pulSize: ?*u32, dwReserved: u32) HRESULT {
        return self.vtable.GetSerializedState(self, ppbData, pulSize, dwReserved);
    }
    pub inline fn SetSerializedState(self: *const ISpSerializeState, pbData: ?*u8, ulSize: u32, dwReserved: u32) HRESULT {
...
pub const ISpRecognizer2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn EmulateRecognitionEx(self: *const ISpRecognizer2, pPhrase: ?*ISpPhrase, dwCompareFlags: u32) HRESULT {
        return self.vtable.EmulateRecognitionEx(self, pPhrase, dwCompareFlags);
    }
    pub inline fn SetTrainingState(self: *const ISpRecognizer2, fDoingTraining: BOOL, fAdaptFromTrainingData: BOOL) HRESULT {
        return self.vtable.SetTrainingState(self, fDoingTraining, fAdaptFromTrainingData);
    }
    pub inline fn ResetAcousticModelAdaptation(self: *const ISpRecognizer2) HRESULT {
...
pub const ISpEnginePronunciation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Normalize(self: *const ISpEnginePronunciation, pszWord: ?[*:0]const u16, pszLeftContext: ?[*:0]const u16, pszRightContext: ?[*:0]const u16, LangID: u16, pNormalizationList: ?*SPNORMALIZATIONLIST) HRESULT {
        return self.vtable.Normalize(self, pszWord, pszLeftContext, pszRightContext, LangID, pNormalizationList);
    }
    pub inline fn GetPronunciations(self: *const ISpEnginePronunciation, pszWord: ?[*:0]const u16, pszLeftContext: ?[*:0]const u16, pszRightContext: ?[*:0]const u16, LangID: u16, pEnginePronunciationList: ?*SPWORDPRONUNCIATIONLIST) HRESULT {
...
pub const ISpDisplayAlternates = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetDisplayAlternates(self: *const ISpDisplayAlternates, pPhrase: ?*const SPDISPLAYPHRASE, cRequestCount: u32, ppCoMemPhrases: ?*?*SPDISPLAYPHRASE, pcPhrasesReturned: ?*u32) HRESULT {
        return self.vtable.GetDisplayAlternates(self, pPhrase, cRequestCount, ppCoMemPhrases, pcPhrasesReturned);
    }
    pub inline fn SetFullStopTrailSpace(self: *const ISpDisplayAlternates, ulTrailSpace: u32) HRESULT {
...
pub const ISpeechDataKey = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn SetBinaryValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: VARIANT) HRESULT {
        return self.vtable.SetBinaryValue(self, ValueName, Value);
    }
    pub inline fn GetBinaryValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: ?*VARIANT) HRESULT {
        return self.vtable.GetBinaryValue(self, ValueName, Value);
    }
    pub inline fn SetStringValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: ?BSTR) HRESULT {
        return self.vtable.SetStringValue(self, ValueName, Value);
    }
    pub inline fn GetStringValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: ?*?BSTR) HRESULT {
        return self.vtable.GetStringValue(self, ValueName, Value);
    }
    pub inline fn SetLongValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: i32) HRESULT {
        return self.vtable.SetLongValue(self, ValueName, Value);
    }
    pub inline fn GetLongValue(self: *const ISpeechDataKey, ValueName: ?BSTR, Value: ?*i32) HRESULT {
        return self.vtable.GetLongValue(self, ValueName, Value);
    }
    pub inline fn OpenKey(self: *const ISpeechDataKey, SubKeyName: ?BSTR, SubKey: ?*?*ISpeechDataKey) HRESULT {
        return self.vtable.OpenKey(self, SubKeyName, SubKey);
    }
    pub inline fn CreateKey(self: *const ISpeechDataKey, SubKeyName: ?BSTR, SubKey: ?*?*ISpeechDataKey) HRESULT {
        return self.vtable.CreateKey(self, SubKeyName, SubKey);
    }
    pub inline fn DeleteKey(self: *const ISpeechDataKey, SubKeyName: ?BSTR) HRESULT {
        return self.vtable.DeleteKey(self, SubKeyName);
    }
    pub inline fn DeleteValue(self: *const ISpeechDataKey, ValueName: ?BSTR) HRESULT {
        return self.vtable.DeleteValue(self, ValueName);
    }
    pub inline fn EnumKeys(self: *const ISpeechDataKey, Index: i32, SubKeyName: ?*?BSTR) HRESULT {
        return self.vtable.EnumKeys(self, Index, SubKeyName);
    }
    pub inline fn EnumValues(self: *const ISpeechDataKey, Index: i32, ValueName: ?*?BSTR) HRESULT {
...
pub const ISpeechObjectToken = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Id(self: *const ISpeechObjectToken, ObjectId: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, ObjectId);
    }
    pub inline fn get_DataKey(self: *const ISpeechObjectToken, DataKey: ?*?*ISpeechDataKey) HRESULT {
        return self.vtable.get_DataKey(self, DataKey);
    }
    pub inline fn get_Category(self: *const ISpeechObjectToken, Category: ?*?*ISpeechObjectTokenCategory) HRESULT {
        return self.vtable.get_Category(self, Category);
    }
    pub inline fn GetDescription(self: *const ISpeechObjectToken, Locale: i32, Description: ?*?BSTR) HRESULT {
        return self.vtable.GetDescription(self, Locale, Description);
    }
    pub inline fn SetId(self: *const ISpeechObjectToken, Id: ?BSTR, CategoryID: ?BSTR, CreateIfNotExist: i16) HRESULT {
        return self.vtable.SetId(self, Id, CategoryID, CreateIfNotExist);
    }
    pub inline fn GetAttribute(self: *const ISpeechObjectToken, AttributeName: ?BSTR, AttributeValue: ?*?BSTR) HRESULT {
        return self.vtable.GetAttribute(self, AttributeName, AttributeValue);
    }
    pub inline fn CreateInstance(self: *const ISpeechObjectToken, pUnkOuter: ?*IUnknown, ClsContext: SpeechTokenContext, Object: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateInstance(self, pUnkOuter, ClsContext, Object);
    }
    pub inline fn Remove(self: *const ISpeechObjectToken, ObjectStorageCLSID: ?BSTR) HRESULT {
        return self.vtable.Remove(self, ObjectStorageCLSID);
    }
    pub inline fn GetStorageFileName(self: *const ISpeechObjectToken, ObjectStorageCLSID: ?BSTR, KeyName: ?BSTR, FileName: ?BSTR, Folder: SpeechTokenShellFolder, FilePath: ?*?BSTR) HRESULT {
        return self.vtable.GetStorageFileName(self, ObjectStorageCLSID, KeyName, FileName, Folder, FilePath);
    }
    pub inline fn RemoveStorageFileName(self: *const ISpeechObjectToken, ObjectStorageCLSID: ?BSTR, KeyName: ?BSTR, DeleteFileA: i16) HRESULT {
        return self.vtable.RemoveStorageFileName(self, ObjectStorageCLSID, KeyName, DeleteFileA);
    }
    pub inline fn IsUISupported(self: *const ISpeechObjectToken, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Object: ?*IUnknown, Supported: ?*i16) HRESULT {
        return self.vtable.IsUISupported(self, TypeOfUI, ExtraData, Object, Supported);
    }
    pub inline fn DisplayUI(self: *const ISpeechObjectToken, hWnd: i32, Title: ?BSTR, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Object: ?*IUnknown) HRESULT {
        return self.vtable.DisplayUI(self, hWnd, Title, TypeOfUI, ExtraData, Object);
    }
    pub inline fn MatchesAttributes(self: *const ISpeechObjectToken, Attributes: ?BSTR, Matches: ?*i16) HRESULT {
...
pub const ISpeechObjectTokens = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechObjectTokens, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechObjectTokens, Index: i32, Token: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.Item(self, Index, Token);
    }
    pub inline fn get__NewEnum(self: *const ISpeechObjectTokens, ppEnumVARIANT: ?*?*IUnknown) HRESULT {
...
pub const ISpeechObjectTokenCategory = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Id(self: *const ISpeechObjectTokenCategory, Id: ?*?BSTR) HRESULT {
        return self.vtable.get_Id(self, Id);
    }
    pub inline fn put_Default(self: *const ISpeechObjectTokenCategory, TokenId: ?BSTR) HRESULT {
        return self.vtable.put_Default(self, TokenId);
    }
    pub inline fn get_Default(self: *const ISpeechObjectTokenCategory, TokenId: ?*?BSTR) HRESULT {
        return self.vtable.get_Default(self, TokenId);
    }
    pub inline fn SetId(self: *const ISpeechObjectTokenCategory, Id: ?BSTR, CreateIfNotExist: i16) HRESULT {
        return self.vtable.SetId(self, Id, CreateIfNotExist);
    }
    pub inline fn GetDataKey(self: *const ISpeechObjectTokenCategory, Location: SpeechDataKeyLocation, DataKey: ?*?*ISpeechDataKey) HRESULT {
        return self.vtable.GetDataKey(self, Location, DataKey);
    }
    pub inline fn EnumerateTokens(self: *const ISpeechObjectTokenCategory, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, Tokens: ?*?*ISpeechObjectTokens) HRESULT {
...
pub const ISpeechAudioBufferInfo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_MinNotification(self: *const ISpeechAudioBufferInfo, MinNotification: ?*i32) HRESULT {
        return self.vtable.get_MinNotification(self, MinNotification);
    }
    pub inline fn put_MinNotification(self: *const ISpeechAudioBufferInfo, MinNotification: i32) HRESULT {
        return self.vtable.put_MinNotification(self, MinNotification);
    }
    pub inline fn get_BufferSize(self: *const ISpeechAudioBufferInfo, BufferSize: ?*i32) HRESULT {
        return self.vtable.get_BufferSize(self, BufferSize);
    }
    pub inline fn put_BufferSize(self: *const ISpeechAudioBufferInfo, BufferSize: i32) HRESULT {
        return self.vtable.put_BufferSize(self, BufferSize);
    }
    pub inline fn get_EventBias(self: *const ISpeechAudioBufferInfo, EventBias: ?*i32) HRESULT {
        return self.vtable.get_EventBias(self, EventBias);
    }
    pub inline fn put_EventBias(self: *const ISpeechAudioBufferInfo, EventBias: i32) HRESULT {
...
pub const ISpeechAudioStatus = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FreeBufferSpace(self: *const ISpeechAudioStatus, FreeBufferSpace: ?*i32) HRESULT {
        return self.vtable.get_FreeBufferSpace(self, FreeBufferSpace);
    }
    pub inline fn get_NonBlockingIO(self: *const ISpeechAudioStatus, NonBlockingIO: ?*i32) HRESULT {
        return self.vtable.get_NonBlockingIO(self, NonBlockingIO);
    }
    pub inline fn get_State(self: *const ISpeechAudioStatus, State: ?*SpeechAudioState) HRESULT {
        return self.vtable.get_State(self, State);
    }
    pub inline fn get_CurrentSeekPosition(self: *const ISpeechAudioStatus, CurrentSeekPosition: ?*VARIANT) HRESULT {
        return self.vtable.get_CurrentSeekPosition(self, CurrentSeekPosition);
    }
    pub inline fn get_CurrentDevicePosition(self: *const ISpeechAudioStatus, CurrentDevicePosition: ?*VARIANT) HRESULT {
...
pub const ISpeechAudioFormat = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Type(self: *const ISpeechAudioFormat, AudioFormat: ?*SpeechAudioFormatType) HRESULT {
        return self.vtable.get_Type(self, AudioFormat);
    }
    pub inline fn put_Type(self: *const ISpeechAudioFormat, AudioFormat: SpeechAudioFormatType) HRESULT {
        return self.vtable.put_Type(self, AudioFormat);
    }
    pub inline fn get_Guid(self: *const ISpeechAudioFormat, _param_Guid: ?*?BSTR) HRESULT {
        return self.vtable.get_Guid(self, _param_Guid);
    }
    pub inline fn put_Guid(self: *const ISpeechAudioFormat, _param_Guid: ?BSTR) HRESULT {
        return self.vtable.put_Guid(self, _param_Guid);
    }
    pub inline fn GetWaveFormatEx(self: *const ISpeechAudioFormat, SpeechWaveFormatEx: ?*?*ISpeechWaveFormatEx) HRESULT {
        return self.vtable.GetWaveFormatEx(self, SpeechWaveFormatEx);
    }
    pub inline fn SetWaveFormatEx(self: *const ISpeechAudioFormat, SpeechWaveFormatEx: ?*ISpeechWaveFormatEx) HRESULT {
...
pub const ISpeechWaveFormatEx = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FormatTag(self: *const ISpeechWaveFormatEx, FormatTag: ?*i16) HRESULT {
        return self.vtable.get_FormatTag(self, FormatTag);
    }
    pub inline fn put_FormatTag(self: *const ISpeechWaveFormatEx, FormatTag: i16) HRESULT {
        return self.vtable.put_FormatTag(self, FormatTag);
    }
    pub inline fn get_Channels(self: *const ISpeechWaveFormatEx, Channels: ?*i16) HRESULT {
        return self.vtable.get_Channels(self, Channels);
    }
    pub inline fn put_Channels(self: *const ISpeechWaveFormatEx, Channels: i16) HRESULT {
        return self.vtable.put_Channels(self, Channels);
    }
    pub inline fn get_SamplesPerSec(self: *const ISpeechWaveFormatEx, SamplesPerSec: ?*i32) HRESULT {
        return self.vtable.get_SamplesPerSec(self, SamplesPerSec);
    }
    pub inline fn put_SamplesPerSec(self: *const ISpeechWaveFormatEx, SamplesPerSec: i32) HRESULT {
        return self.vtable.put_SamplesPerSec(self, SamplesPerSec);
    }
    pub inline fn get_AvgBytesPerSec(self: *const ISpeechWaveFormatEx, AvgBytesPerSec: ?*i32) HRESULT {
        return self.vtable.get_AvgBytesPerSec(self, AvgBytesPerSec);
    }
    pub inline fn put_AvgBytesPerSec(self: *const ISpeechWaveFormatEx, AvgBytesPerSec: i32) HRESULT {
        return self.vtable.put_AvgBytesPerSec(self, AvgBytesPerSec);
    }
    pub inline fn get_BlockAlign(self: *const ISpeechWaveFormatEx, BlockAlign: ?*i16) HRESULT {
        return self.vtable.get_BlockAlign(self, BlockAlign);
    }
    pub inline fn put_BlockAlign(self: *const ISpeechWaveFormatEx, BlockAlign: i16) HRESULT {
        return self.vtable.put_BlockAlign(self, BlockAlign);
    }
    pub inline fn get_BitsPerSample(self: *const ISpeechWaveFormatEx, BitsPerSample: ?*i16) HRESULT {
        return self.vtable.get_BitsPerSample(self, BitsPerSample);
    }
    pub inline fn put_BitsPerSample(self: *const ISpeechWaveFormatEx, BitsPerSample: i16) HRESULT {
        return self.vtable.put_BitsPerSample(self, BitsPerSample);
    }
    pub inline fn get_ExtraData(self: *const ISpeechWaveFormatEx, ExtraData: ?*VARIANT) HRESULT {
        return self.vtable.get_ExtraData(self, ExtraData);
    }
    pub inline fn put_ExtraData(self: *const ISpeechWaveFormatEx, ExtraData: VARIANT) HRESULT {
...
pub const ISpeechBaseStream = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Format(self: *const ISpeechBaseStream, AudioFormat: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.get_Format(self, AudioFormat);
    }
    pub inline fn putref_Format(self: *const ISpeechBaseStream, AudioFormat: ?*ISpeechAudioFormat) HRESULT {
        return self.vtable.putref_Format(self, AudioFormat);
    }
    pub inline fn Read(self: *const ISpeechBaseStream, Buffer: ?*VARIANT, NumberOfBytes: i32, BytesRead: ?*i32) HRESULT {
        return self.vtable.Read(self, Buffer, NumberOfBytes, BytesRead);
    }
    pub inline fn Write(self: *const ISpeechBaseStream, Buffer: VARIANT, BytesWritten: ?*i32) HRESULT {
        return self.vtable.Write(self, Buffer, BytesWritten);
    }
    pub inline fn Seek(self: *const ISpeechBaseStream, Position: VARIANT, Origin: SpeechStreamSeekPositionType, NewPosition: ?*VARIANT) HRESULT {
...
pub const ISpeechFileStream = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Open(self: *const ISpeechFileStream, FileName: ?BSTR, FileMode: SpeechStreamFileMode, DoEvents: i16) HRESULT {
        return self.vtable.Open(self, FileName, FileMode, DoEvents);
    }
    pub inline fn Close(self: *const ISpeechFileStream) HRESULT {
        return self.vtable.Close(self);
    }
};
...
pub const ISpeechMemoryStream = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn SetData(self: *const ISpeechMemoryStream, Data: VARIANT) HRESULT {
        return self.vtable.SetData(self, Data);
    }
    pub inline fn GetData(self: *const ISpeechMemoryStream, pData: ?*VARIANT) HRESULT {
...
pub const ISpeechCustomStream = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BaseStream(self: *const ISpeechCustomStream, ppUnkStream: ?*?*IUnknown) HRESULT {
        return self.vtable.get_BaseStream(self, ppUnkStream);
    }
    pub inline fn putref_BaseStream(self: *const ISpeechCustomStream, pUnkStream: ?*IUnknown) HRESULT {
...
pub const ISpeechAudio = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const ISpeechAudio, Status: ?*?*ISpeechAudioStatus) HRESULT {
        return self.vtable.get_Status(self, Status);
    }
    pub inline fn get_BufferInfo(self: *const ISpeechAudio, BufferInfo: ?*?*ISpeechAudioBufferInfo) HRESULT {
        return self.vtable.get_BufferInfo(self, BufferInfo);
    }
    pub inline fn get_DefaultFormat(self: *const ISpeechAudio, StreamFormat: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.get_DefaultFormat(self, StreamFormat);
    }
    pub inline fn get_Volume(self: *const ISpeechAudio, Volume: ?*i32) HRESULT {
        return self.vtable.get_Volume(self, Volume);
    }
    pub inline fn put_Volume(self: *const ISpeechAudio, Volume: i32) HRESULT {
        return self.vtable.put_Volume(self, Volume);
    }
    pub inline fn get_BufferNotifySize(self: *const ISpeechAudio, BufferNotifySize: ?*i32) HRESULT {
        return self.vtable.get_BufferNotifySize(self, BufferNotifySize);
    }
    pub inline fn put_BufferNotifySize(self: *const ISpeechAudio, BufferNotifySize: i32) HRESULT {
        return self.vtable.put_BufferNotifySize(self, BufferNotifySize);
    }
    pub inline fn get_EventHandle(self: *const ISpeechAudio, EventHandle: ?*i32) HRESULT {
        return self.vtable.get_EventHandle(self, EventHandle);
    }
    pub inline fn SetState(self: *const ISpeechAudio, State: SpeechAudioState) HRESULT {
...
pub const ISpeechMMSysAudio = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DeviceId(self: *const ISpeechMMSysAudio, DeviceId: ?*i32) HRESULT {
        return self.vtable.get_DeviceId(self, DeviceId);
    }
    pub inline fn put_DeviceId(self: *const ISpeechMMSysAudio, DeviceId: i32) HRESULT {
        return self.vtable.put_DeviceId(self, DeviceId);
    }
    pub inline fn get_LineId(self: *const ISpeechMMSysAudio, LineId: ?*i32) HRESULT {
        return self.vtable.get_LineId(self, LineId);
    }
    pub inline fn put_LineId(self: *const ISpeechMMSysAudio, LineId: i32) HRESULT {
        return self.vtable.put_LineId(self, LineId);
    }
    pub inline fn get_MMHandle(self: *const ISpeechMMSysAudio, Handle: ?*i32) HRESULT {
...
pub const ISpeechVoice = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const ISpeechVoice, Status: ?*?*ISpeechVoiceStatus) HRESULT {
        return self.vtable.get_Status(self, Status);
    }
    pub inline fn get_Voice(self: *const ISpeechVoice, Voice: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.get_Voice(self, Voice);
    }
    pub inline fn putref_Voice(self: *const ISpeechVoice, Voice: ?*ISpeechObjectToken) HRESULT {
        return self.vtable.putref_Voice(self, Voice);
    }
    pub inline fn get_AudioOutput(self: *const ISpeechVoice, AudioOutput: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.get_AudioOutput(self, AudioOutput);
    }
    pub inline fn putref_AudioOutput(self: *const ISpeechVoice, AudioOutput: ?*ISpeechObjectToken) HRESULT {
        return self.vtable.putref_AudioOutput(self, AudioOutput);
    }
    pub inline fn get_AudioOutputStream(self: *const ISpeechVoice, AudioOutputStream: ?*?*ISpeechBaseStream) HRESULT {
        return self.vtable.get_AudioOutputStream(self, AudioOutputStream);
    }
    pub inline fn putref_AudioOutputStream(self: *const ISpeechVoice, AudioOutputStream: ?*ISpeechBaseStream) HRESULT {
        return self.vtable.putref_AudioOutputStream(self, AudioOutputStream);
    }
    pub inline fn get_Rate(self: *const ISpeechVoice, Rate: ?*i32) HRESULT {
        return self.vtable.get_Rate(self, Rate);
    }
    pub inline fn put_Rate(self: *const ISpeechVoice, Rate: i32) HRESULT {
        return self.vtable.put_Rate(self, Rate);
    }
    pub inline fn get_Volume(self: *const ISpeechVoice, Volume: ?*i32) HRESULT {
        return self.vtable.get_Volume(self, Volume);
    }
    pub inline fn put_Volume(self: *const ISpeechVoice, Volume: i32) HRESULT {
        return self.vtable.put_Volume(self, Volume);
    }
    pub inline fn put_AllowAudioOutputFormatChangesOnNextSet(self: *const ISpeechVoice, Allow: i16) HRESULT {
        return self.vtable.put_AllowAudioOutputFormatChangesOnNextSet(self, Allow);
    }
    pub inline fn get_AllowAudioOutputFormatChangesOnNextSet(self: *const ISpeechVoice, Allow: ?*i16) HRESULT {
        return self.vtable.get_AllowAudioOutputFormatChangesOnNextSet(self, Allow);
    }
    pub inline fn get_EventInterests(self: *const ISpeechVoice, EventInterestFlags: ?*SpeechVoiceEvents) HRESULT {
        return self.vtable.get_EventInterests(self, EventInterestFlags);
    }
    pub inline fn put_EventInterests(self: *const ISpeechVoice, EventInterestFlags: SpeechVoiceEvents) HRESULT {
        return self.vtable.put_EventInterests(self, EventInterestFlags);
    }
    pub inline fn put_Priority(self: *const ISpeechVoice, Priority: SpeechVoicePriority) HRESULT {
        return self.vtable.put_Priority(self, Priority);
    }
    pub inline fn get_Priority(self: *const ISpeechVoice, Priority: ?*SpeechVoicePriority) HRESULT {
        return self.vtable.get_Priority(self, Priority);
    }
    pub inline fn put_AlertBoundary(self: *const ISpeechVoice, Boundary: SpeechVoiceEvents) HRESULT {
        return self.vtable.put_AlertBoundary(self, Boundary);
    }
    pub inline fn get_AlertBoundary(self: *const ISpeechVoice, Boundary: ?*SpeechVoiceEvents) HRESULT {
        return self.vtable.get_AlertBoundary(self, Boundary);
    }
    pub inline fn put_SynchronousSpeakTimeout(self: *const ISpeechVoice, msTimeout: i32) HRESULT {
        return self.vtable.put_SynchronousSpeakTimeout(self, msTimeout);
    }
    pub inline fn get_SynchronousSpeakTimeout(self: *const ISpeechVoice, msTimeout: ?*i32) HRESULT {
        return self.vtable.get_SynchronousSpeakTimeout(self, msTimeout);
    }
    pub inline fn Speak(self: *const ISpeechVoice, Text: ?BSTR, Flags: SpeechVoiceSpeakFlags, StreamNumber: ?*i32) HRESULT {
        return self.vtable.Speak(self, Text, Flags, StreamNumber);
    }
    pub inline fn SpeakStream(self: *const ISpeechVoice, Stream: ?*ISpeechBaseStream, Flags: SpeechVoiceSpeakFlags, StreamNumber: ?*i32) HRESULT {
        return self.vtable.SpeakStream(self, Stream, Flags, StreamNumber);
    }
    pub inline fn Pause(self: *const ISpeechVoice) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn Resume(self: *const ISpeechVoice) HRESULT {
        return self.vtable.Resume(self);
    }
    pub inline fn Skip(self: *const ISpeechVoice, Type: ?BSTR, NumItems: i32, NumSkipped: ?*i32) HRESULT {
        return self.vtable.Skip(self, Type, NumItems, NumSkipped);
    }
    pub inline fn GetVoices(self: *const ISpeechVoice, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, ObjectTokens: ?*?*ISpeechObjectTokens) HRESULT {
        return self.vtable.GetVoices(self, RequiredAttributes, OptionalAttributes, ObjectTokens);
    }
    pub inline fn GetAudioOutputs(self: *const ISpeechVoice, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, ObjectTokens: ?*?*ISpeechObjectTokens) HRESULT {
        return self.vtable.GetAudioOutputs(self, RequiredAttributes, OptionalAttributes, ObjectTokens);
    }
    pub inline fn WaitUntilDone(self: *const ISpeechVoice, msTimeout: i32, Done: ?*i16) HRESULT {
        return self.vtable.WaitUntilDone(self, msTimeout, Done);
    }
    pub inline fn SpeakCompleteEvent(self: *const ISpeechVoice, Handle: ?*i32) HRESULT {
        return self.vtable.SpeakCompleteEvent(self, Handle);
    }
    pub inline fn IsUISupported(self: *const ISpeechVoice, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Supported: ?*i16) HRESULT {
        return self.vtable.IsUISupported(self, TypeOfUI, ExtraData, Supported);
    }
    pub inline fn DisplayUI(self: *const ISpeechVoice, hWndParent: i32, Title: ?BSTR, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT) HRESULT {
...
pub const ISpeechVoiceStatus = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_CurrentStreamNumber(self: *const ISpeechVoiceStatus, StreamNumber: ?*i32) HRESULT {
        return self.vtable.get_CurrentStreamNumber(self, StreamNumber);
    }
    pub inline fn get_LastStreamNumberQueued(self: *const ISpeechVoiceStatus, StreamNumber: ?*i32) HRESULT {
        return self.vtable.get_LastStreamNumberQueued(self, StreamNumber);
    }
    pub inline fn get_LastHResult(self: *const ISpeechVoiceStatus, HResult: ?*i32) HRESULT {
        return self.vtable.get_LastHResult(self, HResult);
    }
    pub inline fn get_RunningState(self: *const ISpeechVoiceStatus, State: ?*SpeechRunState) HRESULT {
        return self.vtable.get_RunningState(self, State);
    }
    pub inline fn get_InputWordPosition(self: *const ISpeechVoiceStatus, Position: ?*i32) HRESULT {
        return self.vtable.get_InputWordPosition(self, Position);
    }
    pub inline fn get_InputWordLength(self: *const ISpeechVoiceStatus, Length: ?*i32) HRESULT {
        return self.vtable.get_InputWordLength(self, Length);
    }
    pub inline fn get_InputSentencePosition(self: *const ISpeechVoiceStatus, Position: ?*i32) HRESULT {
        return self.vtable.get_InputSentencePosition(self, Position);
    }
    pub inline fn get_InputSentenceLength(self: *const ISpeechVoiceStatus, Length: ?*i32) HRESULT {
        return self.vtable.get_InputSentenceLength(self, Length);
    }
    pub inline fn get_LastBookmark(self: *const ISpeechVoiceStatus, Bookmark: ?*?BSTR) HRESULT {
        return self.vtable.get_LastBookmark(self, Bookmark);
    }
    pub inline fn get_LastBookmarkId(self: *const ISpeechVoiceStatus, BookmarkId: ?*i32) HRESULT {
        return self.vtable.get_LastBookmarkId(self, BookmarkId);
    }
    pub inline fn get_PhonemeId(self: *const ISpeechVoiceStatus, PhoneId: ?*i16) HRESULT {
        return self.vtable.get_PhonemeId(self, PhoneId);
    }
    pub inline fn get_VisemeId(self: *const ISpeechVoiceStatus, VisemeId: ?*i16) HRESULT {
...
pub const ISpeechRecognizer = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn putref_Recognizer(self: *const ISpeechRecognizer, Recognizer: ?*ISpeechObjectToken) HRESULT {
        return self.vtable.putref_Recognizer(self, Recognizer);
    }
    pub inline fn get_Recognizer(self: *const ISpeechRecognizer, Recognizer: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.get_Recognizer(self, Recognizer);
    }
    pub inline fn put_AllowAudioInputFormatChangesOnNextSet(self: *const ISpeechRecognizer, Allow: i16) HRESULT {
        return self.vtable.put_AllowAudioInputFormatChangesOnNextSet(self, Allow);
    }
    pub inline fn get_AllowAudioInputFormatChangesOnNextSet(self: *const ISpeechRecognizer, Allow: ?*i16) HRESULT {
        return self.vtable.get_AllowAudioInputFormatChangesOnNextSet(self, Allow);
    }
    pub inline fn putref_AudioInput(self: *const ISpeechRecognizer, AudioInput: ?*ISpeechObjectToken) HRESULT {
        return self.vtable.putref_AudioInput(self, AudioInput);
    }
    pub inline fn get_AudioInput(self: *const ISpeechRecognizer, AudioInput: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.get_AudioInput(self, AudioInput);
    }
    pub inline fn putref_AudioInputStream(self: *const ISpeechRecognizer, AudioInputStream: ?*ISpeechBaseStream) HRESULT {
        return self.vtable.putref_AudioInputStream(self, AudioInputStream);
    }
    pub inline fn get_AudioInputStream(self: *const ISpeechRecognizer, AudioInputStream: ?*?*ISpeechBaseStream) HRESULT {
        return self.vtable.get_AudioInputStream(self, AudioInputStream);
    }
    pub inline fn get_IsShared(self: *const ISpeechRecognizer, Shared: ?*i16) HRESULT {
        return self.vtable.get_IsShared(self, Shared);
    }
    pub inline fn put_State(self: *const ISpeechRecognizer, State: SpeechRecognizerState) HRESULT {
        return self.vtable.put_State(self, State);
    }
    pub inline fn get_State(self: *const ISpeechRecognizer, State: ?*SpeechRecognizerState) HRESULT {
        return self.vtable.get_State(self, State);
    }
    pub inline fn get_Status(self: *const ISpeechRecognizer, Status: ?*?*ISpeechRecognizerStatus) HRESULT {
        return self.vtable.get_Status(self, Status);
    }
    pub inline fn putref_Profile(self: *const ISpeechRecognizer, Profile: ?*ISpeechObjectToken) HRESULT {
        return self.vtable.putref_Profile(self, Profile);
    }
    pub inline fn get_Profile(self: *const ISpeechRecognizer, Profile: ?*?*ISpeechObjectToken) HRESULT {
        return self.vtable.get_Profile(self, Profile);
    }
    pub inline fn EmulateRecognition(self: *const ISpeechRecognizer, TextElements: VARIANT, ElementDisplayAttributes: ?*VARIANT, LanguageId: i32) HRESULT {
        return self.vtable.EmulateRecognition(self, TextElements, ElementDisplayAttributes, LanguageId);
    }
    pub inline fn CreateRecoContext(self: *const ISpeechRecognizer, NewContext: ?*?*ISpeechRecoContext) HRESULT {
        return self.vtable.CreateRecoContext(self, NewContext);
    }
    pub inline fn GetFormat(self: *const ISpeechRecognizer, Type: SpeechFormatType, Format: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.GetFormat(self, Type, Format);
    }
    pub inline fn SetPropertyNumber(self: *const ISpeechRecognizer, Name: ?BSTR, Value: i32, Supported: ?*i16) HRESULT {
        return self.vtable.SetPropertyNumber(self, Name, Value, Supported);
    }
    pub inline fn GetPropertyNumber(self: *const ISpeechRecognizer, Name: ?BSTR, Value: ?*i32, Supported: ?*i16) HRESULT {
        return self.vtable.GetPropertyNumber(self, Name, Value, Supported);
    }
    pub inline fn SetPropertyString(self: *const ISpeechRecognizer, Name: ?BSTR, Value: ?BSTR, Supported: ?*i16) HRESULT {
        return self.vtable.SetPropertyString(self, Name, Value, Supported);
    }
    pub inline fn GetPropertyString(self: *const ISpeechRecognizer, Name: ?BSTR, Value: ?*?BSTR, Supported: ?*i16) HRESULT {
        return self.vtable.GetPropertyString(self, Name, Value, Supported);
    }
    pub inline fn IsUISupported(self: *const ISpeechRecognizer, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT, Supported: ?*i16) HRESULT {
        return self.vtable.IsUISupported(self, TypeOfUI, ExtraData, Supported);
    }
    pub inline fn DisplayUI(self: *const ISpeechRecognizer, hWndParent: i32, Title: ?BSTR, TypeOfUI: ?BSTR, ExtraData: ?*const VARIANT) HRESULT {
        return self.vtable.DisplayUI(self, hWndParent, Title, TypeOfUI, ExtraData);
    }
    pub inline fn GetRecognizers(self: *const ISpeechRecognizer, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, ObjectTokens: ?*?*ISpeechObjectTokens) HRESULT {
        return self.vtable.GetRecognizers(self, RequiredAttributes, OptionalAttributes, ObjectTokens);
    }
    pub inline fn GetAudioInputs(self: *const ISpeechRecognizer, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, ObjectTokens: ?*?*ISpeechObjectTokens) HRESULT {
        return self.vtable.GetAudioInputs(self, RequiredAttributes, OptionalAttributes, ObjectTokens);
    }
    pub inline fn GetProfiles(self: *const ISpeechRecognizer, RequiredAttributes: ?BSTR, OptionalAttributes: ?BSTR, ObjectTokens: ?*?*ISpeechObjectTokens) HRESULT {
...
pub const ISpeechRecognizerStatus = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_AudioStatus(self: *const ISpeechRecognizerStatus, AudioStatus: ?*?*ISpeechAudioStatus) HRESULT {
        return self.vtable.get_AudioStatus(self, AudioStatus);
    }
    pub inline fn get_CurrentStreamPosition(self: *const ISpeechRecognizerStatus, pCurrentStreamPos: ?*VARIANT) HRESULT {
        return self.vtable.get_CurrentStreamPosition(self, pCurrentStreamPos);
    }
    pub inline fn get_CurrentStreamNumber(self: *const ISpeechRecognizerStatus, StreamNumber: ?*i32) HRESULT {
        return self.vtable.get_CurrentStreamNumber(self, StreamNumber);
    }
    pub inline fn get_NumberOfActiveRules(self: *const ISpeechRecognizerStatus, NumberOfActiveRules: ?*i32) HRESULT {
        return self.vtable.get_NumberOfActiveRules(self, NumberOfActiveRules);
    }
    pub inline fn get_ClsidEngine(self: *const ISpeechRecognizerStatus, ClsidEngine: ?*?BSTR) HRESULT {
        return self.vtable.get_ClsidEngine(self, ClsidEngine);
    }
    pub inline fn get_SupportedLanguages(self: *const ISpeechRecognizerStatus, SupportedLanguages: ?*VARIANT) HRESULT {
...
pub const ISpeechRecoContext = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Recognizer(self: *const ISpeechRecoContext, Recognizer: ?*?*ISpeechRecognizer) HRESULT {
        return self.vtable.get_Recognizer(self, Recognizer);
    }
    pub inline fn get_AudioInputInterferenceStatus(self: *const ISpeechRecoContext, Interference: ?*SpeechInterference) HRESULT {
        return self.vtable.get_AudioInputInterferenceStatus(self, Interference);
    }
    pub inline fn get_RequestedUIType(self: *const ISpeechRecoContext, UIType: ?*?BSTR) HRESULT {
        return self.vtable.get_RequestedUIType(self, UIType);
    }
    pub inline fn putref_Voice(self: *const ISpeechRecoContext, Voice: ?*ISpeechVoice) HRESULT {
        return self.vtable.putref_Voice(self, Voice);
    }
    pub inline fn get_Voice(self: *const ISpeechRecoContext, Voice: ?*?*ISpeechVoice) HRESULT {
        return self.vtable.get_Voice(self, Voice);
    }
    pub inline fn put_AllowVoiceFormatMatchingOnNextSet(self: *const ISpeechRecoContext, Allow: i16) HRESULT {
        return self.vtable.put_AllowVoiceFormatMatchingOnNextSet(self, Allow);
    }
    pub inline fn get_AllowVoiceFormatMatchingOnNextSet(self: *const ISpeechRecoContext, pAllow: ?*i16) HRESULT {
        return self.vtable.get_AllowVoiceFormatMatchingOnNextSet(self, pAllow);
    }
    pub inline fn put_VoicePurgeEvent(self: *const ISpeechRecoContext, EventInterest: SpeechRecoEvents) HRESULT {
        return self.vtable.put_VoicePurgeEvent(self, EventInterest);
    }
    pub inline fn get_VoicePurgeEvent(self: *const ISpeechRecoContext, EventInterest: ?*SpeechRecoEvents) HRESULT {
        return self.vtable.get_VoicePurgeEvent(self, EventInterest);
    }
    pub inline fn put_EventInterests(self: *const ISpeechRecoContext, EventInterest: SpeechRecoEvents) HRESULT {
        return self.vtable.put_EventInterests(self, EventInterest);
    }
    pub inline fn get_EventInterests(self: *const ISpeechRecoContext, EventInterest: ?*SpeechRecoEvents) HRESULT {
        return self.vtable.get_EventInterests(self, EventInterest);
    }
    pub inline fn put_CmdMaxAlternates(self: *const ISpeechRecoContext, MaxAlternates: i32) HRESULT {
        return self.vtable.put_CmdMaxAlternates(self, MaxAlternates);
    }
    pub inline fn get_CmdMaxAlternates(self: *const ISpeechRecoContext, MaxAlternates: ?*i32) HRESULT {
        return self.vtable.get_CmdMaxAlternates(self, MaxAlternates);
    }
    pub inline fn put_State(self: *const ISpeechRecoContext, State: SpeechRecoContextState) HRESULT {
        return self.vtable.put_State(self, State);
    }
    pub inline fn get_State(self: *const ISpeechRecoContext, State: ?*SpeechRecoContextState) HRESULT {
        return self.vtable.get_State(self, State);
    }
    pub inline fn put_RetainedAudio(self: *const ISpeechRecoContext, Option: SpeechRetainedAudioOptions) HRESULT {
        return self.vtable.put_RetainedAudio(self, Option);
    }
    pub inline fn get_RetainedAudio(self: *const ISpeechRecoContext, Option: ?*SpeechRetainedAudioOptions) HRESULT {
        return self.vtable.get_RetainedAudio(self, Option);
    }
    pub inline fn putref_RetainedAudioFormat(self: *const ISpeechRecoContext, Format: ?*ISpeechAudioFormat) HRESULT {
        return self.vtable.putref_RetainedAudioFormat(self, Format);
    }
    pub inline fn get_RetainedAudioFormat(self: *const ISpeechRecoContext, Format: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.get_RetainedAudioFormat(self, Format);
    }
    pub inline fn Pause(self: *const ISpeechRecoContext) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn Resume(self: *const ISpeechRecoContext) HRESULT {
        return self.vtable.Resume(self);
    }
    pub inline fn CreateGrammar(self: *const ISpeechRecoContext, GrammarId: VARIANT, Grammar: ?*?*ISpeechRecoGrammar) HRESULT {
        return self.vtable.CreateGrammar(self, GrammarId, Grammar);
    }
    pub inline fn CreateResultFromMemory(self: *const ISpeechRecoContext, ResultBlock: ?*VARIANT, Result: ?*?*ISpeechRecoResult) HRESULT {
        return self.vtable.CreateResultFromMemory(self, ResultBlock, Result);
    }
    pub inline fn Bookmark(self: *const ISpeechRecoContext, Options: SpeechBookmarkOptions, StreamPos: VARIANT, BookmarkId: VARIANT) HRESULT {
        return self.vtable.Bookmark(self, Options, StreamPos, BookmarkId);
    }
    pub inline fn SetAdaptationData(self: *const ISpeechRecoContext, AdaptationString: ?BSTR) HRESULT {
...
pub const ISpeechRecoGrammar = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Id(self: *const ISpeechRecoGrammar, Id: ?*VARIANT) HRESULT {
        return self.vtable.get_Id(self, Id);
    }
    pub inline fn get_RecoContext(self: *const ISpeechRecoGrammar, RecoContext: ?*?*ISpeechRecoContext) HRESULT {
        return self.vtable.get_RecoContext(self, RecoContext);
    }
    pub inline fn put_State(self: *const ISpeechRecoGrammar, State: SpeechGrammarState) HRESULT {
        return self.vtable.put_State(self, State);
    }
    pub inline fn get_State(self: *const ISpeechRecoGrammar, State: ?*SpeechGrammarState) HRESULT {
        return self.vtable.get_State(self, State);
    }
    pub inline fn get_Rules(self: *const ISpeechRecoGrammar, Rules: ?*?*ISpeechGrammarRules) HRESULT {
        return self.vtable.get_Rules(self, Rules);
    }
    pub inline fn Reset(self: *const ISpeechRecoGrammar, NewLanguage: i32) HRESULT {
        return self.vtable.Reset(self, NewLanguage);
    }
    pub inline fn CmdLoadFromFile(self: *const ISpeechRecoGrammar, FileName: ?BSTR, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.CmdLoadFromFile(self, FileName, LoadOption);
    }
    pub inline fn CmdLoadFromObject(self: *const ISpeechRecoGrammar, ClassId: ?BSTR, GrammarName: ?BSTR, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.CmdLoadFromObject(self, ClassId, GrammarName, LoadOption);
    }
    pub inline fn CmdLoadFromResource(self: *const ISpeechRecoGrammar, hModule: i32, ResourceName: VARIANT, ResourceType: VARIANT, LanguageId: i32, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.CmdLoadFromResource(self, hModule, ResourceName, ResourceType, LanguageId, LoadOption);
    }
    pub inline fn CmdLoadFromMemory(self: *const ISpeechRecoGrammar, GrammarData: VARIANT, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.CmdLoadFromMemory(self, GrammarData, LoadOption);
    }
    pub inline fn CmdLoadFromProprietaryGrammar(self: *const ISpeechRecoGrammar, ProprietaryGuid: ?BSTR, ProprietaryString: ?BSTR, ProprietaryData: VARIANT, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.CmdLoadFromProprietaryGrammar(self, ProprietaryGuid, ProprietaryString, ProprietaryData, LoadOption);
    }
    pub inline fn CmdSetRuleState(self: *const ISpeechRecoGrammar, Name: ?BSTR, State: SpeechRuleState) HRESULT {
        return self.vtable.CmdSetRuleState(self, Name, State);
    }
    pub inline fn CmdSetRuleIdState(self: *const ISpeechRecoGrammar, RuleId: i32, State: SpeechRuleState) HRESULT {
        return self.vtable.CmdSetRuleIdState(self, RuleId, State);
    }
    pub inline fn DictationLoad(self: *const ISpeechRecoGrammar, TopicName: ?BSTR, LoadOption: SpeechLoadOption) HRESULT {
        return self.vtable.DictationLoad(self, TopicName, LoadOption);
    }
    pub inline fn DictationUnload(self: *const ISpeechRecoGrammar) HRESULT {
        return self.vtable.DictationUnload(self);
    }
    pub inline fn DictationSetState(self: *const ISpeechRecoGrammar, State: SpeechRuleState) HRESULT {
        return self.vtable.DictationSetState(self, State);
    }
    pub inline fn SetWordSequenceData(self: *const ISpeechRecoGrammar, Text: ?BSTR, TextLength: i32, Info: ?*ISpeechTextSelectionInformation) HRESULT {
        return self.vtable.SetWordSequenceData(self, Text, TextLength, Info);
    }
    pub inline fn SetTextSelection(self: *const ISpeechRecoGrammar, Info: ?*ISpeechTextSelectionInformation) HRESULT {
        return self.vtable.SetTextSelection(self, Info);
    }
    pub inline fn IsPronounceable(self: *const ISpeechRecoGrammar, Word: ?BSTR, WordPronounceable: ?*SpeechWordPronounceable) HRESULT {
...
pub const ISpeechGrammarRule = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Attributes(self: *const ISpeechGrammarRule, Attributes: ?*SpeechRuleAttributes) HRESULT {
        return self.vtable.get_Attributes(self, Attributes);
    }
    pub inline fn get_InitialState(self: *const ISpeechGrammarRule, State: ?*?*ISpeechGrammarRuleState) HRESULT {
        return self.vtable.get_InitialState(self, State);
    }
    pub inline fn get_Name(self: *const ISpeechGrammarRule, Name: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, Name);
    }
    pub inline fn get_Id(self: *const ISpeechGrammarRule, Id: ?*i32) HRESULT {
        return self.vtable.get_Id(self, Id);
    }
    pub inline fn Clear(self: *const ISpeechGrammarRule) HRESULT {
        return self.vtable.Clear(self);
    }
    pub inline fn AddResource(self: *const ISpeechGrammarRule, ResourceName: ?BSTR, ResourceValue: ?BSTR) HRESULT {
        return self.vtable.AddResource(self, ResourceName, ResourceValue);
    }
    pub inline fn AddState(self: *const ISpeechGrammarRule, State: ?*?*ISpeechGrammarRuleState) HRESULT {
...
pub const ISpeechGrammarRules = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechGrammarRules, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn FindRule(self: *const ISpeechGrammarRules, RuleNameOrId: VARIANT, Rule: ?*?*ISpeechGrammarRule) HRESULT {
        return self.vtable.FindRule(self, RuleNameOrId, Rule);
    }
    pub inline fn Item(self: *const ISpeechGrammarRules, Index: i32, Rule: ?*?*ISpeechGrammarRule) HRESULT {
        return self.vtable.Item(self, Index, Rule);
    }
    pub inline fn get__NewEnum(self: *const ISpeechGrammarRules, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
    pub inline fn get_Dynamic(self: *const ISpeechGrammarRules, Dynamic: ?*i16) HRESULT {
        return self.vtable.get_Dynamic(self, Dynamic);
    }
    pub inline fn Add(self: *const ISpeechGrammarRules, RuleName: ?BSTR, Attributes: SpeechRuleAttributes, RuleId: i32, Rule: ?*?*ISpeechGrammarRule) HRESULT {
        return self.vtable.Add(self, RuleName, Attributes, RuleId, Rule);
    }
    pub inline fn Commit(self: *const ISpeechGrammarRules) HRESULT {
        return self.vtable.Commit(self);
    }
    pub inline fn CommitAndSave(self: *const ISpeechGrammarRules, ErrorText: ?*?BSTR, SaveStream: ?*VARIANT) HRESULT {
...
pub const ISpeechGrammarRuleState = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Rule(self: *const ISpeechGrammarRuleState, Rule: ?*?*ISpeechGrammarRule) HRESULT {
        return self.vtable.get_Rule(self, Rule);
    }
    pub inline fn get_Transitions(self: *const ISpeechGrammarRuleState, Transitions: ?*?*ISpeechGrammarRuleStateTransitions) HRESULT {
        return self.vtable.get_Transitions(self, Transitions);
    }
    pub inline fn AddWordTransition(self: *const ISpeechGrammarRuleState, DestState: ?*ISpeechGrammarRuleState, Words: ?BSTR, Separators: ?BSTR, Type: SpeechGrammarWordType, PropertyName: ?BSTR, PropertyId: i32, PropertyValue: ?*VARIANT, Weight: f32) HRESULT {
        return self.vtable.AddWordTransition(self, DestState, Words, Separators, Type, PropertyName, PropertyId, PropertyValue, Weight);
    }
    pub inline fn AddRuleTransition(self: *const ISpeechGrammarRuleState, DestinationState: ?*ISpeechGrammarRuleState, Rule: ?*ISpeechGrammarRule, PropertyName: ?BSTR, PropertyId: i32, PropertyValue: ?*VARIANT, Weight: f32) HRESULT {
        return self.vtable.AddRuleTransition(self, DestinationState, Rule, PropertyName, PropertyId, PropertyValue, Weight);
    }
    pub inline fn AddSpecialTransition(self: *const ISpeechGrammarRuleState, DestinationState: ?*ISpeechGrammarRuleState, Type: SpeechSpecialTransitionType, PropertyName: ?BSTR, PropertyId: i32, PropertyValue: ?*VARIANT, Weight: f32) HRESULT {
...
pub const ISpeechGrammarRuleStateTransition = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Type(self: *const ISpeechGrammarRuleStateTransition, Type: ?*SpeechGrammarRuleStateTransitionType) HRESULT {
        return self.vtable.get_Type(self, Type);
    }
    pub inline fn get_Text(self: *const ISpeechGrammarRuleStateTransition, Text: ?*?BSTR) HRESULT {
        return self.vtable.get_Text(self, Text);
    }
    pub inline fn get_Rule(self: *const ISpeechGrammarRuleStateTransition, Rule: ?*?*ISpeechGrammarRule) HRESULT {
        return self.vtable.get_Rule(self, Rule);
    }
    pub inline fn get_Weight(self: *const ISpeechGrammarRuleStateTransition, Weight: ?*VARIANT) HRESULT {
        return self.vtable.get_Weight(self, Weight);
    }
    pub inline fn get_PropertyName(self: *const ISpeechGrammarRuleStateTransition, PropertyName: ?*?BSTR) HRESULT {
        return self.vtable.get_PropertyName(self, PropertyName);
    }
    pub inline fn get_PropertyId(self: *const ISpeechGrammarRuleStateTransition, PropertyId: ?*i32) HRESULT {
        return self.vtable.get_PropertyId(self, PropertyId);
    }
    pub inline fn get_PropertyValue(self: *const ISpeechGrammarRuleStateTransition, PropertyValue: ?*VARIANT) HRESULT {
        return self.vtable.get_PropertyValue(self, PropertyValue);
    }
    pub inline fn get_NextState(self: *const ISpeechGrammarRuleStateTransition, NextState: ?*?*ISpeechGrammarRuleState) HRESULT {
...
pub const ISpeechGrammarRuleStateTransitions = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechGrammarRuleStateTransitions, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechGrammarRuleStateTransitions, Index: i32, Transition: ?*?*ISpeechGrammarRuleStateTransition) HRESULT {
        return self.vtable.Item(self, Index, Transition);
    }
    pub inline fn get__NewEnum(self: *const ISpeechGrammarRuleStateTransitions, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechTextSelectionInformation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_ActiveOffset(self: *const ISpeechTextSelectionInformation, ActiveOffset: i32) HRESULT {
        return self.vtable.put_ActiveOffset(self, ActiveOffset);
    }
    pub inline fn get_ActiveOffset(self: *const ISpeechTextSelectionInformation, ActiveOffset: ?*i32) HRESULT {
        return self.vtable.get_ActiveOffset(self, ActiveOffset);
    }
    pub inline fn put_ActiveLength(self: *const ISpeechTextSelectionInformation, ActiveLength: i32) HRESULT {
        return self.vtable.put_ActiveLength(self, ActiveLength);
    }
    pub inline fn get_ActiveLength(self: *const ISpeechTextSelectionInformation, ActiveLength: ?*i32) HRESULT {
        return self.vtable.get_ActiveLength(self, ActiveLength);
    }
    pub inline fn put_SelectionOffset(self: *const ISpeechTextSelectionInformation, SelectionOffset: i32) HRESULT {
        return self.vtable.put_SelectionOffset(self, SelectionOffset);
    }
    pub inline fn get_SelectionOffset(self: *const ISpeechTextSelectionInformation, SelectionOffset: ?*i32) HRESULT {
        return self.vtable.get_SelectionOffset(self, SelectionOffset);
    }
    pub inline fn put_SelectionLength(self: *const ISpeechTextSelectionInformation, SelectionLength: i32) HRESULT {
        return self.vtable.put_SelectionLength(self, SelectionLength);
    }
    pub inline fn get_SelectionLength(self: *const ISpeechTextSelectionInformation, SelectionLength: ?*i32) HRESULT {
...
pub const ISpeechRecoResult = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_RecoContext(self: *const ISpeechRecoResult, RecoContext: ?*?*ISpeechRecoContext) HRESULT {
        return self.vtable.get_RecoContext(self, RecoContext);
    }
    pub inline fn get_Times(self: *const ISpeechRecoResult, Times: ?*?*ISpeechRecoResultTimes) HRESULT {
        return self.vtable.get_Times(self, Times);
    }
    pub inline fn putref_AudioFormat(self: *const ISpeechRecoResult, Format: ?*ISpeechAudioFormat) HRESULT {
        return self.vtable.putref_AudioFormat(self, Format);
    }
    pub inline fn get_AudioFormat(self: *const ISpeechRecoResult, Format: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.get_AudioFormat(self, Format);
    }
    pub inline fn get_PhraseInfo(self: *const ISpeechRecoResult, PhraseInfo: ?*?*ISpeechPhraseInfo) HRESULT {
        return self.vtable.get_PhraseInfo(self, PhraseInfo);
    }
    pub inline fn Alternates(self: *const ISpeechRecoResult, RequestCount: i32, StartElement: i32, Elements: i32, _param_Alternates: ?*?*ISpeechPhraseAlternates) HRESULT {
        return self.vtable.Alternates(self, RequestCount, StartElement, Elements, _param_Alternates);
    }
    pub inline fn Audio(self: *const ISpeechRecoResult, StartElement: i32, Elements: i32, Stream: ?*?*ISpeechMemoryStream) HRESULT {
        return self.vtable.Audio(self, StartElement, Elements, Stream);
    }
    pub inline fn SpeakAudio(self: *const ISpeechRecoResult, StartElement: i32, Elements: i32, Flags: SpeechVoiceSpeakFlags, StreamNumber: ?*i32) HRESULT {
        return self.vtable.SpeakAudio(self, StartElement, Elements, Flags, StreamNumber);
    }
    pub inline fn SaveToMemory(self: *const ISpeechRecoResult, ResultBlock: ?*VARIANT) HRESULT {
        return self.vtable.SaveToMemory(self, ResultBlock);
    }
    pub inline fn DiscardResultInfo(self: *const ISpeechRecoResult, ValueTypes: SpeechDiscardType) HRESULT {
...
pub const ISpeechRecoResult2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn SetTextFeedback(self: *const ISpeechRecoResult2, Feedback: ?BSTR, WasSuccessful: i16) HRESULT {
...
pub const ISpeechRecoResultTimes = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_StreamTime(self: *const ISpeechRecoResultTimes, Time: ?*VARIANT) HRESULT {
        return self.vtable.get_StreamTime(self, Time);
    }
    pub inline fn get_Length(self: *const ISpeechRecoResultTimes, Length: ?*VARIANT) HRESULT {
        return self.vtable.get_Length(self, Length);
    }
    pub inline fn get_TickCount(self: *const ISpeechRecoResultTimes, TickCount: ?*i32) HRESULT {
        return self.vtable.get_TickCount(self, TickCount);
    }
    pub inline fn get_OffsetFromStart(self: *const ISpeechRecoResultTimes, OffsetFromStart: ?*VARIANT) HRESULT {
...
pub const ISpeechPhraseAlternate = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_RecoResult(self: *const ISpeechPhraseAlternate, RecoResult: ?*?*ISpeechRecoResult) HRESULT {
        return self.vtable.get_RecoResult(self, RecoResult);
    }
    pub inline fn get_StartElementInResult(self: *const ISpeechPhraseAlternate, StartElement: ?*i32) HRESULT {
        return self.vtable.get_StartElementInResult(self, StartElement);
    }
    pub inline fn get_NumberOfElementsInResult(self: *const ISpeechPhraseAlternate, NumberOfElements: ?*i32) HRESULT {
        return self.vtable.get_NumberOfElementsInResult(self, NumberOfElements);
    }
    pub inline fn get_PhraseInfo(self: *const ISpeechPhraseAlternate, PhraseInfo: ?*?*ISpeechPhraseInfo) HRESULT {
        return self.vtable.get_PhraseInfo(self, PhraseInfo);
    }
    pub inline fn Commit(self: *const ISpeechPhraseAlternate) HRESULT {
        return self.vtable.Commit(self);
    }
};
...
pub const ISpeechPhraseAlternates = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechPhraseAlternates, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechPhraseAlternates, Index: i32, PhraseAlternate: ?*?*ISpeechPhraseAlternate) HRESULT {
        return self.vtable.Item(self, Index, PhraseAlternate);
    }
    pub inline fn get__NewEnum(self: *const ISpeechPhraseAlternates, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechPhraseInfo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_LanguageId(self: *const ISpeechPhraseInfo, LanguageId: ?*i32) HRESULT {
        return self.vtable.get_LanguageId(self, LanguageId);
    }
    pub inline fn get_GrammarId(self: *const ISpeechPhraseInfo, GrammarId: ?*VARIANT) HRESULT {
        return self.vtable.get_GrammarId(self, GrammarId);
    }
    pub inline fn get_StartTime(self: *const ISpeechPhraseInfo, StartTime: ?*VARIANT) HRESULT {
        return self.vtable.get_StartTime(self, StartTime);
    }
    pub inline fn get_AudioStreamPosition(self: *const ISpeechPhraseInfo, AudioStreamPosition: ?*VARIANT) HRESULT {
        return self.vtable.get_AudioStreamPosition(self, AudioStreamPosition);
    }
    pub inline fn get_AudioSizeBytes(self: *const ISpeechPhraseInfo, pAudioSizeBytes: ?*i32) HRESULT {
        return self.vtable.get_AudioSizeBytes(self, pAudioSizeBytes);
    }
    pub inline fn get_RetainedSizeBytes(self: *const ISpeechPhraseInfo, RetainedSizeBytes: ?*i32) HRESULT {
        return self.vtable.get_RetainedSizeBytes(self, RetainedSizeBytes);
    }
    pub inline fn get_AudioSizeTime(self: *const ISpeechPhraseInfo, AudioSizeTime: ?*i32) HRESULT {
        return self.vtable.get_AudioSizeTime(self, AudioSizeTime);
    }
    pub inline fn get_Rule(self: *const ISpeechPhraseInfo, Rule: ?*?*ISpeechPhraseRule) HRESULT {
        return self.vtable.get_Rule(self, Rule);
    }
    pub inline fn get_Properties(self: *const ISpeechPhraseInfo, Properties: ?*?*ISpeechPhraseProperties) HRESULT {
        return self.vtable.get_Properties(self, Properties);
    }
    pub inline fn get_Elements(self: *const ISpeechPhraseInfo, Elements: ?*?*ISpeechPhraseElements) HRESULT {
        return self.vtable.get_Elements(self, Elements);
    }
    pub inline fn get_Replacements(self: *const ISpeechPhraseInfo, Replacements: ?*?*ISpeechPhraseReplacements) HRESULT {
        return self.vtable.get_Replacements(self, Replacements);
    }
    pub inline fn get_EngineId(self: *const ISpeechPhraseInfo, EngineIdGuid: ?*?BSTR) HRESULT {
        return self.vtable.get_EngineId(self, EngineIdGuid);
    }
    pub inline fn get_EnginePrivateData(self: *const ISpeechPhraseInfo, PrivateData: ?*VARIANT) HRESULT {
        return self.vtable.get_EnginePrivateData(self, PrivateData);
    }
    pub inline fn SaveToMemory(self: *const ISpeechPhraseInfo, PhraseBlock: ?*VARIANT) HRESULT {
        return self.vtable.SaveToMemory(self, PhraseBlock);
    }
    pub inline fn GetText(self: *const ISpeechPhraseInfo, StartElement: i32, Elements: i32, UseReplacements: i16, Text: ?*?BSTR) HRESULT {
        return self.vtable.GetText(self, StartElement, Elements, UseReplacements, Text);
    }
    pub inline fn GetDisplayAttributes(self: *const ISpeechPhraseInfo, StartElement: i32, Elements: i32, UseReplacements: i16, DisplayAttributes: ?*SpeechDisplayAttributes) HRESULT {
...
pub const ISpeechPhraseElement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_AudioTimeOffset(self: *const ISpeechPhraseElement, AudioTimeOffset: ?*i32) HRESULT {
        return self.vtable.get_AudioTimeOffset(self, AudioTimeOffset);
    }
    pub inline fn get_AudioSizeTime(self: *const ISpeechPhraseElement, AudioSizeTime: ?*i32) HRESULT {
        return self.vtable.get_AudioSizeTime(self, AudioSizeTime);
    }
    pub inline fn get_AudioStreamOffset(self: *const ISpeechPhraseElement, AudioStreamOffset: ?*i32) HRESULT {
        return self.vtable.get_AudioStreamOffset(self, AudioStreamOffset);
    }
    pub inline fn get_AudioSizeBytes(self: *const ISpeechPhraseElement, AudioSizeBytes: ?*i32) HRESULT {
        return self.vtable.get_AudioSizeBytes(self, AudioSizeBytes);
    }
    pub inline fn get_RetainedStreamOffset(self: *const ISpeechPhraseElement, RetainedStreamOffset: ?*i32) HRESULT {
        return self.vtable.get_RetainedStreamOffset(self, RetainedStreamOffset);
    }
    pub inline fn get_RetainedSizeBytes(self: *const ISpeechPhraseElement, RetainedSizeBytes: ?*i32) HRESULT {
        return self.vtable.get_RetainedSizeBytes(self, RetainedSizeBytes);
    }
    pub inline fn get_DisplayText(self: *const ISpeechPhraseElement, DisplayText: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayText(self, DisplayText);
    }
    pub inline fn get_LexicalForm(self: *const ISpeechPhraseElement, LexicalForm: ?*?BSTR) HRESULT {
        return self.vtable.get_LexicalForm(self, LexicalForm);
    }
    pub inline fn get_Pronunciation(self: *const ISpeechPhraseElement, Pronunciation: ?*VARIANT) HRESULT {
        return self.vtable.get_Pronunciation(self, Pronunciation);
    }
    pub inline fn get_DisplayAttributes(self: *const ISpeechPhraseElement, DisplayAttributes: ?*SpeechDisplayAttributes) HRESULT {
        return self.vtable.get_DisplayAttributes(self, DisplayAttributes);
    }
    pub inline fn get_RequiredConfidence(self: *const ISpeechPhraseElement, RequiredConfidence: ?*SpeechEngineConfidence) HRESULT {
        return self.vtable.get_RequiredConfidence(self, RequiredConfidence);
    }
    pub inline fn get_ActualConfidence(self: *const ISpeechPhraseElement, ActualConfidence: ?*SpeechEngineConfidence) HRESULT {
        return self.vtable.get_ActualConfidence(self, ActualConfidence);
    }
    pub inline fn get_EngineConfidence(self: *const ISpeechPhraseElement, EngineConfidence: ?*f32) HRESULT {
...
pub const ISpeechPhraseElements = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechPhraseElements, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechPhraseElements, Index: i32, Element: ?*?*ISpeechPhraseElement) HRESULT {
        return self.vtable.Item(self, Index, Element);
    }
    pub inline fn get__NewEnum(self: *const ISpeechPhraseElements, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechPhraseReplacement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DisplayAttributes(self: *const ISpeechPhraseReplacement, DisplayAttributes: ?*SpeechDisplayAttributes) HRESULT {
        return self.vtable.get_DisplayAttributes(self, DisplayAttributes);
    }
    pub inline fn get_Text(self: *const ISpeechPhraseReplacement, Text: ?*?BSTR) HRESULT {
        return self.vtable.get_Text(self, Text);
    }
    pub inline fn get_FirstElement(self: *const ISpeechPhraseReplacement, FirstElement: ?*i32) HRESULT {
        return self.vtable.get_FirstElement(self, FirstElement);
    }
    pub inline fn get_NumberOfElements(self: *const ISpeechPhraseReplacement, NumberOfElements: ?*i32) HRESULT {
...
pub const ISpeechPhraseReplacements = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechPhraseReplacements, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechPhraseReplacements, Index: i32, Reps: ?*?*ISpeechPhraseReplacement) HRESULT {
        return self.vtable.Item(self, Index, Reps);
    }
    pub inline fn get__NewEnum(self: *const ISpeechPhraseReplacements, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechPhraseProperty = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const ISpeechPhraseProperty, Name: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, Name);
    }
    pub inline fn get_Id(self: *const ISpeechPhraseProperty, Id: ?*i32) HRESULT {
        return self.vtable.get_Id(self, Id);
    }
    pub inline fn get_Value(self: *const ISpeechPhraseProperty, Value: ?*VARIANT) HRESULT {
        return self.vtable.get_Value(self, Value);
    }
    pub inline fn get_FirstElement(self: *const ISpeechPhraseProperty, FirstElement: ?*i32) HRESULT {
        return self.vtable.get_FirstElement(self, FirstElement);
    }
    pub inline fn get_NumberOfElements(self: *const ISpeechPhraseProperty, NumberOfElements: ?*i32) HRESULT {
        return self.vtable.get_NumberOfElements(self, NumberOfElements);
    }
    pub inline fn get_EngineConfidence(self: *const ISpeechPhraseProperty, Confidence: ?*f32) HRESULT {
        return self.vtable.get_EngineConfidence(self, Confidence);
    }
    pub inline fn get_Confidence(self: *const ISpeechPhraseProperty, Confidence: ?*SpeechEngineConfidence) HRESULT {
        return self.vtable.get_Confidence(self, Confidence);
    }
    pub inline fn get_Parent(self: *const ISpeechPhraseProperty, ParentProperty: ?*?*ISpeechPhraseProperty) HRESULT {
        return self.vtable.get_Parent(self, ParentProperty);
    }
    pub inline fn get_Children(self: *const ISpeechPhraseProperty, Children: ?*?*ISpeechPhraseProperties) HRESULT {
...
pub const ISpeechPhraseProperties = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechPhraseProperties, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechPhraseProperties, Index: i32, Property: ?*?*ISpeechPhraseProperty) HRESULT {
        return self.vtable.Item(self, Index, Property);
    }
    pub inline fn get__NewEnum(self: *const ISpeechPhraseProperties, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechPhraseRule = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const ISpeechPhraseRule, Name: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, Name);
    }
    pub inline fn get_Id(self: *const ISpeechPhraseRule, Id: ?*i32) HRESULT {
        return self.vtable.get_Id(self, Id);
    }
    pub inline fn get_FirstElement(self: *const ISpeechPhraseRule, FirstElement: ?*i32) HRESULT {
        return self.vtable.get_FirstElement(self, FirstElement);
    }
    pub inline fn get_NumberOfElements(self: *const ISpeechPhraseRule, NumberOfElements: ?*i32) HRESULT {
        return self.vtable.get_NumberOfElements(self, NumberOfElements);
    }
    pub inline fn get_Parent(self: *const ISpeechPhraseRule, Parent: ?*?*ISpeechPhraseRule) HRESULT {
        return self.vtable.get_Parent(self, Parent);
    }
    pub inline fn get_Children(self: *const ISpeechPhraseRule, Children: ?*?*ISpeechPhraseRules) HRESULT {
        return self.vtable.get_Children(self, Children);
    }
    pub inline fn get_Confidence(self: *const ISpeechPhraseRule, ActualConfidence: ?*SpeechEngineConfidence) HRESULT {
        return self.vtable.get_Confidence(self, ActualConfidence);
    }
    pub inline fn get_EngineConfidence(self: *const ISpeechPhraseRule, EngineConfidence: ?*f32) HRESULT {
        return self.vtable.get_EngineConfidence(self, EngineConfidence);
    }
};
...
pub const ISpeechPhraseRules = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechPhraseRules, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechPhraseRules, Index: i32, Rule: ?*?*ISpeechPhraseRule) HRESULT {
        return self.vtable.Item(self, Index, Rule);
    }
    pub inline fn get__NewEnum(self: *const ISpeechPhraseRules, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechLexicon = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_GenerationId(self: *const ISpeechLexicon, GenerationId: ?*i32) HRESULT {
        return self.vtable.get_GenerationId(self, GenerationId);
    }
    pub inline fn GetWords(self: *const ISpeechLexicon, Flags: SpeechLexiconType, GenerationID: ?*i32, Words: ?*?*ISpeechLexiconWords) HRESULT {
        return self.vtable.GetWords(self, Flags, GenerationID, Words);
    }
    pub inline fn AddPronunciation(self: *const ISpeechLexicon, bstrWord: ?BSTR, LangId: i32, PartOfSpeech: SpeechPartOfSpeech, bstrPronunciation: ?BSTR) HRESULT {
        return self.vtable.AddPronunciation(self, bstrWord, LangId, PartOfSpeech, bstrPronunciation);
    }
    pub inline fn AddPronunciationByPhoneIds(self: *const ISpeechLexicon, bstrWord: ?BSTR, LangId: i32, PartOfSpeech: SpeechPartOfSpeech, PhoneIds: ?*VARIANT) HRESULT {
        return self.vtable.AddPronunciationByPhoneIds(self, bstrWord, LangId, PartOfSpeech, PhoneIds);
    }
    pub inline fn RemovePronunciation(self: *const ISpeechLexicon, bstrWord: ?BSTR, LangId: i32, PartOfSpeech: SpeechPartOfSpeech, bstrPronunciation: ?BSTR) HRESULT {
        return self.vtable.RemovePronunciation(self, bstrWord, LangId, PartOfSpeech, bstrPronunciation);
    }
    pub inline fn RemovePronunciationByPhoneIds(self: *const ISpeechLexicon, bstrWord: ?BSTR, LangId: i32, PartOfSpeech: SpeechPartOfSpeech, PhoneIds: ?*VARIANT) HRESULT {
        return self.vtable.RemovePronunciationByPhoneIds(self, bstrWord, LangId, PartOfSpeech, PhoneIds);
    }
    pub inline fn GetPronunciations(self: *const ISpeechLexicon, bstrWord: ?BSTR, LangId: i32, TypeFlags: SpeechLexiconType, ppPronunciations: ?*?*ISpeechLexiconPronunciations) HRESULT {
        return self.vtable.GetPronunciations(self, bstrWord, LangId, TypeFlags, ppPronunciations);
    }
    pub inline fn GetGenerationChange(self: *const ISpeechLexicon, GenerationID: ?*i32, ppWords: ?*?*ISpeechLexiconWords) HRESULT {
...
pub const ISpeechLexiconWords = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechLexiconWords, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechLexiconWords, Index: i32, Word: ?*?*ISpeechLexiconWord) HRESULT {
        return self.vtable.Item(self, Index, Word);
    }
    pub inline fn get__NewEnum(self: *const ISpeechLexiconWords, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechLexiconWord = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_LangId(self: *const ISpeechLexiconWord, LangId: ?*i32) HRESULT {
        return self.vtable.get_LangId(self, LangId);
    }
    pub inline fn get_Type(self: *const ISpeechLexiconWord, WordType: ?*SpeechWordType) HRESULT {
        return self.vtable.get_Type(self, WordType);
    }
    pub inline fn get_Word(self: *const ISpeechLexiconWord, Word: ?*?BSTR) HRESULT {
        return self.vtable.get_Word(self, Word);
    }
    pub inline fn get_Pronunciations(self: *const ISpeechLexiconWord, Pronunciations: ?*?*ISpeechLexiconPronunciations) HRESULT {
...
pub const ISpeechLexiconPronunciations = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const ISpeechLexiconPronunciations, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn Item(self: *const ISpeechLexiconPronunciations, Index: i32, Pronunciation: ?*?*ISpeechLexiconPronunciation) HRESULT {
        return self.vtable.Item(self, Index, Pronunciation);
    }
    pub inline fn get__NewEnum(self: *const ISpeechLexiconPronunciations, EnumVARIANT: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, EnumVARIANT);
    }
};
...
pub const ISpeechLexiconPronunciation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Type(self: *const ISpeechLexiconPronunciation, LexiconType: ?*SpeechLexiconType) HRESULT {
        return self.vtable.get_Type(self, LexiconType);
    }
    pub inline fn get_LangId(self: *const ISpeechLexiconPronunciation, LangId: ?*i32) HRESULT {
        return self.vtable.get_LangId(self, LangId);
    }
    pub inline fn get_PartOfSpeech(self: *const ISpeechLexiconPronunciation, PartOfSpeech: ?*SpeechPartOfSpeech) HRESULT {
        return self.vtable.get_PartOfSpeech(self, PartOfSpeech);
    }
    pub inline fn get_PhoneIds(self: *const ISpeechLexiconPronunciation, PhoneIds: ?*VARIANT) HRESULT {
        return self.vtable.get_PhoneIds(self, PhoneIds);
    }
    pub inline fn get_Symbolic(self: *const ISpeechLexiconPronunciation, Symbolic: ?*?BSTR) HRESULT {
...
pub const ISpeechXMLRecoResult = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetXMLResult(self: *const ISpeechXMLRecoResult, Options: SPXMLRESULTOPTIONS, pResult: ?*?BSTR) HRESULT {
        return self.vtable.GetXMLResult(self, Options, pResult);
    }
    pub inline fn GetXMLErrorInfo(self: *const ISpeechXMLRecoResult, LineNumber: ?*i32, ScriptLine: ?*?BSTR, Source: ?*?BSTR, Description: ?*?BSTR, ResultCode: ?*i32, IsError: ?*i16) HRESULT {
...
pub const ISpeechRecoResultDispatch = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_RecoContext(self: *const ISpeechRecoResultDispatch, RecoContext: ?*?*ISpeechRecoContext) HRESULT {
        return self.vtable.get_RecoContext(self, RecoContext);
    }
    pub inline fn get_Times(self: *const ISpeechRecoResultDispatch, Times: ?*?*ISpeechRecoResultTimes) HRESULT {
        return self.vtable.get_Times(self, Times);
    }
    pub inline fn putref_AudioFormat(self: *const ISpeechRecoResultDispatch, Format: ?*ISpeechAudioFormat) HRESULT {
        return self.vtable.putref_AudioFormat(self, Format);
    }
    pub inline fn get_AudioFormat(self: *const ISpeechRecoResultDispatch, Format: ?*?*ISpeechAudioFormat) HRESULT {
        return self.vtable.get_AudioFormat(self, Format);
    }
    pub inline fn get_PhraseInfo(self: *const ISpeechRecoResultDispatch, PhraseInfo: ?*?*ISpeechPhraseInfo) HRESULT {
        return self.vtable.get_PhraseInfo(self, PhraseInfo);
    }
    pub inline fn Alternates(self: *const ISpeechRecoResultDispatch, RequestCount: i32, StartElement: i32, Elements: i32, _param_Alternates: ?*?*ISpeechPhraseAlternates) HRESULT {
        return self.vtable.Alternates(self, RequestCount, StartElement, Elements, _param_Alternates);
    }
    pub inline fn Audio(self: *const ISpeechRecoResultDispatch, StartElement: i32, Elements: i32, Stream: ?*?*ISpeechMemoryStream) HRESULT {
        return self.vtable.Audio(self, StartElement, Elements, Stream);
    }
    pub inline fn SpeakAudio(self: *const ISpeechRecoResultDispatch, StartElement: i32, Elements: i32, Flags: SpeechVoiceSpeakFlags, StreamNumber: ?*i32) HRESULT {
        return self.vtable.SpeakAudio(self, StartElement, Elements, Flags, StreamNumber);
    }
    pub inline fn SaveToMemory(self: *const ISpeechRecoResultDispatch, ResultBlock: ?*VARIANT) HRESULT {
        return self.vtable.SaveToMemory(self, ResultBlock);
    }
    pub inline fn DiscardResultInfo(self: *const ISpeechRecoResultDispatch, ValueTypes: SpeechDiscardType) HRESULT {
        return self.vtable.DiscardResultInfo(self, ValueTypes);
    }
    pub inline fn GetXMLResult(self: *const ISpeechRecoResultDispatch, Options: SPXMLRESULTOPTIONS, pResult: ?*?BSTR) HRESULT {
        return self.vtable.GetXMLResult(self, Options, pResult);
    }
    pub inline fn GetXMLErrorInfo(self: *const ISpeechRecoResultDispatch, LineNumber: ?*i32, ScriptLine: ?*?BSTR, Source: ?*?BSTR, Description: ?*?BSTR, ResultCode: ?*HRESULT, IsError: ?*i16) HRESULT {
        return self.vtable.GetXMLErrorInfo(self, LineNumber, ScriptLine, Source, Description, ResultCode, IsError);
    }
    pub inline fn SetTextFeedback(self: *const ISpeechRecoResultDispatch, Feedback: ?BSTR, WasSuccessful: i16) HRESULT {
        return self.vtable.SetTextFeedback(self, Feedback, WasSuccessful);
    }
};
...
pub const ISpeechPhraseInfoBuilder = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RestorePhraseFromMemory(self: *const ISpeechPhraseInfoBuilder, PhraseInMemory: ?*VARIANT, PhraseInfo: ?*?*ISpeechPhraseInfo) HRESULT {
...
pub const ISpeechPhoneConverter = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_LanguageId(self: *const ISpeechPhoneConverter, LanguageId: ?*i32) HRESULT {
        return self.vtable.get_LanguageId(self, LanguageId);
    }
    pub inline fn put_LanguageId(self: *const ISpeechPhoneConverter, LanguageId: i32) HRESULT {
        return self.vtable.put_LanguageId(self, LanguageId);
    }
    pub inline fn PhoneToId(self: *const ISpeechPhoneConverter, Phonemes: ?BSTR, IdArray: ?*VARIANT) HRESULT {
        return self.vtable.PhoneToId(self, Phonemes, IdArray);
    }
    pub inline fn IdToPhone(self: *const ISpeechPhoneConverter, IdArray: VARIANT, Phonemes: ?*?BSTR) HRESULT {
