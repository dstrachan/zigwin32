...
pub const IAudioEndpointFormatControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ResetToDefault(self: *const IAudioEndpointFormatControl, ResetFlags: u32) HRESULT {
...
pub const IAudioEndpointOffloadStreamVolume = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetVolumeChannelCount(self: *const IAudioEndpointOffloadStreamVolume, pu32ChannelCount: ?*u32) HRESULT {
        return self.vtable.GetVolumeChannelCount(self, pu32ChannelCount);
    }
    pub inline fn SetChannelVolumes(self: *const IAudioEndpointOffloadStreamVolume, u32ChannelCount: u32, pf32Volumes: ?*f32, u32CurveType: AUDIO_CURVE_TYPE, pCurveDuration: ?*i64) HRESULT {
        return self.vtable.SetChannelVolumes(self, u32ChannelCount, pf32Volumes, u32CurveType, pCurveDuration);
    }
    pub inline fn GetChannelVolumes(self: *const IAudioEndpointOffloadStreamVolume, u32ChannelCount: u32, pf32Volumes: ?*f32) HRESULT {
...
pub const IAudioEndpointOffloadStreamMute = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetMute(self: *const IAudioEndpointOffloadStreamMute, bMuted: u8) HRESULT {
        return self.vtable.SetMute(self, bMuted);
    }
    pub inline fn GetMute(self: *const IAudioEndpointOffloadStreamMute, pbMuted: ?*u8) HRESULT {
...
pub const IAudioEndpointOffloadStreamMeter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetMeterChannelCount(self: *const IAudioEndpointOffloadStreamMeter, pu32ChannelCount: ?*u32) HRESULT {
        return self.vtable.GetMeterChannelCount(self, pu32ChannelCount);
    }
    pub inline fn GetMeteringData(self: *const IAudioEndpointOffloadStreamMeter, u32ChannelCount: u32, pf32PeakValues: ?*f32) HRESULT {
...
pub const IAudioEndpointLastBufferControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsLastBufferControlSupported(self: *const IAudioEndpointLastBufferControl) BOOL {
        return self.vtable.IsLastBufferControlSupported(self);
    }
    pub inline fn ReleaseOutputDataPointerForLastBuffer(self: *const IAudioEndpointLastBufferControl, pConnectionProperty: ?*const APO_CONNECTION_PROPERTY) void {
...
pub const IAudioLfxControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetLocalEffectsState(self: *const IAudioLfxControl, bEnabled: BOOL) HRESULT {
        return self.vtable.SetLocalEffectsState(self, bEnabled);
    }
    pub inline fn GetLocalEffectsState(self: *const IAudioLfxControl, pbEnabled: ?*BOOL) HRESULT {
...
pub const IHardwareAudioEngineBase = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetAvailableOffloadConnectorCount(self: *const IHardwareAudioEngineBase, _pwstrDeviceId: ?PWSTR, _uConnectorId: u32, _pAvailableConnectorInstanceCount: ?*u32) HRESULT {
        return self.vtable.GetAvailableOffloadConnectorCount(self, _pwstrDeviceId, _uConnectorId, _pAvailableConnectorInstanceCount);
    }
    pub inline fn GetEngineFormat(self: *const IHardwareAudioEngineBase, pDevice: ?*IMMDevice, _bRequestDeviceFormat: BOOL, _ppwfxFormat: ?*?*WAVEFORMATEX) HRESULT {
        return self.vtable.GetEngineFormat(self, pDevice, _bRequestDeviceFormat, _ppwfxFormat);
    }
    pub inline fn SetEngineDeviceFormat(self: *const IHardwareAudioEngineBase, pDevice: ?*IMMDevice, _pwfxFormat: ?*WAVEFORMATEX) HRESULT {
        return self.vtable.SetEngineDeviceFormat(self, pDevice, _pwfxFormat);
    }
    pub inline fn SetGfxState(self: *const IHardwareAudioEngineBase, pDevice: ?*IMMDevice, _bEnable: BOOL) HRESULT {
        return self.vtable.SetGfxState(self, pDevice, _bEnable);
    }
    pub inline fn GetGfxState(self: *const IHardwareAudioEngineBase, pDevice: ?*IMMDevice, _pbEnable: ?*BOOL) HRESULT {
...
pub const IAudioEndpointVolumeCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnNotify(self: *const IAudioEndpointVolumeCallback, pNotify: ?*AUDIO_VOLUME_NOTIFICATION_DATA) HRESULT {
...
pub const IAudioEndpointVolume = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RegisterControlChangeNotify(self: *const IAudioEndpointVolume, pNotify: ?*IAudioEndpointVolumeCallback) HRESULT {
        return self.vtable.RegisterControlChangeNotify(self, pNotify);
    }
    pub inline fn UnregisterControlChangeNotify(self: *const IAudioEndpointVolume, pNotify: ?*IAudioEndpointVolumeCallback) HRESULT {
        return self.vtable.UnregisterControlChangeNotify(self, pNotify);
    }
    pub inline fn GetChannelCount(self: *const IAudioEndpointVolume, pnChannelCount: ?*u32) HRESULT {
        return self.vtable.GetChannelCount(self, pnChannelCount);
    }
    pub inline fn SetMasterVolumeLevel(self: *const IAudioEndpointVolume, fLevelDB: f32, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.SetMasterVolumeLevel(self, fLevelDB, pguidEventContext);
    }
    pub inline fn SetMasterVolumeLevelScalar(self: *const IAudioEndpointVolume, fLevel: f32, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.SetMasterVolumeLevelScalar(self, fLevel, pguidEventContext);
    }
    pub inline fn GetMasterVolumeLevel(self: *const IAudioEndpointVolume, pfLevelDB: ?*f32) HRESULT {
        return self.vtable.GetMasterVolumeLevel(self, pfLevelDB);
    }
    pub inline fn GetMasterVolumeLevelScalar(self: *const IAudioEndpointVolume, pfLevel: ?*f32) HRESULT {
        return self.vtable.GetMasterVolumeLevelScalar(self, pfLevel);
    }
    pub inline fn SetChannelVolumeLevel(self: *const IAudioEndpointVolume, nChannel: u32, fLevelDB: f32, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.SetChannelVolumeLevel(self, nChannel, fLevelDB, pguidEventContext);
    }
    pub inline fn SetChannelVolumeLevelScalar(self: *const IAudioEndpointVolume, nChannel: u32, fLevel: f32, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.SetChannelVolumeLevelScalar(self, nChannel, fLevel, pguidEventContext);
    }
    pub inline fn GetChannelVolumeLevel(self: *const IAudioEndpointVolume, nChannel: u32, pfLevelDB: ?*f32) HRESULT {
        return self.vtable.GetChannelVolumeLevel(self, nChannel, pfLevelDB);
    }
    pub inline fn GetChannelVolumeLevelScalar(self: *const IAudioEndpointVolume, nChannel: u32, pfLevel: ?*f32) HRESULT {
        return self.vtable.GetChannelVolumeLevelScalar(self, nChannel, pfLevel);
    }
    pub inline fn SetMute(self: *const IAudioEndpointVolume, bMute: BOOL, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.SetMute(self, bMute, pguidEventContext);
    }
    pub inline fn GetMute(self: *const IAudioEndpointVolume, pbMute: ?*BOOL) HRESULT {
        return self.vtable.GetMute(self, pbMute);
    }
    pub inline fn GetVolumeStepInfo(self: *const IAudioEndpointVolume, pnStep: ?*u32, pnStepCount: ?*u32) HRESULT {
        return self.vtable.GetVolumeStepInfo(self, pnStep, pnStepCount);
    }
    pub inline fn VolumeStepUp(self: *const IAudioEndpointVolume, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.VolumeStepUp(self, pguidEventContext);
    }
    pub inline fn VolumeStepDown(self: *const IAudioEndpointVolume, pguidEventContext: ?*const Guid) HRESULT {
        return self.vtable.VolumeStepDown(self, pguidEventContext);
    }
    pub inline fn QueryHardwareSupport(self: *const IAudioEndpointVolume, pdwHardwareSupportMask: ?*u32) HRESULT {
        return self.vtable.QueryHardwareSupport(self, pdwHardwareSupportMask);
    }
    pub inline fn GetVolumeRange(self: *const IAudioEndpointVolume, pflVolumeMindB: ?*f32, pflVolumeMaxdB: ?*f32, pflVolumeIncrementdB: ?*f32) HRESULT {
...
pub const IAudioEndpointVolumeEx = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetVolumeRangeChannel(self: *const IAudioEndpointVolumeEx, iChannel: u32, pflVolumeMindB: ?*f32, pflVolumeMaxdB: ?*f32, pflVolumeIncrementdB: ?*f32) HRESULT {
...
pub const IAudioMeterInformation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetPeakValue(self: *const IAudioMeterInformation, pfPeak: ?*f32) HRESULT {
        return self.vtable.GetPeakValue(self, pfPeak);
    }
    pub inline fn GetMeteringChannelCount(self: *const IAudioMeterInformation, pnChannelCount: ?*u32) HRESULT {
        return self.vtable.GetMeteringChannelCount(self, pnChannelCount);
    }
    pub inline fn GetChannelsPeakValues(self: *const IAudioMeterInformation, u32ChannelCount: u32, afPeakValues: [*]f32) HRESULT {
        return self.vtable.GetChannelsPeakValues(self, u32ChannelCount, afPeakValues);
    }
    pub inline fn QueryHardwareSupport(self: *const IAudioMeterInformation, pdwHardwareSupportMask: ?*u32) HRESULT {
        return self.vtable.QueryHardwareSupport(self, pdwHardwareSupportMask);
    }
};
