...
pub const IDialEventSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnEvent(self: *const IDialEventSink, dwEvent: u32, dwStatus: u32) HRESULT {
...
pub const IDialEngine = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IDialEngine, pwzConnectoid: ?[*:0]const u16, pIDES: ?*IDialEventSink) HRESULT {
        return self.vtable.Initialize(self, pwzConnectoid, pIDES);
    }
    pub inline fn GetProperty(self: *const IDialEngine, pwzProperty: ?[*:0]const u16, pwzValue: ?PWSTR, dwBufSize: u32) HRESULT {
        return self.vtable.GetProperty(self, pwzProperty, pwzValue, dwBufSize);
    }
    pub inline fn SetProperty(self: *const IDialEngine, pwzProperty: ?[*:0]const u16, pwzValue: ?[*:0]const u16) HRESULT {
        return self.vtable.SetProperty(self, pwzProperty, pwzValue);
    }
    pub inline fn Dial(self: *const IDialEngine) HRESULT {
        return self.vtable.Dial(self);
    }
    pub inline fn HangUp(self: *const IDialEngine) HRESULT {
        return self.vtable.HangUp(self);
    }
    pub inline fn GetConnectedState(self: *const IDialEngine, pdwState: ?*u32) HRESULT {
        return self.vtable.GetConnectedState(self, pdwState);
    }
    pub inline fn GetConnectHandle(self: *const IDialEngine, pdwHandle: ?*usize) HRESULT {
...
pub const IDialBranding = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IDialBranding, pwzConnectoid: ?[*:0]const u16) HRESULT {
        return self.vtable.Initialize(self, pwzConnectoid);
    }
    pub inline fn GetBitmap(self: *const IDialBranding, dwIndex: u32, phBitmap: ?*?HBITMAP) HRESULT {
...
pub const IProofOfPossessionCookieInfoManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCookieInfoForUri(self: *const IProofOfPossessionCookieInfoManager, uri: ?[*:0]const u16, cookieInfoCount: ?*u32, cookieInfo: [*]?*ProofOfPossessionCookieInfo) HRESULT {
...
pub const IProofOfPossessionCookieInfoManager2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCookieInfoWithUriForAccount(self: *const IProofOfPossessionCookieInfoManager2, webAccount: ?*IInspectable, uri: ?[*:0]const u16, cookieInfoCount: ?*u32, cookieInfo: [*]?*ProofOfPossessionCookieInfo) HRESULT {
...
// TODO: this type is limited to platform 'windows5.0'
pub extern "wininet" fn InternetClearAllPerSiteCookieDecisions() callconv(.winapi) BOOL;
...
pub extern "wininet" fn LoadUrlCacheContent() callconv(.winapi) BOOL;
...
pub extern "wininet" fn UrlCacheReloadSettings() callconv(.winapi) u32;
...
pub extern "wininet" fn UrlCacheServer() callconv(.winapi) u32;
...
pub extern "wininet" fn DoConnectoidsExist() callconv(.winapi) BOOL;
...
pub extern "wininet" fn IsProfilesEnabled() callconv(.winapi) BOOL;
