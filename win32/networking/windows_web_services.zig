...
pub const IContentPrefetcherTaskTrigger = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn TriggerContentPrefetcherTask(self: *const IContentPrefetcherTaskTrigger, packageFullName: ?[*:0]const u16) HRESULT {
        return self.vtable.TriggerContentPrefetcherTask(self, packageFullName);
    }
    pub inline fn IsRegisteredForContentPrefetch(self: *const IContentPrefetcherTaskTrigger, packageFullName: ?[*:0]const u16, isRegistered: ?*u8) HRESULT {
...
pub extern "webauthn" fn WebAuthNGetApiVersionNumber() callconv(.winapi) u32;
