...
pub const IIdentityAdvise = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IdentityUpdated(self: *const IIdentityAdvise, dwIdentityUpdateEvents: IdentityUpdateEvent, lpszUniqueID: ?[*:0]const u16) HRESULT {
...
pub const AsyncIIdentityAdvise = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_IdentityUpdated(self: *const AsyncIIdentityAdvise, dwIdentityUpdateEvents: u32, lpszUniqueID: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_IdentityUpdated(self, dwIdentityUpdateEvents, lpszUniqueID);
    }
    pub inline fn Finish_IdentityUpdated(self: *const AsyncIIdentityAdvise) HRESULT {
...
pub const IIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetIdentityEnum(self: *const IIdentityProvider, eIdentityType: IDENTITY_TYPE, pFilterkey: ?*const PROPERTYKEY, pFilterPropVarValue: ?*const PROPVARIANT, ppIdentityEnum: ?*?*IEnumUnknown) HRESULT {
        return self.vtable.GetIdentityEnum(self, eIdentityType, pFilterkey, pFilterPropVarValue, ppIdentityEnum);
    }
    pub inline fn Create(self: *const IIdentityProvider, lpszUserName: ?[*:0]const u16, ppPropertyStore: ?*?*IPropertyStore, pKeywordsToAdd: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Create(self, lpszUserName, ppPropertyStore, pKeywordsToAdd);
    }
    pub inline fn Import(self: *const IIdentityProvider, pPropertyStore: ?*IPropertyStore) HRESULT {
        return self.vtable.Import(self, pPropertyStore);
    }
    pub inline fn Delete(self: *const IIdentityProvider, lpszUniqueID: ?[*:0]const u16, pKeywordsToDelete: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Delete(self, lpszUniqueID, pKeywordsToDelete);
    }
    pub inline fn FindByUniqueID(self: *const IIdentityProvider, lpszUniqueID: ?[*:0]const u16, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.FindByUniqueID(self, lpszUniqueID, ppPropertyStore);
    }
    pub inline fn GetProviderPropertyStore(self: *const IIdentityProvider, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.GetProviderPropertyStore(self, ppPropertyStore);
    }
    pub inline fn Advise(self: *const IIdentityProvider, pIdentityAdvise: ?*IIdentityAdvise, dwIdentityUpdateEvents: IdentityUpdateEvent, pdwCookie: ?*u32) HRESULT {
        return self.vtable.Advise(self, pIdentityAdvise, dwIdentityUpdateEvents, pdwCookie);
    }
    pub inline fn UnAdvise(self: *const IIdentityProvider, dwCookie: u32) HRESULT {
...
pub const AsyncIIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_GetIdentityEnum(self: *const AsyncIIdentityProvider, eIdentityType: IDENTITY_TYPE, pFilterkey: ?*const PROPERTYKEY, pFilterPropVarValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Begin_GetIdentityEnum(self, eIdentityType, pFilterkey, pFilterPropVarValue);
    }
    pub inline fn Finish_GetIdentityEnum(self: *const AsyncIIdentityProvider, ppIdentityEnum: ?*?*IEnumUnknown) HRESULT {
        return self.vtable.Finish_GetIdentityEnum(self, ppIdentityEnum);
    }
    pub inline fn Begin_Create(self: *const AsyncIIdentityProvider, lpszUserName: ?[*:0]const u16, pKeywordsToAdd: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Begin_Create(self, lpszUserName, pKeywordsToAdd);
    }
    pub inline fn Finish_Create(self: *const AsyncIIdentityProvider, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.Finish_Create(self, ppPropertyStore);
    }
    pub inline fn Begin_Import(self: *const AsyncIIdentityProvider, pPropertyStore: ?*IPropertyStore) HRESULT {
        return self.vtable.Begin_Import(self, pPropertyStore);
    }
    pub inline fn Finish_Import(self: *const AsyncIIdentityProvider) HRESULT {
        return self.vtable.Finish_Import(self);
    }
    pub inline fn Begin_Delete(self: *const AsyncIIdentityProvider, lpszUniqueID: ?[*:0]const u16, pKeywordsToDelete: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Begin_Delete(self, lpszUniqueID, pKeywordsToDelete);
    }
    pub inline fn Finish_Delete(self: *const AsyncIIdentityProvider) HRESULT {
        return self.vtable.Finish_Delete(self);
    }
    pub inline fn Begin_FindByUniqueID(self: *const AsyncIIdentityProvider, lpszUniqueID: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_FindByUniqueID(self, lpszUniqueID);
    }
    pub inline fn Finish_FindByUniqueID(self: *const AsyncIIdentityProvider, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.Finish_FindByUniqueID(self, ppPropertyStore);
    }
    pub inline fn Begin_GetProviderPropertyStore(self: *const AsyncIIdentityProvider) HRESULT {
        return self.vtable.Begin_GetProviderPropertyStore(self);
    }
    pub inline fn Finish_GetProviderPropertyStore(self: *const AsyncIIdentityProvider, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.Finish_GetProviderPropertyStore(self, ppPropertyStore);
    }
    pub inline fn Begin_Advise(self: *const AsyncIIdentityProvider, pIdentityAdvise: ?*IIdentityAdvise, dwIdentityUpdateEvents: u32) HRESULT {
        return self.vtable.Begin_Advise(self, pIdentityAdvise, dwIdentityUpdateEvents);
    }
    pub inline fn Finish_Advise(self: *const AsyncIIdentityProvider, pdwCookie: ?*u32) HRESULT {
        return self.vtable.Finish_Advise(self, pdwCookie);
    }
    pub inline fn Begin_UnAdvise(self: *const AsyncIIdentityProvider, dwCookie: u32) HRESULT {
        return self.vtable.Begin_UnAdvise(self, dwCookie);
    }
    pub inline fn Finish_UnAdvise(self: *const AsyncIIdentityProvider) HRESULT {
...
pub const IAssociatedIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AssociateIdentity(self: *const IAssociatedIdentityProvider, hwndParent: ?HWND, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.AssociateIdentity(self, hwndParent, ppPropertyStore);
    }
    pub inline fn DisassociateIdentity(self: *const IAssociatedIdentityProvider, hwndParent: ?HWND, lpszUniqueID: ?[*:0]const u16) HRESULT {
        return self.vtable.DisassociateIdentity(self, hwndParent, lpszUniqueID);
    }
    pub inline fn ChangeCredential(self: *const IAssociatedIdentityProvider, hwndParent: ?HWND, lpszUniqueID: ?[*:0]const u16) HRESULT {
...
pub const AsyncIAssociatedIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_AssociateIdentity(self: *const AsyncIAssociatedIdentityProvider, hwndParent: ?HWND) HRESULT {
        return self.vtable.Begin_AssociateIdentity(self, hwndParent);
    }
    pub inline fn Finish_AssociateIdentity(self: *const AsyncIAssociatedIdentityProvider, ppPropertyStore: ?*?*IPropertyStore) HRESULT {
        return self.vtable.Finish_AssociateIdentity(self, ppPropertyStore);
    }
    pub inline fn Begin_DisassociateIdentity(self: *const AsyncIAssociatedIdentityProvider, hwndParent: ?HWND, lpszUniqueID: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_DisassociateIdentity(self, hwndParent, lpszUniqueID);
    }
    pub inline fn Finish_DisassociateIdentity(self: *const AsyncIAssociatedIdentityProvider) HRESULT {
        return self.vtable.Finish_DisassociateIdentity(self);
    }
    pub inline fn Begin_ChangeCredential(self: *const AsyncIAssociatedIdentityProvider, hwndParent: ?HWND, lpszUniqueID: ?[*:0]const u16) HRESULT {
        return self.vtable.Begin_ChangeCredential(self, hwndParent, lpszUniqueID);
    }
    pub inline fn Finish_ChangeCredential(self: *const AsyncIAssociatedIdentityProvider) HRESULT {
...
pub const IConnectedIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ConnectIdentity(self: *const IConnectedIdentityProvider, AuthBuffer: [*:0]u8, AuthBufferSize: u32) HRESULT {
        return self.vtable.ConnectIdentity(self, AuthBuffer, AuthBufferSize);
    }
    pub inline fn DisconnectIdentity(self: *const IConnectedIdentityProvider) HRESULT {
        return self.vtable.DisconnectIdentity(self);
    }
    pub inline fn IsConnected(self: *const IConnectedIdentityProvider, Connected: ?*BOOL) HRESULT {
        return self.vtable.IsConnected(self, Connected);
    }
    pub inline fn GetUrl(self: *const IConnectedIdentityProvider, Identifier: IDENTITY_URL, Context: ?*IBindCtx, PostData: ?*VARIANT, Url: ?*?PWSTR) HRESULT {
        return self.vtable.GetUrl(self, Identifier, Context, PostData, Url);
    }
    pub inline fn GetAccountState(self: *const IConnectedIdentityProvider, pState: ?*ACCOUNT_STATE) HRESULT {
...
pub const AsyncIConnectedIdentityProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_ConnectIdentity(self: *const AsyncIConnectedIdentityProvider, AuthBuffer: [*:0]u8, AuthBufferSize: u32) HRESULT {
        return self.vtable.Begin_ConnectIdentity(self, AuthBuffer, AuthBufferSize);
    }
    pub inline fn Finish_ConnectIdentity(self: *const AsyncIConnectedIdentityProvider) HRESULT {
        return self.vtable.Finish_ConnectIdentity(self);
    }
    pub inline fn Begin_DisconnectIdentity(self: *const AsyncIConnectedIdentityProvider) HRESULT {
        return self.vtable.Begin_DisconnectIdentity(self);
    }
    pub inline fn Finish_DisconnectIdentity(self: *const AsyncIConnectedIdentityProvider) HRESULT {
        return self.vtable.Finish_DisconnectIdentity(self);
    }
    pub inline fn Begin_IsConnected(self: *const AsyncIConnectedIdentityProvider) HRESULT {
        return self.vtable.Begin_IsConnected(self);
    }
    pub inline fn Finish_IsConnected(self: *const AsyncIConnectedIdentityProvider, Connected: ?*BOOL) HRESULT {
        return self.vtable.Finish_IsConnected(self, Connected);
    }
    pub inline fn Begin_GetUrl(self: *const AsyncIConnectedIdentityProvider, Identifier: IDENTITY_URL, Context: ?*IBindCtx) HRESULT {
        return self.vtable.Begin_GetUrl(self, Identifier, Context);
    }
    pub inline fn Finish_GetUrl(self: *const AsyncIConnectedIdentityProvider, PostData: ?*VARIANT, Url: ?*?PWSTR) HRESULT {
        return self.vtable.Finish_GetUrl(self, PostData, Url);
    }
    pub inline fn Begin_GetAccountState(self: *const AsyncIConnectedIdentityProvider) HRESULT {
        return self.vtable.Begin_GetAccountState(self);
    }
    pub inline fn Finish_GetAccountState(self: *const AsyncIConnectedIdentityProvider, pState: ?*ACCOUNT_STATE) HRESULT {
...
pub const IIdentityAuthentication = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetIdentityCredential(self: *const IIdentityAuthentication, CredBuffer: ?[*:0]u8, CredBufferLength: u32) HRESULT {
        return self.vtable.SetIdentityCredential(self, CredBuffer, CredBufferLength);
    }
    pub inline fn ValidateIdentityCredential(self: *const IIdentityAuthentication, CredBuffer: [*:0]u8, CredBufferLength: u32, ppIdentityProperties: ?*?*IPropertyStore) HRESULT {
...
pub const AsyncIIdentityAuthentication = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_SetIdentityCredential(self: *const AsyncIIdentityAuthentication, CredBuffer: ?[*:0]u8, CredBufferLength: u32) HRESULT {
        return self.vtable.Begin_SetIdentityCredential(self, CredBuffer, CredBufferLength);
    }
    pub inline fn Finish_SetIdentityCredential(self: *const AsyncIIdentityAuthentication) HRESULT {
        return self.vtable.Finish_SetIdentityCredential(self);
    }
    pub inline fn Begin_ValidateIdentityCredential(self: *const AsyncIIdentityAuthentication, CredBuffer: [*:0]u8, CredBufferLength: u32, ppIdentityProperties: ?*?*IPropertyStore) HRESULT {
        return self.vtable.Begin_ValidateIdentityCredential(self, CredBuffer, CredBufferLength, ppIdentityProperties);
    }
    pub inline fn Finish_ValidateIdentityCredential(self: *const AsyncIIdentityAuthentication, ppIdentityProperties: ?*?*IPropertyStore) HRESULT {
...
pub const IIdentityStore = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCount(self: *const IIdentityStore, pdwProviders: ?*u32) HRESULT {
        return self.vtable.GetCount(self, pdwProviders);
    }
    pub inline fn GetAt(self: *const IIdentityStore, dwProvider: u32, pProvGuid: ?*Guid, ppIdentityProvider: ?*?*IUnknown) HRESULT {
        return self.vtable.GetAt(self, dwProvider, pProvGuid, ppIdentityProvider);
    }
    pub inline fn AddToCache(self: *const IIdentityStore, lpszUniqueID: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
        return self.vtable.AddToCache(self, lpszUniqueID, ProviderGUID);
    }
    pub inline fn ConvertToSid(self: *const IIdentityStore, lpszUniqueID: ?[*:0]const u16, ProviderGUID: ?*const Guid, cbSid: u16, pSid: ?[*:0]u8, pcbRequiredSid: ?*u16) HRESULT {
        return self.vtable.ConvertToSid(self, lpszUniqueID, ProviderGUID, cbSid, pSid, pcbRequiredSid);
    }
    pub inline fn EnumerateIdentities(self: *const IIdentityStore, eIdentityType: IDENTITY_TYPE, pFilterkey: ?*const PROPERTYKEY, pFilterPropVarValue: ?*const PROPVARIANT, ppIdentityEnum: ?*?*IEnumUnknown) HRESULT {
        return self.vtable.EnumerateIdentities(self, eIdentityType, pFilterkey, pFilterPropVarValue, ppIdentityEnum);
    }
    pub inline fn Reset(self: *const IIdentityStore) HRESULT {
...
pub const AsyncIIdentityStore = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_GetCount(self: *const AsyncIIdentityStore) HRESULT {
        return self.vtable.Begin_GetCount(self);
    }
    pub inline fn Finish_GetCount(self: *const AsyncIIdentityStore, pdwProviders: ?*u32) HRESULT {
        return self.vtable.Finish_GetCount(self, pdwProviders);
    }
    pub inline fn Begin_GetAt(self: *const AsyncIIdentityStore, dwProvider: u32, pProvGuid: ?*Guid) HRESULT {
        return self.vtable.Begin_GetAt(self, dwProvider, pProvGuid);
    }
    pub inline fn Finish_GetAt(self: *const AsyncIIdentityStore, pProvGuid: ?*Guid, ppIdentityProvider: ?*?*IUnknown) HRESULT {
        return self.vtable.Finish_GetAt(self, pProvGuid, ppIdentityProvider);
    }
    pub inline fn Begin_AddToCache(self: *const AsyncIIdentityStore, lpszUniqueID: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
        return self.vtable.Begin_AddToCache(self, lpszUniqueID, ProviderGUID);
    }
    pub inline fn Finish_AddToCache(self: *const AsyncIIdentityStore) HRESULT {
        return self.vtable.Finish_AddToCache(self);
    }
    pub inline fn Begin_ConvertToSid(self: *const AsyncIIdentityStore, lpszUniqueID: ?[*:0]const u16, ProviderGUID: ?*const Guid, cbSid: u16, pSid: ?*u8) HRESULT {
        return self.vtable.Begin_ConvertToSid(self, lpszUniqueID, ProviderGUID, cbSid, pSid);
    }
    pub inline fn Finish_ConvertToSid(self: *const AsyncIIdentityStore, pSid: ?*u8, pcbRequiredSid: ?*u16) HRESULT {
        return self.vtable.Finish_ConvertToSid(self, pSid, pcbRequiredSid);
    }
    pub inline fn Begin_EnumerateIdentities(self: *const AsyncIIdentityStore, eIdentityType: IDENTITY_TYPE, pFilterkey: ?*const PROPERTYKEY, pFilterPropVarValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.Begin_EnumerateIdentities(self, eIdentityType, pFilterkey, pFilterPropVarValue);
    }
    pub inline fn Finish_EnumerateIdentities(self: *const AsyncIIdentityStore, ppIdentityEnum: ?*?*IEnumUnknown) HRESULT {
        return self.vtable.Finish_EnumerateIdentities(self, ppIdentityEnum);
    }
    pub inline fn Begin_Reset(self: *const AsyncIIdentityStore) HRESULT {
        return self.vtable.Begin_Reset(self);
    }
    pub inline fn Finish_Reset(self: *const AsyncIIdentityStore) HRESULT {
...
pub const IIdentityStoreEx = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateConnectedIdentity(self: *const IIdentityStoreEx, LocalName: ?[*:0]const u16, ConnectedName: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
        return self.vtable.CreateConnectedIdentity(self, LocalName, ConnectedName, ProviderGUID);
    }
    pub inline fn DeleteConnectedIdentity(self: *const IIdentityStoreEx, ConnectedName: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
...
pub const AsyncIIdentityStoreEx = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Begin_CreateConnectedIdentity(self: *const AsyncIIdentityStoreEx, LocalName: ?[*:0]const u16, ConnectedName: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
        return self.vtable.Begin_CreateConnectedIdentity(self, LocalName, ConnectedName, ProviderGUID);
    }
    pub inline fn Finish_CreateConnectedIdentity(self: *const AsyncIIdentityStoreEx) HRESULT {
        return self.vtable.Finish_CreateConnectedIdentity(self);
    }
    pub inline fn Begin_DeleteConnectedIdentity(self: *const AsyncIIdentityStoreEx, ConnectedName: ?[*:0]const u16, ProviderGUID: ?*const Guid) HRESULT {
        return self.vtable.Begin_DeleteConnectedIdentity(self, ConnectedName, ProviderGUID);
    }
    pub inline fn Finish_DeleteConnectedIdentity(self: *const AsyncIIdentityStoreEx) HRESULT {
