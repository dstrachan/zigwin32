...
pub const IAzAuthorizationStore = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Description(self: *const IAzAuthorizationStore, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzAuthorizationStore, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzAuthorizationStore, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzAuthorizationStore, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn get_DomainTimeout(self: *const IAzAuthorizationStore, plProp: ?*i32) HRESULT {
        return self.vtable.get_DomainTimeout(self, plProp);
    }
    pub inline fn put_DomainTimeout(self: *const IAzAuthorizationStore, lProp: i32) HRESULT {
        return self.vtable.put_DomainTimeout(self, lProp);
    }
    pub inline fn get_ScriptEngineTimeout(self: *const IAzAuthorizationStore, plProp: ?*i32) HRESULT {
        return self.vtable.get_ScriptEngineTimeout(self, plProp);
    }
    pub inline fn put_ScriptEngineTimeout(self: *const IAzAuthorizationStore, lProp: i32) HRESULT {
        return self.vtable.put_ScriptEngineTimeout(self, lProp);
    }
    pub inline fn get_MaxScriptEngines(self: *const IAzAuthorizationStore, plProp: ?*i32) HRESULT {
        return self.vtable.get_MaxScriptEngines(self, plProp);
    }
    pub inline fn put_MaxScriptEngines(self: *const IAzAuthorizationStore, lProp: i32) HRESULT {
        return self.vtable.put_MaxScriptEngines(self, lProp);
    }
    pub inline fn get_GenerateAudits(self: *const IAzAuthorizationStore, pbProp: ?*BOOL) HRESULT {
        return self.vtable.get_GenerateAudits(self, pbProp);
    }
    pub inline fn put_GenerateAudits(self: *const IAzAuthorizationStore, bProp: BOOL) HRESULT {
        return self.vtable.put_GenerateAudits(self, bProp);
    }
    pub inline fn get_Writable(self: *const IAzAuthorizationStore, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzAuthorizationStore, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzAuthorizationStore, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn AddPropertyItem(self: *const IAzAuthorizationStore, lPropId: AZ_PROP_CONSTANTS, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzAuthorizationStore, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn get_PolicyAdministrators(self: *const IAzAuthorizationStore, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministrators(self, pvarAdmins);
    }
    pub inline fn get_PolicyReaders(self: *const IAzAuthorizationStore, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReaders(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministrator(self: *const IAzAuthorizationStore, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministrator(self: *const IAzAuthorizationStore, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReader(self: *const IAzAuthorizationStore, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReader(self: *const IAzAuthorizationStore, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn Initialize(self: *const IAzAuthorizationStore, lFlags: AZ_PROP_CONSTANTS, bstrPolicyURL: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.Initialize(self, lFlags, bstrPolicyURL, varReserved);
    }
    pub inline fn UpdateCache(self: *const IAzAuthorizationStore, varReserved: VARIANT) HRESULT {
        return self.vtable.UpdateCache(self, varReserved);
    }
    pub inline fn Delete(self: *const IAzAuthorizationStore, varReserved: VARIANT) HRESULT {
        return self.vtable.Delete(self, varReserved);
    }
    pub inline fn get_Applications(self: *const IAzAuthorizationStore, ppAppCollection: ?*?*IAzApplications) HRESULT {
        return self.vtable.get_Applications(self, ppAppCollection);
    }
    pub inline fn OpenApplication(self: *const IAzAuthorizationStore, bstrApplicationName: ?BSTR, varReserved: VARIANT, ppApplication: ?*?*IAzApplication) HRESULT {
        return self.vtable.OpenApplication(self, bstrApplicationName, varReserved, ppApplication);
    }
    pub inline fn CreateApplication(self: *const IAzAuthorizationStore, bstrApplicationName: ?BSTR, varReserved: VARIANT, ppApplication: ?*?*IAzApplication) HRESULT {
        return self.vtable.CreateApplication(self, bstrApplicationName, varReserved, ppApplication);
    }
    pub inline fn DeleteApplication(self: *const IAzAuthorizationStore, bstrApplicationName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteApplication(self, bstrApplicationName, varReserved);
    }
    pub inline fn get_ApplicationGroups(self: *const IAzAuthorizationStore, ppGroupCollection: ?*?*IAzApplicationGroups) HRESULT {
        return self.vtable.get_ApplicationGroups(self, ppGroupCollection);
    }
    pub inline fn CreateApplicationGroup(self: *const IAzAuthorizationStore, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.CreateApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn OpenApplicationGroup(self: *const IAzAuthorizationStore, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.OpenApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn DeleteApplicationGroup(self: *const IAzAuthorizationStore, bstrGroupName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteApplicationGroup(self, bstrGroupName, varReserved);
    }
    pub inline fn Submit(self: *const IAzAuthorizationStore, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
    pub inline fn get_DelegatedPolicyUsers(self: *const IAzAuthorizationStore, pvarDelegatedPolicyUsers: ?*VARIANT) HRESULT {
        return self.vtable.get_DelegatedPolicyUsers(self, pvarDelegatedPolicyUsers);
    }
    pub inline fn AddDelegatedPolicyUser(self: *const IAzAuthorizationStore, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddDelegatedPolicyUser(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn DeleteDelegatedPolicyUser(self: *const IAzAuthorizationStore, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteDelegatedPolicyUser(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn get_TargetMachine(self: *const IAzAuthorizationStore, pbstrTargetMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_TargetMachine(self, pbstrTargetMachine);
    }
    pub inline fn get_ApplyStoreSacl(self: *const IAzAuthorizationStore, pbApplyStoreSacl: ?*BOOL) HRESULT {
        return self.vtable.get_ApplyStoreSacl(self, pbApplyStoreSacl);
    }
    pub inline fn put_ApplyStoreSacl(self: *const IAzAuthorizationStore, bApplyStoreSacl: BOOL) HRESULT {
        return self.vtable.put_ApplyStoreSacl(self, bApplyStoreSacl);
    }
    pub inline fn get_PolicyAdministratorsName(self: *const IAzAuthorizationStore, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministratorsName(self, pvarAdmins);
    }
    pub inline fn get_PolicyReadersName(self: *const IAzAuthorizationStore, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReadersName(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministratorName(self: *const IAzAuthorizationStore, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministratorName(self: *const IAzAuthorizationStore, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReaderName(self: *const IAzAuthorizationStore, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReaderName(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReaderName(self: *const IAzAuthorizationStore, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReaderName(self, bstrReader, varReserved);
    }
    pub inline fn get_DelegatedPolicyUsersName(self: *const IAzAuthorizationStore, pvarDelegatedPolicyUsers: ?*VARIANT) HRESULT {
        return self.vtable.get_DelegatedPolicyUsersName(self, pvarDelegatedPolicyUsers);
    }
    pub inline fn AddDelegatedPolicyUserName(self: *const IAzAuthorizationStore, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddDelegatedPolicyUserName(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn DeleteDelegatedPolicyUserName(self: *const IAzAuthorizationStore, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteDelegatedPolicyUserName(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn CloseApplication(self: *const IAzAuthorizationStore, bstrApplicationName: ?BSTR, lFlag: i32) HRESULT {
...
pub const IAzAuthorizationStore2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn OpenApplication2(self: *const IAzAuthorizationStore2, bstrApplicationName: ?BSTR, varReserved: VARIANT, ppApplication: ?*?*IAzApplication2) HRESULT {
        return self.vtable.OpenApplication2(self, bstrApplicationName, varReserved, ppApplication);
    }
    pub inline fn CreateApplication2(self: *const IAzAuthorizationStore2, bstrApplicationName: ?BSTR, varReserved: VARIANT, ppApplication: ?*?*IAzApplication2) HRESULT {
...
pub const IAzAuthorizationStore3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn IsUpdateNeeded(self: *const IAzAuthorizationStore3, pbIsUpdateNeeded: ?*i16) HRESULT {
        return self.vtable.IsUpdateNeeded(self, pbIsUpdateNeeded);
    }
    pub inline fn BizruleGroupSupported(self: *const IAzAuthorizationStore3, pbSupported: ?*i16) HRESULT {
        return self.vtable.BizruleGroupSupported(self, pbSupported);
    }
    pub inline fn UpgradeStoresFunctionalLevel(self: *const IAzAuthorizationStore3, lFunctionalLevel: i32) HRESULT {
        return self.vtable.UpgradeStoresFunctionalLevel(self, lFunctionalLevel);
    }
    pub inline fn IsFunctionalLevelUpgradeSupported(self: *const IAzAuthorizationStore3, lFunctionalLevel: i32, pbSupported: ?*i16) HRESULT {
        return self.vtable.IsFunctionalLevelUpgradeSupported(self, lFunctionalLevel, pbSupported);
    }
    pub inline fn GetSchemaVersion(self: *const IAzAuthorizationStore3, plMajorVersion: ?*i32, plMinorVersion: ?*i32) HRESULT {
...
pub const IAzApplication = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzApplication, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzApplication, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Description(self: *const IAzApplication, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzApplication, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzApplication, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzApplication, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn get_AuthzInterfaceClsid(self: *const IAzApplication, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_AuthzInterfaceClsid(self, pbstrProp);
    }
    pub inline fn put_AuthzInterfaceClsid(self: *const IAzApplication, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_AuthzInterfaceClsid(self, bstrProp);
    }
    pub inline fn get_Version(self: *const IAzApplication, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_Version(self, pbstrProp);
    }
    pub inline fn put_Version(self: *const IAzApplication, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_Version(self, bstrProp);
    }
    pub inline fn get_GenerateAudits(self: *const IAzApplication, pbProp: ?*BOOL) HRESULT {
        return self.vtable.get_GenerateAudits(self, pbProp);
    }
    pub inline fn put_GenerateAudits(self: *const IAzApplication, bProp: BOOL) HRESULT {
        return self.vtable.put_GenerateAudits(self, bProp);
    }
    pub inline fn get_ApplyStoreSacl(self: *const IAzApplication, pbProp: ?*BOOL) HRESULT {
        return self.vtable.get_ApplyStoreSacl(self, pbProp);
    }
    pub inline fn put_ApplyStoreSacl(self: *const IAzApplication, bProp: BOOL) HRESULT {
        return self.vtable.put_ApplyStoreSacl(self, bProp);
    }
    pub inline fn get_Writable(self: *const IAzApplication, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzApplication, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzApplication, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn get_PolicyAdministrators(self: *const IAzApplication, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministrators(self, pvarAdmins);
    }
    pub inline fn get_PolicyReaders(self: *const IAzApplication, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReaders(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministrator(self: *const IAzApplication, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministrator(self: *const IAzApplication, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReader(self: *const IAzApplication, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReader(self: *const IAzApplication, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn get_Scopes(self: *const IAzApplication, ppScopeCollection: ?*?*IAzScopes) HRESULT {
        return self.vtable.get_Scopes(self, ppScopeCollection);
    }
    pub inline fn OpenScope(self: *const IAzApplication, bstrScopeName: ?BSTR, varReserved: VARIANT, ppScope: ?*?*IAzScope) HRESULT {
        return self.vtable.OpenScope(self, bstrScopeName, varReserved, ppScope);
    }
    pub inline fn CreateScope(self: *const IAzApplication, bstrScopeName: ?BSTR, varReserved: VARIANT, ppScope: ?*?*IAzScope) HRESULT {
        return self.vtable.CreateScope(self, bstrScopeName, varReserved, ppScope);
    }
    pub inline fn DeleteScope(self: *const IAzApplication, bstrScopeName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteScope(self, bstrScopeName, varReserved);
    }
    pub inline fn get_Operations(self: *const IAzApplication, ppOperationCollection: ?*?*IAzOperations) HRESULT {
        return self.vtable.get_Operations(self, ppOperationCollection);
    }
    pub inline fn OpenOperation(self: *const IAzApplication, bstrOperationName: ?BSTR, varReserved: VARIANT, ppOperation: ?*?*IAzOperation) HRESULT {
        return self.vtable.OpenOperation(self, bstrOperationName, varReserved, ppOperation);
    }
    pub inline fn CreateOperation(self: *const IAzApplication, bstrOperationName: ?BSTR, varReserved: VARIANT, ppOperation: ?*?*IAzOperation) HRESULT {
        return self.vtable.CreateOperation(self, bstrOperationName, varReserved, ppOperation);
    }
    pub inline fn DeleteOperation(self: *const IAzApplication, bstrOperationName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteOperation(self, bstrOperationName, varReserved);
    }
    pub inline fn get_Tasks(self: *const IAzApplication, ppTaskCollection: ?*?*IAzTasks) HRESULT {
        return self.vtable.get_Tasks(self, ppTaskCollection);
    }
    pub inline fn OpenTask(self: *const IAzApplication, bstrTaskName: ?BSTR, varReserved: VARIANT, ppTask: ?*?*IAzTask) HRESULT {
        return self.vtable.OpenTask(self, bstrTaskName, varReserved, ppTask);
    }
    pub inline fn CreateTask(self: *const IAzApplication, bstrTaskName: ?BSTR, varReserved: VARIANT, ppTask: ?*?*IAzTask) HRESULT {
        return self.vtable.CreateTask(self, bstrTaskName, varReserved, ppTask);
    }
    pub inline fn DeleteTask(self: *const IAzApplication, bstrTaskName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteTask(self, bstrTaskName, varReserved);
    }
    pub inline fn get_ApplicationGroups(self: *const IAzApplication, ppGroupCollection: ?*?*IAzApplicationGroups) HRESULT {
        return self.vtable.get_ApplicationGroups(self, ppGroupCollection);
    }
    pub inline fn OpenApplicationGroup(self: *const IAzApplication, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.OpenApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn CreateApplicationGroup(self: *const IAzApplication, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.CreateApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn DeleteApplicationGroup(self: *const IAzApplication, bstrGroupName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteApplicationGroup(self, bstrGroupName, varReserved);
    }
    pub inline fn get_Roles(self: *const IAzApplication, ppRoleCollection: ?*?*IAzRoles) HRESULT {
        return self.vtable.get_Roles(self, ppRoleCollection);
    }
    pub inline fn OpenRole(self: *const IAzApplication, bstrRoleName: ?BSTR, varReserved: VARIANT, ppRole: ?*?*IAzRole) HRESULT {
        return self.vtable.OpenRole(self, bstrRoleName, varReserved, ppRole);
    }
    pub inline fn CreateRole(self: *const IAzApplication, bstrRoleName: ?BSTR, varReserved: VARIANT, ppRole: ?*?*IAzRole) HRESULT {
        return self.vtable.CreateRole(self, bstrRoleName, varReserved, ppRole);
    }
    pub inline fn DeleteRole(self: *const IAzApplication, bstrRoleName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteRole(self, bstrRoleName, varReserved);
    }
    pub inline fn InitializeClientContextFromToken(self: *const IAzApplication, ullTokenHandle: u64, varReserved: VARIANT, ppClientContext: ?*?*IAzClientContext) HRESULT {
        return self.vtable.InitializeClientContextFromToken(self, ullTokenHandle, varReserved, ppClientContext);
    }
    pub inline fn AddPropertyItem(self: *const IAzApplication, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzApplication, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn Submit(self: *const IAzApplication, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
    pub inline fn InitializeClientContextFromName(self: *const IAzApplication, ClientName: ?BSTR, DomainName: ?BSTR, varReserved: VARIANT, ppClientContext: ?*?*IAzClientContext) HRESULT {
        return self.vtable.InitializeClientContextFromName(self, ClientName, DomainName, varReserved, ppClientContext);
    }
    pub inline fn get_DelegatedPolicyUsers(self: *const IAzApplication, pvarDelegatedPolicyUsers: ?*VARIANT) HRESULT {
        return self.vtable.get_DelegatedPolicyUsers(self, pvarDelegatedPolicyUsers);
    }
    pub inline fn AddDelegatedPolicyUser(self: *const IAzApplication, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddDelegatedPolicyUser(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn DeleteDelegatedPolicyUser(self: *const IAzApplication, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteDelegatedPolicyUser(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn InitializeClientContextFromStringSid(self: *const IAzApplication, SidString: ?BSTR, lOptions: i32, varReserved: VARIANT, ppClientContext: ?*?*IAzClientContext) HRESULT {
        return self.vtable.InitializeClientContextFromStringSid(self, SidString, lOptions, varReserved, ppClientContext);
    }
    pub inline fn get_PolicyAdministratorsName(self: *const IAzApplication, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministratorsName(self, pvarAdmins);
    }
    pub inline fn get_PolicyReadersName(self: *const IAzApplication, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReadersName(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministratorName(self: *const IAzApplication, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministratorName(self: *const IAzApplication, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReaderName(self: *const IAzApplication, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReaderName(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReaderName(self: *const IAzApplication, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReaderName(self, bstrReader, varReserved);
    }
    pub inline fn get_DelegatedPolicyUsersName(self: *const IAzApplication, pvarDelegatedPolicyUsers: ?*VARIANT) HRESULT {
        return self.vtable.get_DelegatedPolicyUsersName(self, pvarDelegatedPolicyUsers);
    }
    pub inline fn AddDelegatedPolicyUserName(self: *const IAzApplication, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddDelegatedPolicyUserName(self, bstrDelegatedPolicyUser, varReserved);
    }
    pub inline fn DeleteDelegatedPolicyUserName(self: *const IAzApplication, bstrDelegatedPolicyUser: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteDelegatedPolicyUserName(self, bstrDelegatedPolicyUser, varReserved);
    }
};
...
pub const IAzApplication2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn InitializeClientContextFromToken2(self: *const IAzApplication2, ulTokenHandleLowPart: u32, ulTokenHandleHighPart: u32, varReserved: VARIANT, ppClientContext: ?*?*IAzClientContext2) HRESULT {
    ...
    pub inline fn InitializeClientContext2(self: *const IAzApplication2, IdentifyingString: ?BSTR, varReserved: VARIANT, ppClientContext: ?*?*IAzClientContext2) HRESULT {
...
pub const IAzApplications = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzApplications, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzApplications, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzApplications, ppEnumPtr: ?*?*IUnknown) HRESULT {
...
pub const IAzOperation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzOperation, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzOperation, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Description(self: *const IAzOperation, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzOperation, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzOperation, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzOperation, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn get_OperationID(self: *const IAzOperation, plProp: ?*i32) HRESULT {
        return self.vtable.get_OperationID(self, plProp);
    }
    pub inline fn put_OperationID(self: *const IAzOperation, lProp: i32) HRESULT {
        return self.vtable.put_OperationID(self, lProp);
    }
    pub inline fn get_Writable(self: *const IAzOperation, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzOperation, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzOperation, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn Submit(self: *const IAzOperation, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
};
...
pub const IAzOperations = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzOperations, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzOperations, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzOperations, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzTask = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzTask, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzTask, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Description(self: *const IAzTask, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzTask, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzTask, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzTask, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn get_BizRule(self: *const IAzTask, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRule(self, pbstrProp);
    }
    pub inline fn put_BizRule(self: *const IAzTask, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRule(self, bstrProp);
    }
    pub inline fn get_BizRuleLanguage(self: *const IAzTask, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRuleLanguage(self, pbstrProp);
    }
    pub inline fn put_BizRuleLanguage(self: *const IAzTask, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRuleLanguage(self, bstrProp);
    }
    pub inline fn get_BizRuleImportedPath(self: *const IAzTask, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRuleImportedPath(self, pbstrProp);
    }
    pub inline fn put_BizRuleImportedPath(self: *const IAzTask, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRuleImportedPath(self, bstrProp);
    }
    pub inline fn get_IsRoleDefinition(self: *const IAzTask, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_IsRoleDefinition(self, pfProp);
    }
    pub inline fn put_IsRoleDefinition(self: *const IAzTask, fProp: BOOL) HRESULT {
        return self.vtable.put_IsRoleDefinition(self, fProp);
    }
    pub inline fn get_Operations(self: *const IAzTask, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Operations(self, pvarProp);
    }
    pub inline fn get_Tasks(self: *const IAzTask, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Tasks(self, pvarProp);
    }
    pub inline fn AddOperation(self: *const IAzTask, bstrOp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddOperation(self, bstrOp, varReserved);
    }
    pub inline fn DeleteOperation(self: *const IAzTask, bstrOp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteOperation(self, bstrOp, varReserved);
    }
    pub inline fn AddTask(self: *const IAzTask, bstrTask: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddTask(self, bstrTask, varReserved);
    }
    pub inline fn DeleteTask(self: *const IAzTask, bstrTask: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteTask(self, bstrTask, varReserved);
    }
    pub inline fn get_Writable(self: *const IAzTask, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzTask, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzTask, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn AddPropertyItem(self: *const IAzTask, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzTask, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn Submit(self: *const IAzTask, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
};
...
pub const IAzTasks = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzTasks, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzTasks, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzTasks, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzScope = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzScope, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzScope, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Description(self: *const IAzScope, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzScope, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzScope, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzScope, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn get_Writable(self: *const IAzScope, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzScope, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzScope, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn AddPropertyItem(self: *const IAzScope, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzScope, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn get_PolicyAdministrators(self: *const IAzScope, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministrators(self, pvarAdmins);
    }
    pub inline fn get_PolicyReaders(self: *const IAzScope, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReaders(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministrator(self: *const IAzScope, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministrator(self: *const IAzScope, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministrator(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReader(self: *const IAzScope, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReader(self: *const IAzScope, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReader(self, bstrReader, varReserved);
    }
    pub inline fn get_ApplicationGroups(self: *const IAzScope, ppGroupCollection: ?*?*IAzApplicationGroups) HRESULT {
        return self.vtable.get_ApplicationGroups(self, ppGroupCollection);
    }
    pub inline fn OpenApplicationGroup(self: *const IAzScope, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.OpenApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn CreateApplicationGroup(self: *const IAzScope, bstrGroupName: ?BSTR, varReserved: VARIANT, ppGroup: ?*?*IAzApplicationGroup) HRESULT {
        return self.vtable.CreateApplicationGroup(self, bstrGroupName, varReserved, ppGroup);
    }
    pub inline fn DeleteApplicationGroup(self: *const IAzScope, bstrGroupName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteApplicationGroup(self, bstrGroupName, varReserved);
    }
    pub inline fn get_Roles(self: *const IAzScope, ppRoleCollection: ?*?*IAzRoles) HRESULT {
        return self.vtable.get_Roles(self, ppRoleCollection);
    }
    pub inline fn OpenRole(self: *const IAzScope, bstrRoleName: ?BSTR, varReserved: VARIANT, ppRole: ?*?*IAzRole) HRESULT {
        return self.vtable.OpenRole(self, bstrRoleName, varReserved, ppRole);
    }
    pub inline fn CreateRole(self: *const IAzScope, bstrRoleName: ?BSTR, varReserved: VARIANT, ppRole: ?*?*IAzRole) HRESULT {
        return self.vtable.CreateRole(self, bstrRoleName, varReserved, ppRole);
    }
    pub inline fn DeleteRole(self: *const IAzScope, bstrRoleName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteRole(self, bstrRoleName, varReserved);
    }
    pub inline fn get_Tasks(self: *const IAzScope, ppTaskCollection: ?*?*IAzTasks) HRESULT {
        return self.vtable.get_Tasks(self, ppTaskCollection);
    }
    pub inline fn OpenTask(self: *const IAzScope, bstrTaskName: ?BSTR, varReserved: VARIANT, ppTask: ?*?*IAzTask) HRESULT {
        return self.vtable.OpenTask(self, bstrTaskName, varReserved, ppTask);
    }
    pub inline fn CreateTask(self: *const IAzScope, bstrTaskName: ?BSTR, varReserved: VARIANT, ppTask: ?*?*IAzTask) HRESULT {
        return self.vtable.CreateTask(self, bstrTaskName, varReserved, ppTask);
    }
    pub inline fn DeleteTask(self: *const IAzScope, bstrTaskName: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteTask(self, bstrTaskName, varReserved);
    }
    pub inline fn Submit(self: *const IAzScope, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
    pub inline fn get_CanBeDelegated(self: *const IAzScope, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_CanBeDelegated(self, pfProp);
    }
    pub inline fn get_BizrulesWritable(self: *const IAzScope, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_BizrulesWritable(self, pfProp);
    }
    pub inline fn get_PolicyAdministratorsName(self: *const IAzScope, pvarAdmins: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyAdministratorsName(self, pvarAdmins);
    }
    pub inline fn get_PolicyReadersName(self: *const IAzScope, pvarReaders: ?*VARIANT) HRESULT {
        return self.vtable.get_PolicyReadersName(self, pvarReaders);
    }
    pub inline fn AddPolicyAdministratorName(self: *const IAzScope, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn DeletePolicyAdministratorName(self: *const IAzScope, bstrAdmin: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyAdministratorName(self, bstrAdmin, varReserved);
    }
    pub inline fn AddPolicyReaderName(self: *const IAzScope, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPolicyReaderName(self, bstrReader, varReserved);
    }
    pub inline fn DeletePolicyReaderName(self: *const IAzScope, bstrReader: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePolicyReaderName(self, bstrReader, varReserved);
    }
};
...
pub const IAzScopes = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzScopes, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzScopes, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzScopes, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzApplicationGroup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzApplicationGroup, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzApplicationGroup, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Type(self: *const IAzApplicationGroup, plProp: ?*i32) HRESULT {
        return self.vtable.get_Type(self, plProp);
    }
    pub inline fn put_Type(self: *const IAzApplicationGroup, lProp: i32) HRESULT {
        return self.vtable.put_Type(self, lProp);
    }
    pub inline fn get_LdapQuery(self: *const IAzApplicationGroup, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_LdapQuery(self, pbstrProp);
    }
    pub inline fn put_LdapQuery(self: *const IAzApplicationGroup, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_LdapQuery(self, bstrProp);
    }
    pub inline fn get_AppMembers(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_AppMembers(self, pvarProp);
    }
    pub inline fn get_AppNonMembers(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_AppNonMembers(self, pvarProp);
    }
    pub inline fn get_Members(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Members(self, pvarProp);
    }
    pub inline fn get_NonMembers(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_NonMembers(self, pvarProp);
    }
    pub inline fn get_Description(self: *const IAzApplicationGroup, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzApplicationGroup, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn AddAppMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddAppMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteAppMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteAppMember(self, bstrProp, varReserved);
    }
    pub inline fn AddAppNonMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddAppNonMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteAppNonMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteAppNonMember(self, bstrProp, varReserved);
    }
    pub inline fn AddMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteMember(self, bstrProp, varReserved);
    }
    pub inline fn AddNonMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddNonMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteNonMember(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteNonMember(self, bstrProp, varReserved);
    }
    pub inline fn get_Writable(self: *const IAzApplicationGroup, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzApplicationGroup, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzApplicationGroup, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn AddPropertyItem(self: *const IAzApplicationGroup, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzApplicationGroup, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn Submit(self: *const IAzApplicationGroup, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
    pub inline fn AddMemberName(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddMemberName(self, bstrProp, varReserved);
    }
    pub inline fn DeleteMemberName(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteMemberName(self, bstrProp, varReserved);
    }
    pub inline fn AddNonMemberName(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddNonMemberName(self, bstrProp, varReserved);
    }
    pub inline fn DeleteNonMemberName(self: *const IAzApplicationGroup, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteNonMemberName(self, bstrProp, varReserved);
    }
    pub inline fn get_MembersName(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_MembersName(self, pvarProp);
    }
    pub inline fn get_NonMembersName(self: *const IAzApplicationGroup, pvarProp: ?*VARIANT) HRESULT {
...
pub const IAzApplicationGroups = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzApplicationGroups, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzApplicationGroups, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzApplicationGroups, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzRole = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IAzRole, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IAzRole, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Description(self: *const IAzRole, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbstrDescription);
    }
    pub inline fn put_Description(self: *const IAzRole, bstrDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bstrDescription);
    }
    pub inline fn get_ApplicationData(self: *const IAzRole, pbstrApplicationData: ?*?BSTR) HRESULT {
        return self.vtable.get_ApplicationData(self, pbstrApplicationData);
    }
    pub inline fn put_ApplicationData(self: *const IAzRole, bstrApplicationData: ?BSTR) HRESULT {
        return self.vtable.put_ApplicationData(self, bstrApplicationData);
    }
    pub inline fn AddAppMember(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddAppMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteAppMember(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteAppMember(self, bstrProp, varReserved);
    }
    pub inline fn AddTask(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddTask(self, bstrProp, varReserved);
    }
    pub inline fn DeleteTask(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteTask(self, bstrProp, varReserved);
    }
    pub inline fn AddOperation(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddOperation(self, bstrProp, varReserved);
    }
    pub inline fn DeleteOperation(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteOperation(self, bstrProp, varReserved);
    }
    pub inline fn AddMember(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddMember(self, bstrProp, varReserved);
    }
    pub inline fn DeleteMember(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteMember(self, bstrProp, varReserved);
    }
    pub inline fn get_Writable(self: *const IAzRole, pfProp: ?*BOOL) HRESULT {
        return self.vtable.get_Writable(self, pfProp);
    }
    pub inline fn GetProperty(self: *const IAzRole, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn SetProperty(self: *const IAzRole, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.SetProperty(self, lPropId, varProp, varReserved);
    }
    pub inline fn get_AppMembers(self: *const IAzRole, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_AppMembers(self, pvarProp);
    }
    pub inline fn get_Members(self: *const IAzRole, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Members(self, pvarProp);
    }
    pub inline fn get_Operations(self: *const IAzRole, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Operations(self, pvarProp);
    }
    pub inline fn get_Tasks(self: *const IAzRole, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_Tasks(self, pvarProp);
    }
    pub inline fn AddPropertyItem(self: *const IAzRole, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.AddPropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn DeletePropertyItem(self: *const IAzRole, lPropId: i32, varProp: VARIANT, varReserved: VARIANT) HRESULT {
        return self.vtable.DeletePropertyItem(self, lPropId, varProp, varReserved);
    }
    pub inline fn Submit(self: *const IAzRole, lFlags: i32, varReserved: VARIANT) HRESULT {
        return self.vtable.Submit(self, lFlags, varReserved);
    }
    pub inline fn AddMemberName(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.AddMemberName(self, bstrProp, varReserved);
    }
    pub inline fn DeleteMemberName(self: *const IAzRole, bstrProp: ?BSTR, varReserved: VARIANT) HRESULT {
        return self.vtable.DeleteMemberName(self, bstrProp, varReserved);
    }
    pub inline fn get_MembersName(self: *const IAzRole, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.get_MembersName(self, pvarProp);
    }
};
...
pub const IAzRoles = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzRoles, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzRoles, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzRoles, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzClientContext = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn AccessCheck(self: *const IAzClientContext, bstrObjectName: ?BSTR, varScopeNames: VARIANT, varOperations: VARIANT, varParameterNames: VARIANT, varParameterValues: VARIANT, varInterfaceNames: VARIANT, varInterfaceFlags: VARIANT, varInterfaces: VARIANT, pvarResults: ?*VARIANT) HRESULT {
    ...
    pub inline fn GetBusinessRuleString(self: *const IAzClientContext, pbstrBusinessRuleString: ?*?BSTR) HRESULT {
        return self.vtable.GetBusinessRuleString(self, pbstrBusinessRuleString);
    }
    pub inline fn get_UserDn(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserDn(self, pbstrProp);
    }
    pub inline fn get_UserSamCompat(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserSamCompat(self, pbstrProp);
    }
    pub inline fn get_UserDisplay(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserDisplay(self, pbstrProp);
    }
    pub inline fn get_UserGuid(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserGuid(self, pbstrProp);
    }
    pub inline fn get_UserCanonical(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserCanonical(self, pbstrProp);
    }
    pub inline fn get_UserUpn(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserUpn(self, pbstrProp);
    }
    pub inline fn get_UserDnsSamCompat(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_UserDnsSamCompat(self, pbstrProp);
    }
    pub inline fn GetProperty(self: *const IAzClientContext, lPropId: i32, varReserved: VARIANT, pvarProp: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lPropId, varReserved, pvarProp);
    }
    pub inline fn GetRoles(self: *const IAzClientContext, bstrScopeName: ?BSTR, pvarRoleNames: ?*VARIANT) HRESULT {
        return self.vtable.GetRoles(self, bstrScopeName, pvarRoleNames);
    }
    pub inline fn get_RoleForAccessCheck(self: *const IAzClientContext, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_RoleForAccessCheck(self, pbstrProp);
    }
    pub inline fn put_RoleForAccessCheck(self: *const IAzClientContext, bstrProp: ?BSTR) HRESULT {
...
pub const IAzClientContext2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetAssignedScopesPage(self: *const IAzClientContext2, lOptions: i32, PageSize: i32, pvarCursor: ?*VARIANT, pvarScopeNames: ?*VARIANT) HRESULT {
        return self.vtable.GetAssignedScopesPage(self, lOptions, PageSize, pvarCursor, pvarScopeNames);
    }
    pub inline fn AddRoles(self: *const IAzClientContext2, varRoles: VARIANT, bstrScopeName: ?BSTR) HRESULT {
        return self.vtable.AddRoles(self, varRoles, bstrScopeName);
    }
    pub inline fn AddApplicationGroups(self: *const IAzClientContext2, varApplicationGroups: VARIANT) HRESULT {
        return self.vtable.AddApplicationGroups(self, varApplicationGroups);
    }
    pub inline fn AddStringSids(self: *const IAzClientContext2, varStringSids: VARIANT) HRESULT {
        return self.vtable.AddStringSids(self, varStringSids);
    }
    pub inline fn put_LDAPQueryDN(self: *const IAzClientContext2, bstrLDAPQueryDN: ?BSTR) HRESULT {
        return self.vtable.put_LDAPQueryDN(self, bstrLDAPQueryDN);
    }
    pub inline fn get_LDAPQueryDN(self: *const IAzClientContext2, pbstrLDAPQueryDN: ?*?BSTR) HRESULT {
...
pub const IAzBizRuleContext = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_BusinessRuleResult(self: *const IAzBizRuleContext, bResult: BOOL) HRESULT {
        return self.vtable.put_BusinessRuleResult(self, bResult);
    }
    pub inline fn put_BusinessRuleString(self: *const IAzBizRuleContext, bstrBusinessRuleString: ?BSTR) HRESULT {
        return self.vtable.put_BusinessRuleString(self, bstrBusinessRuleString);
    }
    pub inline fn get_BusinessRuleString(self: *const IAzBizRuleContext, pbstrBusinessRuleString: ?*?BSTR) HRESULT {
        return self.vtable.get_BusinessRuleString(self, pbstrBusinessRuleString);
    }
    pub inline fn GetParameter(self: *const IAzBizRuleContext, bstrParameterName: ?BSTR, pvarParameterValue: ?*VARIANT) HRESULT {
...
pub const IAzBizRuleParameters = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn AddParameter(self: *const IAzBizRuleParameters, bstrParameterName: ?BSTR, varParameterValue: VARIANT) HRESULT {
        return self.vtable.AddParameter(self, bstrParameterName, varParameterValue);
    }
    pub inline fn AddParameters(self: *const IAzBizRuleParameters, varParameterNames: VARIANT, varParameterValues: VARIANT) HRESULT {
        return self.vtable.AddParameters(self, varParameterNames, varParameterValues);
    }
    pub inline fn GetParameterValue(self: *const IAzBizRuleParameters, bstrParameterName: ?BSTR, pvarParameterValue: ?*VARIANT) HRESULT {
        return self.vtable.GetParameterValue(self, bstrParameterName, pvarParameterValue);
    }
    pub inline fn Remove(self: *const IAzBizRuleParameters, varParameterName: ?BSTR) HRESULT {
        return self.vtable.Remove(self, varParameterName);
    }
    pub inline fn RemoveAll(self: *const IAzBizRuleParameters) HRESULT {
        return self.vtable.RemoveAll(self);
    }
    pub inline fn get_Count(self: *const IAzBizRuleParameters, plCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IAzBizRuleInterfaces = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn AddInterface(self: *const IAzBizRuleInterfaces, bstrInterfaceName: ?BSTR, lInterfaceFlag: i32, varInterface: VARIANT) HRESULT {
        return self.vtable.AddInterface(self, bstrInterfaceName, lInterfaceFlag, varInterface);
    }
    pub inline fn AddInterfaces(self: *const IAzBizRuleInterfaces, varInterfaceNames: VARIANT, varInterfaceFlags: VARIANT, varInterfaces: VARIANT) HRESULT {
        return self.vtable.AddInterfaces(self, varInterfaceNames, varInterfaceFlags, varInterfaces);
    }
    pub inline fn GetInterfaceValue(self: *const IAzBizRuleInterfaces, bstrInterfaceName: ?BSTR, lInterfaceFlag: ?*i32, varInterface: ?*VARIANT) HRESULT {
        return self.vtable.GetInterfaceValue(self, bstrInterfaceName, lInterfaceFlag, varInterface);
    }
    pub inline fn Remove(self: *const IAzBizRuleInterfaces, bstrInterfaceName: ?BSTR) HRESULT {
        return self.vtable.Remove(self, bstrInterfaceName);
    }
    pub inline fn RemoveAll(self: *const IAzBizRuleInterfaces) HRESULT {
        return self.vtable.RemoveAll(self);
    }
    pub inline fn get_Count(self: *const IAzBizRuleInterfaces, plCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
};
...
pub const IAzClientContext3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn AccessCheck2(self: *const IAzClientContext3, bstrObjectName: ?BSTR, bstrScopeName: ?BSTR, lOperation: i32, plResult: ?*u32) HRESULT {
        return self.vtable.AccessCheck2(self, bstrObjectName, bstrScopeName, lOperation, plResult);
    }
    pub inline fn IsInRoleAssignment(self: *const IAzClientContext3, bstrScopeName: ?BSTR, bstrRoleName: ?BSTR, pbIsInRole: ?*i16) HRESULT {
        return self.vtable.IsInRoleAssignment(self, bstrScopeName, bstrRoleName, pbIsInRole);
    }
    pub inline fn GetOperations(self: *const IAzClientContext3, bstrScopeName: ?BSTR, ppOperationCollection: ?*?*IAzOperations) HRESULT {
        return self.vtable.GetOperations(self, bstrScopeName, ppOperationCollection);
    }
    pub inline fn GetTasks(self: *const IAzClientContext3, bstrScopeName: ?BSTR, ppTaskCollection: ?*?*IAzTasks) HRESULT {
        return self.vtable.GetTasks(self, bstrScopeName, ppTaskCollection);
    }
    pub inline fn get_BizRuleParameters(self: *const IAzClientContext3, ppBizRuleParam: ?*?*IAzBizRuleParameters) HRESULT {
        return self.vtable.get_BizRuleParameters(self, ppBizRuleParam);
    }
    pub inline fn get_BizRuleInterfaces(self: *const IAzClientContext3, ppBizRuleInterfaces: ?*?*IAzBizRuleInterfaces) HRESULT {
        return self.vtable.get_BizRuleInterfaces(self, ppBizRuleInterfaces);
    }
    pub inline fn GetGroups(self: *const IAzClientContext3, bstrScopeName: ?BSTR, ulOptions: AZ_PROP_CONSTANTS, pGroupArray: ?*VARIANT) HRESULT {
        return self.vtable.GetGroups(self, bstrScopeName, ulOptions, pGroupArray);
    }
    pub inline fn get_Sids(self: *const IAzClientContext3, pStringSidArray: ?*VARIANT) HRESULT {
...
pub const IAzScope2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_RoleDefinitions(self: *const IAzScope2, ppRoleDefinitions: ?*?*IAzRoleDefinitions) HRESULT {
        return self.vtable.get_RoleDefinitions(self, ppRoleDefinitions);
    }
    pub inline fn CreateRoleDefinition(self: *const IAzScope2, bstrRoleDefinitionName: ?BSTR, ppRoleDefinitions: ?*?*IAzRoleDefinition) HRESULT {
        return self.vtable.CreateRoleDefinition(self, bstrRoleDefinitionName, ppRoleDefinitions);
    }
    pub inline fn OpenRoleDefinition(self: *const IAzScope2, bstrRoleDefinitionName: ?BSTR, ppRoleDefinitions: ?*?*IAzRoleDefinition) HRESULT {
        return self.vtable.OpenRoleDefinition(self, bstrRoleDefinitionName, ppRoleDefinitions);
    }
    pub inline fn DeleteRoleDefinition(self: *const IAzScope2, bstrRoleDefinitionName: ?BSTR) HRESULT {
        return self.vtable.DeleteRoleDefinition(self, bstrRoleDefinitionName);
    }
    pub inline fn get_RoleAssignments(self: *const IAzScope2, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
        return self.vtable.get_RoleAssignments(self, ppRoleAssignments);
    }
    pub inline fn CreateRoleAssignment(self: *const IAzScope2, bstrRoleAssignmentName: ?BSTR, ppRoleAssignment: ?*?*IAzRoleAssignment) HRESULT {
        return self.vtable.CreateRoleAssignment(self, bstrRoleAssignmentName, ppRoleAssignment);
    }
    pub inline fn OpenRoleAssignment(self: *const IAzScope2, bstrRoleAssignmentName: ?BSTR, ppRoleAssignment: ?*?*IAzRoleAssignment) HRESULT {
        return self.vtable.OpenRoleAssignment(self, bstrRoleAssignmentName, ppRoleAssignment);
    }
    pub inline fn DeleteRoleAssignment(self: *const IAzScope2, bstrRoleAssignmentName: ?BSTR) HRESULT {
...
pub const IAzApplication3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn ScopeExists(self: *const IAzApplication3, bstrScopeName: ?BSTR, pbExist: ?*i16) HRESULT {
        return self.vtable.ScopeExists(self, bstrScopeName, pbExist);
    }
    pub inline fn OpenScope2(self: *const IAzApplication3, bstrScopeName: ?BSTR, ppScope2: ?*?*IAzScope2) HRESULT {
        return self.vtable.OpenScope2(self, bstrScopeName, ppScope2);
    }
    pub inline fn CreateScope2(self: *const IAzApplication3, bstrScopeName: ?BSTR, ppScope2: ?*?*IAzScope2) HRESULT {
        return self.vtable.CreateScope2(self, bstrScopeName, ppScope2);
    }
    pub inline fn DeleteScope2(self: *const IAzApplication3, bstrScopeName: ?BSTR) HRESULT {
        return self.vtable.DeleteScope2(self, bstrScopeName);
    }
    pub inline fn get_RoleDefinitions(self: *const IAzApplication3, ppRoleDefinitions: ?*?*IAzRoleDefinitions) HRESULT {
        return self.vtable.get_RoleDefinitions(self, ppRoleDefinitions);
    }
    pub inline fn CreateRoleDefinition(self: *const IAzApplication3, bstrRoleDefinitionName: ?BSTR, ppRoleDefinitions: ?*?*IAzRoleDefinition) HRESULT {
        return self.vtable.CreateRoleDefinition(self, bstrRoleDefinitionName, ppRoleDefinitions);
    }
    pub inline fn OpenRoleDefinition(self: *const IAzApplication3, bstrRoleDefinitionName: ?BSTR, ppRoleDefinitions: ?*?*IAzRoleDefinition) HRESULT {
        return self.vtable.OpenRoleDefinition(self, bstrRoleDefinitionName, ppRoleDefinitions);
    }
    pub inline fn DeleteRoleDefinition(self: *const IAzApplication3, bstrRoleDefinitionName: ?BSTR) HRESULT {
        return self.vtable.DeleteRoleDefinition(self, bstrRoleDefinitionName);
    }
    pub inline fn get_RoleAssignments(self: *const IAzApplication3, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
        return self.vtable.get_RoleAssignments(self, ppRoleAssignments);
    }
    pub inline fn CreateRoleAssignment(self: *const IAzApplication3, bstrRoleAssignmentName: ?BSTR, ppRoleAssignment: ?*?*IAzRoleAssignment) HRESULT {
        return self.vtable.CreateRoleAssignment(self, bstrRoleAssignmentName, ppRoleAssignment);
    }
    pub inline fn OpenRoleAssignment(self: *const IAzApplication3, bstrRoleAssignmentName: ?BSTR, ppRoleAssignment: ?*?*IAzRoleAssignment) HRESULT {
        return self.vtable.OpenRoleAssignment(self, bstrRoleAssignmentName, ppRoleAssignment);
    }
    pub inline fn DeleteRoleAssignment(self: *const IAzApplication3, bstrRoleAssignmentName: ?BSTR) HRESULT {
        return self.vtable.DeleteRoleAssignment(self, bstrRoleAssignmentName);
    }
    pub inline fn get_BizRulesEnabled(self: *const IAzApplication3, pbEnabled: ?*i16) HRESULT {
        return self.vtable.get_BizRulesEnabled(self, pbEnabled);
    }
    pub inline fn put_BizRulesEnabled(self: *const IAzApplication3, bEnabled: i16) HRESULT {
...
pub const IAzOperation2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RoleAssignments(self: *const IAzOperation2, bstrScopeName: ?BSTR, bRecursive: i16, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
...
pub const IAzRoleDefinitions = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzRoleDefinitions, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzRoleDefinitions, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzRoleDefinitions, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzRoleDefinition = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RoleAssignments(self: *const IAzRoleDefinition, bstrScopeName: ?BSTR, bRecursive: i16, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
        return self.vtable.RoleAssignments(self, bstrScopeName, bRecursive, ppRoleAssignments);
    }
    pub inline fn AddRoleDefinition(self: *const IAzRoleDefinition, bstrRoleDefinition: ?BSTR) HRESULT {
        return self.vtable.AddRoleDefinition(self, bstrRoleDefinition);
    }
    pub inline fn DeleteRoleDefinition(self: *const IAzRoleDefinition, bstrRoleDefinition: ?BSTR) HRESULT {
        return self.vtable.DeleteRoleDefinition(self, bstrRoleDefinition);
    }
    pub inline fn get_RoleDefinitions(self: *const IAzRoleDefinition, ppRoleDefinitions: ?*?*IAzRoleDefinitions) HRESULT {
        return self.vtable.get_RoleDefinitions(self, ppRoleDefinitions);
    }
};
...
pub const IAzRoleAssignment = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn AddRoleDefinition(self: *const IAzRoleAssignment, bstrRoleDefinition: ?BSTR) HRESULT {
        return self.vtable.AddRoleDefinition(self, bstrRoleDefinition);
    }
    pub inline fn DeleteRoleDefinition(self: *const IAzRoleAssignment, bstrRoleDefinition: ?BSTR) HRESULT {
        return self.vtable.DeleteRoleDefinition(self, bstrRoleDefinition);
    }
    pub inline fn get_RoleDefinitions(self: *const IAzRoleAssignment, ppRoleDefinitions: ?*?*IAzRoleDefinitions) HRESULT {
        return self.vtable.get_RoleDefinitions(self, ppRoleDefinitions);
    }
    pub inline fn get_Scope(self: *const IAzRoleAssignment, ppScope: ?*?*IAzScope) HRESULT {
...
pub const IAzRoleAssignments = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IAzRoleAssignments, Index: i32, pvarObtPtr: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pvarObtPtr);
    }
    pub inline fn get_Count(self: *const IAzRoleAssignments, plCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, plCount);
    }
    pub inline fn get__NewEnum(self: *const IAzRoleAssignments, ppEnumPtr: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnumPtr);
    }
};
...
pub const IAzPrincipalLocator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_NameResolver(self: *const IAzPrincipalLocator, ppNameResolver: ?*?*IAzNameResolver) HRESULT {
        return self.vtable.get_NameResolver(self, ppNameResolver);
    }
    pub inline fn get_ObjectPicker(self: *const IAzPrincipalLocator, ppObjectPicker: ?*?*IAzObjectPicker) HRESULT {
...
pub const IAzNameResolver = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn NameFromSid(self: *const IAzNameResolver, bstrSid: ?BSTR, pSidType: ?*i32, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.NameFromSid(self, bstrSid, pSidType, pbstrName);
    }
    pub inline fn NamesFromSids(self: *const IAzNameResolver, vSids: VARIANT, pvSidTypes: ?*VARIANT, pvNames: ?*VARIANT) HRESULT {
...
pub const IAzObjectPicker = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetPrincipals(self: *const IAzObjectPicker, hParentWnd: ?HWND, bstrTitle: ?BSTR, pvSidTypes: ?*VARIANT, pvNames: ?*VARIANT, pvSids: ?*VARIANT) HRESULT {
        return self.vtable.GetPrincipals(self, hParentWnd, bstrTitle, pvSidTypes, pvNames, pvSids);
    }
    pub inline fn get_Name(self: *const IAzObjectPicker, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
};
...
pub const IAzApplicationGroup2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BizRule(self: *const IAzApplicationGroup2, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRule(self, pbstrProp);
    }
    pub inline fn put_BizRule(self: *const IAzApplicationGroup2, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRule(self, bstrProp);
    }
    pub inline fn get_BizRuleLanguage(self: *const IAzApplicationGroup2, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRuleLanguage(self, pbstrProp);
    }
    pub inline fn put_BizRuleLanguage(self: *const IAzApplicationGroup2, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRuleLanguage(self, bstrProp);
    }
    pub inline fn get_BizRuleImportedPath(self: *const IAzApplicationGroup2, pbstrProp: ?*?BSTR) HRESULT {
        return self.vtable.get_BizRuleImportedPath(self, pbstrProp);
    }
    pub inline fn put_BizRuleImportedPath(self: *const IAzApplicationGroup2, bstrProp: ?BSTR) HRESULT {
        return self.vtable.put_BizRuleImportedPath(self, bstrProp);
    }
    pub inline fn RoleAssignments(self: *const IAzApplicationGroup2, bstrScopeName: ?BSTR, bRecursive: i16, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
        return self.vtable.RoleAssignments(self, bstrScopeName, bRecursive, ppRoleAssignments);
    }
};
...
pub const IAzTask2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RoleAssignments(self: *const IAzTask2, bstrScopeName: ?BSTR, bRecursive: i16, ppRoleAssignments: ?*?*IAzRoleAssignments) HRESULT {
        return self.vtable.RoleAssignments(self, bstrScopeName, bRecursive, ppRoleAssignments);
    }
};
...
// TODO: this type is limited to platform 'windows8.0'
pub extern "authz" fn AuthzFreeCentralAccessPolicyCache() callconv(.winapi) BOOL;
