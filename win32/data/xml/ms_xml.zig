...
pub const IXMLDOMImplementation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn hasFeature(self: *const IXMLDOMImplementation, feature: ?BSTR, version: ?BSTR, _param_hasFeature: ?*i16) HRESULT {
...
pub const IXMLDOMNode = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_nodeName(self: *const IXMLDOMNode, name: ?*?BSTR) HRESULT {
        return self.vtable.get_nodeName(self, name);
    }
    pub inline fn get_nodeValue(self: *const IXMLDOMNode, value: ?*VARIANT) HRESULT {
        return self.vtable.get_nodeValue(self, value);
    }
    pub inline fn put_nodeValue(self: *const IXMLDOMNode, value: VARIANT) HRESULT {
        return self.vtable.put_nodeValue(self, value);
    }
    pub inline fn get_nodeType(self: *const IXMLDOMNode, @"type": ?*DOMNodeType) HRESULT {
        return self.vtable.get_nodeType(self, @"type");
    }
    pub inline fn get_parentNode(self: *const IXMLDOMNode, parent: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_parentNode(self, parent);
    }
    pub inline fn get_childNodes(self: *const IXMLDOMNode, childList: ?*?*IXMLDOMNodeList) HRESULT {
        return self.vtable.get_childNodes(self, childList);
    }
    pub inline fn get_firstChild(self: *const IXMLDOMNode, firstChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_firstChild(self, firstChild);
    }
    pub inline fn get_lastChild(self: *const IXMLDOMNode, lastChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_lastChild(self, lastChild);
    }
    pub inline fn get_previousSibling(self: *const IXMLDOMNode, previousSibling: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_previousSibling(self, previousSibling);
    }
    pub inline fn get_nextSibling(self: *const IXMLDOMNode, nextSibling: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_nextSibling(self, nextSibling);
    }
    pub inline fn get_attributes(self: *const IXMLDOMNode, attributeMap: ?*?*IXMLDOMNamedNodeMap) HRESULT {
        return self.vtable.get_attributes(self, attributeMap);
    }
    pub inline fn insertBefore(self: *const IXMLDOMNode, newChild: ?*IXMLDOMNode, refChild: VARIANT, outNewChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.insertBefore(self, newChild, refChild, outNewChild);
    }
    pub inline fn replaceChild(self: *const IXMLDOMNode, newChild: ?*IXMLDOMNode, oldChild: ?*IXMLDOMNode, outOldChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.replaceChild(self, newChild, oldChild, outOldChild);
    }
    pub inline fn removeChild(self: *const IXMLDOMNode, childNode: ?*IXMLDOMNode, oldChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.removeChild(self, childNode, oldChild);
    }
    pub inline fn appendChild(self: *const IXMLDOMNode, newChild: ?*IXMLDOMNode, outNewChild: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.appendChild(self, newChild, outNewChild);
    }
    pub inline fn hasChildNodes(self: *const IXMLDOMNode, hasChild: ?*i16) HRESULT {
        return self.vtable.hasChildNodes(self, hasChild);
    }
    pub inline fn get_ownerDocument(self: *const IXMLDOMNode, XMLDOMDocument: ?*?*IXMLDOMDocument) HRESULT {
        return self.vtable.get_ownerDocument(self, XMLDOMDocument);
    }
    pub inline fn cloneNode(self: *const IXMLDOMNode, deep: i16, cloneRoot: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.cloneNode(self, deep, cloneRoot);
    }
    pub inline fn get_nodeTypeString(self: *const IXMLDOMNode, nodeType: ?*?BSTR) HRESULT {
        return self.vtable.get_nodeTypeString(self, nodeType);
    }
    pub inline fn get_text(self: *const IXMLDOMNode, text: ?*?BSTR) HRESULT {
        return self.vtable.get_text(self, text);
    }
    pub inline fn put_text(self: *const IXMLDOMNode, text: ?BSTR) HRESULT {
        return self.vtable.put_text(self, text);
    }
    pub inline fn get_specified(self: *const IXMLDOMNode, isSpecified: ?*i16) HRESULT {
        return self.vtable.get_specified(self, isSpecified);
    }
    pub inline fn get_definition(self: *const IXMLDOMNode, definitionNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_definition(self, definitionNode);
    }
    pub inline fn get_nodeTypedValue(self: *const IXMLDOMNode, typedValue: ?*VARIANT) HRESULT {
        return self.vtable.get_nodeTypedValue(self, typedValue);
    }
    pub inline fn put_nodeTypedValue(self: *const IXMLDOMNode, typedValue: VARIANT) HRESULT {
        return self.vtable.put_nodeTypedValue(self, typedValue);
    }
    pub inline fn get_dataType(self: *const IXMLDOMNode, dataTypeName: ?*VARIANT) HRESULT {
        return self.vtable.get_dataType(self, dataTypeName);
    }
    pub inline fn put_dataType(self: *const IXMLDOMNode, dataTypeName: ?BSTR) HRESULT {
        return self.vtable.put_dataType(self, dataTypeName);
    }
    pub inline fn get_xml(self: *const IXMLDOMNode, xmlString: ?*?BSTR) HRESULT {
        return self.vtable.get_xml(self, xmlString);
    }
    pub inline fn transformNode(self: *const IXMLDOMNode, stylesheet: ?*IXMLDOMNode, xmlString: ?*?BSTR) HRESULT {
        return self.vtable.transformNode(self, stylesheet, xmlString);
    }
    pub inline fn selectNodes(self: *const IXMLDOMNode, queryString: ?BSTR, resultList: ?*?*IXMLDOMNodeList) HRESULT {
        return self.vtable.selectNodes(self, queryString, resultList);
    }
    pub inline fn selectSingleNode(self: *const IXMLDOMNode, queryString: ?BSTR, resultNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.selectSingleNode(self, queryString, resultNode);
    }
    pub inline fn get_parsed(self: *const IXMLDOMNode, isParsed: ?*i16) HRESULT {
        return self.vtable.get_parsed(self, isParsed);
    }
    pub inline fn get_namespaceURI(self: *const IXMLDOMNode, namespaceURI: ?*?BSTR) HRESULT {
        return self.vtable.get_namespaceURI(self, namespaceURI);
    }
    pub inline fn get_prefix(self: *const IXMLDOMNode, prefixString: ?*?BSTR) HRESULT {
        return self.vtable.get_prefix(self, prefixString);
    }
    pub inline fn get_baseName(self: *const IXMLDOMNode, nameString: ?*?BSTR) HRESULT {
        return self.vtable.get_baseName(self, nameString);
    }
    pub inline fn transformNodeToObject(self: *const IXMLDOMNode, stylesheet: ?*IXMLDOMNode, outputObject: VARIANT) HRESULT {
...
pub const IXMLDOMDocument = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_doctype(self: *const IXMLDOMDocument, documentType: ?*?*IXMLDOMDocumentType) HRESULT {
        return self.vtable.get_doctype(self, documentType);
    }
    pub inline fn get_implementation(self: *const IXMLDOMDocument, impl: ?*?*IXMLDOMImplementation) HRESULT {
        return self.vtable.get_implementation(self, impl);
    }
    pub inline fn get_documentElement(self: *const IXMLDOMDocument, DOMElement: ?*?*IXMLDOMElement) HRESULT {
        return self.vtable.get_documentElement(self, DOMElement);
    }
    pub inline fn putref_documentElement(self: *const IXMLDOMDocument, DOMElement: ?*IXMLDOMElement) HRESULT {
        return self.vtable.putref_documentElement(self, DOMElement);
    }
    pub inline fn createElement(self: *const IXMLDOMDocument, tagName: ?BSTR, element: ?*?*IXMLDOMElement) HRESULT {
        return self.vtable.createElement(self, tagName, element);
    }
    pub inline fn createDocumentFragment(self: *const IXMLDOMDocument, docFrag: ?*?*IXMLDOMDocumentFragment) HRESULT {
        return self.vtable.createDocumentFragment(self, docFrag);
    }
    pub inline fn createTextNode(self: *const IXMLDOMDocument, data: ?BSTR, text: ?*?*IXMLDOMText) HRESULT {
        return self.vtable.createTextNode(self, data, text);
    }
    pub inline fn createComment(self: *const IXMLDOMDocument, data: ?BSTR, comment: ?*?*IXMLDOMComment) HRESULT {
        return self.vtable.createComment(self, data, comment);
    }
    pub inline fn createCDATASection(self: *const IXMLDOMDocument, data: ?BSTR, cdata: ?*?*IXMLDOMCDATASection) HRESULT {
        return self.vtable.createCDATASection(self, data, cdata);
    }
    pub inline fn createProcessingInstruction(self: *const IXMLDOMDocument, target: ?BSTR, data: ?BSTR, pi: ?*?*IXMLDOMProcessingInstruction) HRESULT {
        return self.vtable.createProcessingInstruction(self, target, data, pi);
    }
    pub inline fn createAttribute(self: *const IXMLDOMDocument, name: ?BSTR, attribute: ?*?*IXMLDOMAttribute) HRESULT {
        return self.vtable.createAttribute(self, name, attribute);
    }
    pub inline fn createEntityReference(self: *const IXMLDOMDocument, name: ?BSTR, entityRef: ?*?*IXMLDOMEntityReference) HRESULT {
        return self.vtable.createEntityReference(self, name, entityRef);
    }
    pub inline fn getElementsByTagName(self: *const IXMLDOMDocument, tagName: ?BSTR, resultList: ?*?*IXMLDOMNodeList) HRESULT {
        return self.vtable.getElementsByTagName(self, tagName, resultList);
    }
    pub inline fn createNode(self: *const IXMLDOMDocument, Type: VARIANT, name: ?BSTR, namespaceURI: ?BSTR, node: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.createNode(self, Type, name, namespaceURI, node);
    }
    pub inline fn nodeFromID(self: *const IXMLDOMDocument, idString: ?BSTR, node: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.nodeFromID(self, idString, node);
    }
    pub inline fn load(self: *const IXMLDOMDocument, xmlSource: VARIANT, isSuccessful: ?*i16) HRESULT {
        return self.vtable.load(self, xmlSource, isSuccessful);
    }
    pub inline fn get_readyState(self: *const IXMLDOMDocument, value: ?*i32) HRESULT {
        return self.vtable.get_readyState(self, value);
    }
    pub inline fn get_parseError(self: *const IXMLDOMDocument, errorObj: ?*?*IXMLDOMParseError) HRESULT {
        return self.vtable.get_parseError(self, errorObj);
    }
    pub inline fn get_url(self: *const IXMLDOMDocument, urlString: ?*?BSTR) HRESULT {
        return self.vtable.get_url(self, urlString);
    }
    pub inline fn get_async(self: *const IXMLDOMDocument, isAsync: ?*i16) HRESULT {
        return self.vtable.get_async(self, isAsync);
    }
    pub inline fn put_async(self: *const IXMLDOMDocument, isAsync: i16) HRESULT {
        return self.vtable.put_async(self, isAsync);
    }
    pub inline fn abort(self: *const IXMLDOMDocument) HRESULT {
        return self.vtable.abort(self);
    }
    pub inline fn loadXML(self: *const IXMLDOMDocument, bstrXML: ?BSTR, isSuccessful: ?*i16) HRESULT {
        return self.vtable.loadXML(self, bstrXML, isSuccessful);
    }
    pub inline fn save(self: *const IXMLDOMDocument, destination: VARIANT) HRESULT {
        return self.vtable.save(self, destination);
    }
    pub inline fn get_validateOnParse(self: *const IXMLDOMDocument, isValidating: ?*i16) HRESULT {
        return self.vtable.get_validateOnParse(self, isValidating);
    }
    pub inline fn put_validateOnParse(self: *const IXMLDOMDocument, isValidating: i16) HRESULT {
        return self.vtable.put_validateOnParse(self, isValidating);
    }
    pub inline fn get_resolveExternals(self: *const IXMLDOMDocument, isResolving: ?*i16) HRESULT {
        return self.vtable.get_resolveExternals(self, isResolving);
    }
    pub inline fn put_resolveExternals(self: *const IXMLDOMDocument, isResolving: i16) HRESULT {
        return self.vtable.put_resolveExternals(self, isResolving);
    }
    pub inline fn get_preserveWhiteSpace(self: *const IXMLDOMDocument, isPreserving: ?*i16) HRESULT {
        return self.vtable.get_preserveWhiteSpace(self, isPreserving);
    }
    pub inline fn put_preserveWhiteSpace(self: *const IXMLDOMDocument, isPreserving: i16) HRESULT {
        return self.vtable.put_preserveWhiteSpace(self, isPreserving);
    }
    pub inline fn put_onreadystatechange(self: *const IXMLDOMDocument, readystatechangeSink: VARIANT) HRESULT {
        return self.vtable.put_onreadystatechange(self, readystatechangeSink);
    }
    pub inline fn put_ondataavailable(self: *const IXMLDOMDocument, ondataavailableSink: VARIANT) HRESULT {
        return self.vtable.put_ondataavailable(self, ondataavailableSink);
    }
    pub inline fn put_ontransformnode(self: *const IXMLDOMDocument, ontransformnodeSink: VARIANT) HRESULT {
...
pub const IXMLDOMNodeList = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_item(self: *const IXMLDOMNodeList, index: i32, listItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_item(self, index, listItem);
    }
    pub inline fn get_length(self: *const IXMLDOMNodeList, listLength: ?*i32) HRESULT {
        return self.vtable.get_length(self, listLength);
    }
    pub inline fn nextNode(self: *const IXMLDOMNodeList, nextItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.nextNode(self, nextItem);
    }
    pub inline fn reset(self: *const IXMLDOMNodeList) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn get__newEnum(self: *const IXMLDOMNodeList, ppUnk: ?*?*IUnknown) HRESULT {
...
pub const IXMLDOMNamedNodeMap = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn getNamedItem(self: *const IXMLDOMNamedNodeMap, name: ?BSTR, namedItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.getNamedItem(self, name, namedItem);
    }
    pub inline fn setNamedItem(self: *const IXMLDOMNamedNodeMap, newItem: ?*IXMLDOMNode, nameItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.setNamedItem(self, newItem, nameItem);
    }
    pub inline fn removeNamedItem(self: *const IXMLDOMNamedNodeMap, name: ?BSTR, namedItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.removeNamedItem(self, name, namedItem);
    }
    pub inline fn get_item(self: *const IXMLDOMNamedNodeMap, index: i32, listItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_item(self, index, listItem);
    }
    pub inline fn get_length(self: *const IXMLDOMNamedNodeMap, listLength: ?*i32) HRESULT {
        return self.vtable.get_length(self, listLength);
    }
    pub inline fn getQualifiedItem(self: *const IXMLDOMNamedNodeMap, baseName: ?BSTR, namespaceURI: ?BSTR, qualifiedItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.getQualifiedItem(self, baseName, namespaceURI, qualifiedItem);
    }
    pub inline fn removeQualifiedItem(self: *const IXMLDOMNamedNodeMap, baseName: ?BSTR, namespaceURI: ?BSTR, qualifiedItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.removeQualifiedItem(self, baseName, namespaceURI, qualifiedItem);
    }
    pub inline fn nextNode(self: *const IXMLDOMNamedNodeMap, nextItem: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.nextNode(self, nextItem);
    }
    pub inline fn reset(self: *const IXMLDOMNamedNodeMap) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn get__newEnum(self: *const IXMLDOMNamedNodeMap, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppUnk);
    }
};
...
pub const IXMLDOMCharacterData = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_data(self: *const IXMLDOMCharacterData, data: ?*?BSTR) HRESULT {
        return self.vtable.get_data(self, data);
    }
    pub inline fn put_data(self: *const IXMLDOMCharacterData, data: ?BSTR) HRESULT {
        return self.vtable.put_data(self, data);
    }
    pub inline fn get_length(self: *const IXMLDOMCharacterData, dataLength: ?*i32) HRESULT {
        return self.vtable.get_length(self, dataLength);
    }
    pub inline fn substringData(self: *const IXMLDOMCharacterData, offset: i32, count: i32, data: ?*?BSTR) HRESULT {
        return self.vtable.substringData(self, offset, count, data);
    }
    pub inline fn appendData(self: *const IXMLDOMCharacterData, data: ?BSTR) HRESULT {
        return self.vtable.appendData(self, data);
    }
    pub inline fn insertData(self: *const IXMLDOMCharacterData, offset: i32, data: ?BSTR) HRESULT {
        return self.vtable.insertData(self, offset, data);
    }
    pub inline fn deleteData(self: *const IXMLDOMCharacterData, offset: i32, count: i32) HRESULT {
        return self.vtable.deleteData(self, offset, count);
    }
    pub inline fn replaceData(self: *const IXMLDOMCharacterData, offset: i32, count: i32, data: ?BSTR) HRESULT {
...
pub const IXMLDOMAttribute = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_name(self: *const IXMLDOMAttribute, attributeName: ?*?BSTR) HRESULT {
        return self.vtable.get_name(self, attributeName);
    }
    pub inline fn get_value(self: *const IXMLDOMAttribute, attributeValue: ?*VARIANT) HRESULT {
        return self.vtable.get_value(self, attributeValue);
    }
    pub inline fn put_value(self: *const IXMLDOMAttribute, attributeValue: VARIANT) HRESULT {
...
pub const IXMLDOMElement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_tagName(self: *const IXMLDOMElement, tagName: ?*?BSTR) HRESULT {
        return self.vtable.get_tagName(self, tagName);
    }
    pub inline fn getAttribute(self: *const IXMLDOMElement, name: ?BSTR, value: ?*VARIANT) HRESULT {
        return self.vtable.getAttribute(self, name, value);
    }
    pub inline fn setAttribute(self: *const IXMLDOMElement, name: ?BSTR, value: VARIANT) HRESULT {
        return self.vtable.setAttribute(self, name, value);
    }
    pub inline fn removeAttribute(self: *const IXMLDOMElement, name: ?BSTR) HRESULT {
        return self.vtable.removeAttribute(self, name);
    }
    pub inline fn getAttributeNode(self: *const IXMLDOMElement, name: ?BSTR, attributeNode: ?*?*IXMLDOMAttribute) HRESULT {
        return self.vtable.getAttributeNode(self, name, attributeNode);
    }
    pub inline fn setAttributeNode(self: *const IXMLDOMElement, DOMAttribute: ?*IXMLDOMAttribute, attributeNode: ?*?*IXMLDOMAttribute) HRESULT {
        return self.vtable.setAttributeNode(self, DOMAttribute, attributeNode);
    }
    pub inline fn removeAttributeNode(self: *const IXMLDOMElement, DOMAttribute: ?*IXMLDOMAttribute, attributeNode: ?*?*IXMLDOMAttribute) HRESULT {
        return self.vtable.removeAttributeNode(self, DOMAttribute, attributeNode);
    }
    pub inline fn getElementsByTagName(self: *const IXMLDOMElement, tagName: ?BSTR, resultList: ?*?*IXMLDOMNodeList) HRESULT {
        return self.vtable.getElementsByTagName(self, tagName, resultList);
    }
    pub inline fn normalize(self: *const IXMLDOMElement) HRESULT {
...
pub const IXMLDOMText = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn splitText(self: *const IXMLDOMText, offset: i32, rightHandTextNode: ?*?*IXMLDOMText) HRESULT {
...
pub const IXMLDOMProcessingInstruction = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_target(self: *const IXMLDOMProcessingInstruction, name: ?*?BSTR) HRESULT {
        return self.vtable.get_target(self, name);
    }
    pub inline fn get_data(self: *const IXMLDOMProcessingInstruction, value: ?*?BSTR) HRESULT {
        return self.vtable.get_data(self, value);
    }
    pub inline fn put_data(self: *const IXMLDOMProcessingInstruction, value: ?BSTR) HRESULT {
...
pub const IXMLDOMDocumentType = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_name(self: *const IXMLDOMDocumentType, rootName: ?*?BSTR) HRESULT {
        return self.vtable.get_name(self, rootName);
    }
    pub inline fn get_entities(self: *const IXMLDOMDocumentType, entityMap: ?*?*IXMLDOMNamedNodeMap) HRESULT {
        return self.vtable.get_entities(self, entityMap);
    }
    pub inline fn get_notations(self: *const IXMLDOMDocumentType, notationMap: ?*?*IXMLDOMNamedNodeMap) HRESULT {
...
pub const IXMLDOMNotation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_publicId(self: *const IXMLDOMNotation, publicID: ?*VARIANT) HRESULT {
        return self.vtable.get_publicId(self, publicID);
    }
    pub inline fn get_systemId(self: *const IXMLDOMNotation, systemID: ?*VARIANT) HRESULT {
...
pub const IXMLDOMEntity = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_publicId(self: *const IXMLDOMEntity, publicID: ?*VARIANT) HRESULT {
        return self.vtable.get_publicId(self, publicID);
    }
    pub inline fn get_systemId(self: *const IXMLDOMEntity, systemID: ?*VARIANT) HRESULT {
        return self.vtable.get_systemId(self, systemID);
    }
    pub inline fn get_notationName(self: *const IXMLDOMEntity, name: ?*?BSTR) HRESULT {
...
pub const IXMLDOMParseError = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_errorCode(self: *const IXMLDOMParseError, errorCode: ?*i32) HRESULT {
        return self.vtable.get_errorCode(self, errorCode);
    }
    pub inline fn get_url(self: *const IXMLDOMParseError, urlString: ?*?BSTR) HRESULT {
        return self.vtable.get_url(self, urlString);
    }
    pub inline fn get_reason(self: *const IXMLDOMParseError, reasonString: ?*?BSTR) HRESULT {
        return self.vtable.get_reason(self, reasonString);
    }
    pub inline fn get_srcText(self: *const IXMLDOMParseError, sourceString: ?*?BSTR) HRESULT {
        return self.vtable.get_srcText(self, sourceString);
    }
    pub inline fn get_line(self: *const IXMLDOMParseError, lineNumber: ?*i32) HRESULT {
        return self.vtable.get_line(self, lineNumber);
    }
    pub inline fn get_linepos(self: *const IXMLDOMParseError, linePosition: ?*i32) HRESULT {
        return self.vtable.get_linepos(self, linePosition);
    }
    pub inline fn get_filepos(self: *const IXMLDOMParseError, filePosition: ?*i32) HRESULT {
...
pub const IXTLRuntime = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn uniqueID(self: *const IXTLRuntime, pNode: ?*IXMLDOMNode, pID: ?*i32) HRESULT {
        return self.vtable.uniqueID(self, pNode, pID);
    }
    pub inline fn depth(self: *const IXTLRuntime, pNode: ?*IXMLDOMNode, pDepth: ?*i32) HRESULT {
        return self.vtable.depth(self, pNode, pDepth);
    }
    pub inline fn childNumber(self: *const IXTLRuntime, pNode: ?*IXMLDOMNode, pNumber: ?*i32) HRESULT {
        return self.vtable.childNumber(self, pNode, pNumber);
    }
    pub inline fn ancestorChildNumber(self: *const IXTLRuntime, bstrNodeName: ?BSTR, pNode: ?*IXMLDOMNode, pNumber: ?*i32) HRESULT {
        return self.vtable.ancestorChildNumber(self, bstrNodeName, pNode, pNumber);
    }
    pub inline fn absoluteChildNumber(self: *const IXTLRuntime, pNode: ?*IXMLDOMNode, pNumber: ?*i32) HRESULT {
        return self.vtable.absoluteChildNumber(self, pNode, pNumber);
    }
    pub inline fn formatIndex(self: *const IXTLRuntime, lIndex: i32, bstrFormat: ?BSTR, pbstrFormattedString: ?*?BSTR) HRESULT {
        return self.vtable.formatIndex(self, lIndex, bstrFormat, pbstrFormattedString);
    }
    pub inline fn formatNumber(self: *const IXTLRuntime, dblNumber: f64, bstrFormat: ?BSTR, pbstrFormattedString: ?*?BSTR) HRESULT {
        return self.vtable.formatNumber(self, dblNumber, bstrFormat, pbstrFormattedString);
    }
    pub inline fn formatDate(self: *const IXTLRuntime, varDate: VARIANT, bstrFormat: ?BSTR, varDestLocale: VARIANT, pbstrFormattedString: ?*?BSTR) HRESULT {
        return self.vtable.formatDate(self, varDate, bstrFormat, varDestLocale, pbstrFormattedString);
    }
    pub inline fn formatTime(self: *const IXTLRuntime, varTime: VARIANT, bstrFormat: ?BSTR, varDestLocale: VARIANT, pbstrFormattedString: ?*?BSTR) HRESULT {
...
pub const IXMLHttpRequest = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn open(self: *const IXMLHttpRequest, bstrMethod: ?BSTR, bstrUrl: ?BSTR, varAsync: VARIANT, bstrUser: VARIANT, bstrPassword: VARIANT) HRESULT {
        return self.vtable.open(self, bstrMethod, bstrUrl, varAsync, bstrUser, bstrPassword);
    }
    pub inline fn setRequestHeader(self: *const IXMLHttpRequest, bstrHeader: ?BSTR, bstrValue: ?BSTR) HRESULT {
        return self.vtable.setRequestHeader(self, bstrHeader, bstrValue);
    }
    pub inline fn getResponseHeader(self: *const IXMLHttpRequest, bstrHeader: ?BSTR, pbstrValue: ?*?BSTR) HRESULT {
        return self.vtable.getResponseHeader(self, bstrHeader, pbstrValue);
    }
    pub inline fn getAllResponseHeaders(self: *const IXMLHttpRequest, pbstrHeaders: ?*?BSTR) HRESULT {
        return self.vtable.getAllResponseHeaders(self, pbstrHeaders);
    }
    pub inline fn send(self: *const IXMLHttpRequest, varBody: VARIANT) HRESULT {
        return self.vtable.send(self, varBody);
    }
    pub inline fn abort(self: *const IXMLHttpRequest) HRESULT {
        return self.vtable.abort(self);
    }
    pub inline fn get_status(self: *const IXMLHttpRequest, plStatus: ?*i32) HRESULT {
        return self.vtable.get_status(self, plStatus);
    }
    pub inline fn get_statusText(self: *const IXMLHttpRequest, pbstrStatus: ?*?BSTR) HRESULT {
        return self.vtable.get_statusText(self, pbstrStatus);
    }
    pub inline fn get_responseXML(self: *const IXMLHttpRequest, ppBody: ?*?*IDispatch) HRESULT {
        return self.vtable.get_responseXML(self, ppBody);
    }
    pub inline fn get_responseText(self: *const IXMLHttpRequest, pbstrBody: ?*?BSTR) HRESULT {
        return self.vtable.get_responseText(self, pbstrBody);
    }
    pub inline fn get_responseBody(self: *const IXMLHttpRequest, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_responseBody(self, pvarBody);
    }
    pub inline fn get_responseStream(self: *const IXMLHttpRequest, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_responseStream(self, pvarBody);
    }
    pub inline fn get_readyState(self: *const IXMLHttpRequest, plState: ?*i32) HRESULT {
        return self.vtable.get_readyState(self, plState);
    }
    pub inline fn put_onreadystatechange(self: *const IXMLHttpRequest, pReadyStateSink: ?*IDispatch) HRESULT {
...
pub const IXMLDSOControl = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_XMLDocument(self: *const IXMLDSOControl, ppDoc: ?*?*IXMLDOMDocument) HRESULT {
        return self.vtable.get_XMLDocument(self, ppDoc);
    }
    pub inline fn put_XMLDocument(self: *const IXMLDSOControl, ppDoc: ?*IXMLDOMDocument) HRESULT {
        return self.vtable.put_XMLDocument(self, ppDoc);
    }
    pub inline fn get_JavaDSOCompatible(self: *const IXMLDSOControl, fJavaDSOCompatible: ?*BOOL) HRESULT {
        return self.vtable.get_JavaDSOCompatible(self, fJavaDSOCompatible);
    }
    pub inline fn put_JavaDSOCompatible(self: *const IXMLDSOControl, fJavaDSOCompatible: BOOL) HRESULT {
        return self.vtable.put_JavaDSOCompatible(self, fJavaDSOCompatible);
    }
    pub inline fn get_readyState(self: *const IXMLDSOControl, state: ?*i32) HRESULT {
...
pub const IXMLElementCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_length(self: *const IXMLElementCollection, v: i32) HRESULT {
        return self.vtable.put_length(self, v);
    }
    pub inline fn get_length(self: *const IXMLElementCollection, p: ?*i32) HRESULT {
        return self.vtable.get_length(self, p);
    }
    pub inline fn get__newEnum(self: *const IXMLElementCollection, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppUnk);
    }
    pub inline fn item(self: *const IXMLElementCollection, var1: VARIANT, var2: VARIANT, ppDisp: ?*?*IDispatch) HRESULT {
...
pub const IXMLDocument = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_root(self: *const IXMLDocument, p: ?*?*IXMLElement) HRESULT {
        return self.vtable.get_root(self, p);
    }
    pub inline fn get_fileSize(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileSize(self, p);
    }
    pub inline fn get_fileModifiedDate(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileModifiedDate(self, p);
    }
    pub inline fn get_fileUpdatedDate(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileUpdatedDate(self, p);
    }
    pub inline fn get_URL(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_URL(self, p);
    }
    pub inline fn put_URL(self: *const IXMLDocument, p: ?BSTR) HRESULT {
        return self.vtable.put_URL(self, p);
    }
    pub inline fn get_mimeType(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_mimeType(self, p);
    }
    pub inline fn get_readyState(self: *const IXMLDocument, pl: ?*i32) HRESULT {
        return self.vtable.get_readyState(self, pl);
    }
    pub inline fn get_charset(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_charset(self, p);
    }
    pub inline fn put_charset(self: *const IXMLDocument, p: ?BSTR) HRESULT {
        return self.vtable.put_charset(self, p);
    }
    pub inline fn get_version(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_version(self, p);
    }
    pub inline fn get_doctype(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_doctype(self, p);
    }
    pub inline fn get_dtdURL(self: *const IXMLDocument, p: ?*?BSTR) HRESULT {
        return self.vtable.get_dtdURL(self, p);
    }
    pub inline fn createElement(self: *const IXMLDocument, vType: VARIANT, var1: VARIANT, ppElem: ?*?*IXMLElement) HRESULT {
...
pub const IXMLDocument2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_root(self: *const IXMLDocument2, p: ?*?*IXMLElement2) HRESULT {
        return self.vtable.get_root(self, p);
    }
    pub inline fn get_fileSize(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileSize(self, p);
    }
    pub inline fn get_fileModifiedDate(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileModifiedDate(self, p);
    }
    pub inline fn get_fileUpdatedDate(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_fileUpdatedDate(self, p);
    }
    pub inline fn get_URL(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_URL(self, p);
    }
    pub inline fn put_URL(self: *const IXMLDocument2, p: ?BSTR) HRESULT {
        return self.vtable.put_URL(self, p);
    }
    pub inline fn get_mimeType(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_mimeType(self, p);
    }
    pub inline fn get_readyState(self: *const IXMLDocument2, pl: ?*i32) HRESULT {
        return self.vtable.get_readyState(self, pl);
    }
    pub inline fn get_charset(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_charset(self, p);
    }
    pub inline fn put_charset(self: *const IXMLDocument2, p: ?BSTR) HRESULT {
        return self.vtable.put_charset(self, p);
    }
    pub inline fn get_version(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_version(self, p);
    }
    pub inline fn get_doctype(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_doctype(self, p);
    }
    pub inline fn get_dtdURL(self: *const IXMLDocument2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_dtdURL(self, p);
    }
    pub inline fn createElement(self: *const IXMLDocument2, vType: VARIANT, var1: VARIANT, ppElem: ?*?*IXMLElement2) HRESULT {
        return self.vtable.createElement(self, vType, var1, ppElem);
    }
    pub inline fn get_async(self: *const IXMLDocument2, pf: ?*i16) HRESULT {
        return self.vtable.get_async(self, pf);
    }
    pub inline fn put_async(self: *const IXMLDocument2, f: i16) HRESULT {
...
pub const IXMLElement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_tagName(self: *const IXMLElement, p: ?*?BSTR) HRESULT {
        return self.vtable.get_tagName(self, p);
    }
    pub inline fn put_tagName(self: *const IXMLElement, p: ?BSTR) HRESULT {
        return self.vtable.put_tagName(self, p);
    }
    pub inline fn get_parent(self: *const IXMLElement, ppParent: ?*?*IXMLElement) HRESULT {
        return self.vtable.get_parent(self, ppParent);
    }
    pub inline fn setAttribute(self: *const IXMLElement, strPropertyName: ?BSTR, PropertyValue: VARIANT) HRESULT {
        return self.vtable.setAttribute(self, strPropertyName, PropertyValue);
    }
    pub inline fn getAttribute(self: *const IXMLElement, strPropertyName: ?BSTR, PropertyValue: ?*VARIANT) HRESULT {
        return self.vtable.getAttribute(self, strPropertyName, PropertyValue);
    }
    pub inline fn removeAttribute(self: *const IXMLElement, strPropertyName: ?BSTR) HRESULT {
        return self.vtable.removeAttribute(self, strPropertyName);
    }
    pub inline fn get_children(self: *const IXMLElement, pp: ?*?*IXMLElementCollection) HRESULT {
        return self.vtable.get_children(self, pp);
    }
    pub inline fn get_type(self: *const IXMLElement, plType: ?*i32) HRESULT {
        return self.vtable.get_type(self, plType);
    }
    pub inline fn get_text(self: *const IXMLElement, p: ?*?BSTR) HRESULT {
        return self.vtable.get_text(self, p);
    }
    pub inline fn put_text(self: *const IXMLElement, p: ?BSTR) HRESULT {
        return self.vtable.put_text(self, p);
    }
    pub inline fn addChild(self: *const IXMLElement, pChildElem: ?*IXMLElement, lIndex: i32, lReserved: i32) HRESULT {
        return self.vtable.addChild(self, pChildElem, lIndex, lReserved);
    }
    pub inline fn removeChild(self: *const IXMLElement, pChildElem: ?*IXMLElement) HRESULT {
...
pub const IXMLElement2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_tagName(self: *const IXMLElement2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_tagName(self, p);
    }
    pub inline fn put_tagName(self: *const IXMLElement2, p: ?BSTR) HRESULT {
        return self.vtable.put_tagName(self, p);
    }
    pub inline fn get_parent(self: *const IXMLElement2, ppParent: ?*?*IXMLElement2) HRESULT {
        return self.vtable.get_parent(self, ppParent);
    }
    pub inline fn setAttribute(self: *const IXMLElement2, strPropertyName: ?BSTR, PropertyValue: VARIANT) HRESULT {
        return self.vtable.setAttribute(self, strPropertyName, PropertyValue);
    }
    pub inline fn getAttribute(self: *const IXMLElement2, strPropertyName: ?BSTR, PropertyValue: ?*VARIANT) HRESULT {
        return self.vtable.getAttribute(self, strPropertyName, PropertyValue);
    }
    pub inline fn removeAttribute(self: *const IXMLElement2, strPropertyName: ?BSTR) HRESULT {
        return self.vtable.removeAttribute(self, strPropertyName);
    }
    pub inline fn get_children(self: *const IXMLElement2, pp: ?*?*IXMLElementCollection) HRESULT {
        return self.vtable.get_children(self, pp);
    }
    pub inline fn get_type(self: *const IXMLElement2, plType: ?*i32) HRESULT {
        return self.vtable.get_type(self, plType);
    }
    pub inline fn get_text(self: *const IXMLElement2, p: ?*?BSTR) HRESULT {
        return self.vtable.get_text(self, p);
    }
    pub inline fn put_text(self: *const IXMLElement2, p: ?BSTR) HRESULT {
        return self.vtable.put_text(self, p);
    }
    pub inline fn addChild(self: *const IXMLElement2, pChildElem: ?*IXMLElement2, lIndex: i32, lReserved: i32) HRESULT {
        return self.vtable.addChild(self, pChildElem, lIndex, lReserved);
    }
    pub inline fn removeChild(self: *const IXMLElement2, pChildElem: ?*IXMLElement2) HRESULT {
        return self.vtable.removeChild(self, pChildElem);
    }
    pub inline fn get_attributes(self: *const IXMLElement2, pp: ?*?*IXMLElementCollection) HRESULT {
...
pub const IXMLAttribute = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_name(self: *const IXMLAttribute, n: ?*?BSTR) HRESULT {
        return self.vtable.get_name(self, n);
    }
    pub inline fn get_value(self: *const IXMLAttribute, v: ?*?BSTR) HRESULT {
...
pub const IXMLError = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetErrorInfo(self: *const IXMLError, pErrorReturn: ?*XML_ERROR) HRESULT {
...
pub const IXMLDOMDocument2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_namespaces(self: *const IXMLDOMDocument2, namespaceCollection: ?*?*IXMLDOMSchemaCollection) HRESULT {
        return self.vtable.get_namespaces(self, namespaceCollection);
    }
    pub inline fn get_schemas(self: *const IXMLDOMDocument2, otherCollection: ?*VARIANT) HRESULT {
        return self.vtable.get_schemas(self, otherCollection);
    }
    pub inline fn putref_schemas(self: *const IXMLDOMDocument2, otherCollection: VARIANT) HRESULT {
        return self.vtable.putref_schemas(self, otherCollection);
    }
    pub inline fn validate(self: *const IXMLDOMDocument2, errorObj: ?*?*IXMLDOMParseError) HRESULT {
        return self.vtable.validate(self, errorObj);
    }
    pub inline fn setProperty(self: *const IXMLDOMDocument2, name: ?BSTR, value: VARIANT) HRESULT {
        return self.vtable.setProperty(self, name, value);
    }
    pub inline fn getProperty(self: *const IXMLDOMDocument2, name: ?BSTR, value: ?*VARIANT) HRESULT {
...
pub const IXMLDOMDocument3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn validateNode(self: *const IXMLDOMDocument3, node: ?*IXMLDOMNode, errorObj: ?*?*IXMLDOMParseError) HRESULT {
        return self.vtable.validateNode(self, node, errorObj);
    }
    pub inline fn importNode(self: *const IXMLDOMDocument3, node: ?*IXMLDOMNode, deep: i16, clone: ?*?*IXMLDOMNode) HRESULT {
...
pub const IXMLDOMSchemaCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn add(self: *const IXMLDOMSchemaCollection, namespaceURI: ?BSTR, @"var": VARIANT) HRESULT {
        return self.vtable.add(self, namespaceURI, @"var");
    }
    pub inline fn get(self: *const IXMLDOMSchemaCollection, namespaceURI: ?BSTR, schemaNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get(self, namespaceURI, schemaNode);
    }
    pub inline fn remove(self: *const IXMLDOMSchemaCollection, namespaceURI: ?BSTR) HRESULT {
        return self.vtable.remove(self, namespaceURI);
    }
    pub inline fn get_length(self: *const IXMLDOMSchemaCollection, length: ?*i32) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get_namespaceURI(self: *const IXMLDOMSchemaCollection, index: i32, length: ?*?BSTR) HRESULT {
        return self.vtable.get_namespaceURI(self, index, length);
    }
    pub inline fn addCollection(self: *const IXMLDOMSchemaCollection, otherCollection: ?*IXMLDOMSchemaCollection) HRESULT {
        return self.vtable.addCollection(self, otherCollection);
    }
    pub inline fn get__newEnum(self: *const IXMLDOMSchemaCollection, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppUnk);
    }
};
...
pub const IXMLDOMSelection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_expr(self: *const IXMLDOMSelection, expression: ?*?BSTR) HRESULT {
        return self.vtable.get_expr(self, expression);
    }
    pub inline fn put_expr(self: *const IXMLDOMSelection, expression: ?BSTR) HRESULT {
        return self.vtable.put_expr(self, expression);
    }
    pub inline fn get_context(self: *const IXMLDOMSelection, ppNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_context(self, ppNode);
    }
    pub inline fn putref_context(self: *const IXMLDOMSelection, pNode: ?*IXMLDOMNode) HRESULT {
        return self.vtable.putref_context(self, pNode);
    }
    pub inline fn peekNode(self: *const IXMLDOMSelection, ppNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.peekNode(self, ppNode);
    }
    pub inline fn matches(self: *const IXMLDOMSelection, pNode: ?*IXMLDOMNode, ppNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.matches(self, pNode, ppNode);
    }
    pub inline fn removeNext(self: *const IXMLDOMSelection, ppNode: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.removeNext(self, ppNode);
    }
    pub inline fn removeAll(self: *const IXMLDOMSelection) HRESULT {
        return self.vtable.removeAll(self);
    }
    pub inline fn clone(self: *const IXMLDOMSelection, ppNode: ?*?*IXMLDOMSelection) HRESULT {
        return self.vtable.clone(self, ppNode);
    }
    pub inline fn getProperty(self: *const IXMLDOMSelection, name: ?BSTR, value: ?*VARIANT) HRESULT {
        return self.vtable.getProperty(self, name, value);
    }
    pub inline fn setProperty(self: *const IXMLDOMSelection, name: ?BSTR, value: VARIANT) HRESULT {
        return self.vtable.setProperty(self, name, value);
    }
};
...
pub const IXMLDOMParseError2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_errorXPath(self: *const IXMLDOMParseError2, xpathexpr: ?*?BSTR) HRESULT {
        return self.vtable.get_errorXPath(self, xpathexpr);
    }
    pub inline fn get_allErrors(self: *const IXMLDOMParseError2, allErrors: ?*?*IXMLDOMParseErrorCollection) HRESULT {
        return self.vtable.get_allErrors(self, allErrors);
    }
    pub inline fn errorParameters(self: *const IXMLDOMParseError2, index: i32, param1: ?*?BSTR) HRESULT {
        return self.vtable.errorParameters(self, index, param1);
    }
    pub inline fn get_errorParametersCount(self: *const IXMLDOMParseError2, count: ?*i32) HRESULT {
...
pub const IXMLDOMParseErrorCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_item(self: *const IXMLDOMParseErrorCollection, index: i32, @"error": ?*?*IXMLDOMParseError2) HRESULT {
        return self.vtable.get_item(self, index, @"error");
    }
    pub inline fn get_length(self: *const IXMLDOMParseErrorCollection, length: ?*i32) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get_next(self: *const IXMLDOMParseErrorCollection, @"error": ?*?*IXMLDOMParseError2) HRESULT {
        return self.vtable.get_next(self, @"error");
    }
    pub inline fn reset(self: *const IXMLDOMParseErrorCollection) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn get__newEnum(self: *const IXMLDOMParseErrorCollection, ppunk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppunk);
    }
};
...
pub const IXSLProcessor = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_input(self: *const IXSLProcessor, @"var": VARIANT) HRESULT {
        return self.vtable.put_input(self, @"var");
    }
    pub inline fn get_input(self: *const IXSLProcessor, pVar: ?*VARIANT) HRESULT {
        return self.vtable.get_input(self, pVar);
    }
    pub inline fn get_ownerTemplate(self: *const IXSLProcessor, ppTemplate: ?*?*IXSLTemplate) HRESULT {
        return self.vtable.get_ownerTemplate(self, ppTemplate);
    }
    pub inline fn setStartMode(self: *const IXSLProcessor, mode: ?BSTR, namespaceURI: ?BSTR) HRESULT {
        return self.vtable.setStartMode(self, mode, namespaceURI);
    }
    pub inline fn get_startMode(self: *const IXSLProcessor, mode: ?*?BSTR) HRESULT {
        return self.vtable.get_startMode(self, mode);
    }
    pub inline fn get_startModeURI(self: *const IXSLProcessor, namespaceURI: ?*?BSTR) HRESULT {
        return self.vtable.get_startModeURI(self, namespaceURI);
    }
    pub inline fn put_output(self: *const IXSLProcessor, output: VARIANT) HRESULT {
        return self.vtable.put_output(self, output);
    }
    pub inline fn get_output(self: *const IXSLProcessor, pOutput: ?*VARIANT) HRESULT {
        return self.vtable.get_output(self, pOutput);
    }
    pub inline fn transform(self: *const IXSLProcessor, pDone: ?*i16) HRESULT {
        return self.vtable.transform(self, pDone);
    }
    pub inline fn reset(self: *const IXSLProcessor) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn get_readyState(self: *const IXSLProcessor, pReadyState: ?*i32) HRESULT {
        return self.vtable.get_readyState(self, pReadyState);
    }
    pub inline fn addParameter(self: *const IXSLProcessor, baseName: ?BSTR, parameter: VARIANT, namespaceURI: ?BSTR) HRESULT {
        return self.vtable.addParameter(self, baseName, parameter, namespaceURI);
    }
    pub inline fn addObject(self: *const IXSLProcessor, obj: ?*IDispatch, namespaceURI: ?BSTR) HRESULT {
        return self.vtable.addObject(self, obj, namespaceURI);
    }
    pub inline fn get_stylesheet(self: *const IXSLProcessor, stylesheet: ?*?*IXMLDOMNode) HRESULT {
...
pub const IXSLTemplate = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn putref_stylesheet(self: *const IXSLTemplate, stylesheet: ?*IXMLDOMNode) HRESULT {
        return self.vtable.putref_stylesheet(self, stylesheet);
    }
    pub inline fn get_stylesheet(self: *const IXSLTemplate, stylesheet: ?*?*IXMLDOMNode) HRESULT {
        return self.vtable.get_stylesheet(self, stylesheet);
    }
    pub inline fn createProcessor(self: *const IXSLTemplate, ppProcessor: ?*?*IXSLProcessor) HRESULT {
...
pub const IServerXMLHTTPRequest = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn setTimeouts(self: *const IServerXMLHTTPRequest, resolveTimeout: i32, connectTimeout: i32, sendTimeout: i32, receiveTimeout: i32) HRESULT {
        return self.vtable.setTimeouts(self, resolveTimeout, connectTimeout, sendTimeout, receiveTimeout);
    }
    pub inline fn waitForResponse(self: *const IServerXMLHTTPRequest, timeoutInSeconds: VARIANT, isSuccessful: ?*i16) HRESULT {
        return self.vtable.waitForResponse(self, timeoutInSeconds, isSuccessful);
    }
    pub inline fn getOption(self: *const IServerXMLHTTPRequest, option: SERVERXMLHTTP_OPTION, value: ?*VARIANT) HRESULT {
        return self.vtable.getOption(self, option, value);
    }
    pub inline fn setOption(self: *const IServerXMLHTTPRequest, option: SERVERXMLHTTP_OPTION, value: VARIANT) HRESULT {
...
pub const IServerXMLHTTPRequest2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn setProxy(self: *const IServerXMLHTTPRequest2, proxySetting: SXH_PROXY_SETTING, varProxyServer: VARIANT, varBypassList: VARIANT) HRESULT {
        return self.vtable.setProxy(self, proxySetting, varProxyServer, varBypassList);
    }
    pub inline fn setProxyCredentials(self: *const IServerXMLHTTPRequest2, bstrUserName: ?BSTR, bstrPassword: ?BSTR) HRESULT {
...
pub const ISAXXMLReader = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn getFeature(self: *const ISAXXMLReader, pwchName: ?[*:0]const u16, pvfValue: ?*i16) HRESULT {
        return self.vtable.getFeature(self, pwchName, pvfValue);
    }
    pub inline fn putFeature(self: *const ISAXXMLReader, pwchName: ?[*:0]const u16, vfValue: i16) HRESULT {
        return self.vtable.putFeature(self, pwchName, vfValue);
    }
    pub inline fn getProperty(self: *const ISAXXMLReader, pwchName: ?[*:0]const u16, pvarValue: ?*VARIANT) HRESULT {
        return self.vtable.getProperty(self, pwchName, pvarValue);
    }
    pub inline fn putProperty(self: *const ISAXXMLReader, pwchName: ?[*:0]const u16, varValue: VARIANT) HRESULT {
        return self.vtable.putProperty(self, pwchName, varValue);
    }
    pub inline fn getEntityResolver(self: *const ISAXXMLReader, ppResolver: ?*?*ISAXEntityResolver) HRESULT {
        return self.vtable.getEntityResolver(self, ppResolver);
    }
    pub inline fn putEntityResolver(self: *const ISAXXMLReader, pResolver: ?*ISAXEntityResolver) HRESULT {
        return self.vtable.putEntityResolver(self, pResolver);
    }
    pub inline fn getContentHandler(self: *const ISAXXMLReader, ppHandler: ?*?*ISAXContentHandler) HRESULT {
        return self.vtable.getContentHandler(self, ppHandler);
    }
    pub inline fn putContentHandler(self: *const ISAXXMLReader, pHandler: ?*ISAXContentHandler) HRESULT {
        return self.vtable.putContentHandler(self, pHandler);
    }
    pub inline fn getDTDHandler(self: *const ISAXXMLReader, ppHandler: ?*?*ISAXDTDHandler) HRESULT {
        return self.vtable.getDTDHandler(self, ppHandler);
    }
    pub inline fn putDTDHandler(self: *const ISAXXMLReader, pHandler: ?*ISAXDTDHandler) HRESULT {
        return self.vtable.putDTDHandler(self, pHandler);
    }
    pub inline fn getErrorHandler(self: *const ISAXXMLReader, ppHandler: ?*?*ISAXErrorHandler) HRESULT {
        return self.vtable.getErrorHandler(self, ppHandler);
    }
    pub inline fn putErrorHandler(self: *const ISAXXMLReader, pHandler: ?*ISAXErrorHandler) HRESULT {
        return self.vtable.putErrorHandler(self, pHandler);
    }
    pub inline fn getBaseURL(self: *const ISAXXMLReader, ppwchBaseUrl: ?*const ?*u16) HRESULT {
        return self.vtable.getBaseURL(self, ppwchBaseUrl);
    }
    pub inline fn putBaseURL(self: *const ISAXXMLReader, pwchBaseUrl: ?[*:0]const u16) HRESULT {
        return self.vtable.putBaseURL(self, pwchBaseUrl);
    }
    pub inline fn getSecureBaseURL(self: *const ISAXXMLReader, ppwchSecureBaseUrl: ?*const ?*u16) HRESULT {
        return self.vtable.getSecureBaseURL(self, ppwchSecureBaseUrl);
    }
    pub inline fn putSecureBaseURL(self: *const ISAXXMLReader, pwchSecureBaseUrl: ?[*:0]const u16) HRESULT {
        return self.vtable.putSecureBaseURL(self, pwchSecureBaseUrl);
    }
    pub inline fn parse(self: *const ISAXXMLReader, varInput: VARIANT) HRESULT {
        return self.vtable.parse(self, varInput);
    }
    pub inline fn parseURL(self: *const ISAXXMLReader, pwchUrl: ?[*:0]const u16) HRESULT {
...
pub const ISAXXMLFilter = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn getParent(self: *const ISAXXMLFilter, ppReader: ?*?*ISAXXMLReader) HRESULT {
        return self.vtable.getParent(self, ppReader);
    }
    pub inline fn putParent(self: *const ISAXXMLFilter, pReader: ?*ISAXXMLReader) HRESULT {
...
pub const ISAXLocator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn getColumnNumber(self: *const ISAXLocator, pnColumn: ?*i32) HRESULT {
        return self.vtable.getColumnNumber(self, pnColumn);
    }
    pub inline fn getLineNumber(self: *const ISAXLocator, pnLine: ?*i32) HRESULT {
        return self.vtable.getLineNumber(self, pnLine);
    }
    pub inline fn getPublicId(self: *const ISAXLocator, ppwchPublicId: ?*const ?*u16) HRESULT {
        return self.vtable.getPublicId(self, ppwchPublicId);
    }
    pub inline fn getSystemId(self: *const ISAXLocator, ppwchSystemId: ?*const ?*u16) HRESULT {
...
pub const ISAXEntityResolver = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn resolveEntity(self: *const ISAXEntityResolver, pwchPublicId: ?[*:0]const u16, pwchSystemId: ?[*:0]const u16, pvarInput: ?*VARIANT) HRESULT {
...
pub const ISAXContentHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn putDocumentLocator(self: *const ISAXContentHandler, pLocator: ?*ISAXLocator) HRESULT {
        return self.vtable.putDocumentLocator(self, pLocator);
    }
    pub inline fn startDocument(self: *const ISAXContentHandler) HRESULT {
        return self.vtable.startDocument(self);
    }
    pub inline fn endDocument(self: *const ISAXContentHandler) HRESULT {
        return self.vtable.endDocument(self);
    }
    pub inline fn startPrefixMapping(self: *const ISAXContentHandler, pwchPrefix: ?[*:0]const u16, cchPrefix: i32, pwchUri: ?[*:0]const u16, cchUri: i32) HRESULT {
        return self.vtable.startPrefixMapping(self, pwchPrefix, cchPrefix, pwchUri, cchUri);
    }
    pub inline fn endPrefixMapping(self: *const ISAXContentHandler, pwchPrefix: ?[*:0]const u16, cchPrefix: i32) HRESULT {
        return self.vtable.endPrefixMapping(self, pwchPrefix, cchPrefix);
    }
    pub inline fn startElement(self: *const ISAXContentHandler, pwchNamespaceUri: ?[*:0]const u16, cchNamespaceUri: i32, pwchLocalName: ?[*:0]const u16, cchLocalName: i32, pwchQName: ?[*:0]const u16, cchQName: i32, pAttributes: ?*ISAXAttributes) HRESULT {
    ...
    pub inline fn endElement(self: *const ISAXContentHandler, pwchNamespaceUri: ?[*:0]const u16, cchNamespaceUri: i32, pwchLocalName: ?[*:0]const u16, cchLocalName: i32, pwchQName: ?[*:0]const u16, cchQName: i32) HRESULT {
        return self.vtable.endElement(self, pwchNamespaceUri, cchNamespaceUri, pwchLocalName, cchLocalName, pwchQName, cchQName);
    }
    pub inline fn characters(self: *const ISAXContentHandler, pwchChars: ?[*:0]const u16, cchChars: i32) HRESULT {
        return self.vtable.characters(self, pwchChars, cchChars);
    }
    pub inline fn ignorableWhitespace(self: *const ISAXContentHandler, pwchChars: ?[*:0]const u16, cchChars: i32) HRESULT {
        return self.vtable.ignorableWhitespace(self, pwchChars, cchChars);
    }
    pub inline fn processingInstruction(self: *const ISAXContentHandler, pwchTarget: ?[*:0]const u16, cchTarget: i32, pwchData: ?[*:0]const u16, cchData: i32) HRESULT {
        return self.vtable.processingInstruction(self, pwchTarget, cchTarget, pwchData, cchData);
    }
    pub inline fn skippedEntity(self: *const ISAXContentHandler, pwchName: ?[*:0]const u16, cchName: i32) HRESULT {
...
pub const ISAXDTDHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn notationDecl(self: *const ISAXDTDHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchPublicId: ?[*:0]const u16, cchPublicId: i32, pwchSystemId: ?[*:0]const u16, cchSystemId: i32) HRESULT {
        return self.vtable.notationDecl(self, pwchName, cchName, pwchPublicId, cchPublicId, pwchSystemId, cchSystemId);
    }
    pub inline fn unparsedEntityDecl(self: *const ISAXDTDHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchPublicId: ?[*:0]const u16, cchPublicId: i32, pwchSystemId: ?[*:0]const u16, cchSystemId: i32, pwchNotationName: ?[*:0]const u16, cchNotationName: i32) HRESULT {
...
pub const ISAXErrorHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn @"error"(self: *const ISAXErrorHandler, pLocator: ?*ISAXLocator, pwchErrorMessage: ?[*:0]const u16, hrErrorCode: HRESULT) HRESULT {
        return self.vtable.@"error"(self, pLocator, pwchErrorMessage, hrErrorCode);
    }
    pub inline fn fatalError(self: *const ISAXErrorHandler, pLocator: ?*ISAXLocator, pwchErrorMessage: ?[*:0]const u16, hrErrorCode: HRESULT) HRESULT {
        return self.vtable.fatalError(self, pLocator, pwchErrorMessage, hrErrorCode);
    }
    pub inline fn ignorableWarning(self: *const ISAXErrorHandler, pLocator: ?*ISAXLocator, pwchErrorMessage: ?[*:0]const u16, hrErrorCode: HRESULT) HRESULT {
...
pub const ISAXLexicalHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn startDTD(self: *const ISAXLexicalHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchPublicId: ?[*:0]const u16, cchPublicId: i32, pwchSystemId: ?[*:0]const u16, cchSystemId: i32) HRESULT {
        return self.vtable.startDTD(self, pwchName, cchName, pwchPublicId, cchPublicId, pwchSystemId, cchSystemId);
    }
    pub inline fn endDTD(self: *const ISAXLexicalHandler) HRESULT {
        return self.vtable.endDTD(self);
    }
    pub inline fn startEntity(self: *const ISAXLexicalHandler, pwchName: ?[*:0]const u16, cchName: i32) HRESULT {
        return self.vtable.startEntity(self, pwchName, cchName);
    }
    pub inline fn endEntity(self: *const ISAXLexicalHandler, pwchName: ?[*:0]const u16, cchName: i32) HRESULT {
        return self.vtable.endEntity(self, pwchName, cchName);
    }
    pub inline fn startCDATA(self: *const ISAXLexicalHandler) HRESULT {
        return self.vtable.startCDATA(self);
    }
    pub inline fn endCDATA(self: *const ISAXLexicalHandler) HRESULT {
        return self.vtable.endCDATA(self);
    }
    pub inline fn comment(self: *const ISAXLexicalHandler, pwchChars: ?[*:0]const u16, cchChars: i32) HRESULT {
...
pub const ISAXDeclHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn elementDecl(self: *const ISAXDeclHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchModel: ?[*:0]const u16, cchModel: i32) HRESULT {
        return self.vtable.elementDecl(self, pwchName, cchName, pwchModel, cchModel);
    }
    pub inline fn attributeDecl(self: *const ISAXDeclHandler, pwchElementName: ?[*:0]const u16, cchElementName: i32, pwchAttributeName: ?[*:0]const u16, cchAttributeName: i32, pwchType: ?[*:0]const u16, cchType: i32, pwchValueDefault: ?[*:0]const u16, cchValueDefault: i32, pwchValue: ?[*:0]const u16, cchValue: i32) HRESULT {
    ...
    pub inline fn internalEntityDecl(self: *const ISAXDeclHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchValue: ?[*:0]const u16, cchValue: i32) HRESULT {
        return self.vtable.internalEntityDecl(self, pwchName, cchName, pwchValue, cchValue);
    }
    pub inline fn externalEntityDecl(self: *const ISAXDeclHandler, pwchName: ?[*:0]const u16, cchName: i32, pwchPublicId: ?[*:0]const u16, cchPublicId: i32, pwchSystemId: ?[*:0]const u16, cchSystemId: i32) HRESULT {
...
pub const ISAXAttributes = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn getLength(self: *const ISAXAttributes, pnLength: ?*i32) HRESULT {
        return self.vtable.getLength(self, pnLength);
    }
    pub inline fn getURI(self: *const ISAXAttributes, nIndex: i32, ppwchUri: ?*const ?*u16, pcchUri: ?*i32) HRESULT {
        return self.vtable.getURI(self, nIndex, ppwchUri, pcchUri);
    }
    pub inline fn getLocalName(self: *const ISAXAttributes, nIndex: i32, ppwchLocalName: ?*const ?*u16, pcchLocalName: ?*i32) HRESULT {
        return self.vtable.getLocalName(self, nIndex, ppwchLocalName, pcchLocalName);
    }
    pub inline fn getQName(self: *const ISAXAttributes, nIndex: i32, ppwchQName: ?*const ?*u16, pcchQName: ?*i32) HRESULT {
        return self.vtable.getQName(self, nIndex, ppwchQName, pcchQName);
    }
    pub inline fn getName(self: *const ISAXAttributes, nIndex: i32, ppwchUri: ?*const ?*u16, pcchUri: ?*i32, ppwchLocalName: ?*const ?*u16, pcchLocalName: ?*i32, ppwchQName: ?*const ?*u16, pcchQName: ?*i32) HRESULT {
        return self.vtable.getName(self, nIndex, ppwchUri, pcchUri, ppwchLocalName, pcchLocalName, ppwchQName, pcchQName);
    }
    pub inline fn getIndexFromName(self: *const ISAXAttributes, pwchUri: ?[*:0]const u16, cchUri: i32, pwchLocalName: ?[*:0]const u16, cchLocalName: i32, pnIndex: ?*i32) HRESULT {
        return self.vtable.getIndexFromName(self, pwchUri, cchUri, pwchLocalName, cchLocalName, pnIndex);
    }
    pub inline fn getIndexFromQName(self: *const ISAXAttributes, pwchQName: ?[*:0]const u16, cchQName: i32, pnIndex: ?*i32) HRESULT {
        return self.vtable.getIndexFromQName(self, pwchQName, cchQName, pnIndex);
    }
    pub inline fn getType(self: *const ISAXAttributes, nIndex: i32, ppwchType: ?*const ?*u16, pcchType: ?*i32) HRESULT {
        return self.vtable.getType(self, nIndex, ppwchType, pcchType);
    }
    pub inline fn getTypeFromName(self: *const ISAXAttributes, pwchUri: ?[*:0]const u16, cchUri: i32, pwchLocalName: ?[*:0]const u16, cchLocalName: i32, ppwchType: ?*const ?*u16, pcchType: ?*i32) HRESULT {
        return self.vtable.getTypeFromName(self, pwchUri, cchUri, pwchLocalName, cchLocalName, ppwchType, pcchType);
    }
    pub inline fn getTypeFromQName(self: *const ISAXAttributes, pwchQName: ?[*:0]const u16, cchQName: i32, ppwchType: ?*const ?*u16, pcchType: ?*i32) HRESULT {
        return self.vtable.getTypeFromQName(self, pwchQName, cchQName, ppwchType, pcchType);
    }
    pub inline fn getValue(self: *const ISAXAttributes, nIndex: i32, ppwchValue: ?*const ?*u16, pcchValue: ?*i32) HRESULT {
        return self.vtable.getValue(self, nIndex, ppwchValue, pcchValue);
    }
    pub inline fn getValueFromName(self: *const ISAXAttributes, pwchUri: ?[*:0]const u16, cchUri: i32, pwchLocalName: ?[*:0]const u16, cchLocalName: i32, ppwchValue: ?*const ?*u16, pcchValue: ?*i32) HRESULT {
        return self.vtable.getValueFromName(self, pwchUri, cchUri, pwchLocalName, cchLocalName, ppwchValue, pcchValue);
    }
    pub inline fn getValueFromQName(self: *const ISAXAttributes, pwchQName: ?[*:0]const u16, cchQName: i32, ppwchValue: ?*const ?*u16, pcchValue: ?*i32) HRESULT {
...
pub const IVBSAXXMLReader = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn getFeature(self: *const IVBSAXXMLReader, strName: ?BSTR, fValue: ?*i16) HRESULT {
        return self.vtable.getFeature(self, strName, fValue);
    }
    pub inline fn putFeature(self: *const IVBSAXXMLReader, strName: ?BSTR, fValue: i16) HRESULT {
        return self.vtable.putFeature(self, strName, fValue);
    }
    pub inline fn getProperty(self: *const IVBSAXXMLReader, strName: ?BSTR, varValue: ?*VARIANT) HRESULT {
        return self.vtable.getProperty(self, strName, varValue);
    }
    pub inline fn putProperty(self: *const IVBSAXXMLReader, strName: ?BSTR, varValue: VARIANT) HRESULT {
        return self.vtable.putProperty(self, strName, varValue);
    }
    pub inline fn get_entityResolver(self: *const IVBSAXXMLReader, oResolver: ?*?*IVBSAXEntityResolver) HRESULT {
        return self.vtable.get_entityResolver(self, oResolver);
    }
    pub inline fn putref_entityResolver(self: *const IVBSAXXMLReader, oResolver: ?*IVBSAXEntityResolver) HRESULT {
        return self.vtable.putref_entityResolver(self, oResolver);
    }
    pub inline fn get_contentHandler(self: *const IVBSAXXMLReader, oHandler: ?*?*IVBSAXContentHandler) HRESULT {
        return self.vtable.get_contentHandler(self, oHandler);
    }
    pub inline fn putref_contentHandler(self: *const IVBSAXXMLReader, oHandler: ?*IVBSAXContentHandler) HRESULT {
        return self.vtable.putref_contentHandler(self, oHandler);
    }
    pub inline fn get_dtdHandler(self: *const IVBSAXXMLReader, oHandler: ?*?*IVBSAXDTDHandler) HRESULT {
        return self.vtable.get_dtdHandler(self, oHandler);
    }
    pub inline fn putref_dtdHandler(self: *const IVBSAXXMLReader, oHandler: ?*IVBSAXDTDHandler) HRESULT {
        return self.vtable.putref_dtdHandler(self, oHandler);
    }
    pub inline fn get_errorHandler(self: *const IVBSAXXMLReader, oHandler: ?*?*IVBSAXErrorHandler) HRESULT {
        return self.vtable.get_errorHandler(self, oHandler);
    }
    pub inline fn putref_errorHandler(self: *const IVBSAXXMLReader, oHandler: ?*IVBSAXErrorHandler) HRESULT {
        return self.vtable.putref_errorHandler(self, oHandler);
    }
    pub inline fn get_baseURL(self: *const IVBSAXXMLReader, strBaseURL: ?*?BSTR) HRESULT {
        return self.vtable.get_baseURL(self, strBaseURL);
    }
    pub inline fn put_baseURL(self: *const IVBSAXXMLReader, strBaseURL: ?BSTR) HRESULT {
        return self.vtable.put_baseURL(self, strBaseURL);
    }
    pub inline fn get_secureBaseURL(self: *const IVBSAXXMLReader, strSecureBaseURL: ?*?BSTR) HRESULT {
        return self.vtable.get_secureBaseURL(self, strSecureBaseURL);
    }
    pub inline fn put_secureBaseURL(self: *const IVBSAXXMLReader, strSecureBaseURL: ?BSTR) HRESULT {
        return self.vtable.put_secureBaseURL(self, strSecureBaseURL);
    }
    pub inline fn parse(self: *const IVBSAXXMLReader, varInput: VARIANT) HRESULT {
        return self.vtable.parse(self, varInput);
    }
    pub inline fn parseURL(self: *const IVBSAXXMLReader, strURL: ?BSTR) HRESULT {
...
pub const IVBSAXXMLFilter = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_parent(self: *const IVBSAXXMLFilter, oReader: ?*?*IVBSAXXMLReader) HRESULT {
        return self.vtable.get_parent(self, oReader);
    }
    pub inline fn putref_parent(self: *const IVBSAXXMLFilter, oReader: ?*IVBSAXXMLReader) HRESULT {
...
pub const IVBSAXLocator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_columnNumber(self: *const IVBSAXLocator, nColumn: ?*i32) HRESULT {
        return self.vtable.get_columnNumber(self, nColumn);
    }
    pub inline fn get_lineNumber(self: *const IVBSAXLocator, nLine: ?*i32) HRESULT {
        return self.vtable.get_lineNumber(self, nLine);
    }
    pub inline fn get_publicId(self: *const IVBSAXLocator, strPublicId: ?*?BSTR) HRESULT {
        return self.vtable.get_publicId(self, strPublicId);
    }
    pub inline fn get_systemId(self: *const IVBSAXLocator, strSystemId: ?*?BSTR) HRESULT {
...
pub const IVBSAXEntityResolver = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn resolveEntity(self: *const IVBSAXEntityResolver, strPublicId: ?*?BSTR, strSystemId: ?*?BSTR, varInput: ?*VARIANT) HRESULT {
...
pub const IVBSAXContentHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn putref_documentLocator(self: *const IVBSAXContentHandler, oLocator: ?*IVBSAXLocator) HRESULT {
        return self.vtable.putref_documentLocator(self, oLocator);
    }
    pub inline fn startDocument(self: *const IVBSAXContentHandler) HRESULT {
        return self.vtable.startDocument(self);
    }
    pub inline fn endDocument(self: *const IVBSAXContentHandler) HRESULT {
        return self.vtable.endDocument(self);
    }
    pub inline fn startPrefixMapping(self: *const IVBSAXContentHandler, strPrefix: ?*?BSTR, strURI: ?*?BSTR) HRESULT {
        return self.vtable.startPrefixMapping(self, strPrefix, strURI);
    }
    pub inline fn endPrefixMapping(self: *const IVBSAXContentHandler, strPrefix: ?*?BSTR) HRESULT {
        return self.vtable.endPrefixMapping(self, strPrefix);
    }
    pub inline fn startElement(self: *const IVBSAXContentHandler, strNamespaceURI: ?*?BSTR, strLocalName: ?*?BSTR, strQName: ?*?BSTR, oAttributes: ?*IVBSAXAttributes) HRESULT {
        return self.vtable.startElement(self, strNamespaceURI, strLocalName, strQName, oAttributes);
    }
    pub inline fn endElement(self: *const IVBSAXContentHandler, strNamespaceURI: ?*?BSTR, strLocalName: ?*?BSTR, strQName: ?*?BSTR) HRESULT {
        return self.vtable.endElement(self, strNamespaceURI, strLocalName, strQName);
    }
    pub inline fn characters(self: *const IVBSAXContentHandler, strChars: ?*?BSTR) HRESULT {
        return self.vtable.characters(self, strChars);
    }
    pub inline fn ignorableWhitespace(self: *const IVBSAXContentHandler, strChars: ?*?BSTR) HRESULT {
        return self.vtable.ignorableWhitespace(self, strChars);
    }
    pub inline fn processingInstruction(self: *const IVBSAXContentHandler, strTarget: ?*?BSTR, strData: ?*?BSTR) HRESULT {
        return self.vtable.processingInstruction(self, strTarget, strData);
    }
    pub inline fn skippedEntity(self: *const IVBSAXContentHandler, strName: ?*?BSTR) HRESULT {
...
pub const IVBSAXDTDHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn notationDecl(self: *const IVBSAXDTDHandler, strName: ?*?BSTR, strPublicId: ?*?BSTR, strSystemId: ?*?BSTR) HRESULT {
        return self.vtable.notationDecl(self, strName, strPublicId, strSystemId);
    }
    pub inline fn unparsedEntityDecl(self: *const IVBSAXDTDHandler, strName: ?*?BSTR, strPublicId: ?*?BSTR, strSystemId: ?*?BSTR, strNotationName: ?*?BSTR) HRESULT {
...
pub const IVBSAXErrorHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn @"error"(self: *const IVBSAXErrorHandler, oLocator: ?*IVBSAXLocator, strErrorMessage: ?*?BSTR, nErrorCode: i32) HRESULT {
        return self.vtable.@"error"(self, oLocator, strErrorMessage, nErrorCode);
    }
    pub inline fn fatalError(self: *const IVBSAXErrorHandler, oLocator: ?*IVBSAXLocator, strErrorMessage: ?*?BSTR, nErrorCode: i32) HRESULT {
        return self.vtable.fatalError(self, oLocator, strErrorMessage, nErrorCode);
    }
    pub inline fn ignorableWarning(self: *const IVBSAXErrorHandler, oLocator: ?*IVBSAXLocator, strErrorMessage: ?*?BSTR, nErrorCode: i32) HRESULT {
...
pub const IVBSAXLexicalHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn startDTD(self: *const IVBSAXLexicalHandler, strName: ?*?BSTR, strPublicId: ?*?BSTR, strSystemId: ?*?BSTR) HRESULT {
        return self.vtable.startDTD(self, strName, strPublicId, strSystemId);
    }
    pub inline fn endDTD(self: *const IVBSAXLexicalHandler) HRESULT {
        return self.vtable.endDTD(self);
    }
    pub inline fn startEntity(self: *const IVBSAXLexicalHandler, strName: ?*?BSTR) HRESULT {
        return self.vtable.startEntity(self, strName);
    }
    pub inline fn endEntity(self: *const IVBSAXLexicalHandler, strName: ?*?BSTR) HRESULT {
        return self.vtable.endEntity(self, strName);
    }
    pub inline fn startCDATA(self: *const IVBSAXLexicalHandler) HRESULT {
        return self.vtable.startCDATA(self);
    }
    pub inline fn endCDATA(self: *const IVBSAXLexicalHandler) HRESULT {
        return self.vtable.endCDATA(self);
    }
    pub inline fn comment(self: *const IVBSAXLexicalHandler, strChars: ?*?BSTR) HRESULT {
...
pub const IVBSAXDeclHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn elementDecl(self: *const IVBSAXDeclHandler, strName: ?*?BSTR, strModel: ?*?BSTR) HRESULT {
        return self.vtable.elementDecl(self, strName, strModel);
    }
    pub inline fn attributeDecl(self: *const IVBSAXDeclHandler, strElementName: ?*?BSTR, strAttributeName: ?*?BSTR, strType: ?*?BSTR, strValueDefault: ?*?BSTR, strValue: ?*?BSTR) HRESULT {
        return self.vtable.attributeDecl(self, strElementName, strAttributeName, strType, strValueDefault, strValue);
    }
    pub inline fn internalEntityDecl(self: *const IVBSAXDeclHandler, strName: ?*?BSTR, strValue: ?*?BSTR) HRESULT {
        return self.vtable.internalEntityDecl(self, strName, strValue);
    }
    pub inline fn externalEntityDecl(self: *const IVBSAXDeclHandler, strName: ?*?BSTR, strPublicId: ?*?BSTR, strSystemId: ?*?BSTR) HRESULT {
...
pub const IVBSAXAttributes = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_length(self: *const IVBSAXAttributes, nLength: ?*i32) HRESULT {
        return self.vtable.get_length(self, nLength);
    }
    pub inline fn getURI(self: *const IVBSAXAttributes, nIndex: i32, strURI: ?*?BSTR) HRESULT {
        return self.vtable.getURI(self, nIndex, strURI);
    }
    pub inline fn getLocalName(self: *const IVBSAXAttributes, nIndex: i32, strLocalName: ?*?BSTR) HRESULT {
        return self.vtable.getLocalName(self, nIndex, strLocalName);
    }
    pub inline fn getQName(self: *const IVBSAXAttributes, nIndex: i32, strQName: ?*?BSTR) HRESULT {
        return self.vtable.getQName(self, nIndex, strQName);
    }
    pub inline fn getIndexFromName(self: *const IVBSAXAttributes, strURI: ?BSTR, strLocalName: ?BSTR, nIndex: ?*i32) HRESULT {
        return self.vtable.getIndexFromName(self, strURI, strLocalName, nIndex);
    }
    pub inline fn getIndexFromQName(self: *const IVBSAXAttributes, strQName: ?BSTR, nIndex: ?*i32) HRESULT {
        return self.vtable.getIndexFromQName(self, strQName, nIndex);
    }
    pub inline fn getType(self: *const IVBSAXAttributes, nIndex: i32, strType: ?*?BSTR) HRESULT {
        return self.vtable.getType(self, nIndex, strType);
    }
    pub inline fn getTypeFromName(self: *const IVBSAXAttributes, strURI: ?BSTR, strLocalName: ?BSTR, strType: ?*?BSTR) HRESULT {
        return self.vtable.getTypeFromName(self, strURI, strLocalName, strType);
    }
    pub inline fn getTypeFromQName(self: *const IVBSAXAttributes, strQName: ?BSTR, strType: ?*?BSTR) HRESULT {
        return self.vtable.getTypeFromQName(self, strQName, strType);
    }
    pub inline fn getValue(self: *const IVBSAXAttributes, nIndex: i32, strValue: ?*?BSTR) HRESULT {
        return self.vtable.getValue(self, nIndex, strValue);
    }
    pub inline fn getValueFromName(self: *const IVBSAXAttributes, strURI: ?BSTR, strLocalName: ?BSTR, strValue: ?*?BSTR) HRESULT {
        return self.vtable.getValueFromName(self, strURI, strLocalName, strValue);
    }
    pub inline fn getValueFromQName(self: *const IVBSAXAttributes, strQName: ?BSTR, strValue: ?*?BSTR) HRESULT {
...
pub const IMXWriter = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_output(self: *const IMXWriter, varDestination: VARIANT) HRESULT {
        return self.vtable.put_output(self, varDestination);
    }
    pub inline fn get_output(self: *const IMXWriter, varDestination: ?*VARIANT) HRESULT {
        return self.vtable.get_output(self, varDestination);
    }
    pub inline fn put_encoding(self: *const IMXWriter, strEncoding: ?BSTR) HRESULT {
        return self.vtable.put_encoding(self, strEncoding);
    }
    pub inline fn get_encoding(self: *const IMXWriter, strEncoding: ?*?BSTR) HRESULT {
        return self.vtable.get_encoding(self, strEncoding);
    }
    pub inline fn put_byteOrderMark(self: *const IMXWriter, fWriteByteOrderMark: i16) HRESULT {
        return self.vtable.put_byteOrderMark(self, fWriteByteOrderMark);
    }
    pub inline fn get_byteOrderMark(self: *const IMXWriter, fWriteByteOrderMark: ?*i16) HRESULT {
        return self.vtable.get_byteOrderMark(self, fWriteByteOrderMark);
    }
    pub inline fn put_indent(self: *const IMXWriter, fIndentMode: i16) HRESULT {
        return self.vtable.put_indent(self, fIndentMode);
    }
    pub inline fn get_indent(self: *const IMXWriter, fIndentMode: ?*i16) HRESULT {
        return self.vtable.get_indent(self, fIndentMode);
    }
    pub inline fn put_standalone(self: *const IMXWriter, fValue: i16) HRESULT {
        return self.vtable.put_standalone(self, fValue);
    }
    pub inline fn get_standalone(self: *const IMXWriter, fValue: ?*i16) HRESULT {
        return self.vtable.get_standalone(self, fValue);
    }
    pub inline fn put_omitXMLDeclaration(self: *const IMXWriter, fValue: i16) HRESULT {
        return self.vtable.put_omitXMLDeclaration(self, fValue);
    }
    pub inline fn get_omitXMLDeclaration(self: *const IMXWriter, fValue: ?*i16) HRESULT {
        return self.vtable.get_omitXMLDeclaration(self, fValue);
    }
    pub inline fn put_version(self: *const IMXWriter, strVersion: ?BSTR) HRESULT {
        return self.vtable.put_version(self, strVersion);
    }
    pub inline fn get_version(self: *const IMXWriter, strVersion: ?*?BSTR) HRESULT {
        return self.vtable.get_version(self, strVersion);
    }
    pub inline fn put_disableOutputEscaping(self: *const IMXWriter, fValue: i16) HRESULT {
        return self.vtable.put_disableOutputEscaping(self, fValue);
    }
    pub inline fn get_disableOutputEscaping(self: *const IMXWriter, fValue: ?*i16) HRESULT {
        return self.vtable.get_disableOutputEscaping(self, fValue);
    }
    pub inline fn flush(self: *const IMXWriter) HRESULT {
...
pub const IMXAttributes = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn addAttribute(self: *const IMXAttributes, strURI: ?BSTR, strLocalName: ?BSTR, strQName: ?BSTR, strType: ?BSTR, strValue: ?BSTR) HRESULT {
        return self.vtable.addAttribute(self, strURI, strLocalName, strQName, strType, strValue);
    }
    pub inline fn addAttributeFromIndex(self: *const IMXAttributes, varAtts: VARIANT, nIndex: i32) HRESULT {
        return self.vtable.addAttributeFromIndex(self, varAtts, nIndex);
    }
    pub inline fn clear(self: *const IMXAttributes) HRESULT {
        return self.vtable.clear(self);
    }
    pub inline fn removeAttribute(self: *const IMXAttributes, nIndex: i32) HRESULT {
        return self.vtable.removeAttribute(self, nIndex);
    }
    pub inline fn setAttribute(self: *const IMXAttributes, nIndex: i32, strURI: ?BSTR, strLocalName: ?BSTR, strQName: ?BSTR, strType: ?BSTR, strValue: ?BSTR) HRESULT {
        return self.vtable.setAttribute(self, nIndex, strURI, strLocalName, strQName, strType, strValue);
    }
    pub inline fn setAttributes(self: *const IMXAttributes, varAtts: VARIANT) HRESULT {
        return self.vtable.setAttributes(self, varAtts);
    }
    pub inline fn setLocalName(self: *const IMXAttributes, nIndex: i32, strLocalName: ?BSTR) HRESULT {
        return self.vtable.setLocalName(self, nIndex, strLocalName);
    }
    pub inline fn setQName(self: *const IMXAttributes, nIndex: i32, strQName: ?BSTR) HRESULT {
        return self.vtable.setQName(self, nIndex, strQName);
    }
    pub inline fn setType(self: *const IMXAttributes, nIndex: i32, strType: ?BSTR) HRESULT {
        return self.vtable.setType(self, nIndex, strType);
    }
    pub inline fn setURI(self: *const IMXAttributes, nIndex: i32, strURI: ?BSTR) HRESULT {
        return self.vtable.setURI(self, nIndex, strURI);
    }
    pub inline fn setValue(self: *const IMXAttributes, nIndex: i32, strValue: ?BSTR) HRESULT {
...
pub const IMXReaderControl = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn abort(self: *const IMXReaderControl) HRESULT {
        return self.vtable.abort(self);
    }
    pub inline fn @"resume"(self: *const IMXReaderControl) HRESULT {
        return self.vtable.@"resume"(self);
    }
    pub inline fn @"suspend"(self: *const IMXReaderControl) HRESULT {
...
pub const IMXSchemaDeclHandler = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn schemaElementDecl(self: *const IMXSchemaDeclHandler, oSchemaElement: ?*ISchemaElement) HRESULT {
...
pub const IMXNamespacePrefixes = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_item(self: *const IMXNamespacePrefixes, index: i32, prefix: ?*?BSTR) HRESULT {
        return self.vtable.get_item(self, index, prefix);
    }
    pub inline fn get_length(self: *const IMXNamespacePrefixes, length: ?*i32) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get__newEnum(self: *const IMXNamespacePrefixes, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppUnk);
    }
};
...
pub const IVBMXNamespaceManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn put_allowOverride(self: *const IVBMXNamespaceManager, fOverride: i16) HRESULT {
        return self.vtable.put_allowOverride(self, fOverride);
    }
    pub inline fn get_allowOverride(self: *const IVBMXNamespaceManager, fOverride: ?*i16) HRESULT {
        return self.vtable.get_allowOverride(self, fOverride);
    }
    pub inline fn reset(self: *const IVBMXNamespaceManager) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn pushContext(self: *const IVBMXNamespaceManager) HRESULT {
        return self.vtable.pushContext(self);
    }
    pub inline fn pushNodeContext(self: *const IVBMXNamespaceManager, contextNode: ?*IXMLDOMNode, fDeep: i16) HRESULT {
        return self.vtable.pushNodeContext(self, contextNode, fDeep);
    }
    pub inline fn popContext(self: *const IVBMXNamespaceManager) HRESULT {
        return self.vtable.popContext(self);
    }
    pub inline fn declarePrefix(self: *const IVBMXNamespaceManager, prefix: ?BSTR, namespaceURI: ?BSTR) HRESULT {
        return self.vtable.declarePrefix(self, prefix, namespaceURI);
    }
    pub inline fn getDeclaredPrefixes(self: *const IVBMXNamespaceManager, prefixes: ?*?*IMXNamespacePrefixes) HRESULT {
        return self.vtable.getDeclaredPrefixes(self, prefixes);
    }
    pub inline fn getPrefixes(self: *const IVBMXNamespaceManager, namespaceURI: ?BSTR, prefixes: ?*?*IMXNamespacePrefixes) HRESULT {
        return self.vtable.getPrefixes(self, namespaceURI, prefixes);
    }
    pub inline fn getURI(self: *const IVBMXNamespaceManager, prefix: ?BSTR, uri: ?*VARIANT) HRESULT {
        return self.vtable.getURI(self, prefix, uri);
    }
    pub inline fn getURIFromNode(self: *const IVBMXNamespaceManager, strPrefix: ?BSTR, contextNode: ?*IXMLDOMNode, uri: ?*VARIANT) HRESULT {
...
pub const IMXNamespaceManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn putAllowOverride(self: *const IMXNamespaceManager, fOverride: i16) HRESULT {
        return self.vtable.putAllowOverride(self, fOverride);
    }
    pub inline fn getAllowOverride(self: *const IMXNamespaceManager, fOverride: ?*i16) HRESULT {
        return self.vtable.getAllowOverride(self, fOverride);
    }
    pub inline fn reset(self: *const IMXNamespaceManager) HRESULT {
        return self.vtable.reset(self);
    }
    pub inline fn pushContext(self: *const IMXNamespaceManager) HRESULT {
        return self.vtable.pushContext(self);
    }
    pub inline fn pushNodeContext(self: *const IMXNamespaceManager, contextNode: ?*IXMLDOMNode, fDeep: i16) HRESULT {
        return self.vtable.pushNodeContext(self, contextNode, fDeep);
    }
    pub inline fn popContext(self: *const IMXNamespaceManager) HRESULT {
        return self.vtable.popContext(self);
    }
    pub inline fn declarePrefix(self: *const IMXNamespaceManager, prefix: ?[*:0]const u16, namespaceURI: ?[*:0]const u16) HRESULT {
        return self.vtable.declarePrefix(self, prefix, namespaceURI);
    }
    pub inline fn getDeclaredPrefix(self: *const IMXNamespaceManager, nIndex: i32, pwchPrefix: [*:0]u16, pcchPrefix: ?*i32) HRESULT {
        return self.vtable.getDeclaredPrefix(self, nIndex, pwchPrefix, pcchPrefix);
    }
    pub inline fn getPrefix(self: *const IMXNamespaceManager, pwszNamespaceURI: ?[*:0]const u16, nIndex: i32, pwchPrefix: [*:0]u16, pcchPrefix: ?*i32) HRESULT {
        return self.vtable.getPrefix(self, pwszNamespaceURI, nIndex, pwchPrefix, pcchPrefix);
    }
    pub inline fn getURI(self: *const IMXNamespaceManager, pwchPrefix: ?[*:0]const u16, pContextNode: ?*IXMLDOMNode, pwchUri: [*:0]u16, pcchUri: ?*i32) HRESULT {
...
pub const IMXXMLFilter = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn getFeature(self: *const IMXXMLFilter, strName: ?BSTR, fValue: ?*i16) HRESULT {
        return self.vtable.getFeature(self, strName, fValue);
    }
    pub inline fn putFeature(self: *const IMXXMLFilter, strName: ?BSTR, fValue: i16) HRESULT {
        return self.vtable.putFeature(self, strName, fValue);
    }
    pub inline fn getProperty(self: *const IMXXMLFilter, strName: ?BSTR, varValue: ?*VARIANT) HRESULT {
        return self.vtable.getProperty(self, strName, varValue);
    }
    pub inline fn putProperty(self: *const IMXXMLFilter, strName: ?BSTR, varValue: VARIANT) HRESULT {
        return self.vtable.putProperty(self, strName, varValue);
    }
    pub inline fn get_entityResolver(self: *const IMXXMLFilter, oResolver: ?*?*IUnknown) HRESULT {
        return self.vtable.get_entityResolver(self, oResolver);
    }
    pub inline fn putref_entityResolver(self: *const IMXXMLFilter, oResolver: ?*IUnknown) HRESULT {
        return self.vtable.putref_entityResolver(self, oResolver);
    }
    pub inline fn get_contentHandler(self: *const IMXXMLFilter, oHandler: ?*?*IUnknown) HRESULT {
        return self.vtable.get_contentHandler(self, oHandler);
    }
    pub inline fn putref_contentHandler(self: *const IMXXMLFilter, oHandler: ?*IUnknown) HRESULT {
        return self.vtable.putref_contentHandler(self, oHandler);
    }
    pub inline fn get_dtdHandler(self: *const IMXXMLFilter, oHandler: ?*?*IUnknown) HRESULT {
        return self.vtable.get_dtdHandler(self, oHandler);
    }
    pub inline fn putref_dtdHandler(self: *const IMXXMLFilter, oHandler: ?*IUnknown) HRESULT {
        return self.vtable.putref_dtdHandler(self, oHandler);
    }
    pub inline fn get_errorHandler(self: *const IMXXMLFilter, oHandler: ?*?*IUnknown) HRESULT {
        return self.vtable.get_errorHandler(self, oHandler);
    }
    pub inline fn putref_errorHandler(self: *const IMXXMLFilter, oHandler: ?*IUnknown) HRESULT {
        return self.vtable.putref_errorHandler(self, oHandler);
    }
};
...
pub const IXMLDOMSchemaCollection2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn validate(self: *const IXMLDOMSchemaCollection2) HRESULT {
        return self.vtable.validate(self);
    }
    pub inline fn put_validateOnLoad(self: *const IXMLDOMSchemaCollection2, validateOnLoad: i16) HRESULT {
        return self.vtable.put_validateOnLoad(self, validateOnLoad);
    }
    pub inline fn get_validateOnLoad(self: *const IXMLDOMSchemaCollection2, validateOnLoad: ?*i16) HRESULT {
        return self.vtable.get_validateOnLoad(self, validateOnLoad);
    }
    pub inline fn getSchema(self: *const IXMLDOMSchemaCollection2, namespaceURI: ?BSTR, schema: ?*?*ISchema) HRESULT {
        return self.vtable.getSchema(self, namespaceURI, schema);
    }
    pub inline fn getDeclaration(self: *const IXMLDOMSchemaCollection2, node: ?*IXMLDOMNode, item: ?*?*ISchemaItem) HRESULT {
...
pub const ISchemaStringCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_item(self: *const ISchemaStringCollection, index: i32, bstr: ?*?BSTR) HRESULT {
        return self.vtable.get_item(self, index, bstr);
    }
    pub inline fn get_length(self: *const ISchemaStringCollection, length: ?*i32) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get__newEnum(self: *const ISchemaStringCollection, ppunk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppunk);
    }
};
...
pub const ISchemaItemCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_item(self: *const ISchemaItemCollection, index: i32, item: ?*?*ISchemaItem) HRESULT {
        return self.vtable.get_item(self, index, item);
    }
    pub inline fn itemByName(self: *const ISchemaItemCollection, name: ?BSTR, item: ?*?*ISchemaItem) HRESULT {
        return self.vtable.itemByName(self, name, item);
    }
    pub inline fn itemByQName(self: *const ISchemaItemCollection, name: ?BSTR, namespaceURI: ?BSTR, item: ?*?*ISchemaItem) HRESULT {
        return self.vtable.itemByQName(self, name, namespaceURI, item);
    }
    pub inline fn get_length(self: *const ISchemaItemCollection, length: ?*i32) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get__newEnum(self: *const ISchemaItemCollection, ppunk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__newEnum(self, ppunk);
    }
};
...
pub const ISchemaItem = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_name(self: *const ISchemaItem, name: ?*?BSTR) HRESULT {
        return self.vtable.get_name(self, name);
    }
    pub inline fn get_namespaceURI(self: *const ISchemaItem, namespaceURI: ?*?BSTR) HRESULT {
        return self.vtable.get_namespaceURI(self, namespaceURI);
    }
    pub inline fn get_schema(self: *const ISchemaItem, schema: ?*?*ISchema) HRESULT {
        return self.vtable.get_schema(self, schema);
    }
    pub inline fn get_id(self: *const ISchemaItem, id: ?*?BSTR) HRESULT {
        return self.vtable.get_id(self, id);
    }
    pub inline fn get_itemType(self: *const ISchemaItem, itemType: ?*SOMITEMTYPE) HRESULT {
        return self.vtable.get_itemType(self, itemType);
    }
    pub inline fn get_unhandledAttributes(self: *const ISchemaItem, attributes: ?*?*IVBSAXAttributes) HRESULT {
        return self.vtable.get_unhandledAttributes(self, attributes);
    }
    pub inline fn writeAnnotation(self: *const ISchemaItem, annotationSink: ?*IUnknown, isWritten: ?*i16) HRESULT {
...
pub const ISchema = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_targetNamespace(self: *const ISchema, targetNamespace: ?*?BSTR) HRESULT {
        return self.vtable.get_targetNamespace(self, targetNamespace);
    }
    pub inline fn get_version(self: *const ISchema, version: ?*?BSTR) HRESULT {
        return self.vtable.get_version(self, version);
    }
    pub inline fn get_types(self: *const ISchema, types: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_types(self, types);
    }
    pub inline fn get_elements(self: *const ISchema, elements: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_elements(self, elements);
    }
    pub inline fn get_attributes(self: *const ISchema, attributes: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_attributes(self, attributes);
    }
    pub inline fn get_attributeGroups(self: *const ISchema, attributeGroups: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_attributeGroups(self, attributeGroups);
    }
    pub inline fn get_modelGroups(self: *const ISchema, modelGroups: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_modelGroups(self, modelGroups);
    }
    pub inline fn get_notations(self: *const ISchema, notations: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_notations(self, notations);
    }
    pub inline fn get_schemaLocations(self: *const ISchema, schemaLocations: ?*?*ISchemaStringCollection) HRESULT {
...
pub const ISchemaParticle = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_minOccurs(self: *const ISchemaParticle, minOccurs: ?*VARIANT) HRESULT {
        return self.vtable.get_minOccurs(self, minOccurs);
    }
    pub inline fn get_maxOccurs(self: *const ISchemaParticle, maxOccurs: ?*VARIANT) HRESULT {
...
pub const ISchemaAttribute = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_type(self: *const ISchemaAttribute, @"type": ?*?*ISchemaType) HRESULT {
        return self.vtable.get_type(self, @"type");
    }
    pub inline fn get_scope(self: *const ISchemaAttribute, scope: ?*?*ISchemaComplexType) HRESULT {
        return self.vtable.get_scope(self, scope);
    }
    pub inline fn get_defaultValue(self: *const ISchemaAttribute, defaultValue: ?*?BSTR) HRESULT {
        return self.vtable.get_defaultValue(self, defaultValue);
    }
    pub inline fn get_fixedValue(self: *const ISchemaAttribute, fixedValue: ?*?BSTR) HRESULT {
        return self.vtable.get_fixedValue(self, fixedValue);
    }
    pub inline fn get_use(self: *const ISchemaAttribute, use: ?*SCHEMAUSE) HRESULT {
        return self.vtable.get_use(self, use);
    }
    pub inline fn get_isReference(self: *const ISchemaAttribute, reference: ?*i16) HRESULT {
...
pub const ISchemaElement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_type(self: *const ISchemaElement, @"type": ?*?*ISchemaType) HRESULT {
        return self.vtable.get_type(self, @"type");
    }
    pub inline fn get_scope(self: *const ISchemaElement, scope: ?*?*ISchemaComplexType) HRESULT {
        return self.vtable.get_scope(self, scope);
    }
    pub inline fn get_defaultValue(self: *const ISchemaElement, defaultValue: ?*?BSTR) HRESULT {
        return self.vtable.get_defaultValue(self, defaultValue);
    }
    pub inline fn get_fixedValue(self: *const ISchemaElement, fixedValue: ?*?BSTR) HRESULT {
        return self.vtable.get_fixedValue(self, fixedValue);
    }
    pub inline fn get_isNillable(self: *const ISchemaElement, nillable: ?*i16) HRESULT {
        return self.vtable.get_isNillable(self, nillable);
    }
    pub inline fn get_identityConstraints(self: *const ISchemaElement, constraints: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_identityConstraints(self, constraints);
    }
    pub inline fn get_substitutionGroup(self: *const ISchemaElement, element: ?*?*ISchemaElement) HRESULT {
        return self.vtable.get_substitutionGroup(self, element);
    }
    pub inline fn get_substitutionGroupExclusions(self: *const ISchemaElement, exclusions: ?*SCHEMADERIVATIONMETHOD) HRESULT {
        return self.vtable.get_substitutionGroupExclusions(self, exclusions);
    }
    pub inline fn get_disallowedSubstitutions(self: *const ISchemaElement, disallowed: ?*SCHEMADERIVATIONMETHOD) HRESULT {
        return self.vtable.get_disallowedSubstitutions(self, disallowed);
    }
    pub inline fn get_isAbstract(self: *const ISchemaElement, abstract: ?*i16) HRESULT {
        return self.vtable.get_isAbstract(self, abstract);
    }
    pub inline fn get_isReference(self: *const ISchemaElement, reference: ?*i16) HRESULT {
        return self.vtable.get_isReference(self, reference);
    }
};
...
pub const ISchemaType = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_baseTypes(self: *const ISchemaType, baseTypes: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_baseTypes(self, baseTypes);
    }
    pub inline fn get_final(self: *const ISchemaType, final: ?*SCHEMADERIVATIONMETHOD) HRESULT {
        return self.vtable.get_final(self, final);
    }
    pub inline fn get_variety(self: *const ISchemaType, variety: ?*SCHEMATYPEVARIETY) HRESULT {
        return self.vtable.get_variety(self, variety);
    }
    pub inline fn get_derivedBy(self: *const ISchemaType, derivedBy: ?*SCHEMADERIVATIONMETHOD) HRESULT {
        return self.vtable.get_derivedBy(self, derivedBy);
    }
    pub inline fn isValid(self: *const ISchemaType, data: ?BSTR, valid: ?*i16) HRESULT {
        return self.vtable.isValid(self, data, valid);
    }
    pub inline fn get_minExclusive(self: *const ISchemaType, minExclusive: ?*?BSTR) HRESULT {
        return self.vtable.get_minExclusive(self, minExclusive);
    }
    pub inline fn get_minInclusive(self: *const ISchemaType, minInclusive: ?*?BSTR) HRESULT {
        return self.vtable.get_minInclusive(self, minInclusive);
    }
    pub inline fn get_maxExclusive(self: *const ISchemaType, maxExclusive: ?*?BSTR) HRESULT {
        return self.vtable.get_maxExclusive(self, maxExclusive);
    }
    pub inline fn get_maxInclusive(self: *const ISchemaType, maxInclusive: ?*?BSTR) HRESULT {
        return self.vtable.get_maxInclusive(self, maxInclusive);
    }
    pub inline fn get_totalDigits(self: *const ISchemaType, totalDigits: ?*VARIANT) HRESULT {
        return self.vtable.get_totalDigits(self, totalDigits);
    }
    pub inline fn get_fractionDigits(self: *const ISchemaType, fractionDigits: ?*VARIANT) HRESULT {
        return self.vtable.get_fractionDigits(self, fractionDigits);
    }
    pub inline fn get_length(self: *const ISchemaType, length: ?*VARIANT) HRESULT {
        return self.vtable.get_length(self, length);
    }
    pub inline fn get_minLength(self: *const ISchemaType, minLength: ?*VARIANT) HRESULT {
        return self.vtable.get_minLength(self, minLength);
    }
    pub inline fn get_maxLength(self: *const ISchemaType, maxLength: ?*VARIANT) HRESULT {
        return self.vtable.get_maxLength(self, maxLength);
    }
    pub inline fn get_enumeration(self: *const ISchemaType, enumeration: ?*?*ISchemaStringCollection) HRESULT {
        return self.vtable.get_enumeration(self, enumeration);
    }
    pub inline fn get_whitespace(self: *const ISchemaType, whitespace: ?*SCHEMAWHITESPACE) HRESULT {
        return self.vtable.get_whitespace(self, whitespace);
    }
    pub inline fn get_patterns(self: *const ISchemaType, patterns: ?*?*ISchemaStringCollection) HRESULT {
...
pub const ISchemaComplexType = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_isAbstract(self: *const ISchemaComplexType, abstract: ?*i16) HRESULT {
        return self.vtable.get_isAbstract(self, abstract);
    }
    pub inline fn get_anyAttribute(self: *const ISchemaComplexType, anyAttribute: ?*?*ISchemaAny) HRESULT {
        return self.vtable.get_anyAttribute(self, anyAttribute);
    }
    pub inline fn get_attributes(self: *const ISchemaComplexType, attributes: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_attributes(self, attributes);
    }
    pub inline fn get_contentType(self: *const ISchemaComplexType, contentType: ?*SCHEMACONTENTTYPE) HRESULT {
        return self.vtable.get_contentType(self, contentType);
    }
    pub inline fn get_contentModel(self: *const ISchemaComplexType, contentModel: ?*?*ISchemaModelGroup) HRESULT {
        return self.vtable.get_contentModel(self, contentModel);
    }
    pub inline fn get_prohibitedSubstitutions(self: *const ISchemaComplexType, prohibited: ?*SCHEMADERIVATIONMETHOD) HRESULT {
...
pub const ISchemaAttributeGroup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_anyAttribute(self: *const ISchemaAttributeGroup, anyAttribute: ?*?*ISchemaAny) HRESULT {
        return self.vtable.get_anyAttribute(self, anyAttribute);
    }
    pub inline fn get_attributes(self: *const ISchemaAttributeGroup, attributes: ?*?*ISchemaItemCollection) HRESULT {
        return self.vtable.get_attributes(self, attributes);
    }
};
...
pub const ISchemaModelGroup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_particles(self: *const ISchemaModelGroup, particles: ?*?*ISchemaItemCollection) HRESULT {
...
pub const ISchemaAny = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_namespaces(self: *const ISchemaAny, namespaces: ?*?*ISchemaStringCollection) HRESULT {
        return self.vtable.get_namespaces(self, namespaces);
    }
    pub inline fn get_processContents(self: *const ISchemaAny, processContents: ?*SCHEMAPROCESSCONTENTS) HRESULT {
...
pub const ISchemaIdentityConstraint = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_selector(self: *const ISchemaIdentityConstraint, selector: ?*?BSTR) HRESULT {
        return self.vtable.get_selector(self, selector);
    }
    pub inline fn get_fields(self: *const ISchemaIdentityConstraint, fields: ?*?*ISchemaStringCollection) HRESULT {
        return self.vtable.get_fields(self, fields);
    }
    pub inline fn get_referencedKey(self: *const ISchemaIdentityConstraint, key: ?*?*ISchemaIdentityConstraint) HRESULT {
...
pub const ISchemaNotation = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_systemIdentifier(self: *const ISchemaNotation, uri: ?*?BSTR) HRESULT {
        return self.vtable.get_systemIdentifier(self, uri);
    }
    pub inline fn get_publicIdentifier(self: *const ISchemaNotation, uri: ?*?BSTR) HRESULT {
...
pub const IXMLHTTPRequest2Callback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnRedirect(self: *const IXMLHTTPRequest2Callback, pXHR: ?*IXMLHTTPRequest2, pwszRedirectUrl: ?[*:0]const u16) HRESULT {
        return self.vtable.OnRedirect(self, pXHR, pwszRedirectUrl);
    }
    pub inline fn OnHeadersAvailable(self: *const IXMLHTTPRequest2Callback, pXHR: ?*IXMLHTTPRequest2, dwStatus: u32, pwszStatus: ?[*:0]const u16) HRESULT {
        return self.vtable.OnHeadersAvailable(self, pXHR, dwStatus, pwszStatus);
    }
    pub inline fn OnDataAvailable(self: *const IXMLHTTPRequest2Callback, pXHR: ?*IXMLHTTPRequest2, pResponseStream: ?*ISequentialStream) HRESULT {
        return self.vtable.OnDataAvailable(self, pXHR, pResponseStream);
    }
    pub inline fn OnResponseReceived(self: *const IXMLHTTPRequest2Callback, pXHR: ?*IXMLHTTPRequest2, pResponseStream: ?*ISequentialStream) HRESULT {
        return self.vtable.OnResponseReceived(self, pXHR, pResponseStream);
    }
    pub inline fn OnError(self: *const IXMLHTTPRequest2Callback, pXHR: ?*IXMLHTTPRequest2, hrError: HRESULT) HRESULT {
...
pub const IXMLHTTPRequest2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Open(self: *const IXMLHTTPRequest2, pwszMethod: ?[*:0]const u16, pwszUrl: ?[*:0]const u16, pStatusCallback: ?*IXMLHTTPRequest2Callback, pwszUserName: ?[*:0]const u16, pwszPassword: ?[*:0]const u16, pwszProxyUserName: ?[*:0]const u16, pwszProxyPassword: ?[*:0]const u16) HRESULT {
    ...
    pub inline fn Send(self: *const IXMLHTTPRequest2, pBody: ?*ISequentialStream, cbBody: u64) HRESULT {
        return self.vtable.Send(self, pBody, cbBody);
    }
    pub inline fn Abort(self: *const IXMLHTTPRequest2) HRESULT {
        return self.vtable.Abort(self);
    }
    pub inline fn SetCookie(self: *const IXMLHTTPRequest2, pCookie: ?*const XHR_COOKIE, pdwCookieState: ?*u32) HRESULT {
        return self.vtable.SetCookie(self, pCookie, pdwCookieState);
    }
    pub inline fn SetCustomResponseStream(self: *const IXMLHTTPRequest2, pSequentialStream: ?*ISequentialStream) HRESULT {
        return self.vtable.SetCustomResponseStream(self, pSequentialStream);
    }
    pub inline fn SetProperty(self: *const IXMLHTTPRequest2, eProperty: XHR_PROPERTY, ullValue: u64) HRESULT {
        return self.vtable.SetProperty(self, eProperty, ullValue);
    }
    pub inline fn SetRequestHeader(self: *const IXMLHTTPRequest2, pwszHeader: ?[*:0]const u16, pwszValue: ?[*:0]const u16) HRESULT {
        return self.vtable.SetRequestHeader(self, pwszHeader, pwszValue);
    }
    pub inline fn GetAllResponseHeaders(self: *const IXMLHTTPRequest2, ppwszHeaders: ?*?*u16) HRESULT {
        return self.vtable.GetAllResponseHeaders(self, ppwszHeaders);
    }
    pub inline fn GetCookie(self: *const IXMLHTTPRequest2, pwszUrl: ?[*:0]const u16, pwszName: ?[*:0]const u16, dwFlags: u32, pcCookies: ?*u32, ppCookies: [*]?*XHR_COOKIE) HRESULT {
        return self.vtable.GetCookie(self, pwszUrl, pwszName, dwFlags, pcCookies, ppCookies);
    }
    pub inline fn GetResponseHeader(self: *const IXMLHTTPRequest2, pwszHeader: ?[*:0]const u16, ppwszValue: ?*?*u16) HRESULT {
...
pub const IXMLHTTPRequest3Callback = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn OnServerCertificateReceived(self: *const IXMLHTTPRequest3Callback, pXHR: ?*IXMLHTTPRequest3, dwCertificateErrors: u32, cServerCertificateChain: u32, rgServerCertificateChain: [*]const XHR_CERT) HRESULT {
    ...
    pub inline fn OnClientCertificateRequested(self: *const IXMLHTTPRequest3Callback, pXHR: ?*IXMLHTTPRequest3, cIssuerList: u32, rgpwszIssuerList: [*]const ?*const u16) HRESULT {
...
pub const IXMLHTTPRequest3 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetClientCertificate(self: *const IXMLHTTPRequest3, cbClientCertificateHash: u32, pbClientCertificateHash: [*:0]const u8, pwszPin: ?[*:0]const u16) HRESULT {
