...
pub const IUISimplePropertySet = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetValue(self: *const IUISimplePropertySet, key: ?*const PROPERTYKEY, value: ?*PROPVARIANT) HRESULT {
...
pub const IUIRibbon = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetHeight(self: *const IUIRibbon, cy: ?*u32) HRESULT {
        return self.vtable.GetHeight(self, cy);
    }
    pub inline fn LoadSettingsFromStream(self: *const IUIRibbon, pStream: ?*IStream) HRESULT {
        return self.vtable.LoadSettingsFromStream(self, pStream);
    }
    pub inline fn SaveSettingsToStream(self: *const IUIRibbon, pStream: ?*IStream) HRESULT {
...
pub const IUIFramework = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IUIFramework, frameWnd: ?HWND, application: ?*IUIApplication) HRESULT {
        return self.vtable.Initialize(self, frameWnd, application);
    }
    pub inline fn Destroy(self: *const IUIFramework) HRESULT {
        return self.vtable.Destroy(self);
    }
    pub inline fn LoadUI(self: *const IUIFramework, instance: ?HINSTANCE, resourceName: ?[*:0]const u16) HRESULT {
        return self.vtable.LoadUI(self, instance, resourceName);
    }
    pub inline fn GetView(self: *const IUIFramework, viewId: u32, riid: ?*const Guid, ppv: ?*?*anyopaque) HRESULT {
        return self.vtable.GetView(self, viewId, riid, ppv);
    }
    pub inline fn GetUICommandProperty(self: *const IUIFramework, commandId: u32, key: ?*const PROPERTYKEY, value: ?*PROPVARIANT) HRESULT {
        return self.vtable.GetUICommandProperty(self, commandId, key, value);
    }
    pub inline fn SetUICommandProperty(self: *const IUIFramework, commandId: u32, key: ?*const PROPERTYKEY, value: ?*const PROPVARIANT) HRESULT {
        return self.vtable.SetUICommandProperty(self, commandId, key, value);
    }
    pub inline fn InvalidateUICommand(self: *const IUIFramework, commandId: u32, flags: UI_INVALIDATIONS, key: ?*const PROPERTYKEY) HRESULT {
        return self.vtable.InvalidateUICommand(self, commandId, flags, key);
    }
    pub inline fn FlushPendingInvalidations(self: *const IUIFramework) HRESULT {
        return self.vtable.FlushPendingInvalidations(self);
    }
    pub inline fn SetModes(self: *const IUIFramework, iModes: i32) HRESULT {
...
pub const IUIEventLogger = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnUIEvent(self: *const IUIEventLogger, pEventParams: ?*UI_EVENTPARAMS) void {
...
pub const IUIEventingManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetEventLogger(self: *const IUIEventingManager, eventLogger: ?*IUIEventLogger) HRESULT {
...
pub const IUIContextualUI = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ShowAtLocation(self: *const IUIContextualUI, x: i32, y: i32) HRESULT {
...
pub const IUICollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCount(self: *const IUICollection, count: ?*u32) HRESULT {
        return self.vtable.GetCount(self, count);
    }
    pub inline fn GetItem(self: *const IUICollection, index: u32, item: ?*?*IUnknown) HRESULT {
        return self.vtable.GetItem(self, index, item);
    }
    pub inline fn Add(self: *const IUICollection, item: ?*IUnknown) HRESULT {
        return self.vtable.Add(self, item);
    }
    pub inline fn Insert(self: *const IUICollection, index: u32, item: ?*IUnknown) HRESULT {
        return self.vtable.Insert(self, index, item);
    }
    pub inline fn RemoveAt(self: *const IUICollection, index: u32) HRESULT {
        return self.vtable.RemoveAt(self, index);
    }
    pub inline fn Replace(self: *const IUICollection, indexReplaced: u32, itemReplaceWith: ?*IUnknown) HRESULT {
        return self.vtable.Replace(self, indexReplaced, itemReplaceWith);
    }
    pub inline fn Clear(self: *const IUICollection) HRESULT {
...
pub const IUICollectionChangedEvent = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnChanged(self: *const IUICollectionChangedEvent, action: UI_COLLECTIONCHANGE, oldIndex: u32, oldItem: ?*IUnknown, newIndex: u32, newItem: ?*IUnknown) HRESULT {
...
pub const IUICommandHandler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Execute(self: *const IUICommandHandler, commandId: u32, verb: UI_EXECUTIONVERB, key: ?*const PROPERTYKEY, currentValue: ?*const PROPVARIANT, commandExecutionProperties: ?*IUISimplePropertySet) HRESULT {
        return self.vtable.Execute(self, commandId, verb, key, currentValue, commandExecutionProperties);
    }
    pub inline fn UpdateProperty(self: *const IUICommandHandler, commandId: u32, key: ?*const PROPERTYKEY, currentValue: ?*const PROPVARIANT, newValue: ?*PROPVARIANT) HRESULT {
...
pub const IUIApplication = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnViewChanged(self: *const IUIApplication, viewId: u32, typeID: UI_VIEWTYPE, view: ?*IUnknown, verb: UI_VIEWVERB, uReasonCode: i32) HRESULT {
        return self.vtable.OnViewChanged(self, viewId, typeID, view, verb, uReasonCode);
    }
    pub inline fn OnCreateUICommand(self: *const IUIApplication, commandId: u32, typeID: UI_COMMANDTYPE, commandHandler: ?*?*IUICommandHandler) HRESULT {
        return self.vtable.OnCreateUICommand(self, commandId, typeID, commandHandler);
    }
    pub inline fn OnDestroyUICommand(self: *const IUIApplication, commandId: u32, typeID: UI_COMMANDTYPE, commandHandler: ?*IUICommandHandler) HRESULT {
...
pub const IUIImage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetBitmap(self: *const IUIImage, bitmap: ?*?HBITMAP) HRESULT {
...
pub const IUIImageFromBitmap = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateImage(self: *const IUIImageFromBitmap, bitmap: ?HBITMAP, options: UI_OWNERSHIP, image: ?*?*IUIImage) HRESULT {
