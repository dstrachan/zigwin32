...
pub const IDeviceModelPlugIn = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IDeviceModelPlugIn, bstrXml: ?BSTR, cNumModels: u32, iModelPosition: u32) HRESULT {
        return self.vtable.Initialize(self, bstrXml, cNumModels, iModelPosition);
    }
    pub inline fn GetNumChannels(self: *const IDeviceModelPlugIn, pNumChannels: ?*u32) HRESULT {
        return self.vtable.GetNumChannels(self, pNumChannels);
    }
    pub inline fn DeviceToColorimetricColors(self: *const IDeviceModelPlugIn, cColors: u32, cChannels: u32, pDeviceValues: ?*const f32, pXYZColors: [*]XYZColorF) HRESULT {
        return self.vtable.DeviceToColorimetricColors(self, cColors, cChannels, pDeviceValues, pXYZColors);
    }
    pub inline fn ColorimetricToDeviceColors(self: *const IDeviceModelPlugIn, cColors: u32, cChannels: u32, pXYZColors: [*]const XYZColorF, pDeviceValues: ?*f32) HRESULT {
        return self.vtable.ColorimetricToDeviceColors(self, cColors, cChannels, pXYZColors, pDeviceValues);
    }
    pub inline fn ColorimetricToDeviceColorsWithBlack(self: *const IDeviceModelPlugIn, cColors: u32, cChannels: u32, pXYZColors: [*]const XYZColorF, pBlackInformation: [*]const BlackInformation, pDeviceValues: ?*f32) HRESULT {
        return self.vtable.ColorimetricToDeviceColorsWithBlack(self, cColors, cChannels, pXYZColors, pBlackInformation, pDeviceValues);
    }
    pub inline fn SetTransformDeviceModelInfo(self: *const IDeviceModelPlugIn, iModelPosition: u32, pIDeviceModelOther: ?*IDeviceModelPlugIn) HRESULT {
        return self.vtable.SetTransformDeviceModelInfo(self, iModelPosition, pIDeviceModelOther);
    }
    pub inline fn GetPrimarySamples(self: *const IDeviceModelPlugIn, pPrimaryColor: ?*PrimaryXYZColors) HRESULT {
        return self.vtable.GetPrimarySamples(self, pPrimaryColor);
    }
    pub inline fn GetGamutBoundaryMeshSize(self: *const IDeviceModelPlugIn, pNumVertices: ?*u32, pNumTriangles: ?*u32) HRESULT {
        return self.vtable.GetGamutBoundaryMeshSize(self, pNumVertices, pNumTriangles);
    }
    pub inline fn GetGamutBoundaryMesh(self: *const IDeviceModelPlugIn, cChannels: u32, cVertices: u32, cTriangles: u32, pVertices: ?*f32, pTriangles: [*]GamutShellTriangle) HRESULT {
        return self.vtable.GetGamutBoundaryMesh(self, cChannels, cVertices, cTriangles, pVertices, pTriangles);
    }
    pub inline fn GetNeutralAxisSize(self: *const IDeviceModelPlugIn, pcColors: ?*u32) HRESULT {
        return self.vtable.GetNeutralAxisSize(self, pcColors);
    }
    pub inline fn GetNeutralAxis(self: *const IDeviceModelPlugIn, cColors: u32, pXYZColors: [*]XYZColorF) HRESULT {
...
pub const IGamutMapModelPlugIn = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IGamutMapModelPlugIn, bstrXml: ?BSTR, pSrcPlugIn: ?*IDeviceModelPlugIn, pDestPlugIn: ?*IDeviceModelPlugIn, pSrcGBD: ?*GamutBoundaryDescription, pDestGBD: ?*GamutBoundaryDescription) HRESULT {
        return self.vtable.Initialize(self, bstrXml, pSrcPlugIn, pDestPlugIn, pSrcGBD, pDestGBD);
    }
    pub inline fn SourceToDestinationAppearanceColors(self: *const IGamutMapModelPlugIn, cColors: u32, pInputColors: [*]const JChColorF, pOutputColors: [*]JChColorF) HRESULT {
