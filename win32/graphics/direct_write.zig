...
pub const IDWriteFontFileLoader = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateStreamFromKey(self: *const IDWriteFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, fontFileStream: **IDWriteFontFileStream) HRESULT {
...
pub const IDWriteLocalFontFileLoader = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetFilePathLengthFromKey(self: *const IDWriteLocalFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, filePathLength: ?*u32) HRESULT {
        return self.vtable.GetFilePathLengthFromKey(self, fontFileReferenceKey, fontFileReferenceKeySize, filePathLength);
    }
    pub inline fn GetFilePathFromKey(self: *const IDWriteLocalFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, filePath: [*:0]u16, filePathSize: u32) HRESULT {
        return self.vtable.GetFilePathFromKey(self, fontFileReferenceKey, fontFileReferenceKeySize, filePath, filePathSize);
    }
    pub inline fn GetLastWriteTimeFromKey(self: *const IDWriteLocalFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, lastWriteTime: ?*FILETIME) HRESULT {
...
pub const IDWriteFontFileStream = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReadFileFragment(self: *const IDWriteFontFileStream, fragmentStart: ?*const ?*anyopaque, fileOffset: u64, fragmentSize: u64, fragmentContext: ?*?*anyopaque) HRESULT {
        return self.vtable.ReadFileFragment(self, fragmentStart, fileOffset, fragmentSize, fragmentContext);
    }
    pub inline fn ReleaseFileFragment(self: *const IDWriteFontFileStream, fragmentContext: ?*anyopaque) void {
        return self.vtable.ReleaseFileFragment(self, fragmentContext);
    }
    pub inline fn GetFileSize(self: *const IDWriteFontFileStream, fileSize: ?*u64) HRESULT {
        return self.vtable.GetFileSize(self, fileSize);
    }
    pub inline fn GetLastWriteTime(self: *const IDWriteFontFileStream, lastWriteTime: ?*u64) HRESULT {
...
pub const IDWriteFontFile = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetReferenceKey(self: *const IDWriteFontFile, fontFileReferenceKey: ?*const ?*anyopaque, fontFileReferenceKeySize: ?*u32) HRESULT {
        return self.vtable.GetReferenceKey(self, fontFileReferenceKey, fontFileReferenceKeySize);
    }
    pub inline fn GetLoader(self: *const IDWriteFontFile, fontFileLoader: **IDWriteFontFileLoader) HRESULT {
        return self.vtable.GetLoader(self, fontFileLoader);
    }
    pub inline fn Analyze(self: *const IDWriteFontFile, isSupportedFontType: ?*BOOL, fontFileType: ?*DWRITE_FONT_FILE_TYPE, fontFaceType: ?*DWRITE_FONT_FACE_TYPE, numberOfFaces: ?*u32) HRESULT {
...
pub const IDWriteRenderingParams = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetGamma(self: *const IDWriteRenderingParams) f32 {
        return self.vtable.GetGamma(self);
    }
    pub inline fn GetEnhancedContrast(self: *const IDWriteRenderingParams) f32 {
        return self.vtable.GetEnhancedContrast(self);
    }
    pub inline fn GetClearTypeLevel(self: *const IDWriteRenderingParams) f32 {
        return self.vtable.GetClearTypeLevel(self);
    }
    pub inline fn GetPixelGeometry(self: *const IDWriteRenderingParams) DWRITE_PIXEL_GEOMETRY {
        return self.vtable.GetPixelGeometry(self);
    }
    pub inline fn GetRenderingMode(self: *const IDWriteRenderingParams) DWRITE_RENDERING_MODE {
...
pub const IDWriteFontFace = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetType(self: *const IDWriteFontFace) DWRITE_FONT_FACE_TYPE {
        return self.vtable.GetType(self);
    }
    pub inline fn GetFiles(self: *const IDWriteFontFace, numberOfFiles: ?*u32, fontFiles: ?[*]?*IDWriteFontFile) HRESULT {
        return self.vtable.GetFiles(self, numberOfFiles, fontFiles);
    }
    pub inline fn GetIndex(self: *const IDWriteFontFace) u32 {
        return self.vtable.GetIndex(self);
    }
    pub inline fn GetSimulations(self: *const IDWriteFontFace) DWRITE_FONT_SIMULATIONS {
        return self.vtable.GetSimulations(self);
    }
    pub inline fn IsSymbolFont(self: *const IDWriteFontFace) BOOL {
        return self.vtable.IsSymbolFont(self);
    }
    pub inline fn GetMetrics(self: *const IDWriteFontFace, fontFaceMetrics: ?*DWRITE_FONT_METRICS) void {
        return self.vtable.GetMetrics(self, fontFaceMetrics);
    }
    pub inline fn GetGlyphCount(self: *const IDWriteFontFace) u16 {
        return self.vtable.GetGlyphCount(self);
    }
    pub inline fn GetDesignGlyphMetrics(self: *const IDWriteFontFace, glyphIndices: [*:0]const u16, glyphCount: u32, glyphMetrics: [*]DWRITE_GLYPH_METRICS, isSideways: BOOL) HRESULT {
        return self.vtable.GetDesignGlyphMetrics(self, glyphIndices, glyphCount, glyphMetrics, isSideways);
    }
    pub inline fn GetGlyphIndices(self: *const IDWriteFontFace, codePoints: [*]const u32, codePointCount: u32, glyphIndices: [*:0]u16) HRESULT {
        return self.vtable.GetGlyphIndices(self, codePoints, codePointCount, glyphIndices);
    }
    pub inline fn TryGetFontTable(self: *const IDWriteFontFace, openTypeTableTag: u32, tableData: ?*const ?*anyopaque, tableSize: ?*u32, tableContext: ?*?*anyopaque, exists: ?*BOOL) HRESULT {
        return self.vtable.TryGetFontTable(self, openTypeTableTag, tableData, tableSize, tableContext, exists);
    }
    pub inline fn ReleaseFontTable(self: *const IDWriteFontFace, tableContext: ?*anyopaque) void {
        return self.vtable.ReleaseFontTable(self, tableContext);
    }
    pub inline fn GetGlyphRunOutline(self: *const IDWriteFontFace, emSize: f32, glyphIndices: [*:0]const u16, glyphAdvances: ?[*]const f32, glyphOffsets: ?[*]const DWRITE_GLYPH_OFFSET, glyphCount: u32, isSideways: BOOL, isRightToLeft: BOOL, geometrySink: ?*ID2D1SimplifiedGeometrySink) HRESULT {
    ...
    pub inline fn GetRecommendedRenderingMode(self: *const IDWriteFontFace, emSize: f32, pixelsPerDip: f32, measuringMode: DWRITE_MEASURING_MODE, renderingParams: ?*IDWriteRenderingParams, renderingMode: ?*DWRITE_RENDERING_MODE) HRESULT {
        return self.vtable.GetRecommendedRenderingMode(self, emSize, pixelsPerDip, measuringMode, renderingParams, renderingMode);
    }
    pub inline fn GetGdiCompatibleMetrics(self: *const IDWriteFontFace, emSize: f32, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, fontFaceMetrics: ?*DWRITE_FONT_METRICS) HRESULT {
        return self.vtable.GetGdiCompatibleMetrics(self, emSize, pixelsPerDip, transform, fontFaceMetrics);
    }
    pub inline fn GetGdiCompatibleGlyphMetrics(self: *const IDWriteFontFace, emSize: f32, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, useGdiNatural: BOOL, glyphIndices: [*:0]const u16, glyphCount: u32, glyphMetrics: [*]DWRITE_GLYPH_METRICS, isSideways: BOOL) HRESULT {
...
pub const IDWriteFontCollectionLoader = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateEnumeratorFromKey(self: *const IDWriteFontCollectionLoader, factory: ?*IDWriteFactory, collectionKey: ?*const anyopaque, collectionKeySize: u32, fontFileEnumerator: **IDWriteFontFileEnumerator) HRESULT {
...
pub const IDWriteFontFileEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn MoveNext(self: *const IDWriteFontFileEnumerator, hasCurrentFile: ?*BOOL) HRESULT {
        return self.vtable.MoveNext(self, hasCurrentFile);
    }
    pub inline fn GetCurrentFontFile(self: *const IDWriteFontFileEnumerator, fontFile: **IDWriteFontFile) HRESULT {
...
pub const IDWriteLocalizedStrings = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCount(self: *const IDWriteLocalizedStrings) u32 {
        return self.vtable.GetCount(self);
    }
    pub inline fn FindLocaleName(self: *const IDWriteLocalizedStrings, localeName: ?[*:0]const u16, index: ?*u32, exists: ?*BOOL) HRESULT {
        return self.vtable.FindLocaleName(self, localeName, index, exists);
    }
    pub inline fn GetLocaleNameLength(self: *const IDWriteLocalizedStrings, index: u32, length: ?*u32) HRESULT {
        return self.vtable.GetLocaleNameLength(self, index, length);
    }
    pub inline fn GetLocaleName(self: *const IDWriteLocalizedStrings, index: u32, localeName: [*:0]u16, size: u32) HRESULT {
        return self.vtable.GetLocaleName(self, index, localeName, size);
    }
    pub inline fn GetStringLength(self: *const IDWriteLocalizedStrings, index: u32, length: ?*u32) HRESULT {
        return self.vtable.GetStringLength(self, index, length);
    }
    pub inline fn GetString(self: *const IDWriteLocalizedStrings, index: u32, stringBuffer: [*:0]u16, size: u32) HRESULT {
...
pub const IDWriteFontCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFontFamilyCount(self: *const IDWriteFontCollection) u32 {
        return self.vtable.GetFontFamilyCount(self);
    }
    pub inline fn GetFontFamily(self: *const IDWriteFontCollection, index: u32, fontFamily: **IDWriteFontFamily) HRESULT {
        return self.vtable.GetFontFamily(self, index, fontFamily);
    }
    pub inline fn FindFamilyName(self: *const IDWriteFontCollection, familyName: ?[*:0]const u16, index: ?*u32, exists: ?*BOOL) HRESULT {
        return self.vtable.FindFamilyName(self, familyName, index, exists);
    }
    pub inline fn GetFontFromFontFace(self: *const IDWriteFontCollection, fontFace: ?*IDWriteFontFace, font: **IDWriteFont) HRESULT {
...
pub const IDWriteFontList = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFontCollection(self: *const IDWriteFontList, fontCollection: **IDWriteFontCollection) HRESULT {
        return self.vtable.GetFontCollection(self, fontCollection);
    }
    pub inline fn GetFontCount(self: *const IDWriteFontList) u32 {
        return self.vtable.GetFontCount(self);
    }
    pub inline fn GetFont(self: *const IDWriteFontList, index: u32, font: **IDWriteFont) HRESULT {
...
pub const IDWriteFontFamily = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetFamilyNames(self: *const IDWriteFontFamily, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetFamilyNames(self, names);
    }
    pub inline fn GetFirstMatchingFont(self: *const IDWriteFontFamily, weight: DWRITE_FONT_WEIGHT, stretch: DWRITE_FONT_STRETCH, style: DWRITE_FONT_STYLE, matchingFont: **IDWriteFont) HRESULT {
        return self.vtable.GetFirstMatchingFont(self, weight, stretch, style, matchingFont);
    }
    pub inline fn GetMatchingFonts(self: *const IDWriteFontFamily, weight: DWRITE_FONT_WEIGHT, stretch: DWRITE_FONT_STRETCH, style: DWRITE_FONT_STYLE, matchingFonts: **IDWriteFontList) HRESULT {
...
pub const IDWriteFont = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFontFamily(self: *const IDWriteFont, fontFamily: **IDWriteFontFamily) HRESULT {
        return self.vtable.GetFontFamily(self, fontFamily);
    }
    pub inline fn GetWeight(self: *const IDWriteFont) DWRITE_FONT_WEIGHT {
        return self.vtable.GetWeight(self);
    }
    pub inline fn GetStretch(self: *const IDWriteFont) DWRITE_FONT_STRETCH {
        return self.vtable.GetStretch(self);
    }
    pub inline fn GetStyle(self: *const IDWriteFont) DWRITE_FONT_STYLE {
        return self.vtable.GetStyle(self);
    }
    pub inline fn IsSymbolFont(self: *const IDWriteFont) BOOL {
        return self.vtable.IsSymbolFont(self);
    }
    pub inline fn GetFaceNames(self: *const IDWriteFont, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetFaceNames(self, names);
    }
    pub inline fn GetInformationalStrings(self: *const IDWriteFont, informationalStringID: DWRITE_INFORMATIONAL_STRING_ID, informationalStrings: ?**IDWriteLocalizedStrings, exists: ?*BOOL) HRESULT {
        return self.vtable.GetInformationalStrings(self, informationalStringID, informationalStrings, exists);
    }
    pub inline fn GetSimulations(self: *const IDWriteFont) DWRITE_FONT_SIMULATIONS {
        return self.vtable.GetSimulations(self);
    }
    pub inline fn GetMetrics(self: *const IDWriteFont, fontMetrics: ?*DWRITE_FONT_METRICS) void {
        return self.vtable.GetMetrics(self, fontMetrics);
    }
    pub inline fn HasCharacter(self: *const IDWriteFont, unicodeValue: u32, exists: ?*BOOL) HRESULT {
        return self.vtable.HasCharacter(self, unicodeValue, exists);
    }
    pub inline fn CreateFontFace(self: *const IDWriteFont, fontFace: **IDWriteFontFace) HRESULT {
...
pub const IDWriteTextFormat = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetTextAlignment(self: *const IDWriteTextFormat, textAlignment: DWRITE_TEXT_ALIGNMENT) HRESULT {
        return self.vtable.SetTextAlignment(self, textAlignment);
    }
    pub inline fn SetParagraphAlignment(self: *const IDWriteTextFormat, paragraphAlignment: DWRITE_PARAGRAPH_ALIGNMENT) HRESULT {
        return self.vtable.SetParagraphAlignment(self, paragraphAlignment);
    }
    pub inline fn SetWordWrapping(self: *const IDWriteTextFormat, wordWrapping: DWRITE_WORD_WRAPPING) HRESULT {
        return self.vtable.SetWordWrapping(self, wordWrapping);
    }
    pub inline fn SetReadingDirection(self: *const IDWriteTextFormat, readingDirection: DWRITE_READING_DIRECTION) HRESULT {
        return self.vtable.SetReadingDirection(self, readingDirection);
    }
    pub inline fn SetFlowDirection(self: *const IDWriteTextFormat, flowDirection: DWRITE_FLOW_DIRECTION) HRESULT {
        return self.vtable.SetFlowDirection(self, flowDirection);
    }
    pub inline fn SetIncrementalTabStop(self: *const IDWriteTextFormat, incrementalTabStop: f32) HRESULT {
        return self.vtable.SetIncrementalTabStop(self, incrementalTabStop);
    }
    pub inline fn SetTrimming(self: *const IDWriteTextFormat, trimmingOptions: ?*const DWRITE_TRIMMING, trimmingSign: ?*IDWriteInlineObject) HRESULT {
        return self.vtable.SetTrimming(self, trimmingOptions, trimmingSign);
    }
    pub inline fn SetLineSpacing(self: *const IDWriteTextFormat, lineSpacingMethod: DWRITE_LINE_SPACING_METHOD, lineSpacing: f32, baseline: f32) HRESULT {
        return self.vtable.SetLineSpacing(self, lineSpacingMethod, lineSpacing, baseline);
    }
    pub inline fn GetTextAlignment(self: *const IDWriteTextFormat) DWRITE_TEXT_ALIGNMENT {
        return self.vtable.GetTextAlignment(self);
    }
    pub inline fn GetParagraphAlignment(self: *const IDWriteTextFormat) DWRITE_PARAGRAPH_ALIGNMENT {
        return self.vtable.GetParagraphAlignment(self);
    }
    pub inline fn GetWordWrapping(self: *const IDWriteTextFormat) DWRITE_WORD_WRAPPING {
        return self.vtable.GetWordWrapping(self);
    }
    pub inline fn GetReadingDirection(self: *const IDWriteTextFormat) DWRITE_READING_DIRECTION {
        return self.vtable.GetReadingDirection(self);
    }
    pub inline fn GetFlowDirection(self: *const IDWriteTextFormat) DWRITE_FLOW_DIRECTION {
        return self.vtable.GetFlowDirection(self);
    }
    pub inline fn GetIncrementalTabStop(self: *const IDWriteTextFormat) f32 {
        return self.vtable.GetIncrementalTabStop(self);
    }
    pub inline fn GetTrimming(self: *const IDWriteTextFormat, trimmingOptions: ?*DWRITE_TRIMMING, trimmingSign: **IDWriteInlineObject) HRESULT {
        return self.vtable.GetTrimming(self, trimmingOptions, trimmingSign);
    }
    pub inline fn GetLineSpacing(self: *const IDWriteTextFormat, lineSpacingMethod: ?*DWRITE_LINE_SPACING_METHOD, lineSpacing: ?*f32, baseline: ?*f32) HRESULT {
        return self.vtable.GetLineSpacing(self, lineSpacingMethod, lineSpacing, baseline);
    }
    pub inline fn GetFontCollection(self: *const IDWriteTextFormat, fontCollection: **IDWriteFontCollection) HRESULT {
        return self.vtable.GetFontCollection(self, fontCollection);
    }
    pub inline fn GetFontFamilyNameLength(self: *const IDWriteTextFormat) u32 {
        return self.vtable.GetFontFamilyNameLength(self);
    }
    pub inline fn GetFontFamilyName(self: *const IDWriteTextFormat, fontFamilyName: [*:0]u16, nameSize: u32) HRESULT {
        return self.vtable.GetFontFamilyName(self, fontFamilyName, nameSize);
    }
    pub inline fn GetFontWeight(self: *const IDWriteTextFormat) DWRITE_FONT_WEIGHT {
        return self.vtable.GetFontWeight(self);
    }
    pub inline fn GetFontStyle(self: *const IDWriteTextFormat) DWRITE_FONT_STYLE {
        return self.vtable.GetFontStyle(self);
    }
    pub inline fn GetFontStretch(self: *const IDWriteTextFormat) DWRITE_FONT_STRETCH {
        return self.vtable.GetFontStretch(self);
    }
    pub inline fn GetFontSize(self: *const IDWriteTextFormat) f32 {
        return self.vtable.GetFontSize(self);
    }
    pub inline fn GetLocaleNameLength(self: *const IDWriteTextFormat) u32 {
        return self.vtable.GetLocaleNameLength(self);
    }
    pub inline fn GetLocaleName(self: *const IDWriteTextFormat, localeName: [*:0]u16, nameSize: u32) HRESULT {
...
pub const IDWriteTypography = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddFontFeature(self: *const IDWriteTypography, fontFeature: DWRITE_FONT_FEATURE) HRESULT {
        return self.vtable.AddFontFeature(self, fontFeature);
    }
    pub inline fn GetFontFeatureCount(self: *const IDWriteTypography) u32 {
        return self.vtable.GetFontFeatureCount(self);
    }
    pub inline fn GetFontFeature(self: *const IDWriteTypography, fontFeatureIndex: u32, fontFeature: ?*DWRITE_FONT_FEATURE) HRESULT {
...
pub const IDWriteTextAnalysisSource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetTextAtPosition(self: *const IDWriteTextAnalysisSource, textPosition: u32, textString: ?*const ?*u16, textLength: ?*u32) HRESULT {
        return self.vtable.GetTextAtPosition(self, textPosition, textString, textLength);
    }
    pub inline fn GetTextBeforePosition(self: *const IDWriteTextAnalysisSource, textPosition: u32, textString: ?*const ?*u16, textLength: ?*u32) HRESULT {
        return self.vtable.GetTextBeforePosition(self, textPosition, textString, textLength);
    }
    pub inline fn GetParagraphReadingDirection(self: *const IDWriteTextAnalysisSource) DWRITE_READING_DIRECTION {
        return self.vtable.GetParagraphReadingDirection(self);
    }
    pub inline fn GetLocaleName(self: *const IDWriteTextAnalysisSource, textPosition: u32, textLength: ?*u32, localeName: ?*const ?*u16) HRESULT {
        return self.vtable.GetLocaleName(self, textPosition, textLength, localeName);
    }
    pub inline fn GetNumberSubstitution(self: *const IDWriteTextAnalysisSource, textPosition: u32, textLength: ?*u32, numberSubstitution: **IDWriteNumberSubstitution) HRESULT {
...
pub const IDWriteTextAnalysisSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetScriptAnalysis(self: *const IDWriteTextAnalysisSink, textPosition: u32, textLength: u32, scriptAnalysis: ?*const DWRITE_SCRIPT_ANALYSIS) HRESULT {
        return self.vtable.SetScriptAnalysis(self, textPosition, textLength, scriptAnalysis);
    }
    pub inline fn SetLineBreakpoints(self: *const IDWriteTextAnalysisSink, textPosition: u32, textLength: u32, lineBreakpoints: [*]const DWRITE_LINE_BREAKPOINT) HRESULT {
        return self.vtable.SetLineBreakpoints(self, textPosition, textLength, lineBreakpoints);
    }
    pub inline fn SetBidiLevel(self: *const IDWriteTextAnalysisSink, textPosition: u32, textLength: u32, explicitLevel: u8, resolvedLevel: u8) HRESULT {
        return self.vtable.SetBidiLevel(self, textPosition, textLength, explicitLevel, resolvedLevel);
    }
    pub inline fn SetNumberSubstitution(self: *const IDWriteTextAnalysisSink, textPosition: u32, textLength: u32, numberSubstitution: ?*IDWriteNumberSubstitution) HRESULT {
...
pub const IDWriteTextAnalyzer = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AnalyzeScript(self: *const IDWriteTextAnalyzer, analysisSource: ?*IDWriteTextAnalysisSource, textPosition: u32, textLength: u32, analysisSink: ?*IDWriteTextAnalysisSink) HRESULT {
        return self.vtable.AnalyzeScript(self, analysisSource, textPosition, textLength, analysisSink);
    }
    pub inline fn AnalyzeBidi(self: *const IDWriteTextAnalyzer, analysisSource: ?*IDWriteTextAnalysisSource, textPosition: u32, textLength: u32, analysisSink: ?*IDWriteTextAnalysisSink) HRESULT {
        return self.vtable.AnalyzeBidi(self, analysisSource, textPosition, textLength, analysisSink);
    }
    pub inline fn AnalyzeNumberSubstitution(self: *const IDWriteTextAnalyzer, analysisSource: ?*IDWriteTextAnalysisSource, textPosition: u32, textLength: u32, analysisSink: ?*IDWriteTextAnalysisSink) HRESULT {
        return self.vtable.AnalyzeNumberSubstitution(self, analysisSource, textPosition, textLength, analysisSink);
    }
    pub inline fn AnalyzeLineBreakpoints(self: *const IDWriteTextAnalyzer, analysisSource: ?*IDWriteTextAnalysisSource, textPosition: u32, textLength: u32, analysisSink: ?*IDWriteTextAnalysisSink) HRESULT {
        return self.vtable.AnalyzeLineBreakpoints(self, analysisSource, textPosition, textLength, analysisSink);
    }
    pub inline fn GetGlyphs(self: *const IDWriteTextAnalyzer, textString: [*:0]const u16, textLength: u32, fontFace: ?*IDWriteFontFace, isSideways: BOOL, isRightToLeft: BOOL, scriptAnalysis: ?*const DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]const u16, numberSubstitution: ?*IDWriteNumberSubstitution, features: ?[*]const ?*const DWRITE_TYPOGRAPHIC_FEATURES, featureRangeLengths: ?[*]const u32, featureRanges: u32, maxGlyphCount: u32, clusterMap: [*:0]u16, textProps: [*]DWRITE_SHAPING_TEXT_PROPERTIES, glyphIndices: [*:0]u16, glyphProps: [*]DWRITE_SHAPING_GLYPH_PROPERTIES, actualGlyphCount: ?*u32) HRESULT {
...
pub const IDWriteInlineObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Draw(self: *const IDWriteInlineObject, clientDrawingContext: ?*anyopaque, renderer: ?*IDWriteTextRenderer, originX: f32, originY: f32, isSideways: BOOL, isRightToLeft: BOOL, clientDrawingEffect: ?*IUnknown) HRESULT {
        return self.vtable.Draw(self, clientDrawingContext, renderer, originX, originY, isSideways, isRightToLeft, clientDrawingEffect);
    }
    pub inline fn GetMetrics(self: *const IDWriteInlineObject, metrics: ?*DWRITE_INLINE_OBJECT_METRICS) HRESULT {
        return self.vtable.GetMetrics(self, metrics);
    }
    pub inline fn GetOverhangMetrics(self: *const IDWriteInlineObject, overhangs: ?*DWRITE_OVERHANG_METRICS) HRESULT {
        return self.vtable.GetOverhangMetrics(self, overhangs);
    }
    pub inline fn GetBreakConditions(self: *const IDWriteInlineObject, breakConditionBefore: ?*DWRITE_BREAK_CONDITION, breakConditionAfter: ?*DWRITE_BREAK_CONDITION) HRESULT {
...
pub const IDWritePixelSnapping = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsPixelSnappingDisabled(self: *const IDWritePixelSnapping, clientDrawingContext: ?*anyopaque, isDisabled: ?*BOOL) HRESULT {
        return self.vtable.IsPixelSnappingDisabled(self, clientDrawingContext, isDisabled);
    }
    pub inline fn GetCurrentTransform(self: *const IDWritePixelSnapping, clientDrawingContext: ?*anyopaque, transform: ?*DWRITE_MATRIX) HRESULT {
        return self.vtable.GetCurrentTransform(self, clientDrawingContext, transform);
    }
    pub inline fn GetPixelsPerDip(self: *const IDWritePixelSnapping, clientDrawingContext: ?*anyopaque, pixelsPerDip: ?*f32) HRESULT {
...
pub const IDWriteTextRenderer = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn DrawGlyphRun(self: *const IDWriteTextRenderer, clientDrawingContext: ?*anyopaque, baselineOriginX: f32, baselineOriginY: f32, measuringMode: DWRITE_MEASURING_MODE, glyphRun: ?*const DWRITE_GLYPH_RUN, glyphRunDescription: ?*const DWRITE_GLYPH_RUN_DESCRIPTION, clientDrawingEffect: ?*IUnknown) HRESULT {
    ...
    pub inline fn DrawUnderline(self: *const IDWriteTextRenderer, clientDrawingContext: ?*anyopaque, baselineOriginX: f32, baselineOriginY: f32, underline: ?*const DWRITE_UNDERLINE, clientDrawingEffect: ?*IUnknown) HRESULT {
        return self.vtable.DrawUnderline(self, clientDrawingContext, baselineOriginX, baselineOriginY, underline, clientDrawingEffect);
    }
    pub inline fn DrawStrikethrough(self: *const IDWriteTextRenderer, clientDrawingContext: ?*anyopaque, baselineOriginX: f32, baselineOriginY: f32, strikethrough: ?*const DWRITE_STRIKETHROUGH, clientDrawingEffect: ?*IUnknown) HRESULT {
    ...
    pub inline fn DrawInlineObject(self: *const IDWriteTextRenderer, clientDrawingContext: ?*anyopaque, originX: f32, originY: f32, inlineObject: ?*IDWriteInlineObject, isSideways: BOOL, isRightToLeft: BOOL, clientDrawingEffect: ?*IUnknown) HRESULT {
...
pub const IDWriteTextLayout = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetMaxWidth(self: *const IDWriteTextLayout, maxWidth: f32) HRESULT {
        return self.vtable.SetMaxWidth(self, maxWidth);
    }
    pub inline fn SetMaxHeight(self: *const IDWriteTextLayout, maxHeight: f32) HRESULT {
        return self.vtable.SetMaxHeight(self, maxHeight);
    }
    pub inline fn SetFontCollection(self: *const IDWriteTextLayout, fontCollection: ?*IDWriteFontCollection, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontCollection(self, fontCollection, textRange);
    }
    pub inline fn SetFontFamilyName(self: *const IDWriteTextLayout, fontFamilyName: ?[*:0]const u16, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontFamilyName(self, fontFamilyName, textRange);
    }
    pub inline fn SetFontWeight(self: *const IDWriteTextLayout, fontWeight: DWRITE_FONT_WEIGHT, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontWeight(self, fontWeight, textRange);
    }
    pub inline fn SetFontStyle(self: *const IDWriteTextLayout, fontStyle: DWRITE_FONT_STYLE, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontStyle(self, fontStyle, textRange);
    }
    pub inline fn SetFontStretch(self: *const IDWriteTextLayout, fontStretch: DWRITE_FONT_STRETCH, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontStretch(self, fontStretch, textRange);
    }
    pub inline fn SetFontSize(self: *const IDWriteTextLayout, fontSize: f32, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontSize(self, fontSize, textRange);
    }
    pub inline fn SetUnderline(self: *const IDWriteTextLayout, hasUnderline: BOOL, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetUnderline(self, hasUnderline, textRange);
    }
    pub inline fn SetStrikethrough(self: *const IDWriteTextLayout, hasStrikethrough: BOOL, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetStrikethrough(self, hasStrikethrough, textRange);
    }
    pub inline fn SetDrawingEffect(self: *const IDWriteTextLayout, drawingEffect: ?*IUnknown, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetDrawingEffect(self, drawingEffect, textRange);
    }
    pub inline fn SetInlineObject(self: *const IDWriteTextLayout, inlineObject: ?*IDWriteInlineObject, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetInlineObject(self, inlineObject, textRange);
    }
    pub inline fn SetTypography(self: *const IDWriteTextLayout, typography: ?*IDWriteTypography, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetTypography(self, typography, textRange);
    }
    pub inline fn SetLocaleName(self: *const IDWriteTextLayout, localeName: ?[*:0]const u16, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetLocaleName(self, localeName, textRange);
    }
    pub inline fn GetMaxWidth(self: *const IDWriteTextLayout) f32 {
        return self.vtable.GetMaxWidth(self);
    }
    pub inline fn GetMaxHeight(self: *const IDWriteTextLayout) f32 {
        return self.vtable.GetMaxHeight(self);
    }
    pub inline fn GetFontCollection(self: *const IDWriteTextLayout, currentPosition: u32, fontCollection: **IDWriteFontCollection, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontCollection(self, currentPosition, fontCollection, textRange);
    }
    pub inline fn GetFontFamilyNameLength(self: *const IDWriteTextLayout, currentPosition: u32, nameLength: ?*u32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontFamilyNameLength(self, currentPosition, nameLength, textRange);
    }
    pub inline fn GetFontFamilyName(self: *const IDWriteTextLayout, currentPosition: u32, fontFamilyName: [*:0]u16, nameSize: u32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontFamilyName(self, currentPosition, fontFamilyName, nameSize, textRange);
    }
    pub inline fn GetFontWeight(self: *const IDWriteTextLayout, currentPosition: u32, fontWeight: ?*DWRITE_FONT_WEIGHT, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontWeight(self, currentPosition, fontWeight, textRange);
    }
    pub inline fn GetFontStyle(self: *const IDWriteTextLayout, currentPosition: u32, fontStyle: ?*DWRITE_FONT_STYLE, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontStyle(self, currentPosition, fontStyle, textRange);
    }
    pub inline fn GetFontStretch(self: *const IDWriteTextLayout, currentPosition: u32, fontStretch: ?*DWRITE_FONT_STRETCH, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontStretch(self, currentPosition, fontStretch, textRange);
    }
    pub inline fn GetFontSize(self: *const IDWriteTextLayout, currentPosition: u32, fontSize: ?*f32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontSize(self, currentPosition, fontSize, textRange);
    }
    pub inline fn GetUnderline(self: *const IDWriteTextLayout, currentPosition: u32, hasUnderline: ?*BOOL, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetUnderline(self, currentPosition, hasUnderline, textRange);
    }
    pub inline fn GetStrikethrough(self: *const IDWriteTextLayout, currentPosition: u32, hasStrikethrough: ?*BOOL, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetStrikethrough(self, currentPosition, hasStrikethrough, textRange);
    }
    pub inline fn GetDrawingEffect(self: *const IDWriteTextLayout, currentPosition: u32, drawingEffect: **IUnknown, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetDrawingEffect(self, currentPosition, drawingEffect, textRange);
    }
    pub inline fn GetInlineObject(self: *const IDWriteTextLayout, currentPosition: u32, inlineObject: **IDWriteInlineObject, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetInlineObject(self, currentPosition, inlineObject, textRange);
    }
    pub inline fn GetTypography(self: *const IDWriteTextLayout, currentPosition: u32, typography: **IDWriteTypography, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetTypography(self, currentPosition, typography, textRange);
    }
    pub inline fn GetLocaleNameLength(self: *const IDWriteTextLayout, currentPosition: u32, nameLength: ?*u32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetLocaleNameLength(self, currentPosition, nameLength, textRange);
    }
    pub inline fn GetLocaleName(self: *const IDWriteTextLayout, currentPosition: u32, localeName: [*:0]u16, nameSize: u32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetLocaleName(self, currentPosition, localeName, nameSize, textRange);
    }
    pub inline fn Draw(self: *const IDWriteTextLayout, clientDrawingContext: ?*anyopaque, renderer: ?*IDWriteTextRenderer, originX: f32, originY: f32) HRESULT {
        return self.vtable.Draw(self, clientDrawingContext, renderer, originX, originY);
    }
    pub inline fn GetLineMetrics(self: *const IDWriteTextLayout, lineMetrics: ?[*]DWRITE_LINE_METRICS, maxLineCount: u32, actualLineCount: ?*u32) HRESULT {
        return self.vtable.GetLineMetrics(self, lineMetrics, maxLineCount, actualLineCount);
    }
    pub inline fn GetMetrics(self: *const IDWriteTextLayout, textMetrics: ?*DWRITE_TEXT_METRICS) HRESULT {
        return self.vtable.GetMetrics(self, textMetrics);
    }
    pub inline fn GetOverhangMetrics(self: *const IDWriteTextLayout, overhangs: ?*DWRITE_OVERHANG_METRICS) HRESULT {
        return self.vtable.GetOverhangMetrics(self, overhangs);
    }
    pub inline fn GetClusterMetrics(self: *const IDWriteTextLayout, clusterMetrics: ?[*]DWRITE_CLUSTER_METRICS, maxClusterCount: u32, actualClusterCount: ?*u32) HRESULT {
        return self.vtable.GetClusterMetrics(self, clusterMetrics, maxClusterCount, actualClusterCount);
    }
    pub inline fn DetermineMinWidth(self: *const IDWriteTextLayout, minWidth: ?*f32) HRESULT {
        return self.vtable.DetermineMinWidth(self, minWidth);
    }
    pub inline fn HitTestPoint(self: *const IDWriteTextLayout, pointX: f32, pointY: f32, isTrailingHit: ?*BOOL, isInside: ?*BOOL, hitTestMetrics: ?*DWRITE_HIT_TEST_METRICS) HRESULT {
        return self.vtable.HitTestPoint(self, pointX, pointY, isTrailingHit, isInside, hitTestMetrics);
    }
    pub inline fn HitTestTextPosition(self: *const IDWriteTextLayout, textPosition: u32, isTrailingHit: BOOL, pointX: ?*f32, pointY: ?*f32, hitTestMetrics: ?*DWRITE_HIT_TEST_METRICS) HRESULT {
        return self.vtable.HitTestTextPosition(self, textPosition, isTrailingHit, pointX, pointY, hitTestMetrics);
    }
    pub inline fn HitTestTextRange(self: *const IDWriteTextLayout, textPosition: u32, textLength: u32, originX: f32, originY: f32, hitTestMetrics: ?[*]DWRITE_HIT_TEST_METRICS, maxHitTestMetricsCount: u32, actualHitTestMetricsCount: ?*u32) HRESULT {
...
pub const IDWriteBitmapRenderTarget = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DrawGlyphRun(self: *const IDWriteBitmapRenderTarget, baselineOriginX: f32, baselineOriginY: f32, measuringMode: DWRITE_MEASURING_MODE, glyphRun: ?*const DWRITE_GLYPH_RUN, renderingParams: ?*IDWriteRenderingParams, textColor: u32, blackBoxRect: ?*RECT) HRESULT {
    ...
    pub inline fn GetMemoryDC(self: *const IDWriteBitmapRenderTarget) ?HDC {
        return self.vtable.GetMemoryDC(self);
    }
    pub inline fn GetPixelsPerDip(self: *const IDWriteBitmapRenderTarget) f32 {
        return self.vtable.GetPixelsPerDip(self);
    }
    pub inline fn SetPixelsPerDip(self: *const IDWriteBitmapRenderTarget, pixelsPerDip: f32) HRESULT {
        return self.vtable.SetPixelsPerDip(self, pixelsPerDip);
    }
    pub inline fn GetCurrentTransform(self: *const IDWriteBitmapRenderTarget, transform: ?*DWRITE_MATRIX) HRESULT {
        return self.vtable.GetCurrentTransform(self, transform);
    }
    pub inline fn SetCurrentTransform(self: *const IDWriteBitmapRenderTarget, transform: ?*const DWRITE_MATRIX) HRESULT {
        return self.vtable.SetCurrentTransform(self, transform);
    }
    pub inline fn GetSize(self: *const IDWriteBitmapRenderTarget, size: ?*SIZE) HRESULT {
        return self.vtable.GetSize(self, size);
    }
    pub inline fn Resize(self: *const IDWriteBitmapRenderTarget, width: u32, height: u32) HRESULT {
...
pub const IDWriteGdiInterop = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateFontFromLOGFONT(self: *const IDWriteGdiInterop, logFont: ?*const LOGFONTW, font: **IDWriteFont) HRESULT {
        return self.vtable.CreateFontFromLOGFONT(self, logFont, font);
    }
    pub inline fn ConvertFontToLOGFONT(self: *const IDWriteGdiInterop, font: ?*IDWriteFont, logFont: ?*LOGFONTW, isSystemFont: ?*BOOL) HRESULT {
        return self.vtable.ConvertFontToLOGFONT(self, font, logFont, isSystemFont);
    }
    pub inline fn ConvertFontFaceToLOGFONT(self: *const IDWriteGdiInterop, font: ?*IDWriteFontFace, logFont: ?*LOGFONTW) HRESULT {
        return self.vtable.ConvertFontFaceToLOGFONT(self, font, logFont);
    }
    pub inline fn CreateFontFaceFromHdc(self: *const IDWriteGdiInterop, hdc: ?HDC, fontFace: **IDWriteFontFace) HRESULT {
        return self.vtable.CreateFontFaceFromHdc(self, hdc, fontFace);
    }
    pub inline fn CreateBitmapRenderTarget(self: *const IDWriteGdiInterop, hdc: ?HDC, width: u32, height: u32, renderTarget: **IDWriteBitmapRenderTarget) HRESULT {
...
pub const IDWriteGlyphRunAnalysis = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetAlphaTextureBounds(self: *const IDWriteGlyphRunAnalysis, textureType: DWRITE_TEXTURE_TYPE, textureBounds: ?*RECT) HRESULT {
        return self.vtable.GetAlphaTextureBounds(self, textureType, textureBounds);
    }
    pub inline fn CreateAlphaTexture(self: *const IDWriteGlyphRunAnalysis, textureType: DWRITE_TEXTURE_TYPE, textureBounds: ?*const RECT, alphaValues: ?*u8, bufferSize: u32) HRESULT {
        return self.vtable.CreateAlphaTexture(self, textureType, textureBounds, alphaValues, bufferSize);
    }
    pub inline fn GetAlphaBlendParams(self: *const IDWriteGlyphRunAnalysis, renderingParams: ?*IDWriteRenderingParams, blendGamma: ?*f32, blendEnhancedContrast: ?*f32, blendClearTypeLevel: ?*f32) HRESULT {
...
pub const IDWriteFactory = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSystemFontCollection(self: *const IDWriteFactory, fontCollection: **IDWriteFontCollection, checkForUpdates: BOOL) HRESULT {
        return self.vtable.GetSystemFontCollection(self, fontCollection, checkForUpdates);
    }
    pub inline fn CreateCustomFontCollection(self: *const IDWriteFactory, collectionLoader: ?*IDWriteFontCollectionLoader, collectionKey: ?*const anyopaque, collectionKeySize: u32, fontCollection: **IDWriteFontCollection) HRESULT {
        return self.vtable.CreateCustomFontCollection(self, collectionLoader, collectionKey, collectionKeySize, fontCollection);
    }
    pub inline fn RegisterFontCollectionLoader(self: *const IDWriteFactory, fontCollectionLoader: ?*IDWriteFontCollectionLoader) HRESULT {
        return self.vtable.RegisterFontCollectionLoader(self, fontCollectionLoader);
    }
    pub inline fn UnregisterFontCollectionLoader(self: *const IDWriteFactory, fontCollectionLoader: ?*IDWriteFontCollectionLoader) HRESULT {
        return self.vtable.UnregisterFontCollectionLoader(self, fontCollectionLoader);
    }
    pub inline fn CreateFontFileReference(self: *const IDWriteFactory, filePath: ?[*:0]const u16, lastWriteTime: ?*const FILETIME, fontFile: **IDWriteFontFile) HRESULT {
        return self.vtable.CreateFontFileReference(self, filePath, lastWriteTime, fontFile);
    }
    pub inline fn CreateCustomFontFileReference(self: *const IDWriteFactory, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, fontFileLoader: ?*IDWriteFontFileLoader, fontFile: **IDWriteFontFile) HRESULT {
    ...
    pub inline fn CreateFontFace(self: *const IDWriteFactory, fontFaceType: DWRITE_FONT_FACE_TYPE, numberOfFiles: u32, fontFiles: [*]?*IDWriteFontFile, faceIndex: u32, fontFaceSimulationFlags: DWRITE_FONT_SIMULATIONS, fontFace: **IDWriteFontFace) HRESULT {
        return self.vtable.CreateFontFace(self, fontFaceType, numberOfFiles, fontFiles, faceIndex, fontFaceSimulationFlags, fontFace);
    }
    pub inline fn CreateRenderingParams(self: *const IDWriteFactory, renderingParams: **IDWriteRenderingParams) HRESULT {
        return self.vtable.CreateRenderingParams(self, renderingParams);
    }
    pub inline fn CreateMonitorRenderingParams(self: *const IDWriteFactory, monitor: ?HMONITOR, renderingParams: **IDWriteRenderingParams) HRESULT {
        return self.vtable.CreateMonitorRenderingParams(self, monitor, renderingParams);
    }
    pub inline fn CreateCustomRenderingParams(self: *const IDWriteFactory, gamma: f32, enhancedContrast: f32, clearTypeLevel: f32, pixelGeometry: DWRITE_PIXEL_GEOMETRY, renderingMode: DWRITE_RENDERING_MODE, renderingParams: **IDWriteRenderingParams) HRESULT {
    ...
    pub inline fn RegisterFontFileLoader(self: *const IDWriteFactory, fontFileLoader: ?*IDWriteFontFileLoader) HRESULT {
        return self.vtable.RegisterFontFileLoader(self, fontFileLoader);
    }
    pub inline fn UnregisterFontFileLoader(self: *const IDWriteFactory, fontFileLoader: ?*IDWriteFontFileLoader) HRESULT {
        return self.vtable.UnregisterFontFileLoader(self, fontFileLoader);
    }
    pub inline fn CreateTextFormat(self: *const IDWriteFactory, fontFamilyName: ?[*:0]const u16, fontCollection: ?*IDWriteFontCollection, fontWeight: DWRITE_FONT_WEIGHT, fontStyle: DWRITE_FONT_STYLE, fontStretch: DWRITE_FONT_STRETCH, fontSize: f32, localeName: ?[*:0]const u16, textFormat: **IDWriteTextFormat) HRESULT {
    ...
    pub inline fn CreateTypography(self: *const IDWriteFactory, typography: **IDWriteTypography) HRESULT {
        return self.vtable.CreateTypography(self, typography);
    }
    pub inline fn GetGdiInterop(self: *const IDWriteFactory, gdiInterop: **IDWriteGdiInterop) HRESULT {
        return self.vtable.GetGdiInterop(self, gdiInterop);
    }
    pub inline fn CreateTextLayout(self: *const IDWriteFactory, string: [*:0]const u16, stringLength: u32, textFormat: ?*IDWriteTextFormat, maxWidth: f32, maxHeight: f32, textLayout: **IDWriteTextLayout) HRESULT {
        return self.vtable.CreateTextLayout(self, string, stringLength, textFormat, maxWidth, maxHeight, textLayout);
    }
    pub inline fn CreateGdiCompatibleTextLayout(self: *const IDWriteFactory, string: [*:0]const u16, stringLength: u32, textFormat: ?*IDWriteTextFormat, layoutWidth: f32, layoutHeight: f32, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, useGdiNatural: BOOL, textLayout: **IDWriteTextLayout) HRESULT {
    ...
    pub inline fn CreateEllipsisTrimmingSign(self: *const IDWriteFactory, textFormat: ?*IDWriteTextFormat, trimmingSign: **IDWriteInlineObject) HRESULT {
        return self.vtable.CreateEllipsisTrimmingSign(self, textFormat, trimmingSign);
    }
    pub inline fn CreateTextAnalyzer(self: *const IDWriteFactory, textAnalyzer: **IDWriteTextAnalyzer) HRESULT {
        return self.vtable.CreateTextAnalyzer(self, textAnalyzer);
    }
    pub inline fn CreateNumberSubstitution(self: *const IDWriteFactory, substitutionMethod: DWRITE_NUMBER_SUBSTITUTION_METHOD, localeName: ?[*:0]const u16, ignoreUserOverride: BOOL, numberSubstitution: **IDWriteNumberSubstitution) HRESULT {
        return self.vtable.CreateNumberSubstitution(self, substitutionMethod, localeName, ignoreUserOverride, numberSubstitution);
    }
    pub inline fn CreateGlyphRunAnalysis(self: *const IDWriteFactory, glyphRun: ?*const DWRITE_GLYPH_RUN, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, renderingMode: DWRITE_RENDERING_MODE, measuringMode: DWRITE_MEASURING_MODE, baselineOriginX: f32, baselineOriginY: f32, glyphRunAnalysis: **IDWriteGlyphRunAnalysis) HRESULT {
...
pub const IDWriteFactory1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetEudcFontCollection(self: *const IDWriteFactory1, fontCollection: **IDWriteFontCollection, checkForUpdates: BOOL) HRESULT {
        return self.vtable.GetEudcFontCollection(self, fontCollection, checkForUpdates);
    }
    pub inline fn CreateCustomRenderingParams(self: *const IDWriteFactory1, gamma: f32, enhancedContrast: f32, enhancedContrastGrayscale: f32, clearTypeLevel: f32, pixelGeometry: DWRITE_PIXEL_GEOMETRY, renderingMode: DWRITE_RENDERING_MODE, renderingParams: **IDWriteRenderingParams1) HRESULT {
...
pub const IDWriteFontFace1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetMetrics(self: *const IDWriteFontFace1, fontMetrics: ?*DWRITE_FONT_METRICS1) void {
        return self.vtable.GetMetrics(self, fontMetrics);
    }
    pub inline fn GetGdiCompatibleMetrics(self: *const IDWriteFontFace1, emSize: f32, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, fontMetrics: ?*DWRITE_FONT_METRICS1) HRESULT {
        return self.vtable.GetGdiCompatibleMetrics(self, emSize, pixelsPerDip, transform, fontMetrics);
    }
    pub inline fn GetCaretMetrics(self: *const IDWriteFontFace1, caretMetrics: ?*DWRITE_CARET_METRICS) void {
        return self.vtable.GetCaretMetrics(self, caretMetrics);
    }
    pub inline fn GetUnicodeRanges(self: *const IDWriteFontFace1, maxRangeCount: u32, unicodeRanges: ?[*]DWRITE_UNICODE_RANGE, actualRangeCount: ?*u32) HRESULT {
        return self.vtable.GetUnicodeRanges(self, maxRangeCount, unicodeRanges, actualRangeCount);
    }
    pub inline fn IsMonospacedFont(self: *const IDWriteFontFace1) BOOL {
        return self.vtable.IsMonospacedFont(self);
    }
    pub inline fn GetDesignGlyphAdvances(self: *const IDWriteFontFace1, glyphCount: u32, glyphIndices: [*:0]const u16, glyphAdvances: [*]i32, isSideways: BOOL) HRESULT {
        return self.vtable.GetDesignGlyphAdvances(self, glyphCount, glyphIndices, glyphAdvances, isSideways);
    }
    pub inline fn GetGdiCompatibleGlyphAdvances(self: *const IDWriteFontFace1, emSize: f32, pixelsPerDip: f32, transform: ?*const DWRITE_MATRIX, useGdiNatural: BOOL, isSideways: BOOL, glyphCount: u32, glyphIndices: [*:0]const u16, glyphAdvances: [*]i32) HRESULT {
    ...
    pub inline fn GetKerningPairAdjustments(self: *const IDWriteFontFace1, glyphCount: u32, glyphIndices: [*:0]const u16, glyphAdvanceAdjustments: [*]i32) HRESULT {
        return self.vtable.GetKerningPairAdjustments(self, glyphCount, glyphIndices, glyphAdvanceAdjustments);
    }
    pub inline fn HasKerningPairs(self: *const IDWriteFontFace1) BOOL {
        return self.vtable.HasKerningPairs(self);
    }
    pub inline fn GetRecommendedRenderingMode(self: *const IDWriteFontFace1, fontEmSize: f32, dpiX: f32, dpiY: f32, transform: ?*const DWRITE_MATRIX, isSideways: BOOL, outlineThreshold: DWRITE_OUTLINE_THRESHOLD, measuringMode: DWRITE_MEASURING_MODE, renderingMode: ?*DWRITE_RENDERING_MODE) HRESULT {
    ...
    pub inline fn GetVerticalGlyphVariants(self: *const IDWriteFontFace1, glyphCount: u32, nominalGlyphIndices: [*:0]const u16, verticalGlyphIndices: [*:0]u16) HRESULT {
        return self.vtable.GetVerticalGlyphVariants(self, glyphCount, nominalGlyphIndices, verticalGlyphIndices);
    }
    pub inline fn HasVerticalGlyphVariants(self: *const IDWriteFontFace1) BOOL {
...
pub const IDWriteFont1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetMetrics(self: *const IDWriteFont1, fontMetrics: ?*DWRITE_FONT_METRICS1) void {
        return self.vtable.GetMetrics(self, fontMetrics);
    }
    pub inline fn GetPanose(self: *const IDWriteFont1, panose: ?*DWRITE_PANOSE) void {
        return self.vtable.GetPanose(self, panose);
    }
    pub inline fn GetUnicodeRanges(self: *const IDWriteFont1, maxRangeCount: u32, unicodeRanges: ?[*]DWRITE_UNICODE_RANGE, actualRangeCount: ?*u32) HRESULT {
        return self.vtable.GetUnicodeRanges(self, maxRangeCount, unicodeRanges, actualRangeCount);
    }
    pub inline fn IsMonospacedFont(self: *const IDWriteFont1) BOOL {
        return self.vtable.IsMonospacedFont(self);
    }
};
...
pub const IDWriteRenderingParams1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetGrayscaleEnhancedContrast(self: *const IDWriteRenderingParams1) f32 {
...
pub const IDWriteTextAnalyzer1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn ApplyCharacterSpacing(self: *const IDWriteTextAnalyzer1, leadingSpacing: f32, trailingSpacing: f32, minimumAdvanceWidth: f32, textLength: u32, glyphCount: u32, clusterMap: [*:0]const u16, glyphAdvances: [*]const f32, glyphOffsets: [*]const DWRITE_GLYPH_OFFSET, glyphProperties: [*]const DWRITE_SHAPING_GLYPH_PROPERTIES, modifiedGlyphAdvances: [*]f32, modifiedGlyphOffsets: [*]DWRITE_GLYPH_OFFSET) HRESULT {
    ...
    pub inline fn GetBaseline(self: *const IDWriteTextAnalyzer1, fontFace: ?*IDWriteFontFace, baseline: DWRITE_BASELINE, isVertical: BOOL, isSimulationAllowed: BOOL, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]const u16, baselineCoordinate: ?*i32, exists: ?*BOOL) HRESULT {
    ...
    pub inline fn AnalyzeVerticalGlyphOrientation(self: *const IDWriteTextAnalyzer1, analysisSource: ?*IDWriteTextAnalysisSource1, textPosition: u32, textLength: u32, analysisSink: ?*IDWriteTextAnalysisSink1) HRESULT {
        return self.vtable.AnalyzeVerticalGlyphOrientation(self, analysisSource, textPosition, textLength, analysisSink);
    }
    pub inline fn GetGlyphOrientationTransform(self: *const IDWriteTextAnalyzer1, glyphOrientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, isSideways: BOOL, transform: ?*DWRITE_MATRIX) HRESULT {
        return self.vtable.GetGlyphOrientationTransform(self, glyphOrientationAngle, isSideways, transform);
    }
    pub inline fn GetScriptProperties(self: *const IDWriteTextAnalyzer1, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, scriptProperties: ?*DWRITE_SCRIPT_PROPERTIES) HRESULT {
        return self.vtable.GetScriptProperties(self, scriptAnalysis, scriptProperties);
    }
    pub inline fn GetTextComplexity(self: *const IDWriteTextAnalyzer1, textString: [*:0]const u16, textLength: u32, fontFace: ?*IDWriteFontFace, isTextSimple: ?*BOOL, textLengthRead: ?*u32, glyphIndices: ?[*:0]u16) HRESULT {
        return self.vtable.GetTextComplexity(self, textString, textLength, fontFace, isTextSimple, textLengthRead, glyphIndices);
    }
    pub inline fn GetJustificationOpportunities(self: *const IDWriteTextAnalyzer1, fontFace: ?*IDWriteFontFace, fontEmSize: f32, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, textLength: u32, glyphCount: u32, textString: [*:0]const u16, clusterMap: [*:0]const u16, glyphProperties: [*]const DWRITE_SHAPING_GLYPH_PROPERTIES, justificationOpportunities: [*]DWRITE_JUSTIFICATION_OPPORTUNITY) HRESULT {
    ...
    pub inline fn GetJustifiedGlyphs(self: *const IDWriteTextAnalyzer1, fontFace: ?*IDWriteFontFace, fontEmSize: f32, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, textLength: u32, glyphCount: u32, maxGlyphCount: u32, clusterMap: ?[*:0]const u16, glyphIndices: [*:0]const u16, glyphAdvances: [*]const f32, justifiedGlyphAdvances: [*]const f32, justifiedGlyphOffsets: [*]const DWRITE_GLYPH_OFFSET, glyphProperties: [*]const DWRITE_SHAPING_GLYPH_PROPERTIES, actualGlyphCount: ?*u32, modifiedClusterMap: ?[*:0]u16, modifiedGlyphIndices: [*:0]u16, modifiedGlyphAdvances: [*]f32, modifiedGlyphOffsets: [*]DWRITE_GLYPH_OFFSET) HRESULT {
...
pub const IDWriteTextAnalysisSource1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetVerticalGlyphOrientation(self: *const IDWriteTextAnalysisSource1, textPosition: u32, textLength: ?*u32, glyphOrientation: ?*DWRITE_VERTICAL_GLYPH_ORIENTATION, bidiLevel: ?*u8) HRESULT {
...
pub const IDWriteTextAnalysisSink1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetGlyphOrientation(self: *const IDWriteTextAnalysisSink1, textPosition: u32, textLength: u32, glyphOrientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, adjustedBidiLevel: u8, isSideways: BOOL, isRightToLeft: BOOL) HRESULT {
...
pub const IDWriteTextLayout1 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn SetPairKerning(self: *const IDWriteTextLayout1, isPairKerningEnabled: BOOL, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetPairKerning(self, isPairKerningEnabled, textRange);
    }
    pub inline fn GetPairKerning(self: *const IDWriteTextLayout1, currentPosition: u32, isPairKerningEnabled: ?*BOOL, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetPairKerning(self, currentPosition, isPairKerningEnabled, textRange);
    }
    pub inline fn SetCharacterSpacing(self: *const IDWriteTextLayout1, leadingSpacing: f32, trailingSpacing: f32, minimumAdvanceWidth: f32, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetCharacterSpacing(self, leadingSpacing, trailingSpacing, minimumAdvanceWidth, textRange);
    }
    pub inline fn GetCharacterSpacing(self: *const IDWriteTextLayout1, currentPosition: u32, leadingSpacing: ?*f32, trailingSpacing: ?*f32, minimumAdvanceWidth: ?*f32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
...
pub const IDWriteBitmapRenderTarget1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetTextAntialiasMode(self: *const IDWriteBitmapRenderTarget1) DWRITE_TEXT_ANTIALIAS_MODE {
        return self.vtable.GetTextAntialiasMode(self);
    }
    pub inline fn SetTextAntialiasMode(self: *const IDWriteBitmapRenderTarget1, antialiasMode: DWRITE_TEXT_ANTIALIAS_MODE) HRESULT {
...
pub const IDWriteTextRenderer1 = extern union {
    ...
    pub inline fn DrawUnderline(self: *const IDWriteTextRenderer1, clientDrawingContext: ?*anyopaque, baselineOriginX: f32, baselineOriginY: f32, orientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, underline: ?*const DWRITE_UNDERLINE, clientDrawingEffect: ?*IUnknown) HRESULT {
    ...
    pub inline fn DrawStrikethrough(self: *const IDWriteTextRenderer1, clientDrawingContext: ?*anyopaque, baselineOriginX: f32, baselineOriginY: f32, orientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, strikethrough: ?*const DWRITE_STRIKETHROUGH, clientDrawingEffect: ?*IUnknown) HRESULT {
    ...
    pub inline fn DrawInlineObject(self: *const IDWriteTextRenderer1, clientDrawingContext: ?*anyopaque, originX: f32, originY: f32, orientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, inlineObject: ?*IDWriteInlineObject, isSideways: BOOL, isRightToLeft: BOOL, clientDrawingEffect: ?*IUnknown) HRESULT {
...
pub const IDWriteTextFormat1 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn SetVerticalGlyphOrientation(self: *const IDWriteTextFormat1, glyphOrientation: DWRITE_VERTICAL_GLYPH_ORIENTATION) HRESULT {
        return self.vtable.SetVerticalGlyphOrientation(self, glyphOrientation);
    }
    pub inline fn GetVerticalGlyphOrientation(self: *const IDWriteTextFormat1) DWRITE_VERTICAL_GLYPH_ORIENTATION {
        return self.vtable.GetVerticalGlyphOrientation(self);
    }
    pub inline fn SetLastLineWrapping(self: *const IDWriteTextFormat1, isLastLineWrappingEnabled: BOOL) HRESULT {
        return self.vtable.SetLastLineWrapping(self, isLastLineWrappingEnabled);
    }
    pub inline fn GetLastLineWrapping(self: *const IDWriteTextFormat1) BOOL {
        return self.vtable.GetLastLineWrapping(self);
    }
    pub inline fn SetOpticalAlignment(self: *const IDWriteTextFormat1, opticalAlignment: DWRITE_OPTICAL_ALIGNMENT) HRESULT {
        return self.vtable.SetOpticalAlignment(self, opticalAlignment);
    }
    pub inline fn GetOpticalAlignment(self: *const IDWriteTextFormat1) DWRITE_OPTICAL_ALIGNMENT {
        return self.vtable.GetOpticalAlignment(self);
    }
    pub inline fn SetFontFallback(self: *const IDWriteTextFormat1, fontFallback: ?*IDWriteFontFallback) HRESULT {
        return self.vtable.SetFontFallback(self, fontFallback);
    }
    pub inline fn GetFontFallback(self: *const IDWriteTextFormat1, fontFallback: ?*?*IDWriteFontFallback) HRESULT {
...
pub const IDWriteTextLayout2 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn GetMetrics(self: *const IDWriteTextLayout2, textMetrics: ?*DWRITE_TEXT_METRICS1) HRESULT {
        return self.vtable.GetMetrics(self, textMetrics);
    }
    pub inline fn SetVerticalGlyphOrientation(self: *const IDWriteTextLayout2, glyphOrientation: DWRITE_VERTICAL_GLYPH_ORIENTATION) HRESULT {
        return self.vtable.SetVerticalGlyphOrientation(self, glyphOrientation);
    }
    pub inline fn GetVerticalGlyphOrientation(self: *const IDWriteTextLayout2) DWRITE_VERTICAL_GLYPH_ORIENTATION {
        return self.vtable.GetVerticalGlyphOrientation(self);
    }
    pub inline fn SetLastLineWrapping(self: *const IDWriteTextLayout2, isLastLineWrappingEnabled: BOOL) HRESULT {
        return self.vtable.SetLastLineWrapping(self, isLastLineWrappingEnabled);
    }
    pub inline fn GetLastLineWrapping(self: *const IDWriteTextLayout2) BOOL {
        return self.vtable.GetLastLineWrapping(self);
    }
    pub inline fn SetOpticalAlignment(self: *const IDWriteTextLayout2, opticalAlignment: DWRITE_OPTICAL_ALIGNMENT) HRESULT {
        return self.vtable.SetOpticalAlignment(self, opticalAlignment);
    }
    pub inline fn GetOpticalAlignment(self: *const IDWriteTextLayout2) DWRITE_OPTICAL_ALIGNMENT {
        return self.vtable.GetOpticalAlignment(self);
    }
    pub inline fn SetFontFallback(self: *const IDWriteTextLayout2, fontFallback: ?*IDWriteFontFallback) HRESULT {
        return self.vtable.SetFontFallback(self, fontFallback);
    }
    pub inline fn GetFontFallback(self: *const IDWriteTextLayout2, fontFallback: ?*?*IDWriteFontFallback) HRESULT {
        return self.vtable.GetFontFallback(self, fontFallback);
    }
};
...
pub const IDWriteTextAnalyzer2 = extern union {
    ...
    IDWriteTextAnalyzer: IDWriteTextAnalyzer,
    IUnknown: IUnknown,
    pub inline fn GetGlyphOrientationTransform(self: *const IDWriteTextAnalyzer2, glyphOrientationAngle: DWRITE_GLYPH_ORIENTATION_ANGLE, isSideways: BOOL, originX: f32, originY: f32, transform: ?*DWRITE_MATRIX) HRESULT {
        return self.vtable.GetGlyphOrientationTransform(self, glyphOrientationAngle, isSideways, originX, originY, transform);
    }
    pub inline fn GetTypographicFeatures(self: *const IDWriteTextAnalyzer2, fontFace: ?*IDWriteFontFace, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]const u16, maxTagCount: u32, actualTagCount: ?*u32, tags: [*]DWRITE_FONT_FEATURE_TAG) HRESULT {
        return self.vtable.GetTypographicFeatures(self, fontFace, scriptAnalysis, localeName, maxTagCount, actualTagCount, tags);
    }
    pub inline fn CheckTypographicFeature(self: *const IDWriteTextAnalyzer2, fontFace: ?*IDWriteFontFace, scriptAnalysis: DWRITE_SCRIPT_ANALYSIS, localeName: ?[*:0]const u16, featureTag: DWRITE_FONT_FEATURE_TAG, glyphCount: u32, glyphIndices: [*:0]const u16, featureApplies: [*:0]u8) HRESULT {
...
pub const IDWriteFontFallbackBuilder = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddMapping(self: *const IDWriteFontFallbackBuilder, ranges: [*]const DWRITE_UNICODE_RANGE, rangesCount: u32, targetFamilyNames: [*]const ?*const u16, targetFamilyNamesCount: u32, fontCollection: ?*IDWriteFontCollection, localeName: ?[*:0]const u16, baseFamilyName: ?[*:0]const u16, scale: f32) HRESULT {
    ...
    pub inline fn AddMappings(self: *const IDWriteFontFallbackBuilder, fontFallback: ?*IDWriteFontFallback) HRESULT {
        return self.vtable.AddMappings(self, fontFallback);
    }
    pub inline fn CreateFontFallback(self: *const IDWriteFontFallbackBuilder, fontFallback: **IDWriteFontFallback) HRESULT {
...
pub const IDWriteFont2 = extern union {
    ...
    IDWriteFont: IDWriteFont,
    IUnknown: IUnknown,
    pub inline fn IsColorFont(self: *const IDWriteFont2) BOOL {
...
pub const IDWriteFontFace2 = extern union {
    ...
    IDWriteFontFace: IDWriteFontFace,
    IUnknown: IUnknown,
    pub inline fn IsColorFont(self: *const IDWriteFontFace2) BOOL {
        return self.vtable.IsColorFont(self);
    }
    pub inline fn GetColorPaletteCount(self: *const IDWriteFontFace2) u32 {
        return self.vtable.GetColorPaletteCount(self);
    }
    pub inline fn GetPaletteEntryCount(self: *const IDWriteFontFace2) u32 {
        return self.vtable.GetPaletteEntryCount(self);
    }
    pub inline fn GetPaletteEntries(self: *const IDWriteFontFace2, colorPaletteIndex: u32, firstEntryIndex: u32, entryCount: u32, paletteEntries: [*]DWRITE_COLOR_F) HRESULT {
        return self.vtable.GetPaletteEntries(self, colorPaletteIndex, firstEntryIndex, entryCount, paletteEntries);
    }
    pub inline fn GetRecommendedRenderingMode(self: *const IDWriteFontFace2, fontEmSize: f32, dpiX: f32, dpiY: f32, transform: ?*const DWRITE_MATRIX, isSideways: BOOL, outlineThreshold: DWRITE_OUTLINE_THRESHOLD, measuringMode: DWRITE_MEASURING_MODE, renderingParams: ?*IDWriteRenderingParams, renderingMode: ?*DWRITE_RENDERING_MODE, gridFitMode: ?*DWRITE_GRID_FIT_MODE) HRESULT {
...
pub const IDWriteColorGlyphRunEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn MoveNext(self: *const IDWriteColorGlyphRunEnumerator, hasRun: ?*BOOL) HRESULT {
        return self.vtable.MoveNext(self, hasRun);
    }
    pub inline fn GetCurrentRun(self: *const IDWriteColorGlyphRunEnumerator, colorGlyphRun: ?*const ?*DWRITE_COLOR_GLYPH_RUN) HRESULT {
...
pub const IDWriteRenderingParams2 = extern union {
    ...
    IDWriteRenderingParams: IDWriteRenderingParams,
    IUnknown: IUnknown,
    pub inline fn GetGridFitMode(self: *const IDWriteRenderingParams2) DWRITE_GRID_FIT_MODE {
...
pub const IDWriteFactory2 = extern union {
    ...
    IDWriteFactory: IDWriteFactory,
    IUnknown: IUnknown,
    pub inline fn GetSystemFontFallback(self: *const IDWriteFactory2, fontFallback: **IDWriteFontFallback) HRESULT {
        return self.vtable.GetSystemFontFallback(self, fontFallback);
    }
    pub inline fn CreateFontFallbackBuilder(self: *const IDWriteFactory2, fontFallbackBuilder: **IDWriteFontFallbackBuilder) HRESULT {
        return self.vtable.CreateFontFallbackBuilder(self, fontFallbackBuilder);
    }
    pub inline fn TranslateColorGlyphRun(self: *const IDWriteFactory2, baselineOriginX: f32, baselineOriginY: f32, glyphRun: ?*const DWRITE_GLYPH_RUN, glyphRunDescription: ?*const DWRITE_GLYPH_RUN_DESCRIPTION, measuringMode: DWRITE_MEASURING_MODE, worldToDeviceTransform: ?*const DWRITE_MATRIX, colorPaletteIndex: u32, colorLayers: **IDWriteColorGlyphRunEnumerator) HRESULT {
...
pub const IDWriteRenderingParams3 = extern union {
    ...
    IDWriteRenderingParams: IDWriteRenderingParams,
    IUnknown: IUnknown,
    pub inline fn GetRenderingMode1(self: *const IDWriteRenderingParams3) DWRITE_RENDERING_MODE1 {
...
pub const IDWriteFactory3 = extern union {
    ...
    pub inline fn GetSystemFontSet(self: *const IDWriteFactory3, fontSet: **IDWriteFontSet) HRESULT {
        return self.vtable.GetSystemFontSet(self, fontSet);
    }
    pub inline fn CreateFontSetBuilder(self: *const IDWriteFactory3, fontSetBuilder: **IDWriteFontSetBuilder) HRESULT {
        return self.vtable.CreateFontSetBuilder(self, fontSetBuilder);
    }
    pub inline fn CreateFontCollectionFromFontSet(self: *const IDWriteFactory3, fontSet: ?*IDWriteFontSet, fontCollection: **IDWriteFontCollection1) HRESULT {
        return self.vtable.CreateFontCollectionFromFontSet(self, fontSet, fontCollection);
    }
    pub inline fn GetSystemFontCollection(self: *const IDWriteFactory3, includeDownloadableFonts: BOOL, fontCollection: **IDWriteFontCollection1, checkForUpdates: BOOL) HRESULT {
        return self.vtable.GetSystemFontCollection(self, includeDownloadableFonts, fontCollection, checkForUpdates);
    }
    pub inline fn GetFontDownloadQueue(self: *const IDWriteFactory3, fontDownloadQueue: **IDWriteFontDownloadQueue) HRESULT {
...
pub const IDWriteFontSet = extern union {
    ...
    pub inline fn GetFontCount(self: *const IDWriteFontSet) u32 {
        return self.vtable.GetFontCount(self);
    }
    pub inline fn GetFontFaceReference(self: *const IDWriteFontSet, listIndex: u32, fontFaceReference: **IDWriteFontFaceReference) HRESULT {
        return self.vtable.GetFontFaceReference(self, listIndex, fontFaceReference);
    }
    pub inline fn FindFontFaceReference(self: *const IDWriteFontSet, fontFaceReference: ?*IDWriteFontFaceReference, listIndex: ?*u32, exists: ?*BOOL) HRESULT {
        return self.vtable.FindFontFaceReference(self, fontFaceReference, listIndex, exists);
    }
    pub inline fn FindFontFace(self: *const IDWriteFontSet, fontFace: ?*IDWriteFontFace, listIndex: ?*u32, exists: ?*BOOL) HRESULT {
        return self.vtable.FindFontFace(self, fontFace, listIndex, exists);
    }
    pub inline fn GetPropertyValues_TODO_A(self: *const IDWriteFontSet, propertyID: DWRITE_FONT_PROPERTY_ID, values: **IDWriteStringList) HRESULT {
        return self.vtable.GetPropertyValues_TODO_A(self, propertyID, values);
    }
    pub inline fn GetPropertyValues_TODO_B(self: *const IDWriteFontSet, propertyID: DWRITE_FONT_PROPERTY_ID, preferredLocaleNames: ?[*:0]const u16, values: **IDWriteStringList) HRESULT {
        return self.vtable.GetPropertyValues_TODO_B(self, propertyID, preferredLocaleNames, values);
    }
    pub inline fn GetPropertyValues_TODO_C(self: *const IDWriteFontSet, listIndex: u32, propertyId: DWRITE_FONT_PROPERTY_ID, exists: ?*BOOL, values: ?**IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetPropertyValues_TODO_C(self, listIndex, propertyId, exists, values);
    }
    pub inline fn GetPropertyOccurrenceCount(self: *const IDWriteFontSet, property: ?*const DWRITE_FONT_PROPERTY, propertyOccurrenceCount: ?*u32) HRESULT {
        return self.vtable.GetPropertyOccurrenceCount(self, property, propertyOccurrenceCount);
    }
    pub inline fn GetMatchingFonts_TODO_A(self: *const IDWriteFontSet, familyName: ?[*:0]const u16, fontWeight: DWRITE_FONT_WEIGHT, fontStretch: DWRITE_FONT_STRETCH, fontStyle: DWRITE_FONT_STYLE, filteredSet: **IDWriteFontSet) HRESULT {
        return self.vtable.GetMatchingFonts_TODO_A(self, familyName, fontWeight, fontStretch, fontStyle, filteredSet);
    }
    pub inline fn GetMatchingFonts_TODO_B(self: *const IDWriteFontSet, properties: [*]const DWRITE_FONT_PROPERTY, propertyCount: u32, filteredSet: **IDWriteFontSet) HRESULT {
...
pub const IDWriteFontSetBuilder = extern union {
    ...
    pub inline fn AddFontFaceReference_TODO_A(self: *const IDWriteFontSetBuilder, fontFaceReference: ?*IDWriteFontFaceReference, properties: [*]const DWRITE_FONT_PROPERTY, propertyCount: u32) HRESULT {
        return self.vtable.AddFontFaceReference_TODO_A(self, fontFaceReference, properties, propertyCount);
    }
    pub inline fn AddFontFaceReference_TODO_B(self: *const IDWriteFontSetBuilder, fontFaceReference: ?*IDWriteFontFaceReference) HRESULT {
        return self.vtable.AddFontFaceReference_TODO_B(self, fontFaceReference);
    }
    pub inline fn AddFontSet(self: *const IDWriteFontSetBuilder, fontSet: ?*IDWriteFontSet) HRESULT {
        return self.vtable.AddFontSet(self, fontSet);
    }
    pub inline fn CreateFontSet(self: *const IDWriteFontSetBuilder, fontSet: **IDWriteFontSet) HRESULT {
...
pub const IDWriteFontCollection1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetFontSet(self: *const IDWriteFontCollection1, fontSet: **IDWriteFontSet) HRESULT {
        return self.vtable.GetFontSet(self, fontSet);
    }
    pub inline fn GetFontFamily(self: *const IDWriteFontCollection1, index: u32, fontFamily: **IDWriteFontFamily1) HRESULT {
        return self.vtable.GetFontFamily(self, index, fontFamily);
    }
};
...
pub const IDWriteFontFamily1 = extern union {
    ...
    IDWriteFontList: IDWriteFontList,
    IUnknown: IUnknown,
    pub inline fn GetFontLocality(self: *const IDWriteFontFamily1, listIndex: u32) DWRITE_LOCALITY {
        return self.vtable.GetFontLocality(self, listIndex);
    }
    pub inline fn GetFont(self: *const IDWriteFontFamily1, listIndex: u32, font: **IDWriteFont3) HRESULT {
        return self.vtable.GetFont(self, listIndex, font);
    }
    pub inline fn GetFontFaceReference(self: *const IDWriteFontFamily1, listIndex: u32, fontFaceReference: **IDWriteFontFaceReference) HRESULT {
        return self.vtable.GetFontFaceReference(self, listIndex, fontFaceReference);
    }
};
...
pub const IDWriteFontList1 = extern union {
    ...
    IDWriteFontList: IDWriteFontList,
    IUnknown: IUnknown,
    pub inline fn GetFontLocality(self: *const IDWriteFontList1, listIndex: u32) DWRITE_LOCALITY {
        return self.vtable.GetFontLocality(self, listIndex);
    }
    pub inline fn GetFont(self: *const IDWriteFontList1, listIndex: u32, font: **IDWriteFont3) HRESULT {
        return self.vtable.GetFont(self, listIndex, font);
    }
    pub inline fn GetFontFaceReference(self: *const IDWriteFontList1, listIndex: u32, fontFaceReference: **IDWriteFontFaceReference) HRESULT {
        return self.vtable.GetFontFaceReference(self, listIndex, fontFaceReference);
    }
};
...
pub const IDWriteFontFaceReference = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateFontFace(self: *const IDWriteFontFaceReference, fontFace: **IDWriteFontFace3) HRESULT {
        return self.vtable.CreateFontFace(self, fontFace);
    }
    pub inline fn CreateFontFaceWithSimulations(self: *const IDWriteFontFaceReference, fontFaceSimulationFlags: DWRITE_FONT_SIMULATIONS, fontFace: **IDWriteFontFace3) HRESULT {
        return self.vtable.CreateFontFaceWithSimulations(self, fontFaceSimulationFlags, fontFace);
    }
    pub inline fn Equals(self: *const IDWriteFontFaceReference, fontFaceReference: ?*IDWriteFontFaceReference) BOOL {
        return self.vtable.Equals(self, fontFaceReference);
    }
    pub inline fn GetFontFaceIndex(self: *const IDWriteFontFaceReference) u32 {
        return self.vtable.GetFontFaceIndex(self);
    }
    pub inline fn GetSimulations(self: *const IDWriteFontFaceReference) DWRITE_FONT_SIMULATIONS {
        return self.vtable.GetSimulations(self);
    }
    pub inline fn GetFontFile(self: *const IDWriteFontFaceReference, fontFile: **IDWriteFontFile) HRESULT {
        return self.vtable.GetFontFile(self, fontFile);
    }
    pub inline fn GetLocalFileSize(self: *const IDWriteFontFaceReference) u64 {
        return self.vtable.GetLocalFileSize(self);
    }
    pub inline fn GetFileSize(self: *const IDWriteFontFaceReference) u64 {
        return self.vtable.GetFileSize(self);
    }
    pub inline fn GetFileTime(self: *const IDWriteFontFaceReference, lastWriteTime: ?*FILETIME) HRESULT {
        return self.vtable.GetFileTime(self, lastWriteTime);
    }
    pub inline fn GetLocality(self: *const IDWriteFontFaceReference) DWRITE_LOCALITY {
        return self.vtable.GetLocality(self);
    }
    pub inline fn EnqueueFontDownloadRequest(self: *const IDWriteFontFaceReference) HRESULT {
        return self.vtable.EnqueueFontDownloadRequest(self);
    }
    pub inline fn EnqueueCharacterDownloadRequest(self: *const IDWriteFontFaceReference, characters: [*:0]const u16, characterCount: u32) HRESULT {
        return self.vtable.EnqueueCharacterDownloadRequest(self, characters, characterCount);
    }
    pub inline fn EnqueueGlyphDownloadRequest(self: *const IDWriteFontFaceReference, glyphIndices: [*:0]const u16, glyphCount: u32) HRESULT {
        return self.vtable.EnqueueGlyphDownloadRequest(self, glyphIndices, glyphCount);
    }
    pub inline fn EnqueueFileFragmentDownloadRequest(self: *const IDWriteFontFaceReference, fileOffset: u64, fragmentSize: u64) HRESULT {
...
pub const IDWriteFont3 = extern union {
    ...
    IDWriteFont: IDWriteFont,
    IUnknown: IUnknown,
    pub inline fn CreateFontFace(self: *const IDWriteFont3, fontFace: **IDWriteFontFace3) HRESULT {
        return self.vtable.CreateFontFace(self, fontFace);
    }
    pub inline fn Equals(self: *const IDWriteFont3, font: ?*IDWriteFont) BOOL {
        return self.vtable.Equals(self, font);
    }
    pub inline fn GetFontFaceReference(self: *const IDWriteFont3, fontFaceReference: **IDWriteFontFaceReference) HRESULT {
        return self.vtable.GetFontFaceReference(self, fontFaceReference);
    }
    pub inline fn HasCharacter(self: *const IDWriteFont3, unicodeValue: u32) BOOL {
        return self.vtable.HasCharacter(self, unicodeValue);
    }
    pub inline fn GetLocality(self: *const IDWriteFont3) DWRITE_LOCALITY {
        return self.vtable.GetLocality(self);
    }
};
...
pub const IDWriteFontFace3 = extern union {
    ...
    IDWriteFontFace: IDWriteFontFace,
    IUnknown: IUnknown,
    pub inline fn GetFontFaceReference(self: *const IDWriteFontFace3, fontFaceReference: **IDWriteFontFaceReference) HRESULT {
        return self.vtable.GetFontFaceReference(self, fontFaceReference);
    }
    pub inline fn GetPanose(self: *const IDWriteFontFace3, panose: ?*DWRITE_PANOSE) void {
        return self.vtable.GetPanose(self, panose);
    }
    pub inline fn GetWeight(self: *const IDWriteFontFace3) DWRITE_FONT_WEIGHT {
        return self.vtable.GetWeight(self);
    }
    pub inline fn GetStretch(self: *const IDWriteFontFace3) DWRITE_FONT_STRETCH {
        return self.vtable.GetStretch(self);
    }
    pub inline fn GetStyle(self: *const IDWriteFontFace3) DWRITE_FONT_STYLE {
        return self.vtable.GetStyle(self);
    }
    pub inline fn GetFamilyNames(self: *const IDWriteFontFace3, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetFamilyNames(self, names);
    }
    pub inline fn GetFaceNames(self: *const IDWriteFontFace3, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetFaceNames(self, names);
    }
    pub inline fn GetInformationalStrings(self: *const IDWriteFontFace3, informationalStringID: DWRITE_INFORMATIONAL_STRING_ID, informationalStrings: ?**IDWriteLocalizedStrings, exists: ?*BOOL) HRESULT {
        return self.vtable.GetInformationalStrings(self, informationalStringID, informationalStrings, exists);
    }
    pub inline fn HasCharacter(self: *const IDWriteFontFace3, unicodeValue: u32) BOOL {
        return self.vtable.HasCharacter(self, unicodeValue);
    }
    pub inline fn GetRecommendedRenderingMode(self: *const IDWriteFontFace3, fontEmSize: f32, dpiX: f32, dpiY: f32, transform: ?*const DWRITE_MATRIX, isSideways: BOOL, outlineThreshold: DWRITE_OUTLINE_THRESHOLD, measuringMode: DWRITE_MEASURING_MODE, renderingParams: ?*IDWriteRenderingParams, renderingMode: ?*DWRITE_RENDERING_MODE1, gridFitMode: ?*DWRITE_GRID_FIT_MODE) HRESULT {
        return self.vtable.GetRecommendedRenderingMode(self, fontEmSize, dpiX, dpiY, transform, isSideways, outlineThreshold, measuringMode, renderingParams, renderingMode, gridFitMode);
    }
    pub inline fn IsCharacterLocal(self: *const IDWriteFontFace3, unicodeValue: u32) BOOL {
        return self.vtable.IsCharacterLocal(self, unicodeValue);
    }
    pub inline fn IsGlyphLocal(self: *const IDWriteFontFace3, glyphId: u16) BOOL {
        return self.vtable.IsGlyphLocal(self, glyphId);
    }
    pub inline fn AreCharactersLocal(self: *const IDWriteFontFace3, characters: [*:0]const u16, characterCount: u32, enqueueIfNotLocal: BOOL, isLocal: ?*BOOL) HRESULT {
        return self.vtable.AreCharactersLocal(self, characters, characterCount, enqueueIfNotLocal, isLocal);
    }
    pub inline fn AreGlyphsLocal(self: *const IDWriteFontFace3, glyphIndices: [*:0]const u16, glyphCount: u32, enqueueIfNotLocal: BOOL, isLocal: ?*BOOL) HRESULT {
...
pub const IDWriteStringList = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCount(self: *const IDWriteStringList) u32 {
        return self.vtable.GetCount(self);
    }
    pub inline fn GetLocaleNameLength(self: *const IDWriteStringList, listIndex: u32, length: ?*u32) HRESULT {
        return self.vtable.GetLocaleNameLength(self, listIndex, length);
    }
    pub inline fn GetLocaleName(self: *const IDWriteStringList, listIndex: u32, localeName: [*:0]u16, size: u32) HRESULT {
        return self.vtable.GetLocaleName(self, listIndex, localeName, size);
    }
    pub inline fn GetStringLength(self: *const IDWriteStringList, listIndex: u32, length: ?*u32) HRESULT {
        return self.vtable.GetStringLength(self, listIndex, length);
    }
    pub inline fn GetString(self: *const IDWriteStringList, listIndex: u32, stringBuffer: [*:0]u16, stringBufferSize: u32) HRESULT {
...
pub const IDWriteFontDownloadListener = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DownloadCompleted(self: *const IDWriteFontDownloadListener, downloadQueue: ?*IDWriteFontDownloadQueue, context: ?*IUnknown, downloadResult: HRESULT) void {
...
pub const IDWriteFontDownloadQueue = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddListener(self: *const IDWriteFontDownloadQueue, listener: ?*IDWriteFontDownloadListener, token: ?*u32) HRESULT {
        return self.vtable.AddListener(self, listener, token);
    }
    pub inline fn RemoveListener(self: *const IDWriteFontDownloadQueue, token: u32) HRESULT {
        return self.vtable.RemoveListener(self, token);
    }
    pub inline fn IsEmpty(self: *const IDWriteFontDownloadQueue) BOOL {
        return self.vtable.IsEmpty(self);
    }
    pub inline fn BeginDownload(self: *const IDWriteFontDownloadQueue, context: ?*IUnknown) HRESULT {
        return self.vtable.BeginDownload(self, context);
    }
    pub inline fn CancelDownload(self: *const IDWriteFontDownloadQueue) HRESULT {
        return self.vtable.CancelDownload(self);
    }
    pub inline fn GetGenerationCount(self: *const IDWriteFontDownloadQueue) u64 {
...
pub const IDWriteGdiInterop1 = extern union {
    ...
    pub inline fn CreateFontFromLOGFONT(self: *const IDWriteGdiInterop1, logFont: ?*const LOGFONTW, fontCollection: ?*IDWriteFontCollection, font: **IDWriteFont) HRESULT {
        return self.vtable.CreateFontFromLOGFONT(self, logFont, fontCollection, font);
    }
    pub inline fn GetFontSignature_TODO_A(self: *const IDWriteGdiInterop1, fontFace: ?*IDWriteFontFace, fontSignature: ?*FONTSIGNATURE) HRESULT {
        return self.vtable.GetFontSignature_TODO_A(self, fontFace, fontSignature);
    }
    pub inline fn GetFontSignature_TODO_B(self: *const IDWriteGdiInterop1, font: ?*IDWriteFont, fontSignature: ?*FONTSIGNATURE) HRESULT {
        return self.vtable.GetFontSignature_TODO_B(self, font, fontSignature);
    }
    pub inline fn GetMatchingFontsByLOGFONT(self: *const IDWriteGdiInterop1, logFont: ?*const LOGFONTA, fontSet: ?*IDWriteFontSet, filteredSet: **IDWriteFontSet) HRESULT {
...
pub const IDWriteTextFormat2 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn SetLineSpacing(self: *const IDWriteTextFormat2, lineSpacingOptions: ?*const DWRITE_LINE_SPACING) HRESULT {
        return self.vtable.SetLineSpacing(self, lineSpacingOptions);
    }
    pub inline fn GetLineSpacing(self: *const IDWriteTextFormat2, lineSpacingOptions: ?*DWRITE_LINE_SPACING) HRESULT {
...
pub const IDWriteTextLayout3 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn InvalidateLayout(self: *const IDWriteTextLayout3) HRESULT {
        return self.vtable.InvalidateLayout(self);
    }
    pub inline fn SetLineSpacing(self: *const IDWriteTextLayout3, lineSpacingOptions: ?*const DWRITE_LINE_SPACING) HRESULT {
        return self.vtable.SetLineSpacing(self, lineSpacingOptions);
    }
    pub inline fn GetLineSpacing(self: *const IDWriteTextLayout3, lineSpacingOptions: ?*DWRITE_LINE_SPACING) HRESULT {
        return self.vtable.GetLineSpacing(self, lineSpacingOptions);
    }
    pub inline fn GetLineMetrics(self: *const IDWriteTextLayout3, lineMetrics: ?[*]DWRITE_LINE_METRICS1, maxLineCount: u32, actualLineCount: ?*u32) HRESULT {
        return self.vtable.GetLineMetrics(self, lineMetrics, maxLineCount, actualLineCount);
    }
};
...
pub const IDWriteColorGlyphRunEnumerator1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetCurrentRun(self: *const IDWriteColorGlyphRunEnumerator1, colorGlyphRun: ?*const ?*DWRITE_COLOR_GLYPH_RUN1) HRESULT {
        return self.vtable.GetCurrentRun(self, colorGlyphRun);
    }
};
...
pub const IDWriteFontFace4 = extern union {
    ...
    pub inline fn GetGlyphImageFormats_TODO_A(self: *const IDWriteFontFace4, glyphId: u16, pixelsPerEmFirst: u32, pixelsPerEmLast: u32, glyphImageFormats: ?*DWRITE_GLYPH_IMAGE_FORMATS) HRESULT {
        return self.vtable.GetGlyphImageFormats_TODO_A(self, glyphId, pixelsPerEmFirst, pixelsPerEmLast, glyphImageFormats);
    }
    pub inline fn GetGlyphImageFormats_TODO_B(self: *const IDWriteFontFace4) DWRITE_GLYPH_IMAGE_FORMATS {
        return self.vtable.GetGlyphImageFormats_TODO_B(self);
    }
    pub inline fn GetGlyphImageData(self: *const IDWriteFontFace4, glyphId: u16, pixelsPerEm: u32, glyphImageFormat: DWRITE_GLYPH_IMAGE_FORMATS, glyphData: ?*DWRITE_GLYPH_IMAGE_DATA, glyphDataContext: ?*?*anyopaque) HRESULT {
        return self.vtable.GetGlyphImageData(self, glyphId, pixelsPerEm, glyphImageFormat, glyphData, glyphDataContext);
    }
    pub inline fn ReleaseGlyphImageData(self: *const IDWriteFontFace4, glyphDataContext: ?*anyopaque) void {
...
pub const IDWriteFactory4 = extern union {
    ...
    pub inline fn TranslateColorGlyphRun(self: *const IDWriteFactory4, baselineOrigin: D2D_POINT_2F, glyphRun: ?*const DWRITE_GLYPH_RUN, glyphRunDescription: ?*const DWRITE_GLYPH_RUN_DESCRIPTION, desiredGlyphImageFormats: DWRITE_GLYPH_IMAGE_FORMATS, measuringMode: DWRITE_MEASURING_MODE, worldAndDpiTransform: ?*const DWRITE_MATRIX, colorPaletteIndex: u32, colorLayers: **IDWriteColorGlyphRunEnumerator1) HRESULT {
    ...
    pub inline fn ComputeGlyphOrigins_TODO_A(self: *const IDWriteFactory4, glyphRun: ?*const DWRITE_GLYPH_RUN, baselineOrigin: D2D_POINT_2F, glyphOrigins: ?*D2D_POINT_2F) HRESULT {
        return self.vtable.ComputeGlyphOrigins_TODO_A(self, glyphRun, baselineOrigin, glyphOrigins);
    }
    pub inline fn ComputeGlyphOrigins_TODO_B(self: *const IDWriteFactory4, glyphRun: ?*const DWRITE_GLYPH_RUN, measuringMode: DWRITE_MEASURING_MODE, baselineOrigin: D2D_POINT_2F, worldAndDpiTransform: ?*const DWRITE_MATRIX, glyphOrigins: ?*D2D_POINT_2F) HRESULT {
...
pub const IDWriteFontSetBuilder1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn AddFontFile(self: *const IDWriteFontSetBuilder1, fontFile: ?*IDWriteFontFile) HRESULT {
...
pub const IDWriteAsyncResult = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetWaitHandle(self: *const IDWriteAsyncResult) ?HANDLE {
        return self.vtable.GetWaitHandle(self);
    }
    pub inline fn GetResult(self: *const IDWriteAsyncResult) HRESULT {
...
pub const IDWriteRemoteFontFileStream = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetLocalFileSize(self: *const IDWriteRemoteFontFileStream, localFileSize: ?*u64) HRESULT {
        return self.vtable.GetLocalFileSize(self, localFileSize);
    }
    pub inline fn GetFileFragmentLocality(self: *const IDWriteRemoteFontFileStream, fileOffset: u64, fragmentSize: u64, isLocal: ?*BOOL, partialSize: ?*u64) HRESULT {
        return self.vtable.GetFileFragmentLocality(self, fileOffset, fragmentSize, isLocal, partialSize);
    }
    pub inline fn GetLocality(self: *const IDWriteRemoteFontFileStream) DWRITE_LOCALITY {
        return self.vtable.GetLocality(self);
    }
    pub inline fn BeginDownload(self: *const IDWriteRemoteFontFileStream, downloadOperationID: ?*const Guid, fileFragments: [*]const DWRITE_FILE_FRAGMENT, fragmentCount: u32, asyncResult: ?**IDWriteAsyncResult) HRESULT {
...
pub const IDWriteRemoteFontFileLoader = extern union {
    ...
    IDWriteFontFileLoader: IDWriteFontFileLoader,
    IUnknown: IUnknown,
    pub inline fn CreateRemoteStreamFromKey(self: *const IDWriteRemoteFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, fontFileStream: **IDWriteRemoteFontFileStream) HRESULT {
        return self.vtable.CreateRemoteStreamFromKey(self, fontFileReferenceKey, fontFileReferenceKeySize, fontFileStream);
    }
    pub inline fn GetLocalityFromKey(self: *const IDWriteRemoteFontFileLoader, fontFileReferenceKey: ?*const anyopaque, fontFileReferenceKeySize: u32, locality: ?*DWRITE_LOCALITY) HRESULT {
        return self.vtable.GetLocalityFromKey(self, fontFileReferenceKey, fontFileReferenceKeySize, locality);
    }
    pub inline fn CreateFontFileReferenceFromUrl(self: *const IDWriteRemoteFontFileLoader, factory: ?*IDWriteFactory, baseUrl: ?[*:0]const u16, fontFileUrl: ?[*:0]const u16, fontFile: **IDWriteFontFile) HRESULT {
...
pub const IDWriteInMemoryFontFileLoader = extern union {
    ...
    IDWriteFontFileLoader: IDWriteFontFileLoader,
    IUnknown: IUnknown,
    pub inline fn CreateInMemoryFontFileReference(self: *const IDWriteInMemoryFontFileLoader, factory: ?*IDWriteFactory, fontData: ?*const anyopaque, fontDataSize: u32, ownerObject: ?*IUnknown, fontFile: **IDWriteFontFile) HRESULT {
        return self.vtable.CreateInMemoryFontFileReference(self, factory, fontData, fontDataSize, ownerObject, fontFile);
    }
    pub inline fn GetFileCount(self: *const IDWriteInMemoryFontFileLoader) u32 {
...
pub const IDWriteFactory5 = extern union {
    ...
    IDWriteFactory: IDWriteFactory,
    IUnknown: IUnknown,
    pub inline fn CreateFontSetBuilder(self: *const IDWriteFactory5, fontSetBuilder: **IDWriteFontSetBuilder1) HRESULT {
        return self.vtable.CreateFontSetBuilder(self, fontSetBuilder);
    }
    pub inline fn CreateInMemoryFontFileLoader(self: *const IDWriteFactory5, newLoader: **IDWriteInMemoryFontFileLoader) HRESULT {
        return self.vtable.CreateInMemoryFontFileLoader(self, newLoader);
    }
    pub inline fn CreateHttpFontFileLoader(self: *const IDWriteFactory5, referrerUrl: ?[*:0]const u16, extraHeaders: ?[*:0]const u16, newLoader: **IDWriteRemoteFontFileLoader) HRESULT {
        return self.vtable.CreateHttpFontFileLoader(self, referrerUrl, extraHeaders, newLoader);
    }
    pub inline fn AnalyzeContainerType(self: *const IDWriteFactory5, fileData: ?*const anyopaque, fileDataSize: u32) DWRITE_CONTAINER_TYPE {
        return self.vtable.AnalyzeContainerType(self, fileData, fileDataSize);
    }
    pub inline fn UnpackFontFile(self: *const IDWriteFactory5, containerType: DWRITE_CONTAINER_TYPE, fileData: ?*const anyopaque, fileDataSize: u32, unpackedFontStream: **IDWriteFontFileStream) HRESULT {
...
pub const IDWriteFactory6 = extern union {
    ...
    IDWriteFactory: IDWriteFactory,
    IUnknown: IUnknown,
    pub inline fn CreateFontFaceReference(self: *const IDWriteFactory6, fontFile: ?*IDWriteFontFile, faceIndex: u32, fontSimulations: DWRITE_FONT_SIMULATIONS, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontFaceReference: **IDWriteFontFaceReference1) HRESULT {
    ...
    pub inline fn CreateFontResource(self: *const IDWriteFactory6, fontFile: ?*IDWriteFontFile, faceIndex: u32, fontResource: **IDWriteFontResource) HRESULT {
        return self.vtable.CreateFontResource(self, fontFile, faceIndex, fontResource);
    }
    pub inline fn GetSystemFontSet(self: *const IDWriteFactory6, includeDownloadableFonts: BOOL, fontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetSystemFontSet(self, includeDownloadableFonts, fontSet);
    }
    pub inline fn GetSystemFontCollection(self: *const IDWriteFactory6, includeDownloadableFonts: BOOL, fontFamilyModel: DWRITE_FONT_FAMILY_MODEL, fontCollection: **IDWriteFontCollection2) HRESULT {
        return self.vtable.GetSystemFontCollection(self, includeDownloadableFonts, fontFamilyModel, fontCollection);
    }
    pub inline fn CreateFontCollectionFromFontSet(self: *const IDWriteFactory6, fontSet: ?*IDWriteFontSet, fontFamilyModel: DWRITE_FONT_FAMILY_MODEL, fontCollection: **IDWriteFontCollection2) HRESULT {
        return self.vtable.CreateFontCollectionFromFontSet(self, fontSet, fontFamilyModel, fontCollection);
    }
    pub inline fn CreateFontSetBuilder(self: *const IDWriteFactory6, fontSetBuilder: **IDWriteFontSetBuilder2) HRESULT {
        return self.vtable.CreateFontSetBuilder(self, fontSetBuilder);
    }
    pub inline fn CreateTextFormat(self: *const IDWriteFactory6, fontFamilyName: ?[*:0]const u16, fontCollection: ?*IDWriteFontCollection, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontSize: f32, localeName: ?[*:0]const u16, textFormat: **IDWriteTextFormat3) HRESULT {
...
pub const IDWriteFontFace5 = extern union {
    ...
    IDWriteFontFace: IDWriteFontFace,
    IUnknown: IUnknown,
    pub inline fn GetFontAxisValueCount(self: *const IDWriteFontFace5) u32 {
        return self.vtable.GetFontAxisValueCount(self);
    }
    pub inline fn GetFontAxisValues(self: *const IDWriteFontFace5, fontAxisValues: [*]DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32) HRESULT {
        return self.vtable.GetFontAxisValues(self, fontAxisValues, fontAxisValueCount);
    }
    pub inline fn HasVariations(self: *const IDWriteFontFace5) BOOL {
        return self.vtable.HasVariations(self);
    }
    pub inline fn GetFontResource(self: *const IDWriteFontFace5, fontResource: **IDWriteFontResource) HRESULT {
        return self.vtable.GetFontResource(self, fontResource);
    }
    pub inline fn Equals(self: *const IDWriteFontFace5, fontFace: ?*IDWriteFontFace) BOOL {
...
pub const IDWriteFontResource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFontFile(self: *const IDWriteFontResource, fontFile: **IDWriteFontFile) HRESULT {
        return self.vtable.GetFontFile(self, fontFile);
    }
    pub inline fn GetFontFaceIndex(self: *const IDWriteFontResource) u32 {
        return self.vtable.GetFontFaceIndex(self);
    }
    pub inline fn GetFontAxisCount(self: *const IDWriteFontResource) u32 {
        return self.vtable.GetFontAxisCount(self);
    }
    pub inline fn GetDefaultFontAxisValues(self: *const IDWriteFontResource, fontAxisValues: [*]DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32) HRESULT {
        return self.vtable.GetDefaultFontAxisValues(self, fontAxisValues, fontAxisValueCount);
    }
    pub inline fn GetFontAxisRanges(self: *const IDWriteFontResource, fontAxisRanges: [*]DWRITE_FONT_AXIS_RANGE, fontAxisRangeCount: u32) HRESULT {
        return self.vtable.GetFontAxisRanges(self, fontAxisRanges, fontAxisRangeCount);
    }
    pub inline fn GetFontAxisAttributes(self: *const IDWriteFontResource, axisIndex: u32) DWRITE_FONT_AXIS_ATTRIBUTES {
        return self.vtable.GetFontAxisAttributes(self, axisIndex);
    }
    pub inline fn GetAxisNames(self: *const IDWriteFontResource, axisIndex: u32, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetAxisNames(self, axisIndex, names);
    }
    pub inline fn GetAxisValueNameCount(self: *const IDWriteFontResource, axisIndex: u32) u32 {
        return self.vtable.GetAxisValueNameCount(self, axisIndex);
    }
    pub inline fn GetAxisValueNames(self: *const IDWriteFontResource, axisIndex: u32, axisValueIndex: u32, fontAxisRange: ?*DWRITE_FONT_AXIS_RANGE, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetAxisValueNames(self, axisIndex, axisValueIndex, fontAxisRange, names);
    }
    pub inline fn HasVariations(self: *const IDWriteFontResource) BOOL {
        return self.vtable.HasVariations(self);
    }
    pub inline fn CreateFontFace(self: *const IDWriteFontResource, fontSimulations: DWRITE_FONT_SIMULATIONS, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontFace: **IDWriteFontFace5) HRESULT {
        return self.vtable.CreateFontFace(self, fontSimulations, fontAxisValues, fontAxisValueCount, fontFace);
    }
    pub inline fn CreateFontFaceReference(self: *const IDWriteFontResource, fontSimulations: DWRITE_FONT_SIMULATIONS, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontFaceReference: **IDWriteFontFaceReference1) HRESULT {
...
pub const IDWriteFontFaceReference1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateFontFace(self: *const IDWriteFontFaceReference1, fontFace: **IDWriteFontFace5) HRESULT {
        return self.vtable.CreateFontFace(self, fontFace);
    }
    pub inline fn GetFontAxisValueCount(self: *const IDWriteFontFaceReference1) u32 {
        return self.vtable.GetFontAxisValueCount(self);
    }
    pub inline fn GetFontAxisValues(self: *const IDWriteFontFaceReference1, fontAxisValues: [*]DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32) HRESULT {
        return self.vtable.GetFontAxisValues(self, fontAxisValues, fontAxisValueCount);
    }
};
...
pub const IDWriteFontSetBuilder2 = extern union {
    ...
    pub inline fn AddFontFile(self: *const IDWriteFontSetBuilder2, filePath: ?[*:0]const u16) HRESULT {
...
pub const IDWriteFontSet1 = extern union {
    ...
    pub inline fn GetMatchingFonts(self: *const IDWriteFontSet1, fontProperty: ?*const DWRITE_FONT_PROPERTY, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, matchingFonts: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetMatchingFonts(self, fontProperty, fontAxisValues, fontAxisValueCount, matchingFonts);
    }
    pub inline fn GetFirstFontResources(self: *const IDWriteFontSet1, filteredFontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFirstFontResources(self, filteredFontSet);
    }
    pub inline fn GetFilteredFonts_TODO_A(self: *const IDWriteFontSet1, indices: [*]const u32, indexCount: u32, filteredFontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFilteredFonts_TODO_A(self, indices, indexCount, filteredFontSet);
    }
    pub inline fn GetFilteredFonts_TODO_B(self: *const IDWriteFontSet1, fontAxisRanges: [*]const DWRITE_FONT_AXIS_RANGE, fontAxisRangeCount: u32, selectAnyRange: BOOL, filteredFontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFilteredFonts_TODO_B(self, fontAxisRanges, fontAxisRangeCount, selectAnyRange, filteredFontSet);
    }
    pub inline fn GetFilteredFonts_TODO_C(self: *const IDWriteFontSet1, properties: ?[*]const DWRITE_FONT_PROPERTY, propertyCount: u32, selectAnyProperty: BOOL, filteredFontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFilteredFonts_TODO_C(self, properties, propertyCount, selectAnyProperty, filteredFontSet);
    }
    pub inline fn GetFilteredFontIndices_TODO_A(self: *const IDWriteFontSet1, fontAxisRanges: [*]const DWRITE_FONT_AXIS_RANGE, fontAxisRangeCount: u32, selectAnyRange: BOOL, indices: [*]u32, maxIndexCount: u32, actualIndexCount: ?*u32) HRESULT {
    ...
    pub inline fn GetFilteredFontIndices_TODO_C(self: *const IDWriteFontSet1, properties: [*]const DWRITE_FONT_PROPERTY, propertyCount: u32, selectAnyProperty: BOOL, indices: [*]u32, maxIndexCount: u32, actualIndexCount: ?*u32) HRESULT {
    ...
    pub inline fn GetFontAxisRanges_TODO_A(self: *const IDWriteFontSet1, listIndex: u32, fontAxisRanges: [*]DWRITE_FONT_AXIS_RANGE, maxFontAxisRangeCount: u32, actualFontAxisRangeCount: ?*u32) HRESULT {
        return self.vtable.GetFontAxisRanges_TODO_A(self, listIndex, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
    }
    pub inline fn GetFontAxisRanges_TODO_B(self: *const IDWriteFontSet1, fontAxisRanges: [*]DWRITE_FONT_AXIS_RANGE, maxFontAxisRangeCount: u32, actualFontAxisRangeCount: ?*u32) HRESULT {
        return self.vtable.GetFontAxisRanges_TODO_B(self, fontAxisRanges, maxFontAxisRangeCount, actualFontAxisRangeCount);
    }
    pub inline fn GetFontFaceReference(self: *const IDWriteFontSet1, listIndex: u32, fontFaceReference: **IDWriteFontFaceReference1) HRESULT {
        return self.vtable.GetFontFaceReference(self, listIndex, fontFaceReference);
    }
    pub inline fn CreateFontResource(self: *const IDWriteFontSet1, listIndex: u32, fontResource: **IDWriteFontResource) HRESULT {
        return self.vtable.CreateFontResource(self, listIndex, fontResource);
    }
    pub inline fn CreateFontFace(self: *const IDWriteFontSet1, listIndex: u32, fontFace: **IDWriteFontFace5) HRESULT {
        return self.vtable.CreateFontFace(self, listIndex, fontFace);
    }
    pub inline fn GetFontLocality(self: *const IDWriteFontSet1, listIndex: u32) DWRITE_LOCALITY {
        return self.vtable.GetFontLocality(self, listIndex);
    }
};
...
pub const IDWriteFontList2 = extern union {
    ...
    IDWriteFontList: IDWriteFontList,
    IUnknown: IUnknown,
    pub inline fn GetFontSet(self: *const IDWriteFontList2, fontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFontSet(self, fontSet);
    }
};
...
pub const IDWriteFontFamily2 = extern union {
    ...
    IDWriteFontList: IDWriteFontList,
    IUnknown: IUnknown,
    pub inline fn GetMatchingFonts(self: *const IDWriteFontFamily2, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, matchingFonts: **IDWriteFontList2) HRESULT {
        return self.vtable.GetMatchingFonts(self, fontAxisValues, fontAxisValueCount, matchingFonts);
    }
    pub inline fn GetFontSet(self: *const IDWriteFontFamily2, fontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFontSet(self, fontSet);
    }
};
...
pub const IDWriteFontCollection2 = extern union {
    ...
    IDWriteFontCollection: IDWriteFontCollection,
    IUnknown: IUnknown,
    pub inline fn GetFontFamily(self: *const IDWriteFontCollection2, index: u32, fontFamily: **IDWriteFontFamily2) HRESULT {
        return self.vtable.GetFontFamily(self, index, fontFamily);
    }
    pub inline fn GetMatchingFonts(self: *const IDWriteFontCollection2, familyName: ?[*:0]const u16, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, fontList: **IDWriteFontList2) HRESULT {
        return self.vtable.GetMatchingFonts(self, familyName, fontAxisValues, fontAxisValueCount, fontList);
    }
    pub inline fn GetFontFamilyModel(self: *const IDWriteFontCollection2) DWRITE_FONT_FAMILY_MODEL {
        return self.vtable.GetFontFamilyModel(self);
    }
    pub inline fn GetFontSet(self: *const IDWriteFontCollection2, fontSet: **IDWriteFontSet1) HRESULT {
        return self.vtable.GetFontSet(self, fontSet);
    }
};
...
pub const IDWriteTextLayout4 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn SetFontAxisValues(self: *const IDWriteTextLayout4, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, textRange: DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.SetFontAxisValues(self, fontAxisValues, fontAxisValueCount, textRange);
    }
    pub inline fn GetFontAxisValueCount(self: *const IDWriteTextLayout4, currentPosition: u32) u32 {
        return self.vtable.GetFontAxisValueCount(self, currentPosition);
    }
    pub inline fn GetFontAxisValues(self: *const IDWriteTextLayout4, currentPosition: u32, fontAxisValues: [*]DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32, textRange: ?*DWRITE_TEXT_RANGE) HRESULT {
        return self.vtable.GetFontAxisValues(self, currentPosition, fontAxisValues, fontAxisValueCount, textRange);
    }
    pub inline fn GetAutomaticFontAxes(self: *const IDWriteTextLayout4) DWRITE_AUTOMATIC_FONT_AXES {
        return self.vtable.GetAutomaticFontAxes(self);
    }
    pub inline fn SetAutomaticFontAxes(self: *const IDWriteTextLayout4, automaticFontAxes: DWRITE_AUTOMATIC_FONT_AXES) HRESULT {
...
pub const IDWriteTextFormat3 = extern union {
    ...
    IDWriteTextFormat: IDWriteTextFormat,
    IUnknown: IUnknown,
    pub inline fn SetFontAxisValues(self: *const IDWriteTextFormat3, fontAxisValues: [*]const DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32) HRESULT {
        return self.vtable.SetFontAxisValues(self, fontAxisValues, fontAxisValueCount);
    }
    pub inline fn GetFontAxisValueCount(self: *const IDWriteTextFormat3) u32 {
        return self.vtable.GetFontAxisValueCount(self);
    }
    pub inline fn GetFontAxisValues(self: *const IDWriteTextFormat3, fontAxisValues: [*]DWRITE_FONT_AXIS_VALUE, fontAxisValueCount: u32) HRESULT {
        return self.vtable.GetFontAxisValues(self, fontAxisValues, fontAxisValueCount);
    }
    pub inline fn GetAutomaticFontAxes(self: *const IDWriteTextFormat3) DWRITE_AUTOMATIC_FONT_AXES {
        return self.vtable.GetAutomaticFontAxes(self);
    }
    pub inline fn SetAutomaticFontAxes(self: *const IDWriteTextFormat3, automaticFontAxes: DWRITE_AUTOMATIC_FONT_AXES) HRESULT {
        return self.vtable.SetAutomaticFontAxes(self, automaticFontAxes);
    }
};
...
pub const IDWriteFontSet2 = extern union {
    ...
    IDWriteFontSet: IDWriteFontSet,
    IUnknown: IUnknown,
    pub inline fn GetExpirationEvent(self: *const IDWriteFontSet2) ?HANDLE {
...
pub const IDWriteFontCollection3 = extern union {
    ...
    IDWriteFontCollection: IDWriteFontCollection,
    IUnknown: IUnknown,
    pub inline fn GetExpirationEvent(self: *const IDWriteFontCollection3) ?HANDLE {
        return self.vtable.GetExpirationEvent(self);
    }
};
...
pub const IDWriteFactory7 = extern union {
    ...
    IDWriteFactory: IDWriteFactory,
    IUnknown: IUnknown,
    pub inline fn GetSystemFontSet(self: *const IDWriteFactory7, includeDownloadableFonts: BOOL, fontSet: **IDWriteFontSet2) HRESULT {
        return self.vtable.GetSystemFontSet(self, includeDownloadableFonts, fontSet);
    }
    pub inline fn GetSystemFontCollection(self: *const IDWriteFactory7, includeDownloadableFonts: BOOL, fontFamilyModel: DWRITE_FONT_FAMILY_MODEL, fontCollection: **IDWriteFontCollection3) HRESULT {
        return self.vtable.GetSystemFontCollection(self, includeDownloadableFonts, fontFamilyModel, fontCollection);
    }
};
...
pub const IDWriteFontSet3 = extern union {
    ...
    IDWriteFontSet: IDWriteFontSet,
    IUnknown: IUnknown,
    pub inline fn GetFontSourceType(self: *const IDWriteFontSet3, fontIndex: u32) DWRITE_FONT_SOURCE_TYPE {
        return self.vtable.GetFontSourceType(self, fontIndex);
    }
    pub inline fn GetFontSourceNameLength(self: *const IDWriteFontSet3, listIndex: u32) u32 {
        return self.vtable.GetFontSourceNameLength(self, listIndex);
    }
    pub inline fn GetFontSourceName(self: *const IDWriteFontSet3, listIndex: u32, stringBuffer: [*:0]u16, stringBufferSize: u32) HRESULT {
...
pub const IDWriteFontFace6 = extern union {
    ...
    IDWriteFontFace: IDWriteFontFace,
    IUnknown: IUnknown,
    pub inline fn GetFamilyNames(self: *const IDWriteFontFace6, fontFamilyModel: DWRITE_FONT_FAMILY_MODEL, names: **IDWriteLocalizedStrings) HRESULT {
        return self.vtable.GetFamilyNames(self, fontFamilyModel, names);
    }
    pub inline fn GetFaceNames(self: *const IDWriteFontFace6, fontFamilyModel: DWRITE_FONT_FAMILY_MODEL, names: **IDWriteLocalizedStrings) HRESULT {
