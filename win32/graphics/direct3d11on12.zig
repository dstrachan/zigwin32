...
pub const ID3D11On12Device = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateWrappedResource(self: *const ID3D11On12Device, pResource12: ?*IUnknown, pFlags11: ?*const D3D11_RESOURCE_FLAGS, InState: D3D12_RESOURCE_STATES, OutState: D3D12_RESOURCE_STATES, riid: ?*const Guid, ppResource11: ?**anyopaque) HRESULT {
        return self.vtable.CreateWrappedResource(self, pResource12, pFlags11, InState, OutState, riid, ppResource11);
    }
    pub inline fn ReleaseWrappedResources(self: *const ID3D11On12Device, ppResources: [*]?*ID3D11Resource, NumResources: u32) void {
        return self.vtable.ReleaseWrappedResources(self, ppResources, NumResources);
    }
    pub inline fn AcquireWrappedResources(self: *const ID3D11On12Device, ppResources: [*]?*ID3D11Resource, NumResources: u32) void {
...
pub const ID3D11On12Device1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetD3D12Device(self: *const ID3D11On12Device1, riid: ?*const Guid, ppvDevice: **anyopaque) HRESULT {
...
pub const ID3D11On12Device2 = extern union {
    ...
    ID3D11On12Device: ID3D11On12Device,
    IUnknown: IUnknown,
    pub inline fn UnwrapUnderlyingResource(self: *const ID3D11On12Device2, pResource11: ?*ID3D11Resource, pCommandQueue: ?*ID3D12CommandQueue, riid: ?*const Guid, ppvResource12: **anyopaque) HRESULT {
        return self.vtable.UnwrapUnderlyingResource(self, pResource11, pCommandQueue, riid, ppvResource12);
    }
    pub inline fn ReturnUnderlyingResource(self: *const ID3D11On12Device2, pResource11: ?*ID3D11Resource, NumSync: u32, pSignalValues: [*]u64, ppFences: [*]?*ID3D12Fence) HRESULT {
