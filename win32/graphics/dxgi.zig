...
pub const IDXGIObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetPrivateData(self: *const IDXGIObject, Name: ?*const Guid, DataSize: u32, pData: ?*const anyopaque) HRESULT {
        return self.vtable.SetPrivateData(self, Name, DataSize, pData);
    }
    pub inline fn SetPrivateDataInterface(self: *const IDXGIObject, Name: ?*const Guid, pUnknown: ?*IUnknown) HRESULT {
        return self.vtable.SetPrivateDataInterface(self, Name, pUnknown);
    }
    pub inline fn GetPrivateData(self: *const IDXGIObject, Name: ?*const Guid, pDataSize: ?*u32, pData: ?*anyopaque) HRESULT {
        return self.vtable.GetPrivateData(self, Name, pDataSize, pData);
    }
    pub inline fn GetParent(self: *const IDXGIObject, riid: ?*const Guid, ppParent: **anyopaque) HRESULT {
...
pub const IDXGIDeviceSubObject = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetDevice(self: *const IDXGIDeviceSubObject, riid: ?*const Guid, ppDevice: **anyopaque) HRESULT {
...
pub const IDXGIResource = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetSharedHandle(self: *const IDXGIResource, pSharedHandle: ?*?HANDLE) HRESULT {
        return self.vtable.GetSharedHandle(self, pSharedHandle);
    }
    pub inline fn GetUsage(self: *const IDXGIResource, pUsage: ?*u32) HRESULT {
        return self.vtable.GetUsage(self, pUsage);
    }
    pub inline fn SetEvictionPriority(self: *const IDXGIResource, EvictionPriority: DXGI_RESOURCE_PRIORITY) HRESULT {
        return self.vtable.SetEvictionPriority(self, EvictionPriority);
    }
    pub inline fn GetEvictionPriority(self: *const IDXGIResource, pEvictionPriority: ?*u32) HRESULT {
...
pub const IDXGIKeyedMutex = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn AcquireSync(self: *const IDXGIKeyedMutex, Key: u64, dwMilliseconds: u32) HRESULT {
        return self.vtable.AcquireSync(self, Key, dwMilliseconds);
    }
    pub inline fn ReleaseSync(self: *const IDXGIKeyedMutex, Key: u64) HRESULT {
...
pub const IDXGISurface = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc(self: *const IDXGISurface, pDesc: ?*DXGI_SURFACE_DESC) HRESULT {
        return self.vtable.GetDesc(self, pDesc);
    }
    pub inline fn Map(self: *const IDXGISurface, pLockedRect: ?*DXGI_MAPPED_RECT, MapFlags: u32) HRESULT {
        return self.vtable.Map(self, pLockedRect, MapFlags);
    }
    pub inline fn Unmap(self: *const IDXGISurface) HRESULT {
...
pub const IDXGISurface1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDC(self: *const IDXGISurface1, Discard: BOOL, phdc: ?*?HDC) HRESULT {
        return self.vtable.GetDC(self, Discard, phdc);
    }
    pub inline fn ReleaseDC(self: *const IDXGISurface1, pDirtyRect: ?*RECT) HRESULT {
...
pub const IDXGIAdapter = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn EnumOutputs(self: *const IDXGIAdapter, Output: u32, ppOutput: **IDXGIOutput) HRESULT {
        return self.vtable.EnumOutputs(self, Output, ppOutput);
    }
    pub inline fn GetDesc(self: *const IDXGIAdapter, pDesc: ?*DXGI_ADAPTER_DESC) HRESULT {
        return self.vtable.GetDesc(self, pDesc);
    }
    pub inline fn CheckInterfaceSupport(self: *const IDXGIAdapter, InterfaceName: ?*const Guid, pUMDVersion: ?*LARGE_INTEGER) HRESULT {
...
pub const IDXGIOutput = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc(self: *const IDXGIOutput, pDesc: ?*DXGI_OUTPUT_DESC) HRESULT {
        return self.vtable.GetDesc(self, pDesc);
    }
    pub inline fn GetDisplayModeList(self: *const IDXGIOutput, EnumFormat: DXGI_FORMAT, Flags: u32, pNumModes: ?*u32, pDesc: ?[*]DXGI_MODE_DESC) HRESULT {
        return self.vtable.GetDisplayModeList(self, EnumFormat, Flags, pNumModes, pDesc);
    }
    pub inline fn FindClosestMatchingMode(self: *const IDXGIOutput, pModeToMatch: ?*const DXGI_MODE_DESC, pClosestMatch: ?*DXGI_MODE_DESC, pConcernedDevice: ?*IUnknown) HRESULT {
        return self.vtable.FindClosestMatchingMode(self, pModeToMatch, pClosestMatch, pConcernedDevice);
    }
    pub inline fn WaitForVBlank(self: *const IDXGIOutput) HRESULT {
        return self.vtable.WaitForVBlank(self);
    }
    pub inline fn TakeOwnership(self: *const IDXGIOutput, pDevice: ?*IUnknown, Exclusive: BOOL) HRESULT {
        return self.vtable.TakeOwnership(self, pDevice, Exclusive);
    }
    pub inline fn ReleaseOwnership(self: *const IDXGIOutput) void {
        return self.vtable.ReleaseOwnership(self);
    }
    pub inline fn GetGammaControlCapabilities(self: *const IDXGIOutput, pGammaCaps: ?*DXGI_GAMMA_CONTROL_CAPABILITIES) HRESULT {
        return self.vtable.GetGammaControlCapabilities(self, pGammaCaps);
    }
    pub inline fn SetGammaControl(self: *const IDXGIOutput, pArray: ?*const DXGI_GAMMA_CONTROL) HRESULT {
        return self.vtable.SetGammaControl(self, pArray);
    }
    pub inline fn GetGammaControl(self: *const IDXGIOutput, pArray: ?*DXGI_GAMMA_CONTROL) HRESULT {
        return self.vtable.GetGammaControl(self, pArray);
    }
    pub inline fn SetDisplaySurface(self: *const IDXGIOutput, pScanoutSurface: ?*IDXGISurface) HRESULT {
        return self.vtable.SetDisplaySurface(self, pScanoutSurface);
    }
    pub inline fn GetDisplaySurfaceData(self: *const IDXGIOutput, pDestination: ?*IDXGISurface) HRESULT {
        return self.vtable.GetDisplaySurfaceData(self, pDestination);
    }
    pub inline fn GetFrameStatistics(self: *const IDXGIOutput, pStats: ?*DXGI_FRAME_STATISTICS) HRESULT {
...
pub const IDXGISwapChain = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn Present(self: *const IDXGISwapChain, SyncInterval: u32, Flags: u32) HRESULT {
        return self.vtable.Present(self, SyncInterval, Flags);
    }
    pub inline fn GetBuffer(self: *const IDXGISwapChain, Buffer: u32, riid: ?*const Guid, ppSurface: **anyopaque) HRESULT {
        return self.vtable.GetBuffer(self, Buffer, riid, ppSurface);
    }
    pub inline fn SetFullscreenState(self: *const IDXGISwapChain, Fullscreen: BOOL, pTarget: ?*IDXGIOutput) HRESULT {
        return self.vtable.SetFullscreenState(self, Fullscreen, pTarget);
    }
    pub inline fn GetFullscreenState(self: *const IDXGISwapChain, pFullscreen: ?*BOOL, ppTarget: ?**IDXGIOutput) HRESULT {
        return self.vtable.GetFullscreenState(self, pFullscreen, ppTarget);
    }
    pub inline fn GetDesc(self: *const IDXGISwapChain, pDesc: ?*DXGI_SWAP_CHAIN_DESC) HRESULT {
        return self.vtable.GetDesc(self, pDesc);
    }
    pub inline fn ResizeBuffers(self: *const IDXGISwapChain, BufferCount: u32, Width: u32, Height: u32, NewFormat: DXGI_FORMAT, SwapChainFlags: u32) HRESULT {
        return self.vtable.ResizeBuffers(self, BufferCount, Width, Height, NewFormat, SwapChainFlags);
    }
    pub inline fn ResizeTarget(self: *const IDXGISwapChain, pNewTargetParameters: ?*const DXGI_MODE_DESC) HRESULT {
        return self.vtable.ResizeTarget(self, pNewTargetParameters);
    }
    pub inline fn GetContainingOutput(self: *const IDXGISwapChain, ppOutput: **IDXGIOutput) HRESULT {
        return self.vtable.GetContainingOutput(self, ppOutput);
    }
    pub inline fn GetFrameStatistics(self: *const IDXGISwapChain, pStats: ?*DXGI_FRAME_STATISTICS) HRESULT {
        return self.vtable.GetFrameStatistics(self, pStats);
    }
    pub inline fn GetLastPresentCount(self: *const IDXGISwapChain, pLastPresentCount: ?*u32) HRESULT {
...
pub const IDXGIFactory = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn EnumAdapters(self: *const IDXGIFactory, Adapter: u32, ppAdapter: **IDXGIAdapter) HRESULT {
        return self.vtable.EnumAdapters(self, Adapter, ppAdapter);
    }
    pub inline fn MakeWindowAssociation(self: *const IDXGIFactory, WindowHandle: ?HWND, Flags: u32) HRESULT {
        return self.vtable.MakeWindowAssociation(self, WindowHandle, Flags);
    }
    pub inline fn GetWindowAssociation(self: *const IDXGIFactory, pWindowHandle: ?*?HWND) HRESULT {
        return self.vtable.GetWindowAssociation(self, pWindowHandle);
    }
    pub inline fn CreateSwapChain(self: *const IDXGIFactory, pDevice: ?*IUnknown, pDesc: ?*DXGI_SWAP_CHAIN_DESC, ppSwapChain: **IDXGISwapChain) HRESULT {
        return self.vtable.CreateSwapChain(self, pDevice, pDesc, ppSwapChain);
    }
    pub inline fn CreateSoftwareAdapter(self: *const IDXGIFactory, Module: ?HINSTANCE, ppAdapter: **IDXGIAdapter) HRESULT {
...
pub const IDXGIDevice = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetAdapter(self: *const IDXGIDevice, pAdapter: **IDXGIAdapter) HRESULT {
        return self.vtable.GetAdapter(self, pAdapter);
    }
    pub inline fn CreateSurface(self: *const IDXGIDevice, pDesc: ?*const DXGI_SURFACE_DESC, NumSurfaces: u32, Usage: u32, pSharedResource: ?*const DXGI_SHARED_RESOURCE, ppSurface: [*]?*IDXGISurface) HRESULT {
        return self.vtable.CreateSurface(self, pDesc, NumSurfaces, Usage, pSharedResource, ppSurface);
    }
    pub inline fn QueryResourceResidency(self: *const IDXGIDevice, ppResources: [*]?*IUnknown, pResidencyStatus: [*]DXGI_RESIDENCY, NumResources: u32) HRESULT {
        return self.vtable.QueryResourceResidency(self, ppResources, pResidencyStatus, NumResources);
    }
    pub inline fn SetGPUThreadPriority(self: *const IDXGIDevice, Priority: i32) HRESULT {
        return self.vtable.SetGPUThreadPriority(self, Priority);
    }
    pub inline fn GetGPUThreadPriority(self: *const IDXGIDevice, pPriority: ?*i32) HRESULT {
...
pub const IDXGIFactory1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn EnumAdapters1(self: *const IDXGIFactory1, Adapter: u32, ppAdapter: **IDXGIAdapter1) HRESULT {
        return self.vtable.EnumAdapters1(self, Adapter, ppAdapter);
    }
    pub inline fn IsCurrent(self: *const IDXGIFactory1) BOOL {
...
pub const IDXGIAdapter1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc1(self: *const IDXGIAdapter1, pDesc: ?*DXGI_ADAPTER_DESC1) HRESULT {
...
pub const IDXGIDevice1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn SetMaximumFrameLatency(self: *const IDXGIDevice1, MaxLatency: u32) HRESULT {
        return self.vtable.SetMaximumFrameLatency(self, MaxLatency);
    }
    pub inline fn GetMaximumFrameLatency(self: *const IDXGIDevice1, pMaxLatency: ?*u32) HRESULT {
...
pub const IDXGIDisplayControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsStereoEnabled(self: *const IDXGIDisplayControl) BOOL {
        return self.vtable.IsStereoEnabled(self);
    }
    pub inline fn SetStereoEnabled(self: *const IDXGIDisplayControl, enabled: BOOL) void {
...
pub const IDXGIOutputDuplication = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc(self: *const IDXGIOutputDuplication, pDesc: ?*DXGI_OUTDUPL_DESC) void {
        return self.vtable.GetDesc(self, pDesc);
    }
    pub inline fn AcquireNextFrame(self: *const IDXGIOutputDuplication, TimeoutInMilliseconds: u32, pFrameInfo: ?*DXGI_OUTDUPL_FRAME_INFO, ppDesktopResource: **IDXGIResource) HRESULT {
        return self.vtable.AcquireNextFrame(self, TimeoutInMilliseconds, pFrameInfo, ppDesktopResource);
    }
    pub inline fn GetFrameDirtyRects(self: *const IDXGIOutputDuplication, DirtyRectsBufferSize: u32, pDirtyRectsBuffer: ?*RECT, pDirtyRectsBufferSizeRequired: ?*u32) HRESULT {
        return self.vtable.GetFrameDirtyRects(self, DirtyRectsBufferSize, pDirtyRectsBuffer, pDirtyRectsBufferSizeRequired);
    }
    pub inline fn GetFrameMoveRects(self: *const IDXGIOutputDuplication, MoveRectsBufferSize: u32, pMoveRectBuffer: ?*DXGI_OUTDUPL_MOVE_RECT, pMoveRectsBufferSizeRequired: ?*u32) HRESULT {
        return self.vtable.GetFrameMoveRects(self, MoveRectsBufferSize, pMoveRectBuffer, pMoveRectsBufferSizeRequired);
    }
    pub inline fn GetFramePointerShape(self: *const IDXGIOutputDuplication, PointerShapeBufferSize: u32, pPointerShapeBuffer: ?*anyopaque, pPointerShapeBufferSizeRequired: ?*u32, pPointerShapeInfo: ?*DXGI_OUTDUPL_POINTER_SHAPE_INFO) HRESULT {
    ...
    pub inline fn MapDesktopSurface(self: *const IDXGIOutputDuplication, pLockedRect: ?*DXGI_MAPPED_RECT) HRESULT {
        return self.vtable.MapDesktopSurface(self, pLockedRect);
    }
    pub inline fn UnMapDesktopSurface(self: *const IDXGIOutputDuplication) HRESULT {
        return self.vtable.UnMapDesktopSurface(self);
    }
    pub inline fn ReleaseFrame(self: *const IDXGIOutputDuplication) HRESULT {
...
pub const IDXGISurface2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetResource(self: *const IDXGISurface2, riid: ?*const Guid, ppParentResource: **anyopaque, pSubresourceIndex: ?*u32) HRESULT {
...
pub const IDXGIResource1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn CreateSubresourceSurface(self: *const IDXGIResource1, index: u32, ppSurface: **IDXGISurface2) HRESULT {
        return self.vtable.CreateSubresourceSurface(self, index, ppSurface);
    }
    pub inline fn CreateSharedHandle(self: *const IDXGIResource1, pAttributes: ?*const SECURITY_ATTRIBUTES, dwAccess: u32, lpName: ?[*:0]const u16, pHandle: ?*?HANDLE) HRESULT {
...
pub const IDXGIDevice2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn OfferResources(self: *const IDXGIDevice2, NumResources: u32, ppResources: [*]?*IDXGIResource, Priority: DXGI_OFFER_RESOURCE_PRIORITY) HRESULT {
        return self.vtable.OfferResources(self, NumResources, ppResources, Priority);
    }
    pub inline fn ReclaimResources(self: *const IDXGIDevice2, NumResources: u32, ppResources: [*]?*IDXGIResource, pDiscarded: ?[*]BOOL) HRESULT {
        return self.vtable.ReclaimResources(self, NumResources, ppResources, pDiscarded);
    }
    pub inline fn EnqueueSetEvent(self: *const IDXGIDevice2, hEvent: ?HANDLE) HRESULT {
...
pub const IDXGISwapChain1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc1(self: *const IDXGISwapChain1, pDesc: ?*DXGI_SWAP_CHAIN_DESC1) HRESULT {
        return self.vtable.GetDesc1(self, pDesc);
    }
    pub inline fn GetFullscreenDesc(self: *const IDXGISwapChain1, pDesc: ?*DXGI_SWAP_CHAIN_FULLSCREEN_DESC) HRESULT {
        return self.vtable.GetFullscreenDesc(self, pDesc);
    }
    pub inline fn GetHwnd(self: *const IDXGISwapChain1, pHwnd: ?*?HWND) HRESULT {
        return self.vtable.GetHwnd(self, pHwnd);
    }
    pub inline fn GetCoreWindow(self: *const IDXGISwapChain1, refiid: ?*const Guid, ppUnk: **anyopaque) HRESULT {
        return self.vtable.GetCoreWindow(self, refiid, ppUnk);
    }
    pub inline fn Present1(self: *const IDXGISwapChain1, SyncInterval: u32, PresentFlags: u32, pPresentParameters: ?*const DXGI_PRESENT_PARAMETERS) HRESULT {
        return self.vtable.Present1(self, SyncInterval, PresentFlags, pPresentParameters);
    }
    pub inline fn IsTemporaryMonoSupported(self: *const IDXGISwapChain1) BOOL {
        return self.vtable.IsTemporaryMonoSupported(self);
    }
    pub inline fn GetRestrictToOutput(self: *const IDXGISwapChain1, ppRestrictToOutput: ?*?*IDXGIOutput) HRESULT {
        return self.vtable.GetRestrictToOutput(self, ppRestrictToOutput);
    }
    pub inline fn SetBackgroundColor(self: *const IDXGISwapChain1, pColor: ?*const DXGI_RGBA) HRESULT {
        return self.vtable.SetBackgroundColor(self, pColor);
    }
    pub inline fn GetBackgroundColor(self: *const IDXGISwapChain1, pColor: ?*DXGI_RGBA) HRESULT {
        return self.vtable.GetBackgroundColor(self, pColor);
    }
    pub inline fn SetRotation(self: *const IDXGISwapChain1, Rotation: DXGI_MODE_ROTATION) HRESULT {
        return self.vtable.SetRotation(self, Rotation);
    }
    pub inline fn GetRotation(self: *const IDXGISwapChain1, pRotation: ?*DXGI_MODE_ROTATION) HRESULT {
...
pub const IDXGIFactory2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn IsWindowedStereoEnabled(self: *const IDXGIFactory2) BOOL {
        return self.vtable.IsWindowedStereoEnabled(self);
    }
    pub inline fn CreateSwapChainForHwnd(self: *const IDXGIFactory2, pDevice: ?*IUnknown, hWnd: ?HWND, pDesc: ?*const DXGI_SWAP_CHAIN_DESC1, pFullscreenDesc: ?*const DXGI_SWAP_CHAIN_FULLSCREEN_DESC, pRestrictToOutput: ?*IDXGIOutput, ppSwapChain: **IDXGISwapChain1) HRESULT {
        return self.vtable.CreateSwapChainForHwnd(self, pDevice, hWnd, pDesc, pFullscreenDesc, pRestrictToOutput, ppSwapChain);
    }
    pub inline fn CreateSwapChainForCoreWindow(self: *const IDXGIFactory2, pDevice: ?*IUnknown, pWindow: ?*IUnknown, pDesc: ?*const DXGI_SWAP_CHAIN_DESC1, pRestrictToOutput: ?*IDXGIOutput, ppSwapChain: **IDXGISwapChain1) HRESULT {
        return self.vtable.CreateSwapChainForCoreWindow(self, pDevice, pWindow, pDesc, pRestrictToOutput, ppSwapChain);
    }
    pub inline fn GetSharedResourceAdapterLuid(self: *const IDXGIFactory2, hResource: ?HANDLE, pLuid: ?*LUID) HRESULT {
        return self.vtable.GetSharedResourceAdapterLuid(self, hResource, pLuid);
    }
    pub inline fn RegisterStereoStatusWindow(self: *const IDXGIFactory2, WindowHandle: ?HWND, wMsg: u32, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterStereoStatusWindow(self, WindowHandle, wMsg, pdwCookie);
    }
    pub inline fn RegisterStereoStatusEvent(self: *const IDXGIFactory2, hEvent: ?HANDLE, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterStereoStatusEvent(self, hEvent, pdwCookie);
    }
    pub inline fn UnregisterStereoStatus(self: *const IDXGIFactory2, dwCookie: u32) void {
        return self.vtable.UnregisterStereoStatus(self, dwCookie);
    }
    pub inline fn RegisterOcclusionStatusWindow(self: *const IDXGIFactory2, WindowHandle: ?HWND, wMsg: u32, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterOcclusionStatusWindow(self, WindowHandle, wMsg, pdwCookie);
    }
    pub inline fn RegisterOcclusionStatusEvent(self: *const IDXGIFactory2, hEvent: ?HANDLE, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterOcclusionStatusEvent(self, hEvent, pdwCookie);
    }
    pub inline fn UnregisterOcclusionStatus(self: *const IDXGIFactory2, dwCookie: u32) void {
        return self.vtable.UnregisterOcclusionStatus(self, dwCookie);
    }
    pub inline fn CreateSwapChainForComposition(self: *const IDXGIFactory2, pDevice: ?*IUnknown, pDesc: ?*const DXGI_SWAP_CHAIN_DESC1, pRestrictToOutput: ?*IDXGIOutput, ppSwapChain: **IDXGISwapChain1) HRESULT {
...
pub const IDXGIAdapter2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc2(self: *const IDXGIAdapter2, pDesc: ?*DXGI_ADAPTER_DESC2) HRESULT {
...
pub const IDXGIOutput1 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDisplayModeList1(self: *const IDXGIOutput1, EnumFormat: DXGI_FORMAT, Flags: u32, pNumModes: ?*u32, pDesc: ?[*]DXGI_MODE_DESC1) HRESULT {
        return self.vtable.GetDisplayModeList1(self, EnumFormat, Flags, pNumModes, pDesc);
    }
    pub inline fn FindClosestMatchingMode1(self: *const IDXGIOutput1, pModeToMatch: ?*const DXGI_MODE_DESC1, pClosestMatch: ?*DXGI_MODE_DESC1, pConcernedDevice: ?*IUnknown) HRESULT {
        return self.vtable.FindClosestMatchingMode1(self, pModeToMatch, pClosestMatch, pConcernedDevice);
    }
    pub inline fn GetDisplaySurfaceData1(self: *const IDXGIOutput1, pDestination: ?*IDXGIResource) HRESULT {
        return self.vtable.GetDisplaySurfaceData1(self, pDestination);
    }
    pub inline fn DuplicateOutput(self: *const IDXGIOutput1, pDevice: ?*IUnknown, ppOutputDuplication: **IDXGIOutputDuplication) HRESULT {
...
pub const IDXGIDevice3 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn Trim(self: *const IDXGIDevice3) void {
...
pub const IDXGISwapChain2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn SetSourceSize(self: *const IDXGISwapChain2, Width: u32, Height: u32) HRESULT {
        return self.vtable.SetSourceSize(self, Width, Height);
    }
    pub inline fn GetSourceSize(self: *const IDXGISwapChain2, pWidth: ?*u32, pHeight: ?*u32) HRESULT {
        return self.vtable.GetSourceSize(self, pWidth, pHeight);
    }
    pub inline fn SetMaximumFrameLatency(self: *const IDXGISwapChain2, MaxLatency: u32) HRESULT {
        return self.vtable.SetMaximumFrameLatency(self, MaxLatency);
    }
    pub inline fn GetMaximumFrameLatency(self: *const IDXGISwapChain2, pMaxLatency: ?*u32) HRESULT {
        return self.vtable.GetMaximumFrameLatency(self, pMaxLatency);
    }
    pub inline fn GetFrameLatencyWaitableObject(self: *const IDXGISwapChain2) ?HANDLE {
        return self.vtable.GetFrameLatencyWaitableObject(self);
    }
    pub inline fn SetMatrixTransform(self: *const IDXGISwapChain2, pMatrix: ?*const DXGI_MATRIX_3X2_F) HRESULT {
        return self.vtable.SetMatrixTransform(self, pMatrix);
    }
    pub inline fn GetMatrixTransform(self: *const IDXGISwapChain2, pMatrix: ?*DXGI_MATRIX_3X2_F) HRESULT {
...
pub const IDXGIOutput2 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn SupportsOverlays(self: *const IDXGIOutput2) BOOL {
...
pub const IDXGIFactory3 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetCreationFlags(self: *const IDXGIFactory3) u32 {
...
pub const IDXGIDecodeSwapChain = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn PresentBuffer(self: *const IDXGIDecodeSwapChain, BufferToPresent: u32, SyncInterval: u32, Flags: u32) HRESULT {
        return self.vtable.PresentBuffer(self, BufferToPresent, SyncInterval, Flags);
    }
    pub inline fn SetSourceRect(self: *const IDXGIDecodeSwapChain, pRect: ?*const RECT) HRESULT {
        return self.vtable.SetSourceRect(self, pRect);
    }
    pub inline fn SetTargetRect(self: *const IDXGIDecodeSwapChain, pRect: ?*const RECT) HRESULT {
        return self.vtable.SetTargetRect(self, pRect);
    }
    pub inline fn SetDestSize(self: *const IDXGIDecodeSwapChain, Width: u32, Height: u32) HRESULT {
        return self.vtable.SetDestSize(self, Width, Height);
    }
    pub inline fn GetSourceRect(self: *const IDXGIDecodeSwapChain, pRect: ?*RECT) HRESULT {
        return self.vtable.GetSourceRect(self, pRect);
    }
    pub inline fn GetTargetRect(self: *const IDXGIDecodeSwapChain, pRect: ?*RECT) HRESULT {
        return self.vtable.GetTargetRect(self, pRect);
    }
    pub inline fn GetDestSize(self: *const IDXGIDecodeSwapChain, pWidth: ?*u32, pHeight: ?*u32) HRESULT {
        return self.vtable.GetDestSize(self, pWidth, pHeight);
    }
    pub inline fn SetColorSpace(self: *const IDXGIDecodeSwapChain, ColorSpace: DXGI_MULTIPLANE_OVERLAY_YCbCr_FLAGS) HRESULT {
        return self.vtable.SetColorSpace(self, ColorSpace);
    }
    pub inline fn GetColorSpace(self: *const IDXGIDecodeSwapChain) DXGI_MULTIPLANE_OVERLAY_YCbCr_FLAGS {
...
pub const IDXGIFactoryMedia = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateSwapChainForCompositionSurfaceHandle(self: *const IDXGIFactoryMedia, pDevice: ?*IUnknown, hSurface: ?HANDLE, pDesc: ?*const DXGI_SWAP_CHAIN_DESC1, pRestrictToOutput: ?*IDXGIOutput, ppSwapChain: **IDXGISwapChain1) HRESULT {
        return self.vtable.CreateSwapChainForCompositionSurfaceHandle(self, pDevice, hSurface, pDesc, pRestrictToOutput, ppSwapChain);
    }
    pub inline fn CreateDecodeSwapChainForCompositionSurfaceHandle(self: *const IDXGIFactoryMedia, pDevice: ?*IUnknown, hSurface: ?HANDLE, pDesc: ?*DXGI_DECODE_SWAP_CHAIN_DESC, pYuvDecodeBuffers: ?*IDXGIResource, pRestrictToOutput: ?*IDXGIOutput, ppSwapChain: **IDXGIDecodeSwapChain) HRESULT {
...
pub const IDXGISwapChainMedia = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFrameStatisticsMedia(self: *const IDXGISwapChainMedia, pStats: ?*DXGI_FRAME_STATISTICS_MEDIA) HRESULT {
        return self.vtable.GetFrameStatisticsMedia(self, pStats);
    }
    pub inline fn SetPresentDuration(self: *const IDXGISwapChainMedia, Duration: u32) HRESULT {
        return self.vtable.SetPresentDuration(self, Duration);
    }
    pub inline fn CheckPresentDurationSupport(self: *const IDXGISwapChainMedia, DesiredPresentDuration: u32, pClosestSmallerPresentDuration: ?*u32, pClosestLargerPresentDuration: ?*u32) HRESULT {
...
pub const IDXGIOutput3 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn CheckOverlaySupport(self: *const IDXGIOutput3, EnumFormat: DXGI_FORMAT, pConcernedDevice: ?*IUnknown, pFlags: ?*u32) HRESULT {
...
pub const IDXGISwapChain3 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetCurrentBackBufferIndex(self: *const IDXGISwapChain3) u32 {
        return self.vtable.GetCurrentBackBufferIndex(self);
    }
    pub inline fn CheckColorSpaceSupport(self: *const IDXGISwapChain3, ColorSpace: DXGI_COLOR_SPACE_TYPE, pColorSpaceSupport: ?*u32) HRESULT {
        return self.vtable.CheckColorSpaceSupport(self, ColorSpace, pColorSpaceSupport);
    }
    pub inline fn SetColorSpace1(self: *const IDXGISwapChain3, ColorSpace: DXGI_COLOR_SPACE_TYPE) HRESULT {
        return self.vtable.SetColorSpace1(self, ColorSpace);
    }
    pub inline fn ResizeBuffers1(self: *const IDXGISwapChain3, BufferCount: u32, Width: u32, Height: u32, Format: DXGI_FORMAT, SwapChainFlags: u32, pCreationNodeMask: [*]const u32, ppPresentQueue: [*]?*IUnknown) HRESULT {
...
pub const IDXGIOutput4 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn CheckOverlayColorSpaceSupport(self: *const IDXGIOutput4, Format: DXGI_FORMAT, ColorSpace: DXGI_COLOR_SPACE_TYPE, pConcernedDevice: ?*IUnknown, pFlags: ?*u32) HRESULT {
...
pub const IDXGIFactory4 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn EnumAdapterByLuid(self: *const IDXGIFactory4, AdapterLuid: LUID, riid: ?*const Guid, ppvAdapter: **anyopaque) HRESULT {
        return self.vtable.EnumAdapterByLuid(self, AdapterLuid, riid, ppvAdapter);
    }
    pub inline fn EnumWarpAdapter(self: *const IDXGIFactory4, riid: ?*const Guid, ppvAdapter: **anyopaque) HRESULT {
...
pub const IDXGIAdapter3 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn RegisterHardwareContentProtectionTeardownStatusEvent(self: *const IDXGIAdapter3, hEvent: ?HANDLE, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterHardwareContentProtectionTeardownStatusEvent(self, hEvent, pdwCookie);
    }
    pub inline fn UnregisterHardwareContentProtectionTeardownStatus(self: *const IDXGIAdapter3, dwCookie: u32) void {
        return self.vtable.UnregisterHardwareContentProtectionTeardownStatus(self, dwCookie);
    }
    pub inline fn QueryVideoMemoryInfo(self: *const IDXGIAdapter3, NodeIndex: u32, MemorySegmentGroup: DXGI_MEMORY_SEGMENT_GROUP, pVideoMemoryInfo: ?*DXGI_QUERY_VIDEO_MEMORY_INFO) HRESULT {
        return self.vtable.QueryVideoMemoryInfo(self, NodeIndex, MemorySegmentGroup, pVideoMemoryInfo);
    }
    pub inline fn SetVideoMemoryReservation(self: *const IDXGIAdapter3, NodeIndex: u32, MemorySegmentGroup: DXGI_MEMORY_SEGMENT_GROUP, Reservation: u64) HRESULT {
        return self.vtable.SetVideoMemoryReservation(self, NodeIndex, MemorySegmentGroup, Reservation);
    }
    pub inline fn RegisterVideoMemoryBudgetChangeNotificationEvent(self: *const IDXGIAdapter3, hEvent: ?HANDLE, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterVideoMemoryBudgetChangeNotificationEvent(self, hEvent, pdwCookie);
    }
    pub inline fn UnregisterVideoMemoryBudgetChangeNotification(self: *const IDXGIAdapter3, dwCookie: u32) void {
...
pub const IDXGIOutput5 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn DuplicateOutput1(self: *const IDXGIOutput5, pDevice: ?*IUnknown, Flags: u32, SupportedFormatsCount: u32, pSupportedFormats: [*]const DXGI_FORMAT, ppOutputDuplication: **IDXGIOutputDuplication) HRESULT {
...
pub const IDXGISwapChain4 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn SetHDRMetaData(self: *const IDXGISwapChain4, Type: DXGI_HDR_METADATA_TYPE, Size: u32, pMetaData: ?[*]u8) HRESULT {
...
pub const IDXGIDevice4 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn OfferResources1(self: *const IDXGIDevice4, NumResources: u32, ppResources: [*]?*IDXGIResource, Priority: DXGI_OFFER_RESOURCE_PRIORITY, Flags: u32) HRESULT {
        return self.vtable.OfferResources1(self, NumResources, ppResources, Priority, Flags);
    }
    pub inline fn ReclaimResources1(self: *const IDXGIDevice4, NumResources: u32, ppResources: [*]?*IDXGIResource, pResults: [*]DXGI_RECLAIM_RESOURCE_RESULTS) HRESULT {
...
pub const IDXGIFactory5 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn CheckFeatureSupport(self: *const IDXGIFactory5, Feature: DXGI_FEATURE, pFeatureSupportData: ?*anyopaque, FeatureSupportDataSize: u32) HRESULT {
...
pub const IDXGIAdapter4 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc3(self: *const IDXGIAdapter4, pDesc: ?*DXGI_ADAPTER_DESC3) HRESULT {
...
pub const IDXGIOutput6 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn GetDesc1(self: *const IDXGIOutput6, pDesc: ?*DXGI_OUTPUT_DESC1) HRESULT {
        return self.vtable.GetDesc1(self, pDesc);
    }
    pub inline fn CheckHardwareCompositionSupport(self: *const IDXGIOutput6, pFlags: ?*u32) HRESULT {
...
pub const IDXGIFactory6 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn EnumAdapterByGpuPreference(self: *const IDXGIFactory6, Adapter: u32, GpuPreference: DXGI_GPU_PREFERENCE, riid: ?*const Guid, ppvAdapter: **anyopaque) HRESULT {
...
pub const IDXGIFactory7 = extern union {
    ...
    IDXGIObject: IDXGIObject,
    IUnknown: IUnknown,
    pub inline fn RegisterAdaptersChangedEvent(self: *const IDXGIFactory7, hEvent: ?HANDLE, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterAdaptersChangedEvent(self, hEvent, pdwCookie);
    }
    pub inline fn UnregisterAdaptersChangedEvent(self: *const IDXGIFactory7, dwCookie: u32) HRESULT {
...
pub const IDXGIInfoQueue = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetMessageCountLimit(self: *const IDXGIInfoQueue, Producer: Guid, MessageCountLimit: u64) HRESULT {
        return self.vtable.SetMessageCountLimit(self, Producer, MessageCountLimit);
    }
    pub inline fn ClearStoredMessages(self: *const IDXGIInfoQueue, Producer: Guid) void {
        return self.vtable.ClearStoredMessages(self, Producer);
    }
    pub inline fn GetMessage(self: *const IDXGIInfoQueue, Producer: Guid, MessageIndex: u64, pMessage: ?*DXGI_INFO_QUEUE_MESSAGE, pMessageByteLength: ?*usize) HRESULT {
        return self.vtable.GetMessage(self, Producer, MessageIndex, pMessage, pMessageByteLength);
    }
    pub inline fn GetNumStoredMessagesAllowedByRetrievalFilters(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetNumStoredMessagesAllowedByRetrievalFilters(self, Producer);
    }
    pub inline fn GetNumStoredMessages(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetNumStoredMessages(self, Producer);
    }
    pub inline fn GetNumMessagesDiscardedByMessageCountLimit(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetNumMessagesDiscardedByMessageCountLimit(self, Producer);
    }
    pub inline fn GetMessageCountLimit(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetMessageCountLimit(self, Producer);
    }
    pub inline fn GetNumMessagesAllowedByStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetNumMessagesAllowedByStorageFilter(self, Producer);
    }
    pub inline fn GetNumMessagesDeniedByStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) u64 {
        return self.vtable.GetNumMessagesDeniedByStorageFilter(self, Producer);
    }
    pub inline fn AddStorageFilterEntries(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER) HRESULT {
        return self.vtable.AddStorageFilterEntries(self, Producer, pFilter);
    }
    pub inline fn GetStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER, pFilterByteLength: ?*usize) HRESULT {
        return self.vtable.GetStorageFilter(self, Producer, pFilter, pFilterByteLength);
    }
    pub inline fn ClearStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) void {
        return self.vtable.ClearStorageFilter(self, Producer);
    }
    pub inline fn PushEmptyStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushEmptyStorageFilter(self, Producer);
    }
    pub inline fn PushDenyAllStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushDenyAllStorageFilter(self, Producer);
    }
    pub inline fn PushCopyOfStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushCopyOfStorageFilter(self, Producer);
    }
    pub inline fn PushStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER) HRESULT {
        return self.vtable.PushStorageFilter(self, Producer, pFilter);
    }
    pub inline fn PopStorageFilter(self: *const IDXGIInfoQueue, Producer: Guid) void {
        return self.vtable.PopStorageFilter(self, Producer);
    }
    pub inline fn GetStorageFilterStackSize(self: *const IDXGIInfoQueue, Producer: Guid) u32 {
        return self.vtable.GetStorageFilterStackSize(self, Producer);
    }
    pub inline fn AddRetrievalFilterEntries(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER) HRESULT {
        return self.vtable.AddRetrievalFilterEntries(self, Producer, pFilter);
    }
    pub inline fn GetRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER, pFilterByteLength: ?*usize) HRESULT {
        return self.vtable.GetRetrievalFilter(self, Producer, pFilter, pFilterByteLength);
    }
    pub inline fn ClearRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid) void {
        return self.vtable.ClearRetrievalFilter(self, Producer);
    }
    pub inline fn PushEmptyRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushEmptyRetrievalFilter(self, Producer);
    }
    pub inline fn PushDenyAllRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushDenyAllRetrievalFilter(self, Producer);
    }
    pub inline fn PushCopyOfRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid) HRESULT {
        return self.vtable.PushCopyOfRetrievalFilter(self, Producer);
    }
    pub inline fn PushRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid, pFilter: ?*DXGI_INFO_QUEUE_FILTER) HRESULT {
        return self.vtable.PushRetrievalFilter(self, Producer, pFilter);
    }
    pub inline fn PopRetrievalFilter(self: *const IDXGIInfoQueue, Producer: Guid) void {
        return self.vtable.PopRetrievalFilter(self, Producer);
    }
    pub inline fn GetRetrievalFilterStackSize(self: *const IDXGIInfoQueue, Producer: Guid) u32 {
        return self.vtable.GetRetrievalFilterStackSize(self, Producer);
    }
    pub inline fn AddMessage(self: *const IDXGIInfoQueue, Producer: Guid, Category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, ID: i32, pDescription: ?[*:0]const u8) HRESULT {
        return self.vtable.AddMessage(self, Producer, Category, Severity, ID, pDescription);
    }
    pub inline fn AddApplicationMessage(self: *const IDXGIInfoQueue, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, pDescription: ?[*:0]const u8) HRESULT {
        return self.vtable.AddApplicationMessage(self, Severity, pDescription);
    }
    pub inline fn SetBreakOnCategory(self: *const IDXGIInfoQueue, Producer: Guid, Category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY, bEnable: BOOL) HRESULT {
        return self.vtable.SetBreakOnCategory(self, Producer, Category, bEnable);
    }
    pub inline fn SetBreakOnSeverity(self: *const IDXGIInfoQueue, Producer: Guid, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY, bEnable: BOOL) HRESULT {
        return self.vtable.SetBreakOnSeverity(self, Producer, Severity, bEnable);
    }
    pub inline fn SetBreakOnID(self: *const IDXGIInfoQueue, Producer: Guid, ID: i32, bEnable: BOOL) HRESULT {
        return self.vtable.SetBreakOnID(self, Producer, ID, bEnable);
    }
    pub inline fn GetBreakOnCategory(self: *const IDXGIInfoQueue, Producer: Guid, Category: DXGI_INFO_QUEUE_MESSAGE_CATEGORY) BOOL {
        return self.vtable.GetBreakOnCategory(self, Producer, Category);
    }
    pub inline fn GetBreakOnSeverity(self: *const IDXGIInfoQueue, Producer: Guid, Severity: DXGI_INFO_QUEUE_MESSAGE_SEVERITY) BOOL {
        return self.vtable.GetBreakOnSeverity(self, Producer, Severity);
    }
    pub inline fn GetBreakOnID(self: *const IDXGIInfoQueue, Producer: Guid, ID: i32) BOOL {
        return self.vtable.GetBreakOnID(self, Producer, ID);
    }
    pub inline fn SetMuteDebugOutput(self: *const IDXGIInfoQueue, Producer: Guid, bMute: BOOL) void {
        return self.vtable.SetMuteDebugOutput(self, Producer, bMute);
    }
    pub inline fn GetMuteDebugOutput(self: *const IDXGIInfoQueue, Producer: Guid) BOOL {
...
pub const IDXGIDebug = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReportLiveObjects(self: *const IDXGIDebug, apiid: Guid, flags: DXGI_DEBUG_RLO_FLAGS) HRESULT {
...
pub const IDXGIDebug1 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn EnableLeakTrackingForThread(self: *const IDXGIDebug1) void {
        return self.vtable.EnableLeakTrackingForThread(self);
    }
    pub inline fn DisableLeakTrackingForThread(self: *const IDXGIDebug1) void {
        return self.vtable.DisableLeakTrackingForThread(self);
    }
    pub inline fn IsLeakTrackingEnabledForThread(self: *const IDXGIDebug1) BOOL {
...
pub const IDXGraphicsAnalysis = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn BeginCapture(self: *const IDXGraphicsAnalysis) void {
        return self.vtable.BeginCapture(self);
    }
    pub inline fn EndCapture(self: *const IDXGraphicsAnalysis) void {
...
// TODO: this type is limited to platform 'windows10.0.17134'
pub extern "dxgi" fn DXGIDeclareAdapterRemovalSupport() callconv(.winapi) HRESULT;
