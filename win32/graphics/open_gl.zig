...
pub const GLUtessEndProc = *const fn () callconv(.winapi) void;
...
pub extern "glu32" fn gluNewQuadric() callconv(.winapi) ?*GLUquadric;
...
pub extern "glu32" fn gluNewNurbsRenderer() callconv(.winapi) ?*GLUnurbs;
