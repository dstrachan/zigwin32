...
pub const IDCompositionAnimation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IDCompositionAnimation) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn SetAbsoluteBeginTime(self: *const IDCompositionAnimation, beginTime: LARGE_INTEGER) HRESULT {
        return self.vtable.SetAbsoluteBeginTime(self, beginTime);
    }
    pub inline fn AddCubic(self: *const IDCompositionAnimation, beginOffset: f64, constantCoefficient: f32, linearCoefficient: f32, quadraticCoefficient: f32, cubicCoefficient: f32) HRESULT {
        return self.vtable.AddCubic(self, beginOffset, constantCoefficient, linearCoefficient, quadraticCoefficient, cubicCoefficient);
    }
    pub inline fn AddSinusoidal(self: *const IDCompositionAnimation, beginOffset: f64, bias: f32, amplitude: f32, frequency: f32, phase: f32) HRESULT {
        return self.vtable.AddSinusoidal(self, beginOffset, bias, amplitude, frequency, phase);
    }
    pub inline fn AddRepeat(self: *const IDCompositionAnimation, beginOffset: f64, durationToRepeat: f64) HRESULT {
        return self.vtable.AddRepeat(self, beginOffset, durationToRepeat);
    }
    pub inline fn End(self: *const IDCompositionAnimation, endOffset: f64, endValue: f32) HRESULT {
...
pub const IDCompositionDevice = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Commit(self: *const IDCompositionDevice) HRESULT {
        return self.vtable.Commit(self);
    }
    pub inline fn WaitForCommitCompletion(self: *const IDCompositionDevice) HRESULT {
        return self.vtable.WaitForCommitCompletion(self);
    }
    pub inline fn GetFrameStatistics(self: *const IDCompositionDevice, statistics: ?*DCOMPOSITION_FRAME_STATISTICS) HRESULT {
        return self.vtable.GetFrameStatistics(self, statistics);
    }
    pub inline fn CreateTargetForHwnd(self: *const IDCompositionDevice, hwnd: ?HWND, topmost: BOOL, target: ?*?*IDCompositionTarget) HRESULT {
        return self.vtable.CreateTargetForHwnd(self, hwnd, topmost, target);
    }
    pub inline fn CreateVisual(self: *const IDCompositionDevice, visual: ?*?*IDCompositionVisual) HRESULT {
        return self.vtable.CreateVisual(self, visual);
    }
    pub inline fn CreateSurface(self: *const IDCompositionDevice, width: u32, height: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, surface: ?*?*IDCompositionSurface) HRESULT {
        return self.vtable.CreateSurface(self, width, height, pixelFormat, alphaMode, surface);
    }
    pub inline fn CreateVirtualSurface(self: *const IDCompositionDevice, initialWidth: u32, initialHeight: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, virtualSurface: ?*?*IDCompositionVirtualSurface) HRESULT {
        return self.vtable.CreateVirtualSurface(self, initialWidth, initialHeight, pixelFormat, alphaMode, virtualSurface);
    }
    pub inline fn CreateSurfaceFromHandle(self: *const IDCompositionDevice, handle: ?HANDLE, surface: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateSurfaceFromHandle(self, handle, surface);
    }
    pub inline fn CreateSurfaceFromHwnd(self: *const IDCompositionDevice, hwnd: ?HWND, surface: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateSurfaceFromHwnd(self, hwnd, surface);
    }
    pub inline fn CreateTranslateTransform(self: *const IDCompositionDevice, translateTransform: ?*?*IDCompositionTranslateTransform) HRESULT {
        return self.vtable.CreateTranslateTransform(self, translateTransform);
    }
    pub inline fn CreateScaleTransform(self: *const IDCompositionDevice, scaleTransform: ?*?*IDCompositionScaleTransform) HRESULT {
        return self.vtable.CreateScaleTransform(self, scaleTransform);
    }
    pub inline fn CreateRotateTransform(self: *const IDCompositionDevice, rotateTransform: ?*?*IDCompositionRotateTransform) HRESULT {
        return self.vtable.CreateRotateTransform(self, rotateTransform);
    }
    pub inline fn CreateSkewTransform(self: *const IDCompositionDevice, skewTransform: ?*?*IDCompositionSkewTransform) HRESULT {
        return self.vtable.CreateSkewTransform(self, skewTransform);
    }
    pub inline fn CreateMatrixTransform(self: *const IDCompositionDevice, matrixTransform: ?*?*IDCompositionMatrixTransform) HRESULT {
        return self.vtable.CreateMatrixTransform(self, matrixTransform);
    }
    pub inline fn CreateTransformGroup(self: *const IDCompositionDevice, transforms: [*]?*IDCompositionTransform, elements: u32, transformGroup: ?*?*IDCompositionTransform) HRESULT {
        return self.vtable.CreateTransformGroup(self, transforms, elements, transformGroup);
    }
    pub inline fn CreateTranslateTransform3D(self: *const IDCompositionDevice, translateTransform3D: ?*?*IDCompositionTranslateTransform3D) HRESULT {
        return self.vtable.CreateTranslateTransform3D(self, translateTransform3D);
    }
    pub inline fn CreateScaleTransform3D(self: *const IDCompositionDevice, scaleTransform3D: ?*?*IDCompositionScaleTransform3D) HRESULT {
        return self.vtable.CreateScaleTransform3D(self, scaleTransform3D);
    }
    pub inline fn CreateRotateTransform3D(self: *const IDCompositionDevice, rotateTransform3D: ?*?*IDCompositionRotateTransform3D) HRESULT {
        return self.vtable.CreateRotateTransform3D(self, rotateTransform3D);
    }
    pub inline fn CreateMatrixTransform3D(self: *const IDCompositionDevice, matrixTransform3D: ?*?*IDCompositionMatrixTransform3D) HRESULT {
        return self.vtable.CreateMatrixTransform3D(self, matrixTransform3D);
    }
    pub inline fn CreateTransform3DGroup(self: *const IDCompositionDevice, transforms3D: [*]?*IDCompositionTransform3D, elements: u32, transform3DGroup: ?*?*IDCompositionTransform3D) HRESULT {
        return self.vtable.CreateTransform3DGroup(self, transforms3D, elements, transform3DGroup);
    }
    pub inline fn CreateEffectGroup(self: *const IDCompositionDevice, effectGroup: ?*?*IDCompositionEffectGroup) HRESULT {
        return self.vtable.CreateEffectGroup(self, effectGroup);
    }
    pub inline fn CreateRectangleClip(self: *const IDCompositionDevice, clip: ?*?*IDCompositionRectangleClip) HRESULT {
        return self.vtable.CreateRectangleClip(self, clip);
    }
    pub inline fn CreateAnimation(self: *const IDCompositionDevice, animation: ?*?*IDCompositionAnimation) HRESULT {
        return self.vtable.CreateAnimation(self, animation);
    }
    pub inline fn CheckDeviceState(self: *const IDCompositionDevice, pfValid: ?*BOOL) HRESULT {
...
pub const IDCompositionTarget = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetRoot(self: *const IDCompositionTarget, visual: ?*IDCompositionVisual) HRESULT {
...
pub const IDCompositionVisual = extern union {
    ...
    pub inline fn SetOffsetX_TODO_A(self: *const IDCompositionVisual, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetX_TODO_A(self, animation);
    }
    pub inline fn SetOffsetX_TODO_B(self: *const IDCompositionVisual, offsetX: f32) HRESULT {
        return self.vtable.SetOffsetX_TODO_B(self, offsetX);
    }
    pub inline fn SetOffsetY_TODO_A(self: *const IDCompositionVisual, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetY_TODO_A(self, animation);
    }
    pub inline fn SetOffsetY_TODO_B(self: *const IDCompositionVisual, offsetY: f32) HRESULT {
        return self.vtable.SetOffsetY_TODO_B(self, offsetY);
    }
    pub inline fn SetTransform_TODO_A(self: *const IDCompositionVisual, transform: ?*IDCompositionTransform) HRESULT {
        return self.vtable.SetTransform_TODO_A(self, transform);
    }
    pub inline fn SetTransform_TODO_B(self: *const IDCompositionVisual, matrix: ?*const D2D_MATRIX_3X2_F) HRESULT {
        return self.vtable.SetTransform_TODO_B(self, matrix);
    }
    pub inline fn SetTransformParent(self: *const IDCompositionVisual, visual: ?*IDCompositionVisual) HRESULT {
        return self.vtable.SetTransformParent(self, visual);
    }
    pub inline fn SetEffect(self: *const IDCompositionVisual, effect: ?*IDCompositionEffect) HRESULT {
        return self.vtable.SetEffect(self, effect);
    }
    pub inline fn SetBitmapInterpolationMode(self: *const IDCompositionVisual, interpolationMode: DCOMPOSITION_BITMAP_INTERPOLATION_MODE) HRESULT {
        return self.vtable.SetBitmapInterpolationMode(self, interpolationMode);
    }
    pub inline fn SetBorderMode(self: *const IDCompositionVisual, borderMode: DCOMPOSITION_BORDER_MODE) HRESULT {
        return self.vtable.SetBorderMode(self, borderMode);
    }
    pub inline fn SetClip_TODO_A(self: *const IDCompositionVisual, clip: ?*IDCompositionClip) HRESULT {
        return self.vtable.SetClip_TODO_A(self, clip);
    }
    pub inline fn SetClip_TODO_B(self: *const IDCompositionVisual, rect: ?*const D2D_RECT_F) HRESULT {
        return self.vtable.SetClip_TODO_B(self, rect);
    }
    pub inline fn SetContent(self: *const IDCompositionVisual, content: ?*IUnknown) HRESULT {
        return self.vtable.SetContent(self, content);
    }
    pub inline fn AddVisual(self: *const IDCompositionVisual, visual: ?*IDCompositionVisual, insertAbove: BOOL, referenceVisual: ?*IDCompositionVisual) HRESULT {
        return self.vtable.AddVisual(self, visual, insertAbove, referenceVisual);
    }
    pub inline fn RemoveVisual(self: *const IDCompositionVisual, visual: ?*IDCompositionVisual) HRESULT {
        return self.vtable.RemoveVisual(self, visual);
    }
    pub inline fn RemoveAllVisuals(self: *const IDCompositionVisual) HRESULT {
        return self.vtable.RemoveAllVisuals(self);
    }
    pub inline fn SetCompositeMode(self: *const IDCompositionVisual, compositeMode: DCOMPOSITION_COMPOSITE_MODE) HRESULT {
...
pub const IDCompositionTranslateTransform = extern union {
    ...
    pub const SetOffsetY = @compileError("COM method 'SetOffsetY' must be called using one of the following overload names: SetOffsetY_TODO_B, SetOffsetY_TODO_A");
    pub const SetOffsetX = @compileError("COM method 'SetOffsetX' must be called using one of the following overload names: SetOffsetX_TODO_A, SetOffsetX_TODO_B");
    pub inline fn SetOffsetX_TODO_A(self: *const IDCompositionTranslateTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetX_TODO_A(self, animation);
    }
    pub inline fn SetOffsetX_TODO_B(self: *const IDCompositionTranslateTransform, offsetX: f32) HRESULT {
        return self.vtable.SetOffsetX_TODO_B(self, offsetX);
    }
    pub inline fn SetOffsetY_TODO_A(self: *const IDCompositionTranslateTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetY_TODO_A(self, animation);
    }
    pub inline fn SetOffsetY_TODO_B(self: *const IDCompositionTranslateTransform, offsetY: f32) HRESULT {
        return self.vtable.SetOffsetY_TODO_B(self, offsetY);
    }
};
...
pub const IDCompositionScaleTransform = extern union {
    ...
    pub inline fn SetScaleX_TODO_A(self: *const IDCompositionScaleTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetScaleX_TODO_A(self, animation);
    }
    pub inline fn SetScaleX_TODO_B(self: *const IDCompositionScaleTransform, scaleX: f32) HRESULT {
        return self.vtable.SetScaleX_TODO_B(self, scaleX);
    }
    pub inline fn SetScaleY_TODO_A(self: *const IDCompositionScaleTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetScaleY_TODO_A(self, animation);
    }
    pub inline fn SetScaleY_TODO_B(self: *const IDCompositionScaleTransform, scaleY: f32) HRESULT {
        return self.vtable.SetScaleY_TODO_B(self, scaleY);
    }
    pub inline fn SetCenterX_TODO_A(self: *const IDCompositionScaleTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterX_TODO_A(self, animation);
    }
    pub inline fn SetCenterX_TODO_B(self: *const IDCompositionScaleTransform, centerX: f32) HRESULT {
        return self.vtable.SetCenterX_TODO_B(self, centerX);
    }
    pub inline fn SetCenterY_TODO_A(self: *const IDCompositionScaleTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterY_TODO_A(self, animation);
    }
    pub inline fn SetCenterY_TODO_B(self: *const IDCompositionScaleTransform, centerY: f32) HRESULT {
...
pub const IDCompositionRotateTransform = extern union {
    ...
    pub inline fn SetAngle_TODO_A(self: *const IDCompositionRotateTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAngle_TODO_A(self, animation);
    }
    pub inline fn SetAngle_TODO_B(self: *const IDCompositionRotateTransform, angle: f32) HRESULT {
        return self.vtable.SetAngle_TODO_B(self, angle);
    }
    pub inline fn SetCenterX_TODO_A(self: *const IDCompositionRotateTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterX_TODO_A(self, animation);
    }
    pub inline fn SetCenterX_TODO_B(self: *const IDCompositionRotateTransform, centerX: f32) HRESULT {
        return self.vtable.SetCenterX_TODO_B(self, centerX);
    }
    pub inline fn SetCenterY_TODO_A(self: *const IDCompositionRotateTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterY_TODO_A(self, animation);
    }
    pub inline fn SetCenterY_TODO_B(self: *const IDCompositionRotateTransform, centerY: f32) HRESULT {
        return self.vtable.SetCenterY_TODO_B(self, centerY);
    }
};
...
pub const IDCompositionSkewTransform = extern union {
    ...
    pub inline fn SetAngleX_TODO_A(self: *const IDCompositionSkewTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAngleX_TODO_A(self, animation);
    }
    pub inline fn SetAngleX_TODO_B(self: *const IDCompositionSkewTransform, angleX: f32) HRESULT {
        return self.vtable.SetAngleX_TODO_B(self, angleX);
    }
    pub inline fn SetAngleY_TODO_A(self: *const IDCompositionSkewTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAngleY_TODO_A(self, animation);
    }
    pub inline fn SetAngleY_TODO_B(self: *const IDCompositionSkewTransform, angleY: f32) HRESULT {
        return self.vtable.SetAngleY_TODO_B(self, angleY);
    }
    pub inline fn SetCenterX_TODO_A(self: *const IDCompositionSkewTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterX_TODO_A(self, animation);
    }
    pub inline fn SetCenterX_TODO_B(self: *const IDCompositionSkewTransform, centerX: f32) HRESULT {
        return self.vtable.SetCenterX_TODO_B(self, centerX);
    }
    pub inline fn SetCenterY_TODO_A(self: *const IDCompositionSkewTransform, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterY_TODO_A(self, animation);
    }
    pub inline fn SetCenterY_TODO_B(self: *const IDCompositionSkewTransform, centerY: f32) HRESULT {
        return self.vtable.SetCenterY_TODO_B(self, centerY);
    }
};
...
pub const IDCompositionMatrixTransform = extern union {
    ...
    pub inline fn SetMatrix(self: *const IDCompositionMatrixTransform, matrix: ?*const D2D_MATRIX_3X2_F) HRESULT {
        return self.vtable.SetMatrix(self, matrix);
    }
    pub inline fn SetMatrixElement_TODO_A(self: *const IDCompositionMatrixTransform, row: i32, column: i32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetMatrixElement_TODO_A(self, row, column, animation);
    }
    pub inline fn SetMatrixElement_TODO_B(self: *const IDCompositionMatrixTransform, row: i32, column: i32, value: f32) HRESULT {
...
pub const IDCompositionEffectGroup = extern union {
    ...
    pub inline fn SetOpacity_TODO_A(self: *const IDCompositionEffectGroup, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOpacity_TODO_A(self, animation);
    }
    pub inline fn SetOpacity_TODO_B(self: *const IDCompositionEffectGroup, opacity: f32) HRESULT {
        return self.vtable.SetOpacity_TODO_B(self, opacity);
    }
    pub inline fn SetTransform3D(self: *const IDCompositionEffectGroup, transform3D: ?*IDCompositionTransform3D) HRESULT {
...
pub const IDCompositionTranslateTransform3D = extern union {
    ...
    pub const SetOffsetX = @compileError("COM method 'SetOffsetX' must be called using one of the following overload names: SetOffsetX_TODO_A, SetOffsetX_TODO_B");
    pub inline fn SetOffsetX_TODO_A(self: *const IDCompositionTranslateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetX_TODO_A(self, animation);
    }
    pub inline fn SetOffsetX_TODO_B(self: *const IDCompositionTranslateTransform3D, offsetX: f32) HRESULT {
        return self.vtable.SetOffsetX_TODO_B(self, offsetX);
    }
    pub inline fn SetOffsetY_TODO_A(self: *const IDCompositionTranslateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetY_TODO_A(self, animation);
    }
    pub inline fn SetOffsetY_TODO_B(self: *const IDCompositionTranslateTransform3D, offsetY: f32) HRESULT {
        return self.vtable.SetOffsetY_TODO_B(self, offsetY);
    }
    pub inline fn SetOffsetZ_TODO_A(self: *const IDCompositionTranslateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetZ_TODO_A(self, animation);
    }
    pub inline fn SetOffsetZ_TODO_B(self: *const IDCompositionTranslateTransform3D, offsetZ: f32) HRESULT {
...
pub const IDCompositionScaleTransform3D = extern union {
    ...
    pub inline fn SetScaleX_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetScaleX_TODO_A(self, animation);
    }
    pub inline fn SetScaleX_TODO_B(self: *const IDCompositionScaleTransform3D, scaleX: f32) HRESULT {
        return self.vtable.SetScaleX_TODO_B(self, scaleX);
    }
    pub inline fn SetScaleY_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetScaleY_TODO_A(self, animation);
    }
    pub inline fn SetScaleY_TODO_B(self: *const IDCompositionScaleTransform3D, scaleY: f32) HRESULT {
        return self.vtable.SetScaleY_TODO_B(self, scaleY);
    }
    pub inline fn SetScaleZ_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetScaleZ_TODO_A(self, animation);
    }
    pub inline fn SetScaleZ_TODO_B(self: *const IDCompositionScaleTransform3D, scaleZ: f32) HRESULT {
        return self.vtable.SetScaleZ_TODO_B(self, scaleZ);
    }
    pub inline fn SetCenterX_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterX_TODO_A(self, animation);
    }
    pub inline fn SetCenterX_TODO_B(self: *const IDCompositionScaleTransform3D, centerX: f32) HRESULT {
        return self.vtable.SetCenterX_TODO_B(self, centerX);
    }
    pub inline fn SetCenterY_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterY_TODO_A(self, animation);
    }
    pub inline fn SetCenterY_TODO_B(self: *const IDCompositionScaleTransform3D, centerY: f32) HRESULT {
        return self.vtable.SetCenterY_TODO_B(self, centerY);
    }
    pub inline fn SetCenterZ_TODO_A(self: *const IDCompositionScaleTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterZ_TODO_A(self, animation);
    }
    pub inline fn SetCenterZ_TODO_B(self: *const IDCompositionScaleTransform3D, centerZ: f32) HRESULT {
...
pub const IDCompositionRotateTransform3D = extern union {
    ...
    pub inline fn SetAngle_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAngle_TODO_A(self, animation);
    }
    pub inline fn SetAngle_TODO_B(self: *const IDCompositionRotateTransform3D, angle: f32) HRESULT {
        return self.vtable.SetAngle_TODO_B(self, angle);
    }
    pub inline fn SetAxisX_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAxisX_TODO_A(self, animation);
    }
    pub inline fn SetAxisX_TODO_B(self: *const IDCompositionRotateTransform3D, axisX: f32) HRESULT {
        return self.vtable.SetAxisX_TODO_B(self, axisX);
    }
    pub inline fn SetAxisY_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAxisY_TODO_A(self, animation);
    }
    pub inline fn SetAxisY_TODO_B(self: *const IDCompositionRotateTransform3D, axisY: f32) HRESULT {
        return self.vtable.SetAxisY_TODO_B(self, axisY);
    }
    pub inline fn SetAxisZ_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAxisZ_TODO_A(self, animation);
    }
    pub inline fn SetAxisZ_TODO_B(self: *const IDCompositionRotateTransform3D, axisZ: f32) HRESULT {
        return self.vtable.SetAxisZ_TODO_B(self, axisZ);
    }
    pub inline fn SetCenterX_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterX_TODO_A(self, animation);
    }
    pub inline fn SetCenterX_TODO_B(self: *const IDCompositionRotateTransform3D, centerX: f32) HRESULT {
        return self.vtable.SetCenterX_TODO_B(self, centerX);
    }
    pub inline fn SetCenterY_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterY_TODO_A(self, animation);
    }
    pub inline fn SetCenterY_TODO_B(self: *const IDCompositionRotateTransform3D, centerY: f32) HRESULT {
        return self.vtable.SetCenterY_TODO_B(self, centerY);
    }
    pub inline fn SetCenterZ_TODO_A(self: *const IDCompositionRotateTransform3D, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCenterZ_TODO_A(self, animation);
    }
    pub inline fn SetCenterZ_TODO_B(self: *const IDCompositionRotateTransform3D, centerZ: f32) HRESULT {
        return self.vtable.SetCenterZ_TODO_B(self, centerZ);
    }
};
...
pub const IDCompositionMatrixTransform3D = extern union {
    ...
    IUnknown: IUnknown,
    pub const SetMatrixElement = @compileError("COM method 'SetMatrixElement' must be called using one of the following overload names: SetMatrixElement_TODO_B, SetMatrixElement_TODO_A");
    pub inline fn SetMatrix(self: *const IDCompositionMatrixTransform3D, matrix: ?*const D3DMATRIX) HRESULT {
        return self.vtable.SetMatrix(self, matrix);
    }
    pub inline fn SetMatrixElement_TODO_A(self: *const IDCompositionMatrixTransform3D, row: i32, column: i32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetMatrixElement_TODO_A(self, row, column, animation);
    }
    pub inline fn SetMatrixElement_TODO_B(self: *const IDCompositionMatrixTransform3D, row: i32, column: i32, value: f32) HRESULT {
        return self.vtable.SetMatrixElement_TODO_B(self, row, column, value);
    }
};
...
pub const IDCompositionRectangleClip = extern union {
    ...
    pub inline fn SetLeft_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetLeft_TODO_A(self, animation);
    }
    pub inline fn SetLeft_TODO_B(self: *const IDCompositionRectangleClip, left: f32) HRESULT {
        return self.vtable.SetLeft_TODO_B(self, left);
    }
    pub inline fn SetTop_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTop_TODO_A(self, animation);
    }
    pub inline fn SetTop_TODO_B(self: *const IDCompositionRectangleClip, top: f32) HRESULT {
        return self.vtable.SetTop_TODO_B(self, top);
    }
    pub inline fn SetRight_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetRight_TODO_A(self, animation);
    }
    pub inline fn SetRight_TODO_B(self: *const IDCompositionRectangleClip, right: f32) HRESULT {
        return self.vtable.SetRight_TODO_B(self, right);
    }
    pub inline fn SetBottom_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBottom_TODO_A(self, animation);
    }
    pub inline fn SetBottom_TODO_B(self: *const IDCompositionRectangleClip, bottom: f32) HRESULT {
        return self.vtable.SetBottom_TODO_B(self, bottom);
    }
    pub inline fn SetTopLeftRadiusX_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTopLeftRadiusX_TODO_A(self, animation);
    }
    pub inline fn SetTopLeftRadiusX_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetTopLeftRadiusX_TODO_B(self, radius);
    }
    pub inline fn SetTopLeftRadiusY_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTopLeftRadiusY_TODO_A(self, animation);
    }
    pub inline fn SetTopLeftRadiusY_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetTopLeftRadiusY_TODO_B(self, radius);
    }
    pub inline fn SetTopRightRadiusX_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTopRightRadiusX_TODO_A(self, animation);
    }
    pub inline fn SetTopRightRadiusX_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetTopRightRadiusX_TODO_B(self, radius);
    }
    pub inline fn SetTopRightRadiusY_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTopRightRadiusY_TODO_A(self, animation);
    }
    pub inline fn SetTopRightRadiusY_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetTopRightRadiusY_TODO_B(self, radius);
    }
    pub inline fn SetBottomLeftRadiusX_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBottomLeftRadiusX_TODO_A(self, animation);
    }
    pub inline fn SetBottomLeftRadiusX_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetBottomLeftRadiusX_TODO_B(self, radius);
    }
    pub inline fn SetBottomLeftRadiusY_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBottomLeftRadiusY_TODO_A(self, animation);
    }
    pub inline fn SetBottomLeftRadiusY_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetBottomLeftRadiusY_TODO_B(self, radius);
    }
    pub inline fn SetBottomRightRadiusX_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBottomRightRadiusX_TODO_A(self, animation);
    }
    pub inline fn SetBottomRightRadiusX_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
        return self.vtable.SetBottomRightRadiusX_TODO_B(self, radius);
    }
    pub inline fn SetBottomRightRadiusY_TODO_A(self: *const IDCompositionRectangleClip, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBottomRightRadiusY_TODO_A(self, animation);
    }
    pub inline fn SetBottomRightRadiusY_TODO_B(self: *const IDCompositionRectangleClip, radius: f32) HRESULT {
...
pub const IDCompositionSurface = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn BeginDraw(self: *const IDCompositionSurface, updateRect: ?*const RECT, iid: ?*const Guid, updateObject: ?*?*anyopaque, updateOffset: ?*POINT) HRESULT {
        return self.vtable.BeginDraw(self, updateRect, iid, updateObject, updateOffset);
    }
    pub inline fn EndDraw(self: *const IDCompositionSurface) HRESULT {
        return self.vtable.EndDraw(self);
    }
    pub inline fn SuspendDraw(self: *const IDCompositionSurface) HRESULT {
        return self.vtable.SuspendDraw(self);
    }
    pub inline fn ResumeDraw(self: *const IDCompositionSurface) HRESULT {
        return self.vtable.ResumeDraw(self);
    }
    pub inline fn Scroll(self: *const IDCompositionSurface, scrollRect: ?*const RECT, clipRect: ?*const RECT, offsetX: i32, offsetY: i32) HRESULT {
...
pub const IDCompositionVirtualSurface = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Resize(self: *const IDCompositionVirtualSurface, width: u32, height: u32) HRESULT {
        return self.vtable.Resize(self, width, height);
    }
    pub inline fn Trim(self: *const IDCompositionVirtualSurface, rectangles: ?[*]const RECT, count: u32) HRESULT {
...
pub const IDCompositionDevice2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Commit(self: *const IDCompositionDevice2) HRESULT {
        return self.vtable.Commit(self);
    }
    pub inline fn WaitForCommitCompletion(self: *const IDCompositionDevice2) HRESULT {
        return self.vtable.WaitForCommitCompletion(self);
    }
    pub inline fn GetFrameStatistics(self: *const IDCompositionDevice2, statistics: ?*DCOMPOSITION_FRAME_STATISTICS) HRESULT {
        return self.vtable.GetFrameStatistics(self, statistics);
    }
    pub inline fn CreateVisual(self: *const IDCompositionDevice2, visual: ?*?*IDCompositionVisual2) HRESULT {
        return self.vtable.CreateVisual(self, visual);
    }
    pub inline fn CreateSurfaceFactory(self: *const IDCompositionDevice2, renderingDevice: ?*IUnknown, surfaceFactory: ?*?*IDCompositionSurfaceFactory) HRESULT {
        return self.vtable.CreateSurfaceFactory(self, renderingDevice, surfaceFactory);
    }
    pub inline fn CreateSurface(self: *const IDCompositionDevice2, width: u32, height: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, surface: ?*?*IDCompositionSurface) HRESULT {
        return self.vtable.CreateSurface(self, width, height, pixelFormat, alphaMode, surface);
    }
    pub inline fn CreateVirtualSurface(self: *const IDCompositionDevice2, initialWidth: u32, initialHeight: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, virtualSurface: ?*?*IDCompositionVirtualSurface) HRESULT {
        return self.vtable.CreateVirtualSurface(self, initialWidth, initialHeight, pixelFormat, alphaMode, virtualSurface);
    }
    pub inline fn CreateTranslateTransform(self: *const IDCompositionDevice2, translateTransform: ?*?*IDCompositionTranslateTransform) HRESULT {
        return self.vtable.CreateTranslateTransform(self, translateTransform);
    }
    pub inline fn CreateScaleTransform(self: *const IDCompositionDevice2, scaleTransform: ?*?*IDCompositionScaleTransform) HRESULT {
        return self.vtable.CreateScaleTransform(self, scaleTransform);
    }
    pub inline fn CreateRotateTransform(self: *const IDCompositionDevice2, rotateTransform: ?*?*IDCompositionRotateTransform) HRESULT {
        return self.vtable.CreateRotateTransform(self, rotateTransform);
    }
    pub inline fn CreateSkewTransform(self: *const IDCompositionDevice2, skewTransform: ?*?*IDCompositionSkewTransform) HRESULT {
        return self.vtable.CreateSkewTransform(self, skewTransform);
    }
    pub inline fn CreateMatrixTransform(self: *const IDCompositionDevice2, matrixTransform: ?*?*IDCompositionMatrixTransform) HRESULT {
        return self.vtable.CreateMatrixTransform(self, matrixTransform);
    }
    pub inline fn CreateTransformGroup(self: *const IDCompositionDevice2, transforms: [*]?*IDCompositionTransform, elements: u32, transformGroup: ?*?*IDCompositionTransform) HRESULT {
        return self.vtable.CreateTransformGroup(self, transforms, elements, transformGroup);
    }
    pub inline fn CreateTranslateTransform3D(self: *const IDCompositionDevice2, translateTransform3D: ?*?*IDCompositionTranslateTransform3D) HRESULT {
        return self.vtable.CreateTranslateTransform3D(self, translateTransform3D);
    }
    pub inline fn CreateScaleTransform3D(self: *const IDCompositionDevice2, scaleTransform3D: ?*?*IDCompositionScaleTransform3D) HRESULT {
        return self.vtable.CreateScaleTransform3D(self, scaleTransform3D);
    }
    pub inline fn CreateRotateTransform3D(self: *const IDCompositionDevice2, rotateTransform3D: ?*?*IDCompositionRotateTransform3D) HRESULT {
        return self.vtable.CreateRotateTransform3D(self, rotateTransform3D);
    }
    pub inline fn CreateMatrixTransform3D(self: *const IDCompositionDevice2, matrixTransform3D: ?*?*IDCompositionMatrixTransform3D) HRESULT {
        return self.vtable.CreateMatrixTransform3D(self, matrixTransform3D);
    }
    pub inline fn CreateTransform3DGroup(self: *const IDCompositionDevice2, transforms3D: [*]?*IDCompositionTransform3D, elements: u32, transform3DGroup: ?*?*IDCompositionTransform3D) HRESULT {
        return self.vtable.CreateTransform3DGroup(self, transforms3D, elements, transform3DGroup);
    }
    pub inline fn CreateEffectGroup(self: *const IDCompositionDevice2, effectGroup: ?*?*IDCompositionEffectGroup) HRESULT {
        return self.vtable.CreateEffectGroup(self, effectGroup);
    }
    pub inline fn CreateRectangleClip(self: *const IDCompositionDevice2, clip: ?*?*IDCompositionRectangleClip) HRESULT {
        return self.vtable.CreateRectangleClip(self, clip);
    }
    pub inline fn CreateAnimation(self: *const IDCompositionDevice2, animation: ?*?*IDCompositionAnimation) HRESULT {
        return self.vtable.CreateAnimation(self, animation);
    }
};
...
pub const IDCompositionDesktopDevice = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateTargetForHwnd(self: *const IDCompositionDesktopDevice, hwnd: ?HWND, topmost: BOOL, target: ?*?*IDCompositionTarget) HRESULT {
        return self.vtable.CreateTargetForHwnd(self, hwnd, topmost, target);
    }
    pub inline fn CreateSurfaceFromHandle(self: *const IDCompositionDesktopDevice, handle: ?HANDLE, surface: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateSurfaceFromHandle(self, handle, surface);
    }
    pub inline fn CreateSurfaceFromHwnd(self: *const IDCompositionDesktopDevice, hwnd: ?HWND, surface: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateSurfaceFromHwnd(self, hwnd, surface);
    }
};
...
pub const IDCompositionDeviceDebug = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn EnableDebugCounters(self: *const IDCompositionDeviceDebug) HRESULT {
        return self.vtable.EnableDebugCounters(self);
    }
    pub inline fn DisableDebugCounters(self: *const IDCompositionDeviceDebug) HRESULT {
...
pub const IDCompositionSurfaceFactory = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateSurface(self: *const IDCompositionSurfaceFactory, width: u32, height: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, surface: ?*?*IDCompositionSurface) HRESULT {
        return self.vtable.CreateSurface(self, width, height, pixelFormat, alphaMode, surface);
    }
    pub inline fn CreateVirtualSurface(self: *const IDCompositionSurfaceFactory, initialWidth: u32, initialHeight: u32, pixelFormat: DXGI_FORMAT, alphaMode: DXGI_ALPHA_MODE, virtualSurface: ?*?*IDCompositionVirtualSurface) HRESULT {
        return self.vtable.CreateVirtualSurface(self, initialWidth, initialHeight, pixelFormat, alphaMode, virtualSurface);
    }
};
...
pub const IDCompositionVisual2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetOpacityMode(self: *const IDCompositionVisual2, mode: DCOMPOSITION_OPACITY_MODE) HRESULT {
        return self.vtable.SetOpacityMode(self, mode);
    }
    pub inline fn SetBackFaceVisibility(self: *const IDCompositionVisual2, visibility: DCOMPOSITION_BACKFACE_VISIBILITY) HRESULT {
...
pub const IDCompositionVisualDebug = extern union {
    ...
    IDCompositionVisual: IDCompositionVisual,
    IUnknown: IUnknown,
    pub inline fn EnableHeatMap(self: *const IDCompositionVisualDebug, color: ?*const D2D_COLOR_F) HRESULT {
        return self.vtable.EnableHeatMap(self, color);
    }
    pub inline fn DisableHeatMap(self: *const IDCompositionVisualDebug) HRESULT {
        return self.vtable.DisableHeatMap(self);
    }
    pub inline fn EnableRedrawRegions(self: *const IDCompositionVisualDebug) HRESULT {
        return self.vtable.EnableRedrawRegions(self);
    }
    pub inline fn DisableRedrawRegions(self: *const IDCompositionVisualDebug) HRESULT {
...
pub const IDCompositionVisual3 = extern union {
    ...
    pub const SetOpacity = @compileError("COM method 'SetOpacity' must be called using one of the following overload names: SetOpacity_TODO_A, SetOpacity_TODO_B");
    pub inline fn SetDepthMode(self: *const IDCompositionVisual3, mode: DCOMPOSITION_DEPTH_MODE) HRESULT {
        return self.vtable.SetDepthMode(self, mode);
    }
    pub inline fn SetOffsetZ_TODO_A(self: *const IDCompositionVisual3, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOffsetZ_TODO_A(self, animation);
    }
    pub inline fn SetOffsetZ_TODO_B(self: *const IDCompositionVisual3, offsetZ: f32) HRESULT {
        return self.vtable.SetOffsetZ_TODO_B(self, offsetZ);
    }
    pub inline fn SetOpacity_TODO_A(self: *const IDCompositionVisual3, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetOpacity_TODO_A(self, animation);
    }
    pub inline fn SetOpacity_TODO_B(self: *const IDCompositionVisual3, opacity: f32) HRESULT {
        return self.vtable.SetOpacity_TODO_B(self, opacity);
    }
    pub inline fn SetTransform_TODO_A(self: *const IDCompositionVisual3, transform: ?*IDCompositionTransform3D) HRESULT {
        return self.vtable.SetTransform_TODO_A(self, transform);
    }
    pub inline fn SetTransform_TODO_B(self: *const IDCompositionVisual3, matrix: ?*const D2D_MATRIX_4X4_F) HRESULT {
        return self.vtable.SetTransform_TODO_B(self, matrix);
    }
    pub inline fn SetVisible(self: *const IDCompositionVisual3, visible: BOOL) HRESULT {
...
pub const IDCompositionDevice3 = extern union {
    ...
    IDCompositionDevice2: IDCompositionDevice2,
    IUnknown: IUnknown,
    pub inline fn CreateGaussianBlurEffect(self: *const IDCompositionDevice3, gaussianBlurEffect: ?*?*IDCompositionGaussianBlurEffect) HRESULT {
        return self.vtable.CreateGaussianBlurEffect(self, gaussianBlurEffect);
    }
    pub inline fn CreateBrightnessEffect(self: *const IDCompositionDevice3, brightnessEffect: ?*?*IDCompositionBrightnessEffect) HRESULT {
        return self.vtable.CreateBrightnessEffect(self, brightnessEffect);
    }
    pub inline fn CreateColorMatrixEffect(self: *const IDCompositionDevice3, colorMatrixEffect: ?*?*IDCompositionColorMatrixEffect) HRESULT {
        return self.vtable.CreateColorMatrixEffect(self, colorMatrixEffect);
    }
    pub inline fn CreateShadowEffect(self: *const IDCompositionDevice3, shadowEffect: ?*?*IDCompositionShadowEffect) HRESULT {
        return self.vtable.CreateShadowEffect(self, shadowEffect);
    }
    pub inline fn CreateHueRotationEffect(self: *const IDCompositionDevice3, hueRotationEffect: ?*?*IDCompositionHueRotationEffect) HRESULT {
        return self.vtable.CreateHueRotationEffect(self, hueRotationEffect);
    }
    pub inline fn CreateSaturationEffect(self: *const IDCompositionDevice3, saturationEffect: ?*?*IDCompositionSaturationEffect) HRESULT {
        return self.vtable.CreateSaturationEffect(self, saturationEffect);
    }
    pub inline fn CreateTurbulenceEffect(self: *const IDCompositionDevice3, turbulenceEffect: ?*?*IDCompositionTurbulenceEffect) HRESULT {
        return self.vtable.CreateTurbulenceEffect(self, turbulenceEffect);
    }
    pub inline fn CreateLinearTransferEffect(self: *const IDCompositionDevice3, linearTransferEffect: ?*?*IDCompositionLinearTransferEffect) HRESULT {
        return self.vtable.CreateLinearTransferEffect(self, linearTransferEffect);
    }
    pub inline fn CreateTableTransferEffect(self: *const IDCompositionDevice3, tableTransferEffect: ?*?*IDCompositionTableTransferEffect) HRESULT {
        return self.vtable.CreateTableTransferEffect(self, tableTransferEffect);
    }
    pub inline fn CreateCompositeEffect(self: *const IDCompositionDevice3, compositeEffect: ?*?*IDCompositionCompositeEffect) HRESULT {
        return self.vtable.CreateCompositeEffect(self, compositeEffect);
    }
    pub inline fn CreateBlendEffect(self: *const IDCompositionDevice3, blendEffect: ?*?*IDCompositionBlendEffect) HRESULT {
        return self.vtable.CreateBlendEffect(self, blendEffect);
    }
    pub inline fn CreateArithmeticCompositeEffect(self: *const IDCompositionDevice3, arithmeticCompositeEffect: ?*?*IDCompositionArithmeticCompositeEffect) HRESULT {
        return self.vtable.CreateArithmeticCompositeEffect(self, arithmeticCompositeEffect);
    }
    pub inline fn CreateAffineTransform2DEffect(self: *const IDCompositionDevice3, affineTransform2dEffect: ?*?*IDCompositionAffineTransform2DEffect) HRESULT {
...
pub const IDCompositionFilterEffect = extern union {
    ...
    IDCompositionEffect: IDCompositionEffect,
    IUnknown: IUnknown,
    pub inline fn SetInput(self: *const IDCompositionFilterEffect, index: u32, input: ?*IUnknown, flags: u32) HRESULT {
...
pub const IDCompositionGaussianBlurEffect = extern union {
    ...
    pub inline fn SetStandardDeviation_TODO_A(self: *const IDCompositionGaussianBlurEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetStandardDeviation_TODO_A(self, animation);
    }
    pub inline fn SetStandardDeviation_TODO_B(self: *const IDCompositionGaussianBlurEffect, amount: f32) HRESULT {
        return self.vtable.SetStandardDeviation_TODO_B(self, amount);
    }
    pub inline fn SetBorderMode(self: *const IDCompositionGaussianBlurEffect, mode: D2D1_BORDER_MODE) HRESULT {
...
pub const IDCompositionBrightnessEffect = extern union {
    ...
    pub inline fn SetWhitePoint(self: *const IDCompositionBrightnessEffect, whitePoint: ?*const D2D_VECTOR_2F) HRESULT {
        return self.vtable.SetWhitePoint(self, whitePoint);
    }
    pub inline fn SetBlackPoint(self: *const IDCompositionBrightnessEffect, blackPoint: ?*const D2D_VECTOR_2F) HRESULT {
        return self.vtable.SetBlackPoint(self, blackPoint);
    }
    pub inline fn SetWhitePointX_TODO_A(self: *const IDCompositionBrightnessEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetWhitePointX_TODO_A(self, animation);
    }
    pub inline fn SetWhitePointX_TODO_B(self: *const IDCompositionBrightnessEffect, whitePointX: f32) HRESULT {
        return self.vtable.SetWhitePointX_TODO_B(self, whitePointX);
    }
    pub inline fn SetWhitePointY_TODO_A(self: *const IDCompositionBrightnessEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetWhitePointY_TODO_A(self, animation);
    }
    pub inline fn SetWhitePointY_TODO_B(self: *const IDCompositionBrightnessEffect, whitePointY: f32) HRESULT {
        return self.vtable.SetWhitePointY_TODO_B(self, whitePointY);
    }
    pub inline fn SetBlackPointX_TODO_A(self: *const IDCompositionBrightnessEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlackPointX_TODO_A(self, animation);
    }
    pub inline fn SetBlackPointX_TODO_B(self: *const IDCompositionBrightnessEffect, blackPointX: f32) HRESULT {
        return self.vtable.SetBlackPointX_TODO_B(self, blackPointX);
    }
    pub inline fn SetBlackPointY_TODO_A(self: *const IDCompositionBrightnessEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlackPointY_TODO_A(self, animation);
    }
    pub inline fn SetBlackPointY_TODO_B(self: *const IDCompositionBrightnessEffect, blackPointY: f32) HRESULT {
...
pub const IDCompositionColorMatrixEffect = extern union {
    ...
    IUnknown: IUnknown,
    pub const SetMatrixElement = @compileError("COM method 'SetMatrixElement' must be called using one of the following overload names: SetMatrixElement_TODO_B, SetMatrixElement_TODO_A");
    pub inline fn SetMatrix(self: *const IDCompositionColorMatrixEffect, matrix: ?*const D2D_MATRIX_5X4_F) HRESULT {
        return self.vtable.SetMatrix(self, matrix);
    }
    pub inline fn SetMatrixElement_TODO_A(self: *const IDCompositionColorMatrixEffect, row: i32, column: i32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetMatrixElement_TODO_A(self, row, column, animation);
    }
    pub inline fn SetMatrixElement_TODO_B(self: *const IDCompositionColorMatrixEffect, row: i32, column: i32, value: f32) HRESULT {
        return self.vtable.SetMatrixElement_TODO_B(self, row, column, value);
    }
    pub inline fn SetAlphaMode(self: *const IDCompositionColorMatrixEffect, mode: D2D1_COLORMATRIX_ALPHA_MODE) HRESULT {
        return self.vtable.SetAlphaMode(self, mode);
    }
    pub inline fn SetClampOutput(self: *const IDCompositionColorMatrixEffect, clamp: BOOL) HRESULT {
...
pub const IDCompositionShadowEffect = extern union {
    ...
    pub inline fn SetStandardDeviation_TODO_A(self: *const IDCompositionShadowEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetStandardDeviation_TODO_A(self, animation);
    }
    pub inline fn SetStandardDeviation_TODO_B(self: *const IDCompositionShadowEffect, amount: f32) HRESULT {
        return self.vtable.SetStandardDeviation_TODO_B(self, amount);
    }
    pub inline fn SetColor(self: *const IDCompositionShadowEffect, color: ?*const D2D_VECTOR_4F) HRESULT {
        return self.vtable.SetColor(self, color);
    }
    pub inline fn SetRed_TODO_A(self: *const IDCompositionShadowEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetRed_TODO_A(self, animation);
    }
    pub inline fn SetRed_TODO_B(self: *const IDCompositionShadowEffect, amount: f32) HRESULT {
        return self.vtable.SetRed_TODO_B(self, amount);
    }
    pub inline fn SetGreen_TODO_A(self: *const IDCompositionShadowEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetGreen_TODO_A(self, animation);
    }
    pub inline fn SetGreen_TODO_B(self: *const IDCompositionShadowEffect, amount: f32) HRESULT {
        return self.vtable.SetGreen_TODO_B(self, amount);
    }
    pub inline fn SetBlue_TODO_A(self: *const IDCompositionShadowEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlue_TODO_A(self, animation);
    }
    pub inline fn SetBlue_TODO_B(self: *const IDCompositionShadowEffect, amount: f32) HRESULT {
        return self.vtable.SetBlue_TODO_B(self, amount);
    }
    pub inline fn SetAlpha_TODO_A(self: *const IDCompositionShadowEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAlpha_TODO_A(self, animation);
    }
    pub inline fn SetAlpha_TODO_B(self: *const IDCompositionShadowEffect, amount: f32) HRESULT {
...
pub const IDCompositionHueRotationEffect = extern union {
    ...
    IUnknown: IUnknown,
    pub const SetAngle = @compileError("COM method 'SetAngle' must be called using one of the following overload names: SetAngle_TODO_A, SetAngle_TODO_B");
    pub inline fn SetAngle_TODO_A(self: *const IDCompositionHueRotationEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAngle_TODO_A(self, animation);
    }
    pub inline fn SetAngle_TODO_B(self: *const IDCompositionHueRotationEffect, amountDegrees: f32) HRESULT {
...
pub const IDCompositionSaturationEffect = extern union {
    ...
    pub inline fn SetSaturation_TODO_A(self: *const IDCompositionSaturationEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetSaturation_TODO_A(self, animation);
    }
    pub inline fn SetSaturation_TODO_B(self: *const IDCompositionSaturationEffect, ratio: f32) HRESULT {
...
pub const IDCompositionTurbulenceEffect = extern union {
    ...
    IDCompositionEffect: IDCompositionEffect,
    IUnknown: IUnknown,
    pub inline fn SetOffset(self: *const IDCompositionTurbulenceEffect, offset: ?*const D2D_VECTOR_2F) HRESULT {
        return self.vtable.SetOffset(self, offset);
    }
    pub inline fn SetBaseFrequency(self: *const IDCompositionTurbulenceEffect, frequency: ?*const D2D_VECTOR_2F) HRESULT {
        return self.vtable.SetBaseFrequency(self, frequency);
    }
    pub inline fn SetSize(self: *const IDCompositionTurbulenceEffect, size: ?*const D2D_VECTOR_2F) HRESULT {
        return self.vtable.SetSize(self, size);
    }
    pub inline fn SetNumOctaves(self: *const IDCompositionTurbulenceEffect, numOctaves: u32) HRESULT {
        return self.vtable.SetNumOctaves(self, numOctaves);
    }
    pub inline fn SetSeed(self: *const IDCompositionTurbulenceEffect, seed: u32) HRESULT {
        return self.vtable.SetSeed(self, seed);
    }
    pub inline fn SetNoise(self: *const IDCompositionTurbulenceEffect, noise: D2D1_TURBULENCE_NOISE) HRESULT {
        return self.vtable.SetNoise(self, noise);
    }
    pub inline fn SetStitchable(self: *const IDCompositionTurbulenceEffect, stitchable: BOOL) HRESULT {
...
pub const IDCompositionLinearTransferEffect = extern union {
    ...
    pub inline fn SetRedYIntercept_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetRedYIntercept_TODO_A(self, animation);
    }
    pub inline fn SetRedYIntercept_TODO_B(self: *const IDCompositionLinearTransferEffect, redYIntercept: f32) HRESULT {
        return self.vtable.SetRedYIntercept_TODO_B(self, redYIntercept);
    }
    pub inline fn SetRedSlope_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetRedSlope_TODO_A(self, animation);
    }
    pub inline fn SetRedSlope_TODO_B(self: *const IDCompositionLinearTransferEffect, redSlope: f32) HRESULT {
        return self.vtable.SetRedSlope_TODO_B(self, redSlope);
    }
    pub inline fn SetRedDisable(self: *const IDCompositionLinearTransferEffect, redDisable: BOOL) HRESULT {
        return self.vtable.SetRedDisable(self, redDisable);
    }
    pub inline fn SetGreenYIntercept_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetGreenYIntercept_TODO_A(self, animation);
    }
    pub inline fn SetGreenYIntercept_TODO_B(self: *const IDCompositionLinearTransferEffect, greenYIntercept: f32) HRESULT {
        return self.vtable.SetGreenYIntercept_TODO_B(self, greenYIntercept);
    }
    pub inline fn SetGreenSlope_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetGreenSlope_TODO_A(self, animation);
    }
    pub inline fn SetGreenSlope_TODO_B(self: *const IDCompositionLinearTransferEffect, greenSlope: f32) HRESULT {
        return self.vtable.SetGreenSlope_TODO_B(self, greenSlope);
    }
    pub inline fn SetGreenDisable(self: *const IDCompositionLinearTransferEffect, greenDisable: BOOL) HRESULT {
        return self.vtable.SetGreenDisable(self, greenDisable);
    }
    pub inline fn SetBlueYIntercept_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlueYIntercept_TODO_A(self, animation);
    }
    pub inline fn SetBlueYIntercept_TODO_B(self: *const IDCompositionLinearTransferEffect, blueYIntercept: f32) HRESULT {
        return self.vtable.SetBlueYIntercept_TODO_B(self, blueYIntercept);
    }
    pub inline fn SetBlueSlope_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlueSlope_TODO_A(self, animation);
    }
    pub inline fn SetBlueSlope_TODO_B(self: *const IDCompositionLinearTransferEffect, blueSlope: f32) HRESULT {
        return self.vtable.SetBlueSlope_TODO_B(self, blueSlope);
    }
    pub inline fn SetBlueDisable(self: *const IDCompositionLinearTransferEffect, blueDisable: BOOL) HRESULT {
        return self.vtable.SetBlueDisable(self, blueDisable);
    }
    pub inline fn SetAlphaYIntercept_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAlphaYIntercept_TODO_A(self, animation);
    }
    pub inline fn SetAlphaYIntercept_TODO_B(self: *const IDCompositionLinearTransferEffect, alphaYIntercept: f32) HRESULT {
        return self.vtable.SetAlphaYIntercept_TODO_B(self, alphaYIntercept);
    }
    pub inline fn SetAlphaSlope_TODO_A(self: *const IDCompositionLinearTransferEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAlphaSlope_TODO_A(self, animation);
    }
    pub inline fn SetAlphaSlope_TODO_B(self: *const IDCompositionLinearTransferEffect, alphaSlope: f32) HRESULT {
        return self.vtable.SetAlphaSlope_TODO_B(self, alphaSlope);
    }
    pub inline fn SetAlphaDisable(self: *const IDCompositionLinearTransferEffect, alphaDisable: BOOL) HRESULT {
        return self.vtable.SetAlphaDisable(self, alphaDisable);
    }
    pub inline fn SetClampOutput(self: *const IDCompositionLinearTransferEffect, clampOutput: BOOL) HRESULT {
...
pub const IDCompositionTableTransferEffect = extern union {
    ...
    pub inline fn SetRedTable(self: *const IDCompositionTableTransferEffect, tableValues: [*]const f32, count: u32) HRESULT {
        return self.vtable.SetRedTable(self, tableValues, count);
    }
    pub inline fn SetGreenTable(self: *const IDCompositionTableTransferEffect, tableValues: [*]const f32, count: u32) HRESULT {
        return self.vtable.SetGreenTable(self, tableValues, count);
    }
    pub inline fn SetBlueTable(self: *const IDCompositionTableTransferEffect, tableValues: [*]const f32, count: u32) HRESULT {
        return self.vtable.SetBlueTable(self, tableValues, count);
    }
    pub inline fn SetAlphaTable(self: *const IDCompositionTableTransferEffect, tableValues: [*]const f32, count: u32) HRESULT {
        return self.vtable.SetAlphaTable(self, tableValues, count);
    }
    pub inline fn SetRedDisable(self: *const IDCompositionTableTransferEffect, redDisable: BOOL) HRESULT {
        return self.vtable.SetRedDisable(self, redDisable);
    }
    pub inline fn SetGreenDisable(self: *const IDCompositionTableTransferEffect, greenDisable: BOOL) HRESULT {
        return self.vtable.SetGreenDisable(self, greenDisable);
    }
    pub inline fn SetBlueDisable(self: *const IDCompositionTableTransferEffect, blueDisable: BOOL) HRESULT {
        return self.vtable.SetBlueDisable(self, blueDisable);
    }
    pub inline fn SetAlphaDisable(self: *const IDCompositionTableTransferEffect, alphaDisable: BOOL) HRESULT {
        return self.vtable.SetAlphaDisable(self, alphaDisable);
    }
    pub inline fn SetClampOutput(self: *const IDCompositionTableTransferEffect, clampOutput: BOOL) HRESULT {
        return self.vtable.SetClampOutput(self, clampOutput);
    }
    pub inline fn SetRedTableValue_TODO_A(self: *const IDCompositionTableTransferEffect, index: u32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetRedTableValue_TODO_A(self, index, animation);
    }
    pub inline fn SetRedTableValue_TODO_B(self: *const IDCompositionTableTransferEffect, index: u32, value: f32) HRESULT {
        return self.vtable.SetRedTableValue_TODO_B(self, index, value);
    }
    pub inline fn SetGreenTableValue_TODO_A(self: *const IDCompositionTableTransferEffect, index: u32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetGreenTableValue_TODO_A(self, index, animation);
    }
    pub inline fn SetGreenTableValue_TODO_B(self: *const IDCompositionTableTransferEffect, index: u32, value: f32) HRESULT {
        return self.vtable.SetGreenTableValue_TODO_B(self, index, value);
    }
    pub inline fn SetBlueTableValue_TODO_A(self: *const IDCompositionTableTransferEffect, index: u32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetBlueTableValue_TODO_A(self, index, animation);
    }
    pub inline fn SetBlueTableValue_TODO_B(self: *const IDCompositionTableTransferEffect, index: u32, value: f32) HRESULT {
        return self.vtable.SetBlueTableValue_TODO_B(self, index, value);
    }
    pub inline fn SetAlphaTableValue_TODO_A(self: *const IDCompositionTableTransferEffect, index: u32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetAlphaTableValue_TODO_A(self, index, animation);
    }
    pub inline fn SetAlphaTableValue_TODO_B(self: *const IDCompositionTableTransferEffect, index: u32, value: f32) HRESULT {
...
pub const IDCompositionCompositeEffect = extern union {
    ...
    IDCompositionEffect: IDCompositionEffect,
    IUnknown: IUnknown,
    pub inline fn SetMode(self: *const IDCompositionCompositeEffect, mode: D2D1_COMPOSITE_MODE) HRESULT {
...
pub const IDCompositionBlendEffect = extern union {
    ...
    IDCompositionEffect: IDCompositionEffect,
    IUnknown: IUnknown,
    pub inline fn SetMode(self: *const IDCompositionBlendEffect, mode: D2D1_BLEND_MODE) HRESULT {
        return self.vtable.SetMode(self, mode);
    }
};
...
pub const IDCompositionArithmeticCompositeEffect = extern union {
    ...
    pub inline fn SetCoefficients(self: *const IDCompositionArithmeticCompositeEffect, coefficients: ?*const D2D_VECTOR_4F) HRESULT {
        return self.vtable.SetCoefficients(self, coefficients);
    }
    pub inline fn SetClampOutput(self: *const IDCompositionArithmeticCompositeEffect, clampoutput: BOOL) HRESULT {
        return self.vtable.SetClampOutput(self, clampoutput);
    }
    pub inline fn SetCoefficient1_TODO_A(self: *const IDCompositionArithmeticCompositeEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCoefficient1_TODO_A(self, animation);
    }
    pub inline fn SetCoefficient1_TODO_B(self: *const IDCompositionArithmeticCompositeEffect, Coeffcient1: f32) HRESULT {
        return self.vtable.SetCoefficient1_TODO_B(self, Coeffcient1);
    }
    pub inline fn SetCoefficient2_TODO_A(self: *const IDCompositionArithmeticCompositeEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCoefficient2_TODO_A(self, animation);
    }
    pub inline fn SetCoefficient2_TODO_B(self: *const IDCompositionArithmeticCompositeEffect, Coefficient2: f32) HRESULT {
        return self.vtable.SetCoefficient2_TODO_B(self, Coefficient2);
    }
    pub inline fn SetCoefficient3_TODO_A(self: *const IDCompositionArithmeticCompositeEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCoefficient3_TODO_A(self, animation);
    }
    pub inline fn SetCoefficient3_TODO_B(self: *const IDCompositionArithmeticCompositeEffect, Coefficient3: f32) HRESULT {
        return self.vtable.SetCoefficient3_TODO_B(self, Coefficient3);
    }
    pub inline fn SetCoefficient4_TODO_A(self: *const IDCompositionArithmeticCompositeEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetCoefficient4_TODO_A(self, animation);
    }
    pub inline fn SetCoefficient4_TODO_B(self: *const IDCompositionArithmeticCompositeEffect, Coefficient4: f32) HRESULT {
...
pub const IDCompositionAffineTransform2DEffect = extern union {
    ...
    pub inline fn SetInterpolationMode(self: *const IDCompositionAffineTransform2DEffect, interpolationMode: D2D1_2DAFFINETRANSFORM_INTERPOLATION_MODE) HRESULT {
        return self.vtable.SetInterpolationMode(self, interpolationMode);
    }
    pub inline fn SetBorderMode(self: *const IDCompositionAffineTransform2DEffect, borderMode: D2D1_BORDER_MODE) HRESULT {
        return self.vtable.SetBorderMode(self, borderMode);
    }
    pub inline fn SetTransformMatrix(self: *const IDCompositionAffineTransform2DEffect, transformMatrix: ?*const D2D_MATRIX_3X2_F) HRESULT {
        return self.vtable.SetTransformMatrix(self, transformMatrix);
    }
    pub inline fn SetTransformMatrixElement_TODO_A(self: *const IDCompositionAffineTransform2DEffect, row: i32, column: i32, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetTransformMatrixElement_TODO_A(self, row, column, animation);
    }
    pub inline fn SetTransformMatrixElement_TODO_B(self: *const IDCompositionAffineTransform2DEffect, row: i32, column: i32, value: f32) HRESULT {
        return self.vtable.SetTransformMatrixElement_TODO_B(self, row, column, value);
    }
    pub inline fn SetSharpness_TODO_A(self: *const IDCompositionAffineTransform2DEffect, animation: ?*IDCompositionAnimation) HRESULT {
        return self.vtable.SetSharpness_TODO_A(self, animation);
    }
    pub inline fn SetSharpness_TODO_B(self: *const IDCompositionAffineTransform2DEffect, sharpness: f32) HRESULT {
...
pub const IDCompositionDelegatedInkTrail = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddTrailPoints(self: *const IDCompositionDelegatedInkTrail, inkPoints: [*]const DCompositionInkTrailPoint, inkPointsCount: u32, generationId: ?*u32) HRESULT {
        return self.vtable.AddTrailPoints(self, inkPoints, inkPointsCount, generationId);
    }
    pub inline fn AddTrailPointsWithPrediction(self: *const IDCompositionDelegatedInkTrail, inkPoints: [*]const DCompositionInkTrailPoint, inkPointsCount: u32, predictedInkPoints: [*]const DCompositionInkTrailPoint, predictedInkPointsCount: u32, generationId: ?*u32) HRESULT {
    ...
    pub inline fn RemoveTrailPoints(self: *const IDCompositionDelegatedInkTrail, generationId: u32) HRESULT {
        return self.vtable.RemoveTrailPoints(self, generationId);
    }
    pub inline fn StartNewTrail(self: *const IDCompositionDelegatedInkTrail, color: ?*const D2D_COLOR_F) HRESULT {
...
pub const IDCompositionInkTrailDevice = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateDelegatedInkTrail(self: *const IDCompositionInkTrailDevice, inkTrail: ?*?*IDCompositionDelegatedInkTrail) HRESULT {
        return self.vtable.CreateDelegatedInkTrail(self, inkTrail);
    }
    pub inline fn CreateDelegatedInkTrailForSwapChain(self: *const IDCompositionInkTrailDevice, swapChain: ?*IUnknown, inkTrail: ?*?*IDCompositionDelegatedInkTrail) HRESULT {
