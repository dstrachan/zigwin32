...
pub const ISurfaceImageSourceNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetDevice(self: *const ISurfaceImageSourceNative, device: ?*IDXGIDevice) HRESULT {
        return self.vtable.SetDevice(self, device);
    }
    pub inline fn BeginDraw(self: *const ISurfaceImageSourceNative, updateRect: RECT, surface: ?*?*IDXGISurface, offset: ?*POINT) HRESULT {
        return self.vtable.BeginDraw(self, updateRect, surface, offset);
    }
    pub inline fn EndDraw(self: *const ISurfaceImageSourceNative) HRESULT {
...
pub const IVirtualSurfaceUpdatesCallbackNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn UpdatesNeeded(self: *const IVirtualSurfaceUpdatesCallbackNative) HRESULT {
...
pub const IVirtualSurfaceImageSourceNative = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Invalidate(self: *const IVirtualSurfaceImageSourceNative, updateRect: RECT) HRESULT {
        return self.vtable.Invalidate(self, updateRect);
    }
    pub inline fn GetUpdateRectCount(self: *const IVirtualSurfaceImageSourceNative, count: ?*u32) HRESULT {
        return self.vtable.GetUpdateRectCount(self, count);
    }
    pub inline fn GetUpdateRects(self: *const IVirtualSurfaceImageSourceNative, updates: [*]RECT, count: u32) HRESULT {
        return self.vtable.GetUpdateRects(self, updates, count);
    }
    pub inline fn GetVisibleBounds(self: *const IVirtualSurfaceImageSourceNative, bounds: ?*RECT) HRESULT {
        return self.vtable.GetVisibleBounds(self, bounds);
    }
    pub inline fn RegisterForUpdatesNeeded(self: *const IVirtualSurfaceImageSourceNative, callback: ?*IVirtualSurfaceUpdatesCallbackNative) HRESULT {
        return self.vtable.RegisterForUpdatesNeeded(self, callback);
    }
    pub inline fn Resize(self: *const IVirtualSurfaceImageSourceNative, newWidth: i32, newHeight: i32) HRESULT {
...
pub const ISwapChainBackgroundPanelNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetSwapChain(self: *const ISwapChainBackgroundPanelNative, swapChain: ?*IDXGISwapChain) HRESULT {
...
pub const ISurfaceImageSourceManagerNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FlushAllSurfacesWithDevice(self: *const ISurfaceImageSourceManagerNative, device: ?*IUnknown) HRESULT {
...
pub const ISurfaceImageSourceNativeWithD2D = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetDevice(self: *const ISurfaceImageSourceNativeWithD2D, device: ?*IUnknown) HRESULT {
        return self.vtable.SetDevice(self, device);
    }
    pub inline fn BeginDraw(self: *const ISurfaceImageSourceNativeWithD2D, updateRect: ?*const RECT, iid: ?*const Guid, updateObject: **anyopaque, offset: ?*POINT) HRESULT {
        return self.vtable.BeginDraw(self, updateRect, iid, updateObject, offset);
    }
    pub inline fn EndDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
        return self.vtable.EndDraw(self);
    }
    pub inline fn SuspendDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
        return self.vtable.SuspendDraw(self);
    }
    pub inline fn ResumeDraw(self: *const ISurfaceImageSourceNativeWithD2D) HRESULT {
...
pub const ISwapChainPanelNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetSwapChain(self: *const ISwapChainPanelNative, swapChain: ?*IDXGISwapChain) HRESULT {
        return self.vtable.SetSwapChain(self, swapChain);
    }
};
...
pub const ISwapChainPanelNative2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SetSwapChainHandle(self: *const ISwapChainPanelNative2, swapChainHandle: ?HANDLE) HRESULT {
...
pub const IDesktopWindowXamlSourceNative = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AttachToWindow(self: *const IDesktopWindowXamlSourceNative, parentWnd: ?HWND) HRESULT {
        return self.vtable.AttachToWindow(self, parentWnd);
    }
    pub inline fn get_WindowHandle(self: *const IDesktopWindowXamlSourceNative, hWnd: ?*?HWND) HRESULT {
...
pub const IDesktopWindowXamlSourceNative2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn PreTranslateMessage(self: *const IDesktopWindowXamlSourceNative2, message: ?*const MSG, result: ?*BOOL) HRESULT {
...
pub const IReferenceTrackerTarget = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddRefFromReferenceTracker(self: *const IReferenceTrackerTarget) u32 {
        return self.vtable.AddRefFromReferenceTracker(self);
    }
    pub inline fn ReleaseFromReferenceTracker(self: *const IReferenceTrackerTarget) u32 {
        return self.vtable.ReleaseFromReferenceTracker(self);
    }
    pub inline fn Peg(self: *const IReferenceTrackerTarget) HRESULT {
        return self.vtable.Peg(self);
    }
    pub inline fn Unpeg(self: *const IReferenceTrackerTarget) HRESULT {
...
pub const IReferenceTracker = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ConnectFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.ConnectFromTrackerSource(self);
    }
    pub inline fn DisconnectFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.DisconnectFromTrackerSource(self);
    }
    pub inline fn FindTrackerTargets(self: *const IReferenceTracker, callback: ?*IFindReferenceTargetsCallback) HRESULT {
        return self.vtable.FindTrackerTargets(self, callback);
    }
    pub inline fn GetReferenceTrackerManager(self: *const IReferenceTracker, value: ?*?*IReferenceTrackerManager) HRESULT {
        return self.vtable.GetReferenceTrackerManager(self, value);
    }
    pub inline fn AddRefFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.AddRefFromTrackerSource(self);
    }
    pub inline fn ReleaseFromTrackerSource(self: *const IReferenceTracker) HRESULT {
        return self.vtable.ReleaseFromTrackerSource(self);
    }
    pub inline fn PegFromTrackerSource(self: *const IReferenceTracker) HRESULT {
...
pub const IReferenceTrackerManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReferenceTrackingStarted(self: *const IReferenceTrackerManager) HRESULT {
        return self.vtable.ReferenceTrackingStarted(self);
    }
    pub inline fn FindTrackerTargetsCompleted(self: *const IReferenceTrackerManager, findFailed: u8) HRESULT {
        return self.vtable.FindTrackerTargetsCompleted(self, findFailed);
    }
    pub inline fn ReferenceTrackingCompleted(self: *const IReferenceTrackerManager) HRESULT {
        return self.vtable.ReferenceTrackingCompleted(self);
    }
    pub inline fn SetReferenceTrackerHost(self: *const IReferenceTrackerManager, value: ?*IReferenceTrackerHost) HRESULT {
...
pub const IFindReferenceTargetsCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FoundTrackerTarget(self: *const IFindReferenceTargetsCallback, target: ?*IReferenceTrackerTarget) HRESULT {
...
pub const IReferenceTrackerHost = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DisconnectUnusedReferenceSources(self: *const IReferenceTrackerHost, options: XAML_REFERENCETRACKER_DISCONNECT) HRESULT {
        return self.vtable.DisconnectUnusedReferenceSources(self, options);
    }
    pub inline fn ReleaseDisconnectedReferenceSources(self: *const IReferenceTrackerHost) HRESULT {
        return self.vtable.ReleaseDisconnectedReferenceSources(self);
    }
    pub inline fn NotifyEndOfReferenceTrackingOnThread(self: *const IReferenceTrackerHost) HRESULT {
        return self.vtable.NotifyEndOfReferenceTrackingOnThread(self);
    }
    pub inline fn GetTrackerTarget(self: *const IReferenceTrackerHost, unknown: ?*IUnknown, newReference: ?*?*IReferenceTrackerTarget) HRESULT {
        return self.vtable.GetTrackerTarget(self, unknown, newReference);
    }
    pub inline fn AddMemoryPressure(self: *const IReferenceTrackerHost, bytesAllocated: u64) HRESULT {
        return self.vtable.AddMemoryPressure(self, bytesAllocated);
    }
    pub inline fn RemoveMemoryPressure(self: *const IReferenceTrackerHost, bytesAllocated: u64) HRESULT {
...
pub const ITrackerOwner = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateTrackerHandle(self: *const ITrackerOwner, returnValue: ?*?*TrackerHandle__) HRESULT {
        return self.vtable.CreateTrackerHandle(self, returnValue);
    }
    pub inline fn DeleteTrackerHandle(self: *const ITrackerOwner, handle: ?*TrackerHandle__) HRESULT {
        return self.vtable.DeleteTrackerHandle(self, handle);
    }
    pub inline fn SetTrackerValue(self: *const ITrackerOwner, handle: ?*TrackerHandle__, value: ?*IUnknown) HRESULT {
        return self.vtable.SetTrackerValue(self, handle, value);
    }
    pub inline fn TryGetSafeTrackerValue(self: *const ITrackerOwner, handle: ?*TrackerHandle__, returnValue: ?*?*IUnknown) u8 {
