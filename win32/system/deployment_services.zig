...
pub const IWdsTransportCacheable = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Dirty(self: *const IWdsTransportCacheable, pbDirty: ?*i16) HRESULT {
        return self.vtable.get_Dirty(self, pbDirty);
    }
    pub inline fn Discard(self: *const IWdsTransportCacheable) HRESULT {
        return self.vtable.Discard(self);
    }
    pub inline fn Refresh(self: *const IWdsTransportCacheable) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Commit(self: *const IWdsTransportCacheable) HRESULT {
...
pub const IWdsTransportCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IWdsTransportCollection, pulCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, pulCount);
    }
    pub inline fn get_Item(self: *const IWdsTransportCollection, ulIndex: u32, ppVal: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Item(self, ulIndex, ppVal);
    }
    pub inline fn get__NewEnum(self: *const IWdsTransportCollection, ppVal: ?*?*IUnknown) HRESULT {
...
pub const IWdsTransportManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetWdsTransportServer(self: *const IWdsTransportManager, bszServerName: ?BSTR, ppWdsTransportServer: ?*?*IWdsTransportServer) HRESULT {
...
pub const IWdsTransportServer = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IWdsTransportServer, pbszName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbszName);
    }
    pub inline fn get_SetupManager(self: *const IWdsTransportServer, ppWdsTransportSetupManager: ?*?*IWdsTransportSetupManager) HRESULT {
        return self.vtable.get_SetupManager(self, ppWdsTransportSetupManager);
    }
    pub inline fn get_ConfigurationManager(self: *const IWdsTransportServer, ppWdsTransportConfigurationManager: ?*?*IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.get_ConfigurationManager(self, ppWdsTransportConfigurationManager);
    }
    pub inline fn get_NamespaceManager(self: *const IWdsTransportServer, ppWdsTransportNamespaceManager: ?*?*IWdsTransportNamespaceManager) HRESULT {
        return self.vtable.get_NamespaceManager(self, ppWdsTransportNamespaceManager);
    }
    pub inline fn DisconnectClient(self: *const IWdsTransportServer, ulClientId: u32, DisconnectionType: WDSTRANSPORT_DISCONNECT_TYPE) HRESULT {
...
pub const IWdsTransportServer2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_TftpManager(self: *const IWdsTransportServer2, ppWdsTransportTftpManager: ?*?*IWdsTransportTftpManager) HRESULT {
...
pub const IWdsTransportSetupManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Version(self: *const IWdsTransportSetupManager, pullVersion: ?*u64) HRESULT {
        return self.vtable.get_Version(self, pullVersion);
    }
    pub inline fn get_InstalledFeatures(self: *const IWdsTransportSetupManager, pulInstalledFeatures: ?*u32) HRESULT {
        return self.vtable.get_InstalledFeatures(self, pulInstalledFeatures);
    }
    pub inline fn get_Protocols(self: *const IWdsTransportSetupManager, pulProtocols: ?*u32) HRESULT {
        return self.vtable.get_Protocols(self, pulProtocols);
    }
    pub inline fn RegisterContentProvider(self: *const IWdsTransportSetupManager, bszName: ?BSTR, bszDescription: ?BSTR, bszFilePath: ?BSTR, bszInitializationRoutine: ?BSTR) HRESULT {
        return self.vtable.RegisterContentProvider(self, bszName, bszDescription, bszFilePath, bszInitializationRoutine);
    }
    pub inline fn DeregisterContentProvider(self: *const IWdsTransportSetupManager, bszName: ?BSTR) HRESULT {
...
pub const IWdsTransportSetupManager2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_TftpCapabilities(self: *const IWdsTransportSetupManager2, pulTftpCapabilities: ?*u32) HRESULT {
        return self.vtable.get_TftpCapabilities(self, pulTftpCapabilities);
    }
    pub inline fn get_ContentProviders(self: *const IWdsTransportSetupManager2, ppProviderCollection: ?*?*IWdsTransportCollection) HRESULT {
...
pub const IWdsTransportConfigurationManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ServicePolicy(self: *const IWdsTransportConfigurationManager, ppWdsTransportServicePolicy: ?*?*IWdsTransportServicePolicy) HRESULT {
        return self.vtable.get_ServicePolicy(self, ppWdsTransportServicePolicy);
    }
    pub inline fn get_DiagnosticsPolicy(self: *const IWdsTransportConfigurationManager, ppWdsTransportDiagnosticsPolicy: ?*?*IWdsTransportDiagnosticsPolicy) HRESULT {
        return self.vtable.get_DiagnosticsPolicy(self, ppWdsTransportDiagnosticsPolicy);
    }
    pub inline fn get_WdsTransportServicesRunning(self: *const IWdsTransportConfigurationManager, bRealtimeStatus: i16, pbServicesRunning: ?*i16) HRESULT {
        return self.vtable.get_WdsTransportServicesRunning(self, bRealtimeStatus, pbServicesRunning);
    }
    pub inline fn EnableWdsTransportServices(self: *const IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.EnableWdsTransportServices(self);
    }
    pub inline fn DisableWdsTransportServices(self: *const IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.DisableWdsTransportServices(self);
    }
    pub inline fn StartWdsTransportServices(self: *const IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.StartWdsTransportServices(self);
    }
    pub inline fn StopWdsTransportServices(self: *const IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.StopWdsTransportServices(self);
    }
    pub inline fn RestartWdsTransportServices(self: *const IWdsTransportConfigurationManager) HRESULT {
        return self.vtable.RestartWdsTransportServices(self);
    }
    pub inline fn NotifyWdsTransportServices(self: *const IWdsTransportConfigurationManager, ServiceNotification: WDSTRANSPORT_SERVICE_NOTIFICATION) HRESULT {
...
pub const IWdsTransportConfigurationManager2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_MulticastSessionPolicy(self: *const IWdsTransportConfigurationManager2, ppWdsTransportMulticastSessionPolicy: ?*?*IWdsTransportMulticastSessionPolicy) HRESULT {
...
pub const IWdsTransportNamespaceManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn CreateNamespace(self: *const IWdsTransportNamespaceManager, NamespaceType: WDSTRANSPORT_NAMESPACE_TYPE, bszNamespaceName: ?BSTR, bszContentProvider: ?BSTR, bszConfiguration: ?BSTR, ppWdsTransportNamespace: ?*?*IWdsTransportNamespace) HRESULT {
    ...
    pub inline fn RetrieveNamespace(self: *const IWdsTransportNamespaceManager, bszNamespaceName: ?BSTR, ppWdsTransportNamespace: ?*?*IWdsTransportNamespace) HRESULT {
        return self.vtable.RetrieveNamespace(self, bszNamespaceName, ppWdsTransportNamespace);
    }
    pub inline fn RetrieveNamespaces(self: *const IWdsTransportNamespaceManager, bszContentProvider: ?BSTR, bszNamespaceName: ?BSTR, bIncludeTombstones: i16, ppWdsTransportNamespaces: ?*?*IWdsTransportCollection) HRESULT {
...
pub const IWdsTransportTftpManager = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RetrieveTftpClients(self: *const IWdsTransportTftpManager, ppWdsTransportTftpClients: ?*?*IWdsTransportCollection) HRESULT {
...
pub const IWdsTransportServicePolicy = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_IpAddressSource(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, pSourceType: ?*WDSTRANSPORT_IP_ADDRESS_SOURCE_TYPE) HRESULT {
        return self.vtable.get_IpAddressSource(self, AddressType, pSourceType);
    }
    pub inline fn put_IpAddressSource(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, SourceType: WDSTRANSPORT_IP_ADDRESS_SOURCE_TYPE) HRESULT {
        return self.vtable.put_IpAddressSource(self, AddressType, SourceType);
    }
    pub inline fn get_StartIpAddress(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, pbszStartIpAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_StartIpAddress(self, AddressType, pbszStartIpAddress);
    }
    pub inline fn put_StartIpAddress(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, bszStartIpAddress: ?BSTR) HRESULT {
        return self.vtable.put_StartIpAddress(self, AddressType, bszStartIpAddress);
    }
    pub inline fn get_EndIpAddress(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, pbszEndIpAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_EndIpAddress(self, AddressType, pbszEndIpAddress);
    }
    pub inline fn put_EndIpAddress(self: *const IWdsTransportServicePolicy, AddressType: WDSTRANSPORT_IP_ADDRESS_TYPE, bszEndIpAddress: ?BSTR) HRESULT {
        return self.vtable.put_EndIpAddress(self, AddressType, bszEndIpAddress);
    }
    pub inline fn get_StartPort(self: *const IWdsTransportServicePolicy, pulStartPort: ?*u32) HRESULT {
        return self.vtable.get_StartPort(self, pulStartPort);
    }
    pub inline fn put_StartPort(self: *const IWdsTransportServicePolicy, ulStartPort: u32) HRESULT {
        return self.vtable.put_StartPort(self, ulStartPort);
    }
    pub inline fn get_EndPort(self: *const IWdsTransportServicePolicy, pulEndPort: ?*u32) HRESULT {
        return self.vtable.get_EndPort(self, pulEndPort);
    }
    pub inline fn put_EndPort(self: *const IWdsTransportServicePolicy, ulEndPort: u32) HRESULT {
        return self.vtable.put_EndPort(self, ulEndPort);
    }
    pub inline fn get_NetworkProfile(self: *const IWdsTransportServicePolicy, pProfileType: ?*WDSTRANSPORT_NETWORK_PROFILE_TYPE) HRESULT {
        return self.vtable.get_NetworkProfile(self, pProfileType);
    }
    pub inline fn put_NetworkProfile(self: *const IWdsTransportServicePolicy, ProfileType: WDSTRANSPORT_NETWORK_PROFILE_TYPE) HRESULT {
...
pub const IWdsTransportServicePolicy2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_UdpPortPolicy(self: *const IWdsTransportServicePolicy2, pUdpPortPolicy: ?*WDSTRANSPORT_UDP_PORT_POLICY) HRESULT {
        return self.vtable.get_UdpPortPolicy(self, pUdpPortPolicy);
    }
    pub inline fn put_UdpPortPolicy(self: *const IWdsTransportServicePolicy2, UdpPortPolicy: WDSTRANSPORT_UDP_PORT_POLICY) HRESULT {
        return self.vtable.put_UdpPortPolicy(self, UdpPortPolicy);
    }
    pub inline fn get_TftpMaximumBlockSize(self: *const IWdsTransportServicePolicy2, pulTftpMaximumBlockSize: ?*u32) HRESULT {
        return self.vtable.get_TftpMaximumBlockSize(self, pulTftpMaximumBlockSize);
    }
    pub inline fn put_TftpMaximumBlockSize(self: *const IWdsTransportServicePolicy2, ulTftpMaximumBlockSize: u32) HRESULT {
        return self.vtable.put_TftpMaximumBlockSize(self, ulTftpMaximumBlockSize);
    }
    pub inline fn get_EnableTftpVariableWindowExtension(self: *const IWdsTransportServicePolicy2, pbEnableTftpVariableWindowExtension: ?*i16) HRESULT {
        return self.vtable.get_EnableTftpVariableWindowExtension(self, pbEnableTftpVariableWindowExtension);
    }
    pub inline fn put_EnableTftpVariableWindowExtension(self: *const IWdsTransportServicePolicy2, bEnableTftpVariableWindowExtension: i16) HRESULT {
...
pub const IWdsTransportDiagnosticsPolicy = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Enabled(self: *const IWdsTransportDiagnosticsPolicy, pbEnabled: ?*i16) HRESULT {
        return self.vtable.get_Enabled(self, pbEnabled);
    }
    pub inline fn put_Enabled(self: *const IWdsTransportDiagnosticsPolicy, bEnabled: i16) HRESULT {
        return self.vtable.put_Enabled(self, bEnabled);
    }
    pub inline fn get_Components(self: *const IWdsTransportDiagnosticsPolicy, pulComponents: ?*u32) HRESULT {
        return self.vtable.get_Components(self, pulComponents);
    }
    pub inline fn put_Components(self: *const IWdsTransportDiagnosticsPolicy, ulComponents: u32) HRESULT {
...
pub const IWdsTransportMulticastSessionPolicy = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_SlowClientHandling(self: *const IWdsTransportMulticastSessionPolicy, pSlowClientHandling: ?*WDSTRANSPORT_SLOW_CLIENT_HANDLING_TYPE) HRESULT {
        return self.vtable.get_SlowClientHandling(self, pSlowClientHandling);
    }
    pub inline fn put_SlowClientHandling(self: *const IWdsTransportMulticastSessionPolicy, SlowClientHandling: WDSTRANSPORT_SLOW_CLIENT_HANDLING_TYPE) HRESULT {
        return self.vtable.put_SlowClientHandling(self, SlowClientHandling);
    }
    pub inline fn get_AutoDisconnectThreshold(self: *const IWdsTransportMulticastSessionPolicy, pulThreshold: ?*u32) HRESULT {
        return self.vtable.get_AutoDisconnectThreshold(self, pulThreshold);
    }
    pub inline fn put_AutoDisconnectThreshold(self: *const IWdsTransportMulticastSessionPolicy, ulThreshold: u32) HRESULT {
        return self.vtable.put_AutoDisconnectThreshold(self, ulThreshold);
    }
    pub inline fn get_MultistreamStreamCount(self: *const IWdsTransportMulticastSessionPolicy, pulStreamCount: ?*u32) HRESULT {
        return self.vtable.get_MultistreamStreamCount(self, pulStreamCount);
    }
    pub inline fn put_MultistreamStreamCount(self: *const IWdsTransportMulticastSessionPolicy, ulStreamCount: u32) HRESULT {
        return self.vtable.put_MultistreamStreamCount(self, ulStreamCount);
    }
    pub inline fn get_SlowClientFallback(self: *const IWdsTransportMulticastSessionPolicy, pbClientFallback: ?*i16) HRESULT {
        return self.vtable.get_SlowClientFallback(self, pbClientFallback);
    }
    pub inline fn put_SlowClientFallback(self: *const IWdsTransportMulticastSessionPolicy, bClientFallback: i16) HRESULT {
...
pub const IWdsTransportNamespace = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Type(self: *const IWdsTransportNamespace, pType: ?*WDSTRANSPORT_NAMESPACE_TYPE) HRESULT {
        return self.vtable.get_Type(self, pType);
    }
    pub inline fn get_Id(self: *const IWdsTransportNamespace, pulId: ?*u32) HRESULT {
        return self.vtable.get_Id(self, pulId);
    }
    pub inline fn get_Name(self: *const IWdsTransportNamespace, pbszName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbszName);
    }
    pub inline fn put_Name(self: *const IWdsTransportNamespace, bszName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bszName);
    }
    pub inline fn get_FriendlyName(self: *const IWdsTransportNamespace, pbszFriendlyName: ?*?BSTR) HRESULT {
        return self.vtable.get_FriendlyName(self, pbszFriendlyName);
    }
    pub inline fn put_FriendlyName(self: *const IWdsTransportNamespace, bszFriendlyName: ?BSTR) HRESULT {
        return self.vtable.put_FriendlyName(self, bszFriendlyName);
    }
    pub inline fn get_Description(self: *const IWdsTransportNamespace, pbszDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbszDescription);
    }
    pub inline fn put_Description(self: *const IWdsTransportNamespace, bszDescription: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, bszDescription);
    }
    pub inline fn get_ContentProvider(self: *const IWdsTransportNamespace, pbszContentProvider: ?*?BSTR) HRESULT {
        return self.vtable.get_ContentProvider(self, pbszContentProvider);
    }
    pub inline fn put_ContentProvider(self: *const IWdsTransportNamespace, bszContentProvider: ?BSTR) HRESULT {
        return self.vtable.put_ContentProvider(self, bszContentProvider);
    }
    pub inline fn get_Configuration(self: *const IWdsTransportNamespace, pbszConfiguration: ?*?BSTR) HRESULT {
        return self.vtable.get_Configuration(self, pbszConfiguration);
    }
    pub inline fn put_Configuration(self: *const IWdsTransportNamespace, bszConfiguration: ?BSTR) HRESULT {
        return self.vtable.put_Configuration(self, bszConfiguration);
    }
    pub inline fn get_Registered(self: *const IWdsTransportNamespace, pbRegistered: ?*i16) HRESULT {
        return self.vtable.get_Registered(self, pbRegistered);
    }
    pub inline fn get_Tombstoned(self: *const IWdsTransportNamespace, pbTombstoned: ?*i16) HRESULT {
        return self.vtable.get_Tombstoned(self, pbTombstoned);
    }
    pub inline fn get_TombstoneTime(self: *const IWdsTransportNamespace, pTombstoneTime: ?*f64) HRESULT {
        return self.vtable.get_TombstoneTime(self, pTombstoneTime);
    }
    pub inline fn get_TransmissionStarted(self: *const IWdsTransportNamespace, pbTransmissionStarted: ?*i16) HRESULT {
        return self.vtable.get_TransmissionStarted(self, pbTransmissionStarted);
    }
    pub inline fn Register(self: *const IWdsTransportNamespace) HRESULT {
        return self.vtable.Register(self);
    }
    pub inline fn Deregister(self: *const IWdsTransportNamespace, bTerminateSessions: i16) HRESULT {
        return self.vtable.Deregister(self, bTerminateSessions);
    }
    pub inline fn Clone(self: *const IWdsTransportNamespace, ppWdsTransportNamespaceClone: ?*?*IWdsTransportNamespace) HRESULT {
        return self.vtable.Clone(self, ppWdsTransportNamespaceClone);
    }
    pub inline fn Refresh(self: *const IWdsTransportNamespace) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn RetrieveContents(self: *const IWdsTransportNamespace, ppWdsTransportContents: ?*?*IWdsTransportCollection) HRESULT {
...
pub const IWdsTransportNamespaceScheduledCast = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn StartTransmission(self: *const IWdsTransportNamespaceScheduledCast) HRESULT {
...
pub const IWdsTransportNamespaceScheduledCastAutoStart = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_MinimumClients(self: *const IWdsTransportNamespaceScheduledCastAutoStart, pulMinimumClients: ?*u32) HRESULT {
        return self.vtable.get_MinimumClients(self, pulMinimumClients);
    }
    pub inline fn put_MinimumClients(self: *const IWdsTransportNamespaceScheduledCastAutoStart, ulMinimumClients: u32) HRESULT {
        return self.vtable.put_MinimumClients(self, ulMinimumClients);
    }
    pub inline fn get_StartTime(self: *const IWdsTransportNamespaceScheduledCastAutoStart, pStartTime: ?*f64) HRESULT {
        return self.vtable.get_StartTime(self, pStartTime);
    }
    pub inline fn put_StartTime(self: *const IWdsTransportNamespaceScheduledCastAutoStart, StartTime: f64) HRESULT {
...
pub const IWdsTransportContent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Namespace(self: *const IWdsTransportContent, ppWdsTransportNamespace: ?*?*IWdsTransportNamespace) HRESULT {
        return self.vtable.get_Namespace(self, ppWdsTransportNamespace);
    }
    pub inline fn get_Id(self: *const IWdsTransportContent, pulId: ?*u32) HRESULT {
        return self.vtable.get_Id(self, pulId);
    }
    pub inline fn get_Name(self: *const IWdsTransportContent, pbszName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbszName);
    }
    pub inline fn RetrieveSessions(self: *const IWdsTransportContent, ppWdsTransportSessions: ?*?*IWdsTransportCollection) HRESULT {
        return self.vtable.RetrieveSessions(self, ppWdsTransportSessions);
    }
    pub inline fn Terminate(self: *const IWdsTransportContent) HRESULT {
...
pub const IWdsTransportSession = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Content(self: *const IWdsTransportSession, ppWdsTransportContent: ?*?*IWdsTransportContent) HRESULT {
        return self.vtable.get_Content(self, ppWdsTransportContent);
    }
    pub inline fn get_Id(self: *const IWdsTransportSession, pulId: ?*u32) HRESULT {
        return self.vtable.get_Id(self, pulId);
    }
    pub inline fn get_NetworkInterfaceName(self: *const IWdsTransportSession, pbszNetworkInterfaceName: ?*?BSTR) HRESULT {
        return self.vtable.get_NetworkInterfaceName(self, pbszNetworkInterfaceName);
    }
    pub inline fn get_NetworkInterfaceAddress(self: *const IWdsTransportSession, pbszNetworkInterfaceAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_NetworkInterfaceAddress(self, pbszNetworkInterfaceAddress);
    }
    pub inline fn get_TransferRate(self: *const IWdsTransportSession, pulTransferRate: ?*u32) HRESULT {
        return self.vtable.get_TransferRate(self, pulTransferRate);
    }
    pub inline fn get_MasterClientId(self: *const IWdsTransportSession, pulMasterClientId: ?*u32) HRESULT {
        return self.vtable.get_MasterClientId(self, pulMasterClientId);
    }
    pub inline fn RetrieveClients(self: *const IWdsTransportSession, ppWdsTransportClients: ?*?*IWdsTransportCollection) HRESULT {
        return self.vtable.RetrieveClients(self, ppWdsTransportClients);
    }
    pub inline fn Terminate(self: *const IWdsTransportSession) HRESULT {
        return self.vtable.Terminate(self);
    }
};
...
pub const IWdsTransportClient = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IWdsTransportClient, ppWdsTransportSession: ?*?*IWdsTransportSession) HRESULT {
        return self.vtable.get_Session(self, ppWdsTransportSession);
    }
    pub inline fn get_Id(self: *const IWdsTransportClient, pulId: ?*u32) HRESULT {
        return self.vtable.get_Id(self, pulId);
    }
    pub inline fn get_Name(self: *const IWdsTransportClient, pbszName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbszName);
    }
    pub inline fn get_MacAddress(self: *const IWdsTransportClient, pbszMacAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_MacAddress(self, pbszMacAddress);
    }
    pub inline fn get_IpAddress(self: *const IWdsTransportClient, pbszIpAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_IpAddress(self, pbszIpAddress);
    }
    pub inline fn get_PercentCompletion(self: *const IWdsTransportClient, pulPercentCompletion: ?*u32) HRESULT {
        return self.vtable.get_PercentCompletion(self, pulPercentCompletion);
    }
    pub inline fn get_JoinDuration(self: *const IWdsTransportClient, pulJoinDuration: ?*u32) HRESULT {
        return self.vtable.get_JoinDuration(self, pulJoinDuration);
    }
    pub inline fn get_CpuUtilization(self: *const IWdsTransportClient, pulCpuUtilization: ?*u32) HRESULT {
        return self.vtable.get_CpuUtilization(self, pulCpuUtilization);
    }
    pub inline fn get_MemoryUtilization(self: *const IWdsTransportClient, pulMemoryUtilization: ?*u32) HRESULT {
        return self.vtable.get_MemoryUtilization(self, pulMemoryUtilization);
    }
    pub inline fn get_NetworkUtilization(self: *const IWdsTransportClient, pulNetworkUtilization: ?*u32) HRESULT {
        return self.vtable.get_NetworkUtilization(self, pulNetworkUtilization);
    }
    pub inline fn get_UserIdentity(self: *const IWdsTransportClient, pbszUserIdentity: ?*?BSTR) HRESULT {
        return self.vtable.get_UserIdentity(self, pbszUserIdentity);
    }
    pub inline fn Disconnect(self: *const IWdsTransportClient, DisconnectionType: WDSTRANSPORT_DISCONNECT_TYPE) HRESULT {
...
pub const IWdsTransportTftpClient = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_FileName(self: *const IWdsTransportTftpClient, pbszFileName: ?*?BSTR) HRESULT {
        return self.vtable.get_FileName(self, pbszFileName);
    }
    pub inline fn get_IpAddress(self: *const IWdsTransportTftpClient, pbszIpAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_IpAddress(self, pbszIpAddress);
    }
    pub inline fn get_Timeout(self: *const IWdsTransportTftpClient, pulTimeout: ?*u32) HRESULT {
        return self.vtable.get_Timeout(self, pulTimeout);
    }
    pub inline fn get_CurrentFileOffset(self: *const IWdsTransportTftpClient, pul64CurrentOffset: ?*u64) HRESULT {
        return self.vtable.get_CurrentFileOffset(self, pul64CurrentOffset);
    }
    pub inline fn get_FileSize(self: *const IWdsTransportTftpClient, pul64FileSize: ?*u64) HRESULT {
        return self.vtable.get_FileSize(self, pul64FileSize);
    }
    pub inline fn get_BlockSize(self: *const IWdsTransportTftpClient, pulBlockSize: ?*u32) HRESULT {
        return self.vtable.get_BlockSize(self, pulBlockSize);
    }
    pub inline fn get_WindowSize(self: *const IWdsTransportTftpClient, pulWindowSize: ?*u32) HRESULT {
...
pub const IWdsTransportContentProvider = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IWdsTransportContentProvider, pbszName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbszName);
    }
    pub inline fn get_Description(self: *const IWdsTransportContentProvider, pbszDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pbszDescription);
    }
    pub inline fn get_FilePath(self: *const IWdsTransportContentProvider, pbszFilePath: ?*?BSTR) HRESULT {
        return self.vtable.get_FilePath(self, pbszFilePath);
    }
    pub inline fn get_InitializationRoutine(self: *const IWdsTransportContentProvider, pbszInitializationRoutine: ?*?BSTR) HRESULT {
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wdstptc" fn WdsTransportClientInitialize() callconv(.winapi) u32;
...
// TODO: this type is limited to platform 'windows6.0.6000'
pub extern "wdstptc" fn WdsTransportClientShutdown() callconv(.winapi) u32;
