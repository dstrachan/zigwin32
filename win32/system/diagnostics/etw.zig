...
pub const ITraceEvent = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Clone(self: *const ITraceEvent, NewEvent: ?*?*ITraceEvent) HRESULT {
        return self.vtable.Clone(self, NewEvent);
    }
    pub inline fn GetUserContext(self: *const ITraceEvent, UserContext: ?*?*anyopaque) HRESULT {
        return self.vtable.GetUserContext(self, UserContext);
    }
    pub inline fn GetEventRecord(self: *const ITraceEvent, EventRecord: ?*?*EVENT_RECORD) HRESULT {
        return self.vtable.GetEventRecord(self, EventRecord);
    }
    pub inline fn SetPayload(self: *const ITraceEvent, Payload: [*:0]u8, PayloadSize: u32) HRESULT {
        return self.vtable.SetPayload(self, Payload, PayloadSize);
    }
    pub inline fn SetEventDescriptor(self: *const ITraceEvent, EventDescriptor: ?*const EVENT_DESCRIPTOR) HRESULT {
        return self.vtable.SetEventDescriptor(self, EventDescriptor);
    }
    pub inline fn SetProcessId(self: *const ITraceEvent, ProcessId: u32) HRESULT {
        return self.vtable.SetProcessId(self, ProcessId);
    }
    pub inline fn SetProcessorIndex(self: *const ITraceEvent, ProcessorIndex: u32) HRESULT {
        return self.vtable.SetProcessorIndex(self, ProcessorIndex);
    }
    pub inline fn SetThreadId(self: *const ITraceEvent, ThreadId: u32) HRESULT {
        return self.vtable.SetThreadId(self, ThreadId);
    }
    pub inline fn SetThreadTimes(self: *const ITraceEvent, KernelTime: u32, UserTime: u32) HRESULT {
        return self.vtable.SetThreadTimes(self, KernelTime, UserTime);
    }
    pub inline fn SetActivityId(self: *const ITraceEvent, ActivityId: ?*const Guid) HRESULT {
        return self.vtable.SetActivityId(self, ActivityId);
    }
    pub inline fn SetTimeStamp(self: *const ITraceEvent, TimeStamp: ?*LARGE_INTEGER) HRESULT {
        return self.vtable.SetTimeStamp(self, TimeStamp);
    }
    pub inline fn SetProviderId(self: *const ITraceEvent, ProviderId: ?*const Guid) HRESULT {
...
pub const ITraceEventCallback = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnBeginProcessTrace(self: *const ITraceEventCallback, HeaderEvent: ?*ITraceEvent, Relogger: ?*ITraceRelogger) HRESULT {
        return self.vtable.OnBeginProcessTrace(self, HeaderEvent, Relogger);
    }
    pub inline fn OnFinalizeProcessTrace(self: *const ITraceEventCallback, Relogger: ?*ITraceRelogger) HRESULT {
        return self.vtable.OnFinalizeProcessTrace(self, Relogger);
    }
    pub inline fn OnEvent(self: *const ITraceEventCallback, Event: ?*ITraceEvent, Relogger: ?*ITraceRelogger) HRESULT {
...
pub const ITraceRelogger = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddLogfileTraceStream(self: *const ITraceRelogger, LogfileName: ?BSTR, UserContext: ?*anyopaque, TraceHandle: ?*RELOGSTREAM_HANDLE) HRESULT {
        return self.vtable.AddLogfileTraceStream(self, LogfileName, UserContext, TraceHandle);
    }
    pub inline fn AddRealtimeTraceStream(self: *const ITraceRelogger, LoggerName: ?BSTR, UserContext: ?*anyopaque, TraceHandle: ?*RELOGSTREAM_HANDLE) HRESULT {
        return self.vtable.AddRealtimeTraceStream(self, LoggerName, UserContext, TraceHandle);
    }
    pub inline fn RegisterCallback(self: *const ITraceRelogger, Callback: ?*ITraceEventCallback) HRESULT {
        return self.vtable.RegisterCallback(self, Callback);
    }
    pub inline fn Inject(self: *const ITraceRelogger, Event: ?*ITraceEvent) HRESULT {
        return self.vtable.Inject(self, Event);
    }
    pub inline fn CreateEventInstance(self: *const ITraceRelogger, TraceHandle: RELOGSTREAM_HANDLE, Flags: u32, Event: ?*?*ITraceEvent) HRESULT {
        return self.vtable.CreateEventInstance(self, TraceHandle, Flags, Event);
    }
    pub inline fn ProcessTrace(self: *const ITraceRelogger) HRESULT {
        return self.vtable.ProcessTrace(self);
    }
    pub inline fn SetOutputFilename(self: *const ITraceRelogger, LogfileName: ?BSTR) HRESULT {
        return self.vtable.SetOutputFilename(self, LogfileName);
    }
    pub inline fn SetCompressionMode(self: *const ITraceRelogger, CompressionMode: BOOLEAN) HRESULT {
        return self.vtable.SetCompressionMode(self, CompressionMode);
    }
    pub inline fn Cancel(self: *const ITraceRelogger) HRESULT {
