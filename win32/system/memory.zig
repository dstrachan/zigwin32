...
pub const PBAD_MEMORY_CALLBACK_ROUTINE = *const fn () callconv(.winapi) void;
...
// TODO: this type is limited to platform 'windows5.1.2600'
pub extern "kernel32" fn GetProcessHeap() callconv(.winapi) ?HeapHandle;
...
pub extern "kernel32" fn GetLargePageMinimum() callconv(.winapi) usize;
