...
pub const IWbemPathKeyList = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCount(self: *const IWbemPathKeyList, puKeyCount: ?*u32) HRESULT {
        return self.vtable.GetCount(self, puKeyCount);
    }
    pub inline fn SetKey(self: *const IWbemPathKeyList, wszName: ?[*:0]const u16, uFlags: u32, uCimType: u32, pKeyVal: ?*anyopaque) HRESULT {
        return self.vtable.SetKey(self, wszName, uFlags, uCimType, pKeyVal);
    }
    pub inline fn SetKey2(self: *const IWbemPathKeyList, wszName: ?[*:0]const u16, uFlags: u32, uCimType: u32, pKeyVal: ?*VARIANT) HRESULT {
        return self.vtable.SetKey2(self, wszName, uFlags, uCimType, pKeyVal);
    }
    pub inline fn GetKey(self: *const IWbemPathKeyList, uKeyIx: u32, uFlags: u32, puNameBufSize: ?*u32, pszKeyName: ?[*:0]u16, puKeyValBufSize: ?*u32, pKeyVal: ?*anyopaque, puApparentCimType: ?*u32) HRESULT {
        return self.vtable.GetKey(self, uKeyIx, uFlags, puNameBufSize, pszKeyName, puKeyValBufSize, pKeyVal, puApparentCimType);
    }
    pub inline fn GetKey2(self: *const IWbemPathKeyList, uKeyIx: u32, uFlags: u32, puNameBufSize: ?*u32, pszKeyName: ?[*:0]u16, pKeyValue: ?*VARIANT, puApparentCimType: ?*u32) HRESULT {
        return self.vtable.GetKey2(self, uKeyIx, uFlags, puNameBufSize, pszKeyName, pKeyValue, puApparentCimType);
    }
    pub inline fn RemoveKey(self: *const IWbemPathKeyList, wszName: ?[*:0]const u16, uFlags: u32) HRESULT {
        return self.vtable.RemoveKey(self, wszName, uFlags);
    }
    pub inline fn RemoveAllKeys(self: *const IWbemPathKeyList, uFlags: u32) HRESULT {
        return self.vtable.RemoveAllKeys(self, uFlags);
    }
    pub inline fn MakeSingleton(self: *const IWbemPathKeyList, bSet: u8) HRESULT {
        return self.vtable.MakeSingleton(self, bSet);
    }
    pub inline fn GetInfo(self: *const IWbemPathKeyList, uRequestedInfo: u32, puResponse: ?*u64) HRESULT {
        return self.vtable.GetInfo(self, uRequestedInfo, puResponse);
    }
    pub inline fn GetText(self: *const IWbemPathKeyList, lFlags: i32, puBuffLength: ?*u32, pszText: [*:0]u16) HRESULT {
...
pub const IWbemPath = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetText(self: *const IWbemPath, uMode: u32, pszPath: ?[*:0]const u16) HRESULT {
        return self.vtable.SetText(self, uMode, pszPath);
    }
    pub inline fn GetText(self: *const IWbemPath, lFlags: i32, puBuffLength: ?*u32, pszText: [*:0]u16) HRESULT {
        return self.vtable.GetText(self, lFlags, puBuffLength, pszText);
    }
    pub inline fn GetInfo(self: *const IWbemPath, uRequestedInfo: u32, puResponse: ?*u64) HRESULT {
        return self.vtable.GetInfo(self, uRequestedInfo, puResponse);
    }
    pub inline fn SetServer(self: *const IWbemPath, Name: ?[*:0]const u16) HRESULT {
        return self.vtable.SetServer(self, Name);
    }
    pub inline fn GetServer(self: *const IWbemPath, puNameBufLength: ?*u32, pName: [*:0]u16) HRESULT {
        return self.vtable.GetServer(self, puNameBufLength, pName);
    }
    pub inline fn GetNamespaceCount(self: *const IWbemPath, puCount: ?*u32) HRESULT {
        return self.vtable.GetNamespaceCount(self, puCount);
    }
    pub inline fn SetNamespaceAt(self: *const IWbemPath, uIndex: u32, pszName: ?[*:0]const u16) HRESULT {
        return self.vtable.SetNamespaceAt(self, uIndex, pszName);
    }
    pub inline fn GetNamespaceAt(self: *const IWbemPath, uIndex: u32, puNameBufLength: ?*u32, pName: [*:0]u16) HRESULT {
        return self.vtable.GetNamespaceAt(self, uIndex, puNameBufLength, pName);
    }
    pub inline fn RemoveNamespaceAt(self: *const IWbemPath, uIndex: u32) HRESULT {
        return self.vtable.RemoveNamespaceAt(self, uIndex);
    }
    pub inline fn RemoveAllNamespaces(self: *const IWbemPath) HRESULT {
        return self.vtable.RemoveAllNamespaces(self);
    }
    pub inline fn GetScopeCount(self: *const IWbemPath, puCount: ?*u32) HRESULT {
        return self.vtable.GetScopeCount(self, puCount);
    }
    pub inline fn SetScope(self: *const IWbemPath, uIndex: u32, pszClass: ?PWSTR) HRESULT {
        return self.vtable.SetScope(self, uIndex, pszClass);
    }
    pub inline fn SetScopeFromText(self: *const IWbemPath, uIndex: u32, pszText: ?PWSTR) HRESULT {
        return self.vtable.SetScopeFromText(self, uIndex, pszText);
    }
    pub inline fn GetScope(self: *const IWbemPath, uIndex: u32, puClassNameBufSize: ?*u32, pszClass: [*:0]u16, pKeyList: ?*?*IWbemPathKeyList) HRESULT {
        return self.vtable.GetScope(self, uIndex, puClassNameBufSize, pszClass, pKeyList);
    }
    pub inline fn GetScopeAsText(self: *const IWbemPath, uIndex: u32, puTextBufSize: ?*u32, pszText: [*:0]u16) HRESULT {
        return self.vtable.GetScopeAsText(self, uIndex, puTextBufSize, pszText);
    }
    pub inline fn RemoveScope(self: *const IWbemPath, uIndex: u32) HRESULT {
        return self.vtable.RemoveScope(self, uIndex);
    }
    pub inline fn RemoveAllScopes(self: *const IWbemPath) HRESULT {
        return self.vtable.RemoveAllScopes(self);
    }
    pub inline fn SetClassName(self: *const IWbemPath, Name: ?[*:0]const u16) HRESULT {
        return self.vtable.SetClassName(self, Name);
    }
    pub inline fn GetClassName(self: *const IWbemPath, puBuffLength: ?*u32, pszName: ?[*:0]u16) HRESULT {
        return self.vtable.GetClassName(self, puBuffLength, pszName);
    }
    pub inline fn GetKeyList(self: *const IWbemPath, pOut: ?*?*IWbemPathKeyList) HRESULT {
        return self.vtable.GetKeyList(self, pOut);
    }
    pub inline fn CreateClassPart(self: *const IWbemPath, lFlags: i32, Name: ?[*:0]const u16) HRESULT {
        return self.vtable.CreateClassPart(self, lFlags, Name);
    }
    pub inline fn DeleteClassPart(self: *const IWbemPath, lFlags: i32) HRESULT {
        return self.vtable.DeleteClassPart(self, lFlags);
    }
    pub inline fn IsRelative(self: *const IWbemPath, wszMachine: ?PWSTR, wszNamespace: ?PWSTR) BOOL {
        return self.vtable.IsRelative(self, wszMachine, wszNamespace);
    }
    pub inline fn IsRelativeOrChild(self: *const IWbemPath, wszMachine: ?PWSTR, wszNamespace: ?PWSTR, lFlags: i32) BOOL {
        return self.vtable.IsRelativeOrChild(self, wszMachine, wszNamespace, lFlags);
    }
    pub inline fn IsLocal(self: *const IWbemPath, wszMachine: ?[*:0]const u16) BOOL {
        return self.vtable.IsLocal(self, wszMachine);
    }
    pub inline fn IsSameClassName(self: *const IWbemPath, wszClass: ?[*:0]const u16) BOOL {
...
pub const IWbemQuery = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Empty(self: *const IWbemQuery) HRESULT {
        return self.vtable.Empty(self);
    }
    pub inline fn SetLanguageFeatures(self: *const IWbemQuery, uFlags: u32, uArraySize: u32, puFeatures: ?*u32) HRESULT {
        return self.vtable.SetLanguageFeatures(self, uFlags, uArraySize, puFeatures);
    }
    pub inline fn TestLanguageFeatures(self: *const IWbemQuery, uFlags: u32, uArraySize: ?*u32, puFeatures: ?*u32) HRESULT {
        return self.vtable.TestLanguageFeatures(self, uFlags, uArraySize, puFeatures);
    }
    pub inline fn Parse(self: *const IWbemQuery, pszLang: ?[*:0]const u16, pszQuery: ?[*:0]const u16, uFlags: u32) HRESULT {
        return self.vtable.Parse(self, pszLang, pszQuery, uFlags);
    }
    pub inline fn GetAnalysis(self: *const IWbemQuery, uAnalysisType: u32, uFlags: u32, pAnalysis: ?*?*anyopaque) HRESULT {
        return self.vtable.GetAnalysis(self, uAnalysisType, uFlags, pAnalysis);
    }
    pub inline fn FreeMemory(self: *const IWbemQuery, pMem: ?*anyopaque) HRESULT {
        return self.vtable.FreeMemory(self, pMem);
    }
    pub inline fn GetQueryInfo(self: *const IWbemQuery, uAnalysisType: u32, uInfoId: u32, uBufSize: u32, pDestBuf: ?*anyopaque) HRESULT {
...
pub const IWbemClassObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetQualifierSet(self: *const IWbemClassObject, ppQualSet: ?*?*IWbemQualifierSet) HRESULT {
        return self.vtable.GetQualifierSet(self, ppQualSet);
    }
    pub inline fn Get(self: *const IWbemClassObject, wszName: ?[*:0]const u16, lFlags: i32, pVal: ?*VARIANT, pType: ?*i32, plFlavor: ?*i32) HRESULT {
        return self.vtable.Get(self, wszName, lFlags, pVal, pType, plFlavor);
    }
    pub inline fn Put(self: *const IWbemClassObject, wszName: ?[*:0]const u16, lFlags: i32, pVal: ?*VARIANT, Type: i32) HRESULT {
        return self.vtable.Put(self, wszName, lFlags, pVal, Type);
    }
    pub inline fn Delete(self: *const IWbemClassObject, wszName: ?[*:0]const u16) HRESULT {
        return self.vtable.Delete(self, wszName);
    }
    pub inline fn GetNames(self: *const IWbemClassObject, wszQualifierName: ?[*:0]const u16, lFlags: i32, pQualifierVal: ?*VARIANT, pNames: ?*?*SAFEARRAY) HRESULT {
        return self.vtable.GetNames(self, wszQualifierName, lFlags, pQualifierVal, pNames);
    }
    pub inline fn BeginEnumeration(self: *const IWbemClassObject, lEnumFlags: i32) HRESULT {
        return self.vtable.BeginEnumeration(self, lEnumFlags);
    }
    pub inline fn Next(self: *const IWbemClassObject, lFlags: i32, strName: ?*?BSTR, pVal: ?*VARIANT, pType: ?*i32, plFlavor: ?*i32) HRESULT {
        return self.vtable.Next(self, lFlags, strName, pVal, pType, plFlavor);
    }
    pub inline fn EndEnumeration(self: *const IWbemClassObject) HRESULT {
        return self.vtable.EndEnumeration(self);
    }
    pub inline fn GetPropertyQualifierSet(self: *const IWbemClassObject, wszProperty: ?[*:0]const u16, ppQualSet: ?*?*IWbemQualifierSet) HRESULT {
        return self.vtable.GetPropertyQualifierSet(self, wszProperty, ppQualSet);
    }
    pub inline fn Clone(self: *const IWbemClassObject, ppCopy: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.Clone(self, ppCopy);
    }
    pub inline fn GetObjectText(self: *const IWbemClassObject, lFlags: i32, pstrObjectText: ?*?BSTR) HRESULT {
        return self.vtable.GetObjectText(self, lFlags, pstrObjectText);
    }
    pub inline fn SpawnDerivedClass(self: *const IWbemClassObject, lFlags: i32, ppNewClass: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.SpawnDerivedClass(self, lFlags, ppNewClass);
    }
    pub inline fn SpawnInstance(self: *const IWbemClassObject, lFlags: i32, ppNewInstance: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.SpawnInstance(self, lFlags, ppNewInstance);
    }
    pub inline fn CompareTo(self: *const IWbemClassObject, lFlags: i32, pCompareTo: ?*IWbemClassObject) HRESULT {
        return self.vtable.CompareTo(self, lFlags, pCompareTo);
    }
    pub inline fn GetPropertyOrigin(self: *const IWbemClassObject, wszName: ?[*:0]const u16, pstrClassName: ?*?BSTR) HRESULT {
        return self.vtable.GetPropertyOrigin(self, wszName, pstrClassName);
    }
    pub inline fn InheritsFrom(self: *const IWbemClassObject, strAncestor: ?[*:0]const u16) HRESULT {
        return self.vtable.InheritsFrom(self, strAncestor);
    }
    pub inline fn GetMethod(self: *const IWbemClassObject, wszName: ?[*:0]const u16, lFlags: i32, ppInSignature: ?*?*IWbemClassObject, ppOutSignature: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.GetMethod(self, wszName, lFlags, ppInSignature, ppOutSignature);
    }
    pub inline fn PutMethod(self: *const IWbemClassObject, wszName: ?[*:0]const u16, lFlags: i32, pInSignature: ?*IWbemClassObject, pOutSignature: ?*IWbemClassObject) HRESULT {
        return self.vtable.PutMethod(self, wszName, lFlags, pInSignature, pOutSignature);
    }
    pub inline fn DeleteMethod(self: *const IWbemClassObject, wszName: ?[*:0]const u16) HRESULT {
        return self.vtable.DeleteMethod(self, wszName);
    }
    pub inline fn BeginMethodEnumeration(self: *const IWbemClassObject, lEnumFlags: i32) HRESULT {
        return self.vtable.BeginMethodEnumeration(self, lEnumFlags);
    }
    pub inline fn NextMethod(self: *const IWbemClassObject, lFlags: i32, pstrName: ?*?BSTR, ppInSignature: ?*?*IWbemClassObject, ppOutSignature: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.NextMethod(self, lFlags, pstrName, ppInSignature, ppOutSignature);
    }
    pub inline fn EndMethodEnumeration(self: *const IWbemClassObject) HRESULT {
        return self.vtable.EndMethodEnumeration(self);
    }
    pub inline fn GetMethodQualifierSet(self: *const IWbemClassObject, wszMethod: ?[*:0]const u16, ppQualSet: ?*?*IWbemQualifierSet) HRESULT {
        return self.vtable.GetMethodQualifierSet(self, wszMethod, ppQualSet);
    }
    pub inline fn GetMethodOrigin(self: *const IWbemClassObject, wszMethodName: ?[*:0]const u16, pstrClassName: ?*?BSTR) HRESULT {
...
pub const IWbemObjectAccess = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetPropertyHandle(self: *const IWbemObjectAccess, wszPropertyName: ?[*:0]const u16, pType: ?*i32, plHandle: ?*i32) HRESULT {
        return self.vtable.GetPropertyHandle(self, wszPropertyName, pType, plHandle);
    }
    pub inline fn WritePropertyValue(self: *const IWbemObjectAccess, lHandle: i32, lNumBytes: i32, aData: [*:0]const u8) HRESULT {
        return self.vtable.WritePropertyValue(self, lHandle, lNumBytes, aData);
    }
    pub inline fn ReadPropertyValue(self: *const IWbemObjectAccess, lHandle: i32, lBufferSize: i32, plNumBytes: ?*i32, aData: [*:0]u8) HRESULT {
        return self.vtable.ReadPropertyValue(self, lHandle, lBufferSize, plNumBytes, aData);
    }
    pub inline fn ReadDWORD(self: *const IWbemObjectAccess, lHandle: i32, pdw: ?*u32) HRESULT {
        return self.vtable.ReadDWORD(self, lHandle, pdw);
    }
    pub inline fn WriteDWORD(self: *const IWbemObjectAccess, lHandle: i32, dw: u32) HRESULT {
        return self.vtable.WriteDWORD(self, lHandle, dw);
    }
    pub inline fn ReadQWORD(self: *const IWbemObjectAccess, lHandle: i32, pqw: ?*u64) HRESULT {
        return self.vtable.ReadQWORD(self, lHandle, pqw);
    }
    pub inline fn WriteQWORD(self: *const IWbemObjectAccess, lHandle: i32, pw: u64) HRESULT {
        return self.vtable.WriteQWORD(self, lHandle, pw);
    }
    pub inline fn GetPropertyInfoByHandle(self: *const IWbemObjectAccess, lHandle: i32, pstrName: ?*?BSTR, pType: ?*i32) HRESULT {
        return self.vtable.GetPropertyInfoByHandle(self, lHandle, pstrName, pType);
    }
    pub inline fn Lock(self: *const IWbemObjectAccess, lFlags: i32) HRESULT {
        return self.vtable.Lock(self, lFlags);
    }
    pub inline fn Unlock(self: *const IWbemObjectAccess, lFlags: i32) HRESULT {
...
pub const IWbemQualifierSet = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Get(self: *const IWbemQualifierSet, wszName: ?[*:0]const u16, lFlags: i32, pVal: ?*VARIANT, plFlavor: ?*i32) HRESULT {
        return self.vtable.Get(self, wszName, lFlags, pVal, plFlavor);
    }
    pub inline fn Put(self: *const IWbemQualifierSet, wszName: ?[*:0]const u16, pVal: ?*VARIANT, lFlavor: i32) HRESULT {
        return self.vtable.Put(self, wszName, pVal, lFlavor);
    }
    pub inline fn Delete(self: *const IWbemQualifierSet, wszName: ?[*:0]const u16) HRESULT {
        return self.vtable.Delete(self, wszName);
    }
    pub inline fn GetNames(self: *const IWbemQualifierSet, lFlags: i32, pNames: ?*?*SAFEARRAY) HRESULT {
        return self.vtable.GetNames(self, lFlags, pNames);
    }
    pub inline fn BeginEnumeration(self: *const IWbemQualifierSet, lFlags: i32) HRESULT {
        return self.vtable.BeginEnumeration(self, lFlags);
    }
    pub inline fn Next(self: *const IWbemQualifierSet, lFlags: i32, pstrName: ?*?BSTR, pVal: ?*VARIANT, plFlavor: ?*i32) HRESULT {
        return self.vtable.Next(self, lFlags, pstrName, pVal, plFlavor);
    }
    pub inline fn EndEnumeration(self: *const IWbemQualifierSet) HRESULT {
        return self.vtable.EndEnumeration(self);
    }
};
...
pub const IWbemServices = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OpenNamespace(self: *const IWbemServices, strNamespace: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppWorkingNamespace: ?*?*IWbemServices, ppResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.OpenNamespace(self, strNamespace, lFlags, pCtx, ppWorkingNamespace, ppResult);
    }
    pub inline fn CancelAsyncCall(self: *const IWbemServices, pSink: ?*IWbemObjectSink) HRESULT {
        return self.vtable.CancelAsyncCall(self, pSink);
    }
    pub inline fn QueryObjectSink(self: *const IWbemServices, lFlags: i32, ppResponseHandler: ?*?*IWbemObjectSink) HRESULT {
        return self.vtable.QueryObjectSink(self, lFlags, ppResponseHandler);
    }
    pub inline fn GetObject(self: *const IWbemServices, strObjectPath: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppObject: ?*?*IWbemClassObject, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.GetObject(self, strObjectPath, lFlags, pCtx, ppObject, ppCallResult);
    }
    pub inline fn GetObjectAsync(self: *const IWbemServices, strObjectPath: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.GetObjectAsync(self, strObjectPath, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn PutClass(self: *const IWbemServices, pObject: ?*IWbemClassObject, lFlags: i32, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.PutClass(self, pObject, lFlags, pCtx, ppCallResult);
    }
    pub inline fn PutClassAsync(self: *const IWbemServices, pObject: ?*IWbemClassObject, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.PutClassAsync(self, pObject, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn DeleteClass(self: *const IWbemServices, strClass: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.DeleteClass(self, strClass, lFlags, pCtx, ppCallResult);
    }
    pub inline fn DeleteClassAsync(self: *const IWbemServices, strClass: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.DeleteClassAsync(self, strClass, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn CreateClassEnum(self: *const IWbemServices, strSuperclass: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) HRESULT {
        return self.vtable.CreateClassEnum(self, strSuperclass, lFlags, pCtx, ppEnum);
    }
    pub inline fn CreateClassEnumAsync(self: *const IWbemServices, strSuperclass: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.CreateClassEnumAsync(self, strSuperclass, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn PutInstance(self: *const IWbemServices, pInst: ?*IWbemClassObject, lFlags: i32, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.PutInstance(self, pInst, lFlags, pCtx, ppCallResult);
    }
    pub inline fn PutInstanceAsync(self: *const IWbemServices, pInst: ?*IWbemClassObject, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.PutInstanceAsync(self, pInst, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn DeleteInstance(self: *const IWbemServices, strObjectPath: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.DeleteInstance(self, strObjectPath, lFlags, pCtx, ppCallResult);
    }
    pub inline fn DeleteInstanceAsync(self: *const IWbemServices, strObjectPath: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.DeleteInstanceAsync(self, strObjectPath, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn CreateInstanceEnum(self: *const IWbemServices, strFilter: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppEnum: **IEnumWbemClassObject) HRESULT {
        return self.vtable.CreateInstanceEnum(self, strFilter, lFlags, pCtx, ppEnum);
    }
    pub inline fn CreateInstanceEnumAsync(self: *const IWbemServices, strFilter: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.CreateInstanceEnumAsync(self, strFilter, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn ExecQuery(self: *const IWbemServices, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) HRESULT {
        return self.vtable.ExecQuery(self, strQueryLanguage, strQuery, lFlags, pCtx, ppEnum);
    }
    pub inline fn ExecQueryAsync(self: *const IWbemServices, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.ExecQueryAsync(self, strQueryLanguage, strQuery, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn ExecNotificationQuery(self: *const IWbemServices, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, ppEnum: ?*?*IEnumWbemClassObject) HRESULT {
        return self.vtable.ExecNotificationQuery(self, strQueryLanguage, strQuery, lFlags, pCtx, ppEnum);
    }
    pub inline fn ExecNotificationQueryAsync(self: *const IWbemServices, strQueryLanguage: ?BSTR, strQuery: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pResponseHandler: ?*IWbemObjectSink) HRESULT {
        return self.vtable.ExecNotificationQueryAsync(self, strQueryLanguage, strQuery, lFlags, pCtx, pResponseHandler);
    }
    pub inline fn ExecMethod(self: *const IWbemServices, strObjectPath: ?BSTR, strMethodName: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pInParams: ?*IWbemClassObject, ppOutParams: ?*?*IWbemClassObject, ppCallResult: ?*?*IWbemCallResult) HRESULT {
        return self.vtable.ExecMethod(self, strObjectPath, strMethodName, lFlags, pCtx, pInParams, ppOutParams, ppCallResult);
    }
    pub inline fn ExecMethodAsync(self: *const IWbemServices, strObjectPath: ?BSTR, strMethodName: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, pInParams: ?*IWbemClassObject, pResponseHandler: ?*IWbemObjectSink) HRESULT {
...
pub const IWbemLocator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ConnectServer(self: *const IWbemLocator, strNetworkResource: ?BSTR, strUser: ?BSTR, strPassword: ?BSTR, strLocale: ?BSTR, lSecurityFlags: i32, strAuthority: ?BSTR, pCtx: ?*IWbemContext, ppNamespace: ?*?*IWbemServices) HRESULT {
...
pub const IWbemObjectSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Indicate(self: *const IWbemObjectSink, lObjectCount: i32, apObjArray: [*]?*IWbemClassObject) HRESULT {
        return self.vtable.Indicate(self, lObjectCount, apObjArray);
    }
    pub inline fn SetStatus(self: *const IWbemObjectSink, lFlags: i32, hResult: HRESULT, strParam: ?BSTR, pObjParam: ?*IWbemClassObject) HRESULT {
...
pub const IEnumWbemClassObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IEnumWbemClassObject) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IEnumWbemClassObject, lTimeout: i32, uCount: u32, apObjects: [*]?*IWbemClassObject, puReturned: ?*u32) HRESULT {
        return self.vtable.Next(self, lTimeout, uCount, apObjects, puReturned);
    }
    pub inline fn NextAsync(self: *const IEnumWbemClassObject, uCount: u32, pSink: ?*IWbemObjectSink) HRESULT {
        return self.vtable.NextAsync(self, uCount, pSink);
    }
    pub inline fn Clone(self: *const IEnumWbemClassObject, ppEnum: ?*?*IEnumWbemClassObject) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
    pub inline fn Skip(self: *const IEnumWbemClassObject, lTimeout: i32, nCount: u32) HRESULT {
...
pub const IWbemCallResult = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetResultObject(self: *const IWbemCallResult, lTimeout: i32, ppResultObject: ?*?*IWbemClassObject) HRESULT {
        return self.vtable.GetResultObject(self, lTimeout, ppResultObject);
    }
    pub inline fn GetResultString(self: *const IWbemCallResult, lTimeout: i32, pstrResultString: ?*?BSTR) HRESULT {
        return self.vtable.GetResultString(self, lTimeout, pstrResultString);
    }
    pub inline fn GetResultServices(self: *const IWbemCallResult, lTimeout: i32, ppServices: ?*?*IWbemServices) HRESULT {
        return self.vtable.GetResultServices(self, lTimeout, ppServices);
    }
    pub inline fn GetCallStatus(self: *const IWbemCallResult, lTimeout: i32, plStatus: ?*i32) HRESULT {
...
pub const IWbemContext = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Clone(self: *const IWbemContext, ppNewCopy: ?*?*IWbemContext) HRESULT {
        return self.vtable.Clone(self, ppNewCopy);
    }
    pub inline fn GetNames(self: *const IWbemContext, lFlags: i32, pNames: ?*?*SAFEARRAY) HRESULT {
        return self.vtable.GetNames(self, lFlags, pNames);
    }
    pub inline fn BeginEnumeration(self: *const IWbemContext, lFlags: i32) HRESULT {
        return self.vtable.BeginEnumeration(self, lFlags);
    }
    pub inline fn Next(self: *const IWbemContext, lFlags: i32, pstrName: ?*?BSTR, pValue: ?*VARIANT) HRESULT {
        return self.vtable.Next(self, lFlags, pstrName, pValue);
    }
    pub inline fn EndEnumeration(self: *const IWbemContext) HRESULT {
        return self.vtable.EndEnumeration(self);
    }
    pub inline fn SetValue(self: *const IWbemContext, wszName: ?[*:0]const u16, lFlags: i32, pValue: ?*VARIANT) HRESULT {
        return self.vtable.SetValue(self, wszName, lFlags, pValue);
    }
    pub inline fn GetValue(self: *const IWbemContext, wszName: ?[*:0]const u16, lFlags: i32, pValue: ?*VARIANT) HRESULT {
        return self.vtable.GetValue(self, wszName, lFlags, pValue);
    }
    pub inline fn DeleteValue(self: *const IWbemContext, wszName: ?[*:0]const u16, lFlags: i32) HRESULT {
        return self.vtable.DeleteValue(self, wszName, lFlags);
    }
    pub inline fn DeleteAll(self: *const IWbemContext) HRESULT {
...
pub const IUnsecuredApartment = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateObjectStub(self: *const IUnsecuredApartment, pObject: ?*IUnknown, ppStub: ?*?*IUnknown) HRESULT {
...
pub const IWbemUnsecuredApartment = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateSinkStub(self: *const IWbemUnsecuredApartment, pSink: ?*IWbemObjectSink, dwFlags: u32, wszReserved: ?[*:0]const u16, ppStub: ?*?*IWbemObjectSink) HRESULT {
...
pub const IWbemStatusCodeText = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetErrorCodeText(self: *const IWbemStatusCodeText, hRes: HRESULT, LocaleId: u32, lFlags: i32, MessageText: ?*?BSTR) HRESULT {
        return self.vtable.GetErrorCodeText(self, hRes, LocaleId, lFlags, MessageText);
    }
    pub inline fn GetFacilityCodeText(self: *const IWbemStatusCodeText, hRes: HRESULT, LocaleId: u32, lFlags: i32, MessageText: ?*?BSTR) HRESULT {
...
pub const IWbemBackupRestore = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Backup(self: *const IWbemBackupRestore, strBackupToFile: ?[*:0]const u16, lFlags: i32) HRESULT {
        return self.vtable.Backup(self, strBackupToFile, lFlags);
    }
    pub inline fn Restore(self: *const IWbemBackupRestore, strRestoreFromFile: ?[*:0]const u16, lFlags: i32) HRESULT {
...
pub const IWbemBackupRestoreEx = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Pause(self: *const IWbemBackupRestoreEx) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn Resume(self: *const IWbemBackupRestoreEx) HRESULT {
...
pub const IWbemRefresher = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Refresh(self: *const IWbemRefresher, lFlags: i32) HRESULT {
...
pub const IWbemHiPerfEnum = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddObjects(self: *const IWbemHiPerfEnum, lFlags: i32, uNumObjects: u32, apIds: [*]i32, apObj: [*]?*IWbemObjectAccess) HRESULT {
        return self.vtable.AddObjects(self, lFlags, uNumObjects, apIds, apObj);
    }
    pub inline fn RemoveObjects(self: *const IWbemHiPerfEnum, lFlags: i32, uNumObjects: u32, apIds: [*]i32) HRESULT {
        return self.vtable.RemoveObjects(self, lFlags, uNumObjects, apIds);
    }
    pub inline fn GetObjects(self: *const IWbemHiPerfEnum, lFlags: i32, uNumObjects: u32, apObj: [*]?*IWbemObjectAccess, puReturned: ?*u32) HRESULT {
        return self.vtable.GetObjects(self, lFlags, uNumObjects, apObj, puReturned);
    }
    pub inline fn RemoveAll(self: *const IWbemHiPerfEnum, lFlags: i32) HRESULT {
...
pub const IWbemConfigureRefresher = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddObjectByPath(self: *const IWbemConfigureRefresher, pNamespace: ?*IWbemServices, wszPath: ?[*:0]const u16, lFlags: i32, pContext: ?*IWbemContext, ppRefreshable: ?*?*IWbemClassObject, plId: ?*i32) HRESULT {
        return self.vtable.AddObjectByPath(self, pNamespace, wszPath, lFlags, pContext, ppRefreshable, plId);
    }
    pub inline fn AddObjectByTemplate(self: *const IWbemConfigureRefresher, pNamespace: ?*IWbemServices, pTemplate: ?*IWbemClassObject, lFlags: i32, pContext: ?*IWbemContext, ppRefreshable: ?*?*IWbemClassObject, plId: ?*i32) HRESULT {
        return self.vtable.AddObjectByTemplate(self, pNamespace, pTemplate, lFlags, pContext, ppRefreshable, plId);
    }
    pub inline fn AddRefresher(self: *const IWbemConfigureRefresher, pRefresher: ?*IWbemRefresher, lFlags: i32, plId: ?*i32) HRESULT {
        return self.vtable.AddRefresher(self, pRefresher, lFlags, plId);
    }
    pub inline fn Remove(self: *const IWbemConfigureRefresher, lId: i32, lFlags: i32) HRESULT {
        return self.vtable.Remove(self, lId, lFlags);
    }
    pub inline fn AddEnum(self: *const IWbemConfigureRefresher, pNamespace: ?*IWbemServices, wszClassName: ?[*:0]const u16, lFlags: i32, pContext: ?*IWbemContext, ppEnum: ?*?*IWbemHiPerfEnum, plId: ?*i32) HRESULT {
...
pub const IWbemObjectSinkEx = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn WriteMessage(self: *const IWbemObjectSinkEx, uChannel: u32, strMessage: ?BSTR) HRESULT {
        return self.vtable.WriteMessage(self, uChannel, strMessage);
    }
    pub inline fn WriteError(self: *const IWbemObjectSinkEx, pObjError: ?*IWbemClassObject, puReturned: ?*u8) HRESULT {
        return self.vtable.WriteError(self, pObjError, puReturned);
    }
    pub inline fn PromptUser(self: *const IWbemObjectSinkEx, strMessage: ?BSTR, uPromptType: u8, puReturned: ?*u8) HRESULT {
        return self.vtable.PromptUser(self, strMessage, uPromptType, puReturned);
    }
    pub inline fn WriteProgress(self: *const IWbemObjectSinkEx, strActivity: ?BSTR, strCurrentOperation: ?BSTR, strStatusDescription: ?BSTR, uPercentComplete: u32, uSecondsRemaining: u32) HRESULT {
    ...
    pub inline fn WriteStreamParameter(self: *const IWbemObjectSinkEx, strName: ?BSTR, vtValue: ?*VARIANT, ulType: u32, ulFlags: u32) HRESULT {
...
pub const IWbemShutdown = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Shutdown(self: *const IWbemShutdown, uReason: i32, uMaxMilliseconds: u32, pCtx: ?*IWbemContext) HRESULT {
...
pub const IWbemObjectTextSrc = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetText(self: *const IWbemObjectTextSrc, lFlags: i32, pObj: ?*IWbemClassObject, uObjTextFormat: u32, pCtx: ?*IWbemContext, strText: ?*?BSTR) HRESULT {
        return self.vtable.GetText(self, lFlags, pObj, uObjTextFormat, pCtx, strText);
    }
    pub inline fn CreateFromText(self: *const IWbemObjectTextSrc, lFlags: i32, strText: ?BSTR, uObjTextFormat: u32, pCtx: ?*IWbemContext, pNewObj: ?*?*IWbemClassObject) HRESULT {
...
pub const IMofCompiler = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CompileFile(self: *const IMofCompiler, FileName: ?PWSTR, ServerAndNamespace: ?PWSTR, User: ?PWSTR, Authority: ?PWSTR, Password: ?PWSTR, lOptionFlags: i32, lClassFlags: i32, lInstanceFlags: i32, pInfo: ?*WBEM_COMPILE_STATUS_INFO) HRESULT {
    ...
    pub inline fn CompileBuffer(self: *const IMofCompiler, BuffSize: i32, pBuffer: ?*u8, ServerAndNamespace: ?PWSTR, User: ?PWSTR, Authority: ?PWSTR, Password: ?PWSTR, lOptionFlags: i32, lClassFlags: i32, lInstanceFlags: i32, pInfo: ?*WBEM_COMPILE_STATUS_INFO) HRESULT {
    ...
    pub inline fn CreateBMOF(self: *const IMofCompiler, TextFileName: ?PWSTR, BMOFFileName: ?PWSTR, ServerAndNamespace: ?PWSTR, lOptionFlags: i32, lClassFlags: i32, lInstanceFlags: i32, pInfo: ?*WBEM_COMPILE_STATUS_INFO) HRESULT {
...
pub const IWbemPropertyProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetProperty(self: *const IWbemPropertyProvider, lFlags: i32, strLocale: ?BSTR, strClassMapping: ?BSTR, strInstMapping: ?BSTR, strPropMapping: ?BSTR, pvValue: ?*VARIANT) HRESULT {
        return self.vtable.GetProperty(self, lFlags, strLocale, strClassMapping, strInstMapping, strPropMapping, pvValue);
    }
    pub inline fn PutProperty(self: *const IWbemPropertyProvider, lFlags: i32, strLocale: ?BSTR, strClassMapping: ?BSTR, strInstMapping: ?BSTR, strPropMapping: ?BSTR, pvValue: ?*const VARIANT) HRESULT {
...
pub const IWbemUnboundObjectSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IndicateToConsumer(self: *const IWbemUnboundObjectSink, pLogicalConsumer: ?*IWbemClassObject, lNumObjects: i32, apObjects: [*]?*IWbemClassObject) HRESULT {
...
pub const IWbemEventProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ProvideEvents(self: *const IWbemEventProvider, pSink: ?*IWbemObjectSink, lFlags: i32) HRESULT {
...
pub const IWbemEventProviderQuerySink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn NewQuery(self: *const IWbemEventProviderQuerySink, dwId: u32, wszQueryLanguage: ?*u16, wszQuery: ?*u16) HRESULT {
        return self.vtable.NewQuery(self, dwId, wszQueryLanguage, wszQuery);
    }
    pub inline fn CancelQuery(self: *const IWbemEventProviderQuerySink, dwId: u32) HRESULT {
...
pub const IWbemEventProviderSecurity = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AccessCheck(self: *const IWbemEventProviderSecurity, wszQueryLanguage: ?*u16, wszQuery: ?*u16, lSidLength: i32, pSid: [*:0]const u8) HRESULT {
...
pub const IWbemEventConsumerProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindConsumer(self: *const IWbemEventConsumerProvider, pLogicalConsumer: ?*IWbemClassObject, ppConsumer: ?*?*IWbemUnboundObjectSink) HRESULT {
...
pub const IWbemProviderInitSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetStatus(self: *const IWbemProviderInitSink, lStatus: i32, lFlags: i32) HRESULT {
...
pub const IWbemProviderInit = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IWbemProviderInit, wszUser: ?PWSTR, lFlags: i32, wszNamespace: ?PWSTR, wszLocale: ?PWSTR, pNamespace: ?*IWbemServices, pCtx: ?*IWbemContext, pInitSink: ?*IWbemProviderInitSink) HRESULT {
...
pub const IWbemHiPerfProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn QueryInstances(self: *const IWbemHiPerfProvider, pNamespace: ?*IWbemServices, wszClass: ?PWSTR, lFlags: i32, pCtx: ?*IWbemContext, pSink: ?*IWbemObjectSink) HRESULT {
        return self.vtable.QueryInstances(self, pNamespace, wszClass, lFlags, pCtx, pSink);
    }
    pub inline fn CreateRefresher(self: *const IWbemHiPerfProvider, pNamespace: ?*IWbemServices, lFlags: i32, ppRefresher: ?*?*IWbemRefresher) HRESULT {
        return self.vtable.CreateRefresher(self, pNamespace, lFlags, ppRefresher);
    }
    pub inline fn CreateRefreshableObject(self: *const IWbemHiPerfProvider, pNamespace: ?*IWbemServices, pTemplate: ?*IWbemObjectAccess, pRefresher: ?*IWbemRefresher, lFlags: i32, pContext: ?*IWbemContext, ppRefreshable: ?*?*IWbemObjectAccess, plId: ?*i32) HRESULT {
        return self.vtable.CreateRefreshableObject(self, pNamespace, pTemplate, pRefresher, lFlags, pContext, ppRefreshable, plId);
    }
    pub inline fn StopRefreshing(self: *const IWbemHiPerfProvider, pRefresher: ?*IWbemRefresher, lId: i32, lFlags: i32) HRESULT {
        return self.vtable.StopRefreshing(self, pRefresher, lId, lFlags);
    }
    pub inline fn CreateRefreshableEnum(self: *const IWbemHiPerfProvider, pNamespace: ?*IWbemServices, wszClass: ?[*:0]const u16, pRefresher: ?*IWbemRefresher, lFlags: i32, pContext: ?*IWbemContext, pHiPerfEnum: ?*IWbemHiPerfEnum, plId: ?*i32) HRESULT {
        return self.vtable.CreateRefreshableEnum(self, pNamespace, wszClass, pRefresher, lFlags, pContext, pHiPerfEnum, plId);
    }
    pub inline fn GetObjects(self: *const IWbemHiPerfProvider, pNamespace: ?*IWbemServices, lNumObjects: i32, apObj: [*]?*IWbemObjectAccess, lFlags: i32, pContext: ?*IWbemContext) HRESULT {
...
pub const IWbemDecoupledRegistrar = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Register(self: *const IWbemDecoupledRegistrar, a_Flags: i32, a_Context: ?*IWbemContext, a_User: ?[*:0]const u16, a_Locale: ?[*:0]const u16, a_Scope: ?[*:0]const u16, a_Registration: ?[*:0]const u16, pIUnknown: ?*IUnknown) HRESULT {
        return self.vtable.Register(self, a_Flags, a_Context, a_User, a_Locale, a_Scope, a_Registration, pIUnknown);
    }
    pub inline fn UnRegister(self: *const IWbemDecoupledRegistrar) HRESULT {
...
pub const IWbemProviderIdentity = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetRegistrationObject(self: *const IWbemProviderIdentity, lFlags: i32, pProvReg: ?*IWbemClassObject) HRESULT {
...
pub const IWbemDecoupledBasicEventProvider = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetSink(self: *const IWbemDecoupledBasicEventProvider, a_Flags: i32, a_Context: ?*IWbemContext, a_Sink: ?*?*IWbemObjectSink) HRESULT {
        return self.vtable.GetSink(self, a_Flags, a_Context, a_Sink);
    }
    pub inline fn GetService(self: *const IWbemDecoupledBasicEventProvider, a_Flags: i32, a_Context: ?*IWbemContext, a_Service: ?*?*IWbemServices) HRESULT {
...
pub const IWbemEventSink = extern union {
    ...
    IWbemObjectSink: IWbemObjectSink,
    IUnknown: IUnknown,
    pub inline fn SetSinkSecurity(self: *const IWbemEventSink, lSDLength: i32, pSD: [*:0]u8) HRESULT {
        return self.vtable.SetSinkSecurity(self, lSDLength, pSD);
    }
    pub inline fn IsActive(self: *const IWbemEventSink) HRESULT {
        return self.vtable.IsActive(self);
    }
    pub inline fn GetRestrictedSink(self: *const IWbemEventSink, lNumQueries: i32, awszQueries: [*]const ?[*:0]const u16, pCallback: ?*IUnknown, ppSink: ?*?*IWbemEventSink) HRESULT {
        return self.vtable.GetRestrictedSink(self, lNumQueries, awszQueries, pCallback, ppSink);
    }
    pub inline fn SetBatchingParameters(self: *const IWbemEventSink, lFlags: i32, dwMaxBufferSize: u32, dwMaxSendLatency: u32) HRESULT {
...
pub const ISWbemServices = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Get(self: *const ISWbemServices, strObjectPath: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.Get(self, strObjectPath, iFlags, objWbemNamedValueSet, objWbemObject);
    }
    pub inline fn GetAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strObjectPath: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.GetAsync(self, objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn Delete(self: *const ISWbemServices, strObjectPath: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch) HRESULT {
        return self.vtable.Delete(self, strObjectPath, iFlags, objWbemNamedValueSet);
    }
    pub inline fn DeleteAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strObjectPath: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.DeleteAsync(self, objWbemSink, strObjectPath, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn InstancesOf(self: *const ISWbemServices, strClass: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.InstancesOf(self, strClass, iFlags, objWbemNamedValueSet, objWbemObjectSet);
    }
    pub inline fn InstancesOfAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strClass: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.InstancesOfAsync(self, objWbemSink, strClass, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn SubclassesOf(self: *const ISWbemServices, strSuperclass: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.SubclassesOf(self, strSuperclass, iFlags, objWbemNamedValueSet, objWbemObjectSet);
    }
    pub inline fn SubclassesOfAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strSuperclass: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.SubclassesOfAsync(self, objWbemSink, strSuperclass, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn ExecQuery(self: *const ISWbemServices, strQuery: ?BSTR, strQueryLanguage: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.ExecQuery(self, strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet, objWbemObjectSet);
    }
    pub inline fn ExecQueryAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strQuery: ?BSTR, strQueryLanguage: ?BSTR, lFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn ReferencesTo(self: *const ISWbemServices, strObjectPath: ?BSTR, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
    ...
    pub inline fn ReferencesToAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strObjectPath: ?BSTR, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn ExecNotificationQuery(self: *const ISWbemServices, strQuery: ?BSTR, strQueryLanguage: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemEventSource: ?*?*ISWbemEventSource) HRESULT {
        return self.vtable.ExecNotificationQuery(self, strQuery, strQueryLanguage, iFlags, objWbemNamedValueSet, objWbemEventSource);
    }
    pub inline fn ExecNotificationQueryAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strQuery: ?BSTR, strQueryLanguage: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn ExecMethod(self: *const ISWbemServices, strObjectPath: ?BSTR, strMethodName: ?BSTR, objWbemInParameters: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemOutParameters: ?*?*ISWbemObject) HRESULT {
    ...
    pub inline fn ExecMethodAsync(self: *const ISWbemServices, objWbemSink: ?*IDispatch, strObjectPath: ?BSTR, strMethodName: ?BSTR, objWbemInParameters: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn get_Security_(self: *const ISWbemServices, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
...
pub const ISWbemLocator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn ConnectServer(self: *const ISWbemLocator, strServer: ?BSTR, strNamespace: ?BSTR, strUser: ?BSTR, strPassword: ?BSTR, strLocale: ?BSTR, strAuthority: ?BSTR, iSecurityFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemServices: ?*?*ISWbemServices) HRESULT {
    ...
    pub inline fn get_Security_(self: *const ISWbemLocator, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
        return self.vtable.get_Security_(self, objWbemSecurity);
    }
};
...
pub const ISWbemObject = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Put_(self: *const ISWbemObject, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectPath: ?*?*ISWbemObjectPath) HRESULT {
        return self.vtable.Put_(self, iFlags, objWbemNamedValueSet, objWbemObjectPath);
    }
    pub inline fn PutAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.PutAsync_(self, objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn Delete_(self: *const ISWbemObject, iFlags: i32, objWbemNamedValueSet: ?*IDispatch) HRESULT {
        return self.vtable.Delete_(self, iFlags, objWbemNamedValueSet);
    }
    pub inline fn DeleteAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.DeleteAsync_(self, objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn Instances_(self: *const ISWbemObject, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.Instances_(self, iFlags, objWbemNamedValueSet, objWbemObjectSet);
    }
    pub inline fn InstancesAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.InstancesAsync_(self, objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn Subclasses_(self: *const ISWbemObject, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.Subclasses_(self, iFlags, objWbemNamedValueSet, objWbemObjectSet);
    }
    pub inline fn SubclassesAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
        return self.vtable.SubclassesAsync_(self, objWbemSink, iFlags, objWbemNamedValueSet, objWbemAsyncContext);
    }
    pub inline fn Associators_(self: *const ISWbemObject, strAssocClass: ?BSTR, strResultClass: ?BSTR, strResultRole: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredAssocQualifier: ?BSTR, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
    ...
    pub inline fn AssociatorsAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, strAssocClass: ?BSTR, strResultClass: ?BSTR, strResultRole: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredAssocQualifier: ?BSTR, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn References_(self: *const ISWbemObject, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
    ...
    pub inline fn ReferencesAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, strResultClass: ?BSTR, strRole: ?BSTR, bClassesOnly: i16, bSchemaOnly: i16, strRequiredQualifier: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn ExecMethod_(self: *const ISWbemObject, strMethodName: ?BSTR, objWbemInParameters: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemOutParameters: ?*?*ISWbemObject) HRESULT {
        return self.vtable.ExecMethod_(self, strMethodName, objWbemInParameters, iFlags, objWbemNamedValueSet, objWbemOutParameters);
    }
    pub inline fn ExecMethodAsync_(self: *const ISWbemObject, objWbemSink: ?*IDispatch, strMethodName: ?BSTR, objWbemInParameters: ?*IDispatch, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
    ...
    pub inline fn Clone_(self: *const ISWbemObject, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.Clone_(self, objWbemObject);
    }
    pub inline fn GetObjectText_(self: *const ISWbemObject, iFlags: i32, strObjectText: ?*?BSTR) HRESULT {
        return self.vtable.GetObjectText_(self, iFlags, strObjectText);
    }
    pub inline fn SpawnDerivedClass_(self: *const ISWbemObject, iFlags: i32, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.SpawnDerivedClass_(self, iFlags, objWbemObject);
    }
    pub inline fn SpawnInstance_(self: *const ISWbemObject, iFlags: i32, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.SpawnInstance_(self, iFlags, objWbemObject);
    }
    pub inline fn CompareTo_(self: *const ISWbemObject, objWbemObject: ?*IDispatch, iFlags: i32, bResult: ?*i16) HRESULT {
        return self.vtable.CompareTo_(self, objWbemObject, iFlags, bResult);
    }
    pub inline fn get_Qualifiers_(self: *const ISWbemObject, objWbemQualifierSet: ?*?*ISWbemQualifierSet) HRESULT {
        return self.vtable.get_Qualifiers_(self, objWbemQualifierSet);
    }
    pub inline fn get_Properties_(self: *const ISWbemObject, objWbemPropertySet: ?*?*ISWbemPropertySet) HRESULT {
        return self.vtable.get_Properties_(self, objWbemPropertySet);
    }
    pub inline fn get_Methods_(self: *const ISWbemObject, objWbemMethodSet: ?*?*ISWbemMethodSet) HRESULT {
        return self.vtable.get_Methods_(self, objWbemMethodSet);
    }
    pub inline fn get_Derivation_(self: *const ISWbemObject, strClassNameArray: ?*VARIANT) HRESULT {
        return self.vtable.get_Derivation_(self, strClassNameArray);
    }
    pub inline fn get_Path_(self: *const ISWbemObject, objWbemObjectPath: ?*?*ISWbemObjectPath) HRESULT {
        return self.vtable.get_Path_(self, objWbemObjectPath);
    }
    pub inline fn get_Security_(self: *const ISWbemObject, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
        return self.vtable.get_Security_(self, objWbemSecurity);
    }
};
...
pub const ISWbemObjectSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemObjectSet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemObjectSet, strObjectPath: ?BSTR, iFlags: i32, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.Item(self, strObjectPath, iFlags, objWbemObject);
    }
    pub inline fn get_Count(self: *const ISWbemObjectSet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn get_Security_(self: *const ISWbemObjectSet, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
        return self.vtable.get_Security_(self, objWbemSecurity);
    }
    pub inline fn ItemIndex(self: *const ISWbemObjectSet, lIndex: i32, objWbemObject: ?*?*ISWbemObject) HRESULT {
...
pub const ISWbemNamedValue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Value(self: *const ISWbemNamedValue, varValue: ?*VARIANT) HRESULT {
        return self.vtable.get_Value(self, varValue);
    }
    pub inline fn put_Value(self: *const ISWbemNamedValue, varValue: ?*VARIANT) HRESULT {
        return self.vtable.put_Value(self, varValue);
    }
    pub inline fn get_Name(self: *const ISWbemNamedValue, strName: ?*?BSTR) HRESULT {
...
pub const ISWbemNamedValueSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemNamedValueSet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemNamedValueSet, strName: ?BSTR, iFlags: i32, objWbemNamedValue: ?*?*ISWbemNamedValue) HRESULT {
        return self.vtable.Item(self, strName, iFlags, objWbemNamedValue);
    }
    pub inline fn get_Count(self: *const ISWbemNamedValueSet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn Add(self: *const ISWbemNamedValueSet, strName: ?BSTR, varValue: ?*VARIANT, iFlags: i32, objWbemNamedValue: ?*?*ISWbemNamedValue) HRESULT {
        return self.vtable.Add(self, strName, varValue, iFlags, objWbemNamedValue);
    }
    pub inline fn Remove(self: *const ISWbemNamedValueSet, strName: ?BSTR, iFlags: i32) HRESULT {
        return self.vtable.Remove(self, strName, iFlags);
    }
    pub inline fn Clone(self: *const ISWbemNamedValueSet, objWbemNamedValueSet: ?*?*ISWbemNamedValueSet) HRESULT {
        return self.vtable.Clone(self, objWbemNamedValueSet);
    }
    pub inline fn DeleteAll(self: *const ISWbemNamedValueSet) HRESULT {
        return self.vtable.DeleteAll(self);
    }
};
...
pub const ISWbemQualifier = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Value(self: *const ISWbemQualifier, varValue: ?*VARIANT) HRESULT {
        return self.vtable.get_Value(self, varValue);
    }
    pub inline fn put_Value(self: *const ISWbemQualifier, varValue: ?*VARIANT) HRESULT {
        return self.vtable.put_Value(self, varValue);
    }
    pub inline fn get_Name(self: *const ISWbemQualifier, strName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, strName);
    }
    pub inline fn get_IsLocal(self: *const ISWbemQualifier, bIsLocal: ?*i16) HRESULT {
        return self.vtable.get_IsLocal(self, bIsLocal);
    }
    pub inline fn get_PropagatesToSubclass(self: *const ISWbemQualifier, bPropagatesToSubclass: ?*i16) HRESULT {
        return self.vtable.get_PropagatesToSubclass(self, bPropagatesToSubclass);
    }
    pub inline fn put_PropagatesToSubclass(self: *const ISWbemQualifier, bPropagatesToSubclass: i16) HRESULT {
        return self.vtable.put_PropagatesToSubclass(self, bPropagatesToSubclass);
    }
    pub inline fn get_PropagatesToInstance(self: *const ISWbemQualifier, bPropagatesToInstance: ?*i16) HRESULT {
        return self.vtable.get_PropagatesToInstance(self, bPropagatesToInstance);
    }
    pub inline fn put_PropagatesToInstance(self: *const ISWbemQualifier, bPropagatesToInstance: i16) HRESULT {
        return self.vtable.put_PropagatesToInstance(self, bPropagatesToInstance);
    }
    pub inline fn get_IsOverridable(self: *const ISWbemQualifier, bIsOverridable: ?*i16) HRESULT {
        return self.vtable.get_IsOverridable(self, bIsOverridable);
    }
    pub inline fn put_IsOverridable(self: *const ISWbemQualifier, bIsOverridable: i16) HRESULT {
        return self.vtable.put_IsOverridable(self, bIsOverridable);
    }
    pub inline fn get_IsAmended(self: *const ISWbemQualifier, bIsAmended: ?*i16) HRESULT {
...
pub const ISWbemQualifierSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemQualifierSet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemQualifierSet, name: ?BSTR, iFlags: i32, objWbemQualifier: ?*?*ISWbemQualifier) HRESULT {
        return self.vtable.Item(self, name, iFlags, objWbemQualifier);
    }
    pub inline fn get_Count(self: *const ISWbemQualifierSet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn Add(self: *const ISWbemQualifierSet, strName: ?BSTR, varVal: ?*VARIANT, bPropagatesToSubclass: i16, bPropagatesToInstance: i16, bIsOverridable: i16, iFlags: i32, objWbemQualifier: ?*?*ISWbemQualifier) HRESULT {
    ...
    pub inline fn Remove(self: *const ISWbemQualifierSet, strName: ?BSTR, iFlags: i32) HRESULT {
        return self.vtable.Remove(self, strName, iFlags);
    }
};
...
pub const ISWbemProperty = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Value(self: *const ISWbemProperty, varValue: ?*VARIANT) HRESULT {
        return self.vtable.get_Value(self, varValue);
    }
    pub inline fn put_Value(self: *const ISWbemProperty, varValue: ?*VARIANT) HRESULT {
        return self.vtable.put_Value(self, varValue);
    }
    pub inline fn get_Name(self: *const ISWbemProperty, strName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, strName);
    }
    pub inline fn get_IsLocal(self: *const ISWbemProperty, bIsLocal: ?*i16) HRESULT {
        return self.vtable.get_IsLocal(self, bIsLocal);
    }
    pub inline fn get_Origin(self: *const ISWbemProperty, strOrigin: ?*?BSTR) HRESULT {
        return self.vtable.get_Origin(self, strOrigin);
    }
    pub inline fn get_CIMType(self: *const ISWbemProperty, iCimType: ?*WbemCimtypeEnum) HRESULT {
        return self.vtable.get_CIMType(self, iCimType);
    }
    pub inline fn get_Qualifiers_(self: *const ISWbemProperty, objWbemQualifierSet: ?*?*ISWbemQualifierSet) HRESULT {
        return self.vtable.get_Qualifiers_(self, objWbemQualifierSet);
    }
    pub inline fn get_IsArray(self: *const ISWbemProperty, bIsArray: ?*i16) HRESULT {
...
pub const ISWbemPropertySet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemPropertySet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemPropertySet, strName: ?BSTR, iFlags: i32, objWbemProperty: ?*?*ISWbemProperty) HRESULT {
        return self.vtable.Item(self, strName, iFlags, objWbemProperty);
    }
    pub inline fn get_Count(self: *const ISWbemPropertySet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn Add(self: *const ISWbemPropertySet, strName: ?BSTR, iCIMType: WbemCimtypeEnum, bIsArray: i16, iFlags: i32, objWbemProperty: ?*?*ISWbemProperty) HRESULT {
        return self.vtable.Add(self, strName, iCIMType, bIsArray, iFlags, objWbemProperty);
    }
    pub inline fn Remove(self: *const ISWbemPropertySet, strName: ?BSTR, iFlags: i32) HRESULT {
        return self.vtable.Remove(self, strName, iFlags);
    }
};
...
pub const ISWbemMethod = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const ISWbemMethod, strName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, strName);
    }
    pub inline fn get_Origin(self: *const ISWbemMethod, strOrigin: ?*?BSTR) HRESULT {
        return self.vtable.get_Origin(self, strOrigin);
    }
    pub inline fn get_InParameters(self: *const ISWbemMethod, objWbemInParameters: ?*?*ISWbemObject) HRESULT {
        return self.vtable.get_InParameters(self, objWbemInParameters);
    }
    pub inline fn get_OutParameters(self: *const ISWbemMethod, objWbemOutParameters: ?*?*ISWbemObject) HRESULT {
        return self.vtable.get_OutParameters(self, objWbemOutParameters);
    }
    pub inline fn get_Qualifiers_(self: *const ISWbemMethod, objWbemQualifierSet: ?*?*ISWbemQualifierSet) HRESULT {
        return self.vtable.get_Qualifiers_(self, objWbemQualifierSet);
    }
};
...
pub const ISWbemMethodSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemMethodSet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemMethodSet, strName: ?BSTR, iFlags: i32, objWbemMethod: ?*?*ISWbemMethod) HRESULT {
        return self.vtable.Item(self, strName, iFlags, objWbemMethod);
    }
    pub inline fn get_Count(self: *const ISWbemMethodSet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
};
...
pub const ISWbemEventSource = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn NextEvent(self: *const ISWbemEventSource, iTimeoutMs: i32, objWbemObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.NextEvent(self, iTimeoutMs, objWbemObject);
    }
    pub inline fn get_Security_(self: *const ISWbemEventSource, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
        return self.vtable.get_Security_(self, objWbemSecurity);
    }
};
...
pub const ISWbemObjectPath = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Path(self: *const ISWbemObjectPath, strPath: ?*?BSTR) HRESULT {
        return self.vtable.get_Path(self, strPath);
    }
    pub inline fn put_Path(self: *const ISWbemObjectPath, strPath: ?BSTR) HRESULT {
        return self.vtable.put_Path(self, strPath);
    }
    pub inline fn get_RelPath(self: *const ISWbemObjectPath, strRelPath: ?*?BSTR) HRESULT {
        return self.vtable.get_RelPath(self, strRelPath);
    }
    pub inline fn put_RelPath(self: *const ISWbemObjectPath, strRelPath: ?BSTR) HRESULT {
        return self.vtable.put_RelPath(self, strRelPath);
    }
    pub inline fn get_Server(self: *const ISWbemObjectPath, strServer: ?*?BSTR) HRESULT {
        return self.vtable.get_Server(self, strServer);
    }
    pub inline fn put_Server(self: *const ISWbemObjectPath, strServer: ?BSTR) HRESULT {
        return self.vtable.put_Server(self, strServer);
    }
    pub inline fn get_Namespace(self: *const ISWbemObjectPath, strNamespace: ?*?BSTR) HRESULT {
        return self.vtable.get_Namespace(self, strNamespace);
    }
    pub inline fn put_Namespace(self: *const ISWbemObjectPath, strNamespace: ?BSTR) HRESULT {
        return self.vtable.put_Namespace(self, strNamespace);
    }
    pub inline fn get_ParentNamespace(self: *const ISWbemObjectPath, strParentNamespace: ?*?BSTR) HRESULT {
        return self.vtable.get_ParentNamespace(self, strParentNamespace);
    }
    pub inline fn get_DisplayName(self: *const ISWbemObjectPath, strDisplayName: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, strDisplayName);
    }
    pub inline fn put_DisplayName(self: *const ISWbemObjectPath, strDisplayName: ?BSTR) HRESULT {
        return self.vtable.put_DisplayName(self, strDisplayName);
    }
    pub inline fn get_Class(self: *const ISWbemObjectPath, strClass: ?*?BSTR) HRESULT {
        return self.vtable.get_Class(self, strClass);
    }
    pub inline fn put_Class(self: *const ISWbemObjectPath, strClass: ?BSTR) HRESULT {
        return self.vtable.put_Class(self, strClass);
    }
    pub inline fn get_IsClass(self: *const ISWbemObjectPath, bIsClass: ?*i16) HRESULT {
        return self.vtable.get_IsClass(self, bIsClass);
    }
    pub inline fn SetAsClass(self: *const ISWbemObjectPath) HRESULT {
        return self.vtable.SetAsClass(self);
    }
    pub inline fn get_IsSingleton(self: *const ISWbemObjectPath, bIsSingleton: ?*i16) HRESULT {
        return self.vtable.get_IsSingleton(self, bIsSingleton);
    }
    pub inline fn SetAsSingleton(self: *const ISWbemObjectPath) HRESULT {
        return self.vtable.SetAsSingleton(self);
    }
    pub inline fn get_Keys(self: *const ISWbemObjectPath, objWbemNamedValueSet: ?*?*ISWbemNamedValueSet) HRESULT {
        return self.vtable.get_Keys(self, objWbemNamedValueSet);
    }
    pub inline fn get_Security_(self: *const ISWbemObjectPath, objWbemSecurity: ?*?*ISWbemSecurity) HRESULT {
        return self.vtable.get_Security_(self, objWbemSecurity);
    }
    pub inline fn get_Locale(self: *const ISWbemObjectPath, strLocale: ?*?BSTR) HRESULT {
        return self.vtable.get_Locale(self, strLocale);
    }
    pub inline fn put_Locale(self: *const ISWbemObjectPath, strLocale: ?BSTR) HRESULT {
        return self.vtable.put_Locale(self, strLocale);
    }
    pub inline fn get_Authority(self: *const ISWbemObjectPath, strAuthority: ?*?BSTR) HRESULT {
        return self.vtable.get_Authority(self, strAuthority);
    }
    pub inline fn put_Authority(self: *const ISWbemObjectPath, strAuthority: ?BSTR) HRESULT {
...
pub const ISWbemSink = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Cancel(self: *const ISWbemSink) HRESULT {
...
pub const ISWbemSecurity = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ImpersonationLevel(self: *const ISWbemSecurity, iImpersonationLevel: ?*WbemImpersonationLevelEnum) HRESULT {
        return self.vtable.get_ImpersonationLevel(self, iImpersonationLevel);
    }
    pub inline fn put_ImpersonationLevel(self: *const ISWbemSecurity, iImpersonationLevel: WbemImpersonationLevelEnum) HRESULT {
        return self.vtable.put_ImpersonationLevel(self, iImpersonationLevel);
    }
    pub inline fn get_AuthenticationLevel(self: *const ISWbemSecurity, iAuthenticationLevel: ?*WbemAuthenticationLevelEnum) HRESULT {
        return self.vtable.get_AuthenticationLevel(self, iAuthenticationLevel);
    }
    pub inline fn put_AuthenticationLevel(self: *const ISWbemSecurity, iAuthenticationLevel: WbemAuthenticationLevelEnum) HRESULT {
        return self.vtable.put_AuthenticationLevel(self, iAuthenticationLevel);
    }
    pub inline fn get_Privileges(self: *const ISWbemSecurity, objWbemPrivilegeSet: ?*?*ISWbemPrivilegeSet) HRESULT {
...
pub const ISWbemPrivilege = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_IsEnabled(self: *const ISWbemPrivilege, bIsEnabled: ?*i16) HRESULT {
        return self.vtable.get_IsEnabled(self, bIsEnabled);
    }
    pub inline fn put_IsEnabled(self: *const ISWbemPrivilege, bIsEnabled: i16) HRESULT {
        return self.vtable.put_IsEnabled(self, bIsEnabled);
    }
    pub inline fn get_Name(self: *const ISWbemPrivilege, strDisplayName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, strDisplayName);
    }
    pub inline fn get_DisplayName(self: *const ISWbemPrivilege, strDisplayName: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, strDisplayName);
    }
    pub inline fn get_Identifier(self: *const ISWbemPrivilege, iPrivilege: ?*WbemPrivilegeEnum) HRESULT {
...
pub const ISWbemPrivilegeSet = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemPrivilegeSet, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemPrivilegeSet, iPrivilege: WbemPrivilegeEnum, objWbemPrivilege: ?*?*ISWbemPrivilege) HRESULT {
        return self.vtable.Item(self, iPrivilege, objWbemPrivilege);
    }
    pub inline fn get_Count(self: *const ISWbemPrivilegeSet, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn Add(self: *const ISWbemPrivilegeSet, iPrivilege: WbemPrivilegeEnum, bIsEnabled: i16, objWbemPrivilege: ?*?*ISWbemPrivilege) HRESULT {
        return self.vtable.Add(self, iPrivilege, bIsEnabled, objWbemPrivilege);
    }
    pub inline fn Remove(self: *const ISWbemPrivilegeSet, iPrivilege: WbemPrivilegeEnum) HRESULT {
        return self.vtable.Remove(self, iPrivilege);
    }
    pub inline fn DeleteAll(self: *const ISWbemPrivilegeSet) HRESULT {
        return self.vtable.DeleteAll(self);
    }
    pub inline fn AddAsString(self: *const ISWbemPrivilegeSet, strPrivilege: ?BSTR, bIsEnabled: i16, objWbemPrivilege: ?*?*ISWbemPrivilege) HRESULT {
...
pub const ISWbemServicesEx = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Put(self: *const ISWbemServicesEx, objWbemObject: ?*ISWbemObjectEx, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemObjectPath: ?*?*ISWbemObjectPath) HRESULT {
        return self.vtable.Put(self, objWbemObject, iFlags, objWbemNamedValueSet, objWbemObjectPath);
    }
    pub inline fn PutAsync(self: *const ISWbemServicesEx, objWbemSink: ?*ISWbemSink, objWbemObject: ?*ISWbemObjectEx, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemAsyncContext: ?*IDispatch) HRESULT {
...
pub const ISWbemObjectEx = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Refresh_(self: *const ISWbemObjectEx, iFlags: i32, objWbemNamedValueSet: ?*IDispatch) HRESULT {
        return self.vtable.Refresh_(self, iFlags, objWbemNamedValueSet);
    }
    pub inline fn get_SystemProperties_(self: *const ISWbemObjectEx, objWbemPropertySet: ?*?*ISWbemPropertySet) HRESULT {
        return self.vtable.get_SystemProperties_(self, objWbemPropertySet);
    }
    pub inline fn GetText_(self: *const ISWbemObjectEx, iObjectTextFormat: WbemObjectTextFormatEnum, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, bsText: ?*?BSTR) HRESULT {
        return self.vtable.GetText_(self, iObjectTextFormat, iFlags, objWbemNamedValueSet, bsText);
    }
    pub inline fn SetFromText_(self: *const ISWbemObjectEx, bsText: ?BSTR, iObjectTextFormat: WbemObjectTextFormatEnum, iFlags: i32, objWbemNamedValueSet: ?*IDispatch) HRESULT {
...
pub const ISWbemDateTime = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Value(self: *const ISWbemDateTime, strValue: ?*?BSTR) HRESULT {
        return self.vtable.get_Value(self, strValue);
    }
    pub inline fn put_Value(self: *const ISWbemDateTime, strValue: ?BSTR) HRESULT {
        return self.vtable.put_Value(self, strValue);
    }
    pub inline fn get_Year(self: *const ISWbemDateTime, iYear: ?*i32) HRESULT {
        return self.vtable.get_Year(self, iYear);
    }
    pub inline fn put_Year(self: *const ISWbemDateTime, iYear: i32) HRESULT {
        return self.vtable.put_Year(self, iYear);
    }
    pub inline fn get_YearSpecified(self: *const ISWbemDateTime, bYearSpecified: ?*i16) HRESULT {
        return self.vtable.get_YearSpecified(self, bYearSpecified);
    }
    pub inline fn put_YearSpecified(self: *const ISWbemDateTime, bYearSpecified: i16) HRESULT {
        return self.vtable.put_YearSpecified(self, bYearSpecified);
    }
    pub inline fn get_Month(self: *const ISWbemDateTime, iMonth: ?*i32) HRESULT {
        return self.vtable.get_Month(self, iMonth);
    }
    pub inline fn put_Month(self: *const ISWbemDateTime, iMonth: i32) HRESULT {
        return self.vtable.put_Month(self, iMonth);
    }
    pub inline fn get_MonthSpecified(self: *const ISWbemDateTime, bMonthSpecified: ?*i16) HRESULT {
        return self.vtable.get_MonthSpecified(self, bMonthSpecified);
    }
    pub inline fn put_MonthSpecified(self: *const ISWbemDateTime, bMonthSpecified: i16) HRESULT {
        return self.vtable.put_MonthSpecified(self, bMonthSpecified);
    }
    pub inline fn get_Day(self: *const ISWbemDateTime, iDay: ?*i32) HRESULT {
        return self.vtable.get_Day(self, iDay);
    }
    pub inline fn put_Day(self: *const ISWbemDateTime, iDay: i32) HRESULT {
        return self.vtable.put_Day(self, iDay);
    }
    pub inline fn get_DaySpecified(self: *const ISWbemDateTime, bDaySpecified: ?*i16) HRESULT {
        return self.vtable.get_DaySpecified(self, bDaySpecified);
    }
    pub inline fn put_DaySpecified(self: *const ISWbemDateTime, bDaySpecified: i16) HRESULT {
        return self.vtable.put_DaySpecified(self, bDaySpecified);
    }
    pub inline fn get_Hours(self: *const ISWbemDateTime, iHours: ?*i32) HRESULT {
        return self.vtable.get_Hours(self, iHours);
    }
    pub inline fn put_Hours(self: *const ISWbemDateTime, iHours: i32) HRESULT {
        return self.vtable.put_Hours(self, iHours);
    }
    pub inline fn get_HoursSpecified(self: *const ISWbemDateTime, bHoursSpecified: ?*i16) HRESULT {
        return self.vtable.get_HoursSpecified(self, bHoursSpecified);
    }
    pub inline fn put_HoursSpecified(self: *const ISWbemDateTime, bHoursSpecified: i16) HRESULT {
        return self.vtable.put_HoursSpecified(self, bHoursSpecified);
    }
    pub inline fn get_Minutes(self: *const ISWbemDateTime, iMinutes: ?*i32) HRESULT {
        return self.vtable.get_Minutes(self, iMinutes);
    }
    pub inline fn put_Minutes(self: *const ISWbemDateTime, iMinutes: i32) HRESULT {
        return self.vtable.put_Minutes(self, iMinutes);
    }
    pub inline fn get_MinutesSpecified(self: *const ISWbemDateTime, bMinutesSpecified: ?*i16) HRESULT {
        return self.vtable.get_MinutesSpecified(self, bMinutesSpecified);
    }
    pub inline fn put_MinutesSpecified(self: *const ISWbemDateTime, bMinutesSpecified: i16) HRESULT {
        return self.vtable.put_MinutesSpecified(self, bMinutesSpecified);
    }
    pub inline fn get_Seconds(self: *const ISWbemDateTime, iSeconds: ?*i32) HRESULT {
        return self.vtable.get_Seconds(self, iSeconds);
    }
    pub inline fn put_Seconds(self: *const ISWbemDateTime, iSeconds: i32) HRESULT {
        return self.vtable.put_Seconds(self, iSeconds);
    }
    pub inline fn get_SecondsSpecified(self: *const ISWbemDateTime, bSecondsSpecified: ?*i16) HRESULT {
        return self.vtable.get_SecondsSpecified(self, bSecondsSpecified);
    }
    pub inline fn put_SecondsSpecified(self: *const ISWbemDateTime, bSecondsSpecified: i16) HRESULT {
        return self.vtable.put_SecondsSpecified(self, bSecondsSpecified);
    }
    pub inline fn get_Microseconds(self: *const ISWbemDateTime, iMicroseconds: ?*i32) HRESULT {
        return self.vtable.get_Microseconds(self, iMicroseconds);
    }
    pub inline fn put_Microseconds(self: *const ISWbemDateTime, iMicroseconds: i32) HRESULT {
        return self.vtable.put_Microseconds(self, iMicroseconds);
    }
    pub inline fn get_MicrosecondsSpecified(self: *const ISWbemDateTime, bMicrosecondsSpecified: ?*i16) HRESULT {
        return self.vtable.get_MicrosecondsSpecified(self, bMicrosecondsSpecified);
    }
    pub inline fn put_MicrosecondsSpecified(self: *const ISWbemDateTime, bMicrosecondsSpecified: i16) HRESULT {
        return self.vtable.put_MicrosecondsSpecified(self, bMicrosecondsSpecified);
    }
    pub inline fn get_UTC(self: *const ISWbemDateTime, iUTC: ?*i32) HRESULT {
        return self.vtable.get_UTC(self, iUTC);
    }
    pub inline fn put_UTC(self: *const ISWbemDateTime, iUTC: i32) HRESULT {
        return self.vtable.put_UTC(self, iUTC);
    }
    pub inline fn get_UTCSpecified(self: *const ISWbemDateTime, bUTCSpecified: ?*i16) HRESULT {
        return self.vtable.get_UTCSpecified(self, bUTCSpecified);
    }
    pub inline fn put_UTCSpecified(self: *const ISWbemDateTime, bUTCSpecified: i16) HRESULT {
        return self.vtable.put_UTCSpecified(self, bUTCSpecified);
    }
    pub inline fn get_IsInterval(self: *const ISWbemDateTime, bIsInterval: ?*i16) HRESULT {
        return self.vtable.get_IsInterval(self, bIsInterval);
    }
    pub inline fn put_IsInterval(self: *const ISWbemDateTime, bIsInterval: i16) HRESULT {
        return self.vtable.put_IsInterval(self, bIsInterval);
    }
    pub inline fn GetVarDate(self: *const ISWbemDateTime, bIsLocal: i16, dVarDate: ?*f64) HRESULT {
        return self.vtable.GetVarDate(self, bIsLocal, dVarDate);
    }
    pub inline fn SetVarDate(self: *const ISWbemDateTime, dVarDate: f64, bIsLocal: i16) HRESULT {
        return self.vtable.SetVarDate(self, dVarDate, bIsLocal);
    }
    pub inline fn GetFileTime(self: *const ISWbemDateTime, bIsLocal: i16, strFileTime: ?*?BSTR) HRESULT {
        return self.vtable.GetFileTime(self, bIsLocal, strFileTime);
    }
    pub inline fn SetFileTime(self: *const ISWbemDateTime, strFileTime: ?BSTR, bIsLocal: i16) HRESULT {
...
pub const ISWbemRefresher = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get__NewEnum(self: *const ISWbemRefresher, pUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, pUnk);
    }
    pub inline fn Item(self: *const ISWbemRefresher, iIndex: i32, objWbemRefreshableItem: ?*?*ISWbemRefreshableItem) HRESULT {
        return self.vtable.Item(self, iIndex, objWbemRefreshableItem);
    }
    pub inline fn get_Count(self: *const ISWbemRefresher, iCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, iCount);
    }
    pub inline fn Add(self: *const ISWbemRefresher, objWbemServices: ?*ISWbemServicesEx, bsInstancePath: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemRefreshableItem: ?*?*ISWbemRefreshableItem) HRESULT {
        return self.vtable.Add(self, objWbemServices, bsInstancePath, iFlags, objWbemNamedValueSet, objWbemRefreshableItem);
    }
    pub inline fn AddEnum(self: *const ISWbemRefresher, objWbemServices: ?*ISWbemServicesEx, bsClassName: ?BSTR, iFlags: i32, objWbemNamedValueSet: ?*IDispatch, objWbemRefreshableItem: ?*?*ISWbemRefreshableItem) HRESULT {
        return self.vtable.AddEnum(self, objWbemServices, bsClassName, iFlags, objWbemNamedValueSet, objWbemRefreshableItem);
    }
    pub inline fn Remove(self: *const ISWbemRefresher, iIndex: i32, iFlags: i32) HRESULT {
        return self.vtable.Remove(self, iIndex, iFlags);
    }
    pub inline fn Refresh(self: *const ISWbemRefresher, iFlags: i32) HRESULT {
        return self.vtable.Refresh(self, iFlags);
    }
    pub inline fn get_AutoReconnect(self: *const ISWbemRefresher, bCount: ?*i16) HRESULT {
        return self.vtable.get_AutoReconnect(self, bCount);
    }
    pub inline fn put_AutoReconnect(self: *const ISWbemRefresher, bCount: i16) HRESULT {
        return self.vtable.put_AutoReconnect(self, bCount);
    }
    pub inline fn DeleteAll(self: *const ISWbemRefresher) HRESULT {
        return self.vtable.DeleteAll(self);
    }
};
...
pub const ISWbemRefreshableItem = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Index(self: *const ISWbemRefreshableItem, iIndex: ?*i32) HRESULT {
        return self.vtable.get_Index(self, iIndex);
    }
    pub inline fn get_Refresher(self: *const ISWbemRefreshableItem, objWbemRefresher: ?*?*ISWbemRefresher) HRESULT {
        return self.vtable.get_Refresher(self, objWbemRefresher);
    }
    pub inline fn get_IsSet(self: *const ISWbemRefreshableItem, bIsSet: ?*i16) HRESULT {
        return self.vtable.get_IsSet(self, bIsSet);
    }
    pub inline fn get_Object(self: *const ISWbemRefreshableItem, objWbemObject: ?*?*ISWbemObjectEx) HRESULT {
        return self.vtable.get_Object(self, objWbemObject);
    }
    pub inline fn get_ObjectSet(self: *const ISWbemRefreshableItem, objWbemObjectSet: ?*?*ISWbemObjectSet) HRESULT {
        return self.vtable.get_ObjectSet(self, objWbemObjectSet);
    }
    pub inline fn Remove(self: *const ISWbemRefreshableItem, iFlags: i32) HRESULT {
...
pub const IWMIExtension = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_WMIObjectPath(self: *const IWMIExtension, strWMIObjectPath: ?*?BSTR) HRESULT {
        return self.vtable.get_WMIObjectPath(self, strWMIObjectPath);
    }
    pub inline fn GetWMIObject(self: *const IWMIExtension, objWMIObject: ?*?*ISWbemObject) HRESULT {
        return self.vtable.GetWMIObject(self, objWMIObject);
    }
    pub inline fn GetWMIServices(self: *const IWMIExtension, objWMIServices: ?*?*ISWbemServices) HRESULT {
...
pub const IWbemTransport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IWbemTransport) HRESULT {
...
pub const IWbemLevel1Login = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn EstablishPosition(self: *const IWbemLevel1Login, wszLocaleList: ?PWSTR, dwNumLocales: u32, reserved: ?*u32) HRESULT {
        return self.vtable.EstablishPosition(self, wszLocaleList, dwNumLocales, reserved);
    }
    pub inline fn RequestChallenge(self: *const IWbemLevel1Login, wszNetworkResource: ?PWSTR, wszUser: ?PWSTR, Nonce: ?*u8) HRESULT {
        return self.vtable.RequestChallenge(self, wszNetworkResource, wszUser, Nonce);
    }
    pub inline fn WBEMLogin(self: *const IWbemLevel1Login, wszPreferredLocale: ?PWSTR, AccessToken: ?*u8, lFlags: i32, pCtx: ?*IWbemContext, ppNamespace: ?*?*IWbemServices) HRESULT {
        return self.vtable.WBEMLogin(self, wszPreferredLocale, AccessToken, lFlags, pCtx, ppNamespace);
    }
    pub inline fn NTLMLogin(self: *const IWbemLevel1Login, wszNetworkResource: ?PWSTR, wszPreferredLocale: ?PWSTR, lFlags: i32, pCtx: ?*IWbemContext, ppNamespace: ?*?*IWbemServices) HRESULT {
...
pub const IWbemConnectorLogin = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ConnectorLogin(self: *const IWbemConnectorLogin, wszNetworkResource: ?PWSTR, wszPreferredLocale: ?PWSTR, lFlags: i32, pCtx: ?*IWbemContext, riid: ?*const Guid, pInterface: **anyopaque) HRESULT {
...
pub const IWbemAddressResolution = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Resolve(self: *const IWbemAddressResolution, wszNamespacePath: ?PWSTR, wszAddressType: ?PWSTR, pdwAddressLength: ?*u32, pabBinaryAddress: ?*?*u8) HRESULT {
...
pub const IWbemClientTransport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ConnectServer(self: *const IWbemClientTransport, strAddressType: ?BSTR, dwBinaryAddressLength: u32, abBinaryAddress: [*:0]u8, strNetworkResource: ?BSTR, strUser: ?BSTR, strPassword: ?BSTR, strLocale: ?BSTR, lSecurityFlags: i32, strAuthority: ?BSTR, pCtx: ?*IWbemContext, ppNamespace: ?*?*IWbemServices) HRESULT {
...
pub const IWbemClientConnectionTransport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Open(self: *const IWbemClientConnectionTransport, strAddressType: ?BSTR, dwBinaryAddressLength: u32, abBinaryAddress: [*:0]u8, strObject: ?BSTR, strUser: ?BSTR, strPassword: ?BSTR, strLocale: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, riid: ?*const Guid, pInterface: **anyopaque, pCallRes: ?*?*IWbemCallResult) HRESULT {
    ...
    pub inline fn OpenAsync(self: *const IWbemClientConnectionTransport, strAddressType: ?BSTR, dwBinaryAddressLength: u32, abBinaryAddress: [*:0]u8, strObject: ?BSTR, strUser: ?BSTR, strPassword: ?BSTR, strLocale: ?BSTR, lFlags: i32, pCtx: ?*IWbemContext, riid: ?*const Guid, pResponseHandler: ?*IWbemObjectSink) HRESULT {
    ...
    pub inline fn Cancel(self: *const IWbemClientConnectionTransport, lFlags: i32, pHandler: ?*IWbemObjectSink) HRESULT {
...
pub const IWbemConstructClassObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetInheritanceChain(self: *const IWbemConstructClassObject, lNumAntecedents: i32, awszAntecedents: ?*?PWSTR) HRESULT {
        return self.vtable.SetInheritanceChain(self, lNumAntecedents, awszAntecedents);
    }
    pub inline fn SetPropertyOrigin(self: *const IWbemConstructClassObject, wszPropertyName: ?[*:0]const u16, lOriginIndex: i32) HRESULT {
        return self.vtable.SetPropertyOrigin(self, wszPropertyName, lOriginIndex);
    }
    pub inline fn SetMethodOrigin(self: *const IWbemConstructClassObject, wszMethodName: ?[*:0]const u16, lOriginIndex: i32) HRESULT {
        return self.vtable.SetMethodOrigin(self, wszMethodName, lOriginIndex);
    }
    pub inline fn SetServerNamespace(self: *const IWbemConstructClassObject, wszServer: ?[*:0]const u16, wszNamespace: ?[*:0]const u16) HRESULT {
