...
pub const IGPM = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetDomain(self: *const IGPM, bstrDomain: ?BSTR, bstrDomainController: ?BSTR, lDCFlags: i32, pIGPMDomain: ?*?*IGPMDomain) HRESULT {
        return self.vtable.GetDomain(self, bstrDomain, bstrDomainController, lDCFlags, pIGPMDomain);
    }
    pub inline fn GetBackupDir(self: *const IGPM, bstrBackupDir: ?BSTR, pIGPMBackupDir: ?*?*IGPMBackupDir) HRESULT {
        return self.vtable.GetBackupDir(self, bstrBackupDir, pIGPMBackupDir);
    }
    pub inline fn GetSitesContainer(self: *const IGPM, bstrForest: ?BSTR, bstrDomain: ?BSTR, bstrDomainController: ?BSTR, lDCFlags: i32, ppIGPMSitesContainer: ?*?*IGPMSitesContainer) HRESULT {
        return self.vtable.GetSitesContainer(self, bstrForest, bstrDomain, bstrDomainController, lDCFlags, ppIGPMSitesContainer);
    }
    pub inline fn GetRSOP(self: *const IGPM, gpmRSoPMode: GPMRSOPMode, bstrNamespace: ?BSTR, lFlags: i32, ppIGPMRSOP: ?*?*IGPMRSOP) HRESULT {
        return self.vtable.GetRSOP(self, gpmRSoPMode, bstrNamespace, lFlags, ppIGPMRSOP);
    }
    pub inline fn CreatePermission(self: *const IGPM, bstrTrustee: ?BSTR, perm: GPMPermissionType, bInheritable: i16, ppPerm: ?*?*IGPMPermission) HRESULT {
        return self.vtable.CreatePermission(self, bstrTrustee, perm, bInheritable, ppPerm);
    }
    pub inline fn CreateSearchCriteria(self: *const IGPM, ppIGPMSearchCriteria: ?*?*IGPMSearchCriteria) HRESULT {
        return self.vtable.CreateSearchCriteria(self, ppIGPMSearchCriteria);
    }
    pub inline fn CreateTrustee(self: *const IGPM, bstrTrustee: ?BSTR, ppIGPMTrustee: ?*?*IGPMTrustee) HRESULT {
        return self.vtable.CreateTrustee(self, bstrTrustee, ppIGPMTrustee);
    }
    pub inline fn GetClientSideExtensions(self: *const IGPM, ppIGPMCSECollection: ?*?*IGPMCSECollection) HRESULT {
        return self.vtable.GetClientSideExtensions(self, ppIGPMCSECollection);
    }
    pub inline fn GetConstants(self: *const IGPM, ppIGPMConstants: ?*?*IGPMConstants) HRESULT {
        return self.vtable.GetConstants(self, ppIGPMConstants);
    }
    pub inline fn GetMigrationTable(self: *const IGPM, bstrMigrationTablePath: ?BSTR, ppMigrationTable: ?*?*IGPMMigrationTable) HRESULT {
        return self.vtable.GetMigrationTable(self, bstrMigrationTablePath, ppMigrationTable);
    }
    pub inline fn CreateMigrationTable(self: *const IGPM, ppMigrationTable: ?*?*IGPMMigrationTable) HRESULT {
        return self.vtable.CreateMigrationTable(self, ppMigrationTable);
    }
    pub inline fn InitializeReporting(self: *const IGPM, bstrAdmPath: ?BSTR) HRESULT {
...
pub const IGPMDomain = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DomainController(self: *const IGPMDomain, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DomainController(self, pVal);
    }
    pub inline fn get_Domain(self: *const IGPMDomain, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Domain(self, pVal);
    }
    pub inline fn CreateGPO(self: *const IGPMDomain, ppNewGPO: ?*?*IGPMGPO) HRESULT {
        return self.vtable.CreateGPO(self, ppNewGPO);
    }
    pub inline fn GetGPO(self: *const IGPMDomain, bstrGuid: ?BSTR, ppGPO: ?*?*IGPMGPO) HRESULT {
        return self.vtable.GetGPO(self, bstrGuid, ppGPO);
    }
    pub inline fn SearchGPOs(self: *const IGPMDomain, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMGPOCollection: ?*?*IGPMGPOCollection) HRESULT {
        return self.vtable.SearchGPOs(self, pIGPMSearchCriteria, ppIGPMGPOCollection);
    }
    pub inline fn RestoreGPO(self: *const IGPMDomain, pIGPMBackup: ?*IGPMBackup, lDCFlags: i32, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.RestoreGPO(self, pIGPMBackup, lDCFlags, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GetSOM(self: *const IGPMDomain, bstrPath: ?BSTR, ppSOM: ?*?*IGPMSOM) HRESULT {
        return self.vtable.GetSOM(self, bstrPath, ppSOM);
    }
    pub inline fn SearchSOMs(self: *const IGPMDomain, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMSOMCollection: ?*?*IGPMSOMCollection) HRESULT {
        return self.vtable.SearchSOMs(self, pIGPMSearchCriteria, ppIGPMSOMCollection);
    }
    pub inline fn GetWMIFilter(self: *const IGPMDomain, bstrPath: ?BSTR, ppWMIFilter: ?*?*IGPMWMIFilter) HRESULT {
        return self.vtable.GetWMIFilter(self, bstrPath, ppWMIFilter);
    }
    pub inline fn SearchWMIFilters(self: *const IGPMDomain, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMWMIFilterCollection: ?*?*IGPMWMIFilterCollection) HRESULT {
...
pub const IGPMBackupDir = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BackupDirectory(self: *const IGPMBackupDir, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_BackupDirectory(self, pVal);
    }
    pub inline fn GetBackup(self: *const IGPMBackupDir, bstrID: ?BSTR, ppBackup: ?*?*IGPMBackup) HRESULT {
        return self.vtable.GetBackup(self, bstrID, ppBackup);
    }
    pub inline fn SearchBackups(self: *const IGPMBackupDir, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMBackupCollection: ?*?*IGPMBackupCollection) HRESULT {
...
pub const IGPMSitesContainer = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DomainController(self: *const IGPMSitesContainer, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DomainController(self, pVal);
    }
    pub inline fn get_Domain(self: *const IGPMSitesContainer, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Domain(self, pVal);
    }
    pub inline fn get_Forest(self: *const IGPMSitesContainer, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Forest(self, pVal);
    }
    pub inline fn GetSite(self: *const IGPMSitesContainer, bstrSiteName: ?BSTR, ppSOM: ?*?*IGPMSOM) HRESULT {
        return self.vtable.GetSite(self, bstrSiteName, ppSOM);
    }
    pub inline fn SearchSites(self: *const IGPMSitesContainer, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMSOMCollection: ?*?*IGPMSOMCollection) HRESULT {
...
pub const IGPMSearchCriteria = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Add(self: *const IGPMSearchCriteria, searchProperty: GPMSearchProperty, searchOperation: GPMSearchOperation, varValue: VARIANT) HRESULT {
...
pub const IGPMTrustee = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_TrusteeSid(self: *const IGPMTrustee, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_TrusteeSid(self, bstrVal);
    }
    pub inline fn get_TrusteeName(self: *const IGPMTrustee, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_TrusteeName(self, bstrVal);
    }
    pub inline fn get_TrusteeDomain(self: *const IGPMTrustee, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_TrusteeDomain(self, bstrVal);
    }
    pub inline fn get_TrusteeDSPath(self: *const IGPMTrustee, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_TrusteeDSPath(self, pVal);
    }
    pub inline fn get_TrusteeType(self: *const IGPMTrustee, lVal: ?*i32) HRESULT {
...
pub const IGPMPermission = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Inherited(self: *const IGPMPermission, pVal: ?*i16) HRESULT {
        return self.vtable.get_Inherited(self, pVal);
    }
    pub inline fn get_Inheritable(self: *const IGPMPermission, pVal: ?*i16) HRESULT {
        return self.vtable.get_Inheritable(self, pVal);
    }
    pub inline fn get_Denied(self: *const IGPMPermission, pVal: ?*i16) HRESULT {
        return self.vtable.get_Denied(self, pVal);
    }
    pub inline fn get_Permission(self: *const IGPMPermission, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_Permission(self, pVal);
    }
    pub inline fn get_Trustee(self: *const IGPMPermission, ppIGPMTrustee: ?*?*IGPMTrustee) HRESULT {
...
pub const IGPMSecurityInfo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMSecurityInfo, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMSecurityInfo, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMSecurityInfo, ppEnum: ?*?*IEnumVARIANT) HRESULT {
        return self.vtable.get__NewEnum(self, ppEnum);
    }
    pub inline fn Add(self: *const IGPMSecurityInfo, pPerm: ?*IGPMPermission) HRESULT {
        return self.vtable.Add(self, pPerm);
    }
    pub inline fn Remove(self: *const IGPMSecurityInfo, pPerm: ?*IGPMPermission) HRESULT {
        return self.vtable.Remove(self, pPerm);
    }
    pub inline fn RemoveTrustee(self: *const IGPMSecurityInfo, bstrTrustee: ?BSTR) HRESULT {
...
pub const IGPMBackup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ID(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ID(self, pVal);
    }
    pub inline fn get_GPOID(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_GPOID(self, pVal);
    }
    pub inline fn get_GPODomain(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_GPODomain(self, pVal);
    }
    pub inline fn get_GPODisplayName(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_GPODisplayName(self, pVal);
    }
    pub inline fn get_Timestamp(self: *const IGPMBackup, pVal: ?*f64) HRESULT {
        return self.vtable.get_Timestamp(self, pVal);
    }
    pub inline fn get_Comment(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Comment(self, pVal);
    }
    pub inline fn get_BackupDir(self: *const IGPMBackup, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_BackupDir(self, pVal);
    }
    pub inline fn Delete(self: *const IGPMBackup) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn GenerateReport(self: *const IGPMBackup, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReportToFile(self: *const IGPMBackup, gpmReportType: GPMReportType, bstrTargetFilePath: ?BSTR, ppIGPMResult: ?*?*IGPMResult) HRESULT {
...
pub const IGPMBackupCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMBackupCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMBackupCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMBackupCollection, ppIGPMBackup: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMSOM = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_GPOInheritanceBlocked(self: *const IGPMSOM, pVal: ?*i16) HRESULT {
        return self.vtable.get_GPOInheritanceBlocked(self, pVal);
    }
    pub inline fn put_GPOInheritanceBlocked(self: *const IGPMSOM, newVal: i16) HRESULT {
        return self.vtable.put_GPOInheritanceBlocked(self, newVal);
    }
    pub inline fn get_Name(self: *const IGPMSOM, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pVal);
    }
    pub inline fn get_Path(self: *const IGPMSOM, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Path(self, pVal);
    }
    pub inline fn CreateGPOLink(self: *const IGPMSOM, lLinkPos: i32, pGPO: ?*IGPMGPO, ppNewGPOLink: ?*?*IGPMGPOLink) HRESULT {
        return self.vtable.CreateGPOLink(self, lLinkPos, pGPO, ppNewGPOLink);
    }
    pub inline fn get_Type(self: *const IGPMSOM, pVal: ?*GPMSOMType) HRESULT {
        return self.vtable.get_Type(self, pVal);
    }
    pub inline fn GetGPOLinks(self: *const IGPMSOM, ppGPOLinks: ?*?*IGPMGPOLinksCollection) HRESULT {
        return self.vtable.GetGPOLinks(self, ppGPOLinks);
    }
    pub inline fn GetInheritedGPOLinks(self: *const IGPMSOM, ppGPOLinks: ?*?*IGPMGPOLinksCollection) HRESULT {
        return self.vtable.GetInheritedGPOLinks(self, ppGPOLinks);
    }
    pub inline fn GetSecurityInfo(self: *const IGPMSOM, ppSecurityInfo: ?*?*IGPMSecurityInfo) HRESULT {
        return self.vtable.GetSecurityInfo(self, ppSecurityInfo);
    }
    pub inline fn SetSecurityInfo(self: *const IGPMSOM, pSecurityInfo: ?*IGPMSecurityInfo) HRESULT {
...
pub const IGPMSOMCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMSOMCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMSOMCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMSOMCollection, ppIGPMSOM: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMWMIFilter = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Path(self: *const IGPMWMIFilter, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Path(self, pVal);
    }
    pub inline fn put_Name(self: *const IGPMWMIFilter, newVal: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, newVal);
    }
    pub inline fn get_Name(self: *const IGPMWMIFilter, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pVal);
    }
    pub inline fn put_Description(self: *const IGPMWMIFilter, newVal: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, newVal);
    }
    pub inline fn get_Description(self: *const IGPMWMIFilter, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pVal);
    }
    pub inline fn GetQueryList(self: *const IGPMWMIFilter, pQryList: ?*VARIANT) HRESULT {
        return self.vtable.GetQueryList(self, pQryList);
    }
    pub inline fn GetSecurityInfo(self: *const IGPMWMIFilter, ppSecurityInfo: ?*?*IGPMSecurityInfo) HRESULT {
        return self.vtable.GetSecurityInfo(self, ppSecurityInfo);
    }
    pub inline fn SetSecurityInfo(self: *const IGPMWMIFilter, pSecurityInfo: ?*IGPMSecurityInfo) HRESULT {
        return self.vtable.SetSecurityInfo(self, pSecurityInfo);
    }
};
...
pub const IGPMWMIFilterCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMWMIFilterCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMWMIFilterCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMWMIFilterCollection, pVal: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMRSOP = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Mode(self: *const IGPMRSOP, pVal: ?*GPMRSOPMode) HRESULT {
        return self.vtable.get_Mode(self, pVal);
    }
    pub inline fn get_Namespace(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Namespace(self, bstrVal);
    }
    pub inline fn put_LoggingComputer(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_LoggingComputer(self, bstrVal);
    }
    pub inline fn get_LoggingComputer(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_LoggingComputer(self, bstrVal);
    }
    pub inline fn put_LoggingUser(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_LoggingUser(self, bstrVal);
    }
    pub inline fn get_LoggingUser(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_LoggingUser(self, bstrVal);
    }
    pub inline fn put_LoggingFlags(self: *const IGPMRSOP, lVal: i32) HRESULT {
        return self.vtable.put_LoggingFlags(self, lVal);
    }
    pub inline fn get_LoggingFlags(self: *const IGPMRSOP, lVal: ?*i32) HRESULT {
        return self.vtable.get_LoggingFlags(self, lVal);
    }
    pub inline fn put_PlanningFlags(self: *const IGPMRSOP, lVal: i32) HRESULT {
        return self.vtable.put_PlanningFlags(self, lVal);
    }
    pub inline fn get_PlanningFlags(self: *const IGPMRSOP, lVal: ?*i32) HRESULT {
        return self.vtable.get_PlanningFlags(self, lVal);
    }
    pub inline fn put_PlanningDomainController(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningDomainController(self, bstrVal);
    }
    pub inline fn get_PlanningDomainController(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningDomainController(self, bstrVal);
    }
    pub inline fn put_PlanningSiteName(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningSiteName(self, bstrVal);
    }
    pub inline fn get_PlanningSiteName(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningSiteName(self, bstrVal);
    }
    pub inline fn put_PlanningUser(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningUser(self, bstrVal);
    }
    pub inline fn get_PlanningUser(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningUser(self, bstrVal);
    }
    pub inline fn put_PlanningUserSOM(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningUserSOM(self, bstrVal);
    }
    pub inline fn get_PlanningUserSOM(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningUserSOM(self, bstrVal);
    }
    pub inline fn put_PlanningUserWMIFilters(self: *const IGPMRSOP, varVal: VARIANT) HRESULT {
        return self.vtable.put_PlanningUserWMIFilters(self, varVal);
    }
    pub inline fn get_PlanningUserWMIFilters(self: *const IGPMRSOP, varVal: ?*VARIANT) HRESULT {
        return self.vtable.get_PlanningUserWMIFilters(self, varVal);
    }
    pub inline fn put_PlanningUserSecurityGroups(self: *const IGPMRSOP, varVal: VARIANT) HRESULT {
        return self.vtable.put_PlanningUserSecurityGroups(self, varVal);
    }
    pub inline fn get_PlanningUserSecurityGroups(self: *const IGPMRSOP, varVal: ?*VARIANT) HRESULT {
        return self.vtable.get_PlanningUserSecurityGroups(self, varVal);
    }
    pub inline fn put_PlanningComputer(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningComputer(self, bstrVal);
    }
    pub inline fn get_PlanningComputer(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningComputer(self, bstrVal);
    }
    pub inline fn put_PlanningComputerSOM(self: *const IGPMRSOP, bstrVal: ?BSTR) HRESULT {
        return self.vtable.put_PlanningComputerSOM(self, bstrVal);
    }
    pub inline fn get_PlanningComputerSOM(self: *const IGPMRSOP, bstrVal: ?*?BSTR) HRESULT {
        return self.vtable.get_PlanningComputerSOM(self, bstrVal);
    }
    pub inline fn put_PlanningComputerWMIFilters(self: *const IGPMRSOP, varVal: VARIANT) HRESULT {
        return self.vtable.put_PlanningComputerWMIFilters(self, varVal);
    }
    pub inline fn get_PlanningComputerWMIFilters(self: *const IGPMRSOP, varVal: ?*VARIANT) HRESULT {
        return self.vtable.get_PlanningComputerWMIFilters(self, varVal);
    }
    pub inline fn put_PlanningComputerSecurityGroups(self: *const IGPMRSOP, varVal: VARIANT) HRESULT {
        return self.vtable.put_PlanningComputerSecurityGroups(self, varVal);
    }
    pub inline fn get_PlanningComputerSecurityGroups(self: *const IGPMRSOP, varVal: ?*VARIANT) HRESULT {
        return self.vtable.get_PlanningComputerSecurityGroups(self, varVal);
    }
    pub inline fn LoggingEnumerateUsers(self: *const IGPMRSOP, varVal: ?*VARIANT) HRESULT {
        return self.vtable.LoggingEnumerateUsers(self, varVal);
    }
    pub inline fn CreateQueryResults(self: *const IGPMRSOP) HRESULT {
        return self.vtable.CreateQueryResults(self);
    }
    pub inline fn ReleaseQueryResults(self: *const IGPMRSOP) HRESULT {
        return self.vtable.ReleaseQueryResults(self);
    }
    pub inline fn GenerateReport(self: *const IGPMRSOP, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReportToFile(self: *const IGPMRSOP, gpmReportType: GPMReportType, bstrTargetFilePath: ?BSTR, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReportToFile(self, gpmReportType, bstrTargetFilePath, ppIGPMResult);
    }
};
...
pub const IGPMGPO = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DisplayName(self: *const IGPMGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, pVal);
    }
    pub inline fn put_DisplayName(self: *const IGPMGPO, newVal: ?BSTR) HRESULT {
        return self.vtable.put_DisplayName(self, newVal);
    }
    pub inline fn get_Path(self: *const IGPMGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Path(self, pVal);
    }
    pub inline fn get_ID(self: *const IGPMGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ID(self, pVal);
    }
    pub inline fn get_DomainName(self: *const IGPMGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DomainName(self, pVal);
    }
    pub inline fn get_CreationTime(self: *const IGPMGPO, pDate: ?*f64) HRESULT {
        return self.vtable.get_CreationTime(self, pDate);
    }
    pub inline fn get_ModificationTime(self: *const IGPMGPO, pDate: ?*f64) HRESULT {
        return self.vtable.get_ModificationTime(self, pDate);
    }
    pub inline fn get_UserDSVersionNumber(self: *const IGPMGPO, pVal: ?*i32) HRESULT {
        return self.vtable.get_UserDSVersionNumber(self, pVal);
    }
    pub inline fn get_ComputerDSVersionNumber(self: *const IGPMGPO, pVal: ?*i32) HRESULT {
        return self.vtable.get_ComputerDSVersionNumber(self, pVal);
    }
    pub inline fn get_UserSysvolVersionNumber(self: *const IGPMGPO, pVal: ?*i32) HRESULT {
        return self.vtable.get_UserSysvolVersionNumber(self, pVal);
    }
    pub inline fn get_ComputerSysvolVersionNumber(self: *const IGPMGPO, pVal: ?*i32) HRESULT {
        return self.vtable.get_ComputerSysvolVersionNumber(self, pVal);
    }
    pub inline fn GetWMIFilter(self: *const IGPMGPO, ppIGPMWMIFilter: ?*?*IGPMWMIFilter) HRESULT {
        return self.vtable.GetWMIFilter(self, ppIGPMWMIFilter);
    }
    pub inline fn SetWMIFilter(self: *const IGPMGPO, pIGPMWMIFilter: ?*IGPMWMIFilter) HRESULT {
        return self.vtable.SetWMIFilter(self, pIGPMWMIFilter);
    }
    pub inline fn SetUserEnabled(self: *const IGPMGPO, vbEnabled: i16) HRESULT {
        return self.vtable.SetUserEnabled(self, vbEnabled);
    }
    pub inline fn SetComputerEnabled(self: *const IGPMGPO, vbEnabled: i16) HRESULT {
        return self.vtable.SetComputerEnabled(self, vbEnabled);
    }
    pub inline fn IsUserEnabled(self: *const IGPMGPO, pvbEnabled: ?*i16) HRESULT {
        return self.vtable.IsUserEnabled(self, pvbEnabled);
    }
    pub inline fn IsComputerEnabled(self: *const IGPMGPO, pvbEnabled: ?*i16) HRESULT {
        return self.vtable.IsComputerEnabled(self, pvbEnabled);
    }
    pub inline fn GetSecurityInfo(self: *const IGPMGPO, ppSecurityInfo: ?*?*IGPMSecurityInfo) HRESULT {
        return self.vtable.GetSecurityInfo(self, ppSecurityInfo);
    }
    pub inline fn SetSecurityInfo(self: *const IGPMGPO, pSecurityInfo: ?*IGPMSecurityInfo) HRESULT {
        return self.vtable.SetSecurityInfo(self, pSecurityInfo);
    }
    pub inline fn Delete(self: *const IGPMGPO) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Backup(self: *const IGPMGPO, bstrBackupDir: ?BSTR, bstrComment: ?BSTR, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.Backup(self, bstrBackupDir, bstrComment, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn Import(self: *const IGPMGPO, lFlags: i32, pIGPMBackup: ?*IGPMBackup, pvarMigrationTable: ?*VARIANT, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.Import(self, lFlags, pIGPMBackup, pvarMigrationTable, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReport(self: *const IGPMGPO, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReportToFile(self: *const IGPMGPO, gpmReportType: GPMReportType, bstrTargetFilePath: ?BSTR, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReportToFile(self, gpmReportType, bstrTargetFilePath, ppIGPMResult);
    }
    pub inline fn CopyTo(self: *const IGPMGPO, lFlags: i32, pIGPMDomain: ?*IGPMDomain, pvarNewDisplayName: ?*VARIANT, pvarMigrationTable: ?*VARIANT, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
    ...
    pub inline fn SetSecurityDescriptor(self: *const IGPMGPO, lFlags: i32, pSD: ?*IDispatch) HRESULT {
        return self.vtable.SetSecurityDescriptor(self, lFlags, pSD);
    }
    pub inline fn GetSecurityDescriptor(self: *const IGPMGPO, lFlags: i32, ppSD: ?*?*IDispatch) HRESULT {
        return self.vtable.GetSecurityDescriptor(self, lFlags, ppSD);
    }
    pub inline fn IsACLConsistent(self: *const IGPMGPO, pvbConsistent: ?*i16) HRESULT {
        return self.vtable.IsACLConsistent(self, pvbConsistent);
    }
    pub inline fn MakeACLConsistent(self: *const IGPMGPO) HRESULT {
...
pub const IGPMGPOCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMGPOCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMGPOCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMGPOCollection, ppIGPMGPOs: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMGPOLink = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_GPOID(self: *const IGPMGPOLink, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_GPOID(self, pVal);
    }
    pub inline fn get_GPODomain(self: *const IGPMGPOLink, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_GPODomain(self, pVal);
    }
    pub inline fn get_Enabled(self: *const IGPMGPOLink, pVal: ?*i16) HRESULT {
        return self.vtable.get_Enabled(self, pVal);
    }
    pub inline fn put_Enabled(self: *const IGPMGPOLink, newVal: i16) HRESULT {
        return self.vtable.put_Enabled(self, newVal);
    }
    pub inline fn get_Enforced(self: *const IGPMGPOLink, pVal: ?*i16) HRESULT {
        return self.vtable.get_Enforced(self, pVal);
    }
    pub inline fn put_Enforced(self: *const IGPMGPOLink, newVal: i16) HRESULT {
        return self.vtable.put_Enforced(self, newVal);
    }
    pub inline fn get_SOMLinkOrder(self: *const IGPMGPOLink, lVal: ?*i32) HRESULT {
        return self.vtable.get_SOMLinkOrder(self, lVal);
    }
    pub inline fn get_SOM(self: *const IGPMGPOLink, ppIGPMSOM: ?*?*IGPMSOM) HRESULT {
        return self.vtable.get_SOM(self, ppIGPMSOM);
    }
    pub inline fn Delete(self: *const IGPMGPOLink) HRESULT {
        return self.vtable.Delete(self);
    }
};
...
pub const IGPMGPOLinksCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMGPOLinksCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMGPOLinksCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMGPOLinksCollection, ppIGPMLinks: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMCSECollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMCSECollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMCSECollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMCSECollection, ppIGPMCSEs: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMClientSideExtension = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ID(self: *const IGPMClientSideExtension, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ID(self, pVal);
    }
    pub inline fn get_DisplayName(self: *const IGPMClientSideExtension, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, pVal);
    }
    pub inline fn IsUserEnabled(self: *const IGPMClientSideExtension, pvbEnabled: ?*i16) HRESULT {
        return self.vtable.IsUserEnabled(self, pvbEnabled);
    }
    pub inline fn IsComputerEnabled(self: *const IGPMClientSideExtension, pvbEnabled: ?*i16) HRESULT {
        return self.vtable.IsComputerEnabled(self, pvbEnabled);
    }
};
...
pub const IGPMAsyncCancel = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Cancel(self: *const IGPMAsyncCancel) HRESULT {
...
pub const IGPMAsyncProgress = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Status(self: *const IGPMAsyncProgress, lProgressNumerator: i32, lProgressDenominator: i32, hrStatus: HRESULT, pResult: ?*VARIANT, ppIGPMStatusMsgCollection: ?*IGPMStatusMsgCollection) HRESULT {
...
pub const IGPMStatusMsgCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMStatusMsgCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMStatusMsgCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMStatusMsgCollection, pVal: ?*?*IEnumVARIANT) HRESULT {
        return self.vtable.get__NewEnum(self, pVal);
    }
};
...
pub const IGPMStatusMessage = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ObjectPath(self: *const IGPMStatusMessage, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ObjectPath(self, pVal);
    }
    pub inline fn ErrorCode(self: *const IGPMStatusMessage) HRESULT {
        return self.vtable.ErrorCode(self);
    }
    pub inline fn get_ExtensionName(self: *const IGPMStatusMessage, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtensionName(self, pVal);
    }
    pub inline fn get_SettingsName(self: *const IGPMStatusMessage, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_SettingsName(self, pVal);
    }
    pub inline fn OperationCode(self: *const IGPMStatusMessage) HRESULT {
        return self.vtable.OperationCode(self);
    }
    pub inline fn get_Message(self: *const IGPMStatusMessage, pVal: ?*?BSTR) HRESULT {
...
pub const IGPMConstants = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_PermGPOApply(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermGPOApply(self, pVal);
    }
    pub inline fn get_PermGPORead(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermGPORead(self, pVal);
    }
    pub inline fn get_PermGPOEdit(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermGPOEdit(self, pVal);
    }
    pub inline fn get_PermGPOEditSecurityAndDelete(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermGPOEditSecurityAndDelete(self, pVal);
    }
    pub inline fn get_PermGPOCustom(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermGPOCustom(self, pVal);
    }
    pub inline fn get_PermWMIFilterEdit(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermWMIFilterEdit(self, pVal);
    }
    pub inline fn get_PermWMIFilterFullControl(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermWMIFilterFullControl(self, pVal);
    }
    pub inline fn get_PermWMIFilterCustom(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermWMIFilterCustom(self, pVal);
    }
    pub inline fn get_PermSOMLink(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMLink(self, pVal);
    }
    pub inline fn get_PermSOMLogging(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMLogging(self, pVal);
    }
    pub inline fn get_PermSOMPlanning(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMPlanning(self, pVal);
    }
    pub inline fn get_PermSOMGPOCreate(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMGPOCreate(self, pVal);
    }
    pub inline fn get_PermSOMWMICreate(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMWMICreate(self, pVal);
    }
    pub inline fn get_PermSOMWMIFullControl(self: *const IGPMConstants, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermSOMWMIFullControl(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOPermissions(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOPermissions(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOEffectivePermissions(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOEffectivePermissions(self, pVal);
    }
    pub inline fn get_SearchPropertyGPODisplayName(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPODisplayName(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOWMIFilter(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOWMIFilter(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOID(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOID(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOComputerExtensions(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOComputerExtensions(self, pVal);
    }
    pub inline fn get_SearchPropertyGPOUserExtensions(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPOUserExtensions(self, pVal);
    }
    pub inline fn get_SearchPropertySOMLinks(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertySOMLinks(self, pVal);
    }
    pub inline fn get_SearchPropertyGPODomain(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyGPODomain(self, pVal);
    }
    pub inline fn get_SearchPropertyBackupMostRecent(self: *const IGPMConstants, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyBackupMostRecent(self, pVal);
    }
    pub inline fn get_SearchOpEquals(self: *const IGPMConstants, pVal: ?*GPMSearchOperation) HRESULT {
        return self.vtable.get_SearchOpEquals(self, pVal);
    }
    pub inline fn get_SearchOpContains(self: *const IGPMConstants, pVal: ?*GPMSearchOperation) HRESULT {
        return self.vtable.get_SearchOpContains(self, pVal);
    }
    pub inline fn get_SearchOpNotContains(self: *const IGPMConstants, pVal: ?*GPMSearchOperation) HRESULT {
        return self.vtable.get_SearchOpNotContains(self, pVal);
    }
    pub inline fn get_SearchOpNotEquals(self: *const IGPMConstants, pVal: ?*GPMSearchOperation) HRESULT {
        return self.vtable.get_SearchOpNotEquals(self, pVal);
    }
    pub inline fn get_UsePDC(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_UsePDC(self, pVal);
    }
    pub inline fn get_UseAnyDC(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_UseAnyDC(self, pVal);
    }
    pub inline fn get_DoNotUseW2KDC(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_DoNotUseW2KDC(self, pVal);
    }
    pub inline fn get_SOMSite(self: *const IGPMConstants, pVal: ?*GPMSOMType) HRESULT {
        return self.vtable.get_SOMSite(self, pVal);
    }
    pub inline fn get_SOMDomain(self: *const IGPMConstants, pVal: ?*GPMSOMType) HRESULT {
        return self.vtable.get_SOMDomain(self, pVal);
    }
    pub inline fn get_SOMOU(self: *const IGPMConstants, pVal: ?*GPMSOMType) HRESULT {
        return self.vtable.get_SOMOU(self, pVal);
    }
    pub inline fn get_SecurityFlags(self: *const IGPMConstants, vbOwner: i16, vbGroup: i16, vbDACL: i16, vbSACL: i16, pVal: ?*i32) HRESULT {
        return self.vtable.get_SecurityFlags(self, vbOwner, vbGroup, vbDACL, vbSACL, pVal);
    }
    pub inline fn get_DoNotValidateDC(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_DoNotValidateDC(self, pVal);
    }
    pub inline fn get_ReportHTML(self: *const IGPMConstants, pVal: ?*GPMReportType) HRESULT {
        return self.vtable.get_ReportHTML(self, pVal);
    }
    pub inline fn get_ReportXML(self: *const IGPMConstants, pVal: ?*GPMReportType) HRESULT {
        return self.vtable.get_ReportXML(self, pVal);
    }
    pub inline fn get_RSOPModeUnknown(self: *const IGPMConstants, pVal: ?*GPMRSOPMode) HRESULT {
        return self.vtable.get_RSOPModeUnknown(self, pVal);
    }
    pub inline fn get_RSOPModePlanning(self: *const IGPMConstants, pVal: ?*GPMRSOPMode) HRESULT {
        return self.vtable.get_RSOPModePlanning(self, pVal);
    }
    pub inline fn get_RSOPModeLogging(self: *const IGPMConstants, pVal: ?*GPMRSOPMode) HRESULT {
        return self.vtable.get_RSOPModeLogging(self, pVal);
    }
    pub inline fn get_EntryTypeUser(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeUser(self, pVal);
    }
    pub inline fn get_EntryTypeComputer(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeComputer(self, pVal);
    }
    pub inline fn get_EntryTypeLocalGroup(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeLocalGroup(self, pVal);
    }
    pub inline fn get_EntryTypeGlobalGroup(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeGlobalGroup(self, pVal);
    }
    pub inline fn get_EntryTypeUniversalGroup(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeUniversalGroup(self, pVal);
    }
    pub inline fn get_EntryTypeUNCPath(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeUNCPath(self, pVal);
    }
    pub inline fn get_EntryTypeUnknown(self: *const IGPMConstants, pVal: ?*GPMEntryType) HRESULT {
        return self.vtable.get_EntryTypeUnknown(self, pVal);
    }
    pub inline fn get_DestinationOptionSameAsSource(self: *const IGPMConstants, pVal: ?*GPMDestinationOption) HRESULT {
        return self.vtable.get_DestinationOptionSameAsSource(self, pVal);
    }
    pub inline fn get_DestinationOptionNone(self: *const IGPMConstants, pVal: ?*GPMDestinationOption) HRESULT {
        return self.vtable.get_DestinationOptionNone(self, pVal);
    }
    pub inline fn get_DestinationOptionByRelativeName(self: *const IGPMConstants, pVal: ?*GPMDestinationOption) HRESULT {
        return self.vtable.get_DestinationOptionByRelativeName(self, pVal);
    }
    pub inline fn get_DestinationOptionSet(self: *const IGPMConstants, pVal: ?*GPMDestinationOption) HRESULT {
        return self.vtable.get_DestinationOptionSet(self, pVal);
    }
    pub inline fn get_MigrationTableOnly(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_MigrationTableOnly(self, pVal);
    }
    pub inline fn get_ProcessSecurity(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_ProcessSecurity(self, pVal);
    }
    pub inline fn get_RsopLoggingNoComputer(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_RsopLoggingNoComputer(self, pVal);
    }
    pub inline fn get_RsopLoggingNoUser(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_RsopLoggingNoUser(self, pVal);
    }
    pub inline fn get_RsopPlanningAssumeSlowLink(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_RsopPlanningAssumeSlowLink(self, pVal);
    }
    pub inline fn get_RsopPlanningLoopbackOption(self: *const IGPMConstants, vbMerge: i16, pVal: ?*i32) HRESULT {
        return self.vtable.get_RsopPlanningLoopbackOption(self, vbMerge, pVal);
    }
    pub inline fn get_RsopPlanningAssumeUserWQLFilterTrue(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
        return self.vtable.get_RsopPlanningAssumeUserWQLFilterTrue(self, pVal);
    }
    pub inline fn get_RsopPlanningAssumeCompWQLFilterTrue(self: *const IGPMConstants, pVal: ?*i32) HRESULT {
...
pub const IGPMResult = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const IGPMResult, ppIGPMStatusMsgCollection: ?*?*IGPMStatusMsgCollection) HRESULT {
        return self.vtable.get_Status(self, ppIGPMStatusMsgCollection);
    }
    pub inline fn get_Result(self: *const IGPMResult, pvarResult: ?*VARIANT) HRESULT {
        return self.vtable.get_Result(self, pvarResult);
    }
    pub inline fn OverallStatus(self: *const IGPMResult) HRESULT {
...
pub const IGPMMapEntryCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMMapEntryCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMMapEntryCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMMapEntryCollection, pVal: ?*?*IEnumVARIANT) HRESULT {
        return self.vtable.get__NewEnum(self, pVal);
    }
};
...
pub const IGPMMapEntry = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Source(self: *const IGPMMapEntry, pbstrSource: ?*?BSTR) HRESULT {
        return self.vtable.get_Source(self, pbstrSource);
    }
    pub inline fn get_Destination(self: *const IGPMMapEntry, pbstrDestination: ?*?BSTR) HRESULT {
        return self.vtable.get_Destination(self, pbstrDestination);
    }
    pub inline fn get_DestinationOption(self: *const IGPMMapEntry, pgpmDestOption: ?*GPMDestinationOption) HRESULT {
        return self.vtable.get_DestinationOption(self, pgpmDestOption);
    }
    pub inline fn get_EntryType(self: *const IGPMMapEntry, pgpmEntryType: ?*GPMEntryType) HRESULT {
...
pub const IGPMMigrationTable = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Save(self: *const IGPMMigrationTable, bstrMigrationTablePath: ?BSTR) HRESULT {
        return self.vtable.Save(self, bstrMigrationTablePath);
    }
    pub inline fn Add(self: *const IGPMMigrationTable, lFlags: i32, @"var": VARIANT) HRESULT {
        return self.vtable.Add(self, lFlags, @"var");
    }
    pub inline fn AddEntry(self: *const IGPMMigrationTable, bstrSource: ?BSTR, gpmEntryType: GPMEntryType, pvarDestination: ?*VARIANT, ppEntry: ?*?*IGPMMapEntry) HRESULT {
        return self.vtable.AddEntry(self, bstrSource, gpmEntryType, pvarDestination, ppEntry);
    }
    pub inline fn GetEntry(self: *const IGPMMigrationTable, bstrSource: ?BSTR, ppEntry: ?*?*IGPMMapEntry) HRESULT {
        return self.vtable.GetEntry(self, bstrSource, ppEntry);
    }
    pub inline fn DeleteEntry(self: *const IGPMMigrationTable, bstrSource: ?BSTR) HRESULT {
        return self.vtable.DeleteEntry(self, bstrSource);
    }
    pub inline fn UpdateDestination(self: *const IGPMMigrationTable, bstrSource: ?BSTR, pvarDestination: ?*VARIANT, ppEntry: ?*?*IGPMMapEntry) HRESULT {
        return self.vtable.UpdateDestination(self, bstrSource, pvarDestination, ppEntry);
    }
    pub inline fn Validate(self: *const IGPMMigrationTable, ppResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.Validate(self, ppResult);
    }
    pub inline fn GetEntries(self: *const IGPMMigrationTable, ppEntries: ?*?*IGPMMapEntryCollection) HRESULT {
...
pub const IGPMBackupDirEx = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BackupDir(self: *const IGPMBackupDirEx, pbstrBackupDir: ?*?BSTR) HRESULT {
        return self.vtable.get_BackupDir(self, pbstrBackupDir);
    }
    pub inline fn get_BackupType(self: *const IGPMBackupDirEx, pgpmBackupType: ?*GPMBackupType) HRESULT {
        return self.vtable.get_BackupType(self, pgpmBackupType);
    }
    pub inline fn GetBackup(self: *const IGPMBackupDirEx, bstrID: ?BSTR, pvarBackup: ?*VARIANT) HRESULT {
        return self.vtable.GetBackup(self, bstrID, pvarBackup);
    }
    pub inline fn SearchBackups(self: *const IGPMBackupDirEx, pIGPMSearchCriteria: ?*IGPMSearchCriteria, pvarBackupCollection: ?*VARIANT) HRESULT {
...
pub const IGPMStarterGPOBackupCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMStarterGPOBackupCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMStarterGPOBackupCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMStarterGPOBackupCollection, ppIGPMTmplBackup: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMStarterGPOBackup = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BackupDir(self: *const IGPMStarterGPOBackup, pbstrBackupDir: ?*?BSTR) HRESULT {
        return self.vtable.get_BackupDir(self, pbstrBackupDir);
    }
    pub inline fn get_Comment(self: *const IGPMStarterGPOBackup, pbstrComment: ?*?BSTR) HRESULT {
        return self.vtable.get_Comment(self, pbstrComment);
    }
    pub inline fn get_DisplayName(self: *const IGPMStarterGPOBackup, pbstrDisplayName: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, pbstrDisplayName);
    }
    pub inline fn get_Domain(self: *const IGPMStarterGPOBackup, pbstrTemplateDomain: ?*?BSTR) HRESULT {
        return self.vtable.get_Domain(self, pbstrTemplateDomain);
    }
    pub inline fn get_StarterGPOID(self: *const IGPMStarterGPOBackup, pbstrTemplateID: ?*?BSTR) HRESULT {
        return self.vtable.get_StarterGPOID(self, pbstrTemplateID);
    }
    pub inline fn get_ID(self: *const IGPMStarterGPOBackup, pbstrID: ?*?BSTR) HRESULT {
        return self.vtable.get_ID(self, pbstrID);
    }
    pub inline fn get_Timestamp(self: *const IGPMStarterGPOBackup, pTimestamp: ?*f64) HRESULT {
        return self.vtable.get_Timestamp(self, pTimestamp);
    }
    pub inline fn get_Type(self: *const IGPMStarterGPOBackup, pType: ?*GPMStarterGPOType) HRESULT {
        return self.vtable.get_Type(self, pType);
    }
    pub inline fn Delete(self: *const IGPMStarterGPOBackup) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn GenerateReport(self: *const IGPMStarterGPOBackup, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReportToFile(self: *const IGPMStarterGPOBackup, gpmReportType: GPMReportType, bstrTargetFilePath: ?BSTR, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReportToFile(self, gpmReportType, bstrTargetFilePath, ppIGPMResult);
    }
};
...
pub const IGPM2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GetBackupDirEx(self: *const IGPM2, bstrBackupDir: ?BSTR, backupDirType: GPMBackupType, ppIGPMBackupDirEx: ?*?*IGPMBackupDirEx) HRESULT {
        return self.vtable.GetBackupDirEx(self, bstrBackupDir, backupDirType, ppIGPMBackupDirEx);
    }
    pub inline fn InitializeReportingEx(self: *const IGPM2, bstrAdmPath: ?BSTR, reportingOptions: i32) HRESULT {
...
pub const IGPMStarterGPO = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_DisplayName(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, pVal);
    }
    pub inline fn put_DisplayName(self: *const IGPMStarterGPO, newVal: ?BSTR) HRESULT {
        return self.vtable.put_DisplayName(self, newVal);
    }
    pub inline fn get_Description(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pVal);
    }
    pub inline fn put_Description(self: *const IGPMStarterGPO, newVal: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, newVal);
    }
    pub inline fn get_Author(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Author(self, pVal);
    }
    pub inline fn get_Product(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Product(self, pVal);
    }
    pub inline fn get_CreationTime(self: *const IGPMStarterGPO, pVal: ?*f64) HRESULT {
        return self.vtable.get_CreationTime(self, pVal);
    }
    pub inline fn get_ID(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_ID(self, pVal);
    }
    pub inline fn get_ModifiedTime(self: *const IGPMStarterGPO, pVal: ?*f64) HRESULT {
        return self.vtable.get_ModifiedTime(self, pVal);
    }
    pub inline fn get_Type(self: *const IGPMStarterGPO, pVal: ?*GPMStarterGPOType) HRESULT {
        return self.vtable.get_Type(self, pVal);
    }
    pub inline fn get_ComputerVersion(self: *const IGPMStarterGPO, pVal: ?*u16) HRESULT {
        return self.vtable.get_ComputerVersion(self, pVal);
    }
    pub inline fn get_UserVersion(self: *const IGPMStarterGPO, pVal: ?*u16) HRESULT {
        return self.vtable.get_UserVersion(self, pVal);
    }
    pub inline fn get_StarterGPOVersion(self: *const IGPMStarterGPO, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_StarterGPOVersion(self, pVal);
    }
    pub inline fn Delete(self: *const IGPMStarterGPO) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Save(self: *const IGPMStarterGPO, bstrSaveFile: ?BSTR, bOverwrite: i16, bSaveAsSystem: i16, bstrLanguage: ?*VARIANT, bstrAuthor: ?*VARIANT, bstrProduct: ?*VARIANT, bstrUniqueID: ?*VARIANT, bstrVersion: ?*VARIANT, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
    ...
    pub inline fn Backup(self: *const IGPMStarterGPO, bstrBackupDir: ?BSTR, bstrComment: ?BSTR, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.Backup(self, bstrBackupDir, bstrComment, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn CopyTo(self: *const IGPMStarterGPO, pvarNewDisplayName: ?*VARIANT, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.CopyTo(self, pvarNewDisplayName, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReport(self: *const IGPMStarterGPO, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn GenerateReportToFile(self: *const IGPMStarterGPO, gpmReportType: GPMReportType, bstrTargetFilePath: ?BSTR, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReportToFile(self, gpmReportType, bstrTargetFilePath, ppIGPMResult);
    }
    pub inline fn GetSecurityInfo(self: *const IGPMStarterGPO, ppSecurityInfo: ?*?*IGPMSecurityInfo) HRESULT {
        return self.vtable.GetSecurityInfo(self, ppSecurityInfo);
    }
    pub inline fn SetSecurityInfo(self: *const IGPMStarterGPO, pSecurityInfo: ?*IGPMSecurityInfo) HRESULT {
        return self.vtable.SetSecurityInfo(self, pSecurityInfo);
    }
};
...
pub const IGPMStarterGPOCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IGPMStarterGPOCollection, pVal: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pVal);
    }
    pub inline fn get_Item(self: *const IGPMStarterGPOCollection, lIndex: i32, pVal: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, lIndex, pVal);
    }
    pub inline fn get__NewEnum(self: *const IGPMStarterGPOCollection, ppIGPMTemplates: ?*?*IEnumVARIANT) HRESULT {
...
pub const IGPMDomain2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn CreateStarterGPO(self: *const IGPMDomain2, ppnewTemplate: ?*?*IGPMStarterGPO) HRESULT {
        return self.vtable.CreateStarterGPO(self, ppnewTemplate);
    }
    pub inline fn CreateGPOFromStarterGPO(self: *const IGPMDomain2, pGPOTemplate: ?*IGPMStarterGPO, ppnewGPO: ?*?*IGPMGPO) HRESULT {
        return self.vtable.CreateGPOFromStarterGPO(self, pGPOTemplate, ppnewGPO);
    }
    pub inline fn GetStarterGPO(self: *const IGPMDomain2, bstrGuid: ?BSTR, ppTemplate: ?*?*IGPMStarterGPO) HRESULT {
        return self.vtable.GetStarterGPO(self, bstrGuid, ppTemplate);
    }
    pub inline fn SearchStarterGPOs(self: *const IGPMDomain2, pIGPMSearchCriteria: ?*IGPMSearchCriteria, ppIGPMTemplateCollection: ?*?*IGPMStarterGPOCollection) HRESULT {
        return self.vtable.SearchStarterGPOs(self, pIGPMSearchCriteria, ppIGPMTemplateCollection);
    }
    pub inline fn LoadStarterGPO(self: *const IGPMDomain2, bstrLoadFile: ?BSTR, bOverwrite: i16, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.LoadStarterGPO(self, bstrLoadFile, bOverwrite, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn RestoreStarterGPO(self: *const IGPMDomain2, pIGPMTmplBackup: ?*IGPMStarterGPOBackup, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
...
pub const IGPMConstants2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_BackupTypeGPO(self: *const IGPMConstants2, pVal: ?*GPMBackupType) HRESULT {
        return self.vtable.get_BackupTypeGPO(self, pVal);
    }
    pub inline fn get_BackupTypeStarterGPO(self: *const IGPMConstants2, pVal: ?*GPMBackupType) HRESULT {
        return self.vtable.get_BackupTypeStarterGPO(self, pVal);
    }
    pub inline fn get_StarterGPOTypeSystem(self: *const IGPMConstants2, pVal: ?*GPMStarterGPOType) HRESULT {
        return self.vtable.get_StarterGPOTypeSystem(self, pVal);
    }
    pub inline fn get_StarterGPOTypeCustom(self: *const IGPMConstants2, pVal: ?*GPMStarterGPOType) HRESULT {
        return self.vtable.get_StarterGPOTypeCustom(self, pVal);
    }
    pub inline fn get_SearchPropertyStarterGPOPermissions(self: *const IGPMConstants2, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyStarterGPOPermissions(self, pVal);
    }
    pub inline fn get_SearchPropertyStarterGPOEffectivePermissions(self: *const IGPMConstants2, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyStarterGPOEffectivePermissions(self, pVal);
    }
    pub inline fn get_SearchPropertyStarterGPODisplayName(self: *const IGPMConstants2, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyStarterGPODisplayName(self, pVal);
    }
    pub inline fn get_SearchPropertyStarterGPOID(self: *const IGPMConstants2, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyStarterGPOID(self, pVal);
    }
    pub inline fn get_SearchPropertyStarterGPODomain(self: *const IGPMConstants2, pVal: ?*GPMSearchProperty) HRESULT {
        return self.vtable.get_SearchPropertyStarterGPODomain(self, pVal);
    }
    pub inline fn get_PermStarterGPORead(self: *const IGPMConstants2, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermStarterGPORead(self, pVal);
    }
    pub inline fn get_PermStarterGPOEdit(self: *const IGPMConstants2, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermStarterGPOEdit(self, pVal);
    }
    pub inline fn get_PermStarterGPOFullControl(self: *const IGPMConstants2, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermStarterGPOFullControl(self, pVal);
    }
    pub inline fn get_PermStarterGPOCustom(self: *const IGPMConstants2, pVal: ?*GPMPermissionType) HRESULT {
        return self.vtable.get_PermStarterGPOCustom(self, pVal);
    }
    pub inline fn get_ReportLegacy(self: *const IGPMConstants2, pVal: ?*GPMReportingOptions) HRESULT {
        return self.vtable.get_ReportLegacy(self, pVal);
    }
    pub inline fn get_ReportComments(self: *const IGPMConstants2, pVal: ?*GPMReportingOptions) HRESULT {
...
pub const IGPMGPO2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Description(self: *const IGPMGPO2, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pVal);
    }
    pub inline fn put_Description(self: *const IGPMGPO2, newVal: ?BSTR) HRESULT {
        return self.vtable.put_Description(self, newVal);
    }
};
...
pub const IGPMDomain3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn GenerateReport(self: *const IGPMDomain3, gpmReportType: GPMReportType, pvarGPMProgress: ?*VARIANT, pvarGPMCancel: ?*VARIANT, ppIGPMResult: ?*?*IGPMResult) HRESULT {
        return self.vtable.GenerateReport(self, gpmReportType, pvarGPMProgress, pvarGPMCancel, ppIGPMResult);
    }
    pub inline fn get_InfrastructureDC(self: *const IGPMDomain3, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_InfrastructureDC(self, pVal);
    }
    pub inline fn put_InfrastructureDC(self: *const IGPMDomain3, newVal: ?BSTR) HRESULT {
        return self.vtable.put_InfrastructureDC(self, newVal);
    }
    pub inline fn put_InfrastructureFlags(self: *const IGPMDomain3, dwFlags: u32) HRESULT {
...
pub const IGPMGPO3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_InfrastructureDC(self: *const IGPMGPO3, pVal: ?*?BSTR) HRESULT {
        return self.vtable.get_InfrastructureDC(self, pVal);
    }
    pub inline fn put_InfrastructureDC(self: *const IGPMGPO3, newVal: ?BSTR) HRESULT {
        return self.vtable.put_InfrastructureDC(self, newVal);
    }
    pub inline fn put_InfrastructureFlags(self: *const IGPMGPO3, dwFlags: u32) HRESULT {
        return self.vtable.put_InfrastructureFlags(self, dwFlags);
    }
};
...
pub const IGPEInformation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetName(self: *const IGPEInformation, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetName(self, pszName, cchMaxLength);
    }
    pub inline fn GetDisplayName(self: *const IGPEInformation, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetDisplayName(self, pszName, cchMaxLength);
    }
    pub inline fn GetRegistryKey(self: *const IGPEInformation, dwSection: u32, hKey: ?*?HKEY) HRESULT {
        return self.vtable.GetRegistryKey(self, dwSection, hKey);
    }
    pub inline fn GetDSPath(self: *const IGPEInformation, dwSection: u32, pszPath: [*:0]u16, cchMaxPath: i32) HRESULT {
        return self.vtable.GetDSPath(self, dwSection, pszPath, cchMaxPath);
    }
    pub inline fn GetFileSysPath(self: *const IGPEInformation, dwSection: u32, pszPath: [*:0]u16, cchMaxPath: i32) HRESULT {
        return self.vtable.GetFileSysPath(self, dwSection, pszPath, cchMaxPath);
    }
    pub inline fn GetOptions(self: *const IGPEInformation, dwOptions: ?*u32) HRESULT {
        return self.vtable.GetOptions(self, dwOptions);
    }
    pub inline fn GetType(self: *const IGPEInformation, gpoType: ?*GROUP_POLICY_OBJECT_TYPE) HRESULT {
        return self.vtable.GetType(self, gpoType);
    }
    pub inline fn GetHint(self: *const IGPEInformation, gpHint: ?*GROUP_POLICY_HINT_TYPE) HRESULT {
        return self.vtable.GetHint(self, gpHint);
    }
    pub inline fn PolicyChanged(self: *const IGPEInformation, bMachine: BOOL, bAdd: BOOL, pGuidExtension: ?*Guid, pGuidSnapin: ?*Guid) HRESULT {
...
pub const IGroupPolicyObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn New(self: *const IGroupPolicyObject, pszDomainName: ?PWSTR, pszDisplayName: ?PWSTR, dwFlags: u32) HRESULT {
        return self.vtable.New(self, pszDomainName, pszDisplayName, dwFlags);
    }
    pub inline fn OpenDSGPO(self: *const IGroupPolicyObject, pszPath: ?PWSTR, dwFlags: u32) HRESULT {
        return self.vtable.OpenDSGPO(self, pszPath, dwFlags);
    }
    pub inline fn OpenLocalMachineGPO(self: *const IGroupPolicyObject, dwFlags: u32) HRESULT {
        return self.vtable.OpenLocalMachineGPO(self, dwFlags);
    }
    pub inline fn OpenRemoteMachineGPO(self: *const IGroupPolicyObject, pszComputerName: ?PWSTR, dwFlags: u32) HRESULT {
        return self.vtable.OpenRemoteMachineGPO(self, pszComputerName, dwFlags);
    }
    pub inline fn Save(self: *const IGroupPolicyObject, bMachine: BOOL, bAdd: BOOL, pGuidExtension: ?*Guid, pGuid: ?*Guid) HRESULT {
        return self.vtable.Save(self, bMachine, bAdd, pGuidExtension, pGuid);
    }
    pub inline fn Delete(self: *const IGroupPolicyObject) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn GetName(self: *const IGroupPolicyObject, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetName(self, pszName, cchMaxLength);
    }
    pub inline fn GetDisplayName(self: *const IGroupPolicyObject, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetDisplayName(self, pszName, cchMaxLength);
    }
    pub inline fn SetDisplayName(self: *const IGroupPolicyObject, pszName: ?PWSTR) HRESULT {
        return self.vtable.SetDisplayName(self, pszName);
    }
    pub inline fn GetPath(self: *const IGroupPolicyObject, pszPath: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetPath(self, pszPath, cchMaxLength);
    }
    pub inline fn GetDSPath(self: *const IGroupPolicyObject, dwSection: u32, pszPath: [*:0]u16, cchMaxPath: i32) HRESULT {
        return self.vtable.GetDSPath(self, dwSection, pszPath, cchMaxPath);
    }
    pub inline fn GetFileSysPath(self: *const IGroupPolicyObject, dwSection: u32, pszPath: [*:0]u16, cchMaxPath: i32) HRESULT {
        return self.vtable.GetFileSysPath(self, dwSection, pszPath, cchMaxPath);
    }
    pub inline fn GetRegistryKey(self: *const IGroupPolicyObject, dwSection: u32, hKey: ?*?HKEY) HRESULT {
        return self.vtable.GetRegistryKey(self, dwSection, hKey);
    }
    pub inline fn GetOptions(self: *const IGroupPolicyObject, dwOptions: ?*u32) HRESULT {
        return self.vtable.GetOptions(self, dwOptions);
    }
    pub inline fn SetOptions(self: *const IGroupPolicyObject, dwOptions: u32, dwMask: u32) HRESULT {
        return self.vtable.SetOptions(self, dwOptions, dwMask);
    }
    pub inline fn GetType(self: *const IGroupPolicyObject, gpoType: ?*GROUP_POLICY_OBJECT_TYPE) HRESULT {
        return self.vtable.GetType(self, gpoType);
    }
    pub inline fn GetMachineName(self: *const IGroupPolicyObject, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetMachineName(self, pszName, cchMaxLength);
    }
    pub inline fn GetPropertySheetPages(self: *const IGroupPolicyObject, hPages: ?*?*?HPROPSHEETPAGE, uPageCount: ?*u32) HRESULT {
...
pub const IRSOPInformation = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetNamespace(self: *const IRSOPInformation, dwSection: u32, pszName: [*:0]u16, cchMaxLength: i32) HRESULT {
        return self.vtable.GetNamespace(self, dwSection, pszName, cchMaxLength);
    }
    pub inline fn GetFlags(self: *const IRSOPInformation, pdwFlags: ?*u32) HRESULT {
        return self.vtable.GetFlags(self, pdwFlags);
    }
    pub inline fn GetEventLogEntryText(self: *const IRSOPInformation, pszEventSource: ?PWSTR, pszEventLogName: ?PWSTR, pszEventTime: ?PWSTR, dwEventID: u32, ppszText: ?*?PWSTR) HRESULT {
