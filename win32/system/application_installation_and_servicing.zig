...
pub const IValidate = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OpenDatabase(self: *const IValidate, szDatabase: ?[*:0]const u16) HRESULT {
        return self.vtable.OpenDatabase(self, szDatabase);
    }
    pub inline fn OpenCUB(self: *const IValidate, szCUBFile: ?[*:0]const u16) HRESULT {
        return self.vtable.OpenCUB(self, szCUBFile);
    }
    pub inline fn CloseDatabase(self: *const IValidate) HRESULT {
        return self.vtable.CloseDatabase(self);
    }
    pub inline fn CloseCUB(self: *const IValidate) HRESULT {
        return self.vtable.CloseCUB(self);
    }
    pub inline fn SetDisplay(self: *const IValidate, pDisplayFunction: ?LPDISPLAYVAL, pContext: ?*anyopaque) HRESULT {
        return self.vtable.SetDisplay(self, pDisplayFunction, pContext);
    }
    pub inline fn SetStatus(self: *const IValidate, pStatusFunction: ?LPEVALCOMCALLBACK, pContext: ?*anyopaque) HRESULT {
        return self.vtable.SetStatus(self, pStatusFunction, pContext);
    }
    pub inline fn Validate(self: *const IValidate, wzICEs: ?[*:0]const u16) HRESULT {
...
pub const IEnumMsmString = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumMsmString, cFetch: u32, rgbstrStrings: ?*?BSTR, pcFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, cFetch, rgbstrStrings, pcFetched);
    }
    pub inline fn Skip(self: *const IEnumMsmString, cSkip: u32) HRESULT {
        return self.vtable.Skip(self, cSkip);
    }
    pub inline fn Reset(self: *const IEnumMsmString) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumMsmString, pemsmStrings: ?*?*IEnumMsmString) HRESULT {
...
pub const IMsmStrings = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IMsmStrings, Item: i32, Return: ?*?BSTR) HRESULT {
        return self.vtable.get_Item(self, Item, Return);
    }
    pub inline fn get_Count(self: *const IMsmStrings, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn get__NewEnum(self: *const IMsmStrings, NewEnum: ?*?*IUnknown) HRESULT {
...
pub const IMsmError = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Type(self: *const IMsmError, ErrorType: ?*msmErrorType) HRESULT {
        return self.vtable.get_Type(self, ErrorType);
    }
    pub inline fn get_Path(self: *const IMsmError, ErrorPath: ?*?BSTR) HRESULT {
        return self.vtable.get_Path(self, ErrorPath);
    }
    pub inline fn get_Language(self: *const IMsmError, ErrorLanguage: ?*i16) HRESULT {
        return self.vtable.get_Language(self, ErrorLanguage);
    }
    pub inline fn get_DatabaseTable(self: *const IMsmError, ErrorTable: ?*?BSTR) HRESULT {
        return self.vtable.get_DatabaseTable(self, ErrorTable);
    }
    pub inline fn get_DatabaseKeys(self: *const IMsmError, ErrorKeys: ?*?*IMsmStrings) HRESULT {
        return self.vtable.get_DatabaseKeys(self, ErrorKeys);
    }
    pub inline fn get_ModuleTable(self: *const IMsmError, ErrorTable: ?*?BSTR) HRESULT {
        return self.vtable.get_ModuleTable(self, ErrorTable);
    }
    pub inline fn get_ModuleKeys(self: *const IMsmError, ErrorKeys: ?*?*IMsmStrings) HRESULT {
...
pub const IEnumMsmError = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumMsmError, cFetch: u32, rgmsmErrors: ?*?*IMsmError, pcFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, cFetch, rgmsmErrors, pcFetched);
    }
    pub inline fn Skip(self: *const IEnumMsmError, cSkip: u32) HRESULT {
        return self.vtable.Skip(self, cSkip);
    }
    pub inline fn Reset(self: *const IEnumMsmError) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumMsmError, pemsmErrors: ?*?*IEnumMsmError) HRESULT {
...
pub const IMsmErrors = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IMsmErrors, Item: i32, Return: ?*?*IMsmError) HRESULT {
        return self.vtable.get_Item(self, Item, Return);
    }
    pub inline fn get_Count(self: *const IMsmErrors, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn get__NewEnum(self: *const IMsmErrors, NewEnum: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, NewEnum);
    }
};
...
pub const IMsmDependency = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Module(self: *const IMsmDependency, Module: ?*?BSTR) HRESULT {
        return self.vtable.get_Module(self, Module);
    }
    pub inline fn get_Language(self: *const IMsmDependency, Language: ?*i16) HRESULT {
        return self.vtable.get_Language(self, Language);
    }
    pub inline fn get_Version(self: *const IMsmDependency, Version: ?*?BSTR) HRESULT {
...
pub const IEnumMsmDependency = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumMsmDependency, cFetch: u32, rgmsmDependencies: ?*?*IMsmDependency, pcFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, cFetch, rgmsmDependencies, pcFetched);
    }
    pub inline fn Skip(self: *const IEnumMsmDependency, cSkip: u32) HRESULT {
        return self.vtable.Skip(self, cSkip);
    }
    pub inline fn Reset(self: *const IEnumMsmDependency) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumMsmDependency, pemsmDependencies: ?*?*IEnumMsmDependency) HRESULT {
...
pub const IMsmDependencies = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Item(self: *const IMsmDependencies, Item: i32, Return: ?*?*IMsmDependency) HRESULT {
        return self.vtable.get_Item(self, Item, Return);
    }
    pub inline fn get_Count(self: *const IMsmDependencies, Count: ?*i32) HRESULT {
        return self.vtable.get_Count(self, Count);
    }
    pub inline fn get__NewEnum(self: *const IMsmDependencies, NewEnum: ?*?*IUnknown) HRESULT {
        return self.vtable.get__NewEnum(self, NewEnum);
    }
};
...
pub const IMsmMerge = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn OpenDatabase(self: *const IMsmMerge, Path: ?BSTR) HRESULT {
        return self.vtable.OpenDatabase(self, Path);
    }
    pub inline fn OpenModule(self: *const IMsmMerge, Path: ?BSTR, Language: i16) HRESULT {
        return self.vtable.OpenModule(self, Path, Language);
    }
    pub inline fn CloseDatabase(self: *const IMsmMerge, Commit: i16) HRESULT {
        return self.vtable.CloseDatabase(self, Commit);
    }
    pub inline fn CloseModule(self: *const IMsmMerge) HRESULT {
        return self.vtable.CloseModule(self);
    }
    pub inline fn OpenLog(self: *const IMsmMerge, Path: ?BSTR) HRESULT {
        return self.vtable.OpenLog(self, Path);
    }
    pub inline fn CloseLog(self: *const IMsmMerge) HRESULT {
        return self.vtable.CloseLog(self);
    }
    pub inline fn Log(self: *const IMsmMerge, Message: ?BSTR) HRESULT {
        return self.vtable.Log(self, Message);
    }
    pub inline fn get_Errors(self: *const IMsmMerge, Errors: ?*?*IMsmErrors) HRESULT {
        return self.vtable.get_Errors(self, Errors);
    }
    pub inline fn get_Dependencies(self: *const IMsmMerge, Dependencies: ?*?*IMsmDependencies) HRESULT {
        return self.vtable.get_Dependencies(self, Dependencies);
    }
    pub inline fn Merge(self: *const IMsmMerge, Feature: ?BSTR, RedirectDir: ?BSTR) HRESULT {
        return self.vtable.Merge(self, Feature, RedirectDir);
    }
    pub inline fn Connect(self: *const IMsmMerge, Feature: ?BSTR) HRESULT {
        return self.vtable.Connect(self, Feature);
    }
    pub inline fn ExtractCAB(self: *const IMsmMerge, FileName: ?BSTR) HRESULT {
        return self.vtable.ExtractCAB(self, FileName);
    }
    pub inline fn ExtractFiles(self: *const IMsmMerge, Path: ?BSTR) HRESULT {
...
pub const IMsmGetFiles = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ModuleFiles(self: *const IMsmGetFiles, Files: ?*?*IMsmStrings) HRESULT {
...
pub const IAssemblyName = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetProperty(self: *const IAssemblyName, PropertyId: u32, pvProperty: ?*anyopaque, cbProperty: u32) HRESULT {
        return self.vtable.SetProperty(self, PropertyId, pvProperty, cbProperty);
    }
    pub inline fn GetProperty(self: *const IAssemblyName, PropertyId: u32, pvProperty: ?*anyopaque, pcbProperty: ?*u32) HRESULT {
        return self.vtable.GetProperty(self, PropertyId, pvProperty, pcbProperty);
    }
    pub inline fn Finalize(self: *const IAssemblyName) HRESULT {
        return self.vtable.Finalize(self);
    }
    pub inline fn GetDisplayName(self: *const IAssemblyName, szDisplayName: ?[*:0]u16, pccDisplayName: ?*u32, dwDisplayFlags: u32) HRESULT {
        return self.vtable.GetDisplayName(self, szDisplayName, pccDisplayName, dwDisplayFlags);
    }
    pub inline fn Reserved(self: *const IAssemblyName, refIID: ?*const Guid, pUnkReserved1: ?*IUnknown, pUnkReserved2: ?*IUnknown, szReserved: ?[*:0]const u16, llReserved: i64, pvReserved: ?*anyopaque, cbReserved: u32, ppReserved: ?*?*anyopaque) HRESULT {
    ...
    pub inline fn GetName(self: *const IAssemblyName, lpcwBuffer: ?*u32, pwzName: ?[*:0]u16) HRESULT {
        return self.vtable.GetName(self, lpcwBuffer, pwzName);
    }
    pub inline fn GetVersion(self: *const IAssemblyName, pdwVersionHi: ?*u32, pdwVersionLow: ?*u32) HRESULT {
        return self.vtable.GetVersion(self, pdwVersionHi, pdwVersionLow);
    }
    pub inline fn IsEqual(self: *const IAssemblyName, pName: ?*IAssemblyName, dwCmpFlags: u32) HRESULT {
        return self.vtable.IsEqual(self, pName, dwCmpFlags);
    }
    pub inline fn Clone(self: *const IAssemblyName, pName: ?*?*IAssemblyName) HRESULT {
...
pub const IAssemblyCacheItem = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateStream(self: *const IAssemblyCacheItem, dwFlags: u32, pszStreamName: ?[*:0]const u16, dwFormat: u32, dwFormatFlags: u32, ppIStream: ?*?*IStream, puliMaxSize: ?*ULARGE_INTEGER) HRESULT {
        return self.vtable.CreateStream(self, dwFlags, pszStreamName, dwFormat, dwFormatFlags, ppIStream, puliMaxSize);
    }
    pub inline fn Commit(self: *const IAssemblyCacheItem, dwFlags: u32, pulDisposition: ?*u32) HRESULT {
        return self.vtable.Commit(self, dwFlags, pulDisposition);
    }
    pub inline fn AbortItem(self: *const IAssemblyCacheItem) HRESULT {
...
pub const IAssemblyCache = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn UninstallAssembly(self: *const IAssemblyCache, dwFlags: u32, pszAssemblyName: ?[*:0]const u16, pRefData: ?*FUSION_INSTALL_REFERENCE, pulDisposition: ?*IASSEMBLYCACHE_UNINSTALL_DISPOSITION) HRESULT {
        return self.vtable.UninstallAssembly(self, dwFlags, pszAssemblyName, pRefData, pulDisposition);
    }
    pub inline fn QueryAssemblyInfo(self: *const IAssemblyCache, dwFlags: QUERYASMINFO_FLAGS, pszAssemblyName: ?[*:0]const u16, pAsmInfo: ?*ASSEMBLY_INFO) HRESULT {
        return self.vtable.QueryAssemblyInfo(self, dwFlags, pszAssemblyName, pAsmInfo);
    }
    pub inline fn CreateAssemblyCacheItem(self: *const IAssemblyCache, dwFlags: u32, pvReserved: ?*anyopaque, ppAsmItem: ?*?*IAssemblyCacheItem, pszAssemblyName: ?[*:0]const u16) HRESULT {
        return self.vtable.CreateAssemblyCacheItem(self, dwFlags, pvReserved, ppAsmItem, pszAssemblyName);
    }
    pub inline fn Reserved(self: *const IAssemblyCache, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.Reserved(self, ppUnk);
    }
    pub inline fn InstallAssembly(self: *const IAssemblyCache, dwFlags: u32, pszManifestFilePath: ?[*:0]const u16, pRefData: ?*FUSION_INSTALL_REFERENCE) HRESULT {
...
pub const IPMApplicationInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMApplicationInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_InstanceID(self: *const IPMApplicationInfo, pInstanceID: ?*Guid) HRESULT {
        return self.vtable.get_InstanceID(self, pInstanceID);
    }
    pub inline fn get_OfferID(self: *const IPMApplicationInfo, pOfferID: ?*Guid) HRESULT {
        return self.vtable.get_OfferID(self, pOfferID);
    }
    pub inline fn get_DefaultTask(self: *const IPMApplicationInfo, pDefaultTask: ?*?BSTR) HRESULT {
        return self.vtable.get_DefaultTask(self, pDefaultTask);
    }
    pub inline fn get_AppTitle(self: *const IPMApplicationInfo, pAppTitle: ?*?BSTR) HRESULT {
        return self.vtable.get_AppTitle(self, pAppTitle);
    }
    pub inline fn get_IconPath(self: *const IPMApplicationInfo, pAppIconPath: ?*?BSTR) HRESULT {
        return self.vtable.get_IconPath(self, pAppIconPath);
    }
    pub inline fn get_NotificationState(self: *const IPMApplicationInfo, pIsNotified: ?*BOOL) HRESULT {
        return self.vtable.get_NotificationState(self, pIsNotified);
    }
    pub inline fn get_AppInstallType(self: *const IPMApplicationInfo, pAppInstallType: ?*PM_APPLICATION_INSTALL_TYPE) HRESULT {
        return self.vtable.get_AppInstallType(self, pAppInstallType);
    }
    pub inline fn get_State(self: *const IPMApplicationInfo, pState: ?*PM_APPLICATION_STATE) HRESULT {
        return self.vtable.get_State(self, pState);
    }
    pub inline fn get_IsRevoked(self: *const IPMApplicationInfo, pIsRevoked: ?*BOOL) HRESULT {
        return self.vtable.get_IsRevoked(self, pIsRevoked);
    }
    pub inline fn get_UpdateAvailable(self: *const IPMApplicationInfo, pIsUpdateAvailable: ?*BOOL) HRESULT {
        return self.vtable.get_UpdateAvailable(self, pIsUpdateAvailable);
    }
    pub inline fn get_InstallDate(self: *const IPMApplicationInfo, pInstallDate: ?*FILETIME) HRESULT {
        return self.vtable.get_InstallDate(self, pInstallDate);
    }
    pub inline fn get_IsUninstallable(self: *const IPMApplicationInfo, pIsUninstallable: ?*BOOL) HRESULT {
        return self.vtable.get_IsUninstallable(self, pIsUninstallable);
    }
    pub inline fn get_IsThemable(self: *const IPMApplicationInfo, pIsThemable: ?*BOOL) HRESULT {
        return self.vtable.get_IsThemable(self, pIsThemable);
    }
    pub inline fn get_IsTrial(self: *const IPMApplicationInfo, pIsTrial: ?*BOOL) HRESULT {
        return self.vtable.get_IsTrial(self, pIsTrial);
    }
    pub inline fn get_InstallPath(self: *const IPMApplicationInfo, pInstallPath: ?*?BSTR) HRESULT {
        return self.vtable.get_InstallPath(self, pInstallPath);
    }
    pub inline fn get_DataRoot(self: *const IPMApplicationInfo, pDataRoot: ?*?BSTR) HRESULT {
        return self.vtable.get_DataRoot(self, pDataRoot);
    }
    pub inline fn get_Genre(self: *const IPMApplicationInfo, pGenre: ?*PM_APP_GENRE) HRESULT {
        return self.vtable.get_Genre(self, pGenre);
    }
    pub inline fn get_Publisher(self: *const IPMApplicationInfo, pPublisher: ?*?BSTR) HRESULT {
        return self.vtable.get_Publisher(self, pPublisher);
    }
    pub inline fn get_Author(self: *const IPMApplicationInfo, pAuthor: ?*?BSTR) HRESULT {
        return self.vtable.get_Author(self, pAuthor);
    }
    pub inline fn get_Description(self: *const IPMApplicationInfo, pDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pDescription);
    }
    pub inline fn get_Version(self: *const IPMApplicationInfo, pVersion: ?*?BSTR) HRESULT {
        return self.vtable.get_Version(self, pVersion);
    }
    pub inline fn get_InvocationInfo(self: *const IPMApplicationInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
    pub inline fn get_AppPlatMajorVersion(self: *const IPMApplicationInfo, pMajorVer: ?*u8) HRESULT {
        return self.vtable.get_AppPlatMajorVersion(self, pMajorVer);
    }
    pub inline fn get_AppPlatMinorVersion(self: *const IPMApplicationInfo, pMinorVer: ?*u8) HRESULT {
        return self.vtable.get_AppPlatMinorVersion(self, pMinorVer);
    }
    pub inline fn get_PublisherID(self: *const IPMApplicationInfo, pPublisherID: ?*Guid) HRESULT {
        return self.vtable.get_PublisherID(self, pPublisherID);
    }
    pub inline fn get_IsMultiCore(self: *const IPMApplicationInfo, pIsMultiCore: ?*BOOL) HRESULT {
        return self.vtable.get_IsMultiCore(self, pIsMultiCore);
    }
    pub inline fn get_SID(self: *const IPMApplicationInfo, pSID: ?*?BSTR) HRESULT {
        return self.vtable.get_SID(self, pSID);
    }
    pub inline fn get_AppPlatMajorVersionLightUp(self: *const IPMApplicationInfo, pMajorVer: ?*u8) HRESULT {
        return self.vtable.get_AppPlatMajorVersionLightUp(self, pMajorVer);
    }
    pub inline fn get_AppPlatMinorVersionLightUp(self: *const IPMApplicationInfo, pMinorVer: ?*u8) HRESULT {
        return self.vtable.get_AppPlatMinorVersionLightUp(self, pMinorVer);
    }
    pub inline fn set_UpdateAvailable(self: *const IPMApplicationInfo, IsUpdateAvailable: BOOL) HRESULT {
        return self.vtable.set_UpdateAvailable(self, IsUpdateAvailable);
    }
    pub inline fn set_NotificationState(self: *const IPMApplicationInfo, IsNotified: BOOL) HRESULT {
        return self.vtable.set_NotificationState(self, IsNotified);
    }
    pub inline fn set_IconPath(self: *const IPMApplicationInfo, AppIconPath: ?BSTR) HRESULT {
        return self.vtable.set_IconPath(self, AppIconPath);
    }
    pub inline fn set_UninstallableState(self: *const IPMApplicationInfo, IsUninstallable: BOOL) HRESULT {
        return self.vtable.set_UninstallableState(self, IsUninstallable);
    }
    pub inline fn get_IsPinableOnKidZone(self: *const IPMApplicationInfo, pIsPinable: ?*BOOL) HRESULT {
        return self.vtable.get_IsPinableOnKidZone(self, pIsPinable);
    }
    pub inline fn get_IsOriginallyPreInstalled(self: *const IPMApplicationInfo, pIsPreinstalled: ?*BOOL) HRESULT {
        return self.vtable.get_IsOriginallyPreInstalled(self, pIsPreinstalled);
    }
    pub inline fn get_IsInstallOnSD(self: *const IPMApplicationInfo, pIsInstallOnSD: ?*BOOL) HRESULT {
        return self.vtable.get_IsInstallOnSD(self, pIsInstallOnSD);
    }
    pub inline fn get_IsOptoutOnSD(self: *const IPMApplicationInfo, pIsOptoutOnSD: ?*BOOL) HRESULT {
        return self.vtable.get_IsOptoutOnSD(self, pIsOptoutOnSD);
    }
    pub inline fn get_IsOptoutBackupRestore(self: *const IPMApplicationInfo, pIsOptoutBackupRestore: ?*BOOL) HRESULT {
        return self.vtable.get_IsOptoutBackupRestore(self, pIsOptoutBackupRestore);
    }
    pub inline fn set_EnterpriseDisabled(self: *const IPMApplicationInfo, IsDisabled: BOOL) HRESULT {
        return self.vtable.set_EnterpriseDisabled(self, IsDisabled);
    }
    pub inline fn set_EnterpriseUninstallable(self: *const IPMApplicationInfo, IsUninstallable: BOOL) HRESULT {
        return self.vtable.set_EnterpriseUninstallable(self, IsUninstallable);
    }
    pub inline fn get_EnterpriseDisabled(self: *const IPMApplicationInfo, IsDisabled: ?*BOOL) HRESULT {
        return self.vtable.get_EnterpriseDisabled(self, IsDisabled);
    }
    pub inline fn get_EnterpriseUninstallable(self: *const IPMApplicationInfo, IsUninstallable: ?*BOOL) HRESULT {
        return self.vtable.get_EnterpriseUninstallable(self, IsUninstallable);
    }
    pub inline fn get_IsVisibleOnAppList(self: *const IPMApplicationInfo, pIsVisible: ?*BOOL) HRESULT {
        return self.vtable.get_IsVisibleOnAppList(self, pIsVisible);
    }
    pub inline fn get_IsInboxApp(self: *const IPMApplicationInfo, pIsInboxApp: ?*BOOL) HRESULT {
        return self.vtable.get_IsInboxApp(self, pIsInboxApp);
    }
    pub inline fn get_StorageID(self: *const IPMApplicationInfo, pStorageID: ?*Guid) HRESULT {
        return self.vtable.get_StorageID(self, pStorageID);
    }
    pub inline fn get_StartAppBlob(self: *const IPMApplicationInfo, pBlob: ?*PM_STARTAPPBLOB) HRESULT {
        return self.vtable.get_StartAppBlob(self, pBlob);
    }
    pub inline fn get_IsMovable(self: *const IPMApplicationInfo, pIsMovable: ?*BOOL) HRESULT {
        return self.vtable.get_IsMovable(self, pIsMovable);
    }
    pub inline fn get_DeploymentAppEnumerationHubFilter(self: *const IPMApplicationInfo, HubType: ?*PM_TILE_HUBTYPE) HRESULT {
        return self.vtable.get_DeploymentAppEnumerationHubFilter(self, HubType);
    }
    pub inline fn get_ModifiedDate(self: *const IPMApplicationInfo, pModifiedDate: ?*FILETIME) HRESULT {
        return self.vtable.get_ModifiedDate(self, pModifiedDate);
    }
    pub inline fn get_IsOriginallyRestored(self: *const IPMApplicationInfo, pIsRestored: ?*BOOL) HRESULT {
        return self.vtable.get_IsOriginallyRestored(self, pIsRestored);
    }
    pub inline fn get_ShouldDeferMdilBind(self: *const IPMApplicationInfo, pfDeferMdilBind: ?*BOOL) HRESULT {
        return self.vtable.get_ShouldDeferMdilBind(self, pfDeferMdilBind);
    }
    pub inline fn get_IsFullyPreInstall(self: *const IPMApplicationInfo, pfIsFullyPreInstall: ?*BOOL) HRESULT {
        return self.vtable.get_IsFullyPreInstall(self, pfIsFullyPreInstall);
    }
    pub inline fn set_IsMdilMaintenanceNeeded(self: *const IPMApplicationInfo, fIsMdilMaintenanceNeeded: BOOL) HRESULT {
        return self.vtable.set_IsMdilMaintenanceNeeded(self, fIsMdilMaintenanceNeeded);
    }
    pub inline fn set_Title(self: *const IPMApplicationInfo, AppTitle: ?BSTR) HRESULT {
...
pub const IPMTilePropertyInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_PropertyID(self: *const IPMTilePropertyInfo, pPropID: ?*u32) HRESULT {
        return self.vtable.get_PropertyID(self, pPropID);
    }
    pub inline fn get_PropertyValue(self: *const IPMTilePropertyInfo, pPropValue: ?*?BSTR) HRESULT {
        return self.vtable.get_PropertyValue(self, pPropValue);
    }
    pub inline fn set_Property(self: *const IPMTilePropertyInfo, PropValue: ?BSTR) HRESULT {
...
pub const IPMTilePropertyEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMTilePropertyEnumerator, ppPropInfo: ?*?*IPMTilePropertyInfo) HRESULT {
...
pub const IPMTileInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMTileInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_TileID(self: *const IPMTileInfo, pTileID: ?*?BSTR) HRESULT {
        return self.vtable.get_TileID(self, pTileID);
    }
    pub inline fn get_TemplateType(self: *const IPMTileInfo, pTemplateType: ?*TILE_TEMPLATE_TYPE) HRESULT {
        return self.vtable.get_TemplateType(self, pTemplateType);
    }
    pub inline fn get_HubPinnedState(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, pPinned: ?*BOOL) HRESULT {
        return self.vtable.get_HubPinnedState(self, HubType, pPinned);
    }
    pub inline fn get_HubPosition(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, pPosition: ?*u32) HRESULT {
        return self.vtable.get_HubPosition(self, HubType, pPosition);
    }
    pub inline fn get_IsNotified(self: *const IPMTileInfo, pIsNotified: ?*BOOL) HRESULT {
        return self.vtable.get_IsNotified(self, pIsNotified);
    }
    pub inline fn get_IsDefault(self: *const IPMTileInfo, pIsDefault: ?*BOOL) HRESULT {
        return self.vtable.get_IsDefault(self, pIsDefault);
    }
    pub inline fn get_TaskID(self: *const IPMTileInfo, pTaskID: ?*?BSTR) HRESULT {
        return self.vtable.get_TaskID(self, pTaskID);
    }
    pub inline fn get_TileType(self: *const IPMTileInfo, pStartTileType: ?*PM_STARTTILE_TYPE) HRESULT {
        return self.vtable.get_TileType(self, pStartTileType);
    }
    pub inline fn get_IsThemable(self: *const IPMTileInfo, pIsThemable: ?*BOOL) HRESULT {
        return self.vtable.get_IsThemable(self, pIsThemable);
    }
    pub inline fn get_PropertyById(self: *const IPMTileInfo, PropID: u32, ppPropInfo: ?*?*IPMTilePropertyInfo) HRESULT {
        return self.vtable.get_PropertyById(self, PropID, ppPropInfo);
    }
    pub inline fn get_InvocationInfo(self: *const IPMTileInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
    pub inline fn get_PropertyEnum(self: *const IPMTileInfo, ppTilePropEnum: ?*?*IPMTilePropertyEnumerator) HRESULT {
        return self.vtable.get_PropertyEnum(self, ppTilePropEnum);
    }
    pub inline fn get_HubTileSize(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, pSize: ?*PM_TILE_SIZE) HRESULT {
        return self.vtable.get_HubTileSize(self, HubType, pSize);
    }
    pub inline fn set_HubPosition(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, Position: u32) HRESULT {
        return self.vtable.set_HubPosition(self, HubType, Position);
    }
    pub inline fn set_NotifiedState(self: *const IPMTileInfo, Notified: BOOL) HRESULT {
        return self.vtable.set_NotifiedState(self, Notified);
    }
    pub inline fn set_HubPinnedState(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, Pinned: BOOL) HRESULT {
        return self.vtable.set_HubPinnedState(self, HubType, Pinned);
    }
    pub inline fn set_HubTileSize(self: *const IPMTileInfo, HubType: PM_TILE_HUBTYPE, Size: PM_TILE_SIZE) HRESULT {
        return self.vtable.set_HubTileSize(self, HubType, Size);
    }
    pub inline fn set_InvocationInfo(self: *const IPMTileInfo, TaskName: ?BSTR, TaskParameters: ?BSTR) HRESULT {
        return self.vtable.set_InvocationInfo(self, TaskName, TaskParameters);
    }
    pub inline fn get_StartTileBlob(self: *const IPMTileInfo, pBlob: ?*PM_STARTTILEBLOB) HRESULT {
        return self.vtable.get_StartTileBlob(self, pBlob);
    }
    pub inline fn get_IsRestoring(self: *const IPMTileInfo, pIsRestoring: ?*BOOL) HRESULT {
        return self.vtable.get_IsRestoring(self, pIsRestoring);
    }
    pub inline fn get_IsAutoRestoreDisabled(self: *const IPMTileInfo, pIsAutoRestoreDisabled: ?*BOOL) HRESULT {
        return self.vtable.get_IsAutoRestoreDisabled(self, pIsAutoRestoreDisabled);
    }
    pub inline fn set_IsRestoring(self: *const IPMTileInfo, Restoring: BOOL) HRESULT {
        return self.vtable.set_IsRestoring(self, Restoring);
    }
    pub inline fn set_IsAutoRestoreDisabled(self: *const IPMTileInfo, AutoRestoreDisabled: BOOL) HRESULT {
...
pub const IPMTileInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMTileInfoEnumerator, ppTileInfo: ?*?*IPMTileInfo) HRESULT {
...
pub const IPMApplicationInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMApplicationInfoEnumerator, ppAppInfo: ?*?*IPMApplicationInfo) HRESULT {
...
pub const IPMLiveTileJobInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMLiveTileJobInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_TileID(self: *const IPMLiveTileJobInfo, pTileID: ?*?BSTR) HRESULT {
        return self.vtable.get_TileID(self, pTileID);
    }
    pub inline fn get_NextSchedule(self: *const IPMLiveTileJobInfo, pNextSchedule: ?*FILETIME) HRESULT {
        return self.vtable.get_NextSchedule(self, pNextSchedule);
    }
    pub inline fn set_NextSchedule(self: *const IPMLiveTileJobInfo, ftNextSchedule: FILETIME) HRESULT {
        return self.vtable.set_NextSchedule(self, ftNextSchedule);
    }
    pub inline fn get_StartSchedule(self: *const IPMLiveTileJobInfo, pStartSchedule: ?*FILETIME) HRESULT {
        return self.vtable.get_StartSchedule(self, pStartSchedule);
    }
    pub inline fn set_StartSchedule(self: *const IPMLiveTileJobInfo, ftStartSchedule: FILETIME) HRESULT {
        return self.vtable.set_StartSchedule(self, ftStartSchedule);
    }
    pub inline fn get_IntervalDuration(self: *const IPMLiveTileJobInfo, pIntervalDuration: ?*u32) HRESULT {
        return self.vtable.get_IntervalDuration(self, pIntervalDuration);
    }
    pub inline fn set_IntervalDuration(self: *const IPMLiveTileJobInfo, ulIntervalDuration: u32) HRESULT {
        return self.vtable.set_IntervalDuration(self, ulIntervalDuration);
    }
    pub inline fn get_RunForever(self: *const IPMLiveTileJobInfo, IsRunForever: ?*BOOL) HRESULT {
        return self.vtable.get_RunForever(self, IsRunForever);
    }
    pub inline fn set_RunForever(self: *const IPMLiveTileJobInfo, fRunForever: BOOL) HRESULT {
        return self.vtable.set_RunForever(self, fRunForever);
    }
    pub inline fn get_MaxRunCount(self: *const IPMLiveTileJobInfo, pMaxRunCount: ?*u32) HRESULT {
        return self.vtable.get_MaxRunCount(self, pMaxRunCount);
    }
    pub inline fn set_MaxRunCount(self: *const IPMLiveTileJobInfo, ulMaxRunCount: u32) HRESULT {
        return self.vtable.set_MaxRunCount(self, ulMaxRunCount);
    }
    pub inline fn get_RunCount(self: *const IPMLiveTileJobInfo, pRunCount: ?*u32) HRESULT {
        return self.vtable.get_RunCount(self, pRunCount);
    }
    pub inline fn set_RunCount(self: *const IPMLiveTileJobInfo, ulRunCount: u32) HRESULT {
        return self.vtable.set_RunCount(self, ulRunCount);
    }
    pub inline fn get_RecurrenceType(self: *const IPMLiveTileJobInfo, pRecurrenceType: ?*u32) HRESULT {
        return self.vtable.get_RecurrenceType(self, pRecurrenceType);
    }
    pub inline fn set_RecurrenceType(self: *const IPMLiveTileJobInfo, ulRecurrenceType: u32) HRESULT {
        return self.vtable.set_RecurrenceType(self, ulRecurrenceType);
    }
    pub inline fn get_TileXML(self: *const IPMLiveTileJobInfo, pTileXml: [*]?*u8, pcbTileXml: ?*u32) HRESULT {
        return self.vtable.get_TileXML(self, pTileXml, pcbTileXml);
    }
    pub inline fn set_TileXML(self: *const IPMLiveTileJobInfo, pTileXml: [*:0]u8, cbTileXml: u32) HRESULT {
        return self.vtable.set_TileXML(self, pTileXml, cbTileXml);
    }
    pub inline fn get_UrlXML(self: *const IPMLiveTileJobInfo, pUrlXML: [*]?*u8, pcbUrlXML: ?*u32) HRESULT {
        return self.vtable.get_UrlXML(self, pUrlXML, pcbUrlXML);
    }
    pub inline fn set_UrlXML(self: *const IPMLiveTileJobInfo, pUrlXML: [*:0]u8, cbUrlXML: u32) HRESULT {
        return self.vtable.set_UrlXML(self, pUrlXML, cbUrlXML);
    }
    pub inline fn get_AttemptCount(self: *const IPMLiveTileJobInfo, pAttemptCount: ?*u32) HRESULT {
        return self.vtable.get_AttemptCount(self, pAttemptCount);
    }
    pub inline fn set_AttemptCount(self: *const IPMLiveTileJobInfo, ulAttemptCount: u32) HRESULT {
        return self.vtable.set_AttemptCount(self, ulAttemptCount);
    }
    pub inline fn get_DownloadState(self: *const IPMLiveTileJobInfo, pDownloadState: ?*u32) HRESULT {
        return self.vtable.get_DownloadState(self, pDownloadState);
    }
    pub inline fn set_DownloadState(self: *const IPMLiveTileJobInfo, ulDownloadState: u32) HRESULT {
...
pub const IPMLiveTileJobInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMLiveTileJobInfoEnumerator, ppLiveTileJobInfo: ?*?*IPMLiveTileJobInfo) HRESULT {
...
pub const IPMDeploymentManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReportDownloadBegin(self: *const IPMDeploymentManager, productID: Guid) HRESULT {
        return self.vtable.ReportDownloadBegin(self, productID);
    }
    pub inline fn ReportDownloadProgress(self: *const IPMDeploymentManager, productID: Guid, usProgress: u16) HRESULT {
        return self.vtable.ReportDownloadProgress(self, productID, usProgress);
    }
    pub inline fn ReportDownloadComplete(self: *const IPMDeploymentManager, productID: Guid, hrResult: HRESULT) HRESULT {
        return self.vtable.ReportDownloadComplete(self, productID, hrResult);
    }
    pub inline fn BeginInstall(self: *const IPMDeploymentManager, pInstallInfo: ?*PM_INSTALLINFO) HRESULT {
        return self.vtable.BeginInstall(self, pInstallInfo);
    }
    pub inline fn BeginUpdate(self: *const IPMDeploymentManager, pUpdateInfo: ?*PM_UPDATEINFO) HRESULT {
        return self.vtable.BeginUpdate(self, pUpdateInfo);
    }
    pub inline fn BeginDeployPackage(self: *const IPMDeploymentManager, pInstallInfo: ?*PM_INSTALLINFO) HRESULT {
        return self.vtable.BeginDeployPackage(self, pInstallInfo);
    }
    pub inline fn BeginUpdateDeployedPackageLegacy(self: *const IPMDeploymentManager, pUpdateInfo: ?*PM_UPDATEINFO_LEGACY) HRESULT {
        return self.vtable.BeginUpdateDeployedPackageLegacy(self, pUpdateInfo);
    }
    pub inline fn BeginUninstall(self: *const IPMDeploymentManager, productID: Guid) HRESULT {
        return self.vtable.BeginUninstall(self, productID);
    }
    pub inline fn BeginEnterpriseAppInstall(self: *const IPMDeploymentManager, pInstallInfo: ?*PM_INSTALLINFO) HRESULT {
        return self.vtable.BeginEnterpriseAppInstall(self, pInstallInfo);
    }
    pub inline fn BeginEnterpriseAppUpdate(self: *const IPMDeploymentManager, pUpdateInfo: ?*PM_UPDATEINFO) HRESULT {
        return self.vtable.BeginEnterpriseAppUpdate(self, pUpdateInfo);
    }
    pub inline fn BeginUpdateLicense(self: *const IPMDeploymentManager, productID: Guid, offerID: Guid, pbLicense: [*:0]u8, cbLicense: u32) HRESULT {
        return self.vtable.BeginUpdateLicense(self, productID, offerID, pbLicense, cbLicense);
    }
    pub inline fn GetLicenseChallenge(self: *const IPMDeploymentManager, PackagePath: ?BSTR, ppbChallenge: [*]?*u8, pcbChallenge: ?*u32, ppbKID: ?[*]?*u8, pcbKID: ?*u32, ppbDeviceID: ?[*]?*u8, pcbDeviceID: ?*u32, ppbSaltValue: ?[*]?*u8, pcbSaltValue: ?*u32, ppbKGVValue: ?[*]?*u8, pcbKGVValue: ?*u32) HRESULT {
    ...
    pub inline fn GetLicenseChallengeByProductID(self: *const IPMDeploymentManager, ProductID: Guid, ppbChallenge: [*]?*u8, pcbLicense: ?*u32) HRESULT {
        return self.vtable.GetLicenseChallengeByProductID(self, ProductID, ppbChallenge, pcbLicense);
    }
    pub inline fn GetLicenseChallengeByProductID2(self: *const IPMDeploymentManager, ProductID: Guid, ppbChallenge: [*]?*u8, pcbLicense: ?*u32, ppbKID: ?[*]?*u8, pcbKID: ?*u32, ppbDeviceID: ?[*]?*u8, pcbDeviceID: ?*u32, ppbSaltValue: ?[*]?*u8, pcbSaltValue: ?*u32, ppbKGVValue: ?[*]?*u8, pcbKGVValue: ?*u32) HRESULT {
    ...
    pub inline fn RevokeLicense(self: *const IPMDeploymentManager, productID: Guid) HRESULT {
        return self.vtable.RevokeLicense(self, productID);
    }
    pub inline fn RebindMdilBinaries(self: *const IPMDeploymentManager, ProductID: Guid, FileNames: ?*SAFEARRAY) HRESULT {
        return self.vtable.RebindMdilBinaries(self, ProductID, FileNames);
    }
    pub inline fn RebindAllMdilBinaries(self: *const IPMDeploymentManager, ProductID: Guid, InstanceID: Guid) HRESULT {
        return self.vtable.RebindAllMdilBinaries(self, ProductID, InstanceID);
    }
    pub inline fn RegenerateXbf(self: *const IPMDeploymentManager, ProductID: Guid, AssemblyPaths: ?*SAFEARRAY) HRESULT {
        return self.vtable.RegenerateXbf(self, ProductID, AssemblyPaths);
    }
    pub inline fn GenerateXbfForCurrentLocale(self: *const IPMDeploymentManager, ProductID: Guid) HRESULT {
        return self.vtable.GenerateXbfForCurrentLocale(self, ProductID);
    }
    pub inline fn BeginProvision(self: *const IPMDeploymentManager, ProductID: Guid, XMLpath: ?BSTR) HRESULT {
        return self.vtable.BeginProvision(self, ProductID, XMLpath);
    }
    pub inline fn BeginDeprovision(self: *const IPMDeploymentManager, ProductID: Guid) HRESULT {
        return self.vtable.BeginDeprovision(self, ProductID);
    }
    pub inline fn ReindexSQLCEDatabases(self: *const IPMDeploymentManager, ProductID: Guid) HRESULT {
        return self.vtable.ReindexSQLCEDatabases(self, ProductID);
    }
    pub inline fn SetApplicationsNeedMaintenance(self: *const IPMDeploymentManager, RequiredMaintenanceOperations: u32, pcApplications: ?*u32) HRESULT {
        return self.vtable.SetApplicationsNeedMaintenance(self, RequiredMaintenanceOperations, pcApplications);
    }
    pub inline fn UpdateChamberProfile(self: *const IPMDeploymentManager, ProductID: Guid) HRESULT {
        return self.vtable.UpdateChamberProfile(self, ProductID);
    }
    pub inline fn EnterprisePolicyIsApplicationAllowed(self: *const IPMDeploymentManager, productId: Guid, publisherName: ?[*:0]const u16, pIsAllowed: ?*BOOL) HRESULT {
        return self.vtable.EnterprisePolicyIsApplicationAllowed(self, productId, publisherName, pIsAllowed);
    }
    pub inline fn BeginUpdateDeployedPackage(self: *const IPMDeploymentManager, pUpdateInfo: ?*PM_UPDATEINFO) HRESULT {
        return self.vtable.BeginUpdateDeployedPackage(self, pUpdateInfo);
    }
    pub inline fn ReportRestoreCancelled(self: *const IPMDeploymentManager, productID: Guid) HRESULT {
        return self.vtable.ReportRestoreCancelled(self, productID);
    }
    pub inline fn ResolveResourceString(self: *const IPMDeploymentManager, resourceString: ?[*:0]const u16, pResolvedResourceString: ?*?BSTR) HRESULT {
        return self.vtable.ResolveResourceString(self, resourceString, pResolvedResourceString);
    }
    pub inline fn UpdateCapabilitiesForModernApps(self: *const IPMDeploymentManager) HRESULT {
        return self.vtable.UpdateCapabilitiesForModernApps(self);
    }
    pub inline fn ReportDownloadStatusUpdate(self: *const IPMDeploymentManager, productId: Guid) HRESULT {
        return self.vtable.ReportDownloadStatusUpdate(self, productId);
    }
    pub inline fn BeginUninstallWithOptions(self: *const IPMDeploymentManager, productID: Guid, removalOptions: u32) HRESULT {
        return self.vtable.BeginUninstallWithOptions(self, productID, removalOptions);
    }
    pub inline fn BindDeferredMdilBinaries(self: *const IPMDeploymentManager) HRESULT {
        return self.vtable.BindDeferredMdilBinaries(self);
    }
    pub inline fn GenerateXamlLightupXbfForCurrentLocale(self: *const IPMDeploymentManager, PackageFamilyName: ?BSTR) HRESULT {
        return self.vtable.GenerateXamlLightupXbfForCurrentLocale(self, PackageFamilyName);
    }
    pub inline fn AddLicenseForAppx(self: *const IPMDeploymentManager, productID: Guid, pbLicense: [*:0]u8, cbLicense: u32, pbPlayReadyHeader: ?[*:0]u8, cbPlayReadyHeader: u32) HRESULT {
        return self.vtable.AddLicenseForAppx(self, productID, pbLicense, cbLicense, pbPlayReadyHeader, cbPlayReadyHeader);
    }
    pub inline fn FixJunctionsForAppsOnSDCard(self: *const IPMDeploymentManager) HRESULT {
...
pub const IPMEnumerationManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_AllApplications(self: *const IPMEnumerationManager, ppAppEnum: ?*?*IPMApplicationInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllApplications(self, ppAppEnum, Filter);
    }
    pub inline fn get_AllTiles(self: *const IPMEnumerationManager, ppTileEnum: ?*?*IPMTileInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllTiles(self, ppTileEnum, Filter);
    }
    pub inline fn get_AllTasks(self: *const IPMEnumerationManager, ppTaskEnum: ?*?*IPMTaskInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllTasks(self, ppTaskEnum, Filter);
    }
    pub inline fn get_AllExtensions(self: *const IPMEnumerationManager, ppExtensionEnum: ?*?*IPMExtensionInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllExtensions(self, ppExtensionEnum, Filter);
    }
    pub inline fn get_AllBackgroundServiceAgents(self: *const IPMEnumerationManager, ppBSAEnum: ?*?*IPMBackgroundServiceAgentInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllBackgroundServiceAgents(self, ppBSAEnum, Filter);
    }
    pub inline fn get_AllBackgroundWorkers(self: *const IPMEnumerationManager, ppBSWEnum: ?*?*IPMBackgroundWorkerInfoEnumerator, Filter: PM_ENUM_FILTER) HRESULT {
        return self.vtable.get_AllBackgroundWorkers(self, ppBSWEnum, Filter);
    }
    pub inline fn get_ApplicationInfo(self: *const IPMEnumerationManager, ProductID: Guid, ppAppInfo: ?*?*IPMApplicationInfo) HRESULT {
        return self.vtable.get_ApplicationInfo(self, ProductID, ppAppInfo);
    }
    pub inline fn get_TileInfo(self: *const IPMEnumerationManager, ProductID: Guid, TileID: ?BSTR, ppTileInfo: ?*?*IPMTileInfo) HRESULT {
        return self.vtable.get_TileInfo(self, ProductID, TileID, ppTileInfo);
    }
    pub inline fn get_TaskInfo(self: *const IPMEnumerationManager, ProductID: Guid, TaskID: ?BSTR, ppTaskInfo: ?*?*IPMTaskInfo) HRESULT {
        return self.vtable.get_TaskInfo(self, ProductID, TaskID, ppTaskInfo);
    }
    pub inline fn get_TaskInfoEx(self: *const IPMEnumerationManager, ProductID: Guid, TaskID: ?[*:0]const u16, ppTaskInfo: ?*?*IPMTaskInfo) HRESULT {
        return self.vtable.get_TaskInfoEx(self, ProductID, TaskID, ppTaskInfo);
    }
    pub inline fn get_BackgroundServiceAgentInfo(self: *const IPMEnumerationManager, BSAID: u32, ppTaskInfo: ?*?*IPMBackgroundServiceAgentInfo) HRESULT {
        return self.vtable.get_BackgroundServiceAgentInfo(self, BSAID, ppTaskInfo);
    }
    pub inline fn get_AllLiveTileJobs(self: *const IPMEnumerationManager, ppLiveTileJobEnum: ?*?*IPMLiveTileJobInfoEnumerator) HRESULT {
        return self.vtable.get_AllLiveTileJobs(self, ppLiveTileJobEnum);
    }
    pub inline fn get_LiveTileJob(self: *const IPMEnumerationManager, ProductID: Guid, TileID: ?BSTR, RecurrenceType: PM_LIVETILE_RECURRENCE_TYPE, ppLiveTileJobInfo: ?*?*IPMLiveTileJobInfo) HRESULT {
        return self.vtable.get_LiveTileJob(self, ProductID, TileID, RecurrenceType, ppLiveTileJobInfo);
    }
    pub inline fn get_ApplicationInfoExternal(self: *const IPMEnumerationManager, ProductID: Guid, ppAppInfo: ?*?*IPMApplicationInfo) HRESULT {
        return self.vtable.get_ApplicationInfoExternal(self, ProductID, ppAppInfo);
    }
    pub inline fn get_FileHandlerGenericLogo(self: *const IPMEnumerationManager, FileType: ?BSTR, LogoSize: PM_LOGO_SIZE, pLogo: ?*?BSTR) HRESULT {
        return self.vtable.get_FileHandlerGenericLogo(self, FileType, LogoSize, pLogo);
    }
    pub inline fn get_ApplicationInfoFromAccessClaims(self: *const IPMEnumerationManager, SysAppID0: ?BSTR, SysAppID1: ?BSTR, ppAppInfo: ?*?*IPMApplicationInfo) HRESULT {
        return self.vtable.get_ApplicationInfoFromAccessClaims(self, SysAppID0, SysAppID1, ppAppInfo);
    }
    pub inline fn get_StartTileEnumeratorBlob(self: *const IPMEnumerationManager, Filter: PM_ENUM_FILTER, pcTiles: ?*u32, ppTileBlobs: [*]?*PM_STARTTILEBLOB) HRESULT {
        return self.vtable.get_StartTileEnumeratorBlob(self, Filter, pcTiles, ppTileBlobs);
    }
    pub inline fn get_StartAppEnumeratorBlob(self: *const IPMEnumerationManager, Filter: PM_ENUM_FILTER, pcApps: ?*u32, ppAppBlobs: [*]?*PM_STARTAPPBLOB) HRESULT {
...
pub const IPMTaskInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMTaskInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_TaskID(self: *const IPMTaskInfo, pTaskID: ?*?BSTR) HRESULT {
        return self.vtable.get_TaskID(self, pTaskID);
    }
    pub inline fn get_NavigationPage(self: *const IPMTaskInfo, pNavigationPage: ?*?BSTR) HRESULT {
        return self.vtable.get_NavigationPage(self, pNavigationPage);
    }
    pub inline fn get_TaskTransition(self: *const IPMTaskInfo, pTaskTransition: ?*PM_TASK_TRANSITION) HRESULT {
        return self.vtable.get_TaskTransition(self, pTaskTransition);
    }
    pub inline fn get_RuntimeType(self: *const IPMTaskInfo, pRuntimetype: ?*PACKMAN_RUNTIME) HRESULT {
        return self.vtable.get_RuntimeType(self, pRuntimetype);
    }
    pub inline fn get_ActivationPolicy(self: *const IPMTaskInfo, pActivationPolicy: ?*PM_ACTIVATION_POLICY) HRESULT {
        return self.vtable.get_ActivationPolicy(self, pActivationPolicy);
    }
    pub inline fn get_TaskType(self: *const IPMTaskInfo, pTaskType: ?*PM_TASK_TYPE) HRESULT {
        return self.vtable.get_TaskType(self, pTaskType);
    }
    pub inline fn get_InvocationInfo(self: *const IPMTaskInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
    pub inline fn get_ImagePath(self: *const IPMTaskInfo, pImagePath: ?*?BSTR) HRESULT {
        return self.vtable.get_ImagePath(self, pImagePath);
    }
    pub inline fn get_ImageParams(self: *const IPMTaskInfo, pImageParams: ?*?BSTR) HRESULT {
        return self.vtable.get_ImageParams(self, pImageParams);
    }
    pub inline fn get_InstallRootFolder(self: *const IPMTaskInfo, pInstallRootFolder: ?*?BSTR) HRESULT {
        return self.vtable.get_InstallRootFolder(self, pInstallRootFolder);
    }
    pub inline fn get_DataRootFolder(self: *const IPMTaskInfo, pDataRootFolder: ?*?BSTR) HRESULT {
        return self.vtable.get_DataRootFolder(self, pDataRootFolder);
    }
    pub inline fn get_IsSingleInstanceHost(self: *const IPMTaskInfo, pIsSingleInstanceHost: ?*BOOL) HRESULT {
        return self.vtable.get_IsSingleInstanceHost(self, pIsSingleInstanceHost);
    }
    pub inline fn get_IsInteropEnabled(self: *const IPMTaskInfo, pIsInteropEnabled: ?*BOOL) HRESULT {
        return self.vtable.get_IsInteropEnabled(self, pIsInteropEnabled);
    }
    pub inline fn get_ApplicationState(self: *const IPMTaskInfo, pApplicationState: ?*PM_APPLICATION_STATE) HRESULT {
        return self.vtable.get_ApplicationState(self, pApplicationState);
    }
    pub inline fn get_InstallType(self: *const IPMTaskInfo, pInstallType: ?*PM_APPLICATION_INSTALL_TYPE) HRESULT {
        return self.vtable.get_InstallType(self, pInstallType);
    }
    pub inline fn get_Version(self: *const IPMTaskInfo, pTargetMajorVersion: ?*u8, pTargetMinorVersion: ?*u8) HRESULT {
        return self.vtable.get_Version(self, pTargetMajorVersion, pTargetMinorVersion);
    }
    pub inline fn get_BitsPerPixel(self: *const IPMTaskInfo, pBitsPerPixel: ?*u16) HRESULT {
        return self.vtable.get_BitsPerPixel(self, pBitsPerPixel);
    }
    pub inline fn get_SuppressesDehydration(self: *const IPMTaskInfo, pSuppressesDehydration: ?*BOOL) HRESULT {
        return self.vtable.get_SuppressesDehydration(self, pSuppressesDehydration);
    }
    pub inline fn get_BackgroundExecutionAbilities(self: *const IPMTaskInfo, pBackgroundExecutionAbilities: ?*?BSTR) HRESULT {
        return self.vtable.get_BackgroundExecutionAbilities(self, pBackgroundExecutionAbilities);
    }
    pub inline fn get_IsOptedForExtendedMem(self: *const IPMTaskInfo, pIsOptedIn: ?*BOOL) HRESULT {
...
pub const IPMTaskInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMTaskInfoEnumerator, ppTaskInfo: ?*?*IPMTaskInfo) HRESULT {
...
pub const IPMExtensionInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_SupplierPID(self: *const IPMExtensionInfo, pSupplierPID: ?*Guid) HRESULT {
        return self.vtable.get_SupplierPID(self, pSupplierPID);
    }
    pub inline fn get_SupplierTaskID(self: *const IPMExtensionInfo, pSupplierTID: ?*?BSTR) HRESULT {
        return self.vtable.get_SupplierTaskID(self, pSupplierTID);
    }
    pub inline fn get_Title(self: *const IPMExtensionInfo, pTitle: ?*?BSTR) HRESULT {
        return self.vtable.get_Title(self, pTitle);
    }
    pub inline fn get_IconPath(self: *const IPMExtensionInfo, pIconPath: ?*?BSTR) HRESULT {
        return self.vtable.get_IconPath(self, pIconPath);
    }
    pub inline fn get_ExtraFile(self: *const IPMExtensionInfo, pFilePath: ?*?BSTR) HRESULT {
        return self.vtable.get_ExtraFile(self, pFilePath);
    }
    pub inline fn get_InvocationInfo(self: *const IPMExtensionInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
};
...
pub const IPMExtensionFileExtensionInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IPMExtensionFileExtensionInfo, pName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pName);
    }
    pub inline fn get_DisplayName(self: *const IPMExtensionFileExtensionInfo, pDisplayName: ?*?BSTR) HRESULT {
        return self.vtable.get_DisplayName(self, pDisplayName);
    }
    pub inline fn get_Logo(self: *const IPMExtensionFileExtensionInfo, LogoSize: PM_LOGO_SIZE, pLogo: ?*?BSTR) HRESULT {
        return self.vtable.get_Logo(self, LogoSize, pLogo);
    }
    pub inline fn get_ContentType(self: *const IPMExtensionFileExtensionInfo, FileType: ?BSTR, pContentType: ?*?BSTR) HRESULT {
        return self.vtable.get_ContentType(self, FileType, pContentType);
    }
    pub inline fn get_FileType(self: *const IPMExtensionFileExtensionInfo, ContentType: ?BSTR, pFileType: ?*?BSTR) HRESULT {
        return self.vtable.get_FileType(self, ContentType, pFileType);
    }
    pub inline fn get_InvocationInfo(self: *const IPMExtensionFileExtensionInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
    pub inline fn get_AllFileTypes(self: *const IPMExtensionFileExtensionInfo, pcbTypes: ?*u32, ppTypes: [*]?*?BSTR) HRESULT {
...
pub const IPMExtensionProtocolInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Protocol(self: *const IPMExtensionProtocolInfo, pProtocol: ?*?BSTR) HRESULT {
        return self.vtable.get_Protocol(self, pProtocol);
    }
    pub inline fn get_InvocationInfo(self: *const IPMExtensionProtocolInfo, pImageUrn: ?*?BSTR, pParameters: ?*?BSTR) HRESULT {
        return self.vtable.get_InvocationInfo(self, pImageUrn, pParameters);
    }
};
...
pub const IPMExtensionShareTargetInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_AllFileTypes(self: *const IPMExtensionShareTargetInfo, pcTypes: ?*u32, ppTypes: [*]?*?BSTR) HRESULT {
        return self.vtable.get_AllFileTypes(self, pcTypes, ppTypes);
    }
    pub inline fn get_AllDataFormats(self: *const IPMExtensionShareTargetInfo, pcDataFormats: ?*u32, ppDataFormats: [*]?*?BSTR) HRESULT {
        return self.vtable.get_AllDataFormats(self, pcDataFormats, ppDataFormats);
    }
    pub inline fn get_SupportsAllFileTypes(self: *const IPMExtensionShareTargetInfo, pSupportsAllTypes: ?*BOOL) HRESULT {
...
pub const IPMExtensionContractInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_InvocationInfo(self: *const IPMExtensionContractInfo, pAUMID: ?*?BSTR, pArgs: ?*?BSTR) HRESULT {
...
pub const IPMExtensionFileOpenPickerInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_AllFileTypes(self: *const IPMExtensionFileOpenPickerInfo, pcTypes: ?*u32, ppTypes: [*]?*?BSTR) HRESULT {
        return self.vtable.get_AllFileTypes(self, pcTypes, ppTypes);
    }
    pub inline fn get_SupportsAllFileTypes(self: *const IPMExtensionFileOpenPickerInfo, pSupportsAllTypes: ?*BOOL) HRESULT {
        return self.vtable.get_SupportsAllFileTypes(self, pSupportsAllTypes);
    }
};
...
pub const IPMExtensionFileSavePickerInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_AllFileTypes(self: *const IPMExtensionFileSavePickerInfo, pcTypes: ?*u32, ppTypes: [*]?*?BSTR) HRESULT {
        return self.vtable.get_AllFileTypes(self, pcTypes, ppTypes);
    }
    pub inline fn get_SupportsAllFileTypes(self: *const IPMExtensionFileSavePickerInfo, pSupportsAllTypes: ?*BOOL) HRESULT {
        return self.vtable.get_SupportsAllFileTypes(self, pSupportsAllTypes);
    }
};
...
pub const IPMExtensionCachedFileUpdaterInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_SupportsUpdates(self: *const IPMExtensionCachedFileUpdaterInfo, pSupportsUpdates: ?*BOOL) HRESULT {
...
pub const IPMExtensionInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMExtensionInfoEnumerator, ppExtensionInfo: ?*?*IPMExtensionInfo) HRESULT {
...
pub const IPMBackgroundServiceAgentInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMBackgroundServiceAgentInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_TaskID(self: *const IPMBackgroundServiceAgentInfo, pTaskID: ?*?BSTR) HRESULT {
        return self.vtable.get_TaskID(self, pTaskID);
    }
    pub inline fn get_BSAID(self: *const IPMBackgroundServiceAgentInfo, pBSAID: ?*u32) HRESULT {
        return self.vtable.get_BSAID(self, pBSAID);
    }
    pub inline fn get_BGSpecifier(self: *const IPMBackgroundServiceAgentInfo, pBGSpecifier: ?*?BSTR) HRESULT {
        return self.vtable.get_BGSpecifier(self, pBGSpecifier);
    }
    pub inline fn get_BGName(self: *const IPMBackgroundServiceAgentInfo, pBGName: ?*?BSTR) HRESULT {
        return self.vtable.get_BGName(self, pBGName);
    }
    pub inline fn get_BGSource(self: *const IPMBackgroundServiceAgentInfo, pBGSource: ?*?BSTR) HRESULT {
        return self.vtable.get_BGSource(self, pBGSource);
    }
    pub inline fn get_BGType(self: *const IPMBackgroundServiceAgentInfo, pBGType: ?*?BSTR) HRESULT {
        return self.vtable.get_BGType(self, pBGType);
    }
    pub inline fn get_IsPeriodic(self: *const IPMBackgroundServiceAgentInfo, pIsPeriodic: ?*BOOL) HRESULT {
        return self.vtable.get_IsPeriodic(self, pIsPeriodic);
    }
    pub inline fn get_IsScheduled(self: *const IPMBackgroundServiceAgentInfo, pIsScheduled: ?*BOOL) HRESULT {
        return self.vtable.get_IsScheduled(self, pIsScheduled);
    }
    pub inline fn get_IsScheduleAllowed(self: *const IPMBackgroundServiceAgentInfo, pIsScheduleAllowed: ?*BOOL) HRESULT {
        return self.vtable.get_IsScheduleAllowed(self, pIsScheduleAllowed);
    }
    pub inline fn get_Description(self: *const IPMBackgroundServiceAgentInfo, pDescription: ?*?BSTR) HRESULT {
        return self.vtable.get_Description(self, pDescription);
    }
    pub inline fn get_IsLaunchOnBoot(self: *const IPMBackgroundServiceAgentInfo, pLaunchOnBoot: ?*BOOL) HRESULT {
        return self.vtable.get_IsLaunchOnBoot(self, pLaunchOnBoot);
    }
    pub inline fn set_IsScheduled(self: *const IPMBackgroundServiceAgentInfo, IsScheduled: BOOL) HRESULT {
        return self.vtable.set_IsScheduled(self, IsScheduled);
    }
    pub inline fn set_IsScheduleAllowed(self: *const IPMBackgroundServiceAgentInfo, IsScheduleAllowed: BOOL) HRESULT {
...
pub const IPMBackgroundWorkerInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ProductID(self: *const IPMBackgroundWorkerInfo, pProductID: ?*Guid) HRESULT {
        return self.vtable.get_ProductID(self, pProductID);
    }
    pub inline fn get_TaskID(self: *const IPMBackgroundWorkerInfo, pTaskID: ?*?BSTR) HRESULT {
        return self.vtable.get_TaskID(self, pTaskID);
    }
    pub inline fn get_BGName(self: *const IPMBackgroundWorkerInfo, pBGName: ?*?BSTR) HRESULT {
        return self.vtable.get_BGName(self, pBGName);
    }
    pub inline fn get_MaxStartupLatency(self: *const IPMBackgroundWorkerInfo, pMaxStartupLatency: ?*u32) HRESULT {
        return self.vtable.get_MaxStartupLatency(self, pMaxStartupLatency);
    }
    pub inline fn get_ExpectedRuntime(self: *const IPMBackgroundWorkerInfo, pExpectedRuntime: ?*u32) HRESULT {
        return self.vtable.get_ExpectedRuntime(self, pExpectedRuntime);
    }
    pub inline fn get_IsBootWorker(self: *const IPMBackgroundWorkerInfo, pIsBootWorker: ?*BOOL) HRESULT {
...
pub const IPMBackgroundServiceAgentInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMBackgroundServiceAgentInfoEnumerator, ppBSAInfo: ?*?*IPMBackgroundServiceAgentInfo) HRESULT {
...
pub const IPMBackgroundWorkerInfoEnumerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Next(self: *const IPMBackgroundWorkerInfoEnumerator, ppBWInfo: ?*?*IPMBackgroundWorkerInfo) HRESULT {
...
// TODO: this type is limited to platform 'windows8.0'
pub extern "msi" fn MsiCloseAllHandles() callconv(.winapi) u32;
...
// TODO: this type is limited to platform 'windows8.0'
pub extern "msi" fn MsiGetLastErrorRecord() callconv(.winapi) MSIHANDLE;
