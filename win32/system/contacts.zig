...
pub const IContactManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IContactManager, pszAppName: ?[*:0]const u16, pszAppVersion: ?[*:0]const u16) HRESULT {
        return self.vtable.Initialize(self, pszAppName, pszAppVersion);
    }
    pub inline fn Load(self: *const IContactManager, pszContactID: ?[*:0]const u16, ppContact: ?*?*IContact) HRESULT {
        return self.vtable.Load(self, pszContactID, ppContact);
    }
    pub inline fn MergeContactIDs(self: *const IContactManager, pszNewContactID: ?[*:0]const u16, pszOldContactID: ?[*:0]const u16) HRESULT {
        return self.vtable.MergeContactIDs(self, pszNewContactID, pszOldContactID);
    }
    pub inline fn GetMeContact(self: *const IContactManager, ppMeContact: ?*?*IContact) HRESULT {
        return self.vtable.GetMeContact(self, ppMeContact);
    }
    pub inline fn SetMeContact(self: *const IContactManager, pMeContact: ?*IContact) HRESULT {
        return self.vtable.SetMeContact(self, pMeContact);
    }
    pub inline fn GetContactCollection(self: *const IContactManager, ppContactCollection: ?*?*IContactCollection) HRESULT {
...
pub const IContactCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IContactCollection) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IContactCollection) HRESULT {
        return self.vtable.Next(self);
    }
    pub inline fn GetCurrent(self: *const IContactCollection, ppContact: ?*?*IContact) HRESULT {
...
pub const IContactProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetString(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, pszValue: [*:0]u16, cchValue: u32, pdwcchPropertyValueRequired: ?*u32) HRESULT {
        return self.vtable.GetString(self, pszPropertyName, dwFlags, pszValue, cchValue, pdwcchPropertyValueRequired);
    }
    pub inline fn GetDate(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, pftDateTime: ?*FILETIME) HRESULT {
        return self.vtable.GetDate(self, pszPropertyName, dwFlags, pftDateTime);
    }
    pub inline fn GetBinary(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, pszContentType: [*:0]u16, cchContentType: u32, pdwcchContentTypeRequired: ?*u32, ppStream: ?*?*IStream) HRESULT {
    ...
    pub inline fn GetLabels(self: *const IContactProperties, pszArrayElementName: ?[*:0]const u16, dwFlags: u32, pszLabels: [*:0]u16, cchLabels: u32, pdwcchLabelsRequired: ?*u32) HRESULT {
        return self.vtable.GetLabels(self, pszArrayElementName, dwFlags, pszLabels, cchLabels, pdwcchLabelsRequired);
    }
    pub inline fn SetString(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, pszValue: ?[*:0]const u16) HRESULT {
        return self.vtable.SetString(self, pszPropertyName, dwFlags, pszValue);
    }
    pub inline fn SetDate(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, ftDateTime: FILETIME) HRESULT {
        return self.vtable.SetDate(self, pszPropertyName, dwFlags, ftDateTime);
    }
    pub inline fn SetBinary(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32, pszContentType: ?[*:0]const u16, pStream: ?*IStream) HRESULT {
        return self.vtable.SetBinary(self, pszPropertyName, dwFlags, pszContentType, pStream);
    }
    pub inline fn SetLabels(self: *const IContactProperties, pszArrayElementName: ?[*:0]const u16, dwFlags: u32, dwLabelCount: u32, ppszLabels: [*]?PWSTR) HRESULT {
        return self.vtable.SetLabels(self, pszArrayElementName, dwFlags, dwLabelCount, ppszLabels);
    }
    pub inline fn CreateArrayNode(self: *const IContactProperties, pszArrayName: ?[*:0]const u16, dwFlags: u32, fAppend: BOOL, pszNewArrayElementName: [*:0]u16, cchNewArrayElementName: u32, pdwcchNewArrayElementNameRequired: ?*u32) HRESULT {
    ...
    pub inline fn DeleteProperty(self: *const IContactProperties, pszPropertyName: ?[*:0]const u16, dwFlags: u32) HRESULT {
        return self.vtable.DeleteProperty(self, pszPropertyName, dwFlags);
    }
    pub inline fn DeleteArrayNode(self: *const IContactProperties, pszArrayElementName: ?[*:0]const u16, dwFlags: u32) HRESULT {
        return self.vtable.DeleteArrayNode(self, pszArrayElementName, dwFlags);
    }
    pub inline fn DeleteLabels(self: *const IContactProperties, pszArrayElementName: ?[*:0]const u16, dwFlags: u32) HRESULT {
        return self.vtable.DeleteLabels(self, pszArrayElementName, dwFlags);
    }
    pub inline fn GetPropertyCollection(self: *const IContactProperties, ppPropertyCollection: ?*?*IContactPropertyCollection, dwFlags: u32, pszMultiValueName: ?[*:0]const u16, dwLabelCount: u32, ppszLabels: [*]?PWSTR, fAnyLabelMatches: BOOL) HRESULT {
...
pub const IContact = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetContactID(self: *const IContact, pszContactID: [*:0]u16, cchContactID: u32, pdwcchContactIDRequired: ?*u32) HRESULT {
        return self.vtable.GetContactID(self, pszContactID, cchContactID, pdwcchContactIDRequired);
    }
    pub inline fn GetPath(self: *const IContact, pszPath: [*:0]u16, cchPath: u32, pdwcchPathRequired: ?*u32) HRESULT {
        return self.vtable.GetPath(self, pszPath, cchPath, pdwcchPathRequired);
    }
    pub inline fn CommitChanges(self: *const IContact, dwCommitFlags: u32) HRESULT {
...
pub const IContactPropertyCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IContactPropertyCollection) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IContactPropertyCollection) HRESULT {
        return self.vtable.Next(self);
    }
    pub inline fn GetPropertyName(self: *const IContactPropertyCollection, pszPropertyName: [*:0]u16, cchPropertyName: u32, pdwcchPropertyNameRequired: ?*u32) HRESULT {
        return self.vtable.GetPropertyName(self, pszPropertyName, cchPropertyName, pdwcchPropertyNameRequired);
    }
    pub inline fn GetPropertyType(self: *const IContactPropertyCollection, pdwType: ?*u32) HRESULT {
        return self.vtable.GetPropertyType(self, pdwType);
    }
    pub inline fn GetPropertyVersion(self: *const IContactPropertyCollection, pdwVersion: ?*u32) HRESULT {
        return self.vtable.GetPropertyVersion(self, pdwVersion);
    }
    pub inline fn GetPropertyModificationDate(self: *const IContactPropertyCollection, pftModificationDate: ?*FILETIME) HRESULT {
        return self.vtable.GetPropertyModificationDate(self, pftModificationDate);
    }
    pub inline fn GetPropertyArrayElementID(self: *const IContactPropertyCollection, pszArrayElementID: [*:0]u16, cchArrayElementID: u32, pdwcchArrayElementIDRequired: ?*u32) HRESULT {
...
pub const IContactAggregationManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetVersionInfo(self: *const IContactAggregationManager, plMajorVersion: ?*i32, plMinorVersion: ?*i32) HRESULT {
        return self.vtable.GetVersionInfo(self, plMajorVersion, plMinorVersion);
    }
    pub inline fn CreateOrOpenGroup(self: *const IContactAggregationManager, pGroupName: ?[*:0]const u16, options: CONTACT_AGGREGATION_CREATE_OR_OPEN_OPTIONS, pCreatedGroup: ?*BOOL, ppGroup: ?*?*IContactAggregationGroup) HRESULT {
        return self.vtable.CreateOrOpenGroup(self, pGroupName, options, pCreatedGroup, ppGroup);
    }
    pub inline fn CreateExternalContact(self: *const IContactAggregationManager, ppItem: ?*?*IContactAggregationContact) HRESULT {
        return self.vtable.CreateExternalContact(self, ppItem);
    }
    pub inline fn CreateServerPerson(self: *const IContactAggregationManager, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.CreateServerPerson(self, ppServerPerson);
    }
    pub inline fn CreateServerContactLink(self: *const IContactAggregationManager, ppServerContactLink: ?*?*IContactAggregationLink) HRESULT {
        return self.vtable.CreateServerContactLink(self, ppServerContactLink);
    }
    pub inline fn Flush(self: *const IContactAggregationManager) HRESULT {
        return self.vtable.Flush(self);
    }
    pub inline fn OpenAggregateContact(self: *const IContactAggregationManager, pItemId: ?[*:0]const u16, ppItem: ?*?*IContactAggregationAggregate) HRESULT {
        return self.vtable.OpenAggregateContact(self, pItemId, ppItem);
    }
    pub inline fn OpenContact(self: *const IContactAggregationManager, pItemId: ?[*:0]const u16, ppItem: ?*?*IContactAggregationContact) HRESULT {
        return self.vtable.OpenContact(self, pItemId, ppItem);
    }
    pub inline fn OpenServerContactLink(self: *const IContactAggregationManager, pItemId: ?[*:0]const u16, ppItem: ?*?*IContactAggregationLink) HRESULT {
        return self.vtable.OpenServerContactLink(self, pItemId, ppItem);
    }
    pub inline fn OpenServerPerson(self: *const IContactAggregationManager, pItemId: ?[*:0]const u16, ppItem: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.OpenServerPerson(self, pItemId, ppItem);
    }
    pub inline fn get_Contacts(self: *const IContactAggregationManager, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS, ppItems: ?*?*IContactAggregationContactCollection) HRESULT {
        return self.vtable.get_Contacts(self, options, ppItems);
    }
    pub inline fn get_AggregateContacts(self: *const IContactAggregationManager, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS, ppAggregates: ?*?*IContactAggregationAggregateCollection) HRESULT {
        return self.vtable.get_AggregateContacts(self, options, ppAggregates);
    }
    pub inline fn get_Groups(self: *const IContactAggregationManager, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS, ppGroups: ?*?*IContactAggregationGroupCollection) HRESULT {
        return self.vtable.get_Groups(self, options, ppGroups);
    }
    pub inline fn get_ServerPersons(self: *const IContactAggregationManager, ppServerPersonCollection: ?*?*IContactAggregationServerPersonCollection) HRESULT {
        return self.vtable.get_ServerPersons(self, ppServerPersonCollection);
    }
    pub inline fn get_ServerContactLinks(self: *const IContactAggregationManager, pPersonItemId: ?[*:0]const u16, ppServerContactLinkCollection: ?*?*IContactAggregationLinkCollection) HRESULT {
...
pub const IContactAggregationContact = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Delete(self: *const IContactAggregationContact) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Save(self: *const IContactAggregationContact) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn MoveToAggregate(self: *const IContactAggregationContact, pAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.MoveToAggregate(self, pAggregateId);
    }
    pub inline fn Unlink(self: *const IContactAggregationContact) HRESULT {
        return self.vtable.Unlink(self);
    }
    pub inline fn get_AccountId(self: *const IContactAggregationContact, ppAccountId: ?*?PWSTR) HRESULT {
        return self.vtable.get_AccountId(self, ppAccountId);
    }
    pub inline fn put_AccountId(self: *const IContactAggregationContact, pAccountId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AccountId(self, pAccountId);
    }
    pub inline fn get_AggregateId(self: *const IContactAggregationContact, ppAggregateId: ?*?PWSTR) HRESULT {
        return self.vtable.get_AggregateId(self, ppAggregateId);
    }
    pub inline fn get_Id(self: *const IContactAggregationContact, ppItemId: ?*?PWSTR) HRESULT {
        return self.vtable.get_Id(self, ppItemId);
    }
    pub inline fn get_IsMe(self: *const IContactAggregationContact, pIsMe: ?*BOOL) HRESULT {
        return self.vtable.get_IsMe(self, pIsMe);
    }
    pub inline fn get_IsExternal(self: *const IContactAggregationContact, pIsExternal: ?*BOOL) HRESULT {
        return self.vtable.get_IsExternal(self, pIsExternal);
    }
    pub inline fn get_NetworkSourceId(self: *const IContactAggregationContact, pNetworkSourceId: ?*u32) HRESULT {
        return self.vtable.get_NetworkSourceId(self, pNetworkSourceId);
    }
    pub inline fn put_NetworkSourceId(self: *const IContactAggregationContact, networkSourceId: u32) HRESULT {
        return self.vtable.put_NetworkSourceId(self, networkSourceId);
    }
    pub inline fn get_NetworkSourceIdString(self: *const IContactAggregationContact, ppNetworkSourceId: ?*?PWSTR) HRESULT {
        return self.vtable.get_NetworkSourceIdString(self, ppNetworkSourceId);
    }
    pub inline fn put_NetworkSourceIdString(self: *const IContactAggregationContact, pNetworkSourceId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_NetworkSourceIdString(self, pNetworkSourceId);
    }
    pub inline fn get_RemoteObjectId(self: *const IContactAggregationContact, ppRemoteObjectId: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_RemoteObjectId(self, ppRemoteObjectId);
    }
    pub inline fn put_RemoteObjectId(self: *const IContactAggregationContact, pRemoteObjectId: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.put_RemoteObjectId(self, pRemoteObjectId);
    }
    pub inline fn get_SyncIdentityHash(self: *const IContactAggregationContact, ppSyncIdentityHash: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_SyncIdentityHash(self, ppSyncIdentityHash);
    }
    pub inline fn put_SyncIdentityHash(self: *const IContactAggregationContact, pSyncIdentityHash: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
...
pub const IContactAggregationContactCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindFirst(self: *const IContactAggregationContactCollection, ppItem: ?*?*IContactAggregationContact) HRESULT {
        return self.vtable.FindFirst(self, ppItem);
    }
    pub inline fn FindNext(self: *const IContactAggregationContactCollection, ppItem: ?*?*IContactAggregationContact) HRESULT {
        return self.vtable.FindNext(self, ppItem);
    }
    pub inline fn FindFirstByIdentityHash(self: *const IContactAggregationContactCollection, pSourceType: ?[*:0]const u16, pAccountId: ?[*:0]const u16, pIdentityHash: ?*const CONTACT_AGGREGATION_BLOB, ppItem: ?*?*IContactAggregationContact) HRESULT {
        return self.vtable.FindFirstByIdentityHash(self, pSourceType, pAccountId, pIdentityHash, ppItem);
    }
    pub inline fn get_Count(self: *const IContactAggregationContactCollection, pCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
    pub inline fn FindFirstByRemoteId(self: *const IContactAggregationContactCollection, pSourceType: ?[*:0]const u16, pAccountId: ?[*:0]const u16, pRemoteObjectId: ?*const CONTACT_AGGREGATION_BLOB, ppItem: ?*?*IContactAggregationContact) HRESULT {
...
pub const IContactAggregationAggregate = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Save(self: *const IContactAggregationAggregate) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn GetComponentItems(self: *const IContactAggregationAggregate, pComponentItems: ?*?*IContactAggregationContactCollection) HRESULT {
        return self.vtable.GetComponentItems(self, pComponentItems);
    }
    pub inline fn Link(self: *const IContactAggregationAggregate, pAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.Link(self, pAggregateId);
    }
    pub inline fn get_Groups(self: *const IContactAggregationAggregate, options: CONTACT_AGGREGATION_COLLECTION_OPTIONS, ppGroups: ?*?*IContactAggregationGroupCollection) HRESULT {
        return self.vtable.get_Groups(self, options, ppGroups);
    }
    pub inline fn get_AntiLink(self: *const IContactAggregationAggregate, ppAntiLink: ?*?PWSTR) HRESULT {
        return self.vtable.get_AntiLink(self, ppAntiLink);
    }
    pub inline fn put_AntiLink(self: *const IContactAggregationAggregate, pAntiLink: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AntiLink(self, pAntiLink);
    }
    pub inline fn get_FavoriteOrder(self: *const IContactAggregationAggregate, pFavoriteOrder: ?*u32) HRESULT {
        return self.vtable.get_FavoriteOrder(self, pFavoriteOrder);
    }
    pub inline fn put_FavoriteOrder(self: *const IContactAggregationAggregate, favoriteOrder: u32) HRESULT {
        return self.vtable.put_FavoriteOrder(self, favoriteOrder);
    }
    pub inline fn get_Id(self: *const IContactAggregationAggregate, ppItemId: ?*?PWSTR) HRESULT {
        return self.vtable.get_Id(self, ppItemId);
    }
};
...
pub const IContactAggregationAggregateCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindFirst(self: *const IContactAggregationAggregateCollection, ppAggregate: ?*?*IContactAggregationAggregate) HRESULT {
        return self.vtable.FindFirst(self, ppAggregate);
    }
    pub inline fn FindFirstByAntiLinkId(self: *const IContactAggregationAggregateCollection, pAntiLinkId: ?[*:0]const u16, ppAggregate: ?*?*IContactAggregationAggregate) HRESULT {
        return self.vtable.FindFirstByAntiLinkId(self, pAntiLinkId, ppAggregate);
    }
    pub inline fn FindNext(self: *const IContactAggregationAggregateCollection, ppAggregate: ?*?*IContactAggregationAggregate) HRESULT {
        return self.vtable.FindNext(self, ppAggregate);
    }
    pub inline fn get_Count(self: *const IContactAggregationAggregateCollection, pCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
};
...
pub const IContactAggregationGroup = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Delete(self: *const IContactAggregationGroup) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Save(self: *const IContactAggregationGroup) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn Add(self: *const IContactAggregationGroup, pAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.Add(self, pAggregateId);
    }
    pub inline fn Remove(self: *const IContactAggregationGroup, pAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.Remove(self, pAggregateId);
    }
    pub inline fn get_Members(self: *const IContactAggregationGroup, ppAggregateContactCollection: ?*?*IContactAggregationAggregateCollection) HRESULT {
        return self.vtable.get_Members(self, ppAggregateContactCollection);
    }
    pub inline fn get_GlobalObjectId(self: *const IContactAggregationGroup, pGlobalObjectId: ?*Guid) HRESULT {
        return self.vtable.get_GlobalObjectId(self, pGlobalObjectId);
    }
    pub inline fn put_GlobalObjectId(self: *const IContactAggregationGroup, pGlobalObjectId: ?*const Guid) HRESULT {
        return self.vtable.put_GlobalObjectId(self, pGlobalObjectId);
    }
    pub inline fn get_Id(self: *const IContactAggregationGroup, ppItemId: ?*?PWSTR) HRESULT {
        return self.vtable.get_Id(self, ppItemId);
    }
    pub inline fn get_Name(self: *const IContactAggregationGroup, ppName: ?*?PWSTR) HRESULT {
        return self.vtable.get_Name(self, ppName);
    }
    pub inline fn put_Name(self: *const IContactAggregationGroup, pName: ?[*:0]const u16) HRESULT {
...
pub const IContactAggregationGroupCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindFirst(self: *const IContactAggregationGroupCollection, ppGroup: ?*?*IContactAggregationGroup) HRESULT {
        return self.vtable.FindFirst(self, ppGroup);
    }
    pub inline fn FindFirstByGlobalObjectId(self: *const IContactAggregationGroupCollection, pGlobalObjectId: ?*const Guid, ppGroup: ?*?*IContactAggregationGroup) HRESULT {
        return self.vtable.FindFirstByGlobalObjectId(self, pGlobalObjectId, ppGroup);
    }
    pub inline fn FindNext(self: *const IContactAggregationGroupCollection, ppGroup: ?*?*IContactAggregationGroup) HRESULT {
        return self.vtable.FindNext(self, ppGroup);
    }
    pub inline fn get_Count(self: *const IContactAggregationGroupCollection, pCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
};
...
pub const IContactAggregationLink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Delete(self: *const IContactAggregationLink) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Save(self: *const IContactAggregationLink) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn get_AccountId(self: *const IContactAggregationLink, ppAccountId: ?*?PWSTR) HRESULT {
        return self.vtable.get_AccountId(self, ppAccountId);
    }
    pub inline fn put_AccountId(self: *const IContactAggregationLink, pAccountId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AccountId(self, pAccountId);
    }
    pub inline fn get_Id(self: *const IContactAggregationLink, ppItemId: ?*?PWSTR) HRESULT {
        return self.vtable.get_Id(self, ppItemId);
    }
    pub inline fn get_IsLinkResolved(self: *const IContactAggregationLink, pIsLinkResolved: ?*BOOL) HRESULT {
        return self.vtable.get_IsLinkResolved(self, pIsLinkResolved);
    }
    pub inline fn put_IsLinkResolved(self: *const IContactAggregationLink, isLinkResolved: BOOL) HRESULT {
        return self.vtable.put_IsLinkResolved(self, isLinkResolved);
    }
    pub inline fn get_NetworkSourceIdString(self: *const IContactAggregationLink, ppNetworkSourceId: ?*?PWSTR) HRESULT {
        return self.vtable.get_NetworkSourceIdString(self, ppNetworkSourceId);
    }
    pub inline fn put_NetworkSourceIdString(self: *const IContactAggregationLink, pNetworkSourceId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_NetworkSourceIdString(self, pNetworkSourceId);
    }
    pub inline fn get_RemoteObjectId(self: *const IContactAggregationLink, ppRemoteObjectId: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_RemoteObjectId(self, ppRemoteObjectId);
    }
    pub inline fn put_RemoteObjectId(self: *const IContactAggregationLink, pRemoteObjectId: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.put_RemoteObjectId(self, pRemoteObjectId);
    }
    pub inline fn get_ServerPerson(self: *const IContactAggregationLink, ppServerPersonId: ?*?PWSTR) HRESULT {
        return self.vtable.get_ServerPerson(self, ppServerPersonId);
    }
    pub inline fn put_ServerPerson(self: *const IContactAggregationLink, pServerPersonId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_ServerPerson(self, pServerPersonId);
    }
    pub inline fn get_ServerPersonBaseline(self: *const IContactAggregationLink, ppServerPersonId: ?*?PWSTR) HRESULT {
        return self.vtable.get_ServerPersonBaseline(self, ppServerPersonId);
    }
    pub inline fn put_ServerPersonBaseline(self: *const IContactAggregationLink, pServerPersonId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_ServerPersonBaseline(self, pServerPersonId);
    }
    pub inline fn get_SyncIdentityHash(self: *const IContactAggregationLink, ppSyncIdentityHash: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_SyncIdentityHash(self, ppSyncIdentityHash);
    }
    pub inline fn put_SyncIdentityHash(self: *const IContactAggregationLink, pSyncIdentityHash: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.put_SyncIdentityHash(self, pSyncIdentityHash);
    }
};
...
pub const IContactAggregationLinkCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindFirst(self: *const IContactAggregationLinkCollection, ppServerContactLink: ?*?*IContactAggregationLink) HRESULT {
        return self.vtable.FindFirst(self, ppServerContactLink);
    }
    pub inline fn FindFirstByRemoteId(self: *const IContactAggregationLinkCollection, pSourceType: ?[*:0]const u16, pAccountId: ?[*:0]const u16, pRemoteId: ?*const CONTACT_AGGREGATION_BLOB, ppServerContactLink: ?*?*IContactAggregationLink) HRESULT {
        return self.vtable.FindFirstByRemoteId(self, pSourceType, pAccountId, pRemoteId, ppServerContactLink);
    }
    pub inline fn FindNext(self: *const IContactAggregationLinkCollection, ppServerContactLink: ?*?*IContactAggregationLink) HRESULT {
        return self.vtable.FindNext(self, ppServerContactLink);
    }
    pub inline fn get_Count(self: *const IContactAggregationLinkCollection, pCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
};
...
pub const IContactAggregationServerPerson = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Delete(self: *const IContactAggregationServerPerson) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Save(self: *const IContactAggregationServerPerson) HRESULT {
        return self.vtable.Save(self);
    }
    pub inline fn get_AggregateId(self: *const IContactAggregationServerPerson, ppAggregateId: ?*?PWSTR) HRESULT {
        return self.vtable.get_AggregateId(self, ppAggregateId);
    }
    pub inline fn put_AggregateId(self: *const IContactAggregationServerPerson, pAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AggregateId(self, pAggregateId);
    }
    pub inline fn get_AntiLink(self: *const IContactAggregationServerPerson, ppAntiLink: ?*?PWSTR) HRESULT {
        return self.vtable.get_AntiLink(self, ppAntiLink);
    }
    pub inline fn put_AntiLink(self: *const IContactAggregationServerPerson, pAntiLink: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AntiLink(self, pAntiLink);
    }
    pub inline fn get_AntiLinkBaseline(self: *const IContactAggregationServerPerson, ppAntiLink: ?*?PWSTR) HRESULT {
        return self.vtable.get_AntiLinkBaseline(self, ppAntiLink);
    }
    pub inline fn put_AntiLinkBaseline(self: *const IContactAggregationServerPerson, pAntiLink: ?[*:0]const u16) HRESULT {
        return self.vtable.put_AntiLinkBaseline(self, pAntiLink);
    }
    pub inline fn get_FavoriteOrder(self: *const IContactAggregationServerPerson, pFavoriteOrder: ?*u32) HRESULT {
        return self.vtable.get_FavoriteOrder(self, pFavoriteOrder);
    }
    pub inline fn put_FavoriteOrder(self: *const IContactAggregationServerPerson, favoriteOrder: u32) HRESULT {
        return self.vtable.put_FavoriteOrder(self, favoriteOrder);
    }
    pub inline fn get_FavoriteOrderBaseline(self: *const IContactAggregationServerPerson, pFavoriteOrder: ?*u32) HRESULT {
        return self.vtable.get_FavoriteOrderBaseline(self, pFavoriteOrder);
    }
    pub inline fn put_FavoriteOrderBaseline(self: *const IContactAggregationServerPerson, favoriteOrder: u32) HRESULT {
        return self.vtable.put_FavoriteOrderBaseline(self, favoriteOrder);
    }
    pub inline fn get_Groups(self: *const IContactAggregationServerPerson, pGroups: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_Groups(self, pGroups);
    }
    pub inline fn put_Groups(self: *const IContactAggregationServerPerson, pGroups: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.put_Groups(self, pGroups);
    }
    pub inline fn get_GroupsBaseline(self: *const IContactAggregationServerPerson, ppGroups: ?*?*CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.get_GroupsBaseline(self, ppGroups);
    }
    pub inline fn put_GroupsBaseline(self: *const IContactAggregationServerPerson, pGroups: ?*const CONTACT_AGGREGATION_BLOB) HRESULT {
        return self.vtable.put_GroupsBaseline(self, pGroups);
    }
    pub inline fn get_Id(self: *const IContactAggregationServerPerson, ppId: ?*?PWSTR) HRESULT {
        return self.vtable.get_Id(self, ppId);
    }
    pub inline fn get_IsTombstone(self: *const IContactAggregationServerPerson, pIsTombstone: ?*BOOL) HRESULT {
        return self.vtable.get_IsTombstone(self, pIsTombstone);
    }
    pub inline fn put_IsTombstone(self: *const IContactAggregationServerPerson, isTombstone: BOOL) HRESULT {
        return self.vtable.put_IsTombstone(self, isTombstone);
    }
    pub inline fn get_LinkedAggregateId(self: *const IContactAggregationServerPerson, ppLinkedAggregateId: ?*?PWSTR) HRESULT {
        return self.vtable.get_LinkedAggregateId(self, ppLinkedAggregateId);
    }
    pub inline fn put_LinkedAggregateId(self: *const IContactAggregationServerPerson, pLinkedAggregateId: ?[*:0]const u16) HRESULT {
        return self.vtable.put_LinkedAggregateId(self, pLinkedAggregateId);
    }
    pub inline fn get_ObjectId(self: *const IContactAggregationServerPerson, ppObjectId: ?*?PWSTR) HRESULT {
        return self.vtable.get_ObjectId(self, ppObjectId);
    }
    pub inline fn put_ObjectId(self: *const IContactAggregationServerPerson, pObjectId: ?[*:0]const u16) HRESULT {
...
pub const IContactAggregationServerPersonCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindFirst(self: *const IContactAggregationServerPersonCollection, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.FindFirst(self, ppServerPerson);
    }
    pub inline fn FindFirstByServerId(self: *const IContactAggregationServerPersonCollection, pServerId: ?[*:0]const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.FindFirstByServerId(self, pServerId, ppServerPerson);
    }
    pub inline fn FindFirstByAggregateId(self: *const IContactAggregationServerPersonCollection, pAggregateId: ?[*:0]const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.FindFirstByAggregateId(self, pAggregateId, ppServerPerson);
    }
    pub inline fn FindFirstByLinkedAggregateId(self: *const IContactAggregationServerPersonCollection, pAggregateId: ?[*:0]const u16, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.FindFirstByLinkedAggregateId(self, pAggregateId, ppServerPerson);
    }
    pub inline fn FindNext(self: *const IContactAggregationServerPersonCollection, ppServerPerson: ?*?*IContactAggregationServerPerson) HRESULT {
        return self.vtable.FindNext(self, ppServerPerson);
    }
    pub inline fn get_Count(self: *const IContactAggregationServerPersonCollection, pCount: ?*u32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
};
