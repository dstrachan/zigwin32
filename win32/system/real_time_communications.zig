...
pub const IRTCClient = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IRTCClient) HRESULT {
        return self.vtable.Initialize(self);
    }
    pub inline fn Shutdown(self: *const IRTCClient) HRESULT {
        return self.vtable.Shutdown(self);
    }
    pub inline fn PrepareForShutdown(self: *const IRTCClient) HRESULT {
        return self.vtable.PrepareForShutdown(self);
    }
    pub inline fn put_EventFilter(self: *const IRTCClient, lFilter: i32) HRESULT {
        return self.vtable.put_EventFilter(self, lFilter);
    }
    pub inline fn get_EventFilter(self: *const IRTCClient, plFilter: ?*i32) HRESULT {
        return self.vtable.get_EventFilter(self, plFilter);
    }
    pub inline fn SetPreferredMediaTypes(self: *const IRTCClient, lMediaTypes: i32, fPersistent: i16) HRESULT {
        return self.vtable.SetPreferredMediaTypes(self, lMediaTypes, fPersistent);
    }
    pub inline fn get_PreferredMediaTypes(self: *const IRTCClient, plMediaTypes: ?*i32) HRESULT {
        return self.vtable.get_PreferredMediaTypes(self, plMediaTypes);
    }
    pub inline fn get_MediaCapabilities(self: *const IRTCClient, plMediaTypes: ?*i32) HRESULT {
        return self.vtable.get_MediaCapabilities(self, plMediaTypes);
    }
    pub inline fn CreateSession(self: *const IRTCClient, enType: RTC_SESSION_TYPE, bstrLocalPhoneURI: ?BSTR, pProfile: ?*IRTCProfile, lFlags: i32, ppSession: ?*?*IRTCSession) HRESULT {
        return self.vtable.CreateSession(self, enType, bstrLocalPhoneURI, pProfile, lFlags, ppSession);
    }
    pub inline fn put_ListenForIncomingSessions(self: *const IRTCClient, enListen: RTC_LISTEN_MODE) HRESULT {
        return self.vtable.put_ListenForIncomingSessions(self, enListen);
    }
    pub inline fn get_ListenForIncomingSessions(self: *const IRTCClient, penListen: ?*RTC_LISTEN_MODE) HRESULT {
        return self.vtable.get_ListenForIncomingSessions(self, penListen);
    }
    pub inline fn get_NetworkAddresses(self: *const IRTCClient, fTCP: i16, fExternal: i16, pvAddresses: ?*VARIANT) HRESULT {
        return self.vtable.get_NetworkAddresses(self, fTCP, fExternal, pvAddresses);
    }
    pub inline fn put_Volume(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, lVolume: i32) HRESULT {
        return self.vtable.put_Volume(self, enDevice, lVolume);
    }
    pub inline fn get_Volume(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, plVolume: ?*i32) HRESULT {
        return self.vtable.get_Volume(self, enDevice, plVolume);
    }
    pub inline fn put_AudioMuted(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, fMuted: i16) HRESULT {
        return self.vtable.put_AudioMuted(self, enDevice, fMuted);
    }
    pub inline fn get_AudioMuted(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, pfMuted: ?*i16) HRESULT {
        return self.vtable.get_AudioMuted(self, enDevice, pfMuted);
    }
    pub inline fn get_IVideoWindow(self: *const IRTCClient, enDevice: RTC_VIDEO_DEVICE, ppIVideoWindow: ?*?*IVideoWindow) HRESULT {
        return self.vtable.get_IVideoWindow(self, enDevice, ppIVideoWindow);
    }
    pub inline fn put_PreferredAudioDevice(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, bstrDeviceName: ?BSTR) HRESULT {
        return self.vtable.put_PreferredAudioDevice(self, enDevice, bstrDeviceName);
    }
    pub inline fn get_PreferredAudioDevice(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, pbstrDeviceName: ?*?BSTR) HRESULT {
        return self.vtable.get_PreferredAudioDevice(self, enDevice, pbstrDeviceName);
    }
    pub inline fn put_PreferredVolume(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, lVolume: i32) HRESULT {
        return self.vtable.put_PreferredVolume(self, enDevice, lVolume);
    }
    pub inline fn get_PreferredVolume(self: *const IRTCClient, enDevice: RTC_AUDIO_DEVICE, plVolume: ?*i32) HRESULT {
        return self.vtable.get_PreferredVolume(self, enDevice, plVolume);
    }
    pub inline fn put_PreferredAEC(self: *const IRTCClient, bEnable: i16) HRESULT {
        return self.vtable.put_PreferredAEC(self, bEnable);
    }
    pub inline fn get_PreferredAEC(self: *const IRTCClient, pbEnabled: ?*i16) HRESULT {
        return self.vtable.get_PreferredAEC(self, pbEnabled);
    }
    pub inline fn put_PreferredVideoDevice(self: *const IRTCClient, bstrDeviceName: ?BSTR) HRESULT {
        return self.vtable.put_PreferredVideoDevice(self, bstrDeviceName);
    }
    pub inline fn get_PreferredVideoDevice(self: *const IRTCClient, pbstrDeviceName: ?*?BSTR) HRESULT {
        return self.vtable.get_PreferredVideoDevice(self, pbstrDeviceName);
    }
    pub inline fn get_ActiveMedia(self: *const IRTCClient, plMediaType: ?*i32) HRESULT {
        return self.vtable.get_ActiveMedia(self, plMediaType);
    }
    pub inline fn put_MaxBitrate(self: *const IRTCClient, lMaxBitrate: i32) HRESULT {
        return self.vtable.put_MaxBitrate(self, lMaxBitrate);
    }
    pub inline fn get_MaxBitrate(self: *const IRTCClient, plMaxBitrate: ?*i32) HRESULT {
        return self.vtable.get_MaxBitrate(self, plMaxBitrate);
    }
    pub inline fn put_TemporalSpatialTradeOff(self: *const IRTCClient, lValue: i32) HRESULT {
        return self.vtable.put_TemporalSpatialTradeOff(self, lValue);
    }
    pub inline fn get_TemporalSpatialTradeOff(self: *const IRTCClient, plValue: ?*i32) HRESULT {
        return self.vtable.get_TemporalSpatialTradeOff(self, plValue);
    }
    pub inline fn get_NetworkQuality(self: *const IRTCClient, plNetworkQuality: ?*i32) HRESULT {
        return self.vtable.get_NetworkQuality(self, plNetworkQuality);
    }
    pub inline fn StartT120Applet(self: *const IRTCClient, enApplet: RTC_T120_APPLET) HRESULT {
        return self.vtable.StartT120Applet(self, enApplet);
    }
    pub inline fn StopT120Applets(self: *const IRTCClient) HRESULT {
        return self.vtable.StopT120Applets(self);
    }
    pub inline fn get_IsT120AppletRunning(self: *const IRTCClient, enApplet: RTC_T120_APPLET, pfRunning: ?*i16) HRESULT {
        return self.vtable.get_IsT120AppletRunning(self, enApplet, pfRunning);
    }
    pub inline fn get_LocalUserURI(self: *const IRTCClient, pbstrUserURI: ?*?BSTR) HRESULT {
        return self.vtable.get_LocalUserURI(self, pbstrUserURI);
    }
    pub inline fn put_LocalUserURI(self: *const IRTCClient, bstrUserURI: ?BSTR) HRESULT {
        return self.vtable.put_LocalUserURI(self, bstrUserURI);
    }
    pub inline fn get_LocalUserName(self: *const IRTCClient, pbstrUserName: ?*?BSTR) HRESULT {
        return self.vtable.get_LocalUserName(self, pbstrUserName);
    }
    pub inline fn put_LocalUserName(self: *const IRTCClient, bstrUserName: ?BSTR) HRESULT {
        return self.vtable.put_LocalUserName(self, bstrUserName);
    }
    pub inline fn PlayRing(self: *const IRTCClient, enType: RTC_RING_TYPE, bPlay: i16) HRESULT {
        return self.vtable.PlayRing(self, enType, bPlay);
    }
    pub inline fn SendDTMF(self: *const IRTCClient, enDTMF: RTC_DTMF) HRESULT {
        return self.vtable.SendDTMF(self, enDTMF);
    }
    pub inline fn InvokeTuningWizard(self: *const IRTCClient, hwndParent: isize) HRESULT {
        return self.vtable.InvokeTuningWizard(self, hwndParent);
    }
    pub inline fn get_IsTuned(self: *const IRTCClient, pfTuned: ?*i16) HRESULT {
...
pub const IRTCClient2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn put_AnswerMode(self: *const IRTCClient2, enType: RTC_SESSION_TYPE, enMode: RTC_ANSWER_MODE) HRESULT {
        return self.vtable.put_AnswerMode(self, enType, enMode);
    }
    pub inline fn get_AnswerMode(self: *const IRTCClient2, enType: RTC_SESSION_TYPE, penMode: ?*RTC_ANSWER_MODE) HRESULT {
        return self.vtable.get_AnswerMode(self, enType, penMode);
    }
    pub inline fn InvokeTuningWizardEx(self: *const IRTCClient2, hwndParent: isize, fAllowAudio: i16, fAllowVideo: i16) HRESULT {
        return self.vtable.InvokeTuningWizardEx(self, hwndParent, fAllowAudio, fAllowVideo);
    }
    pub inline fn get_Version(self: *const IRTCClient2, plVersion: ?*i32) HRESULT {
        return self.vtable.get_Version(self, plVersion);
    }
    pub inline fn put_ClientName(self: *const IRTCClient2, bstrClientName: ?BSTR) HRESULT {
        return self.vtable.put_ClientName(self, bstrClientName);
    }
    pub inline fn put_ClientCurVer(self: *const IRTCClient2, bstrClientCurVer: ?BSTR) HRESULT {
        return self.vtable.put_ClientCurVer(self, bstrClientCurVer);
    }
    pub inline fn InitializeEx(self: *const IRTCClient2, lFlags: i32) HRESULT {
        return self.vtable.InitializeEx(self, lFlags);
    }
    pub inline fn CreateSessionWithDescription(self: *const IRTCClient2, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR, pProfile: ?*IRTCProfile, lFlags: i32, ppSession2: ?*?*IRTCSession2) HRESULT {
        return self.vtable.CreateSessionWithDescription(self, bstrContentType, bstrSessionDescription, pProfile, lFlags, ppSession2);
    }
    pub inline fn SetSessionDescriptionManager(self: *const IRTCClient2, pSessionDescriptionManager: ?*IRTCSessionDescriptionManager) HRESULT {
        return self.vtable.SetSessionDescriptionManager(self, pSessionDescriptionManager);
    }
    pub inline fn put_PreferredSecurityLevel(self: *const IRTCClient2, enSecurityType: RTC_SECURITY_TYPE, enSecurityLevel: RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.put_PreferredSecurityLevel(self, enSecurityType, enSecurityLevel);
    }
    pub inline fn get_PreferredSecurityLevel(self: *const IRTCClient2, enSecurityType: RTC_SECURITY_TYPE, penSecurityLevel: ?*RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.get_PreferredSecurityLevel(self, enSecurityType, penSecurityLevel);
    }
    pub inline fn put_AllowedPorts(self: *const IRTCClient2, lTransport: i32, enListenMode: RTC_LISTEN_MODE) HRESULT {
        return self.vtable.put_AllowedPorts(self, lTransport, enListenMode);
    }
    pub inline fn get_AllowedPorts(self: *const IRTCClient2, lTransport: i32, penListenMode: ?*RTC_LISTEN_MODE) HRESULT {
...
pub const IRTCClientPresence = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn EnablePresence(self: *const IRTCClientPresence, fUseStorage: i16, varStorage: VARIANT) HRESULT {
        return self.vtable.EnablePresence(self, fUseStorage, varStorage);
    }
    pub inline fn Export(self: *const IRTCClientPresence, varStorage: VARIANT) HRESULT {
        return self.vtable.Export(self, varStorage);
    }
    pub inline fn Import(self: *const IRTCClientPresence, varStorage: VARIANT, fReplaceAll: i16) HRESULT {
        return self.vtable.Import(self, varStorage, fReplaceAll);
    }
    pub inline fn EnumerateBuddies(self: *const IRTCClientPresence, ppEnum: ?*?*IRTCEnumBuddies) HRESULT {
        return self.vtable.EnumerateBuddies(self, ppEnum);
    }
    pub inline fn get_Buddies(self: *const IRTCClientPresence, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Buddies(self, ppCollection);
    }
    pub inline fn get_Buddy(self: *const IRTCClientPresence, bstrPresentityURI: ?BSTR, ppBuddy: ?*?*IRTCBuddy) HRESULT {
        return self.vtable.get_Buddy(self, bstrPresentityURI, ppBuddy);
    }
    pub inline fn AddBuddy(self: *const IRTCClientPresence, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fPersistent: i16, pProfile: ?*IRTCProfile, lFlags: i32, ppBuddy: ?*?*IRTCBuddy) HRESULT {
        return self.vtable.AddBuddy(self, bstrPresentityURI, bstrUserName, bstrData, fPersistent, pProfile, lFlags, ppBuddy);
    }
    pub inline fn RemoveBuddy(self: *const IRTCClientPresence, pBuddy: ?*IRTCBuddy) HRESULT {
        return self.vtable.RemoveBuddy(self, pBuddy);
    }
    pub inline fn EnumerateWatchers(self: *const IRTCClientPresence, ppEnum: ?*?*IRTCEnumWatchers) HRESULT {
        return self.vtable.EnumerateWatchers(self, ppEnum);
    }
    pub inline fn get_Watchers(self: *const IRTCClientPresence, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Watchers(self, ppCollection);
    }
    pub inline fn get_Watcher(self: *const IRTCClientPresence, bstrPresentityURI: ?BSTR, ppWatcher: ?*?*IRTCWatcher) HRESULT {
        return self.vtable.get_Watcher(self, bstrPresentityURI, ppWatcher);
    }
    pub inline fn AddWatcher(self: *const IRTCClientPresence, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fBlocked: i16, fPersistent: i16, ppWatcher: ?*?*IRTCWatcher) HRESULT {
        return self.vtable.AddWatcher(self, bstrPresentityURI, bstrUserName, bstrData, fBlocked, fPersistent, ppWatcher);
    }
    pub inline fn RemoveWatcher(self: *const IRTCClientPresence, pWatcher: ?*IRTCWatcher) HRESULT {
        return self.vtable.RemoveWatcher(self, pWatcher);
    }
    pub inline fn SetLocalPresenceInfo(self: *const IRTCClientPresence, enStatus: RTC_PRESENCE_STATUS, bstrNotes: ?BSTR) HRESULT {
        return self.vtable.SetLocalPresenceInfo(self, enStatus, bstrNotes);
    }
    pub inline fn get_OfferWatcherMode(self: *const IRTCClientPresence, penMode: ?*RTC_OFFER_WATCHER_MODE) HRESULT {
        return self.vtable.get_OfferWatcherMode(self, penMode);
    }
    pub inline fn put_OfferWatcherMode(self: *const IRTCClientPresence, enMode: RTC_OFFER_WATCHER_MODE) HRESULT {
        return self.vtable.put_OfferWatcherMode(self, enMode);
    }
    pub inline fn get_PrivacyMode(self: *const IRTCClientPresence, penMode: ?*RTC_PRIVACY_MODE) HRESULT {
        return self.vtable.get_PrivacyMode(self, penMode);
    }
    pub inline fn put_PrivacyMode(self: *const IRTCClientPresence, enMode: RTC_PRIVACY_MODE) HRESULT {
...
pub const IRTCClientPresence2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn EnablePresenceEx(self: *const IRTCClientPresence2, pProfile: ?*IRTCProfile, varStorage: VARIANT, lFlags: i32) HRESULT {
        return self.vtable.EnablePresenceEx(self, pProfile, varStorage, lFlags);
    }
    pub inline fn DisablePresence(self: *const IRTCClientPresence2) HRESULT {
        return self.vtable.DisablePresence(self);
    }
    pub inline fn AddGroup(self: *const IRTCClientPresence2, bstrGroupName: ?BSTR, bstrData: ?BSTR, pProfile: ?*IRTCProfile, lFlags: i32, ppGroup: ?*?*IRTCBuddyGroup) HRESULT {
        return self.vtable.AddGroup(self, bstrGroupName, bstrData, pProfile, lFlags, ppGroup);
    }
    pub inline fn RemoveGroup(self: *const IRTCClientPresence2, pGroup: ?*IRTCBuddyGroup) HRESULT {
        return self.vtable.RemoveGroup(self, pGroup);
    }
    pub inline fn EnumerateGroups(self: *const IRTCClientPresence2, ppEnum: ?*?*IRTCEnumGroups) HRESULT {
        return self.vtable.EnumerateGroups(self, ppEnum);
    }
    pub inline fn get_Groups(self: *const IRTCClientPresence2, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Groups(self, ppCollection);
    }
    pub inline fn get_Group(self: *const IRTCClientPresence2, bstrGroupName: ?BSTR, ppGroup: ?*?*IRTCBuddyGroup) HRESULT {
        return self.vtable.get_Group(self, bstrGroupName, ppGroup);
    }
    pub inline fn AddWatcherEx(self: *const IRTCClientPresence2, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, enState: RTC_WATCHER_STATE, fPersistent: i16, enScope: RTC_ACE_SCOPE, pProfile: ?*IRTCProfile, lFlags: i32, ppWatcher: ?*?*IRTCWatcher2) HRESULT {
    ...
    pub inline fn get_WatcherEx(self: *const IRTCClientPresence2, enMode: RTC_WATCHER_MATCH_MODE, bstrPresentityURI: ?BSTR, ppWatcher: ?*?*IRTCWatcher2) HRESULT {
        return self.vtable.get_WatcherEx(self, enMode, bstrPresentityURI, ppWatcher);
    }
    pub inline fn put_PresenceProperty(self: *const IRTCClientPresence2, enProperty: RTC_PRESENCE_PROPERTY, bstrProperty: ?BSTR) HRESULT {
        return self.vtable.put_PresenceProperty(self, enProperty, bstrProperty);
    }
    pub inline fn get_PresenceProperty(self: *const IRTCClientPresence2, enProperty: RTC_PRESENCE_PROPERTY, pbstrProperty: ?*?BSTR) HRESULT {
        return self.vtable.get_PresenceProperty(self, enProperty, pbstrProperty);
    }
    pub inline fn SetPresenceData(self: *const IRTCClientPresence2, bstrNamespace: ?BSTR, bstrData: ?BSTR) HRESULT {
        return self.vtable.SetPresenceData(self, bstrNamespace, bstrData);
    }
    pub inline fn GetPresenceData(self: *const IRTCClientPresence2, pbstrNamespace: ?*?BSTR, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.GetPresenceData(self, pbstrNamespace, pbstrData);
    }
    pub inline fn GetLocalPresenceInfo(self: *const IRTCClientPresence2, penStatus: ?*RTC_PRESENCE_STATUS, pbstrNotes: ?*?BSTR) HRESULT {
        return self.vtable.GetLocalPresenceInfo(self, penStatus, pbstrNotes);
    }
    pub inline fn AddBuddyEx(self: *const IRTCClientPresence2, bstrPresentityURI: ?BSTR, bstrUserName: ?BSTR, bstrData: ?BSTR, fPersistent: i16, enSubscriptionType: RTC_BUDDY_SUBSCRIPTION_TYPE, pProfile: ?*IRTCProfile, lFlags: i32, ppBuddy: ?*?*IRTCBuddy2) HRESULT {
...
pub const IRTCClientProvisioning = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateProfile(self: *const IRTCClientProvisioning, bstrProfileXML: ?BSTR, ppProfile: ?*?*IRTCProfile) HRESULT {
        return self.vtable.CreateProfile(self, bstrProfileXML, ppProfile);
    }
    pub inline fn EnableProfile(self: *const IRTCClientProvisioning, pProfile: ?*IRTCProfile, lRegisterFlags: i32) HRESULT {
        return self.vtable.EnableProfile(self, pProfile, lRegisterFlags);
    }
    pub inline fn DisableProfile(self: *const IRTCClientProvisioning, pProfile: ?*IRTCProfile) HRESULT {
        return self.vtable.DisableProfile(self, pProfile);
    }
    pub inline fn EnumerateProfiles(self: *const IRTCClientProvisioning, ppEnum: ?*?*IRTCEnumProfiles) HRESULT {
        return self.vtable.EnumerateProfiles(self, ppEnum);
    }
    pub inline fn get_Profiles(self: *const IRTCClientProvisioning, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Profiles(self, ppCollection);
    }
    pub inline fn GetProfile(self: *const IRTCClientProvisioning, bstrUserAccount: ?BSTR, bstrUserPassword: ?BSTR, bstrUserURI: ?BSTR, bstrServer: ?BSTR, lTransport: i32, lCookie: isize) HRESULT {
        return self.vtable.GetProfile(self, bstrUserAccount, bstrUserPassword, bstrUserURI, bstrServer, lTransport, lCookie);
    }
    pub inline fn get_SessionCapabilities(self: *const IRTCClientProvisioning, plSupportedSessions: ?*i32) HRESULT {
...
pub const IRTCClientProvisioning2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn EnableProfileEx(self: *const IRTCClientProvisioning2, pProfile: ?*IRTCProfile, lRegisterFlags: i32, lRoamingFlags: i32) HRESULT {
...
pub const IRTCProfile = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Key(self: *const IRTCProfile, pbstrKey: ?*?BSTR) HRESULT {
        return self.vtable.get_Key(self, pbstrKey);
    }
    pub inline fn get_Name(self: *const IRTCProfile, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn get_XML(self: *const IRTCProfile, pbstrXML: ?*?BSTR) HRESULT {
        return self.vtable.get_XML(self, pbstrXML);
    }
    pub inline fn get_ProviderName(self: *const IRTCProfile, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_ProviderName(self, pbstrName);
    }
    pub inline fn get_ProviderURI(self: *const IRTCProfile, enURI: RTC_PROVIDER_URI, pbstrURI: ?*?BSTR) HRESULT {
        return self.vtable.get_ProviderURI(self, enURI, pbstrURI);
    }
    pub inline fn get_ProviderData(self: *const IRTCProfile, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.get_ProviderData(self, pbstrData);
    }
    pub inline fn get_ClientName(self: *const IRTCProfile, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_ClientName(self, pbstrName);
    }
    pub inline fn get_ClientBanner(self: *const IRTCProfile, pfBanner: ?*i16) HRESULT {
        return self.vtable.get_ClientBanner(self, pfBanner);
    }
    pub inline fn get_ClientMinVer(self: *const IRTCProfile, pbstrMinVer: ?*?BSTR) HRESULT {
        return self.vtable.get_ClientMinVer(self, pbstrMinVer);
    }
    pub inline fn get_ClientCurVer(self: *const IRTCProfile, pbstrCurVer: ?*?BSTR) HRESULT {
        return self.vtable.get_ClientCurVer(self, pbstrCurVer);
    }
    pub inline fn get_ClientUpdateURI(self: *const IRTCProfile, pbstrUpdateURI: ?*?BSTR) HRESULT {
        return self.vtable.get_ClientUpdateURI(self, pbstrUpdateURI);
    }
    pub inline fn get_ClientData(self: *const IRTCProfile, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.get_ClientData(self, pbstrData);
    }
    pub inline fn get_UserURI(self: *const IRTCProfile, pbstrUserURI: ?*?BSTR) HRESULT {
        return self.vtable.get_UserURI(self, pbstrUserURI);
    }
    pub inline fn get_UserName(self: *const IRTCProfile, pbstrUserName: ?*?BSTR) HRESULT {
        return self.vtable.get_UserName(self, pbstrUserName);
    }
    pub inline fn get_UserAccount(self: *const IRTCProfile, pbstrUserAccount: ?*?BSTR) HRESULT {
        return self.vtable.get_UserAccount(self, pbstrUserAccount);
    }
    pub inline fn SetCredentials(self: *const IRTCProfile, bstrUserURI: ?BSTR, bstrUserAccount: ?BSTR, bstrPassword: ?BSTR) HRESULT {
        return self.vtable.SetCredentials(self, bstrUserURI, bstrUserAccount, bstrPassword);
    }
    pub inline fn get_SessionCapabilities(self: *const IRTCProfile, plSupportedSessions: ?*i32) HRESULT {
        return self.vtable.get_SessionCapabilities(self, plSupportedSessions);
    }
    pub inline fn get_State(self: *const IRTCProfile, penState: ?*RTC_REGISTRATION_STATE) HRESULT {
...
pub const IRTCProfile2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn get_Realm(self: *const IRTCProfile2, pbstrRealm: ?*?BSTR) HRESULT {
        return self.vtable.get_Realm(self, pbstrRealm);
    }
    pub inline fn put_Realm(self: *const IRTCProfile2, bstrRealm: ?BSTR) HRESULT {
        return self.vtable.put_Realm(self, bstrRealm);
    }
    pub inline fn get_AllowedAuth(self: *const IRTCProfile2, plAllowedAuth: ?*i32) HRESULT {
        return self.vtable.get_AllowedAuth(self, plAllowedAuth);
    }
    pub inline fn put_AllowedAuth(self: *const IRTCProfile2, lAllowedAuth: i32) HRESULT {
...
pub const IRTCSession = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Client(self: *const IRTCSession, ppClient: ?*?*IRTCClient) HRESULT {
        return self.vtable.get_Client(self, ppClient);
    }
    pub inline fn get_State(self: *const IRTCSession, penState: ?*RTC_SESSION_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn get_Type(self: *const IRTCSession, penType: ?*RTC_SESSION_TYPE) HRESULT {
        return self.vtable.get_Type(self, penType);
    }
    pub inline fn get_Profile(self: *const IRTCSession, ppProfile: ?*?*IRTCProfile) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_Participants(self: *const IRTCSession, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Participants(self, ppCollection);
    }
    pub inline fn Answer(self: *const IRTCSession) HRESULT {
        return self.vtable.Answer(self);
    }
    pub inline fn Terminate(self: *const IRTCSession, enReason: RTC_TERMINATE_REASON) HRESULT {
        return self.vtable.Terminate(self, enReason);
    }
    pub inline fn Redirect(self: *const IRTCSession, enType: RTC_SESSION_TYPE, bstrLocalPhoneURI: ?BSTR, pProfile: ?*IRTCProfile, lFlags: i32) HRESULT {
        return self.vtable.Redirect(self, enType, bstrLocalPhoneURI, pProfile, lFlags);
    }
    pub inline fn AddParticipant(self: *const IRTCSession, bstrAddress: ?BSTR, bstrName: ?BSTR, ppParticipant: ?*?*IRTCParticipant) HRESULT {
        return self.vtable.AddParticipant(self, bstrAddress, bstrName, ppParticipant);
    }
    pub inline fn RemoveParticipant(self: *const IRTCSession, pParticipant: ?*IRTCParticipant) HRESULT {
        return self.vtable.RemoveParticipant(self, pParticipant);
    }
    pub inline fn EnumerateParticipants(self: *const IRTCSession, ppEnum: ?*?*IRTCEnumParticipants) HRESULT {
        return self.vtable.EnumerateParticipants(self, ppEnum);
    }
    pub inline fn get_CanAddParticipants(self: *const IRTCSession, pfCanAdd: ?*i16) HRESULT {
        return self.vtable.get_CanAddParticipants(self, pfCanAdd);
    }
    pub inline fn get_RedirectedUserURI(self: *const IRTCSession, pbstrUserURI: ?*?BSTR) HRESULT {
        return self.vtable.get_RedirectedUserURI(self, pbstrUserURI);
    }
    pub inline fn get_RedirectedUserName(self: *const IRTCSession, pbstrUserName: ?*?BSTR) HRESULT {
        return self.vtable.get_RedirectedUserName(self, pbstrUserName);
    }
    pub inline fn NextRedirectedUser(self: *const IRTCSession) HRESULT {
        return self.vtable.NextRedirectedUser(self);
    }
    pub inline fn SendMessage(self: *const IRTCSession, bstrMessageHeader: ?BSTR, bstrMessage: ?BSTR, lCookie: isize) HRESULT {
        return self.vtable.SendMessage(self, bstrMessageHeader, bstrMessage, lCookie);
    }
    pub inline fn SendMessageStatus(self: *const IRTCSession, enUserStatus: RTC_MESSAGING_USER_STATUS, lCookie: isize) HRESULT {
        return self.vtable.SendMessageStatus(self, enUserStatus, lCookie);
    }
    pub inline fn AddStream(self: *const IRTCSession, lMediaType: i32, lCookie: isize) HRESULT {
        return self.vtable.AddStream(self, lMediaType, lCookie);
    }
    pub inline fn RemoveStream(self: *const IRTCSession, lMediaType: i32, lCookie: isize) HRESULT {
        return self.vtable.RemoveStream(self, lMediaType, lCookie);
    }
    pub inline fn put_EncryptionKey(self: *const IRTCSession, lMediaType: i32, EncryptionKey: ?BSTR) HRESULT {
...
pub const IRTCSession2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn SendInfo(self: *const IRTCSession2, bstrInfoHeader: ?BSTR, bstrInfo: ?BSTR, lCookie: isize) HRESULT {
        return self.vtable.SendInfo(self, bstrInfoHeader, bstrInfo, lCookie);
    }
    pub inline fn put_PreferredSecurityLevel(self: *const IRTCSession2, enSecurityType: RTC_SECURITY_TYPE, enSecurityLevel: RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.put_PreferredSecurityLevel(self, enSecurityType, enSecurityLevel);
    }
    pub inline fn get_PreferredSecurityLevel(self: *const IRTCSession2, enSecurityType: RTC_SECURITY_TYPE, penSecurityLevel: ?*RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.get_PreferredSecurityLevel(self, enSecurityType, penSecurityLevel);
    }
    pub inline fn IsSecurityEnabled(self: *const IRTCSession2, enSecurityType: RTC_SECURITY_TYPE, pfSecurityEnabled: ?*i16) HRESULT {
        return self.vtable.IsSecurityEnabled(self, enSecurityType, pfSecurityEnabled);
    }
    pub inline fn AnswerWithSessionDescription(self: *const IRTCSession2, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR) HRESULT {
        return self.vtable.AnswerWithSessionDescription(self, bstrContentType, bstrSessionDescription);
    }
    pub inline fn ReInviteWithSessionDescription(self: *const IRTCSession2, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR, lCookie: isize) HRESULT {
...
pub const IRTCSessionCallControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Hold(self: *const IRTCSessionCallControl, lCookie: isize) HRESULT {
        return self.vtable.Hold(self, lCookie);
    }
    pub inline fn UnHold(self: *const IRTCSessionCallControl, lCookie: isize) HRESULT {
        return self.vtable.UnHold(self, lCookie);
    }
    pub inline fn Forward(self: *const IRTCSessionCallControl, bstrForwardToURI: ?BSTR) HRESULT {
        return self.vtable.Forward(self, bstrForwardToURI);
    }
    pub inline fn Refer(self: *const IRTCSessionCallControl, bstrReferToURI: ?BSTR, bstrReferCookie: ?BSTR) HRESULT {
        return self.vtable.Refer(self, bstrReferToURI, bstrReferCookie);
    }
    pub inline fn put_ReferredByURI(self: *const IRTCSessionCallControl, bstrReferredByURI: ?BSTR) HRESULT {
        return self.vtable.put_ReferredByURI(self, bstrReferredByURI);
    }
    pub inline fn get_ReferredByURI(self: *const IRTCSessionCallControl, pbstrReferredByURI: ?*?BSTR) HRESULT {
        return self.vtable.get_ReferredByURI(self, pbstrReferredByURI);
    }
    pub inline fn put_ReferCookie(self: *const IRTCSessionCallControl, bstrReferCookie: ?BSTR) HRESULT {
        return self.vtable.put_ReferCookie(self, bstrReferCookie);
    }
    pub inline fn get_ReferCookie(self: *const IRTCSessionCallControl, pbstrReferCookie: ?*?BSTR) HRESULT {
        return self.vtable.get_ReferCookie(self, pbstrReferCookie);
    }
    pub inline fn get_IsReferred(self: *const IRTCSessionCallControl, pfIsReferred: ?*i16) HRESULT {
...
pub const IRTCParticipant = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_UserURI(self: *const IRTCParticipant, pbstrUserURI: ?*?BSTR) HRESULT {
        return self.vtable.get_UserURI(self, pbstrUserURI);
    }
    pub inline fn get_Name(self: *const IRTCParticipant, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn get_Removable(self: *const IRTCParticipant, pfRemovable: ?*i16) HRESULT {
        return self.vtable.get_Removable(self, pfRemovable);
    }
    pub inline fn get_State(self: *const IRTCParticipant, penState: ?*RTC_PARTICIPANT_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn get_Session(self: *const IRTCParticipant, ppSession: ?*?*IRTCSession) HRESULT {
...
pub const IRTCRoamingEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCRoamingEvent, pEventType: ?*RTC_ROAMING_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, pEventType);
    }
    pub inline fn get_Profile(self: *const IRTCRoamingEvent, ppProfile: ?*?*IRTCProfile2) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_StatusCode(self: *const IRTCRoamingEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCRoamingEvent, pbstrStatusText: ?*?BSTR) HRESULT {
...
pub const IRTCProfileEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Profile(self: *const IRTCProfileEvent, ppProfile: ?*?*IRTCProfile) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_Cookie(self: *const IRTCProfileEvent, plCookie: ?*isize) HRESULT {
        return self.vtable.get_Cookie(self, plCookie);
    }
    pub inline fn get_StatusCode(self: *const IRTCProfileEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
};
...
pub const IRTCProfileEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCProfileEvent2, pEventType: ?*RTC_PROFILE_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, pEventType);
    }
};
...
pub const IRTCClientEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCClientEvent, penEventType: ?*RTC_CLIENT_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, penEventType);
    }
    pub inline fn get_Client(self: *const IRTCClientEvent, ppClient: ?*?*IRTCClient) HRESULT {
        return self.vtable.get_Client(self, ppClient);
    }
};
...
pub const IRTCRegistrationStateChangeEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Profile(self: *const IRTCRegistrationStateChangeEvent, ppProfile: ?*?*IRTCProfile) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_State(self: *const IRTCRegistrationStateChangeEvent, penState: ?*RTC_REGISTRATION_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn get_StatusCode(self: *const IRTCRegistrationStateChangeEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCRegistrationStateChangeEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
};
...
pub const IRTCSessionStateChangeEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCSessionStateChangeEvent, ppSession: ?*?*IRTCSession) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_State(self: *const IRTCSessionStateChangeEvent, penState: ?*RTC_SESSION_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn get_StatusCode(self: *const IRTCSessionStateChangeEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCSessionStateChangeEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
};
...
pub const IRTCSessionStateChangeEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_MediaTypes(self: *const IRTCSessionStateChangeEvent2, pMediaTypes: ?*i32) HRESULT {
        return self.vtable.get_MediaTypes(self, pMediaTypes);
    }
    pub inline fn get_RemotePreferredSecurityLevel(self: *const IRTCSessionStateChangeEvent2, enSecurityType: RTC_SECURITY_TYPE, penSecurityLevel: ?*RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.get_RemotePreferredSecurityLevel(self, enSecurityType, penSecurityLevel);
    }
    pub inline fn get_IsForked(self: *const IRTCSessionStateChangeEvent2, pfIsForked: ?*i16) HRESULT {
        return self.vtable.get_IsForked(self, pfIsForked);
    }
    pub inline fn GetRemoteSessionDescription(self: *const IRTCSessionStateChangeEvent2, pbstrContentType: ?*?BSTR, pbstrSessionDescription: ?*?BSTR) HRESULT {
...
pub const IRTCSessionOperationCompleteEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCSessionOperationCompleteEvent, ppSession: ?*?*IRTCSession) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_Cookie(self: *const IRTCSessionOperationCompleteEvent, plCookie: ?*isize) HRESULT {
        return self.vtable.get_Cookie(self, plCookie);
    }
    pub inline fn get_StatusCode(self: *const IRTCSessionOperationCompleteEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCSessionOperationCompleteEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
};
...
pub const IRTCSessionOperationCompleteEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Participant(self: *const IRTCSessionOperationCompleteEvent2, ppParticipant: ?*?*IRTCParticipant) HRESULT {
        return self.vtable.get_Participant(self, ppParticipant);
    }
    pub inline fn GetRemoteSessionDescription(self: *const IRTCSessionOperationCompleteEvent2, pbstrContentType: ?*?BSTR, pbstrSessionDescription: ?*?BSTR) HRESULT {
        return self.vtable.GetRemoteSessionDescription(self, pbstrContentType, pbstrSessionDescription);
    }
};
...
pub const IRTCParticipantStateChangeEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Participant(self: *const IRTCParticipantStateChangeEvent, ppParticipant: ?*?*IRTCParticipant) HRESULT {
        return self.vtable.get_Participant(self, ppParticipant);
    }
    pub inline fn get_State(self: *const IRTCParticipantStateChangeEvent, penState: ?*RTC_PARTICIPANT_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn get_StatusCode(self: *const IRTCParticipantStateChangeEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
};
...
pub const IRTCMediaEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_MediaType(self: *const IRTCMediaEvent, pMediaType: ?*i32) HRESULT {
        return self.vtable.get_MediaType(self, pMediaType);
    }
    pub inline fn get_EventType(self: *const IRTCMediaEvent, penEventType: ?*RTC_MEDIA_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, penEventType);
    }
    pub inline fn get_EventReason(self: *const IRTCMediaEvent, penEventReason: ?*RTC_MEDIA_EVENT_REASON) HRESULT {
...
pub const IRTCIntensityEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Level(self: *const IRTCIntensityEvent, plLevel: ?*i32) HRESULT {
        return self.vtable.get_Level(self, plLevel);
    }
    pub inline fn get_Min(self: *const IRTCIntensityEvent, plMin: ?*i32) HRESULT {
        return self.vtable.get_Min(self, plMin);
    }
    pub inline fn get_Max(self: *const IRTCIntensityEvent, plMax: ?*i32) HRESULT {
        return self.vtable.get_Max(self, plMax);
    }
    pub inline fn get_Direction(self: *const IRTCIntensityEvent, penDirection: ?*RTC_AUDIO_DEVICE) HRESULT {
...
pub const IRTCMessagingEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCMessagingEvent, ppSession: ?*?*IRTCSession) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_Participant(self: *const IRTCMessagingEvent, ppParticipant: ?*?*IRTCParticipant) HRESULT {
        return self.vtable.get_Participant(self, ppParticipant);
    }
    pub inline fn get_EventType(self: *const IRTCMessagingEvent, penEventType: ?*RTC_MESSAGING_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, penEventType);
    }
    pub inline fn get_Message(self: *const IRTCMessagingEvent, pbstrMessage: ?*?BSTR) HRESULT {
        return self.vtable.get_Message(self, pbstrMessage);
    }
    pub inline fn get_MessageHeader(self: *const IRTCMessagingEvent, pbstrMessageHeader: ?*?BSTR) HRESULT {
        return self.vtable.get_MessageHeader(self, pbstrMessageHeader);
    }
    pub inline fn get_UserStatus(self: *const IRTCMessagingEvent, penUserStatus: ?*RTC_MESSAGING_USER_STATUS) HRESULT {
...
pub const IRTCBuddyEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Buddy(self: *const IRTCBuddyEvent, ppBuddy: ?*?*IRTCBuddy) HRESULT {
...
pub const IRTCBuddyEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCBuddyEvent2, pEventType: ?*RTC_BUDDY_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, pEventType);
    }
    pub inline fn get_StatusCode(self: *const IRTCBuddyEvent2, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCBuddyEvent2, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
};
...
pub const IRTCWatcherEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Watcher(self: *const IRTCWatcherEvent, ppWatcher: ?*?*IRTCWatcher) HRESULT {
...
pub const IRTCWatcherEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCWatcherEvent2, pEventType: ?*RTC_WATCHER_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, pEventType);
    }
    pub inline fn get_StatusCode(self: *const IRTCWatcherEvent2, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
};
...
pub const IRTCBuddyGroupEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_EventType(self: *const IRTCBuddyGroupEvent, pEventType: ?*RTC_GROUP_EVENT_TYPE) HRESULT {
        return self.vtable.get_EventType(self, pEventType);
    }
    pub inline fn get_Group(self: *const IRTCBuddyGroupEvent, ppGroup: ?*?*IRTCBuddyGroup) HRESULT {
        return self.vtable.get_Group(self, ppGroup);
    }
    pub inline fn get_Buddy(self: *const IRTCBuddyGroupEvent, ppBuddy: ?*?*IRTCBuddy2) HRESULT {
        return self.vtable.get_Buddy(self, ppBuddy);
    }
    pub inline fn get_StatusCode(self: *const IRTCBuddyGroupEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
};
...
pub const IRTCInfoEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCInfoEvent, ppSession: ?*?*IRTCSession2) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_Participant(self: *const IRTCInfoEvent, ppParticipant: ?*?*IRTCParticipant) HRESULT {
        return self.vtable.get_Participant(self, ppParticipant);
    }
    pub inline fn get_Info(self: *const IRTCInfoEvent, pbstrInfo: ?*?BSTR) HRESULT {
        return self.vtable.get_Info(self, pbstrInfo);
    }
    pub inline fn get_InfoHeader(self: *const IRTCInfoEvent, pbstrInfoHeader: ?*?BSTR) HRESULT {
...
pub const IRTCMediaRequestEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCMediaRequestEvent, ppSession: ?*?*IRTCSession2) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_ProposedMedia(self: *const IRTCMediaRequestEvent, plMediaTypes: ?*i32) HRESULT {
        return self.vtable.get_ProposedMedia(self, plMediaTypes);
    }
    pub inline fn get_CurrentMedia(self: *const IRTCMediaRequestEvent, plMediaTypes: ?*i32) HRESULT {
        return self.vtable.get_CurrentMedia(self, plMediaTypes);
    }
    pub inline fn Accept(self: *const IRTCMediaRequestEvent, lMediaTypes: i32) HRESULT {
        return self.vtable.Accept(self, lMediaTypes);
    }
    pub inline fn get_RemotePreferredSecurityLevel(self: *const IRTCMediaRequestEvent, enSecurityType: RTC_SECURITY_TYPE, penSecurityLevel: ?*RTC_SECURITY_LEVEL) HRESULT {
        return self.vtable.get_RemotePreferredSecurityLevel(self, enSecurityType, penSecurityLevel);
    }
    pub inline fn Reject(self: *const IRTCMediaRequestEvent) HRESULT {
        return self.vtable.Reject(self);
    }
    pub inline fn get_State(self: *const IRTCMediaRequestEvent, pState: ?*RTC_REINVITE_STATE) HRESULT {
...
pub const IRTCReInviteEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCReInviteEvent, ppSession2: ?*?*IRTCSession2) HRESULT {
        return self.vtable.get_Session(self, ppSession2);
    }
    pub inline fn Accept(self: *const IRTCReInviteEvent, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR) HRESULT {
        return self.vtable.Accept(self, bstrContentType, bstrSessionDescription);
    }
    pub inline fn Reject(self: *const IRTCReInviteEvent) HRESULT {
        return self.vtable.Reject(self);
    }
    pub inline fn get_State(self: *const IRTCReInviteEvent, pState: ?*RTC_REINVITE_STATE) HRESULT {
        return self.vtable.get_State(self, pState);
    }
    pub inline fn GetRemoteSessionDescription(self: *const IRTCReInviteEvent, pbstrContentType: ?*?BSTR, pbstrSessionDescription: ?*?BSTR) HRESULT {
        return self.vtable.GetRemoteSessionDescription(self, pbstrContentType, pbstrSessionDescription);
    }
};
...
pub const IRTCPresencePropertyEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_StatusCode(self: *const IRTCPresencePropertyEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCPresencePropertyEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
    pub inline fn get_PresenceProperty(self: *const IRTCPresencePropertyEvent, penPresProp: ?*RTC_PRESENCE_PROPERTY) HRESULT {
        return self.vtable.get_PresenceProperty(self, penPresProp);
    }
    pub inline fn get_Value(self: *const IRTCPresencePropertyEvent, pbstrValue: ?*?BSTR) HRESULT {
...
pub const IRTCPresenceDataEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_StatusCode(self: *const IRTCPresenceDataEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCPresenceDataEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
    pub inline fn GetPresenceData(self: *const IRTCPresenceDataEvent, pbstrNamespace: ?*?BSTR, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.GetPresenceData(self, pbstrNamespace, pbstrData);
    }
};
...
pub const IRTCPresenceStatusEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_StatusCode(self: *const IRTCPresenceStatusEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCPresenceStatusEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
    pub inline fn GetLocalPresenceInfo(self: *const IRTCPresenceStatusEvent, penStatus: ?*RTC_PRESENCE_STATUS, pbstrNotes: ?*?BSTR) HRESULT {
        return self.vtable.GetLocalPresenceInfo(self, penStatus, pbstrNotes);
    }
};
...
pub const IRTCCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Count(self: *const IRTCCollection, lCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, lCount);
    }
    pub inline fn get_Item(self: *const IRTCCollection, Index: i32, pVariant: ?*VARIANT) HRESULT {
        return self.vtable.get_Item(self, Index, pVariant);
    }
    pub inline fn get__NewEnum(self: *const IRTCCollection, ppNewEnum: ?*?*IUnknown) HRESULT {
...
pub const IRTCEnumParticipants = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumParticipants, celt: u32, ppElements: [*]?*IRTCParticipant, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumParticipants) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumParticipants, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumParticipants, ppEnum: ?*?*IRTCEnumParticipants) HRESULT {
...
pub const IRTCEnumProfiles = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumProfiles, celt: u32, ppElements: [*]?*IRTCProfile, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumProfiles) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumProfiles, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumProfiles, ppEnum: ?*?*IRTCEnumProfiles) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCEnumBuddies = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumBuddies, celt: u32, ppElements: [*]?*IRTCBuddy, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumBuddies) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumBuddies, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumBuddies, ppEnum: ?*?*IRTCEnumBuddies) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCEnumWatchers = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumWatchers, celt: u32, ppElements: [*]?*IRTCWatcher, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumWatchers) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumWatchers, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumWatchers, ppEnum: ?*?*IRTCEnumWatchers) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCEnumGroups = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumGroups, celt: u32, ppElements: [*]?*IRTCBuddyGroup, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumGroups) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumGroups, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumGroups, ppEnum: ?*?*IRTCEnumGroups) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCPresenceContact = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_PresentityURI(self: *const IRTCPresenceContact, pbstrPresentityURI: ?*?BSTR) HRESULT {
        return self.vtable.get_PresentityURI(self, pbstrPresentityURI);
    }
    pub inline fn put_PresentityURI(self: *const IRTCPresenceContact, bstrPresentityURI: ?BSTR) HRESULT {
        return self.vtable.put_PresentityURI(self, bstrPresentityURI);
    }
    pub inline fn get_Name(self: *const IRTCPresenceContact, pbstrName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrName);
    }
    pub inline fn put_Name(self: *const IRTCPresenceContact, bstrName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrName);
    }
    pub inline fn get_Data(self: *const IRTCPresenceContact, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.get_Data(self, pbstrData);
    }
    pub inline fn put_Data(self: *const IRTCPresenceContact, bstrData: ?BSTR) HRESULT {
        return self.vtable.put_Data(self, bstrData);
    }
    pub inline fn get_Persistent(self: *const IRTCPresenceContact, pfPersistent: ?*i16) HRESULT {
        return self.vtable.get_Persistent(self, pfPersistent);
    }
    pub inline fn put_Persistent(self: *const IRTCPresenceContact, fPersistent: i16) HRESULT {
...
pub const IRTCBuddy = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const IRTCBuddy, penStatus: ?*RTC_PRESENCE_STATUS) HRESULT {
        return self.vtable.get_Status(self, penStatus);
    }
    pub inline fn get_Notes(self: *const IRTCBuddy, pbstrNotes: ?*?BSTR) HRESULT {
...
pub const IRTCBuddy2 = extern union {
    ...
    IRTCPresenceContact: IRTCPresenceContact,
    IUnknown: IUnknown,
    pub inline fn get_Profile(self: *const IRTCBuddy2, ppProfile: ?*?*IRTCProfile2) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn Refresh(self: *const IRTCBuddy2) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn EnumerateGroups(self: *const IRTCBuddy2, ppEnum: ?*?*IRTCEnumGroups) HRESULT {
        return self.vtable.EnumerateGroups(self, ppEnum);
    }
    pub inline fn get_Groups(self: *const IRTCBuddy2, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Groups(self, ppCollection);
    }
    pub inline fn get_PresenceProperty(self: *const IRTCBuddy2, enProperty: RTC_PRESENCE_PROPERTY, pbstrProperty: ?*?BSTR) HRESULT {
        return self.vtable.get_PresenceProperty(self, enProperty, pbstrProperty);
    }
    pub inline fn EnumeratePresenceDevices(self: *const IRTCBuddy2, ppEnumDevices: ?*?*IRTCEnumPresenceDevices) HRESULT {
        return self.vtable.EnumeratePresenceDevices(self, ppEnumDevices);
    }
    pub inline fn get_PresenceDevices(self: *const IRTCBuddy2, ppDevicesCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_PresenceDevices(self, ppDevicesCollection);
    }
    pub inline fn get_SubscriptionType(self: *const IRTCBuddy2, penSubscriptionType: ?*RTC_BUDDY_SUBSCRIPTION_TYPE) HRESULT {
...
pub const IRTCWatcher = extern union {
    ...
    IRTCPresenceContact: IRTCPresenceContact,
    IUnknown: IUnknown,
    pub inline fn get_State(self: *const IRTCWatcher, penState: ?*RTC_WATCHER_STATE) HRESULT {
        return self.vtable.get_State(self, penState);
    }
    pub inline fn put_State(self: *const IRTCWatcher, enState: RTC_WATCHER_STATE) HRESULT {
...
pub const IRTCWatcher2 = extern union {
    ...
    IRTCPresenceContact: IRTCPresenceContact,
    IUnknown: IUnknown,
    pub inline fn get_Profile(self: *const IRTCWatcher2, ppProfile: ?*?*IRTCProfile2) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_Scope(self: *const IRTCWatcher2, penScope: ?*RTC_ACE_SCOPE) HRESULT {
...
pub const IRTCBuddyGroup = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const IRTCBuddyGroup, pbstrGroupName: ?*?BSTR) HRESULT {
        return self.vtable.get_Name(self, pbstrGroupName);
    }
    pub inline fn put_Name(self: *const IRTCBuddyGroup, bstrGroupName: ?BSTR) HRESULT {
        return self.vtable.put_Name(self, bstrGroupName);
    }
    pub inline fn AddBuddy(self: *const IRTCBuddyGroup, pBuddy: ?*IRTCBuddy) HRESULT {
        return self.vtable.AddBuddy(self, pBuddy);
    }
    pub inline fn RemoveBuddy(self: *const IRTCBuddyGroup, pBuddy: ?*IRTCBuddy) HRESULT {
        return self.vtable.RemoveBuddy(self, pBuddy);
    }
    pub inline fn EnumerateBuddies(self: *const IRTCBuddyGroup, ppEnum: ?*?*IRTCEnumBuddies) HRESULT {
        return self.vtable.EnumerateBuddies(self, ppEnum);
    }
    pub inline fn get_Buddies(self: *const IRTCBuddyGroup, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Buddies(self, ppCollection);
    }
    pub inline fn get_Data(self: *const IRTCBuddyGroup, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.get_Data(self, pbstrData);
    }
    pub inline fn put_Data(self: *const IRTCBuddyGroup, bstrData: ?BSTR) HRESULT {
        return self.vtable.put_Data(self, bstrData);
    }
    pub inline fn get_Profile(self: *const IRTCBuddyGroup, ppProfile: ?*?*IRTCProfile2) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
};
...
pub const IRTCEventNotification = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Event(self: *const IRTCEventNotification, RTCEvent: RTC_EVENT, pEvent: ?*IDispatch) HRESULT {
...
pub const IRTCPortManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetMapping(self: *const IRTCPortManager, bstrRemoteAddress: ?BSTR, enPortType: RTC_PORT_TYPE, pbstrInternalLocalAddress: ?*?BSTR, plInternalLocalPort: ?*i32, pbstrExternalLocalAddress: ?*?BSTR, plExternalLocalPort: ?*i32) HRESULT {
    ...
    pub inline fn UpdateRemoteAddress(self: *const IRTCPortManager, bstrRemoteAddress: ?BSTR, bstrInternalLocalAddress: ?BSTR, lInternalLocalPort: i32, bstrExternalLocalAddress: ?BSTR, lExternalLocalPort: i32) HRESULT {
    ...
    pub inline fn ReleaseMapping(self: *const IRTCPortManager, bstrInternalLocalAddress: ?BSTR, lInternalLocalPort: i32, bstrExternalLocalAddress: ?BSTR, lExternalLocalAddress: i32) HRESULT {
...
pub const IRTCSessionPortManagement = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetPortManager(self: *const IRTCSessionPortManagement, pPortManager: ?*IRTCPortManager) HRESULT {
...
pub const IRTCClientPortManagement = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn StartListenAddressAndPort(self: *const IRTCClientPortManagement, bstrInternalLocalAddress: ?BSTR, lInternalLocalPort: i32) HRESULT {
        return self.vtable.StartListenAddressAndPort(self, bstrInternalLocalAddress, lInternalLocalPort);
    }
    pub inline fn StopListenAddressAndPort(self: *const IRTCClientPortManagement, bstrInternalLocalAddress: ?BSTR, lInternalLocalPort: i32) HRESULT {
        return self.vtable.StopListenAddressAndPort(self, bstrInternalLocalAddress, lInternalLocalPort);
    }
    pub inline fn GetPortRange(self: *const IRTCClientPortManagement, enPortType: RTC_PORT_TYPE, plMinValue: ?*i32, plMaxValue: ?*i32) HRESULT {
...
pub const IRTCUserSearch = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateQuery(self: *const IRTCUserSearch, ppQuery: ?*?*IRTCUserSearchQuery) HRESULT {
        return self.vtable.CreateQuery(self, ppQuery);
    }
    pub inline fn ExecuteSearch(self: *const IRTCUserSearch, pQuery: ?*IRTCUserSearchQuery, pProfile: ?*IRTCProfile, lCookie: isize) HRESULT {
...
pub const IRTCUserSearchQuery = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn put_SearchTerm(self: *const IRTCUserSearchQuery, bstrName: ?BSTR, bstrValue: ?BSTR) HRESULT {
        return self.vtable.put_SearchTerm(self, bstrName, bstrValue);
    }
    pub inline fn get_SearchTerm(self: *const IRTCUserSearchQuery, bstrName: ?BSTR, pbstrValue: ?*?BSTR) HRESULT {
        return self.vtable.get_SearchTerm(self, bstrName, pbstrValue);
    }
    pub inline fn get_SearchTerms(self: *const IRTCUserSearchQuery, pbstrNames: ?*?BSTR) HRESULT {
        return self.vtable.get_SearchTerms(self, pbstrNames);
    }
    pub inline fn put_SearchPreference(self: *const IRTCUserSearchQuery, enPreference: RTC_USER_SEARCH_PREFERENCE, lValue: i32) HRESULT {
        return self.vtable.put_SearchPreference(self, enPreference, lValue);
    }
    pub inline fn get_SearchPreference(self: *const IRTCUserSearchQuery, enPreference: RTC_USER_SEARCH_PREFERENCE, plValue: ?*i32) HRESULT {
        return self.vtable.get_SearchPreference(self, enPreference, plValue);
    }
    pub inline fn put_SearchDomain(self: *const IRTCUserSearchQuery, bstrDomain: ?BSTR) HRESULT {
        return self.vtable.put_SearchDomain(self, bstrDomain);
    }
    pub inline fn get_SearchDomain(self: *const IRTCUserSearchQuery, pbstrDomain: ?*?BSTR) HRESULT {
...
pub const IRTCUserSearchResult = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Value(self: *const IRTCUserSearchResult, enColumn: RTC_USER_SEARCH_COLUMN, pbstrValue: ?*?BSTR) HRESULT {
...
pub const IRTCEnumUserSearchResults = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumUserSearchResults, celt: u32, ppElements: [*]?*IRTCUserSearchResult, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumUserSearchResults) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumUserSearchResults, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumUserSearchResults, ppEnum: ?*?*IRTCEnumUserSearchResults) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCUserSearchResultsEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn EnumerateResults(self: *const IRTCUserSearchResultsEvent, ppEnum: ?*?*IRTCEnumUserSearchResults) HRESULT {
        return self.vtable.EnumerateResults(self, ppEnum);
    }
    pub inline fn get_Results(self: *const IRTCUserSearchResultsEvent, ppCollection: ?*?*IRTCCollection) HRESULT {
        return self.vtable.get_Results(self, ppCollection);
    }
    pub inline fn get_Profile(self: *const IRTCUserSearchResultsEvent, ppProfile: ?*?*IRTCProfile2) HRESULT {
        return self.vtable.get_Profile(self, ppProfile);
    }
    pub inline fn get_Query(self: *const IRTCUserSearchResultsEvent, ppQuery: ?*?*IRTCUserSearchQuery) HRESULT {
        return self.vtable.get_Query(self, ppQuery);
    }
    pub inline fn get_Cookie(self: *const IRTCUserSearchResultsEvent, plCookie: ?*isize) HRESULT {
        return self.vtable.get_Cookie(self, plCookie);
    }
    pub inline fn get_StatusCode(self: *const IRTCUserSearchResultsEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_MoreAvailable(self: *const IRTCUserSearchResultsEvent, pfMoreAvailable: ?*i16) HRESULT {
...
pub const IRTCSessionReferStatusEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCSessionReferStatusEvent, ppSession: ?*?*IRTCSession2) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_ReferStatus(self: *const IRTCSessionReferStatusEvent, penReferStatus: ?*RTC_SESSION_REFER_STATUS) HRESULT {
        return self.vtable.get_ReferStatus(self, penReferStatus);
    }
    pub inline fn get_StatusCode(self: *const IRTCSessionReferStatusEvent, plStatusCode: ?*i32) HRESULT {
        return self.vtable.get_StatusCode(self, plStatusCode);
    }
    pub inline fn get_StatusText(self: *const IRTCSessionReferStatusEvent, pbstrStatusText: ?*?BSTR) HRESULT {
        return self.vtable.get_StatusText(self, pbstrStatusText);
    }
};
...
pub const IRTCSessionReferredEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Session(self: *const IRTCSessionReferredEvent, ppSession: ?*?*IRTCSession2) HRESULT {
        return self.vtable.get_Session(self, ppSession);
    }
    pub inline fn get_ReferredByURI(self: *const IRTCSessionReferredEvent, pbstrReferredByURI: ?*?BSTR) HRESULT {
        return self.vtable.get_ReferredByURI(self, pbstrReferredByURI);
    }
    pub inline fn get_ReferToURI(self: *const IRTCSessionReferredEvent, pbstrReferoURI: ?*?BSTR) HRESULT {
        return self.vtable.get_ReferToURI(self, pbstrReferoURI);
    }
    pub inline fn get_ReferCookie(self: *const IRTCSessionReferredEvent, pbstrReferCookie: ?*?BSTR) HRESULT {
        return self.vtable.get_ReferCookie(self, pbstrReferCookie);
    }
    pub inline fn Accept(self: *const IRTCSessionReferredEvent) HRESULT {
        return self.vtable.Accept(self);
    }
    pub inline fn Reject(self: *const IRTCSessionReferredEvent) HRESULT {
        return self.vtable.Reject(self);
    }
    pub inline fn SetReferredSessionState(self: *const IRTCSessionReferredEvent, enState: RTC_SESSION_STATE) HRESULT {
...
pub const IRTCSessionDescriptionManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn EvaluateSessionDescription(self: *const IRTCSessionDescriptionManager, bstrContentType: ?BSTR, bstrSessionDescription: ?BSTR, pfApplicationSession: ?*i16) HRESULT {
...
pub const IRTCEnumPresenceDevices = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IRTCEnumPresenceDevices, celt: u32, ppElements: [*]?*IRTCPresenceDevice, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, ppElements, pceltFetched);
    }
    pub inline fn Reset(self: *const IRTCEnumPresenceDevices) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Skip(self: *const IRTCEnumPresenceDevices, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Clone(self: *const IRTCEnumPresenceDevices, ppEnum: ?*?*IRTCEnumPresenceDevices) HRESULT {
        return self.vtable.Clone(self, ppEnum);
    }
};
...
pub const IRTCPresenceDevice = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Status(self: *const IRTCPresenceDevice, penStatus: ?*RTC_PRESENCE_STATUS) HRESULT {
        return self.vtable.get_Status(self, penStatus);
    }
    pub inline fn get_Notes(self: *const IRTCPresenceDevice, pbstrNotes: ?*?BSTR) HRESULT {
        return self.vtable.get_Notes(self, pbstrNotes);
    }
    pub inline fn get_PresenceProperty(self: *const IRTCPresenceDevice, enProperty: RTC_PRESENCE_PROPERTY, pbstrProperty: ?*?BSTR) HRESULT {
        return self.vtable.get_PresenceProperty(self, enProperty, pbstrProperty);
    }
    pub inline fn GetPresenceData(self: *const IRTCPresenceDevice, pbstrNamespace: ?*?BSTR, pbstrData: ?*?BSTR) HRESULT {
        return self.vtable.GetPresenceData(self, pbstrNamespace, pbstrData);
    }
};
...
pub const ITransportSettingsInternal = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ApplySetting(self: *const ITransportSettingsInternal, Setting: ?*TRANSPORT_SETTING) HRESULT {
        return self.vtable.ApplySetting(self, Setting);
    }
    pub inline fn QuerySetting(self: *const ITransportSettingsInternal, Setting: ?*TRANSPORT_SETTING) HRESULT {
...
pub const INetworkTransportSettings = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ApplySetting(self: *const INetworkTransportSettings, SettingId: ?*const TRANSPORT_SETTING_ID, LengthIn: u32, ValueIn: [*:0]const u8, LengthOut: ?*u32, ValueOut: [*]?*u8) HRESULT {
        return self.vtable.ApplySetting(self, SettingId, LengthIn, ValueIn, LengthOut, ValueOut);
    }
    pub inline fn QuerySetting(self: *const INetworkTransportSettings, SettingId: ?*const TRANSPORT_SETTING_ID, LengthIn: u32, ValueIn: [*:0]const u8, LengthOut: ?*u32, ValueOut: [*]?*u8) HRESULT {
...
pub const INotificationTransportSync = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CompleteDelivery(self: *const INotificationTransportSync) HRESULT {
        return self.vtable.CompleteDelivery(self);
    }
    pub inline fn Flush(self: *const INotificationTransportSync) HRESULT {
