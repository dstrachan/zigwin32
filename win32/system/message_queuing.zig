...
pub const IMSMQQuery = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn LookupQueue(self: *const IMSMQQuery, QueueGuid: ?*VARIANT, ServiceTypeGuid: ?*VARIANT, Label: ?*VARIANT, CreateTime: ?*VARIANT, ModifyTime: ?*VARIANT, RelServiceType: ?*VARIANT, RelLabel: ?*VARIANT, RelCreateTime: ?*VARIANT, RelModifyTime: ?*VARIANT, ppqinfos: ?*?*IMSMQQueueInfos) HRESULT {
...
pub const IMSMQQueueInfo = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_QueueGuid(self: *const IMSMQQueueInfo, pbstrGuidQueue: ?*?BSTR) HRESULT {
        return self.vtable.get_QueueGuid(self, pbstrGuidQueue);
    }
    pub inline fn get_ServiceTypeGuid(self: *const IMSMQQueueInfo, pbstrGuidServiceType: ?*?BSTR) HRESULT {
        return self.vtable.get_ServiceTypeGuid(self, pbstrGuidServiceType);
    }
    pub inline fn put_ServiceTypeGuid(self: *const IMSMQQueueInfo, bstrGuidServiceType: ?BSTR) HRESULT {
        return self.vtable.put_ServiceTypeGuid(self, bstrGuidServiceType);
    }
    pub inline fn get_Label(self: *const IMSMQQueueInfo, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQQueueInfo, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_PathName(self: *const IMSMQQueueInfo, pbstrPathName: ?*?BSTR) HRESULT {
        return self.vtable.get_PathName(self, pbstrPathName);
    }
    pub inline fn put_PathName(self: *const IMSMQQueueInfo, bstrPathName: ?BSTR) HRESULT {
        return self.vtable.put_PathName(self, bstrPathName);
    }
    pub inline fn get_FormatName(self: *const IMSMQQueueInfo, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn put_FormatName(self: *const IMSMQQueueInfo, bstrFormatName: ?BSTR) HRESULT {
        return self.vtable.put_FormatName(self, bstrFormatName);
    }
    pub inline fn get_IsTransactional(self: *const IMSMQQueueInfo, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional(self, pisTransactional);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQQueueInfo, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQQueueInfo, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_Journal(self: *const IMSMQQueueInfo, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQQueueInfo, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_Quota(self: *const IMSMQQueueInfo, plQuota: ?*i32) HRESULT {
        return self.vtable.get_Quota(self, plQuota);
    }
    pub inline fn put_Quota(self: *const IMSMQQueueInfo, lQuota: i32) HRESULT {
        return self.vtable.put_Quota(self, lQuota);
    }
    pub inline fn get_BasePriority(self: *const IMSMQQueueInfo, plBasePriority: ?*i32) HRESULT {
        return self.vtable.get_BasePriority(self, plBasePriority);
    }
    pub inline fn put_BasePriority(self: *const IMSMQQueueInfo, lBasePriority: i32) HRESULT {
        return self.vtable.put_BasePriority(self, lBasePriority);
    }
    pub inline fn get_CreateTime(self: *const IMSMQQueueInfo, pvarCreateTime: ?*VARIANT) HRESULT {
        return self.vtable.get_CreateTime(self, pvarCreateTime);
    }
    pub inline fn get_ModifyTime(self: *const IMSMQQueueInfo, pvarModifyTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ModifyTime(self, pvarModifyTime);
    }
    pub inline fn get_Authenticate(self: *const IMSMQQueueInfo, plAuthenticate: ?*i32) HRESULT {
        return self.vtable.get_Authenticate(self, plAuthenticate);
    }
    pub inline fn put_Authenticate(self: *const IMSMQQueueInfo, lAuthenticate: i32) HRESULT {
        return self.vtable.put_Authenticate(self, lAuthenticate);
    }
    pub inline fn get_JournalQuota(self: *const IMSMQQueueInfo, plJournalQuota: ?*i32) HRESULT {
        return self.vtable.get_JournalQuota(self, plJournalQuota);
    }
    pub inline fn put_JournalQuota(self: *const IMSMQQueueInfo, lJournalQuota: i32) HRESULT {
        return self.vtable.put_JournalQuota(self, lJournalQuota);
    }
    pub inline fn get_IsWorldReadable(self: *const IMSMQQueueInfo, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable(self, pisWorldReadable);
    }
    pub inline fn Create(self: *const IMSMQQueueInfo, IsTransactional: ?*VARIANT, IsWorldReadable: ?*VARIANT) HRESULT {
        return self.vtable.Create(self, IsTransactional, IsWorldReadable);
    }
    pub inline fn Delete(self: *const IMSMQQueueInfo) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Open(self: *const IMSMQQueueInfo, Access: i32, ShareMode: i32, ppq: ?*?*IMSMQQueue) HRESULT {
        return self.vtable.Open(self, Access, ShareMode, ppq);
    }
    pub inline fn Refresh(self: *const IMSMQQueueInfo) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Update(self: *const IMSMQQueueInfo) HRESULT {
...
pub const IMSMQQueueInfo2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_QueueGuid(self: *const IMSMQQueueInfo2, pbstrGuidQueue: ?*?BSTR) HRESULT {
        return self.vtable.get_QueueGuid(self, pbstrGuidQueue);
    }
    pub inline fn get_ServiceTypeGuid(self: *const IMSMQQueueInfo2, pbstrGuidServiceType: ?*?BSTR) HRESULT {
        return self.vtable.get_ServiceTypeGuid(self, pbstrGuidServiceType);
    }
    pub inline fn put_ServiceTypeGuid(self: *const IMSMQQueueInfo2, bstrGuidServiceType: ?BSTR) HRESULT {
        return self.vtable.put_ServiceTypeGuid(self, bstrGuidServiceType);
    }
    pub inline fn get_Label(self: *const IMSMQQueueInfo2, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQQueueInfo2, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_PathName(self: *const IMSMQQueueInfo2, pbstrPathName: ?*?BSTR) HRESULT {
        return self.vtable.get_PathName(self, pbstrPathName);
    }
    pub inline fn put_PathName(self: *const IMSMQQueueInfo2, bstrPathName: ?BSTR) HRESULT {
        return self.vtable.put_PathName(self, bstrPathName);
    }
    pub inline fn get_FormatName(self: *const IMSMQQueueInfo2, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn put_FormatName(self: *const IMSMQQueueInfo2, bstrFormatName: ?BSTR) HRESULT {
        return self.vtable.put_FormatName(self, bstrFormatName);
    }
    pub inline fn get_IsTransactional(self: *const IMSMQQueueInfo2, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional(self, pisTransactional);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQQueueInfo2, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQQueueInfo2, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_Journal(self: *const IMSMQQueueInfo2, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQQueueInfo2, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_Quota(self: *const IMSMQQueueInfo2, plQuota: ?*i32) HRESULT {
        return self.vtable.get_Quota(self, plQuota);
    }
    pub inline fn put_Quota(self: *const IMSMQQueueInfo2, lQuota: i32) HRESULT {
        return self.vtable.put_Quota(self, lQuota);
    }
    pub inline fn get_BasePriority(self: *const IMSMQQueueInfo2, plBasePriority: ?*i32) HRESULT {
        return self.vtable.get_BasePriority(self, plBasePriority);
    }
    pub inline fn put_BasePriority(self: *const IMSMQQueueInfo2, lBasePriority: i32) HRESULT {
        return self.vtable.put_BasePriority(self, lBasePriority);
    }
    pub inline fn get_CreateTime(self: *const IMSMQQueueInfo2, pvarCreateTime: ?*VARIANT) HRESULT {
        return self.vtable.get_CreateTime(self, pvarCreateTime);
    }
    pub inline fn get_ModifyTime(self: *const IMSMQQueueInfo2, pvarModifyTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ModifyTime(self, pvarModifyTime);
    }
    pub inline fn get_Authenticate(self: *const IMSMQQueueInfo2, plAuthenticate: ?*i32) HRESULT {
        return self.vtable.get_Authenticate(self, plAuthenticate);
    }
    pub inline fn put_Authenticate(self: *const IMSMQQueueInfo2, lAuthenticate: i32) HRESULT {
        return self.vtable.put_Authenticate(self, lAuthenticate);
    }
    pub inline fn get_JournalQuota(self: *const IMSMQQueueInfo2, plJournalQuota: ?*i32) HRESULT {
        return self.vtable.get_JournalQuota(self, plJournalQuota);
    }
    pub inline fn put_JournalQuota(self: *const IMSMQQueueInfo2, lJournalQuota: i32) HRESULT {
        return self.vtable.put_JournalQuota(self, lJournalQuota);
    }
    pub inline fn get_IsWorldReadable(self: *const IMSMQQueueInfo2, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable(self, pisWorldReadable);
    }
    pub inline fn Create(self: *const IMSMQQueueInfo2, IsTransactional: ?*VARIANT, IsWorldReadable: ?*VARIANT) HRESULT {
        return self.vtable.Create(self, IsTransactional, IsWorldReadable);
    }
    pub inline fn Delete(self: *const IMSMQQueueInfo2) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Open(self: *const IMSMQQueueInfo2, Access: i32, ShareMode: i32, ppq: ?*?*IMSMQQueue2) HRESULT {
        return self.vtable.Open(self, Access, ShareMode, ppq);
    }
    pub inline fn Refresh(self: *const IMSMQQueueInfo2) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Update(self: *const IMSMQQueueInfo2) HRESULT {
        return self.vtable.Update(self);
    }
    pub inline fn get_PathNameDNS(self: *const IMSMQQueueInfo2, pbstrPathNameDNS: ?*?BSTR) HRESULT {
        return self.vtable.get_PathNameDNS(self, pbstrPathNameDNS);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfo2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_Security(self: *const IMSMQQueueInfo2, pvarSecurity: ?*VARIANT) HRESULT {
        return self.vtable.get_Security(self, pvarSecurity);
    }
    pub inline fn put_Security(self: *const IMSMQQueueInfo2, varSecurity: VARIANT) HRESULT {
...
pub const IMSMQQueueInfo3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_QueueGuid(self: *const IMSMQQueueInfo3, pbstrGuidQueue: ?*?BSTR) HRESULT {
        return self.vtable.get_QueueGuid(self, pbstrGuidQueue);
    }
    pub inline fn get_ServiceTypeGuid(self: *const IMSMQQueueInfo3, pbstrGuidServiceType: ?*?BSTR) HRESULT {
        return self.vtable.get_ServiceTypeGuid(self, pbstrGuidServiceType);
    }
    pub inline fn put_ServiceTypeGuid(self: *const IMSMQQueueInfo3, bstrGuidServiceType: ?BSTR) HRESULT {
        return self.vtable.put_ServiceTypeGuid(self, bstrGuidServiceType);
    }
    pub inline fn get_Label(self: *const IMSMQQueueInfo3, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQQueueInfo3, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_PathName(self: *const IMSMQQueueInfo3, pbstrPathName: ?*?BSTR) HRESULT {
        return self.vtable.get_PathName(self, pbstrPathName);
    }
    pub inline fn put_PathName(self: *const IMSMQQueueInfo3, bstrPathName: ?BSTR) HRESULT {
        return self.vtable.put_PathName(self, bstrPathName);
    }
    pub inline fn get_FormatName(self: *const IMSMQQueueInfo3, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn put_FormatName(self: *const IMSMQQueueInfo3, bstrFormatName: ?BSTR) HRESULT {
        return self.vtable.put_FormatName(self, bstrFormatName);
    }
    pub inline fn get_IsTransactional(self: *const IMSMQQueueInfo3, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional(self, pisTransactional);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQQueueInfo3, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQQueueInfo3, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_Journal(self: *const IMSMQQueueInfo3, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQQueueInfo3, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_Quota(self: *const IMSMQQueueInfo3, plQuota: ?*i32) HRESULT {
        return self.vtable.get_Quota(self, plQuota);
    }
    pub inline fn put_Quota(self: *const IMSMQQueueInfo3, lQuota: i32) HRESULT {
        return self.vtable.put_Quota(self, lQuota);
    }
    pub inline fn get_BasePriority(self: *const IMSMQQueueInfo3, plBasePriority: ?*i32) HRESULT {
        return self.vtable.get_BasePriority(self, plBasePriority);
    }
    pub inline fn put_BasePriority(self: *const IMSMQQueueInfo3, lBasePriority: i32) HRESULT {
        return self.vtable.put_BasePriority(self, lBasePriority);
    }
    pub inline fn get_CreateTime(self: *const IMSMQQueueInfo3, pvarCreateTime: ?*VARIANT) HRESULT {
        return self.vtable.get_CreateTime(self, pvarCreateTime);
    }
    pub inline fn get_ModifyTime(self: *const IMSMQQueueInfo3, pvarModifyTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ModifyTime(self, pvarModifyTime);
    }
    pub inline fn get_Authenticate(self: *const IMSMQQueueInfo3, plAuthenticate: ?*i32) HRESULT {
        return self.vtable.get_Authenticate(self, plAuthenticate);
    }
    pub inline fn put_Authenticate(self: *const IMSMQQueueInfo3, lAuthenticate: i32) HRESULT {
        return self.vtable.put_Authenticate(self, lAuthenticate);
    }
    pub inline fn get_JournalQuota(self: *const IMSMQQueueInfo3, plJournalQuota: ?*i32) HRESULT {
        return self.vtable.get_JournalQuota(self, plJournalQuota);
    }
    pub inline fn put_JournalQuota(self: *const IMSMQQueueInfo3, lJournalQuota: i32) HRESULT {
        return self.vtable.put_JournalQuota(self, lJournalQuota);
    }
    pub inline fn get_IsWorldReadable(self: *const IMSMQQueueInfo3, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable(self, pisWorldReadable);
    }
    pub inline fn Create(self: *const IMSMQQueueInfo3, IsTransactional: ?*VARIANT, IsWorldReadable: ?*VARIANT) HRESULT {
        return self.vtable.Create(self, IsTransactional, IsWorldReadable);
    }
    pub inline fn Delete(self: *const IMSMQQueueInfo3) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Open(self: *const IMSMQQueueInfo3, Access: i32, ShareMode: i32, ppq: ?*?*IMSMQQueue3) HRESULT {
        return self.vtable.Open(self, Access, ShareMode, ppq);
    }
    pub inline fn Refresh(self: *const IMSMQQueueInfo3) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Update(self: *const IMSMQQueueInfo3) HRESULT {
        return self.vtable.Update(self);
    }
    pub inline fn get_PathNameDNS(self: *const IMSMQQueueInfo3, pbstrPathNameDNS: ?*?BSTR) HRESULT {
        return self.vtable.get_PathNameDNS(self, pbstrPathNameDNS);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfo3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_Security(self: *const IMSMQQueueInfo3, pvarSecurity: ?*VARIANT) HRESULT {
        return self.vtable.get_Security(self, pvarSecurity);
    }
    pub inline fn put_Security(self: *const IMSMQQueueInfo3, varSecurity: VARIANT) HRESULT {
        return self.vtable.put_Security(self, varSecurity);
    }
    pub inline fn get_IsTransactional2(self: *const IMSMQQueueInfo3, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional2(self, pisTransactional);
    }
    pub inline fn get_IsWorldReadable2(self: *const IMSMQQueueInfo3, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable2(self, pisWorldReadable);
    }
    pub inline fn get_MulticastAddress(self: *const IMSMQQueueInfo3, pbstrMulticastAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_MulticastAddress(self, pbstrMulticastAddress);
    }
    pub inline fn put_MulticastAddress(self: *const IMSMQQueueInfo3, bstrMulticastAddress: ?BSTR) HRESULT {
        return self.vtable.put_MulticastAddress(self, bstrMulticastAddress);
    }
    pub inline fn get_ADsPath(self: *const IMSMQQueueInfo3, pbstrADsPath: ?*?BSTR) HRESULT {
...
pub const IMSMQQueueInfo4 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_QueueGuid(self: *const IMSMQQueueInfo4, pbstrGuidQueue: ?*?BSTR) HRESULT {
        return self.vtable.get_QueueGuid(self, pbstrGuidQueue);
    }
    pub inline fn get_ServiceTypeGuid(self: *const IMSMQQueueInfo4, pbstrGuidServiceType: ?*?BSTR) HRESULT {
        return self.vtable.get_ServiceTypeGuid(self, pbstrGuidServiceType);
    }
    pub inline fn put_ServiceTypeGuid(self: *const IMSMQQueueInfo4, bstrGuidServiceType: ?BSTR) HRESULT {
        return self.vtable.put_ServiceTypeGuid(self, bstrGuidServiceType);
    }
    pub inline fn get_Label(self: *const IMSMQQueueInfo4, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQQueueInfo4, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_PathName(self: *const IMSMQQueueInfo4, pbstrPathName: ?*?BSTR) HRESULT {
        return self.vtable.get_PathName(self, pbstrPathName);
    }
    pub inline fn put_PathName(self: *const IMSMQQueueInfo4, bstrPathName: ?BSTR) HRESULT {
        return self.vtable.put_PathName(self, bstrPathName);
    }
    pub inline fn get_FormatName(self: *const IMSMQQueueInfo4, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn put_FormatName(self: *const IMSMQQueueInfo4, bstrFormatName: ?BSTR) HRESULT {
        return self.vtable.put_FormatName(self, bstrFormatName);
    }
    pub inline fn get_IsTransactional(self: *const IMSMQQueueInfo4, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional(self, pisTransactional);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQQueueInfo4, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQQueueInfo4, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_Journal(self: *const IMSMQQueueInfo4, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQQueueInfo4, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_Quota(self: *const IMSMQQueueInfo4, plQuota: ?*i32) HRESULT {
        return self.vtable.get_Quota(self, plQuota);
    }
    pub inline fn put_Quota(self: *const IMSMQQueueInfo4, lQuota: i32) HRESULT {
        return self.vtable.put_Quota(self, lQuota);
    }
    pub inline fn get_BasePriority(self: *const IMSMQQueueInfo4, plBasePriority: ?*i32) HRESULT {
        return self.vtable.get_BasePriority(self, plBasePriority);
    }
    pub inline fn put_BasePriority(self: *const IMSMQQueueInfo4, lBasePriority: i32) HRESULT {
        return self.vtable.put_BasePriority(self, lBasePriority);
    }
    pub inline fn get_CreateTime(self: *const IMSMQQueueInfo4, pvarCreateTime: ?*VARIANT) HRESULT {
        return self.vtable.get_CreateTime(self, pvarCreateTime);
    }
    pub inline fn get_ModifyTime(self: *const IMSMQQueueInfo4, pvarModifyTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ModifyTime(self, pvarModifyTime);
    }
    pub inline fn get_Authenticate(self: *const IMSMQQueueInfo4, plAuthenticate: ?*i32) HRESULT {
        return self.vtable.get_Authenticate(self, plAuthenticate);
    }
    pub inline fn put_Authenticate(self: *const IMSMQQueueInfo4, lAuthenticate: i32) HRESULT {
        return self.vtable.put_Authenticate(self, lAuthenticate);
    }
    pub inline fn get_JournalQuota(self: *const IMSMQQueueInfo4, plJournalQuota: ?*i32) HRESULT {
        return self.vtable.get_JournalQuota(self, plJournalQuota);
    }
    pub inline fn put_JournalQuota(self: *const IMSMQQueueInfo4, lJournalQuota: i32) HRESULT {
        return self.vtable.put_JournalQuota(self, lJournalQuota);
    }
    pub inline fn get_IsWorldReadable(self: *const IMSMQQueueInfo4, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable(self, pisWorldReadable);
    }
    pub inline fn Create(self: *const IMSMQQueueInfo4, IsTransactional: ?*VARIANT, IsWorldReadable: ?*VARIANT) HRESULT {
        return self.vtable.Create(self, IsTransactional, IsWorldReadable);
    }
    pub inline fn Delete(self: *const IMSMQQueueInfo4) HRESULT {
        return self.vtable.Delete(self);
    }
    pub inline fn Open(self: *const IMSMQQueueInfo4, Access: i32, ShareMode: i32, ppq: ?*?*IMSMQQueue4) HRESULT {
        return self.vtable.Open(self, Access, ShareMode, ppq);
    }
    pub inline fn Refresh(self: *const IMSMQQueueInfo4) HRESULT {
        return self.vtable.Refresh(self);
    }
    pub inline fn Update(self: *const IMSMQQueueInfo4) HRESULT {
        return self.vtable.Update(self);
    }
    pub inline fn get_PathNameDNS(self: *const IMSMQQueueInfo4, pbstrPathNameDNS: ?*?BSTR) HRESULT {
        return self.vtable.get_PathNameDNS(self, pbstrPathNameDNS);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfo4, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_Security(self: *const IMSMQQueueInfo4, pvarSecurity: ?*VARIANT) HRESULT {
        return self.vtable.get_Security(self, pvarSecurity);
    }
    pub inline fn put_Security(self: *const IMSMQQueueInfo4, varSecurity: VARIANT) HRESULT {
        return self.vtable.put_Security(self, varSecurity);
    }
    pub inline fn get_IsTransactional2(self: *const IMSMQQueueInfo4, pisTransactional: ?*i16) HRESULT {
        return self.vtable.get_IsTransactional2(self, pisTransactional);
    }
    pub inline fn get_IsWorldReadable2(self: *const IMSMQQueueInfo4, pisWorldReadable: ?*i16) HRESULT {
        return self.vtable.get_IsWorldReadable2(self, pisWorldReadable);
    }
    pub inline fn get_MulticastAddress(self: *const IMSMQQueueInfo4, pbstrMulticastAddress: ?*?BSTR) HRESULT {
        return self.vtable.get_MulticastAddress(self, pbstrMulticastAddress);
    }
    pub inline fn put_MulticastAddress(self: *const IMSMQQueueInfo4, bstrMulticastAddress: ?BSTR) HRESULT {
        return self.vtable.put_MulticastAddress(self, bstrMulticastAddress);
    }
    pub inline fn get_ADsPath(self: *const IMSMQQueueInfo4, pbstrADsPath: ?*?BSTR) HRESULT {
        return self.vtable.get_ADsPath(self, pbstrADsPath);
    }
};
...
pub const IMSMQQueue = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Access(self: *const IMSMQQueue, plAccess: ?*i32) HRESULT {
        return self.vtable.get_Access(self, plAccess);
    }
    pub inline fn get_ShareMode(self: *const IMSMQQueue, plShareMode: ?*i32) HRESULT {
        return self.vtable.get_ShareMode(self, plShareMode);
    }
    pub inline fn get_QueueInfo(self: *const IMSMQQueue, ppqinfo: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_QueueInfo(self, ppqinfo);
    }
    pub inline fn get_Handle(self: *const IMSMQQueue, plHandle: ?*i32) HRESULT {
        return self.vtable.get_Handle(self, plHandle);
    }
    pub inline fn get_IsOpen(self: *const IMSMQQueue, pisOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen(self, pisOpen);
    }
    pub inline fn Close(self: *const IMSMQQueue) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn Receive(self: *const IMSMQQueue, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Receive(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Peek(self: *const IMSMQQueue, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Peek(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn EnableNotification(self: *const IMSMQQueue, Event: ?*IMSMQEvent, Cursor: ?*VARIANT, ReceiveTimeout: ?*VARIANT) HRESULT {
        return self.vtable.EnableNotification(self, Event, Cursor, ReceiveTimeout);
    }
    pub inline fn Reset(self: *const IMSMQQueue) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn ReceiveCurrent(self: *const IMSMQQueue, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.ReceiveCurrent(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekNext(self: *const IMSMQQueue, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekNext(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekCurrent(self: *const IMSMQQueue, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
...
pub const IMSMQQueue2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Access(self: *const IMSMQQueue2, plAccess: ?*i32) HRESULT {
        return self.vtable.get_Access(self, plAccess);
    }
    pub inline fn get_ShareMode(self: *const IMSMQQueue2, plShareMode: ?*i32) HRESULT {
        return self.vtable.get_ShareMode(self, plShareMode);
    }
    pub inline fn get_QueueInfo(self: *const IMSMQQueue2, ppqinfo: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_QueueInfo(self, ppqinfo);
    }
    pub inline fn get_Handle(self: *const IMSMQQueue2, plHandle: ?*i32) HRESULT {
        return self.vtable.get_Handle(self, plHandle);
    }
    pub inline fn get_IsOpen(self: *const IMSMQQueue2, pisOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen(self, pisOpen);
    }
    pub inline fn Close(self: *const IMSMQQueue2) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn Receive_v1(self: *const IMSMQQueue2, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Receive_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Peek_v1(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Peek_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn EnableNotification(self: *const IMSMQQueue2, Event: ?*IMSMQEvent2, Cursor: ?*VARIANT, ReceiveTimeout: ?*VARIANT) HRESULT {
        return self.vtable.EnableNotification(self, Event, Cursor, ReceiveTimeout);
    }
    pub inline fn Reset(self: *const IMSMQQueue2) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn ReceiveCurrent_v1(self: *const IMSMQQueue2, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.ReceiveCurrent_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekNext_v1(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekNext_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekCurrent_v1(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekCurrent_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Receive(self: *const IMSMQQueue2, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage2) HRESULT {
        return self.vtable.Receive(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn Peek(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage2) HRESULT {
        return self.vtable.Peek(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveCurrent(self: *const IMSMQQueue2, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage2) HRESULT {
        return self.vtable.ReceiveCurrent(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekNext(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage2) HRESULT {
        return self.vtable.PeekNext(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekCurrent(self: *const IMSMQQueue2, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage2) HRESULT {
        return self.vtable.PeekCurrent(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn get_Properties(self: *const IMSMQQueue2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQQueue3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Access(self: *const IMSMQQueue3, plAccess: ?*i32) HRESULT {
        return self.vtable.get_Access(self, plAccess);
    }
    pub inline fn get_ShareMode(self: *const IMSMQQueue3, plShareMode: ?*i32) HRESULT {
        return self.vtable.get_ShareMode(self, plShareMode);
    }
    pub inline fn get_QueueInfo(self: *const IMSMQQueue3, ppqinfo: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.get_QueueInfo(self, ppqinfo);
    }
    pub inline fn get_Handle(self: *const IMSMQQueue3, plHandle: ?*i32) HRESULT {
        return self.vtable.get_Handle(self, plHandle);
    }
    pub inline fn get_IsOpen(self: *const IMSMQQueue3, pisOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen(self, pisOpen);
    }
    pub inline fn Close(self: *const IMSMQQueue3) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn Receive_v1(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Receive_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Peek_v1(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Peek_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn EnableNotification(self: *const IMSMQQueue3, Event: ?*IMSMQEvent3, Cursor: ?*VARIANT, ReceiveTimeout: ?*VARIANT) HRESULT {
        return self.vtable.EnableNotification(self, Event, Cursor, ReceiveTimeout);
    }
    pub inline fn Reset(self: *const IMSMQQueue3) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn ReceiveCurrent_v1(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.ReceiveCurrent_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekNext_v1(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekNext_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekCurrent_v1(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekCurrent_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Receive(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.Receive(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn Peek(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.Peek(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveCurrent(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.ReceiveCurrent(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekNext(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekNext(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekCurrent(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekCurrent(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn get_Properties(self: *const IMSMQQueue3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_Handle2(self: *const IMSMQQueue3, pvarHandle: ?*VARIANT) HRESULT {
        return self.vtable.get_Handle2(self, pvarHandle);
    }
    pub inline fn ReceiveByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.ReceiveByLookupId(self, LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveNextByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.ReceiveNextByLookupId(self, LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceivePreviousByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
    ...
    pub inline fn ReceiveFirstByLookupId(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.ReceiveFirstByLookupId(self, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveLastByLookupId(self: *const IMSMQQueue3, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.ReceiveLastByLookupId(self, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekNextByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekNextByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekPreviousByLookupId(self: *const IMSMQQueue3, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekPreviousByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekFirstByLookupId(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekFirstByLookupId(self, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekLastByLookupId(self: *const IMSMQQueue3, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage3) HRESULT {
        return self.vtable.PeekLastByLookupId(self, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn Purge(self: *const IMSMQQueue3) HRESULT {
        return self.vtable.Purge(self);
    }
    pub inline fn get_IsOpen2(self: *const IMSMQQueue3, pisOpen: ?*i16) HRESULT {
...
pub const IMSMQQueue4 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Access(self: *const IMSMQQueue4, plAccess: ?*i32) HRESULT {
        return self.vtable.get_Access(self, plAccess);
    }
    pub inline fn get_ShareMode(self: *const IMSMQQueue4, plShareMode: ?*i32) HRESULT {
        return self.vtable.get_ShareMode(self, plShareMode);
    }
    pub inline fn get_QueueInfo(self: *const IMSMQQueue4, ppqinfo: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.get_QueueInfo(self, ppqinfo);
    }
    pub inline fn get_Handle(self: *const IMSMQQueue4, plHandle: ?*i32) HRESULT {
        return self.vtable.get_Handle(self, plHandle);
    }
    pub inline fn get_IsOpen(self: *const IMSMQQueue4, pisOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen(self, pisOpen);
    }
    pub inline fn Close(self: *const IMSMQQueue4) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn Receive_v1(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Receive_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Peek_v1(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.Peek_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn EnableNotification(self: *const IMSMQQueue4, Event: ?*IMSMQEvent3, Cursor: ?*VARIANT, ReceiveTimeout: ?*VARIANT) HRESULT {
        return self.vtable.EnableNotification(self, Event, Cursor, ReceiveTimeout);
    }
    pub inline fn Reset(self: *const IMSMQQueue4) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn ReceiveCurrent_v1(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.ReceiveCurrent_v1(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekNext_v1(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekNext_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn PeekCurrent_v1(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, ppmsg: ?*?*IMSMQMessage) HRESULT {
        return self.vtable.PeekCurrent_v1(self, WantDestinationQueue, WantBody, ReceiveTimeout, ppmsg);
    }
    pub inline fn Receive(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.Receive(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn Peek(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.Peek(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveCurrent(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceiveCurrent(self, Transaction, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekNext(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekNext(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn PeekCurrent(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, ReceiveTimeout: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekCurrent(self, WantDestinationQueue, WantBody, ReceiveTimeout, WantConnectorType, ppmsg);
    }
    pub inline fn get_Properties(self: *const IMSMQQueue4, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_Handle2(self: *const IMSMQQueue4, pvarHandle: ?*VARIANT) HRESULT {
        return self.vtable.get_Handle2(self, pvarHandle);
    }
    pub inline fn ReceiveByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceiveByLookupId(self, LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveNextByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceiveNextByLookupId(self, LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceivePreviousByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceivePreviousByLookupId(self, LookupId, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveFirstByLookupId(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceiveFirstByLookupId(self, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn ReceiveLastByLookupId(self: *const IMSMQQueue4, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.ReceiveLastByLookupId(self, Transaction, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekNextByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekNextByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekPreviousByLookupId(self: *const IMSMQQueue4, LookupId: VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekPreviousByLookupId(self, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekFirstByLookupId(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekFirstByLookupId(self, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn PeekLastByLookupId(self: *const IMSMQQueue4, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
        return self.vtable.PeekLastByLookupId(self, WantDestinationQueue, WantBody, WantConnectorType, ppmsg);
    }
    pub inline fn Purge(self: *const IMSMQQueue4) HRESULT {
        return self.vtable.Purge(self);
    }
    pub inline fn get_IsOpen2(self: *const IMSMQQueue4, pisOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen2(self, pisOpen);
    }
    pub inline fn ReceiveByLookupIdAllowPeek(self: *const IMSMQQueue4, LookupId: VARIANT, Transaction: ?*VARIANT, WantDestinationQueue: ?*VARIANT, WantBody: ?*VARIANT, WantConnectorType: ?*VARIANT, ppmsg: ?*?*IMSMQMessage4) HRESULT {
...
pub const IMSMQMessage = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Class(self: *const IMSMQMessage, plClass: ?*i32) HRESULT {
        return self.vtable.get_Class(self, plClass);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQMessage, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQMessage, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_AuthLevel(self: *const IMSMQMessage, plAuthLevel: ?*i32) HRESULT {
        return self.vtable.get_AuthLevel(self, plAuthLevel);
    }
    pub inline fn put_AuthLevel(self: *const IMSMQMessage, lAuthLevel: i32) HRESULT {
        return self.vtable.put_AuthLevel(self, lAuthLevel);
    }
    pub inline fn get_IsAuthenticated(self: *const IMSMQMessage, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated(self, pisAuthenticated);
    }
    pub inline fn get_Delivery(self: *const IMSMQMessage, plDelivery: ?*i32) HRESULT {
        return self.vtable.get_Delivery(self, plDelivery);
    }
    pub inline fn put_Delivery(self: *const IMSMQMessage, lDelivery: i32) HRESULT {
        return self.vtable.put_Delivery(self, lDelivery);
    }
    pub inline fn get_Trace(self: *const IMSMQMessage, plTrace: ?*i32) HRESULT {
        return self.vtable.get_Trace(self, plTrace);
    }
    pub inline fn put_Trace(self: *const IMSMQMessage, lTrace: i32) HRESULT {
        return self.vtable.put_Trace(self, lTrace);
    }
    pub inline fn get_Priority(self: *const IMSMQMessage, plPriority: ?*i32) HRESULT {
        return self.vtable.get_Priority(self, plPriority);
    }
    pub inline fn put_Priority(self: *const IMSMQMessage, lPriority: i32) HRESULT {
        return self.vtable.put_Priority(self, lPriority);
    }
    pub inline fn get_Journal(self: *const IMSMQMessage, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQMessage, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_ResponseQueueInfo(self: *const IMSMQMessage, ppqinfoResponse: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_ResponseQueueInfo(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo(self: *const IMSMQMessage, pqinfoResponse: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_ResponseQueueInfo(self, pqinfoResponse);
    }
    pub inline fn get_AppSpecific(self: *const IMSMQMessage, plAppSpecific: ?*i32) HRESULT {
        return self.vtable.get_AppSpecific(self, plAppSpecific);
    }
    pub inline fn put_AppSpecific(self: *const IMSMQMessage, lAppSpecific: i32) HRESULT {
        return self.vtable.put_AppSpecific(self, lAppSpecific);
    }
    pub inline fn get_SourceMachineGuid(self: *const IMSMQMessage, pbstrGuidSrcMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_SourceMachineGuid(self, pbstrGuidSrcMachine);
    }
    pub inline fn get_BodyLength(self: *const IMSMQMessage, pcbBody: ?*i32) HRESULT {
        return self.vtable.get_BodyLength(self, pcbBody);
    }
    pub inline fn get_Body(self: *const IMSMQMessage, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_Body(self, pvarBody);
    }
    pub inline fn put_Body(self: *const IMSMQMessage, varBody: VARIANT) HRESULT {
        return self.vtable.put_Body(self, varBody);
    }
    pub inline fn get_AdminQueueInfo(self: *const IMSMQMessage, ppqinfoAdmin: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_AdminQueueInfo(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo(self: *const IMSMQMessage, pqinfoAdmin: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_AdminQueueInfo(self, pqinfoAdmin);
    }
    pub inline fn get_Id(self: *const IMSMQMessage, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_Id(self, pvarMsgId);
    }
    pub inline fn get_CorrelationId(self: *const IMSMQMessage, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_CorrelationId(self, pvarMsgId);
    }
    pub inline fn put_CorrelationId(self: *const IMSMQMessage, varMsgId: VARIANT) HRESULT {
        return self.vtable.put_CorrelationId(self, varMsgId);
    }
    pub inline fn get_Ack(self: *const IMSMQMessage, plAck: ?*i32) HRESULT {
        return self.vtable.get_Ack(self, plAck);
    }
    pub inline fn put_Ack(self: *const IMSMQMessage, lAck: i32) HRESULT {
        return self.vtable.put_Ack(self, lAck);
    }
    pub inline fn get_Label(self: *const IMSMQMessage, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQMessage, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_MaxTimeToReachQueue(self: *const IMSMQMessage, plMaxTimeToReachQueue: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReachQueue(self, plMaxTimeToReachQueue);
    }
    pub inline fn put_MaxTimeToReachQueue(self: *const IMSMQMessage, lMaxTimeToReachQueue: i32) HRESULT {
        return self.vtable.put_MaxTimeToReachQueue(self, lMaxTimeToReachQueue);
    }
    pub inline fn get_MaxTimeToReceive(self: *const IMSMQMessage, plMaxTimeToReceive: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReceive(self, plMaxTimeToReceive);
    }
    pub inline fn put_MaxTimeToReceive(self: *const IMSMQMessage, lMaxTimeToReceive: i32) HRESULT {
        return self.vtable.put_MaxTimeToReceive(self, lMaxTimeToReceive);
    }
    pub inline fn get_HashAlgorithm(self: *const IMSMQMessage, plHashAlg: ?*i32) HRESULT {
        return self.vtable.get_HashAlgorithm(self, plHashAlg);
    }
    pub inline fn put_HashAlgorithm(self: *const IMSMQMessage, lHashAlg: i32) HRESULT {
        return self.vtable.put_HashAlgorithm(self, lHashAlg);
    }
    pub inline fn get_EncryptAlgorithm(self: *const IMSMQMessage, plEncryptAlg: ?*i32) HRESULT {
        return self.vtable.get_EncryptAlgorithm(self, plEncryptAlg);
    }
    pub inline fn put_EncryptAlgorithm(self: *const IMSMQMessage, lEncryptAlg: i32) HRESULT {
        return self.vtable.put_EncryptAlgorithm(self, lEncryptAlg);
    }
    pub inline fn get_SentTime(self: *const IMSMQMessage, pvarSentTime: ?*VARIANT) HRESULT {
        return self.vtable.get_SentTime(self, pvarSentTime);
    }
    pub inline fn get_ArrivedTime(self: *const IMSMQMessage, plArrivedTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ArrivedTime(self, plArrivedTime);
    }
    pub inline fn get_DestinationQueueInfo(self: *const IMSMQMessage, ppqinfoDest: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_DestinationQueueInfo(self, ppqinfoDest);
    }
    pub inline fn get_SenderCertificate(self: *const IMSMQMessage, pvarSenderCert: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderCertificate(self, pvarSenderCert);
    }
    pub inline fn put_SenderCertificate(self: *const IMSMQMessage, varSenderCert: VARIANT) HRESULT {
        return self.vtable.put_SenderCertificate(self, varSenderCert);
    }
    pub inline fn get_SenderId(self: *const IMSMQMessage, pvarSenderId: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderId(self, pvarSenderId);
    }
    pub inline fn get_SenderIdType(self: *const IMSMQMessage, plSenderIdType: ?*i32) HRESULT {
        return self.vtable.get_SenderIdType(self, plSenderIdType);
    }
    pub inline fn put_SenderIdType(self: *const IMSMQMessage, lSenderIdType: i32) HRESULT {
        return self.vtable.put_SenderIdType(self, lSenderIdType);
    }
    pub inline fn Send(self: *const IMSMQMessage, DestinationQueue: ?*IMSMQQueue, Transaction: ?*VARIANT) HRESULT {
        return self.vtable.Send(self, DestinationQueue, Transaction);
    }
    pub inline fn AttachCurrentSecurityContext(self: *const IMSMQMessage) HRESULT {
...
pub const IMSMQQueueInfos = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IMSMQQueueInfos) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IMSMQQueueInfos, ppqinfoNext: ?*?*IMSMQQueueInfo) HRESULT {
...
pub const IMSMQQueueInfos2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IMSMQQueueInfos2) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IMSMQQueueInfos2, ppqinfoNext: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.Next(self, ppqinfoNext);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfos2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQQueueInfos3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IMSMQQueueInfos3) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IMSMQQueueInfos3, ppqinfoNext: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.Next(self, ppqinfoNext);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfos3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQQueueInfos4 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IMSMQQueueInfos4) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Next(self: *const IMSMQQueueInfos4, ppqinfoNext: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.Next(self, ppqinfoNext);
    }
    pub inline fn get_Properties(self: *const IMSMQQueueInfos4, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQEvent2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Properties(self: *const IMSMQEvent2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQTransaction = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Transaction(self: *const IMSMQTransaction, plTransaction: ?*i32) HRESULT {
        return self.vtable.get_Transaction(self, plTransaction);
    }
    pub inline fn Commit(self: *const IMSMQTransaction, fRetaining: ?*VARIANT, grfTC: ?*VARIANT, grfRM: ?*VARIANT) HRESULT {
        return self.vtable.Commit(self, fRetaining, grfTC, grfRM);
    }
    pub inline fn Abort(self: *const IMSMQTransaction, fRetaining: ?*VARIANT, fAsync: ?*VARIANT) HRESULT {
...
pub const IMSMQCoordinatedTransactionDispenser = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQCoordinatedTransactionDispenser, ptransaction: ?*?*IMSMQTransaction) HRESULT {
...
pub const IMSMQTransactionDispenser = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQTransactionDispenser, ptransaction: ?*?*IMSMQTransaction) HRESULT {
        return self.vtable.BeginTransaction(self, ptransaction);
    }
};
...
pub const IMSMQQuery2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn LookupQueue(self: *const IMSMQQuery2, QueueGuid: ?*VARIANT, ServiceTypeGuid: ?*VARIANT, Label: ?*VARIANT, CreateTime: ?*VARIANT, ModifyTime: ?*VARIANT, RelServiceType: ?*VARIANT, RelLabel: ?*VARIANT, RelCreateTime: ?*VARIANT, RelModifyTime: ?*VARIANT, ppqinfos: ?*?*IMSMQQueueInfos2) HRESULT {
        return self.vtable.LookupQueue(self, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime, RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos);
    }
    pub inline fn get_Properties(self: *const IMSMQQuery2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQQuery3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn LookupQueue_v2(self: *const IMSMQQuery3, QueueGuid: ?*VARIANT, ServiceTypeGuid: ?*VARIANT, Label: ?*VARIANT, CreateTime: ?*VARIANT, ModifyTime: ?*VARIANT, RelServiceType: ?*VARIANT, RelLabel: ?*VARIANT, RelCreateTime: ?*VARIANT, RelModifyTime: ?*VARIANT, ppqinfos: ?*?*IMSMQQueueInfos3) HRESULT {
...
pub const IMSMQQuery4 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn LookupQueue_v2(self: *const IMSMQQuery4, QueueGuid: ?*VARIANT, ServiceTypeGuid: ?*VARIANT, Label: ?*VARIANT, CreateTime: ?*VARIANT, ModifyTime: ?*VARIANT, RelServiceType: ?*VARIANT, RelLabel: ?*VARIANT, RelCreateTime: ?*VARIANT, RelModifyTime: ?*VARIANT, ppqinfos: ?*?*IMSMQQueueInfos4) HRESULT {
        return self.vtable.LookupQueue_v2(self, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime, RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos);
    }
    pub inline fn get_Properties(self: *const IMSMQQuery4, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn LookupQueue(self: *const IMSMQQuery4, QueueGuid: ?*VARIANT, ServiceTypeGuid: ?*VARIANT, Label: ?*VARIANT, CreateTime: ?*VARIANT, ModifyTime: ?*VARIANT, RelServiceType: ?*VARIANT, RelLabel: ?*VARIANT, RelCreateTime: ?*VARIANT, RelModifyTime: ?*VARIANT, MulticastAddress: ?*VARIANT, RelMulticastAddress: ?*VARIANT, ppqinfos: ?*?*IMSMQQueueInfos4) HRESULT {
        return self.vtable.LookupQueue(self, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime, RelServiceType, RelLabel, RelCreateTime, RelModifyTime, MulticastAddress, RelMulticastAddress, ppqinfos);
    }
};
...
pub const IMSMQMessage2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Class(self: *const IMSMQMessage2, plClass: ?*i32) HRESULT {
        return self.vtable.get_Class(self, plClass);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQMessage2, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQMessage2, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_AuthLevel(self: *const IMSMQMessage2, plAuthLevel: ?*i32) HRESULT {
        return self.vtable.get_AuthLevel(self, plAuthLevel);
    }
    pub inline fn put_AuthLevel(self: *const IMSMQMessage2, lAuthLevel: i32) HRESULT {
        return self.vtable.put_AuthLevel(self, lAuthLevel);
    }
    pub inline fn get_IsAuthenticated(self: *const IMSMQMessage2, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated(self, pisAuthenticated);
    }
    pub inline fn get_Delivery(self: *const IMSMQMessage2, plDelivery: ?*i32) HRESULT {
        return self.vtable.get_Delivery(self, plDelivery);
    }
    pub inline fn put_Delivery(self: *const IMSMQMessage2, lDelivery: i32) HRESULT {
        return self.vtable.put_Delivery(self, lDelivery);
    }
    pub inline fn get_Trace(self: *const IMSMQMessage2, plTrace: ?*i32) HRESULT {
        return self.vtable.get_Trace(self, plTrace);
    }
    pub inline fn put_Trace(self: *const IMSMQMessage2, lTrace: i32) HRESULT {
        return self.vtable.put_Trace(self, lTrace);
    }
    pub inline fn get_Priority(self: *const IMSMQMessage2, plPriority: ?*i32) HRESULT {
        return self.vtable.get_Priority(self, plPriority);
    }
    pub inline fn put_Priority(self: *const IMSMQMessage2, lPriority: i32) HRESULT {
        return self.vtable.put_Priority(self, lPriority);
    }
    pub inline fn get_Journal(self: *const IMSMQMessage2, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQMessage2, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_ResponseQueueInfo_v1(self: *const IMSMQMessage2, ppqinfoResponse: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_ResponseQueueInfo_v1(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo_v1(self: *const IMSMQMessage2, pqinfoResponse: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_ResponseQueueInfo_v1(self, pqinfoResponse);
    }
    pub inline fn get_AppSpecific(self: *const IMSMQMessage2, plAppSpecific: ?*i32) HRESULT {
        return self.vtable.get_AppSpecific(self, plAppSpecific);
    }
    pub inline fn put_AppSpecific(self: *const IMSMQMessage2, lAppSpecific: i32) HRESULT {
        return self.vtable.put_AppSpecific(self, lAppSpecific);
    }
    pub inline fn get_SourceMachineGuid(self: *const IMSMQMessage2, pbstrGuidSrcMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_SourceMachineGuid(self, pbstrGuidSrcMachine);
    }
    pub inline fn get_BodyLength(self: *const IMSMQMessage2, pcbBody: ?*i32) HRESULT {
        return self.vtable.get_BodyLength(self, pcbBody);
    }
    pub inline fn get_Body(self: *const IMSMQMessage2, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_Body(self, pvarBody);
    }
    pub inline fn put_Body(self: *const IMSMQMessage2, varBody: VARIANT) HRESULT {
        return self.vtable.put_Body(self, varBody);
    }
    pub inline fn get_AdminQueueInfo_v1(self: *const IMSMQMessage2, ppqinfoAdmin: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_AdminQueueInfo_v1(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo_v1(self: *const IMSMQMessage2, pqinfoAdmin: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_AdminQueueInfo_v1(self, pqinfoAdmin);
    }
    pub inline fn get_Id(self: *const IMSMQMessage2, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_Id(self, pvarMsgId);
    }
    pub inline fn get_CorrelationId(self: *const IMSMQMessage2, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_CorrelationId(self, pvarMsgId);
    }
    pub inline fn put_CorrelationId(self: *const IMSMQMessage2, varMsgId: VARIANT) HRESULT {
        return self.vtable.put_CorrelationId(self, varMsgId);
    }
    pub inline fn get_Ack(self: *const IMSMQMessage2, plAck: ?*i32) HRESULT {
        return self.vtable.get_Ack(self, plAck);
    }
    pub inline fn put_Ack(self: *const IMSMQMessage2, lAck: i32) HRESULT {
        return self.vtable.put_Ack(self, lAck);
    }
    pub inline fn get_Label(self: *const IMSMQMessage2, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQMessage2, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_MaxTimeToReachQueue(self: *const IMSMQMessage2, plMaxTimeToReachQueue: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReachQueue(self, plMaxTimeToReachQueue);
    }
    pub inline fn put_MaxTimeToReachQueue(self: *const IMSMQMessage2, lMaxTimeToReachQueue: i32) HRESULT {
        return self.vtable.put_MaxTimeToReachQueue(self, lMaxTimeToReachQueue);
    }
    pub inline fn get_MaxTimeToReceive(self: *const IMSMQMessage2, plMaxTimeToReceive: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReceive(self, plMaxTimeToReceive);
    }
    pub inline fn put_MaxTimeToReceive(self: *const IMSMQMessage2, lMaxTimeToReceive: i32) HRESULT {
        return self.vtable.put_MaxTimeToReceive(self, lMaxTimeToReceive);
    }
    pub inline fn get_HashAlgorithm(self: *const IMSMQMessage2, plHashAlg: ?*i32) HRESULT {
        return self.vtable.get_HashAlgorithm(self, plHashAlg);
    }
    pub inline fn put_HashAlgorithm(self: *const IMSMQMessage2, lHashAlg: i32) HRESULT {
        return self.vtable.put_HashAlgorithm(self, lHashAlg);
    }
    pub inline fn get_EncryptAlgorithm(self: *const IMSMQMessage2, plEncryptAlg: ?*i32) HRESULT {
        return self.vtable.get_EncryptAlgorithm(self, plEncryptAlg);
    }
    pub inline fn put_EncryptAlgorithm(self: *const IMSMQMessage2, lEncryptAlg: i32) HRESULT {
        return self.vtable.put_EncryptAlgorithm(self, lEncryptAlg);
    }
    pub inline fn get_SentTime(self: *const IMSMQMessage2, pvarSentTime: ?*VARIANT) HRESULT {
        return self.vtable.get_SentTime(self, pvarSentTime);
    }
    pub inline fn get_ArrivedTime(self: *const IMSMQMessage2, plArrivedTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ArrivedTime(self, plArrivedTime);
    }
    pub inline fn get_DestinationQueueInfo(self: *const IMSMQMessage2, ppqinfoDest: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_DestinationQueueInfo(self, ppqinfoDest);
    }
    pub inline fn get_SenderCertificate(self: *const IMSMQMessage2, pvarSenderCert: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderCertificate(self, pvarSenderCert);
    }
    pub inline fn put_SenderCertificate(self: *const IMSMQMessage2, varSenderCert: VARIANT) HRESULT {
        return self.vtable.put_SenderCertificate(self, varSenderCert);
    }
    pub inline fn get_SenderId(self: *const IMSMQMessage2, pvarSenderId: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderId(self, pvarSenderId);
    }
    pub inline fn get_SenderIdType(self: *const IMSMQMessage2, plSenderIdType: ?*i32) HRESULT {
        return self.vtable.get_SenderIdType(self, plSenderIdType);
    }
    pub inline fn put_SenderIdType(self: *const IMSMQMessage2, lSenderIdType: i32) HRESULT {
        return self.vtable.put_SenderIdType(self, lSenderIdType);
    }
    pub inline fn Send(self: *const IMSMQMessage2, DestinationQueue: ?*IMSMQQueue2, Transaction: ?*VARIANT) HRESULT {
        return self.vtable.Send(self, DestinationQueue, Transaction);
    }
    pub inline fn AttachCurrentSecurityContext(self: *const IMSMQMessage2) HRESULT {
        return self.vtable.AttachCurrentSecurityContext(self);
    }
    pub inline fn get_SenderVersion(self: *const IMSMQMessage2, plSenderVersion: ?*i32) HRESULT {
        return self.vtable.get_SenderVersion(self, plSenderVersion);
    }
    pub inline fn get_Extension(self: *const IMSMQMessage2, pvarExtension: ?*VARIANT) HRESULT {
        return self.vtable.get_Extension(self, pvarExtension);
    }
    pub inline fn put_Extension(self: *const IMSMQMessage2, varExtension: VARIANT) HRESULT {
        return self.vtable.put_Extension(self, varExtension);
    }
    pub inline fn get_ConnectorTypeGuid(self: *const IMSMQMessage2, pbstrGuidConnectorType: ?*?BSTR) HRESULT {
        return self.vtable.get_ConnectorTypeGuid(self, pbstrGuidConnectorType);
    }
    pub inline fn put_ConnectorTypeGuid(self: *const IMSMQMessage2, bstrGuidConnectorType: ?BSTR) HRESULT {
        return self.vtable.put_ConnectorTypeGuid(self, bstrGuidConnectorType);
    }
    pub inline fn get_TransactionStatusQueueInfo(self: *const IMSMQMessage2, ppqinfoXactStatus: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_TransactionStatusQueueInfo(self, ppqinfoXactStatus);
    }
    pub inline fn get_DestinationSymmetricKey(self: *const IMSMQMessage2, pvarDestSymmKey: ?*VARIANT) HRESULT {
        return self.vtable.get_DestinationSymmetricKey(self, pvarDestSymmKey);
    }
    pub inline fn put_DestinationSymmetricKey(self: *const IMSMQMessage2, varDestSymmKey: VARIANT) HRESULT {
        return self.vtable.put_DestinationSymmetricKey(self, varDestSymmKey);
    }
    pub inline fn get_Signature(self: *const IMSMQMessage2, pvarSignature: ?*VARIANT) HRESULT {
        return self.vtable.get_Signature(self, pvarSignature);
    }
    pub inline fn put_Signature(self: *const IMSMQMessage2, varSignature: VARIANT) HRESULT {
        return self.vtable.put_Signature(self, varSignature);
    }
    pub inline fn get_AuthenticationProviderType(self: *const IMSMQMessage2, plAuthProvType: ?*i32) HRESULT {
        return self.vtable.get_AuthenticationProviderType(self, plAuthProvType);
    }
    pub inline fn put_AuthenticationProviderType(self: *const IMSMQMessage2, lAuthProvType: i32) HRESULT {
        return self.vtable.put_AuthenticationProviderType(self, lAuthProvType);
    }
    pub inline fn get_AuthenticationProviderName(self: *const IMSMQMessage2, pbstrAuthProvName: ?*?BSTR) HRESULT {
        return self.vtable.get_AuthenticationProviderName(self, pbstrAuthProvName);
    }
    pub inline fn put_AuthenticationProviderName(self: *const IMSMQMessage2, bstrAuthProvName: ?BSTR) HRESULT {
        return self.vtable.put_AuthenticationProviderName(self, bstrAuthProvName);
    }
    pub inline fn put_SenderId(self: *const IMSMQMessage2, varSenderId: VARIANT) HRESULT {
        return self.vtable.put_SenderId(self, varSenderId);
    }
    pub inline fn get_MsgClass(self: *const IMSMQMessage2, plMsgClass: ?*i32) HRESULT {
        return self.vtable.get_MsgClass(self, plMsgClass);
    }
    pub inline fn put_MsgClass(self: *const IMSMQMessage2, lMsgClass: i32) HRESULT {
        return self.vtable.put_MsgClass(self, lMsgClass);
    }
    pub inline fn get_Properties(self: *const IMSMQMessage2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_TransactionId(self: *const IMSMQMessage2, pvarXactId: ?*VARIANT) HRESULT {
        return self.vtable.get_TransactionId(self, pvarXactId);
    }
    pub inline fn get_IsFirstInTransaction(self: *const IMSMQMessage2, pisFirstInXact: ?*i16) HRESULT {
        return self.vtable.get_IsFirstInTransaction(self, pisFirstInXact);
    }
    pub inline fn get_IsLastInTransaction(self: *const IMSMQMessage2, pisLastInXact: ?*i16) HRESULT {
        return self.vtable.get_IsLastInTransaction(self, pisLastInXact);
    }
    pub inline fn get_ResponseQueueInfo(self: *const IMSMQMessage2, ppqinfoResponse: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_ResponseQueueInfo(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo(self: *const IMSMQMessage2, pqinfoResponse: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_ResponseQueueInfo(self, pqinfoResponse);
    }
    pub inline fn get_AdminQueueInfo(self: *const IMSMQMessage2, ppqinfoAdmin: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_AdminQueueInfo(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo(self: *const IMSMQMessage2, pqinfoAdmin: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_AdminQueueInfo(self, pqinfoAdmin);
    }
    pub inline fn get_ReceivedAuthenticationLevel(self: *const IMSMQMessage2, psReceivedAuthenticationLevel: ?*i16) HRESULT {
...
pub const IMSMQMessage3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Class(self: *const IMSMQMessage3, plClass: ?*i32) HRESULT {
        return self.vtable.get_Class(self, plClass);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQMessage3, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQMessage3, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_AuthLevel(self: *const IMSMQMessage3, plAuthLevel: ?*i32) HRESULT {
        return self.vtable.get_AuthLevel(self, plAuthLevel);
    }
    pub inline fn put_AuthLevel(self: *const IMSMQMessage3, lAuthLevel: i32) HRESULT {
        return self.vtable.put_AuthLevel(self, lAuthLevel);
    }
    pub inline fn get_IsAuthenticated(self: *const IMSMQMessage3, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated(self, pisAuthenticated);
    }
    pub inline fn get_Delivery(self: *const IMSMQMessage3, plDelivery: ?*i32) HRESULT {
        return self.vtable.get_Delivery(self, plDelivery);
    }
    pub inline fn put_Delivery(self: *const IMSMQMessage3, lDelivery: i32) HRESULT {
        return self.vtable.put_Delivery(self, lDelivery);
    }
    pub inline fn get_Trace(self: *const IMSMQMessage3, plTrace: ?*i32) HRESULT {
        return self.vtable.get_Trace(self, plTrace);
    }
    pub inline fn put_Trace(self: *const IMSMQMessage3, lTrace: i32) HRESULT {
        return self.vtable.put_Trace(self, lTrace);
    }
    pub inline fn get_Priority(self: *const IMSMQMessage3, plPriority: ?*i32) HRESULT {
        return self.vtable.get_Priority(self, plPriority);
    }
    pub inline fn put_Priority(self: *const IMSMQMessage3, lPriority: i32) HRESULT {
        return self.vtable.put_Priority(self, lPriority);
    }
    pub inline fn get_Journal(self: *const IMSMQMessage3, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQMessage3, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_ResponseQueueInfo_v1(self: *const IMSMQMessage3, ppqinfoResponse: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_ResponseQueueInfo_v1(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo_v1(self: *const IMSMQMessage3, pqinfoResponse: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_ResponseQueueInfo_v1(self, pqinfoResponse);
    }
    pub inline fn get_AppSpecific(self: *const IMSMQMessage3, plAppSpecific: ?*i32) HRESULT {
        return self.vtable.get_AppSpecific(self, plAppSpecific);
    }
    pub inline fn put_AppSpecific(self: *const IMSMQMessage3, lAppSpecific: i32) HRESULT {
        return self.vtable.put_AppSpecific(self, lAppSpecific);
    }
    pub inline fn get_SourceMachineGuid(self: *const IMSMQMessage3, pbstrGuidSrcMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_SourceMachineGuid(self, pbstrGuidSrcMachine);
    }
    pub inline fn get_BodyLength(self: *const IMSMQMessage3, pcbBody: ?*i32) HRESULT {
        return self.vtable.get_BodyLength(self, pcbBody);
    }
    pub inline fn get_Body(self: *const IMSMQMessage3, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_Body(self, pvarBody);
    }
    pub inline fn put_Body(self: *const IMSMQMessage3, varBody: VARIANT) HRESULT {
        return self.vtable.put_Body(self, varBody);
    }
    pub inline fn get_AdminQueueInfo_v1(self: *const IMSMQMessage3, ppqinfoAdmin: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_AdminQueueInfo_v1(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo_v1(self: *const IMSMQMessage3, pqinfoAdmin: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_AdminQueueInfo_v1(self, pqinfoAdmin);
    }
    pub inline fn get_Id(self: *const IMSMQMessage3, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_Id(self, pvarMsgId);
    }
    pub inline fn get_CorrelationId(self: *const IMSMQMessage3, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_CorrelationId(self, pvarMsgId);
    }
    pub inline fn put_CorrelationId(self: *const IMSMQMessage3, varMsgId: VARIANT) HRESULT {
        return self.vtable.put_CorrelationId(self, varMsgId);
    }
    pub inline fn get_Ack(self: *const IMSMQMessage3, plAck: ?*i32) HRESULT {
        return self.vtable.get_Ack(self, plAck);
    }
    pub inline fn put_Ack(self: *const IMSMQMessage3, lAck: i32) HRESULT {
        return self.vtable.put_Ack(self, lAck);
    }
    pub inline fn get_Label(self: *const IMSMQMessage3, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQMessage3, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_MaxTimeToReachQueue(self: *const IMSMQMessage3, plMaxTimeToReachQueue: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReachQueue(self, plMaxTimeToReachQueue);
    }
    pub inline fn put_MaxTimeToReachQueue(self: *const IMSMQMessage3, lMaxTimeToReachQueue: i32) HRESULT {
        return self.vtable.put_MaxTimeToReachQueue(self, lMaxTimeToReachQueue);
    }
    pub inline fn get_MaxTimeToReceive(self: *const IMSMQMessage3, plMaxTimeToReceive: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReceive(self, plMaxTimeToReceive);
    }
    pub inline fn put_MaxTimeToReceive(self: *const IMSMQMessage3, lMaxTimeToReceive: i32) HRESULT {
        return self.vtable.put_MaxTimeToReceive(self, lMaxTimeToReceive);
    }
    pub inline fn get_HashAlgorithm(self: *const IMSMQMessage3, plHashAlg: ?*i32) HRESULT {
        return self.vtable.get_HashAlgorithm(self, plHashAlg);
    }
    pub inline fn put_HashAlgorithm(self: *const IMSMQMessage3, lHashAlg: i32) HRESULT {
        return self.vtable.put_HashAlgorithm(self, lHashAlg);
    }
    pub inline fn get_EncryptAlgorithm(self: *const IMSMQMessage3, plEncryptAlg: ?*i32) HRESULT {
        return self.vtable.get_EncryptAlgorithm(self, plEncryptAlg);
    }
    pub inline fn put_EncryptAlgorithm(self: *const IMSMQMessage3, lEncryptAlg: i32) HRESULT {
        return self.vtable.put_EncryptAlgorithm(self, lEncryptAlg);
    }
    pub inline fn get_SentTime(self: *const IMSMQMessage3, pvarSentTime: ?*VARIANT) HRESULT {
        return self.vtable.get_SentTime(self, pvarSentTime);
    }
    pub inline fn get_ArrivedTime(self: *const IMSMQMessage3, plArrivedTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ArrivedTime(self, plArrivedTime);
    }
    pub inline fn get_DestinationQueueInfo(self: *const IMSMQMessage3, ppqinfoDest: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.get_DestinationQueueInfo(self, ppqinfoDest);
    }
    pub inline fn get_SenderCertificate(self: *const IMSMQMessage3, pvarSenderCert: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderCertificate(self, pvarSenderCert);
    }
    pub inline fn put_SenderCertificate(self: *const IMSMQMessage3, varSenderCert: VARIANT) HRESULT {
        return self.vtable.put_SenderCertificate(self, varSenderCert);
    }
    pub inline fn get_SenderId(self: *const IMSMQMessage3, pvarSenderId: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderId(self, pvarSenderId);
    }
    pub inline fn get_SenderIdType(self: *const IMSMQMessage3, plSenderIdType: ?*i32) HRESULT {
        return self.vtable.get_SenderIdType(self, plSenderIdType);
    }
    pub inline fn put_SenderIdType(self: *const IMSMQMessage3, lSenderIdType: i32) HRESULT {
        return self.vtable.put_SenderIdType(self, lSenderIdType);
    }
    pub inline fn Send(self: *const IMSMQMessage3, DestinationQueue: ?*IDispatch, Transaction: ?*VARIANT) HRESULT {
        return self.vtable.Send(self, DestinationQueue, Transaction);
    }
    pub inline fn AttachCurrentSecurityContext(self: *const IMSMQMessage3) HRESULT {
        return self.vtable.AttachCurrentSecurityContext(self);
    }
    pub inline fn get_SenderVersion(self: *const IMSMQMessage3, plSenderVersion: ?*i32) HRESULT {
        return self.vtable.get_SenderVersion(self, plSenderVersion);
    }
    pub inline fn get_Extension(self: *const IMSMQMessage3, pvarExtension: ?*VARIANT) HRESULT {
        return self.vtable.get_Extension(self, pvarExtension);
    }
    pub inline fn put_Extension(self: *const IMSMQMessage3, varExtension: VARIANT) HRESULT {
        return self.vtable.put_Extension(self, varExtension);
    }
    pub inline fn get_ConnectorTypeGuid(self: *const IMSMQMessage3, pbstrGuidConnectorType: ?*?BSTR) HRESULT {
        return self.vtable.get_ConnectorTypeGuid(self, pbstrGuidConnectorType);
    }
    pub inline fn put_ConnectorTypeGuid(self: *const IMSMQMessage3, bstrGuidConnectorType: ?BSTR) HRESULT {
        return self.vtable.put_ConnectorTypeGuid(self, bstrGuidConnectorType);
    }
    pub inline fn get_TransactionStatusQueueInfo(self: *const IMSMQMessage3, ppqinfoXactStatus: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.get_TransactionStatusQueueInfo(self, ppqinfoXactStatus);
    }
    pub inline fn get_DestinationSymmetricKey(self: *const IMSMQMessage3, pvarDestSymmKey: ?*VARIANT) HRESULT {
        return self.vtable.get_DestinationSymmetricKey(self, pvarDestSymmKey);
    }
    pub inline fn put_DestinationSymmetricKey(self: *const IMSMQMessage3, varDestSymmKey: VARIANT) HRESULT {
        return self.vtable.put_DestinationSymmetricKey(self, varDestSymmKey);
    }
    pub inline fn get_Signature(self: *const IMSMQMessage3, pvarSignature: ?*VARIANT) HRESULT {
        return self.vtable.get_Signature(self, pvarSignature);
    }
    pub inline fn put_Signature(self: *const IMSMQMessage3, varSignature: VARIANT) HRESULT {
        return self.vtable.put_Signature(self, varSignature);
    }
    pub inline fn get_AuthenticationProviderType(self: *const IMSMQMessage3, plAuthProvType: ?*i32) HRESULT {
        return self.vtable.get_AuthenticationProviderType(self, plAuthProvType);
    }
    pub inline fn put_AuthenticationProviderType(self: *const IMSMQMessage3, lAuthProvType: i32) HRESULT {
        return self.vtable.put_AuthenticationProviderType(self, lAuthProvType);
    }
    pub inline fn get_AuthenticationProviderName(self: *const IMSMQMessage3, pbstrAuthProvName: ?*?BSTR) HRESULT {
        return self.vtable.get_AuthenticationProviderName(self, pbstrAuthProvName);
    }
    pub inline fn put_AuthenticationProviderName(self: *const IMSMQMessage3, bstrAuthProvName: ?BSTR) HRESULT {
        return self.vtable.put_AuthenticationProviderName(self, bstrAuthProvName);
    }
    pub inline fn put_SenderId(self: *const IMSMQMessage3, varSenderId: VARIANT) HRESULT {
        return self.vtable.put_SenderId(self, varSenderId);
    }
    pub inline fn get_MsgClass(self: *const IMSMQMessage3, plMsgClass: ?*i32) HRESULT {
        return self.vtable.get_MsgClass(self, plMsgClass);
    }
    pub inline fn put_MsgClass(self: *const IMSMQMessage3, lMsgClass: i32) HRESULT {
        return self.vtable.put_MsgClass(self, lMsgClass);
    }
    pub inline fn get_Properties(self: *const IMSMQMessage3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_TransactionId(self: *const IMSMQMessage3, pvarXactId: ?*VARIANT) HRESULT {
        return self.vtable.get_TransactionId(self, pvarXactId);
    }
    pub inline fn get_IsFirstInTransaction(self: *const IMSMQMessage3, pisFirstInXact: ?*i16) HRESULT {
        return self.vtable.get_IsFirstInTransaction(self, pisFirstInXact);
    }
    pub inline fn get_IsLastInTransaction(self: *const IMSMQMessage3, pisLastInXact: ?*i16) HRESULT {
        return self.vtable.get_IsLastInTransaction(self, pisLastInXact);
    }
    pub inline fn get_ResponseQueueInfo_v2(self: *const IMSMQMessage3, ppqinfoResponse: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_ResponseQueueInfo_v2(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo_v2(self: *const IMSMQMessage3, pqinfoResponse: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_ResponseQueueInfo_v2(self, pqinfoResponse);
    }
    pub inline fn get_AdminQueueInfo_v2(self: *const IMSMQMessage3, ppqinfoAdmin: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_AdminQueueInfo_v2(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo_v2(self: *const IMSMQMessage3, pqinfoAdmin: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_AdminQueueInfo_v2(self, pqinfoAdmin);
    }
    pub inline fn get_ReceivedAuthenticationLevel(self: *const IMSMQMessage3, psReceivedAuthenticationLevel: ?*i16) HRESULT {
        return self.vtable.get_ReceivedAuthenticationLevel(self, psReceivedAuthenticationLevel);
    }
    pub inline fn get_ResponseQueueInfo(self: *const IMSMQMessage3, ppqinfoResponse: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.get_ResponseQueueInfo(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo(self: *const IMSMQMessage3, pqinfoResponse: ?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.putref_ResponseQueueInfo(self, pqinfoResponse);
    }
    pub inline fn get_AdminQueueInfo(self: *const IMSMQMessage3, ppqinfoAdmin: ?*?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.get_AdminQueueInfo(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo(self: *const IMSMQMessage3, pqinfoAdmin: ?*IMSMQQueueInfo3) HRESULT {
        return self.vtable.putref_AdminQueueInfo(self, pqinfoAdmin);
    }
    pub inline fn get_ResponseDestination(self: *const IMSMQMessage3, ppdestResponse: ?*?*IDispatch) HRESULT {
        return self.vtable.get_ResponseDestination(self, ppdestResponse);
    }
    pub inline fn putref_ResponseDestination(self: *const IMSMQMessage3, pdestResponse: ?*IDispatch) HRESULT {
        return self.vtable.putref_ResponseDestination(self, pdestResponse);
    }
    pub inline fn get_Destination(self: *const IMSMQMessage3, ppdestDestination: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Destination(self, ppdestDestination);
    }
    pub inline fn get_LookupId(self: *const IMSMQMessage3, pvarLookupId: ?*VARIANT) HRESULT {
        return self.vtable.get_LookupId(self, pvarLookupId);
    }
    pub inline fn get_IsAuthenticated2(self: *const IMSMQMessage3, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated2(self, pisAuthenticated);
    }
    pub inline fn get_IsFirstInTransaction2(self: *const IMSMQMessage3, pisFirstInXact: ?*i16) HRESULT {
        return self.vtable.get_IsFirstInTransaction2(self, pisFirstInXact);
    }
    pub inline fn get_IsLastInTransaction2(self: *const IMSMQMessage3, pisLastInXact: ?*i16) HRESULT {
        return self.vtable.get_IsLastInTransaction2(self, pisLastInXact);
    }
    pub inline fn AttachCurrentSecurityContext2(self: *const IMSMQMessage3) HRESULT {
        return self.vtable.AttachCurrentSecurityContext2(self);
    }
    pub inline fn get_SoapEnvelope(self: *const IMSMQMessage3, pbstrSoapEnvelope: ?*?BSTR) HRESULT {
        return self.vtable.get_SoapEnvelope(self, pbstrSoapEnvelope);
    }
    pub inline fn get_CompoundMessage(self: *const IMSMQMessage3, pvarCompoundMessage: ?*VARIANT) HRESULT {
        return self.vtable.get_CompoundMessage(self, pvarCompoundMessage);
    }
    pub inline fn put_SoapHeader(self: *const IMSMQMessage3, bstrSoapHeader: ?BSTR) HRESULT {
        return self.vtable.put_SoapHeader(self, bstrSoapHeader);
    }
    pub inline fn put_SoapBody(self: *const IMSMQMessage3, bstrSoapBody: ?BSTR) HRESULT {
...
pub const IMSMQMessage4 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Class(self: *const IMSMQMessage4, plClass: ?*i32) HRESULT {
        return self.vtable.get_Class(self, plClass);
    }
    pub inline fn get_PrivLevel(self: *const IMSMQMessage4, plPrivLevel: ?*i32) HRESULT {
        return self.vtable.get_PrivLevel(self, plPrivLevel);
    }
    pub inline fn put_PrivLevel(self: *const IMSMQMessage4, lPrivLevel: i32) HRESULT {
        return self.vtable.put_PrivLevel(self, lPrivLevel);
    }
    pub inline fn get_AuthLevel(self: *const IMSMQMessage4, plAuthLevel: ?*i32) HRESULT {
        return self.vtable.get_AuthLevel(self, plAuthLevel);
    }
    pub inline fn put_AuthLevel(self: *const IMSMQMessage4, lAuthLevel: i32) HRESULT {
        return self.vtable.put_AuthLevel(self, lAuthLevel);
    }
    pub inline fn get_IsAuthenticated(self: *const IMSMQMessage4, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated(self, pisAuthenticated);
    }
    pub inline fn get_Delivery(self: *const IMSMQMessage4, plDelivery: ?*i32) HRESULT {
        return self.vtable.get_Delivery(self, plDelivery);
    }
    pub inline fn put_Delivery(self: *const IMSMQMessage4, lDelivery: i32) HRESULT {
        return self.vtable.put_Delivery(self, lDelivery);
    }
    pub inline fn get_Trace(self: *const IMSMQMessage4, plTrace: ?*i32) HRESULT {
        return self.vtable.get_Trace(self, plTrace);
    }
    pub inline fn put_Trace(self: *const IMSMQMessage4, lTrace: i32) HRESULT {
        return self.vtable.put_Trace(self, lTrace);
    }
    pub inline fn get_Priority(self: *const IMSMQMessage4, plPriority: ?*i32) HRESULT {
        return self.vtable.get_Priority(self, plPriority);
    }
    pub inline fn put_Priority(self: *const IMSMQMessage4, lPriority: i32) HRESULT {
        return self.vtable.put_Priority(self, lPriority);
    }
    pub inline fn get_Journal(self: *const IMSMQMessage4, plJournal: ?*i32) HRESULT {
        return self.vtable.get_Journal(self, plJournal);
    }
    pub inline fn put_Journal(self: *const IMSMQMessage4, lJournal: i32) HRESULT {
        return self.vtable.put_Journal(self, lJournal);
    }
    pub inline fn get_ResponseQueueInfo_v1(self: *const IMSMQMessage4, ppqinfoResponse: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_ResponseQueueInfo_v1(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo_v1(self: *const IMSMQMessage4, pqinfoResponse: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_ResponseQueueInfo_v1(self, pqinfoResponse);
    }
    pub inline fn get_AppSpecific(self: *const IMSMQMessage4, plAppSpecific: ?*i32) HRESULT {
        return self.vtable.get_AppSpecific(self, plAppSpecific);
    }
    pub inline fn put_AppSpecific(self: *const IMSMQMessage4, lAppSpecific: i32) HRESULT {
        return self.vtable.put_AppSpecific(self, lAppSpecific);
    }
    pub inline fn get_SourceMachineGuid(self: *const IMSMQMessage4, pbstrGuidSrcMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_SourceMachineGuid(self, pbstrGuidSrcMachine);
    }
    pub inline fn get_BodyLength(self: *const IMSMQMessage4, pcbBody: ?*i32) HRESULT {
        return self.vtable.get_BodyLength(self, pcbBody);
    }
    pub inline fn get_Body(self: *const IMSMQMessage4, pvarBody: ?*VARIANT) HRESULT {
        return self.vtable.get_Body(self, pvarBody);
    }
    pub inline fn put_Body(self: *const IMSMQMessage4, varBody: VARIANT) HRESULT {
        return self.vtable.put_Body(self, varBody);
    }
    pub inline fn get_AdminQueueInfo_v1(self: *const IMSMQMessage4, ppqinfoAdmin: ?*?*IMSMQQueueInfo) HRESULT {
        return self.vtable.get_AdminQueueInfo_v1(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo_v1(self: *const IMSMQMessage4, pqinfoAdmin: ?*IMSMQQueueInfo) HRESULT {
        return self.vtable.putref_AdminQueueInfo_v1(self, pqinfoAdmin);
    }
    pub inline fn get_Id(self: *const IMSMQMessage4, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_Id(self, pvarMsgId);
    }
    pub inline fn get_CorrelationId(self: *const IMSMQMessage4, pvarMsgId: ?*VARIANT) HRESULT {
        return self.vtable.get_CorrelationId(self, pvarMsgId);
    }
    pub inline fn put_CorrelationId(self: *const IMSMQMessage4, varMsgId: VARIANT) HRESULT {
        return self.vtable.put_CorrelationId(self, varMsgId);
    }
    pub inline fn get_Ack(self: *const IMSMQMessage4, plAck: ?*i32) HRESULT {
        return self.vtable.get_Ack(self, plAck);
    }
    pub inline fn put_Ack(self: *const IMSMQMessage4, lAck: i32) HRESULT {
        return self.vtable.put_Ack(self, lAck);
    }
    pub inline fn get_Label(self: *const IMSMQMessage4, pbstrLabel: ?*?BSTR) HRESULT {
        return self.vtable.get_Label(self, pbstrLabel);
    }
    pub inline fn put_Label(self: *const IMSMQMessage4, bstrLabel: ?BSTR) HRESULT {
        return self.vtable.put_Label(self, bstrLabel);
    }
    pub inline fn get_MaxTimeToReachQueue(self: *const IMSMQMessage4, plMaxTimeToReachQueue: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReachQueue(self, plMaxTimeToReachQueue);
    }
    pub inline fn put_MaxTimeToReachQueue(self: *const IMSMQMessage4, lMaxTimeToReachQueue: i32) HRESULT {
        return self.vtable.put_MaxTimeToReachQueue(self, lMaxTimeToReachQueue);
    }
    pub inline fn get_MaxTimeToReceive(self: *const IMSMQMessage4, plMaxTimeToReceive: ?*i32) HRESULT {
        return self.vtable.get_MaxTimeToReceive(self, plMaxTimeToReceive);
    }
    pub inline fn put_MaxTimeToReceive(self: *const IMSMQMessage4, lMaxTimeToReceive: i32) HRESULT {
        return self.vtable.put_MaxTimeToReceive(self, lMaxTimeToReceive);
    }
    pub inline fn get_HashAlgorithm(self: *const IMSMQMessage4, plHashAlg: ?*i32) HRESULT {
        return self.vtable.get_HashAlgorithm(self, plHashAlg);
    }
    pub inline fn put_HashAlgorithm(self: *const IMSMQMessage4, lHashAlg: i32) HRESULT {
        return self.vtable.put_HashAlgorithm(self, lHashAlg);
    }
    pub inline fn get_EncryptAlgorithm(self: *const IMSMQMessage4, plEncryptAlg: ?*i32) HRESULT {
        return self.vtable.get_EncryptAlgorithm(self, plEncryptAlg);
    }
    pub inline fn put_EncryptAlgorithm(self: *const IMSMQMessage4, lEncryptAlg: i32) HRESULT {
        return self.vtable.put_EncryptAlgorithm(self, lEncryptAlg);
    }
    pub inline fn get_SentTime(self: *const IMSMQMessage4, pvarSentTime: ?*VARIANT) HRESULT {
        return self.vtable.get_SentTime(self, pvarSentTime);
    }
    pub inline fn get_ArrivedTime(self: *const IMSMQMessage4, plArrivedTime: ?*VARIANT) HRESULT {
        return self.vtable.get_ArrivedTime(self, plArrivedTime);
    }
    pub inline fn get_DestinationQueueInfo(self: *const IMSMQMessage4, ppqinfoDest: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.get_DestinationQueueInfo(self, ppqinfoDest);
    }
    pub inline fn get_SenderCertificate(self: *const IMSMQMessage4, pvarSenderCert: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderCertificate(self, pvarSenderCert);
    }
    pub inline fn put_SenderCertificate(self: *const IMSMQMessage4, varSenderCert: VARIANT) HRESULT {
        return self.vtable.put_SenderCertificate(self, varSenderCert);
    }
    pub inline fn get_SenderId(self: *const IMSMQMessage4, pvarSenderId: ?*VARIANT) HRESULT {
        return self.vtable.get_SenderId(self, pvarSenderId);
    }
    pub inline fn get_SenderIdType(self: *const IMSMQMessage4, plSenderIdType: ?*i32) HRESULT {
        return self.vtable.get_SenderIdType(self, plSenderIdType);
    }
    pub inline fn put_SenderIdType(self: *const IMSMQMessage4, lSenderIdType: i32) HRESULT {
        return self.vtable.put_SenderIdType(self, lSenderIdType);
    }
    pub inline fn Send(self: *const IMSMQMessage4, DestinationQueue: ?*IDispatch, Transaction: ?*VARIANT) HRESULT {
        return self.vtable.Send(self, DestinationQueue, Transaction);
    }
    pub inline fn AttachCurrentSecurityContext(self: *const IMSMQMessage4) HRESULT {
        return self.vtable.AttachCurrentSecurityContext(self);
    }
    pub inline fn get_SenderVersion(self: *const IMSMQMessage4, plSenderVersion: ?*i32) HRESULT {
        return self.vtable.get_SenderVersion(self, plSenderVersion);
    }
    pub inline fn get_Extension(self: *const IMSMQMessage4, pvarExtension: ?*VARIANT) HRESULT {
        return self.vtable.get_Extension(self, pvarExtension);
    }
    pub inline fn put_Extension(self: *const IMSMQMessage4, varExtension: VARIANT) HRESULT {
        return self.vtable.put_Extension(self, varExtension);
    }
    pub inline fn get_ConnectorTypeGuid(self: *const IMSMQMessage4, pbstrGuidConnectorType: ?*?BSTR) HRESULT {
        return self.vtable.get_ConnectorTypeGuid(self, pbstrGuidConnectorType);
    }
    pub inline fn put_ConnectorTypeGuid(self: *const IMSMQMessage4, bstrGuidConnectorType: ?BSTR) HRESULT {
        return self.vtable.put_ConnectorTypeGuid(self, bstrGuidConnectorType);
    }
    pub inline fn get_TransactionStatusQueueInfo(self: *const IMSMQMessage4, ppqinfoXactStatus: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.get_TransactionStatusQueueInfo(self, ppqinfoXactStatus);
    }
    pub inline fn get_DestinationSymmetricKey(self: *const IMSMQMessage4, pvarDestSymmKey: ?*VARIANT) HRESULT {
        return self.vtable.get_DestinationSymmetricKey(self, pvarDestSymmKey);
    }
    pub inline fn put_DestinationSymmetricKey(self: *const IMSMQMessage4, varDestSymmKey: VARIANT) HRESULT {
        return self.vtable.put_DestinationSymmetricKey(self, varDestSymmKey);
    }
    pub inline fn get_Signature(self: *const IMSMQMessage4, pvarSignature: ?*VARIANT) HRESULT {
        return self.vtable.get_Signature(self, pvarSignature);
    }
    pub inline fn put_Signature(self: *const IMSMQMessage4, varSignature: VARIANT) HRESULT {
        return self.vtable.put_Signature(self, varSignature);
    }
    pub inline fn get_AuthenticationProviderType(self: *const IMSMQMessage4, plAuthProvType: ?*i32) HRESULT {
        return self.vtable.get_AuthenticationProviderType(self, plAuthProvType);
    }
    pub inline fn put_AuthenticationProviderType(self: *const IMSMQMessage4, lAuthProvType: i32) HRESULT {
        return self.vtable.put_AuthenticationProviderType(self, lAuthProvType);
    }
    pub inline fn get_AuthenticationProviderName(self: *const IMSMQMessage4, pbstrAuthProvName: ?*?BSTR) HRESULT {
        return self.vtable.get_AuthenticationProviderName(self, pbstrAuthProvName);
    }
    pub inline fn put_AuthenticationProviderName(self: *const IMSMQMessage4, bstrAuthProvName: ?BSTR) HRESULT {
        return self.vtable.put_AuthenticationProviderName(self, bstrAuthProvName);
    }
    pub inline fn put_SenderId(self: *const IMSMQMessage4, varSenderId: VARIANT) HRESULT {
        return self.vtable.put_SenderId(self, varSenderId);
    }
    pub inline fn get_MsgClass(self: *const IMSMQMessage4, plMsgClass: ?*i32) HRESULT {
        return self.vtable.get_MsgClass(self, plMsgClass);
    }
    pub inline fn put_MsgClass(self: *const IMSMQMessage4, lMsgClass: i32) HRESULT {
        return self.vtable.put_MsgClass(self, lMsgClass);
    }
    pub inline fn get_Properties(self: *const IMSMQMessage4, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
    pub inline fn get_TransactionId(self: *const IMSMQMessage4, pvarXactId: ?*VARIANT) HRESULT {
        return self.vtable.get_TransactionId(self, pvarXactId);
    }
    pub inline fn get_IsFirstInTransaction(self: *const IMSMQMessage4, pisFirstInXact: ?*i16) HRESULT {
        return self.vtable.get_IsFirstInTransaction(self, pisFirstInXact);
    }
    pub inline fn get_IsLastInTransaction(self: *const IMSMQMessage4, pisLastInXact: ?*i16) HRESULT {
        return self.vtable.get_IsLastInTransaction(self, pisLastInXact);
    }
    pub inline fn get_ResponseQueueInfo_v2(self: *const IMSMQMessage4, ppqinfoResponse: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_ResponseQueueInfo_v2(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo_v2(self: *const IMSMQMessage4, pqinfoResponse: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_ResponseQueueInfo_v2(self, pqinfoResponse);
    }
    pub inline fn get_AdminQueueInfo_v2(self: *const IMSMQMessage4, ppqinfoAdmin: ?*?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.get_AdminQueueInfo_v2(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo_v2(self: *const IMSMQMessage4, pqinfoAdmin: ?*IMSMQQueueInfo2) HRESULT {
        return self.vtable.putref_AdminQueueInfo_v2(self, pqinfoAdmin);
    }
    pub inline fn get_ReceivedAuthenticationLevel(self: *const IMSMQMessage4, psReceivedAuthenticationLevel: ?*i16) HRESULT {
        return self.vtable.get_ReceivedAuthenticationLevel(self, psReceivedAuthenticationLevel);
    }
    pub inline fn get_ResponseQueueInfo(self: *const IMSMQMessage4, ppqinfoResponse: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.get_ResponseQueueInfo(self, ppqinfoResponse);
    }
    pub inline fn putref_ResponseQueueInfo(self: *const IMSMQMessage4, pqinfoResponse: ?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.putref_ResponseQueueInfo(self, pqinfoResponse);
    }
    pub inline fn get_AdminQueueInfo(self: *const IMSMQMessage4, ppqinfoAdmin: ?*?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.get_AdminQueueInfo(self, ppqinfoAdmin);
    }
    pub inline fn putref_AdminQueueInfo(self: *const IMSMQMessage4, pqinfoAdmin: ?*IMSMQQueueInfo4) HRESULT {
        return self.vtable.putref_AdminQueueInfo(self, pqinfoAdmin);
    }
    pub inline fn get_ResponseDestination(self: *const IMSMQMessage4, ppdestResponse: ?*?*IDispatch) HRESULT {
        return self.vtable.get_ResponseDestination(self, ppdestResponse);
    }
    pub inline fn putref_ResponseDestination(self: *const IMSMQMessage4, pdestResponse: ?*IDispatch) HRESULT {
        return self.vtable.putref_ResponseDestination(self, pdestResponse);
    }
    pub inline fn get_Destination(self: *const IMSMQMessage4, ppdestDestination: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Destination(self, ppdestDestination);
    }
    pub inline fn get_LookupId(self: *const IMSMQMessage4, pvarLookupId: ?*VARIANT) HRESULT {
        return self.vtable.get_LookupId(self, pvarLookupId);
    }
    pub inline fn get_IsAuthenticated2(self: *const IMSMQMessage4, pisAuthenticated: ?*i16) HRESULT {
        return self.vtable.get_IsAuthenticated2(self, pisAuthenticated);
    }
    pub inline fn get_IsFirstInTransaction2(self: *const IMSMQMessage4, pisFirstInXact: ?*i16) HRESULT {
        return self.vtable.get_IsFirstInTransaction2(self, pisFirstInXact);
    }
    pub inline fn get_IsLastInTransaction2(self: *const IMSMQMessage4, pisLastInXact: ?*i16) HRESULT {
        return self.vtable.get_IsLastInTransaction2(self, pisLastInXact);
    }
    pub inline fn AttachCurrentSecurityContext2(self: *const IMSMQMessage4) HRESULT {
        return self.vtable.AttachCurrentSecurityContext2(self);
    }
    pub inline fn get_SoapEnvelope(self: *const IMSMQMessage4, pbstrSoapEnvelope: ?*?BSTR) HRESULT {
        return self.vtable.get_SoapEnvelope(self, pbstrSoapEnvelope);
    }
    pub inline fn get_CompoundMessage(self: *const IMSMQMessage4, pvarCompoundMessage: ?*VARIANT) HRESULT {
        return self.vtable.get_CompoundMessage(self, pvarCompoundMessage);
    }
    pub inline fn put_SoapHeader(self: *const IMSMQMessage4, bstrSoapHeader: ?BSTR) HRESULT {
        return self.vtable.put_SoapHeader(self, bstrSoapHeader);
    }
    pub inline fn put_SoapBody(self: *const IMSMQMessage4, bstrSoapBody: ?BSTR) HRESULT {
        return self.vtable.put_SoapBody(self, bstrSoapBody);
    }
};
...
pub const IMSMQPrivateEvent = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Hwnd(self: *const IMSMQPrivateEvent, phwnd: ?*i32) HRESULT {
        return self.vtable.get_Hwnd(self, phwnd);
    }
    pub inline fn FireArrivedEvent(self: *const IMSMQPrivateEvent, pq: ?*IMSMQQueue, msgcursor: i32) HRESULT {
        return self.vtable.FireArrivedEvent(self, pq, msgcursor);
    }
    pub inline fn FireArrivedErrorEvent(self: *const IMSMQPrivateEvent, pq: ?*IMSMQQueue, hrStatus: HRESULT, msgcursor: i32) HRESULT {
...
pub const IMSMQTransaction2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn InitNew(self: *const IMSMQTransaction2, varTransaction: VARIANT) HRESULT {
        return self.vtable.InitNew(self, varTransaction);
    }
    pub inline fn get_Properties(self: *const IMSMQTransaction2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQTransaction3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ITransaction(self: *const IMSMQTransaction3, pvarITransaction: ?*VARIANT) HRESULT {
...
pub const IMSMQCoordinatedTransactionDispenser2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQCoordinatedTransactionDispenser2, ptransaction: ?*?*IMSMQTransaction2) HRESULT {
        return self.vtable.BeginTransaction(self, ptransaction);
    }
    pub inline fn get_Properties(self: *const IMSMQCoordinatedTransactionDispenser2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQCoordinatedTransactionDispenser3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQCoordinatedTransactionDispenser3, ptransaction: ?*?*IMSMQTransaction3) HRESULT {
        return self.vtable.BeginTransaction(self, ptransaction);
    }
    pub inline fn get_Properties(self: *const IMSMQCoordinatedTransactionDispenser3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQTransactionDispenser2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQTransactionDispenser2, ptransaction: ?*?*IMSMQTransaction2) HRESULT {
        return self.vtable.BeginTransaction(self, ptransaction);
    }
    pub inline fn get_Properties(self: *const IMSMQTransactionDispenser2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQTransactionDispenser3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn BeginTransaction(self: *const IMSMQTransactionDispenser3, ptransaction: ?*?*IMSMQTransaction3) HRESULT {
        return self.vtable.BeginTransaction(self, ptransaction);
    }
    pub inline fn get_Properties(self: *const IMSMQTransactionDispenser3, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQApplication = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn MachineIdOfMachineName(self: *const IMSMQApplication, MachineName: ?BSTR, pbstrGuid: ?*?BSTR) HRESULT {
...
pub const IMSMQApplication2 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn RegisterCertificate(self: *const IMSMQApplication2, Flags: ?*VARIANT, ExternalCertificate: ?*VARIANT) HRESULT {
        return self.vtable.RegisterCertificate(self, Flags, ExternalCertificate);
    }
    pub inline fn MachineNameOfMachineId(self: *const IMSMQApplication2, bstrGuid: ?BSTR, pbstrMachineName: ?*?BSTR) HRESULT {
        return self.vtable.MachineNameOfMachineId(self, bstrGuid, pbstrMachineName);
    }
    pub inline fn get_MSMQVersionMajor(self: *const IMSMQApplication2, psMSMQVersionMajor: ?*i16) HRESULT {
        return self.vtable.get_MSMQVersionMajor(self, psMSMQVersionMajor);
    }
    pub inline fn get_MSMQVersionMinor(self: *const IMSMQApplication2, psMSMQVersionMinor: ?*i16) HRESULT {
        return self.vtable.get_MSMQVersionMinor(self, psMSMQVersionMinor);
    }
    pub inline fn get_MSMQVersionBuild(self: *const IMSMQApplication2, psMSMQVersionBuild: ?*i16) HRESULT {
        return self.vtable.get_MSMQVersionBuild(self, psMSMQVersionBuild);
    }
    pub inline fn get_IsDsEnabled(self: *const IMSMQApplication2, pfIsDsEnabled: ?*i16) HRESULT {
        return self.vtable.get_IsDsEnabled(self, pfIsDsEnabled);
    }
    pub inline fn get_Properties(self: *const IMSMQApplication2, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQApplication3 = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_ActiveQueues(self: *const IMSMQApplication3, pvActiveQueues: ?*VARIANT) HRESULT {
        return self.vtable.get_ActiveQueues(self, pvActiveQueues);
    }
    pub inline fn get_PrivateQueues(self: *const IMSMQApplication3, pvPrivateQueues: ?*VARIANT) HRESULT {
        return self.vtable.get_PrivateQueues(self, pvPrivateQueues);
    }
    pub inline fn get_DirectoryServiceServer(self: *const IMSMQApplication3, pbstrDirectoryServiceServer: ?*?BSTR) HRESULT {
        return self.vtable.get_DirectoryServiceServer(self, pbstrDirectoryServiceServer);
    }
    pub inline fn get_IsConnected(self: *const IMSMQApplication3, pfIsConnected: ?*i16) HRESULT {
        return self.vtable.get_IsConnected(self, pfIsConnected);
    }
    pub inline fn get_BytesInAllQueues(self: *const IMSMQApplication3, pvBytesInAllQueues: ?*VARIANT) HRESULT {
        return self.vtable.get_BytesInAllQueues(self, pvBytesInAllQueues);
    }
    pub inline fn put_Machine(self: *const IMSMQApplication3, bstrMachine: ?BSTR) HRESULT {
        return self.vtable.put_Machine(self, bstrMachine);
    }
    pub inline fn get_Machine(self: *const IMSMQApplication3, pbstrMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_Machine(self, pbstrMachine);
    }
    pub inline fn Connect(self: *const IMSMQApplication3) HRESULT {
        return self.vtable.Connect(self);
    }
    pub inline fn Disconnect(self: *const IMSMQApplication3) HRESULT {
        return self.vtable.Disconnect(self);
    }
    pub inline fn Tidy(self: *const IMSMQApplication3) HRESULT {
...
pub const IMSMQDestination = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Open(self: *const IMSMQDestination) HRESULT {
        return self.vtable.Open(self);
    }
    pub inline fn Close(self: *const IMSMQDestination) HRESULT {
        return self.vtable.Close(self);
    }
    pub inline fn get_IsOpen(self: *const IMSMQDestination, pfIsOpen: ?*i16) HRESULT {
        return self.vtable.get_IsOpen(self, pfIsOpen);
    }
    pub inline fn get_IADs(self: *const IMSMQDestination, ppIADs: ?*?*IDispatch) HRESULT {
        return self.vtable.get_IADs(self, ppIADs);
    }
    pub inline fn putref_IADs(self: *const IMSMQDestination, pIADs: ?*IDispatch) HRESULT {
        return self.vtable.putref_IADs(self, pIADs);
    }
    pub inline fn get_ADsPath(self: *const IMSMQDestination, pbstrADsPath: ?*?BSTR) HRESULT {
        return self.vtable.get_ADsPath(self, pbstrADsPath);
    }
    pub inline fn put_ADsPath(self: *const IMSMQDestination, bstrADsPath: ?BSTR) HRESULT {
        return self.vtable.put_ADsPath(self, bstrADsPath);
    }
    pub inline fn get_PathName(self: *const IMSMQDestination, pbstrPathName: ?*?BSTR) HRESULT {
        return self.vtable.get_PathName(self, pbstrPathName);
    }
    pub inline fn put_PathName(self: *const IMSMQDestination, bstrPathName: ?BSTR) HRESULT {
        return self.vtable.put_PathName(self, bstrPathName);
    }
    pub inline fn get_FormatName(self: *const IMSMQDestination, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn put_FormatName(self: *const IMSMQDestination, bstrFormatName: ?BSTR) HRESULT {
        return self.vtable.put_FormatName(self, bstrFormatName);
    }
    pub inline fn get_Destinations(self: *const IMSMQDestination, ppDestinations: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Destinations(self, ppDestinations);
    }
    pub inline fn putref_Destinations(self: *const IMSMQDestination, pDestinations: ?*IDispatch) HRESULT {
        return self.vtable.putref_Destinations(self, pDestinations);
    }
    pub inline fn get_Properties(self: *const IMSMQDestination, ppcolProperties: ?*?*IDispatch) HRESULT {
        return self.vtable.get_Properties(self, ppcolProperties);
    }
};
...
pub const IMSMQPrivateDestination = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_Handle(self: *const IMSMQPrivateDestination, pvarHandle: ?*VARIANT) HRESULT {
        return self.vtable.get_Handle(self, pvarHandle);
    }
    pub inline fn put_Handle(self: *const IMSMQPrivateDestination, varHandle: VARIANT) HRESULT {
...
pub const IMSMQCollection = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Item(self: *const IMSMQCollection, Index: ?*VARIANT, pvarRet: ?*VARIANT) HRESULT {
        return self.vtable.Item(self, Index, pvarRet);
    }
    pub inline fn get_Count(self: *const IMSMQCollection, pCount: ?*i32) HRESULT {
        return self.vtable.get_Count(self, pCount);
    }
    pub inline fn _NewEnum(self: *const IMSMQCollection, ppunk: ?*?*IUnknown) HRESULT {
...
pub const IMSMQManagement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const IMSMQManagement, Machine: ?*VARIANT, Pathname: ?*VARIANT, FormatName: ?*VARIANT) HRESULT {
        return self.vtable.Init(self, Machine, Pathname, FormatName);
    }
    pub inline fn get_FormatName(self: *const IMSMQManagement, pbstrFormatName: ?*?BSTR) HRESULT {
        return self.vtable.get_FormatName(self, pbstrFormatName);
    }
    pub inline fn get_Machine(self: *const IMSMQManagement, pbstrMachine: ?*?BSTR) HRESULT {
        return self.vtable.get_Machine(self, pbstrMachine);
    }
    pub inline fn get_MessageCount(self: *const IMSMQManagement, plMessageCount: ?*i32) HRESULT {
        return self.vtable.get_MessageCount(self, plMessageCount);
    }
    pub inline fn get_ForeignStatus(self: *const IMSMQManagement, plForeignStatus: ?*i32) HRESULT {
        return self.vtable.get_ForeignStatus(self, plForeignStatus);
    }
    pub inline fn get_QueueType(self: *const IMSMQManagement, plQueueType: ?*i32) HRESULT {
        return self.vtable.get_QueueType(self, plQueueType);
    }
    pub inline fn get_IsLocal(self: *const IMSMQManagement, pfIsLocal: ?*i16) HRESULT {
        return self.vtable.get_IsLocal(self, pfIsLocal);
    }
    pub inline fn get_TransactionalStatus(self: *const IMSMQManagement, plTransactionalStatus: ?*i32) HRESULT {
        return self.vtable.get_TransactionalStatus(self, plTransactionalStatus);
    }
    pub inline fn get_BytesInQueue(self: *const IMSMQManagement, pvBytesInQueue: ?*VARIANT) HRESULT {
...
pub const IMSMQOutgoingQueueManagement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_State(self: *const IMSMQOutgoingQueueManagement, plState: ?*i32) HRESULT {
        return self.vtable.get_State(self, plState);
    }
    pub inline fn get_NextHops(self: *const IMSMQOutgoingQueueManagement, pvNextHops: ?*VARIANT) HRESULT {
        return self.vtable.get_NextHops(self, pvNextHops);
    }
    pub inline fn EodGetSendInfo(self: *const IMSMQOutgoingQueueManagement, ppCollection: ?*?*IMSMQCollection) HRESULT {
        return self.vtable.EodGetSendInfo(self, ppCollection);
    }
    pub inline fn Resume(self: *const IMSMQOutgoingQueueManagement) HRESULT {
        return self.vtable.Resume(self);
    }
    pub inline fn Pause(self: *const IMSMQOutgoingQueueManagement) HRESULT {
        return self.vtable.Pause(self);
    }
    pub inline fn EodResend(self: *const IMSMQOutgoingQueueManagement) HRESULT {
...
pub const IMSMQQueueManagement = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_JournalMessageCount(self: *const IMSMQQueueManagement, plJournalMessageCount: ?*i32) HRESULT {
        return self.vtable.get_JournalMessageCount(self, plJournalMessageCount);
    }
    pub inline fn get_BytesInJournal(self: *const IMSMQQueueManagement, pvBytesInJournal: ?*VARIANT) HRESULT {
        return self.vtable.get_BytesInJournal(self, pvBytesInJournal);
    }
    pub inline fn EodGetReceiveInfo(self: *const IMSMQQueueManagement, pvCollection: ?*VARIANT) HRESULT {
