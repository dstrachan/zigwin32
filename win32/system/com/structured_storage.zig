...
pub const IEnumSTATSTG = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSTATSTG, celt: u32, rgelt: [*]STATSTG, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSTATSTG, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSTATSTG) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSTATSTG, ppenum: ?*?*IEnumSTATSTG) HRESULT {
...
pub const IStorage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateStream(self: *const IStorage, pwcsName: ?[*:0]const u16, grfMode: STGM, reserved1: u32, reserved2: u32, ppstm: ?*?*IStream) HRESULT {
        return self.vtable.CreateStream(self, pwcsName, grfMode, reserved1, reserved2, ppstm);
    }
    pub inline fn OpenStream(self: *const IStorage, pwcsName: ?[*:0]const u16, reserved1: ?*anyopaque, grfMode: STGM, reserved2: u32, ppstm: ?*?*IStream) HRESULT {
        return self.vtable.OpenStream(self, pwcsName, reserved1, grfMode, reserved2, ppstm);
    }
    pub inline fn CreateStorage(self: *const IStorage, pwcsName: ?[*:0]const u16, grfMode: STGM, reserved1: u32, reserved2: u32, ppstg: ?*?*IStorage) HRESULT {
        return self.vtable.CreateStorage(self, pwcsName, grfMode, reserved1, reserved2, ppstg);
    }
    pub inline fn OpenStorage(self: *const IStorage, pwcsName: ?[*:0]const u16, pstgPriority: ?*IStorage, grfMode: STGM, snbExclude: ?*?*u16, reserved: u32, ppstg: ?*?*IStorage) HRESULT {
        return self.vtable.OpenStorage(self, pwcsName, pstgPriority, grfMode, snbExclude, reserved, ppstg);
    }
    pub inline fn CopyTo(self: *const IStorage, ciidExclude: u32, rgiidExclude: ?[*]const Guid, snbExclude: ?*?*u16, pstgDest: ?*IStorage) HRESULT {
        return self.vtable.CopyTo(self, ciidExclude, rgiidExclude, snbExclude, pstgDest);
    }
    pub inline fn MoveElementTo(self: *const IStorage, pwcsName: ?[*:0]const u16, pstgDest: ?*IStorage, pwcsNewName: ?[*:0]const u16, grfFlags: STGMOVE) HRESULT {
        return self.vtable.MoveElementTo(self, pwcsName, pstgDest, pwcsNewName, grfFlags);
    }
    pub inline fn Commit(self: *const IStorage, grfCommitFlags: STGC) HRESULT {
        return self.vtable.Commit(self, grfCommitFlags);
    }
    pub inline fn Revert(self: *const IStorage) HRESULT {
        return self.vtable.Revert(self);
    }
    pub inline fn EnumElements(self: *const IStorage, reserved1: u32, reserved2: ?*anyopaque, reserved3: u32, ppenum: ?*?*IEnumSTATSTG) HRESULT {
        return self.vtable.EnumElements(self, reserved1, reserved2, reserved3, ppenum);
    }
    pub inline fn DestroyElement(self: *const IStorage, pwcsName: ?[*:0]const u16) HRESULT {
        return self.vtable.DestroyElement(self, pwcsName);
    }
    pub inline fn RenameElement(self: *const IStorage, pwcsOldName: ?[*:0]const u16, pwcsNewName: ?[*:0]const u16) HRESULT {
        return self.vtable.RenameElement(self, pwcsOldName, pwcsNewName);
    }
    pub inline fn SetElementTimes(self: *const IStorage, pwcsName: ?[*:0]const u16, pctime: ?*const FILETIME, patime: ?*const FILETIME, pmtime: ?*const FILETIME) HRESULT {
        return self.vtable.SetElementTimes(self, pwcsName, pctime, patime, pmtime);
    }
    pub inline fn SetClass(self: *const IStorage, clsid: ?*const Guid) HRESULT {
        return self.vtable.SetClass(self, clsid);
    }
    pub inline fn SetStateBits(self: *const IStorage, grfStateBits: u32, grfMask: u32) HRESULT {
        return self.vtable.SetStateBits(self, grfStateBits, grfMask);
    }
    pub inline fn Stat(self: *const IStorage, pstatstg: ?*STATSTG, grfStatFlag: u32) HRESULT {
...
pub const IPersistStorage = extern union {
    ...
    IPersist: IPersist,
    IUnknown: IUnknown,
    pub inline fn IsDirty(self: *const IPersistStorage) HRESULT {
        return self.vtable.IsDirty(self);
    }
    pub inline fn InitNew(self: *const IPersistStorage, pStg: ?*IStorage) HRESULT {
        return self.vtable.InitNew(self, pStg);
    }
    pub inline fn Load(self: *const IPersistStorage, pStg: ?*IStorage) HRESULT {
        return self.vtable.Load(self, pStg);
    }
    pub inline fn Save(self: *const IPersistStorage, pStgSave: ?*IStorage, fSameAsLoad: BOOL) HRESULT {
        return self.vtable.Save(self, pStgSave, fSameAsLoad);
    }
    pub inline fn SaveCompleted(self: *const IPersistStorage, pStgNew: ?*IStorage) HRESULT {
        return self.vtable.SaveCompleted(self, pStgNew);
    }
    pub inline fn HandsOffStorage(self: *const IPersistStorage) HRESULT {
...
pub const ILockBytes = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReadAt(self: *const ILockBytes, ulOffset: ULARGE_INTEGER, pv: ?*anyopaque, cb: u32, pcbRead: ?*u32) HRESULT {
        return self.vtable.ReadAt(self, ulOffset, pv, cb, pcbRead);
    }
    pub inline fn WriteAt(self: *const ILockBytes, ulOffset: ULARGE_INTEGER, pv: ?*const anyopaque, cb: u32, pcbWritten: ?*u32) HRESULT {
        return self.vtable.WriteAt(self, ulOffset, pv, cb, pcbWritten);
    }
    pub inline fn Flush(self: *const ILockBytes) HRESULT {
        return self.vtable.Flush(self);
    }
    pub inline fn SetSize(self: *const ILockBytes, cb: ULARGE_INTEGER) HRESULT {
        return self.vtable.SetSize(self, cb);
    }
    pub inline fn LockRegion(self: *const ILockBytes, libOffset: ULARGE_INTEGER, cb: ULARGE_INTEGER, dwLockType: u32) HRESULT {
        return self.vtable.LockRegion(self, libOffset, cb, dwLockType);
    }
    pub inline fn UnlockRegion(self: *const ILockBytes, libOffset: ULARGE_INTEGER, cb: ULARGE_INTEGER, dwLockType: u32) HRESULT {
        return self.vtable.UnlockRegion(self, libOffset, cb, dwLockType);
    }
    pub inline fn Stat(self: *const ILockBytes, pstatstg: ?*STATSTG, grfStatFlag: u32) HRESULT {
        return self.vtable.Stat(self, pstatstg, grfStatFlag);
    }
};
...
pub const IRootStorage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SwitchToFile(self: *const IRootStorage, pszFile: ?PWSTR) HRESULT {
...
pub const IFillLockBytes = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FillAppend(self: *const IFillLockBytes, pv: ?*const anyopaque, cb: u32, pcbWritten: ?*u32) HRESULT {
        return self.vtable.FillAppend(self, pv, cb, pcbWritten);
    }
    pub inline fn FillAt(self: *const IFillLockBytes, ulOffset: ULARGE_INTEGER, pv: ?*const anyopaque, cb: u32, pcbWritten: ?*u32) HRESULT {
        return self.vtable.FillAt(self, ulOffset, pv, cb, pcbWritten);
    }
    pub inline fn SetFillSize(self: *const IFillLockBytes, ulSize: ULARGE_INTEGER) HRESULT {
        return self.vtable.SetFillSize(self, ulSize);
    }
    pub inline fn Terminate(self: *const IFillLockBytes, bCanceled: BOOL) HRESULT {
...
pub const ILayoutStorage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn LayoutScript(self: *const ILayoutStorage, pStorageLayout: [*]StorageLayout, nEntries: u32, glfInterleavedFlag: u32) HRESULT {
        return self.vtable.LayoutScript(self, pStorageLayout, nEntries, glfInterleavedFlag);
    }
    pub inline fn BeginMonitor(self: *const ILayoutStorage) HRESULT {
        return self.vtable.BeginMonitor(self);
    }
    pub inline fn EndMonitor(self: *const ILayoutStorage) HRESULT {
        return self.vtable.EndMonitor(self);
    }
    pub inline fn ReLayoutDocfile(self: *const ILayoutStorage, pwcsNewDfName: ?PWSTR) HRESULT {
        return self.vtable.ReLayoutDocfile(self, pwcsNewDfName);
    }
    pub inline fn ReLayoutDocfileOnILockBytes(self: *const ILayoutStorage, pILockBytes: ?*ILockBytes) HRESULT {
...
pub const IDirectWriterLock = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn WaitForWriteAccess(self: *const IDirectWriterLock, dwTimeout: u32) HRESULT {
        return self.vtable.WaitForWriteAccess(self, dwTimeout);
    }
    pub inline fn ReleaseWriteAccess(self: *const IDirectWriterLock) HRESULT {
        return self.vtable.ReleaseWriteAccess(self);
    }
    pub inline fn HaveWriteAccess(self: *const IDirectWriterLock) HRESULT {
...
pub const IPropertyStorage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReadMultiple(self: *const IPropertyStorage, cpspec: u32, rgpspec: [*]const PROPSPEC, rgpropvar: [*]PROPVARIANT) HRESULT {
        return self.vtable.ReadMultiple(self, cpspec, rgpspec, rgpropvar);
    }
    pub inline fn WriteMultiple(self: *const IPropertyStorage, cpspec: u32, rgpspec: [*]const PROPSPEC, rgpropvar: [*]const PROPVARIANT, propidNameFirst: u32) HRESULT {
        return self.vtable.WriteMultiple(self, cpspec, rgpspec, rgpropvar, propidNameFirst);
    }
    pub inline fn DeleteMultiple(self: *const IPropertyStorage, cpspec: u32, rgpspec: [*]const PROPSPEC) HRESULT {
        return self.vtable.DeleteMultiple(self, cpspec, rgpspec);
    }
    pub inline fn ReadPropertyNames(self: *const IPropertyStorage, cpropid: u32, rgpropid: [*]const u32, rglpwstrName: [*]?PWSTR) HRESULT {
        return self.vtable.ReadPropertyNames(self, cpropid, rgpropid, rglpwstrName);
    }
    pub inline fn WritePropertyNames(self: *const IPropertyStorage, cpropid: u32, rgpropid: [*]const u32, rglpwstrName: [*]const ?[*:0]const u16) HRESULT {
        return self.vtable.WritePropertyNames(self, cpropid, rgpropid, rglpwstrName);
    }
    pub inline fn DeletePropertyNames(self: *const IPropertyStorage, cpropid: u32, rgpropid: [*]const u32) HRESULT {
        return self.vtable.DeletePropertyNames(self, cpropid, rgpropid);
    }
    pub inline fn Commit(self: *const IPropertyStorage, grfCommitFlags: u32) HRESULT {
        return self.vtable.Commit(self, grfCommitFlags);
    }
    pub inline fn Revert(self: *const IPropertyStorage) HRESULT {
        return self.vtable.Revert(self);
    }
    pub inline fn Enum(self: *const IPropertyStorage, ppenum: ?*?*IEnumSTATPROPSTG) HRESULT {
        return self.vtable.Enum(self, ppenum);
    }
    pub inline fn SetTimes(self: *const IPropertyStorage, pctime: ?*const FILETIME, patime: ?*const FILETIME, pmtime: ?*const FILETIME) HRESULT {
        return self.vtable.SetTimes(self, pctime, patime, pmtime);
    }
    pub inline fn SetClass(self: *const IPropertyStorage, clsid: ?*const Guid) HRESULT {
        return self.vtable.SetClass(self, clsid);
    }
    pub inline fn Stat(self: *const IPropertyStorage, pstatpsstg: ?*STATPROPSETSTG) HRESULT {
...
pub const IPropertySetStorage = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Create(self: *const IPropertySetStorage, rfmtid: ?*const Guid, pclsid: ?*const Guid, grfFlags: u32, grfMode: u32, ppprstg: ?*?*IPropertyStorage) HRESULT {
        return self.vtable.Create(self, rfmtid, pclsid, grfFlags, grfMode, ppprstg);
    }
    pub inline fn Open(self: *const IPropertySetStorage, rfmtid: ?*const Guid, grfMode: u32, ppprstg: ?*?*IPropertyStorage) HRESULT {
        return self.vtable.Open(self, rfmtid, grfMode, ppprstg);
    }
    pub inline fn Delete(self: *const IPropertySetStorage, rfmtid: ?*const Guid) HRESULT {
        return self.vtable.Delete(self, rfmtid);
    }
    pub inline fn Enum(self: *const IPropertySetStorage, ppenum: ?*?*IEnumSTATPROPSETSTG) HRESULT {
        return self.vtable.Enum(self, ppenum);
    }
};
...
pub const IEnumSTATPROPSTG = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSTATPROPSTG, celt: u32, rgelt: [*]STATPROPSTG, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSTATPROPSTG, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSTATPROPSTG) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSTATPROPSTG, ppenum: ?*?*IEnumSTATPROPSTG) HRESULT {
        return self.vtable.Clone(self, ppenum);
    }
};
...
pub const IEnumSTATPROPSETSTG = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSTATPROPSETSTG, celt: u32, rgelt: [*]STATPROPSETSTG, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSTATPROPSETSTG, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSTATPROPSETSTG) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSTATPROPSETSTG, ppenum: ?*?*IEnumSTATPROPSETSTG) HRESULT {
        return self.vtable.Clone(self, ppenum);
    }
};
...
pub const IPropertyBag = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Read(self: *const IPropertyBag, pszPropName: ?[*:0]const u16, pVar: ?*VARIANT, pErrorLog: ?*IErrorLog) HRESULT {
        return self.vtable.Read(self, pszPropName, pVar, pErrorLog);
    }
    pub inline fn Write(self: *const IPropertyBag, pszPropName: ?[*:0]const u16, pVar: ?*VARIANT) HRESULT {
...
pub const IPropertyBag2 = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Read(self: *const IPropertyBag2, cProperties: u32, pPropBag: [*]PROPBAG2, pErrLog: ?*IErrorLog, pvarValue: [*]VARIANT, phrError: [*]HRESULT) HRESULT {
        return self.vtable.Read(self, cProperties, pPropBag, pErrLog, pvarValue, phrError);
    }
    pub inline fn Write(self: *const IPropertyBag2, cProperties: u32, pPropBag: [*]PROPBAG2, pvarValue: [*]VARIANT) HRESULT {
        return self.vtable.Write(self, cProperties, pPropBag, pvarValue);
    }
    pub inline fn CountProperties(self: *const IPropertyBag2, pcProperties: ?*u32) HRESULT {
        return self.vtable.CountProperties(self, pcProperties);
    }
    pub inline fn GetPropertyInfo(self: *const IPropertyBag2, iProperty: u32, cProperties: u32, pPropBag: [*]PROPBAG2, pcProperties: ?*u32) HRESULT {
        return self.vtable.GetPropertyInfo(self, iProperty, cProperties, pPropBag, pcProperties);
    }
    pub inline fn LoadObject(self: *const IPropertyBag2, pstrName: ?[*:0]const u16, dwHint: u32, pUnkObject: ?*IUnknown, pErrLog: ?*IErrorLog) HRESULT {
