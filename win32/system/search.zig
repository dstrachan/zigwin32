...
pub const IWordSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn PutWord(self: *const IWordSink, cwc: u32, pwcInBuf: ?[*:0]const u16, cwcSrcLen: u32, cwcSrcPos: u32) HRESULT {
        return self.vtable.PutWord(self, cwc, pwcInBuf, cwcSrcLen, cwcSrcPos);
    }
    pub inline fn PutAltWord(self: *const IWordSink, cwc: u32, pwcInBuf: ?[*:0]const u16, cwcSrcLen: u32, cwcSrcPos: u32) HRESULT {
        return self.vtable.PutAltWord(self, cwc, pwcInBuf, cwcSrcLen, cwcSrcPos);
    }
    pub inline fn StartAltPhrase(self: *const IWordSink) HRESULT {
        return self.vtable.StartAltPhrase(self);
    }
    pub inline fn EndAltPhrase(self: *const IWordSink) HRESULT {
        return self.vtable.EndAltPhrase(self);
    }
    pub inline fn PutBreak(self: *const IWordSink, breakType: WORDREP_BREAK_TYPE) HRESULT {
...
pub const IWordBreaker = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const IWordBreaker, fQuery: BOOL, ulMaxTokenSize: u32, pfLicense: ?*BOOL) HRESULT {
        return self.vtable.Init(self, fQuery, ulMaxTokenSize, pfLicense);
    }
    pub inline fn BreakText(self: *const IWordBreaker, pTextSource: ?*TEXT_SOURCE, pWordSink: ?*IWordSink, pPhraseSink: ?*IPhraseSink) HRESULT {
        return self.vtable.BreakText(self, pTextSource, pWordSink, pPhraseSink);
    }
    pub inline fn ComposePhrase(self: *const IWordBreaker, pwcNoun: ?[*:0]const u16, cwcNoun: u32, pwcModifier: ?[*:0]const u16, cwcModifier: u32, ulAttachmentType: u32, pwcPhrase: ?PWSTR, pcwcPhrase: ?*u32) HRESULT {
        return self.vtable.ComposePhrase(self, pwcNoun, cwcNoun, pwcModifier, cwcModifier, ulAttachmentType, pwcPhrase, pcwcPhrase);
    }
    pub inline fn GetLicenseToUse(self: *const IWordBreaker, ppwcsLicense: ?*const ?*u16) HRESULT {
...
pub const IWordFormSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn PutAltWord(self: *const IWordFormSink, pwcInBuf: ?[*:0]const u16, cwc: u32) HRESULT {
        return self.vtable.PutAltWord(self, pwcInBuf, cwc);
    }
    pub inline fn PutWord(self: *const IWordFormSink, pwcInBuf: ?[*:0]const u16, cwc: u32) HRESULT {
...
pub const IStemmer = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const IStemmer, ulMaxTokenSize: u32, pfLicense: ?*BOOL) HRESULT {
        return self.vtable.Init(self, ulMaxTokenSize, pfLicense);
    }
    pub inline fn GenerateWordForms(self: *const IStemmer, pwcInBuf: ?[*:0]const u16, cwc: u32, pStemSink: ?*IWordFormSink) HRESULT {
        return self.vtable.GenerateWordForms(self, pwcInBuf, cwc, pStemSink);
    }
    pub inline fn GetLicenseToUse(self: *const IStemmer, ppwcsLicense: ?*const ?*u16) HRESULT {
        return self.vtable.GetLicenseToUse(self, ppwcsLicense);
    }
};
...
pub const ISimpleCommandCreator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateICommand(self: *const ISimpleCommandCreator, ppIUnknown: ?*?*IUnknown, pOuterUnk: ?*IUnknown) HRESULT {
        return self.vtable.CreateICommand(self, ppIUnknown, pOuterUnk);
    }
    pub inline fn VerifyCatalog(self: *const ISimpleCommandCreator, pwszMachine: ?[*:0]const u16, pwszCatalogName: ?[*:0]const u16) HRESULT {
        return self.vtable.VerifyCatalog(self, pwszMachine, pwszCatalogName);
    }
    pub inline fn GetDefaultCatalog(self: *const ISimpleCommandCreator, pwszCatalogName: ?PWSTR, cwcIn: u32, pcwcOut: ?*u32) HRESULT {
...
pub const IColumnMapper = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetPropInfoFromName(self: *const IColumnMapper, wcsPropName: ?[*:0]const u16, ppPropId: ?*?*DBID, pPropType: ?*u16, puiWidth: ?*u32) HRESULT {
        return self.vtable.GetPropInfoFromName(self, wcsPropName, ppPropId, pPropType, puiWidth);
    }
    pub inline fn GetPropInfoFromId(self: *const IColumnMapper, pPropId: ?*const DBID, pwcsName: ?*?*u16, pPropType: ?*u16, puiWidth: ?*u32) HRESULT {
        return self.vtable.GetPropInfoFromId(self, pPropId, pwcsName, pPropType, puiWidth);
    }
    pub inline fn EnumPropInfo(self: *const IColumnMapper, iEntry: u32, pwcsName: ?*const ?*u16, ppPropId: ?*?*DBID, pPropType: ?*u16, puiWidth: ?*u32) HRESULT {
        return self.vtable.EnumPropInfo(self, iEntry, pwcsName, ppPropId, pPropType, puiWidth);
    }
    pub inline fn IsMapUpToDate(self: *const IColumnMapper) HRESULT {
...
pub const IColumnMapperCreator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetColumnMapper(self: *const IColumnMapperCreator, wcsMachineName: ?[*:0]const u16, wcsCatalogName: ?[*:0]const u16, ppColumnMapper: ?*?*IColumnMapper) HRESULT {
...
pub const ILoadFilter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn LoadIFilter(self: *const ILoadFilter, pwcsPath: ?[*:0]const u16, pFilteredSources: ?*FILTERED_DATA_SOURCES, pUnkOuter: ?*IUnknown, fUseDefault: BOOL, pFilterClsid: ?*Guid, SearchDecSize: ?*i32, pwcsSearchDesc: ?*?*u16, ppIFilt: ?*?*IFilter) HRESULT {
    ...
    pub inline fn LoadIFilterFromStorage(self: *const ILoadFilter, pStg: ?*IStorage, pUnkOuter: ?*IUnknown, pwcsOverride: ?[*:0]const u16, fUseDefault: BOOL, pFilterClsid: ?*Guid, SearchDecSize: ?*i32, pwcsSearchDesc: ?*?*u16, ppIFilt: ?*?*IFilter) HRESULT {
    ...
    pub inline fn LoadIFilterFromStream(self: *const ILoadFilter, pStm: ?*IStream, pFilteredSources: ?*FILTERED_DATA_SOURCES, pUnkOuter: ?*IUnknown, fUseDefault: BOOL, pFilterClsid: ?*Guid, SearchDecSize: ?*i32, pwcsSearchDesc: ?*?*u16, ppIFilt: ?*?*IFilter) HRESULT {
...
pub const ILoadFilterWithPrivateComActivation = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn LoadIFilterWithPrivateComActivation(self: *const ILoadFilterWithPrivateComActivation, filteredSources: ?*FILTERED_DATA_SOURCES, useDefault: BOOL, filterClsid: ?*Guid, isFilterPrivateComActivated: ?*BOOL, filterObj: ?*?*IFilter) HRESULT {
...
pub const IRichChunk = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetData(self: *const IRichChunk, pFirstPos: ?*u32, pLength: ?*u32, ppsz: ?*?PWSTR, pValue: ?*PROPVARIANT) HRESULT {
...
pub const ICondition = extern union {
    ...
    IPersist: IPersist,
    IUnknown: IUnknown,
    pub inline fn GetConditionType(self: *const ICondition, pNodeType: ?*CONDITION_TYPE) HRESULT {
        return self.vtable.GetConditionType(self, pNodeType);
    }
    pub inline fn GetSubConditions(self: *const ICondition, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.GetSubConditions(self, riid, ppv);
    }
    pub inline fn GetComparisonInfo(self: *const ICondition, ppszPropertyName: ?*?PWSTR, pcop: ?*CONDITION_OPERATION, ppropvar: ?*PROPVARIANT) HRESULT {
        return self.vtable.GetComparisonInfo(self, ppszPropertyName, pcop, ppropvar);
    }
    pub inline fn GetValueType(self: *const ICondition, ppszValueTypeName: ?*?PWSTR) HRESULT {
        return self.vtable.GetValueType(self, ppszValueTypeName);
    }
    pub inline fn GetValueNormalization(self: *const ICondition, ppszNormalization: ?*?PWSTR) HRESULT {
        return self.vtable.GetValueNormalization(self, ppszNormalization);
    }
    pub inline fn GetInputTerms(self: *const ICondition, ppPropertyTerm: ?*?*IRichChunk, ppOperationTerm: ?*?*IRichChunk, ppValueTerm: ?*?*IRichChunk) HRESULT {
        return self.vtable.GetInputTerms(self, ppPropertyTerm, ppOperationTerm, ppValueTerm);
    }
    pub inline fn Clone(self: *const ICondition, ppc: ?*?*ICondition) HRESULT {
...
pub const ICondition2 = extern union {
    ...
    IPersist: IPersist,
    IUnknown: IUnknown,
    pub inline fn GetLocale(self: *const ICondition2, ppszLocaleName: ?*?PWSTR) HRESULT {
        return self.vtable.GetLocale(self, ppszLocaleName);
    }
    pub inline fn GetLeafConditionInfo(self: *const ICondition2, ppropkey: ?*PROPERTYKEY, pcop: ?*CONDITION_OPERATION, ppropvar: ?*PROPVARIANT) HRESULT {
...
pub const IAccessor = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddRefAccessor(self: *const IAccessor, hAccessor: usize, pcRefCount: ?*u32) HRESULT {
        return self.vtable.AddRefAccessor(self, hAccessor, pcRefCount);
    }
    pub inline fn CreateAccessor(self: *const IAccessor, dwAccessorFlags: u32, cBindings: usize, rgBindings: [*]const DBBINDING, cbRowSize: usize, phAccessor: ?*usize, rgStatus: ?[*]u32) HRESULT {
        return self.vtable.CreateAccessor(self, dwAccessorFlags, cBindings, rgBindings, cbRowSize, phAccessor, rgStatus);
    }
    pub inline fn GetBindings(self: *const IAccessor, hAccessor: usize, pdwAccessorFlags: ?*u32, pcBindings: ?*usize, prgBindings: ?*?*DBBINDING) HRESULT {
        return self.vtable.GetBindings(self, hAccessor, pdwAccessorFlags, pcBindings, prgBindings);
    }
    pub inline fn ReleaseAccessor(self: *const IAccessor, hAccessor: usize, pcRefCount: ?*u32) HRESULT {
...
pub const IRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddRefRows(self: *const IRowset, cRows: usize, rghRows: ?*const usize, rgRefCounts: ?*u32, rgRowStatus: ?*u32) HRESULT {
        return self.vtable.AddRefRows(self, cRows, rghRows, rgRefCounts, rgRowStatus);
    }
    pub inline fn GetData(self: *const IRowset, hRow: usize, hAccessor: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.GetData(self, hRow, hAccessor, pData);
    }
    pub inline fn GetNextRows(self: *const IRowset, hReserved: usize, lRowsOffset: isize, cRows: isize, pcRowsObtained: ?*usize, prghRows: ?*?*usize) HRESULT {
        return self.vtable.GetNextRows(self, hReserved, lRowsOffset, cRows, pcRowsObtained, prghRows);
    }
    pub inline fn ReleaseRows(self: *const IRowset, cRows: usize, rghRows: ?*const usize, rgRowOptions: ?*u32, rgRefCounts: ?*u32, rgRowStatus: ?*u32) HRESULT {
        return self.vtable.ReleaseRows(self, cRows, rghRows, rgRowOptions, rgRefCounts, rgRowStatus);
    }
    pub inline fn RestartPosition(self: *const IRowset, hReserved: usize) HRESULT {
...
pub const IRowsetInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetProperties(self: *const IRowsetInfo, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertySets: ?*u32, prgPropertySets: ?*?*DBPROPSET) HRESULT {
        return self.vtable.GetProperties(self, cPropertyIDSets, rgPropertyIDSets, pcPropertySets, prgPropertySets);
    }
    pub inline fn GetReferencedRowset(self: *const IRowsetInfo, iOrdinal: usize, riid: ?*const Guid, ppReferencedRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.GetReferencedRowset(self, iOrdinal, riid, ppReferencedRowset);
    }
    pub inline fn GetSpecification(self: *const IRowsetInfo, riid: ?*const Guid, ppSpecification: ?*?*IUnknown) HRESULT {
...
pub const IRowsetLocate = extern union {
    ...
    IRowset: IRowset,
    IUnknown: IUnknown,
    pub inline fn Compare(self: *const IRowsetLocate, hReserved: usize, cbBookmark1: usize, pBookmark1: ?*const u8, cbBookmark2: usize, pBookmark2: ?*const u8, pComparison: ?*u32) HRESULT {
        return self.vtable.Compare(self, hReserved, cbBookmark1, pBookmark1, cbBookmark2, pBookmark2, pComparison);
    }
    pub inline fn GetRowsAt(self: *const IRowsetLocate, hReserved1: usize, hReserved2: usize, cbBookmark: usize, pBookmark: ?*const u8, lRowsOffset: isize, cRows: isize, pcRowsObtained: ?*usize, prghRows: ?*?*usize) HRESULT {
        return self.vtable.GetRowsAt(self, hReserved1, hReserved2, cbBookmark, pBookmark, lRowsOffset, cRows, pcRowsObtained, prghRows);
    }
    pub inline fn GetRowsByBookmark(self: *const IRowsetLocate, hReserved: usize, cRows: usize, rgcbBookmarks: ?*const usize, rgpBookmarks: ?*const ?*u8, rghRows: ?*usize, rgRowStatus: ?*u32) HRESULT {
        return self.vtable.GetRowsByBookmark(self, hReserved, cRows, rgcbBookmarks, rgpBookmarks, rghRows, rgRowStatus);
    }
    pub inline fn Hash(self: *const IRowsetLocate, hReserved: usize, cBookmarks: usize, rgcbBookmarks: ?*const usize, rgpBookmarks: ?*const ?*u8, rgHashedValues: ?*usize, rgBookmarkStatus: ?*u32) HRESULT {
...
pub const IRowsetResynch = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetVisibleData(self: *const IRowsetResynch, hRow: usize, hAccessor: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.GetVisibleData(self, hRow, hAccessor, pData);
    }
    pub inline fn ResynchRows(self: *const IRowsetResynch, cRows: usize, rghRows: ?*const usize, pcRowsResynched: ?*usize, prghRowsResynched: ?*?*usize, prgRowStatus: ?*?*u32) HRESULT {
...
pub const IRowsetScroll = extern union {
    ...
    IRowset: IRowset,
    IUnknown: IUnknown,
    pub inline fn GetApproximatePosition(self: *const IRowsetScroll, hReserved: usize, cbBookmark: usize, pBookmark: ?*const u8, pulPosition: ?*usize, pcRows: ?*usize) HRESULT {
        return self.vtable.GetApproximatePosition(self, hReserved, cbBookmark, pBookmark, pulPosition, pcRows);
    }
    pub inline fn GetRowsAtRatio(self: *const IRowsetScroll, hReserved1: usize, hReserved2: usize, ulNumerator: usize, ulDenominator: usize, cRows: isize, pcRowsObtained: ?*usize, prghRows: ?*?*usize) HRESULT {
...
pub const IChapteredRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddRefChapter(self: *const IChapteredRowset, hChapter: usize, pcRefCount: ?*u32) HRESULT {
        return self.vtable.AddRefChapter(self, hChapter, pcRefCount);
    }
    pub inline fn ReleaseChapter(self: *const IChapteredRowset, hChapter: usize, pcRefCount: ?*u32) HRESULT {
...
pub const IRowsetFind = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindNextRow(self: *const IRowsetFind, hChapter: usize, hAccessor: usize, pFindValue: ?*anyopaque, CompareOp: u32, cbBookmark: usize, pBookmark: ?*const u8, lRowsOffset: isize, cRows: isize, pcRowsObtained: ?*usize, prghRows: ?*?*usize) HRESULT {
...
pub const IRowPosition = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ClearRowPosition(self: *const IRowPosition) HRESULT {
        return self.vtable.ClearRowPosition(self);
    }
    pub inline fn GetRowPosition(self: *const IRowPosition, phChapter: ?*usize, phRow: ?*usize, pdwPositionFlags: ?*u32) HRESULT {
        return self.vtable.GetRowPosition(self, phChapter, phRow, pdwPositionFlags);
    }
    pub inline fn GetRowset(self: *const IRowPosition, riid: ?*const Guid, ppRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.GetRowset(self, riid, ppRowset);
    }
    pub inline fn Initialize(self: *const IRowPosition, pRowset: ?*IUnknown) HRESULT {
        return self.vtable.Initialize(self, pRowset);
    }
    pub inline fn SetRowPosition(self: *const IRowPosition, hChapter: usize, hRow: usize, dwPositionFlags: u32) HRESULT {
...
pub const IRowPositionChange = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnRowPositionChange(self: *const IRowPositionChange, eReason: u32, ePhase: u32, fCantDeny: BOOL) HRESULT {
...
pub const IViewRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSpecification(self: *const IViewRowset, riid: ?*const Guid, ppObject: ?*?*IUnknown) HRESULT {
        return self.vtable.GetSpecification(self, riid, ppObject);
    }
    pub inline fn OpenViewRowset(self: *const IViewRowset, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppRowset: ?*?*IUnknown) HRESULT {
...
pub const IViewChapter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSpecification(self: *const IViewChapter, riid: ?*const Guid, ppRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.GetSpecification(self, riid, ppRowset);
    }
    pub inline fn OpenViewChapter(self: *const IViewChapter, hSource: usize, phViewChapter: ?*usize) HRESULT {
...
pub const IViewSort = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSortOrder(self: *const IViewSort, pcValues: ?*usize, prgColumns: ?*?*usize, prgOrders: ?*?*u32) HRESULT {
        return self.vtable.GetSortOrder(self, pcValues, prgColumns, prgOrders);
    }
    pub inline fn SetSortOrder(self: *const IViewSort, cValues: usize, rgColumns: [*]const usize, rgOrders: [*]const u32) HRESULT {
...
pub const IViewFilter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFilter(self: *const IViewFilter, hAccessor: usize, pcRows: ?*usize, pCompareOps: [*]?*u32, pCriteriaData: ?*anyopaque) HRESULT {
        return self.vtable.GetFilter(self, hAccessor, pcRows, pCompareOps, pCriteriaData);
    }
    pub inline fn GetFilterBindings(self: *const IViewFilter, pcBindings: ?*usize, prgBindings: ?*?*DBBINDING) HRESULT {
        return self.vtable.GetFilterBindings(self, pcBindings, prgBindings);
    }
    pub inline fn SetFilter(self: *const IViewFilter, hAccessor: usize, cRows: usize, CompareOps: [*]u32, pCriteriaData: ?*anyopaque) HRESULT {
...
pub const IRowsetView = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateView(self: *const IRowsetView, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppView: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateView(self, pUnkOuter, riid, ppView);
    }
    pub inline fn GetView(self: *const IRowsetView, hChapter: usize, riid: ?*const Guid, phChapterSource: ?*usize, ppView: ?*?*IUnknown) HRESULT {
...
pub const IRowsetChange = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DeleteRows(self: *const IRowsetChange, hReserved: usize, cRows: usize, rghRows: ?*const usize, rgRowStatus: ?*u32) HRESULT {
        return self.vtable.DeleteRows(self, hReserved, cRows, rghRows, rgRowStatus);
    }
    pub inline fn SetData(self: *const IRowsetChange, hRow: usize, hAccessor: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.SetData(self, hRow, hAccessor, pData);
    }
    pub inline fn InsertRow(self: *const IRowsetChange, hReserved: usize, hAccessor: usize, pData: ?*anyopaque, phRow: ?*usize) HRESULT {
...
pub const IRowsetUpdate = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetOriginalData(self: *const IRowsetUpdate, hRow: usize, hAccessor: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.GetOriginalData(self, hRow, hAccessor, pData);
    }
    pub inline fn GetPendingRows(self: *const IRowsetUpdate, hReserved: usize, dwRowStatus: u32, pcPendingRows: ?*usize, prgPendingRows: ?*?*usize, prgPendingStatus: ?*?*u32) HRESULT {
        return self.vtable.GetPendingRows(self, hReserved, dwRowStatus, pcPendingRows, prgPendingRows, prgPendingStatus);
    }
    pub inline fn GetRowStatus(self: *const IRowsetUpdate, hReserved: usize, cRows: usize, rghRows: ?*const usize, rgPendingStatus: ?*u32) HRESULT {
        return self.vtable.GetRowStatus(self, hReserved, cRows, rghRows, rgPendingStatus);
    }
    pub inline fn Undo(self: *const IRowsetUpdate, hReserved: usize, cRows: usize, rghRows: ?*const usize, pcRowsUndone: ?*usize, prgRowsUndone: ?*?*usize, prgRowStatus: ?*?*u32) HRESULT {
        return self.vtable.Undo(self, hReserved, cRows, rghRows, pcRowsUndone, prgRowsUndone, prgRowStatus);
    }
    pub inline fn Update(self: *const IRowsetUpdate, hReserved: usize, cRows: usize, rghRows: ?*const usize, pcRows: ?*usize, prgRows: ?*?*usize, prgRowStatus: ?*?*u32) HRESULT {
...
pub const IRowsetIdentity = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsSameRow(self: *const IRowsetIdentity, hThisRow: usize, hThatRow: usize) HRESULT {
...
pub const IRowsetNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnFieldChange(self: *const IRowsetNotify, pRowset: ?*IRowset, hRow: usize, cColumns: usize, rgColumns: [*]usize, eReason: u32, ePhase: u32, fCantDeny: BOOL) HRESULT {
        return self.vtable.OnFieldChange(self, pRowset, hRow, cColumns, rgColumns, eReason, ePhase, fCantDeny);
    }
    pub inline fn OnRowChange(self: *const IRowsetNotify, pRowset: ?*IRowset, cRows: usize, rghRows: [*]const usize, eReason: u32, ePhase: u32, fCantDeny: BOOL) HRESULT {
        return self.vtable.OnRowChange(self, pRowset, cRows, rghRows, eReason, ePhase, fCantDeny);
    }
    pub inline fn OnRowsetChange(self: *const IRowsetNotify, pRowset: ?*IRowset, eReason: u32, ePhase: u32, fCantDeny: BOOL) HRESULT {
...
pub const IRowsetIndex = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetIndexInfo(self: *const IRowsetIndex, pcKeyColumns: ?*usize, prgIndexColumnDesc: ?*?*DBINDEXCOLUMNDESC, pcIndexPropertySets: ?*u32, prgIndexPropertySets: ?*?*DBPROPSET) HRESULT {
        return self.vtable.GetIndexInfo(self, pcKeyColumns, prgIndexColumnDesc, pcIndexPropertySets, prgIndexPropertySets);
    }
    pub inline fn Seek(self: *const IRowsetIndex, hAccessor: usize, cKeyValues: usize, pData: ?*anyopaque, dwSeekOptions: u32) HRESULT {
        return self.vtable.Seek(self, hAccessor, cKeyValues, pData, dwSeekOptions);
    }
    pub inline fn SetRange(self: *const IRowsetIndex, hAccessor: usize, cStartKeyColumns: usize, pStartData: ?*anyopaque, cEndKeyColumns: usize, pEndData: ?*anyopaque, dwRangeOptions: u32) HRESULT {
...
pub const ICommand = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Cancel(self: *const ICommand) HRESULT {
        return self.vtable.Cancel(self);
    }
    pub inline fn Execute(self: *const ICommand, pUnkOuter: ?*IUnknown, riid: ?*const Guid, pParams: ?*DBPARAMS, pcRowsAffected: ?*isize, ppRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.Execute(self, pUnkOuter, riid, pParams, pcRowsAffected, ppRowset);
    }
    pub inline fn GetDBSession(self: *const ICommand, riid: ?*const Guid, ppSession: ?*?*IUnknown) HRESULT {
...
pub const IMultipleResults = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetResult(self: *const IMultipleResults, pUnkOuter: ?*IUnknown, lResultFlag: isize, riid: ?*const Guid, pcRowsAffected: ?*isize, ppRowset: ?*?*IUnknown) HRESULT {
...
pub const IConvertType = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CanConvert(self: *const IConvertType, wFromType: u16, wToType: u16, dwConvertFlags: u32) HRESULT {
...
pub const ICommandPrepare = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Prepare(self: *const ICommandPrepare, cExpectedRuns: u32) HRESULT {
        return self.vtable.Prepare(self, cExpectedRuns);
    }
    pub inline fn Unprepare(self: *const ICommandPrepare) HRESULT {
...
pub const ICommandProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetProperties(self: *const ICommandProperties, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertySets: ?*u32, prgPropertySets: ?*?*DBPROPSET) HRESULT {
        return self.vtable.GetProperties(self, cPropertyIDSets, rgPropertyIDSets, pcPropertySets, prgPropertySets);
    }
    pub inline fn SetProperties(self: *const ICommandProperties, cPropertySets: u32, rgPropertySets: [*]DBPROPSET) HRESULT {
...
pub const ICommandText = extern union {
    ...
    ICommand: ICommand,
    IUnknown: IUnknown,
    pub inline fn GetCommandText(self: *const ICommandText, pguidDialect: ?*Guid, ppwszCommand: ?*?PWSTR) HRESULT {
        return self.vtable.GetCommandText(self, pguidDialect, ppwszCommand);
    }
    pub inline fn SetCommandText(self: *const ICommandText, rguidDialect: ?*const Guid, pwszCommand: ?[*:0]const u16) HRESULT {
...
pub const ICommandWithParameters = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetParameterInfo(self: *const ICommandWithParameters, pcParams: ?*usize, prgParamInfo: ?*?*DBPARAMINFO, ppNamesBuffer: ?*?*u16) HRESULT {
        return self.vtable.GetParameterInfo(self, pcParams, prgParamInfo, ppNamesBuffer);
    }
    pub inline fn MapParameterNames(self: *const ICommandWithParameters, cParamNames: usize, rgParamNames: [*]?PWSTR, rgParamOrdinals: [*]isize) HRESULT {
        return self.vtable.MapParameterNames(self, cParamNames, rgParamNames, rgParamOrdinals);
    }
    pub inline fn SetParameterInfo(self: *const ICommandWithParameters, cParams: usize, rgParamOrdinals: ?[*]const usize, rgParamBindInfo: ?[*]const DBPARAMBINDINFO) HRESULT {
...
pub const IColumnsRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetAvailableColumns(self: *const IColumnsRowset, pcOptColumns: ?*usize, prgOptColumns: ?*?*DBID) HRESULT {
        return self.vtable.GetAvailableColumns(self, pcOptColumns, prgOptColumns);
    }
    pub inline fn GetColumnsRowset(self: *const IColumnsRowset, pUnkOuter: ?*IUnknown, cOptColumns: usize, rgOptColumns: [*]const DBID, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET, ppColRowset: ?*?*IUnknown) HRESULT {
...
pub const IColumnsInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetColumnInfo(self: *const IColumnsInfo, pcColumns: ?*usize, prgInfo: ?*?*DBCOLUMNINFO, ppStringsBuffer: ?*?*u16) HRESULT {
        return self.vtable.GetColumnInfo(self, pcColumns, prgInfo, ppStringsBuffer);
    }
    pub inline fn MapColumnIDs(self: *const IColumnsInfo, cColumnIDs: usize, rgColumnIDs: ?[*]const DBID, rgColumns: ?[*]usize) HRESULT {
...
pub const IDBCreateCommand = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateCommand(self: *const IDBCreateCommand, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppCommand: ?*?*IUnknown) HRESULT {
...
pub const IDBCreateSession = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateSession(self: *const IDBCreateSession, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppDBSession: ?*?*IUnknown) HRESULT {
...
pub const ISourcesRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSourcesRowset(self: *const ISourcesRowset, pUnkOuter: ?*IUnknown, riid: ?*const Guid, cPropertySets: u32, rgProperties: ?[*]DBPROPSET, ppSourcesRowset: ?*?*IUnknown) HRESULT {
...
pub const IDBProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetProperties(self: *const IDBProperties, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertySets: ?*u32, prgPropertySets: ?*?*DBPROPSET) HRESULT {
        return self.vtable.GetProperties(self, cPropertyIDSets, rgPropertyIDSets, pcPropertySets, prgPropertySets);
    }
    pub inline fn GetPropertyInfo(self: *const IDBProperties, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertyInfoSets: ?*u32, prgPropertyInfoSets: ?*?*DBPROPINFOSET, ppDescBuffer: ?*?*u16) HRESULT {
    ...
    pub inline fn SetProperties(self: *const IDBProperties, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET) HRESULT {
        return self.vtable.SetProperties(self, cPropertySets, rgPropertySets);
    }
};
...
pub const IDBInitialize = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IDBInitialize) HRESULT {
        return self.vtable.Initialize(self);
    }
    pub inline fn Uninitialize(self: *const IDBInitialize) HRESULT {
...
pub const IDBInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetKeywords(self: *const IDBInfo, ppwszKeywords: ?*?PWSTR) HRESULT {
        return self.vtable.GetKeywords(self, ppwszKeywords);
    }
    pub inline fn GetLiteralInfo(self: *const IDBInfo, cLiterals: u32, rgLiterals: ?[*]const u32, pcLiteralInfo: ?*u32, prgLiteralInfo: ?*?*DBLITERALINFO, ppCharBuffer: ?*?*u16) HRESULT {
...
pub const IDBDataSourceAdmin = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateDataSource(self: *const IDBDataSourceAdmin, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppDBSession: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateDataSource(self, cPropertySets, rgPropertySets, pUnkOuter, riid, ppDBSession);
    }
    pub inline fn DestroyDataSource(self: *const IDBDataSourceAdmin) HRESULT {
        return self.vtable.DestroyDataSource(self);
    }
    pub inline fn GetCreationProperties(self: *const IDBDataSourceAdmin, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertyInfoSets: ?*u32, prgPropertyInfoSets: ?*?*DBPROPINFOSET, ppDescBuffer: ?*?*u16) HRESULT {
    ...
    pub inline fn ModifyDataSource(self: *const IDBDataSourceAdmin, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET) HRESULT {
...
pub const IDBAsynchNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnLowResource(self: *const IDBAsynchNotify, dwReserved: usize) HRESULT {
        return self.vtable.OnLowResource(self, dwReserved);
    }
    pub inline fn OnProgress(self: *const IDBAsynchNotify, hChapter: usize, eOperation: u32, ulProgress: usize, ulProgressMax: usize, eAsynchPhase: u32, pwszStatusText: ?PWSTR) HRESULT {
        return self.vtable.OnProgress(self, hChapter, eOperation, ulProgress, ulProgressMax, eAsynchPhase, pwszStatusText);
    }
    pub inline fn OnStop(self: *const IDBAsynchNotify, hChapter: usize, eOperation: u32, hrStatus: HRESULT, pwszStatusText: ?PWSTR) HRESULT {
...
pub const IDBAsynchStatus = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Abort(self: *const IDBAsynchStatus, hChapter: usize, eOperation: u32) HRESULT {
        return self.vtable.Abort(self, hChapter, eOperation);
    }
    pub inline fn GetStatus(self: *const IDBAsynchStatus, hChapter: usize, eOperation: u32, pulProgress: ?*usize, pulProgressMax: ?*usize, peAsynchPhase: ?*u32, ppwszStatusText: ?*?PWSTR) HRESULT {
...
pub const ISessionProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetProperties(self: *const ISessionProperties, cPropertyIDSets: u32, rgPropertyIDSets: ?[*]const DBPROPIDSET, pcPropertySets: ?*u32, prgPropertySets: ?*?*DBPROPSET) HRESULT {
        return self.vtable.GetProperties(self, cPropertyIDSets, rgPropertyIDSets, pcPropertySets, prgPropertySets);
    }
    pub inline fn SetProperties(self: *const ISessionProperties, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET) HRESULT {
        return self.vtable.SetProperties(self, cPropertySets, rgPropertySets);
    }
};
...
pub const IIndexDefinition = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateIndex(self: *const IIndexDefinition, pTableID: ?*DBID, pIndexID: ?*DBID, cIndexColumnDescs: usize, rgIndexColumnDescs: [*]const DBINDEXCOLUMNDESC, cPropertySets: u32, rgPropertySets: [*]DBPROPSET, ppIndexID: ?*?*DBID) HRESULT {
    ...
    pub inline fn DropIndex(self: *const IIndexDefinition, pTableID: ?*DBID, pIndexID: ?*DBID) HRESULT {
...
pub const ITableDefinition = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateTable(self: *const ITableDefinition, pUnkOuter: ?*IUnknown, pTableID: ?*DBID, cColumnDescs: usize, rgColumnDescs: ?[*]const DBCOLUMNDESC, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET, ppTableID: ?*?*DBID, ppRowset: ?*?*IUnknown) HRESULT {
    ...
    pub inline fn DropTable(self: *const ITableDefinition, pTableID: ?*DBID) HRESULT {
        return self.vtable.DropTable(self, pTableID);
    }
    pub inline fn AddColumn(self: *const ITableDefinition, pTableID: ?*DBID, pColumnDesc: ?*DBCOLUMNDESC, ppColumnID: ?*?*DBID) HRESULT {
        return self.vtable.AddColumn(self, pTableID, pColumnDesc, ppColumnID);
    }
    pub inline fn DropColumn(self: *const ITableDefinition, pTableID: ?*DBID, pColumnID: ?*DBID) HRESULT {
...
pub const IOpenRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OpenRowset(self: *const IOpenRowset, pUnkOuter: ?*IUnknown, pTableID: ?*DBID, pIndexID: ?*DBID, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET, ppRowset: ?*?*IUnknown) HRESULT {
...
pub const IDBSchemaRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetRowset(self: *const IDBSchemaRowset, pUnkOuter: ?*IUnknown, rguidSchema: ?*const Guid, cRestrictions: u32, rgRestrictions: ?[*]const VARIANT, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?[*]DBPROPSET, ppRowset: ?*?*IUnknown) HRESULT {
    ...
    pub inline fn GetSchemas(self: *const IDBSchemaRowset, pcSchemas: ?*u32, prgSchemas: ?*?*Guid, prgRestrictionSupport: ?*?*u32) HRESULT {
...
pub const IMDDataset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FreeAxisInfo(self: *const IMDDataset, cAxes: usize, rgAxisInfo: ?*MDAXISINFO) HRESULT {
        return self.vtable.FreeAxisInfo(self, cAxes, rgAxisInfo);
    }
    pub inline fn GetAxisInfo(self: *const IMDDataset, pcAxes: ?*usize, prgAxisInfo: ?*?*MDAXISINFO) HRESULT {
        return self.vtable.GetAxisInfo(self, pcAxes, prgAxisInfo);
    }
    pub inline fn GetAxisRowset(self: *const IMDDataset, pUnkOuter: ?*IUnknown, iAxis: usize, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?*DBPROPSET, ppRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.GetAxisRowset(self, pUnkOuter, iAxis, riid, cPropertySets, rgPropertySets, ppRowset);
    }
    pub inline fn GetCellData(self: *const IMDDataset, hAccessor: usize, ulStartCell: usize, ulEndCell: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.GetCellData(self, hAccessor, ulStartCell, ulEndCell, pData);
    }
    pub inline fn GetSpecification(self: *const IMDDataset, riid: ?*const Guid, ppSpecification: ?*?*IUnknown) HRESULT {
        return self.vtable.GetSpecification(self, riid, ppSpecification);
    }
};
...
pub const IMDFind = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn FindCell(self: *const IMDFind, ulStartingOrdinal: usize, cMembers: usize, rgpwszMember: ?*?PWSTR, pulCellOrdinal: ?*usize) HRESULT {
        return self.vtable.FindCell(self, ulStartingOrdinal, cMembers, rgpwszMember, pulCellOrdinal);
    }
    pub inline fn FindTuple(self: *const IMDFind, ulAxisIdentifier: u32, ulStartingOrdinal: usize, cMembers: usize, rgpwszMember: ?*?PWSTR, pulTupleOrdinal: ?*u32) HRESULT {
...
pub const IMDRangeRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetRangeRowset(self: *const IMDRangeRowset, pUnkOuter: ?*IUnknown, ulStartCell: usize, ulEndCell: usize, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?*DBPROPSET, ppRowset: ?*?*IUnknown) HRESULT {
...
pub const IAlterTable = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AlterColumn(self: *const IAlterTable, pTableId: ?*DBID, pColumnId: ?*DBID, dwColumnDescFlags: u32, pColumnDesc: ?*DBCOLUMNDESC) HRESULT {
        return self.vtable.AlterColumn(self, pTableId, pColumnId, dwColumnDescFlags, pColumnDesc);
    }
    pub inline fn AlterTable(self: *const IAlterTable, pTableId: ?*DBID, pNewTableId: ?*DBID, cPropertySets: u32, rgPropertySets: ?*DBPROPSET) HRESULT {
...
pub const IAlterIndex = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AlterIndex(self: *const IAlterIndex, pTableId: ?*DBID, pIndexId: ?*DBID, pNewIndexId: ?*DBID, cPropertySets: u32, rgPropertySets: ?*DBPROPSET) HRESULT {
...
pub const IRowsetChapterMember = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsRowInChapter(self: *const IRowsetChapterMember, hChapter: usize, hRow: usize) HRESULT {
...
pub const ICommandPersist = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DeleteCommand(self: *const ICommandPersist, pCommandID: ?*DBID) HRESULT {
        return self.vtable.DeleteCommand(self, pCommandID);
    }
    pub inline fn GetCurrentCommand(self: *const ICommandPersist, ppCommandID: ?*?*DBID) HRESULT {
        return self.vtable.GetCurrentCommand(self, ppCommandID);
    }
    pub inline fn LoadCommand(self: *const ICommandPersist, pCommandID: ?*DBID, dwFlags: u32) HRESULT {
        return self.vtable.LoadCommand(self, pCommandID, dwFlags);
    }
    pub inline fn SaveCommand(self: *const ICommandPersist, pCommandID: ?*DBID, dwFlags: u32) HRESULT {
...
pub const IRowsetRefresh = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RefreshVisibleData(self: *const IRowsetRefresh, hChapter: usize, cRows: usize, rghRows: ?*const usize, fOverWrite: BOOL, pcRowsRefreshed: ?*usize, prghRowsRefreshed: ?*?*usize, prgRowStatus: ?*?*u32) HRESULT {
    ...
    pub inline fn GetLastVisibleData(self: *const IRowsetRefresh, hRow: usize, hAccessor: usize, pData: ?*anyopaque) HRESULT {
...
pub const IParentRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetChildRowset(self: *const IParentRowset, pUnkOuter: ?*IUnknown, iOrdinal: usize, riid: ?*const Guid, ppRowset: ?*?*IUnknown) HRESULT {
...
pub const IErrorRecords = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddErrorRecord(self: *const IErrorRecords, pErrorInfo: ?*ERRORINFO, dwLookupID: u32, pdispparams: ?*DISPPARAMS, punkCustomError: ?*IUnknown, dwDynamicErrorID: u32) HRESULT {
        return self.vtable.AddErrorRecord(self, pErrorInfo, dwLookupID, pdispparams, punkCustomError, dwDynamicErrorID);
    }
    pub inline fn GetBasicErrorInfo(self: *const IErrorRecords, ulRecordNum: u32, pErrorInfo: ?*ERRORINFO) HRESULT {
        return self.vtable.GetBasicErrorInfo(self, ulRecordNum, pErrorInfo);
    }
    pub inline fn GetCustomErrorObject(self: *const IErrorRecords, ulRecordNum: u32, riid: ?*const Guid, ppObject: ?*?*IUnknown) HRESULT {
        return self.vtable.GetCustomErrorObject(self, ulRecordNum, riid, ppObject);
    }
    pub inline fn GetErrorInfo(self: *const IErrorRecords, ulRecordNum: u32, lcid: u32, ppErrorInfo: ?*?*IErrorInfo) HRESULT {
        return self.vtable.GetErrorInfo(self, ulRecordNum, lcid, ppErrorInfo);
    }
    pub inline fn GetErrorParameters(self: *const IErrorRecords, ulRecordNum: u32, pdispparams: ?*DISPPARAMS) HRESULT {
        return self.vtable.GetErrorParameters(self, ulRecordNum, pdispparams);
    }
    pub inline fn GetRecordCount(self: *const IErrorRecords, pcRecords: ?*u32) HRESULT {
...
pub const IErrorLookup = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetErrorDescription(self: *const IErrorLookup, hrError: HRESULT, dwLookupID: u32, pdispparams: ?*DISPPARAMS, lcid: u32, pbstrSource: ?*?BSTR, pbstrDescription: ?*?BSTR) HRESULT {
        return self.vtable.GetErrorDescription(self, hrError, dwLookupID, pdispparams, lcid, pbstrSource, pbstrDescription);
    }
    pub inline fn GetHelpInfo(self: *const IErrorLookup, hrError: HRESULT, dwLookupID: u32, lcid: u32, pbstrHelpFile: ?*?BSTR, pdwHelpContext: ?*u32) HRESULT {
        return self.vtable.GetHelpInfo(self, hrError, dwLookupID, lcid, pbstrHelpFile, pdwHelpContext);
    }
    pub inline fn ReleaseErrors(self: *const IErrorLookup, dwDynamicErrorID: u32) HRESULT {
...
pub const ISQLErrorInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSQLInfo(self: *const ISQLErrorInfo, pbstrSQLState: ?*?BSTR, plNativeError: ?*i32) HRESULT {
...
pub const IGetDataSource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetDataSource(self: *const IGetDataSource, riid: ?*const Guid, ppDataSource: ?*?*IUnknown) HRESULT {
...
pub const ITransactionLocal = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetOptionsObject(self: *const ITransactionLocal, ppOptions: ?*?*ITransactionOptions) HRESULT {
        return self.vtable.GetOptionsObject(self, ppOptions);
    }
    pub inline fn StartTransaction(self: *const ITransactionLocal, isoLevel: i32, isoFlags: u32, pOtherOptions: ?*ITransactionOptions, pulTransactionLevel: ?*u32) HRESULT {
...
pub const ITransactionJoin = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetOptionsObject(self: *const ITransactionJoin, ppOptions: ?*?*ITransactionOptions) HRESULT {
        return self.vtable.GetOptionsObject(self, ppOptions);
    }
    pub inline fn JoinTransaction(self: *const ITransactionJoin, punkTransactionCoord: ?*IUnknown, isoLevel: i32, isoFlags: u32, pOtherOptions: ?*ITransactionOptions) HRESULT {
...
pub const ITransactionObject = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetTransactionObject(self: *const ITransactionObject, ulTransactionLevel: u32, ppTransactionObject: ?*?*ITransaction) HRESULT {
...
pub const ITrusteeAdmin = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CompareTrustees(self: *const ITrusteeAdmin, pTrustee1: ?*TRUSTEE_W, pTrustee2: ?*TRUSTEE_W) HRESULT {
        return self.vtable.CompareTrustees(self, pTrustee1, pTrustee2);
    }
    pub inline fn CreateTrustee(self: *const ITrusteeAdmin, pTrustee: ?*TRUSTEE_W, cPropertySets: u32, rgPropertySets: ?*DBPROPSET) HRESULT {
        return self.vtable.CreateTrustee(self, pTrustee, cPropertySets, rgPropertySets);
    }
    pub inline fn DeleteTrustee(self: *const ITrusteeAdmin, pTrustee: ?*TRUSTEE_W) HRESULT {
        return self.vtable.DeleteTrustee(self, pTrustee);
    }
    pub inline fn SetTrusteeProperties(self: *const ITrusteeAdmin, pTrustee: ?*TRUSTEE_W, cPropertySets: u32, rgPropertySets: ?*DBPROPSET) HRESULT {
        return self.vtable.SetTrusteeProperties(self, pTrustee, cPropertySets, rgPropertySets);
    }
    pub inline fn GetTrusteeProperties(self: *const ITrusteeAdmin, pTrustee: ?*TRUSTEE_W, cPropertyIDSets: u32, rgPropertyIDSets: ?*const DBPROPIDSET, pcPropertySets: ?*u32, prgPropertySets: ?*?*DBPROPSET) HRESULT {
...
pub const ITrusteeGroupAdmin = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddMember(self: *const ITrusteeGroupAdmin, pMembershipTrustee: ?*TRUSTEE_W, pMemberTrustee: ?*TRUSTEE_W) HRESULT {
        return self.vtable.AddMember(self, pMembershipTrustee, pMemberTrustee);
    }
    pub inline fn DeleteMember(self: *const ITrusteeGroupAdmin, pMembershipTrustee: ?*TRUSTEE_W, pMemberTrustee: ?*TRUSTEE_W) HRESULT {
        return self.vtable.DeleteMember(self, pMembershipTrustee, pMemberTrustee);
    }
    pub inline fn IsMember(self: *const ITrusteeGroupAdmin, pMembershipTrustee: ?*TRUSTEE_W, pMemberTrustee: ?*TRUSTEE_W, pfStatus: ?*BOOL) HRESULT {
        return self.vtable.IsMember(self, pMembershipTrustee, pMemberTrustee, pfStatus);
    }
    pub inline fn GetMembers(self: *const ITrusteeGroupAdmin, pMembershipTrustee: ?*TRUSTEE_W, pcMembers: ?*u32, prgMembers: ?*?*TRUSTEE_W) HRESULT {
        return self.vtable.GetMembers(self, pMembershipTrustee, pcMembers, prgMembers);
    }
    pub inline fn GetMemberships(self: *const ITrusteeGroupAdmin, pTrustee: ?*TRUSTEE_W, pcMemberships: ?*u32, prgMemberships: ?*?*TRUSTEE_W) HRESULT {
...
pub const IObjectAccessControl = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetObjectAccessRights(self: *const IObjectAccessControl, pObject: ?*SEC_OBJECT, pcAccessEntries: ?*u32, prgAccessEntries: ?*?*EXPLICIT_ACCESS_W) HRESULT {
        return self.vtable.GetObjectAccessRights(self, pObject, pcAccessEntries, prgAccessEntries);
    }
    pub inline fn GetObjectOwner(self: *const IObjectAccessControl, pObject: ?*SEC_OBJECT, ppOwner: ?*?*TRUSTEE_W) HRESULT {
        return self.vtable.GetObjectOwner(self, pObject, ppOwner);
    }
    pub inline fn IsObjectAccessAllowed(self: *const IObjectAccessControl, pObject: ?*SEC_OBJECT, pAccessEntry: ?*EXPLICIT_ACCESS_W, pfResult: ?*BOOL) HRESULT {
        return self.vtable.IsObjectAccessAllowed(self, pObject, pAccessEntry, pfResult);
    }
    pub inline fn SetObjectAccessRights(self: *const IObjectAccessControl, pObject: ?*SEC_OBJECT, cAccessEntries: u32, prgAccessEntries: ?*EXPLICIT_ACCESS_W) HRESULT {
        return self.vtable.SetObjectAccessRights(self, pObject, cAccessEntries, prgAccessEntries);
    }
    pub inline fn SetObjectOwner(self: *const IObjectAccessControl, pObject: ?*SEC_OBJECT, pOwner: ?*TRUSTEE_W) HRESULT {
...
pub const ISecurityInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCurrentTrustee(self: *const ISecurityInfo, ppTrustee: ?*?*TRUSTEE_W) HRESULT {
        return self.vtable.GetCurrentTrustee(self, ppTrustee);
    }
    pub inline fn GetObjectTypes(self: *const ISecurityInfo, cObjectTypes: ?*u32, rgObjectTypes: ?*?*Guid) HRESULT {
        return self.vtable.GetObjectTypes(self, cObjectTypes, rgObjectTypes);
    }
    pub inline fn GetPermissions(self: *const ISecurityInfo, ObjectType: Guid, pPermissions: ?*u32) HRESULT {
...
pub const ITableCreation = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetTableDefinition(self: *const ITableCreation, pTableID: ?*DBID, pcColumnDescs: ?*usize, prgColumnDescs: ?[*]?*DBCOLUMNDESC, pcPropertySets: ?*u32, prgPropertySets: ?[*]?*DBPROPSET, pcConstraintDescs: ?*u32, prgConstraintDescs: ?[*]?*DBCONSTRAINTDESC, ppwszStringBuffer: ?*?*u16) HRESULT {
...
pub const ITableDefinitionWithConstraints = extern union {
    ...
    ITableDefinition: ITableDefinition,
    IUnknown: IUnknown,
    pub inline fn AddConstraint(self: *const ITableDefinitionWithConstraints, pTableID: ?*DBID, pConstraintDesc: ?*DBCONSTRAINTDESC) HRESULT {
        return self.vtable.AddConstraint(self, pTableID, pConstraintDesc);
    }
    pub inline fn CreateTableWithConstraints(self: *const ITableDefinitionWithConstraints, pUnkOuter: ?*IUnknown, pTableID: ?*DBID, cColumnDescs: usize, rgColumnDescs: ?*DBCOLUMNDESC, cConstraintDescs: u32, rgConstraintDescs: ?*DBCONSTRAINTDESC, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: ?*DBPROPSET, ppTableID: ?*?*DBID, ppRowset: ?*?*IUnknown) HRESULT {
    ...
    pub inline fn DropConstraint(self: *const ITableDefinitionWithConstraints, pTableID: ?*DBID, pConstraintID: ?*DBID) HRESULT {
...
pub const IRow = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetColumns(self: *const IRow, cColumns: usize, rgColumns: [*]DBCOLUMNACCESS) HRESULT {
        return self.vtable.GetColumns(self, cColumns, rgColumns);
    }
    pub inline fn GetSourceRowset(self: *const IRow, riid: ?*const Guid, ppRowset: ?*?*IUnknown, phRow: ?*usize) HRESULT {
        return self.vtable.GetSourceRowset(self, riid, ppRowset, phRow);
    }
    pub inline fn Open(self: *const IRow, pUnkOuter: ?*IUnknown, pColumnID: ?*DBID, rguidColumnType: ?*const Guid, dwBindFlags: u32, riid: ?*const Guid, ppUnk: ?*?*IUnknown) HRESULT {
...
pub const IRowChange = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetColumns(self: *const IRowChange, cColumns: usize, rgColumns: [*]DBCOLUMNACCESS) HRESULT {
...
pub const IRowSchemaChange = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn DeleteColumns(self: *const IRowSchemaChange, cColumns: usize, rgColumnIDs: ?*const DBID, rgdwStatus: ?*u32) HRESULT {
        return self.vtable.DeleteColumns(self, cColumns, rgColumnIDs, rgdwStatus);
    }
    pub inline fn AddColumns(self: *const IRowSchemaChange, cColumns: usize, rgNewColumnInfo: ?*const DBCOLUMNINFO, rgColumns: ?*DBCOLUMNACCESS) HRESULT {
...
pub const IGetRow = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetRowFromHROW(self: *const IGetRow, pUnkOuter: ?*IUnknown, hRow: usize, riid: ?*const Guid, ppUnk: ?*?*IUnknown) HRESULT {
        return self.vtable.GetRowFromHROW(self, pUnkOuter, hRow, riid, ppUnk);
    }
    pub inline fn GetURLFromHROW(self: *const IGetRow, hRow: usize, ppwszURL: ?*?PWSTR) HRESULT {
...
pub const IBindResource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Bind(self: *const IBindResource, pUnkOuter: ?*IUnknown, pwszURL: ?[*:0]const u16, dwBindURLFlags: u32, rguid: ?*const Guid, riid: ?*const Guid, pAuthenticate: ?*IAuthenticate, pImplSession: ?*DBIMPLICITSESSION, pdwBindStatus: ?*u32, ppUnk: ?*?*IUnknown) HRESULT {
...
pub const IScopedOperations = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Copy(self: *const IScopedOperations, cRows: usize, rgpwszSourceURLs: ?[*]?PWSTR, rgpwszDestURLs: [*]?PWSTR, dwCopyFlags: u32, pAuthenticate: ?*IAuthenticate, rgdwStatus: [*]u32, rgpwszNewURLs: ?[*]?PWSTR, ppStringsBuffer: ?*?*u16) HRESULT {
    ...
    pub inline fn Move(self: *const IScopedOperations, cRows: usize, rgpwszSourceURLs: ?[*]?PWSTR, rgpwszDestURLs: [*]?PWSTR, dwMoveFlags: u32, pAuthenticate: ?*IAuthenticate, rgdwStatus: [*]u32, rgpwszNewURLs: ?[*]?PWSTR, ppStringsBuffer: ?*?*u16) HRESULT {
    ...
    pub inline fn Delete(self: *const IScopedOperations, cRows: usize, rgpwszURLs: [*]?PWSTR, dwDeleteFlags: u32, rgdwStatus: [*]u32) HRESULT {
        return self.vtable.Delete(self, cRows, rgpwszURLs, dwDeleteFlags, rgdwStatus);
    }
    pub inline fn OpenRowset(self: *const IScopedOperations, pUnkOuter: ?*IUnknown, pTableID: ?*DBID, pIndexID: ?*DBID, riid: ?*const Guid, cPropertySets: u32, rgPropertySets: [*]DBPROPSET, ppRowset: ?*?*IUnknown) HRESULT {
        return self.vtable.OpenRowset(self, pUnkOuter, pTableID, pIndexID, riid, cPropertySets, rgPropertySets, ppRowset);
    }
};
...
pub const ICreateRow = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateRow(self: *const ICreateRow, pUnkOuter: ?*IUnknown, pwszURL: ?[*:0]const u16, dwBindURLFlags: u32, rguid: ?*const Guid, riid: ?*const Guid, pAuthenticate: ?*IAuthenticate, pImplSession: ?*DBIMPLICITSESSION, pdwBindStatus: ?*u32, ppwszNewURL: ?*?PWSTR, ppUnk: ?*?*IUnknown) HRESULT {
...
pub const IDBBinderProperties = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn Reset(self: *const IDBBinderProperties) HRESULT {
...
pub const IColumnsInfo2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetRestrictedColumnInfo(self: *const IColumnsInfo2, cColumnIDMasks: usize, rgColumnIDMasks: [*]const DBID, dwFlags: u32, pcColumns: ?*usize, prgColumnIDs: ?*?*DBID, prgColumnInfo: ?*?*DBCOLUMNINFO, ppStringsBuffer: ?*?*u16) HRESULT {
...
pub const IRegisterProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetURLMapping(self: *const IRegisterProvider, pwszURL: ?[*:0]const u16, dwReserved: usize, pclsidProvider: ?*Guid) HRESULT {
        return self.vtable.GetURLMapping(self, pwszURL, dwReserved, pclsidProvider);
    }
    pub inline fn SetURLMapping(self: *const IRegisterProvider, pwszURL: ?[*:0]const u16, dwReserved: usize, rclsidProvider: ?*const Guid) HRESULT {
        return self.vtable.SetURLMapping(self, pwszURL, dwReserved, rclsidProvider);
    }
    pub inline fn UnregisterProvider(self: *const IRegisterProvider, pwszURL: ?[*:0]const u16, dwReserved: usize, rclsidProvider: ?*const Guid) HRESULT {
...
pub const IGetSession = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSession(self: *const IGetSession, riid: ?*const Guid, ppSession: ?*?*IUnknown) HRESULT {
...
pub const IGetSourceRow = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSourceRow(self: *const IGetSourceRow, riid: ?*const Guid, ppRow: ?*?*IUnknown) HRESULT {
...
pub const IRowsetCurrentIndex = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetIndex(self: *const IRowsetCurrentIndex, ppIndexID: ?*?*DBID) HRESULT {
        return self.vtable.GetIndex(self, ppIndexID);
    }
    pub inline fn SetIndex(self: *const IRowsetCurrentIndex, pIndexID: ?*DBID) HRESULT {
...
pub const ICommandStream = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCommandStream(self: *const ICommandStream, piid: ?*Guid, pguidDialect: ?*Guid, ppCommandStream: ?*?*IUnknown) HRESULT {
        return self.vtable.GetCommandStream(self, piid, pguidDialect, ppCommandStream);
    }
    pub inline fn SetCommandStream(self: *const ICommandStream, riid: ?*const Guid, rguidDialect: ?*const Guid, pCommandStream: ?*IUnknown) HRESULT {
...
pub const IRowsetBookmark = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn PositionOnBookmark(self: *const IRowsetBookmark, hChapter: usize, cbBookmark: usize, pBookmark: ?*const u8) HRESULT {
...
pub const IQueryParser = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Parse(self: *const IQueryParser, pszInputString: ?[*:0]const u16, pCustomProperties: ?*IEnumUnknown, ppSolution: ?*?*IQuerySolution) HRESULT {
        return self.vtable.Parse(self, pszInputString, pCustomProperties, ppSolution);
    }
    pub inline fn SetOption(self: *const IQueryParser, option: STRUCTURED_QUERY_SINGLE_OPTION, pOptionValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.SetOption(self, option, pOptionValue);
    }
    pub inline fn GetOption(self: *const IQueryParser, option: STRUCTURED_QUERY_SINGLE_OPTION, pOptionValue: ?*PROPVARIANT) HRESULT {
        return self.vtable.GetOption(self, option, pOptionValue);
    }
    pub inline fn SetMultiOption(self: *const IQueryParser, option: STRUCTURED_QUERY_MULTIOPTION, pszOptionKey: ?[*:0]const u16, pOptionValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.SetMultiOption(self, option, pszOptionKey, pOptionValue);
    }
    pub inline fn GetSchemaProvider(self: *const IQueryParser, ppSchemaProvider: ?*?*ISchemaProvider) HRESULT {
        return self.vtable.GetSchemaProvider(self, ppSchemaProvider);
    }
    pub inline fn RestateToString(self: *const IQueryParser, pCondition: ?*ICondition, fUseEnglish: BOOL, ppszQueryString: ?*?PWSTR) HRESULT {
        return self.vtable.RestateToString(self, pCondition, fUseEnglish, ppszQueryString);
    }
    pub inline fn ParsePropertyValue(self: *const IQueryParser, pszPropertyName: ?[*:0]const u16, pszInputString: ?[*:0]const u16, ppSolution: ?*?*IQuerySolution) HRESULT {
        return self.vtable.ParsePropertyValue(self, pszPropertyName, pszInputString, ppSolution);
    }
    pub inline fn RestatePropertyValueToString(self: *const IQueryParser, pCondition: ?*ICondition, fUseEnglish: BOOL, ppszPropertyName: ?*?PWSTR, ppszQueryString: ?*?PWSTR) HRESULT {
...
pub const IConditionFactory = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn MakeNot(self: *const IConditionFactory, pcSub: ?*ICondition, fSimplify: BOOL, ppcResult: ?*?*ICondition) HRESULT {
        return self.vtable.MakeNot(self, pcSub, fSimplify, ppcResult);
    }
    pub inline fn MakeAndOr(self: *const IConditionFactory, ct: CONDITION_TYPE, peuSubs: ?*IEnumUnknown, fSimplify: BOOL, ppcResult: ?*?*ICondition) HRESULT {
        return self.vtable.MakeAndOr(self, ct, peuSubs, fSimplify, ppcResult);
    }
    pub inline fn MakeLeaf(self: *const IConditionFactory, pszPropertyName: ?[*:0]const u16, cop: CONDITION_OPERATION, pszValueType: ?[*:0]const u16, ppropvar: ?*const PROPVARIANT, pPropertyNameTerm: ?*IRichChunk, pOperationTerm: ?*IRichChunk, pValueTerm: ?*IRichChunk, fExpand: BOOL, ppcResult: ?*?*ICondition) HRESULT {
    ...
    pub inline fn Resolve(self: *const IConditionFactory, pc: ?*ICondition, sqro: STRUCTURED_QUERY_RESOLVE_OPTION, pstReferenceTime: ?*const SYSTEMTIME, ppcResolved: ?*?*ICondition) HRESULT {
...
pub const IQuerySolution = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetQuery(self: *const IQuerySolution, ppQueryNode: ?*?*ICondition, ppMainType: ?*?*IEntity) HRESULT {
        return self.vtable.GetQuery(self, ppQueryNode, ppMainType);
    }
    pub inline fn GetErrors(self: *const IQuerySolution, riid: ?*const Guid, ppParseErrors: **anyopaque) HRESULT {
        return self.vtable.GetErrors(self, riid, ppParseErrors);
    }
    pub inline fn GetLexicalData(self: *const IQuerySolution, ppszInputString: ?*?PWSTR, ppTokens: ?*?*ITokenCollection, plcid: ?*u32, ppWordBreaker: ?*?*IUnknown) HRESULT {
...
pub const IConditionFactory2 = extern union {
    ...
    IConditionFactory: IConditionFactory,
    IUnknown: IUnknown,
    pub inline fn CreateTrueFalse(self: *const IConditionFactory2, fVal: BOOL, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateTrueFalse(self, fVal, cco, riid, ppv);
    }
    pub inline fn CreateNegation(self: *const IConditionFactory2, pcSub: ?*ICondition, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateNegation(self, pcSub, cco, riid, ppv);
    }
    pub inline fn CreateCompoundFromObjectArray(self: *const IConditionFactory2, ct: CONDITION_TYPE, poaSubs: ?*IObjectArray, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateCompoundFromObjectArray(self, ct, poaSubs, cco, riid, ppv);
    }
    pub inline fn CreateCompoundFromArray(self: *const IConditionFactory2, ct: CONDITION_TYPE, ppcondSubs: [*]?*ICondition, cSubs: u32, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateCompoundFromArray(self, ct, ppcondSubs, cSubs, cco, riid, ppv);
    }
    pub inline fn CreateStringLeaf(self: *const IConditionFactory2, propkey: ?*const PROPERTYKEY, cop: CONDITION_OPERATION, pszValue: ?[*:0]const u16, pszLocaleName: ?[*:0]const u16, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateStringLeaf(self, propkey, cop, pszValue, pszLocaleName, cco, riid, ppv);
    }
    pub inline fn CreateIntegerLeaf(self: *const IConditionFactory2, propkey: ?*const PROPERTYKEY, cop: CONDITION_OPERATION, lValue: i32, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateIntegerLeaf(self, propkey, cop, lValue, cco, riid, ppv);
    }
    pub inline fn CreateBooleanLeaf(self: *const IConditionFactory2, propkey: ?*const PROPERTYKEY, cop: CONDITION_OPERATION, fValue: BOOL, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
        return self.vtable.CreateBooleanLeaf(self, propkey, cop, fValue, cco, riid, ppv);
    }
    pub inline fn CreateLeaf(self: *const IConditionFactory2, propkey: ?*const PROPERTYKEY, cop: CONDITION_OPERATION, propvar: ?*const PROPVARIANT, pszSemanticType: ?[*:0]const u16, pszLocaleName: ?[*:0]const u16, pPropertyNameTerm: ?*IRichChunk, pOperationTerm: ?*IRichChunk, pValueTerm: ?*IRichChunk, cco: CONDITION_CREATION_OPTIONS, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
    ...
    pub inline fn ResolveCondition(self: *const IConditionFactory2, pc: ?*ICondition, sqro: STRUCTURED_QUERY_RESOLVE_OPTION, pstReferenceTime: ?*const SYSTEMTIME, riid: ?*const Guid, ppv: **anyopaque) HRESULT {
...
pub const IConditionGenerator = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IConditionGenerator, pSchemaProvider: ?*ISchemaProvider) HRESULT {
        return self.vtable.Initialize(self, pSchemaProvider);
    }
    pub inline fn RecognizeNamedEntities(self: *const IConditionGenerator, pszInputString: ?[*:0]const u16, lcidUserLocale: u32, pTokenCollection: ?*ITokenCollection, pNamedEntities: ?*INamedEntityCollector) HRESULT {
        return self.vtable.RecognizeNamedEntities(self, pszInputString, lcidUserLocale, pTokenCollection, pNamedEntities);
    }
    pub inline fn GenerateForLeaf(self: *const IConditionGenerator, pConditionFactory: ?*IConditionFactory, pszPropertyName: ?[*:0]const u16, cop: CONDITION_OPERATION, pszValueType: ?[*:0]const u16, pszValue: ?[*:0]const u16, pszValue2: ?[*:0]const u16, pPropertyNameTerm: ?*IRichChunk, pOperationTerm: ?*IRichChunk, pValueTerm: ?*IRichChunk, automaticWildcard: BOOL, pNoStringQuery: ?*BOOL, ppQueryExpression: ?*?*ICondition) HRESULT {
    ...
    pub inline fn DefaultPhrase(self: *const IConditionGenerator, pszValueType: ?[*:0]const u16, ppropvar: ?*const PROPVARIANT, fUseEnglish: BOOL, ppszPhrase: ?*?PWSTR) HRESULT {
...
pub const IInterval = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetLimits(self: *const IInterval, pilkLower: ?*INTERVAL_LIMIT_KIND, ppropvarLower: ?*PROPVARIANT, pilkUpper: ?*INTERVAL_LIMIT_KIND, ppropvarUpper: ?*PROPVARIANT) HRESULT {
...
pub const IMetaData = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetData(self: *const IMetaData, ppszKey: ?*?PWSTR, ppszValue: ?*?PWSTR) HRESULT {
...
pub const IEntity = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Name(self: *const IEntity, ppszName: ?*?PWSTR) HRESULT {
        return self.vtable.Name(self, ppszName);
    }
    pub inline fn Base(self: *const IEntity, pBaseEntity: ?*?*IEntity) HRESULT {
        return self.vtable.Base(self, pBaseEntity);
    }
    pub inline fn Relationships(self: *const IEntity, riid: ?*const Guid, pRelationships: **anyopaque) HRESULT {
        return self.vtable.Relationships(self, riid, pRelationships);
    }
    pub inline fn GetRelationship(self: *const IEntity, pszRelationName: ?[*:0]const u16, pRelationship: ?*?*IRelationship) HRESULT {
        return self.vtable.GetRelationship(self, pszRelationName, pRelationship);
    }
    pub inline fn MetaData(self: *const IEntity, riid: ?*const Guid, pMetaData: **anyopaque) HRESULT {
        return self.vtable.MetaData(self, riid, pMetaData);
    }
    pub inline fn NamedEntities(self: *const IEntity, riid: ?*const Guid, pNamedEntities: **anyopaque) HRESULT {
        return self.vtable.NamedEntities(self, riid, pNamedEntities);
    }
    pub inline fn GetNamedEntity(self: *const IEntity, pszValue: ?[*:0]const u16, ppNamedEntity: ?*?*INamedEntity) HRESULT {
        return self.vtable.GetNamedEntity(self, pszValue, ppNamedEntity);
    }
    pub inline fn DefaultPhrase(self: *const IEntity, ppszPhrase: ?*?PWSTR) HRESULT {
...
pub const IRelationship = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Name(self: *const IRelationship, ppszName: ?*?PWSTR) HRESULT {
        return self.vtable.Name(self, ppszName);
    }
    pub inline fn IsReal(self: *const IRelationship, pIsReal: ?*BOOL) HRESULT {
        return self.vtable.IsReal(self, pIsReal);
    }
    pub inline fn Destination(self: *const IRelationship, pDestinationEntity: ?*?*IEntity) HRESULT {
        return self.vtable.Destination(self, pDestinationEntity);
    }
    pub inline fn MetaData(self: *const IRelationship, riid: ?*const Guid, pMetaData: **anyopaque) HRESULT {
        return self.vtable.MetaData(self, riid, pMetaData);
    }
    pub inline fn DefaultPhrase(self: *const IRelationship, ppszPhrase: ?*?PWSTR) HRESULT {
        return self.vtable.DefaultPhrase(self, ppszPhrase);
    }
};
...
pub const INamedEntity = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetValue(self: *const INamedEntity, ppszValue: ?*?PWSTR) HRESULT {
        return self.vtable.GetValue(self, ppszValue);
    }
    pub inline fn DefaultPhrase(self: *const INamedEntity, ppszPhrase: ?*?PWSTR) HRESULT {
        return self.vtable.DefaultPhrase(self, ppszPhrase);
    }
};
...
pub const ISchemaProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Entities(self: *const ISchemaProvider, riid: ?*const Guid, pEntities: **anyopaque) HRESULT {
        return self.vtable.Entities(self, riid, pEntities);
    }
    pub inline fn RootEntity(self: *const ISchemaProvider, pRootEntity: ?*?*IEntity) HRESULT {
        return self.vtable.RootEntity(self, pRootEntity);
    }
    pub inline fn GetEntity(self: *const ISchemaProvider, pszEntityName: ?[*:0]const u16, pEntity: ?*?*IEntity) HRESULT {
        return self.vtable.GetEntity(self, pszEntityName, pEntity);
    }
    pub inline fn MetaData(self: *const ISchemaProvider, riid: ?*const Guid, pMetaData: **anyopaque) HRESULT {
        return self.vtable.MetaData(self, riid, pMetaData);
    }
    pub inline fn Localize(self: *const ISchemaProvider, lcid: u32, pSchemaLocalizerSupport: ?*ISchemaLocalizerSupport) HRESULT {
        return self.vtable.Localize(self, lcid, pSchemaLocalizerSupport);
    }
    pub inline fn SaveBinary(self: *const ISchemaProvider, pszSchemaBinaryPath: ?[*:0]const u16) HRESULT {
        return self.vtable.SaveBinary(self, pszSchemaBinaryPath);
    }
    pub inline fn LookupAuthoredNamedEntity(self: *const ISchemaProvider, pEntity: ?*IEntity, pszInputString: ?[*:0]const u16, pTokenCollection: ?*ITokenCollection, cTokensBegin: u32, pcTokensLength: ?*u32, ppszValue: ?*?PWSTR) HRESULT {
...
pub const ITokenCollection = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn NumberOfTokens(self: *const ITokenCollection, pCount: ?*u32) HRESULT {
        return self.vtable.NumberOfTokens(self, pCount);
    }
    pub inline fn GetToken(self: *const ITokenCollection, i: u32, pBegin: ?*u32, pLength: ?*u32, ppsz: ?*?PWSTR) HRESULT {
...
pub const INamedEntityCollector = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Add(self: *const INamedEntityCollector, beginSpan: u32, endSpan: u32, beginActual: u32, endActual: u32, pType: ?*IEntity, pszValue: ?[*:0]const u16, certainty: NAMED_ENTITY_CERTAINTY) HRESULT {
...
pub const ISchemaLocalizerSupport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Localize(self: *const ISchemaLocalizerSupport, pszGlobalString: ?[*:0]const u16, ppszLocalString: ?*?PWSTR) HRESULT {
...
pub const IQueryParserManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CreateLoadedParser(self: *const IQueryParserManager, pszCatalog: ?[*:0]const u16, langidForKeywords: u16, riid: ?*const Guid, ppQueryParser: **anyopaque) HRESULT {
        return self.vtable.CreateLoadedParser(self, pszCatalog, langidForKeywords, riid, ppQueryParser);
    }
    pub inline fn InitializeOptions(self: *const IQueryParserManager, fUnderstandNQS: BOOL, fAutoWildCard: BOOL, pQueryParser: ?*IQueryParser) HRESULT {
        return self.vtable.InitializeOptions(self, fUnderstandNQS, fAutoWildCard, pQueryParser);
    }
    pub inline fn SetOption(self: *const IQueryParserManager, option: QUERY_PARSER_MANAGER_OPTION, pOptionValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.SetOption(self, option, pOptionValue);
    }
};
...
pub const IUrlAccessor = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddRequestParameter(self: *const IUrlAccessor, pSpec: ?*PROPSPEC, pVar: ?*PROPVARIANT) HRESULT {
        return self.vtable.AddRequestParameter(self, pSpec, pVar);
    }
    pub inline fn GetDocFormat(self: *const IUrlAccessor, wszDocFormat: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetDocFormat(self, wszDocFormat, dwSize, pdwLength);
    }
    pub inline fn GetCLSID(self: *const IUrlAccessor, pClsid: ?*Guid) HRESULT {
        return self.vtable.GetCLSID(self, pClsid);
    }
    pub inline fn GetHost(self: *const IUrlAccessor, wszHost: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetHost(self, wszHost, dwSize, pdwLength);
    }
    pub inline fn IsDirectory(self: *const IUrlAccessor) HRESULT {
        return self.vtable.IsDirectory(self);
    }
    pub inline fn GetSize(self: *const IUrlAccessor, pllSize: ?*u64) HRESULT {
        return self.vtable.GetSize(self, pllSize);
    }
    pub inline fn GetLastModified(self: *const IUrlAccessor, pftLastModified: ?*FILETIME) HRESULT {
        return self.vtable.GetLastModified(self, pftLastModified);
    }
    pub inline fn GetFileName(self: *const IUrlAccessor, wszFileName: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetFileName(self, wszFileName, dwSize, pdwLength);
    }
    pub inline fn GetSecurityDescriptor(self: *const IUrlAccessor, pSD: [*:0]u8, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetSecurityDescriptor(self, pSD, dwSize, pdwLength);
    }
    pub inline fn GetRedirectedURL(self: *const IUrlAccessor, wszRedirectedURL: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetRedirectedURL(self, wszRedirectedURL, dwSize, pdwLength);
    }
    pub inline fn GetSecurityProvider(self: *const IUrlAccessor, pSPClsid: ?*Guid) HRESULT {
        return self.vtable.GetSecurityProvider(self, pSPClsid);
    }
    pub inline fn BindToStream(self: *const IUrlAccessor, ppStream: ?*?*IStream) HRESULT {
        return self.vtable.BindToStream(self, ppStream);
    }
    pub inline fn BindToFilter(self: *const IUrlAccessor, ppFilter: ?*?*IFilter) HRESULT {
...
pub const IUrlAccessor2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetDisplayUrl(self: *const IUrlAccessor2, wszDocUrl: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
        return self.vtable.GetDisplayUrl(self, wszDocUrl, dwSize, pdwLength);
    }
    pub inline fn IsDocument(self: *const IUrlAccessor2) HRESULT {
        return self.vtable.IsDocument(self);
    }
    pub inline fn GetCodePage(self: *const IUrlAccessor2, wszCodePage: [*:0]u16, dwSize: u32, pdwLength: ?*u32) HRESULT {
...
pub const IUrlAccessor3 = extern union {
    ...
    IUrlAccessor: IUrlAccessor,
    IUnknown: IUnknown,
    pub inline fn GetImpersonationSidBlobs(self: *const IUrlAccessor3, pcwszURL: ?[*:0]const u16, pcSidCount: ?*u32, ppSidBlobs: ?*?*BLOB) HRESULT {
...
pub const IUrlAccessor4 = extern union {
    ...
    IUrlAccessor: IUrlAccessor,
    IUnknown: IUnknown,
    pub inline fn ShouldIndexItemContent(self: *const IUrlAccessor4, pfIndexContent: ?*BOOL) HRESULT {
        return self.vtable.ShouldIndexItemContent(self, pfIndexContent);
    }
    pub inline fn ShouldIndexProperty(self: *const IUrlAccessor4, key: ?*const PROPERTYKEY, pfIndexProperty: ?*BOOL) HRESULT {
...
pub const IOpLockStatus = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn IsOplockValid(self: *const IOpLockStatus, pfIsOplockValid: ?*BOOL) HRESULT {
        return self.vtable.IsOplockValid(self, pfIsOplockValid);
    }
    pub inline fn IsOplockBroken(self: *const IOpLockStatus, pfIsOplockBroken: ?*BOOL) HRESULT {
        return self.vtable.IsOplockBroken(self, pfIsOplockBroken);
    }
    pub inline fn GetOplockEventHandle(self: *const IOpLockStatus, phOplockEv: ?*?HANDLE) HRESULT {
...
pub const ISearchProtocolThreadContext = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ThreadInit(self: *const ISearchProtocolThreadContext) HRESULT {
        return self.vtable.ThreadInit(self);
    }
    pub inline fn ThreadShutdown(self: *const ISearchProtocolThreadContext) HRESULT {
        return self.vtable.ThreadShutdown(self);
    }
    pub inline fn ThreadIdle(self: *const ISearchProtocolThreadContext, dwTimeElaspedSinceLastCallInMS: u32) HRESULT {
...
pub const ISearchProtocol = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const ISearchProtocol, pTimeoutInfo: ?*TIMEOUT_INFO, pProtocolHandlerSite: ?*IProtocolHandlerSite, pProxyInfo: ?*PROXY_INFO) HRESULT {
        return self.vtable.Init(self, pTimeoutInfo, pProtocolHandlerSite, pProxyInfo);
    }
    pub inline fn CreateAccessor(self: *const ISearchProtocol, pcwszURL: ?[*:0]const u16, pAuthenticationInfo: ?*AUTHENTICATION_INFO, pIncrementalAccessInfo: ?*INCREMENTAL_ACCESS_INFO, pItemInfo: ?*ITEM_INFO, ppAccessor: ?*?*IUrlAccessor) HRESULT {
        return self.vtable.CreateAccessor(self, pcwszURL, pAuthenticationInfo, pIncrementalAccessInfo, pItemInfo, ppAccessor);
    }
    pub inline fn CloseAccessor(self: *const ISearchProtocol, pAccessor: ?*IUrlAccessor) HRESULT {
        return self.vtable.CloseAccessor(self, pAccessor);
    }
    pub inline fn ShutDown(self: *const ISearchProtocol) HRESULT {
...
pub const ISearchProtocol2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateAccessorEx(self: *const ISearchProtocol2, pcwszURL: ?[*:0]const u16, pAuthenticationInfo: ?*AUTHENTICATION_INFO, pIncrementalAccessInfo: ?*INCREMENTAL_ACCESS_INFO, pItemInfo: ?*ITEM_INFO, pUserData: ?*const BLOB, ppAccessor: ?*?*IUrlAccessor) HRESULT {
...
pub const IProtocolHandlerSite = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetFilter(self: *const IProtocolHandlerSite, pclsidObj: ?*Guid, pcwszContentType: ?[*:0]const u16, pcwszExtension: ?[*:0]const u16, ppFilter: ?*?*IFilter) HRESULT {
...
pub const ISearchRoot = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn put_Schedule(self: *const ISearchRoot, pszTaskArg: ?[*:0]const u16) HRESULT {
        return self.vtable.put_Schedule(self, pszTaskArg);
    }
    pub inline fn get_Schedule(self: *const ISearchRoot, ppszTaskArg: ?*?PWSTR) HRESULT {
        return self.vtable.get_Schedule(self, ppszTaskArg);
    }
    pub inline fn put_RootURL(self: *const ISearchRoot, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.put_RootURL(self, pszURL);
    }
    pub inline fn get_RootURL(self: *const ISearchRoot, ppszURL: ?*?PWSTR) HRESULT {
        return self.vtable.get_RootURL(self, ppszURL);
    }
    pub inline fn put_IsHierarchical(self: *const ISearchRoot, fIsHierarchical: BOOL) HRESULT {
        return self.vtable.put_IsHierarchical(self, fIsHierarchical);
    }
    pub inline fn get_IsHierarchical(self: *const ISearchRoot, pfIsHierarchical: ?*BOOL) HRESULT {
        return self.vtable.get_IsHierarchical(self, pfIsHierarchical);
    }
    pub inline fn put_ProvidesNotifications(self: *const ISearchRoot, fProvidesNotifications: BOOL) HRESULT {
        return self.vtable.put_ProvidesNotifications(self, fProvidesNotifications);
    }
    pub inline fn get_ProvidesNotifications(self: *const ISearchRoot, pfProvidesNotifications: ?*BOOL) HRESULT {
        return self.vtable.get_ProvidesNotifications(self, pfProvidesNotifications);
    }
    pub inline fn put_UseNotificationsOnly(self: *const ISearchRoot, fUseNotificationsOnly: BOOL) HRESULT {
        return self.vtable.put_UseNotificationsOnly(self, fUseNotificationsOnly);
    }
    pub inline fn get_UseNotificationsOnly(self: *const ISearchRoot, pfUseNotificationsOnly: ?*BOOL) HRESULT {
        return self.vtable.get_UseNotificationsOnly(self, pfUseNotificationsOnly);
    }
    pub inline fn put_EnumerationDepth(self: *const ISearchRoot, dwDepth: u32) HRESULT {
        return self.vtable.put_EnumerationDepth(self, dwDepth);
    }
    pub inline fn get_EnumerationDepth(self: *const ISearchRoot, pdwDepth: ?*u32) HRESULT {
        return self.vtable.get_EnumerationDepth(self, pdwDepth);
    }
    pub inline fn put_HostDepth(self: *const ISearchRoot, dwDepth: u32) HRESULT {
        return self.vtable.put_HostDepth(self, dwDepth);
    }
    pub inline fn get_HostDepth(self: *const ISearchRoot, pdwDepth: ?*u32) HRESULT {
        return self.vtable.get_HostDepth(self, pdwDepth);
    }
    pub inline fn put_FollowDirectories(self: *const ISearchRoot, fFollowDirectories: BOOL) HRESULT {
        return self.vtable.put_FollowDirectories(self, fFollowDirectories);
    }
    pub inline fn get_FollowDirectories(self: *const ISearchRoot, pfFollowDirectories: ?*BOOL) HRESULT {
        return self.vtable.get_FollowDirectories(self, pfFollowDirectories);
    }
    pub inline fn put_AuthenticationType(self: *const ISearchRoot, authType: AUTH_TYPE) HRESULT {
        return self.vtable.put_AuthenticationType(self, authType);
    }
    pub inline fn get_AuthenticationType(self: *const ISearchRoot, pAuthType: ?*AUTH_TYPE) HRESULT {
        return self.vtable.get_AuthenticationType(self, pAuthType);
    }
    pub inline fn put_User(self: *const ISearchRoot, pszUser: ?[*:0]const u16) HRESULT {
        return self.vtable.put_User(self, pszUser);
    }
    pub inline fn get_User(self: *const ISearchRoot, ppszUser: ?*?PWSTR) HRESULT {
        return self.vtable.get_User(self, ppszUser);
    }
    pub inline fn put_Password(self: *const ISearchRoot, pszPassword: ?[*:0]const u16) HRESULT {
        return self.vtable.put_Password(self, pszPassword);
    }
    pub inline fn get_Password(self: *const ISearchRoot, ppszPassword: ?*?PWSTR) HRESULT {
...
pub const IEnumSearchRoots = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSearchRoots, celt: u32, rgelt: [*]?*ISearchRoot, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSearchRoots, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSearchRoots) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSearchRoots, ppenum: ?*?*IEnumSearchRoots) HRESULT {
...
pub const ISearchScopeRule = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_PatternOrURL(self: *const ISearchScopeRule, ppszPatternOrURL: ?*?PWSTR) HRESULT {
        return self.vtable.get_PatternOrURL(self, ppszPatternOrURL);
    }
    pub inline fn get_IsIncluded(self: *const ISearchScopeRule, pfIsIncluded: ?*BOOL) HRESULT {
        return self.vtable.get_IsIncluded(self, pfIsIncluded);
    }
    pub inline fn get_IsDefault(self: *const ISearchScopeRule, pfIsDefault: ?*BOOL) HRESULT {
        return self.vtable.get_IsDefault(self, pfIsDefault);
    }
    pub inline fn get_FollowFlags(self: *const ISearchScopeRule, pFollowFlags: ?*u32) HRESULT {
...
pub const IEnumSearchScopeRules = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSearchScopeRules, celt: u32, pprgelt: [*]?*ISearchScopeRule, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, pprgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSearchScopeRules, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSearchScopeRules) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSearchScopeRules, ppenum: ?*?*IEnumSearchScopeRules) HRESULT {
        return self.vtable.Clone(self, ppenum);
    }
};
...
pub const ISearchCrawlScopeManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn AddDefaultScopeRule(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, fInclude: BOOL, fFollowFlags: u32) HRESULT {
        return self.vtable.AddDefaultScopeRule(self, pszURL, fInclude, fFollowFlags);
    }
    pub inline fn AddRoot(self: *const ISearchCrawlScopeManager, pSearchRoot: ?*ISearchRoot) HRESULT {
        return self.vtable.AddRoot(self, pSearchRoot);
    }
    pub inline fn RemoveRoot(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.RemoveRoot(self, pszURL);
    }
    pub inline fn EnumerateRoots(self: *const ISearchCrawlScopeManager, ppSearchRoots: ?*?*IEnumSearchRoots) HRESULT {
        return self.vtable.EnumerateRoots(self, ppSearchRoots);
    }
    pub inline fn AddHierarchicalScope(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, fInclude: BOOL, fDefault: BOOL, fOverrideChildren: BOOL) HRESULT {
        return self.vtable.AddHierarchicalScope(self, pszURL, fInclude, fDefault, fOverrideChildren);
    }
    pub inline fn AddUserScopeRule(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, fInclude: BOOL, fOverrideChildren: BOOL, fFollowFlags: u32) HRESULT {
        return self.vtable.AddUserScopeRule(self, pszURL, fInclude, fOverrideChildren, fFollowFlags);
    }
    pub inline fn RemoveScopeRule(self: *const ISearchCrawlScopeManager, pszRule: ?[*:0]const u16) HRESULT {
        return self.vtable.RemoveScopeRule(self, pszRule);
    }
    pub inline fn EnumerateScopeRules(self: *const ISearchCrawlScopeManager, ppSearchScopeRules: ?*?*IEnumSearchScopeRules) HRESULT {
        return self.vtable.EnumerateScopeRules(self, ppSearchScopeRules);
    }
    pub inline fn HasParentScopeRule(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, pfHasParentRule: ?*BOOL) HRESULT {
        return self.vtable.HasParentScopeRule(self, pszURL, pfHasParentRule);
    }
    pub inline fn HasChildScopeRule(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, pfHasChildRule: ?*BOOL) HRESULT {
        return self.vtable.HasChildScopeRule(self, pszURL, pfHasChildRule);
    }
    pub inline fn IncludedInCrawlScope(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, pfIsIncluded: ?*BOOL) HRESULT {
        return self.vtable.IncludedInCrawlScope(self, pszURL, pfIsIncluded);
    }
    pub inline fn IncludedInCrawlScopeEx(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, pfIsIncluded: ?*BOOL, pReason: ?*CLUSION_REASON) HRESULT {
        return self.vtable.IncludedInCrawlScopeEx(self, pszURL, pfIsIncluded, pReason);
    }
    pub inline fn RevertToDefaultScopes(self: *const ISearchCrawlScopeManager) HRESULT {
        return self.vtable.RevertToDefaultScopes(self);
    }
    pub inline fn SaveAll(self: *const ISearchCrawlScopeManager) HRESULT {
        return self.vtable.SaveAll(self);
    }
    pub inline fn GetParentScopeVersionId(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16, plScopeId: ?*i32) HRESULT {
        return self.vtable.GetParentScopeVersionId(self, pszURL, plScopeId);
    }
    pub inline fn RemoveDefaultScopeRule(self: *const ISearchCrawlScopeManager, pszURL: ?[*:0]const u16) HRESULT {
...
pub const ISearchCrawlScopeManager2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetVersion(self: *const ISearchCrawlScopeManager2, plVersion: ?*?*i32, phFileMapping: ?*?HANDLE) HRESULT {
...
pub const ISearchItemsChangedSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn StartedMonitoringScope(self: *const ISearchItemsChangedSink, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.StartedMonitoringScope(self, pszURL);
    }
    pub inline fn StoppedMonitoringScope(self: *const ISearchItemsChangedSink, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.StoppedMonitoringScope(self, pszURL);
    }
    pub inline fn OnItemsChanged(self: *const ISearchItemsChangedSink, dwNumberOfChanges: u32, rgDataChangeEntries: [*]SEARCH_ITEM_CHANGE, rgdwDocIds: [*]u32, rghrCompletionCodes: [*]HRESULT) HRESULT {
...
pub const ISearchPersistentItemsChangedSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn StartedMonitoringScope(self: *const ISearchPersistentItemsChangedSink, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.StartedMonitoringScope(self, pszURL);
    }
    pub inline fn StoppedMonitoringScope(self: *const ISearchPersistentItemsChangedSink, pszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.StoppedMonitoringScope(self, pszURL);
    }
    pub inline fn OnItemsChanged(self: *const ISearchPersistentItemsChangedSink, dwNumberOfChanges: u32, DataChangeEntries: [*]SEARCH_ITEM_PERSISTENT_CHANGE, hrCompletionCodes: [*]HRESULT) HRESULT {
...
pub const ISearchViewChangedSink = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnChange(self: *const ISearchViewChangedSink, pdwDocID: ?*i32, pChange: ?*SEARCH_ITEM_CHANGE, pfInView: ?*BOOL) HRESULT {
...
pub const ISearchNotifyInlineSite = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnItemIndexedStatusChange(self: *const ISearchNotifyInlineSite, sipStatus: SEARCH_INDEXING_PHASE, dwNumEntries: u32, rgItemStatusEntries: [*]SEARCH_ITEM_INDEXING_STATUS) HRESULT {
        return self.vtable.OnItemIndexedStatusChange(self, sipStatus, dwNumEntries, rgItemStatusEntries);
    }
    pub inline fn OnCatalogStatusChange(self: *const ISearchNotifyInlineSite, guidCatalogResetSignature: ?*const Guid, guidCheckPointSignature: ?*const Guid, dwLastCheckPointNumber: u32) HRESULT {
...
pub const ISearchCatalogManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_Name(self: *const ISearchCatalogManager, pszName: ?*?PWSTR) HRESULT {
        return self.vtable.get_Name(self, pszName);
    }
    pub inline fn GetParameter(self: *const ISearchCatalogManager, pszName: ?[*:0]const u16, ppValue: ?*?*PROPVARIANT) HRESULT {
        return self.vtable.GetParameter(self, pszName, ppValue);
    }
    pub inline fn SetParameter(self: *const ISearchCatalogManager, pszName: ?[*:0]const u16, pValue: ?*PROPVARIANT) HRESULT {
        return self.vtable.SetParameter(self, pszName, pValue);
    }
    pub inline fn GetCatalogStatus(self: *const ISearchCatalogManager, pStatus: ?*CatalogStatus, pPausedReason: ?*CatalogPausedReason) HRESULT {
        return self.vtable.GetCatalogStatus(self, pStatus, pPausedReason);
    }
    pub inline fn Reset(self: *const ISearchCatalogManager) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Reindex(self: *const ISearchCatalogManager) HRESULT {
        return self.vtable.Reindex(self);
    }
    pub inline fn ReindexMatchingURLs(self: *const ISearchCatalogManager, pszPattern: ?[*:0]const u16) HRESULT {
        return self.vtable.ReindexMatchingURLs(self, pszPattern);
    }
    pub inline fn ReindexSearchRoot(self: *const ISearchCatalogManager, pszRootURL: ?[*:0]const u16) HRESULT {
        return self.vtable.ReindexSearchRoot(self, pszRootURL);
    }
    pub inline fn put_ConnectTimeout(self: *const ISearchCatalogManager, dwConnectTimeout: u32) HRESULT {
        return self.vtable.put_ConnectTimeout(self, dwConnectTimeout);
    }
    pub inline fn get_ConnectTimeout(self: *const ISearchCatalogManager, pdwConnectTimeout: ?*u32) HRESULT {
        return self.vtable.get_ConnectTimeout(self, pdwConnectTimeout);
    }
    pub inline fn put_DataTimeout(self: *const ISearchCatalogManager, dwDataTimeout: u32) HRESULT {
        return self.vtable.put_DataTimeout(self, dwDataTimeout);
    }
    pub inline fn get_DataTimeout(self: *const ISearchCatalogManager, pdwDataTimeout: ?*u32) HRESULT {
        return self.vtable.get_DataTimeout(self, pdwDataTimeout);
    }
    pub inline fn NumberOfItems(self: *const ISearchCatalogManager, plCount: ?*i32) HRESULT {
        return self.vtable.NumberOfItems(self, plCount);
    }
    pub inline fn NumberOfItemsToIndex(self: *const ISearchCatalogManager, plIncrementalCount: ?*i32, plNotificationQueue: ?*i32, plHighPriorityQueue: ?*i32) HRESULT {
        return self.vtable.NumberOfItemsToIndex(self, plIncrementalCount, plNotificationQueue, plHighPriorityQueue);
    }
    pub inline fn URLBeingIndexed(self: *const ISearchCatalogManager, pszUrl: ?*?PWSTR) HRESULT {
        return self.vtable.URLBeingIndexed(self, pszUrl);
    }
    pub inline fn GetURLIndexingState(self: *const ISearchCatalogManager, pszURL: ?[*:0]const u16, pdwState: ?*u32) HRESULT {
        return self.vtable.GetURLIndexingState(self, pszURL, pdwState);
    }
    pub inline fn GetPersistentItemsChangedSink(self: *const ISearchCatalogManager, ppISearchPersistentItemsChangedSink: ?*?*ISearchPersistentItemsChangedSink) HRESULT {
        return self.vtable.GetPersistentItemsChangedSink(self, ppISearchPersistentItemsChangedSink);
    }
    pub inline fn RegisterViewForNotification(self: *const ISearchCatalogManager, pszView: ?[*:0]const u16, pViewChangedSink: ?*ISearchViewChangedSink, pdwCookie: ?*u32) HRESULT {
        return self.vtable.RegisterViewForNotification(self, pszView, pViewChangedSink, pdwCookie);
    }
    pub inline fn GetItemsChangedSink(self: *const ISearchCatalogManager, pISearchNotifyInlineSite: ?*ISearchNotifyInlineSite, riid: ?*const Guid, ppv: ?*?*anyopaque, pGUIDCatalogResetSignature: ?*Guid, pGUIDCheckPointSignature: ?*Guid, pdwLastCheckPointNumber: ?*u32) HRESULT {
    ...
    pub inline fn UnregisterViewForNotification(self: *const ISearchCatalogManager, dwCookie: u32) HRESULT {
        return self.vtable.UnregisterViewForNotification(self, dwCookie);
    }
    pub inline fn SetExtensionClusion(self: *const ISearchCatalogManager, pszExtension: ?[*:0]const u16, fExclude: BOOL) HRESULT {
        return self.vtable.SetExtensionClusion(self, pszExtension, fExclude);
    }
    pub inline fn EnumerateExcludedExtensions(self: *const ISearchCatalogManager, ppExtensions: ?*?*IEnumString) HRESULT {
        return self.vtable.EnumerateExcludedExtensions(self, ppExtensions);
    }
    pub inline fn GetQueryHelper(self: *const ISearchCatalogManager, ppSearchQueryHelper: ?*?*ISearchQueryHelper) HRESULT {
        return self.vtable.GetQueryHelper(self, ppSearchQueryHelper);
    }
    pub inline fn put_DiacriticSensitivity(self: *const ISearchCatalogManager, fDiacriticSensitive: BOOL) HRESULT {
        return self.vtable.put_DiacriticSensitivity(self, fDiacriticSensitive);
    }
    pub inline fn get_DiacriticSensitivity(self: *const ISearchCatalogManager, pfDiacriticSensitive: ?*BOOL) HRESULT {
        return self.vtable.get_DiacriticSensitivity(self, pfDiacriticSensitive);
    }
    pub inline fn GetCrawlScopeManager(self: *const ISearchCatalogManager, ppCrawlScopeManager: ?*?*ISearchCrawlScopeManager) HRESULT {
...
pub const ISearchCatalogManager2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn PrioritizeMatchingURLs(self: *const ISearchCatalogManager2, pszPattern: ?[*:0]const u16, dwPrioritizeFlags: PRIORITIZE_FLAGS) HRESULT {
...
pub const ISearchQueryHelper = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn get_ConnectionString(self: *const ISearchQueryHelper, pszConnectionString: ?*?PWSTR) HRESULT {
        return self.vtable.get_ConnectionString(self, pszConnectionString);
    }
    pub inline fn put_QueryContentLocale(self: *const ISearchQueryHelper, lcid: u32) HRESULT {
        return self.vtable.put_QueryContentLocale(self, lcid);
    }
    pub inline fn get_QueryContentLocale(self: *const ISearchQueryHelper, plcid: ?*u32) HRESULT {
        return self.vtable.get_QueryContentLocale(self, plcid);
    }
    pub inline fn put_QueryKeywordLocale(self: *const ISearchQueryHelper, lcid: u32) HRESULT {
        return self.vtable.put_QueryKeywordLocale(self, lcid);
    }
    pub inline fn get_QueryKeywordLocale(self: *const ISearchQueryHelper, plcid: ?*u32) HRESULT {
        return self.vtable.get_QueryKeywordLocale(self, plcid);
    }
    pub inline fn put_QueryTermExpansion(self: *const ISearchQueryHelper, expandTerms: SEARCH_TERM_EXPANSION) HRESULT {
        return self.vtable.put_QueryTermExpansion(self, expandTerms);
    }
    pub inline fn get_QueryTermExpansion(self: *const ISearchQueryHelper, pExpandTerms: ?*SEARCH_TERM_EXPANSION) HRESULT {
        return self.vtable.get_QueryTermExpansion(self, pExpandTerms);
    }
    pub inline fn put_QuerySyntax(self: *const ISearchQueryHelper, querySyntax: SEARCH_QUERY_SYNTAX) HRESULT {
        return self.vtable.put_QuerySyntax(self, querySyntax);
    }
    pub inline fn get_QuerySyntax(self: *const ISearchQueryHelper, pQuerySyntax: ?*SEARCH_QUERY_SYNTAX) HRESULT {
        return self.vtable.get_QuerySyntax(self, pQuerySyntax);
    }
    pub inline fn put_QueryContentProperties(self: *const ISearchQueryHelper, pszContentProperties: ?[*:0]const u16) HRESULT {
        return self.vtable.put_QueryContentProperties(self, pszContentProperties);
    }
    pub inline fn get_QueryContentProperties(self: *const ISearchQueryHelper, ppszContentProperties: ?*?PWSTR) HRESULT {
        return self.vtable.get_QueryContentProperties(self, ppszContentProperties);
    }
    pub inline fn put_QuerySelectColumns(self: *const ISearchQueryHelper, pszSelectColumns: ?[*:0]const u16) HRESULT {
        return self.vtable.put_QuerySelectColumns(self, pszSelectColumns);
    }
    pub inline fn get_QuerySelectColumns(self: *const ISearchQueryHelper, ppszSelectColumns: ?*?PWSTR) HRESULT {
        return self.vtable.get_QuerySelectColumns(self, ppszSelectColumns);
    }
    pub inline fn put_QueryWhereRestrictions(self: *const ISearchQueryHelper, pszRestrictions: ?[*:0]const u16) HRESULT {
        return self.vtable.put_QueryWhereRestrictions(self, pszRestrictions);
    }
    pub inline fn get_QueryWhereRestrictions(self: *const ISearchQueryHelper, ppszRestrictions: ?*?PWSTR) HRESULT {
        return self.vtable.get_QueryWhereRestrictions(self, ppszRestrictions);
    }
    pub inline fn put_QuerySorting(self: *const ISearchQueryHelper, pszSorting: ?[*:0]const u16) HRESULT {
        return self.vtable.put_QuerySorting(self, pszSorting);
    }
    pub inline fn get_QuerySorting(self: *const ISearchQueryHelper, ppszSorting: ?*?PWSTR) HRESULT {
        return self.vtable.get_QuerySorting(self, ppszSorting);
    }
    pub inline fn GenerateSQLFromUserQuery(self: *const ISearchQueryHelper, pszQuery: ?[*:0]const u16, ppszSQL: ?*?PWSTR) HRESULT {
        return self.vtable.GenerateSQLFromUserQuery(self, pszQuery, ppszSQL);
    }
    pub inline fn WriteProperties(self: *const ISearchQueryHelper, itemID: i32, dwNumberOfColumns: u32, pColumns: [*]PROPERTYKEY, pValues: [*]SEARCH_COLUMN_PROPERTIES, pftGatherModifiedTime: ?*FILETIME) HRESULT {
        return self.vtable.WriteProperties(self, itemID, dwNumberOfColumns, pColumns, pValues, pftGatherModifiedTime);
    }
    pub inline fn put_QueryMaxResults(self: *const ISearchQueryHelper, cMaxResults: i32) HRESULT {
        return self.vtable.put_QueryMaxResults(self, cMaxResults);
    }
    pub inline fn get_QueryMaxResults(self: *const ISearchQueryHelper, pcMaxResults: ?*i32) HRESULT {
...
pub const IRowsetPrioritization = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetScopePriority(self: *const IRowsetPrioritization, priority: PRIORITY_LEVEL, scopeStatisticsEventFrequency: u32) HRESULT {
        return self.vtable.SetScopePriority(self, priority, scopeStatisticsEventFrequency);
    }
    pub inline fn GetScopePriority(self: *const IRowsetPrioritization, priority: ?*PRIORITY_LEVEL, scopeStatisticsEventFrequency: ?*u32) HRESULT {
        return self.vtable.GetScopePriority(self, priority, scopeStatisticsEventFrequency);
    }
    pub inline fn GetScopeStatistics(self: *const IRowsetPrioritization, indexedDocumentCount: ?*u32, oustandingAddCount: ?*u32, oustandingModifyCount: ?*u32) HRESULT {
...
pub const IRowsetEvents = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnNewItem(self: *const IRowsetEvents, itemID: ?*const PROPVARIANT, newItemState: ROWSETEVENT_ITEMSTATE) HRESULT {
        return self.vtable.OnNewItem(self, itemID, newItemState);
    }
    pub inline fn OnChangedItem(self: *const IRowsetEvents, itemID: ?*const PROPVARIANT, rowsetItemState: ROWSETEVENT_ITEMSTATE, changedItemState: ROWSETEVENT_ITEMSTATE) HRESULT {
        return self.vtable.OnChangedItem(self, itemID, rowsetItemState, changedItemState);
    }
    pub inline fn OnDeletedItem(self: *const IRowsetEvents, itemID: ?*const PROPVARIANT, deletedItemState: ROWSETEVENT_ITEMSTATE) HRESULT {
        return self.vtable.OnDeletedItem(self, itemID, deletedItemState);
    }
    pub inline fn OnRowsetEvent(self: *const IRowsetEvents, eventType: ROWSETEVENT_TYPE, eventData: ?*const PROPVARIANT) HRESULT {
...
pub const ISearchManager = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetIndexerVersionStr(self: *const ISearchManager, ppszVersionString: ?*?PWSTR) HRESULT {
        return self.vtable.GetIndexerVersionStr(self, ppszVersionString);
    }
    pub inline fn GetIndexerVersion(self: *const ISearchManager, pdwMajor: ?*u32, pdwMinor: ?*u32) HRESULT {
        return self.vtable.GetIndexerVersion(self, pdwMajor, pdwMinor);
    }
    pub inline fn GetParameter(self: *const ISearchManager, pszName: ?[*:0]const u16, ppValue: ?*?*PROPVARIANT) HRESULT {
        return self.vtable.GetParameter(self, pszName, ppValue);
    }
    pub inline fn SetParameter(self: *const ISearchManager, pszName: ?[*:0]const u16, pValue: ?*const PROPVARIANT) HRESULT {
        return self.vtable.SetParameter(self, pszName, pValue);
    }
    pub inline fn get_ProxyName(self: *const ISearchManager, ppszProxyName: ?*?PWSTR) HRESULT {
        return self.vtable.get_ProxyName(self, ppszProxyName);
    }
    pub inline fn get_BypassList(self: *const ISearchManager, ppszBypassList: ?*?PWSTR) HRESULT {
        return self.vtable.get_BypassList(self, ppszBypassList);
    }
    pub inline fn SetProxy(self: *const ISearchManager, sUseProxy: PROXY_ACCESS, fLocalByPassProxy: BOOL, dwPortNumber: u32, pszProxyName: ?[*:0]const u16, pszByPassList: ?[*:0]const u16) HRESULT {
        return self.vtable.SetProxy(self, sUseProxy, fLocalByPassProxy, dwPortNumber, pszProxyName, pszByPassList);
    }
    pub inline fn GetCatalog(self: *const ISearchManager, pszCatalog: ?[*:0]const u16, ppCatalogManager: ?*?*ISearchCatalogManager) HRESULT {
        return self.vtable.GetCatalog(self, pszCatalog, ppCatalogManager);
    }
    pub inline fn get_UserAgent(self: *const ISearchManager, ppszUserAgent: ?*?PWSTR) HRESULT {
        return self.vtable.get_UserAgent(self, ppszUserAgent);
    }
    pub inline fn put_UserAgent(self: *const ISearchManager, pszUserAgent: ?[*:0]const u16) HRESULT {
        return self.vtable.put_UserAgent(self, pszUserAgent);
    }
    pub inline fn get_UseProxy(self: *const ISearchManager, pUseProxy: ?*PROXY_ACCESS) HRESULT {
        return self.vtable.get_UseProxy(self, pUseProxy);
    }
    pub inline fn get_LocalBypass(self: *const ISearchManager, pfLocalBypass: ?*BOOL) HRESULT {
        return self.vtable.get_LocalBypass(self, pfLocalBypass);
    }
    pub inline fn get_PortNumber(self: *const ISearchManager, pdwPortNumber: ?*u32) HRESULT {
...
pub const ISearchManager2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateCatalog(self: *const ISearchManager2, pszCatalog: ?[*:0]const u16, ppCatalogManager: ?*?*ISearchCatalogManager) HRESULT {
        return self.vtable.CreateCatalog(self, pszCatalog, ppCatalogManager);
    }
    pub inline fn DeleteCatalog(self: *const ISearchManager2, pszCatalog: ?[*:0]const u16) HRESULT {
...
pub const ISearchLanguageSupport = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetDiacriticSensitivity(self: *const ISearchLanguageSupport, fDiacriticSensitive: BOOL) HRESULT {
        return self.vtable.SetDiacriticSensitivity(self, fDiacriticSensitive);
    }
    pub inline fn GetDiacriticSensitivity(self: *const ISearchLanguageSupport, pfDiacriticSensitive: ?*BOOL) HRESULT {
        return self.vtable.GetDiacriticSensitivity(self, pfDiacriticSensitive);
    }
    pub inline fn LoadWordBreaker(self: *const ISearchLanguageSupport, lcid: u32, riid: ?*const Guid, ppWordBreaker: ?*?*anyopaque, pLcidUsed: ?*u32) HRESULT {
        return self.vtable.LoadWordBreaker(self, lcid, riid, ppWordBreaker, pLcidUsed);
    }
    pub inline fn LoadStemmer(self: *const ISearchLanguageSupport, lcid: u32, riid: ?*const Guid, ppStemmer: ?*?*anyopaque, pLcidUsed: ?*u32) HRESULT {
        return self.vtable.LoadStemmer(self, lcid, riid, ppStemmer, pLcidUsed);
    }
    pub inline fn IsPrefixNormalized(self: *const ISearchLanguageSupport, pwcsQueryToken: [*:0]const u16, cwcQueryToken: u32, pwcsDocumentToken: [*:0]const u16, cwcDocumentToken: u32, pulPrefixLength: ?*u32) HRESULT {
...
pub const IEnumItemProperties = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumItemProperties, celt: u32, rgelt: [*]ITEMPROP, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumItemProperties, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumItemProperties) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumItemProperties, ppenum: ?*?*IEnumItemProperties) HRESULT {
        return self.vtable.Clone(self, ppenum);
    }
    pub inline fn GetCount(self: *const IEnumItemProperties, pnCount: ?*u32) HRESULT {
...
pub const ISubscriptionItem = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCookie(self: *const ISubscriptionItem, pCookie: ?*Guid) HRESULT {
        return self.vtable.GetCookie(self, pCookie);
    }
    pub inline fn GetSubscriptionItemInfo(self: *const ISubscriptionItem, pSubscriptionItemInfo: ?*SUBSCRIPTIONITEMINFO) HRESULT {
        return self.vtable.GetSubscriptionItemInfo(self, pSubscriptionItemInfo);
    }
    pub inline fn SetSubscriptionItemInfo(self: *const ISubscriptionItem, pSubscriptionItemInfo: ?*const SUBSCRIPTIONITEMINFO) HRESULT {
        return self.vtable.SetSubscriptionItemInfo(self, pSubscriptionItemInfo);
    }
    pub inline fn ReadProperties(self: *const ISubscriptionItem, nCount: u32, rgwszName: [*]const ?[*:0]const u16, rgValue: [*]VARIANT) HRESULT {
        return self.vtable.ReadProperties(self, nCount, rgwszName, rgValue);
    }
    pub inline fn WriteProperties(self: *const ISubscriptionItem, nCount: u32, rgwszName: [*]const ?[*:0]const u16, rgValue: [*]const VARIANT) HRESULT {
        return self.vtable.WriteProperties(self, nCount, rgwszName, rgValue);
    }
    pub inline fn EnumProperties(self: *const ISubscriptionItem, ppEnumItemProperties: ?*?*IEnumItemProperties) HRESULT {
        return self.vtable.EnumProperties(self, ppEnumItemProperties);
    }
    pub inline fn NotifyChanged(self: *const ISubscriptionItem) HRESULT {
...
pub const IEnumSubscription = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Next(self: *const IEnumSubscription, celt: u32, rgelt: [*]Guid, pceltFetched: ?*u32) HRESULT {
        return self.vtable.Next(self, celt, rgelt, pceltFetched);
    }
    pub inline fn Skip(self: *const IEnumSubscription, celt: u32) HRESULT {
        return self.vtable.Skip(self, celt);
    }
    pub inline fn Reset(self: *const IEnumSubscription) HRESULT {
        return self.vtable.Reset(self);
    }
    pub inline fn Clone(self: *const IEnumSubscription, ppenum: ?*?*IEnumSubscription) HRESULT {
        return self.vtable.Clone(self, ppenum);
    }
    pub inline fn GetCount(self: *const IEnumSubscription, pnCount: ?*u32) HRESULT {
        return self.vtable.GetCount(self, pnCount);
    }
};
...
pub const ISubscriptionMgr = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DeleteSubscription(self: *const ISubscriptionMgr, pwszURL: ?[*:0]const u16, hwnd: ?HWND) HRESULT {
        return self.vtable.DeleteSubscription(self, pwszURL, hwnd);
    }
    pub inline fn UpdateSubscription(self: *const ISubscriptionMgr, pwszURL: ?[*:0]const u16) HRESULT {
        return self.vtable.UpdateSubscription(self, pwszURL);
    }
    pub inline fn UpdateAll(self: *const ISubscriptionMgr) HRESULT {
        return self.vtable.UpdateAll(self);
    }
    pub inline fn IsSubscribed(self: *const ISubscriptionMgr, pwszURL: ?[*:0]const u16, pfSubscribed: ?*BOOL) HRESULT {
        return self.vtable.IsSubscribed(self, pwszURL, pfSubscribed);
    }
    pub inline fn GetSubscriptionInfo(self: *const ISubscriptionMgr, pwszURL: ?[*:0]const u16, pInfo: ?*SUBSCRIPTIONINFO) HRESULT {
        return self.vtable.GetSubscriptionInfo(self, pwszURL, pInfo);
    }
    pub inline fn GetDefaultInfo(self: *const ISubscriptionMgr, subType: SUBSCRIPTIONTYPE, pInfo: ?*SUBSCRIPTIONINFO) HRESULT {
        return self.vtable.GetDefaultInfo(self, subType, pInfo);
    }
    pub inline fn ShowSubscriptionProperties(self: *const ISubscriptionMgr, pwszURL: ?[*:0]const u16, hwnd: ?HWND) HRESULT {
        return self.vtable.ShowSubscriptionProperties(self, pwszURL, hwnd);
    }
    pub inline fn CreateSubscription(self: *const ISubscriptionMgr, hwnd: ?HWND, pwszURL: ?[*:0]const u16, pwszFriendlyName: ?[*:0]const u16, dwFlags: u32, subsType: SUBSCRIPTIONTYPE, pInfo: ?*SUBSCRIPTIONINFO) HRESULT {
...
pub const ISubscriptionMgr2 = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn GetItemFromURL(self: *const ISubscriptionMgr2, pwszURL: ?[*:0]const u16, ppSubscriptionItem: ?*?*ISubscriptionItem) HRESULT {
        return self.vtable.GetItemFromURL(self, pwszURL, ppSubscriptionItem);
    }
    pub inline fn GetItemFromCookie(self: *const ISubscriptionMgr2, pSubscriptionCookie: ?*const Guid, ppSubscriptionItem: ?*?*ISubscriptionItem) HRESULT {
        return self.vtable.GetItemFromCookie(self, pSubscriptionCookie, ppSubscriptionItem);
    }
    pub inline fn GetSubscriptionRunState(self: *const ISubscriptionMgr2, dwNumCookies: u32, pCookies: [*]const Guid, pdwRunState: [*]u32) HRESULT {
        return self.vtable.GetSubscriptionRunState(self, dwNumCookies, pCookies, pdwRunState);
    }
    pub inline fn EnumSubscriptions(self: *const ISubscriptionMgr2, dwFlags: u32, ppEnumSubscriptions: ?*?*IEnumSubscription) HRESULT {
        return self.vtable.EnumSubscriptions(self, dwFlags, ppEnumSubscriptions);
    }
    pub inline fn UpdateItems(self: *const ISubscriptionMgr2, dwFlags: u32, dwNumCookies: u32, pCookies: [*]const Guid) HRESULT {
        return self.vtable.UpdateItems(self, dwFlags, dwNumCookies, pCookies);
    }
    pub inline fn AbortItems(self: *const ISubscriptionMgr2, dwNumCookies: u32, pCookies: [*]const Guid) HRESULT {
        return self.vtable.AbortItems(self, dwNumCookies, pCookies);
    }
    pub inline fn AbortAll(self: *const ISubscriptionMgr2) HRESULT {
...
pub const IDataConvert = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn DataConvert(self: *const IDataConvert, wSrcType: u16, wDstType: u16, cbSrcLength: usize, pcbDstLength: ?*usize, pSrc: ?*anyopaque, pDst: ?*anyopaque, cbDstMaxLength: usize, dbsSrcStatus: u32, pdbsStatus: ?*u32, bPrecision: u8, bScale: u8, dwFlags: u32) HRESULT {
    ...
    pub inline fn CanConvert(self: *const IDataConvert, wSrcType: u16, wDstType: u16) HRESULT {
        return self.vtable.CanConvert(self, wSrcType, wDstType);
    }
    pub inline fn GetConversionSize(self: *const IDataConvert, wSrcType: u16, wDstType: u16, pcbSrcLength: ?*usize, pcbDstLength: ?*usize, pSrc: ?*anyopaque) HRESULT {
...
pub const IDCInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetInfo(self: *const IDCInfo, cInfo: u32, rgeInfoType: [*]u32, prgInfo: [*]?*DCINFO) HRESULT {
        return self.vtable.GetInfo(self, cInfo, rgeInfoType, prgInfo);
    }
    pub inline fn SetInfo(self: *const IDCInfo, cInfo: u32, rgInfo: [*]DCINFO) HRESULT {
...
pub const DataSourceListener = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn dataMemberChanged(self: *const DataSourceListener, bstrDM: ?*u16) HRESULT {
        return self.vtable.dataMemberChanged(self, bstrDM);
    }
    pub inline fn dataMemberAdded(self: *const DataSourceListener, bstrDM: ?*u16) HRESULT {
        return self.vtable.dataMemberAdded(self, bstrDM);
    }
    pub inline fn dataMemberRemoved(self: *const DataSourceListener, bstrDM: ?*u16) HRESULT {
...
pub const DataSource = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn getDataMember(self: *const DataSource, bstrDM: ?*u16, riid: ?*const Guid, ppunk: ?*?*IUnknown) HRESULT {
        return self.vtable.getDataMember(self, bstrDM, riid, ppunk);
    }
    pub inline fn getDataMemberName(self: *const DataSource, lIndex: i32, pbstrDM: ?*?*u16) HRESULT {
        return self.vtable.getDataMemberName(self, lIndex, pbstrDM);
    }
    pub inline fn getDataMemberCount(self: *const DataSource, plCount: ?*i32) HRESULT {
        return self.vtable.getDataMemberCount(self, plCount);
    }
    pub inline fn addDataSourceListener(self: *const DataSource, pDSL: ?*DataSourceListener) HRESULT {
        return self.vtable.addDataSourceListener(self, pDSL);
    }
    pub inline fn removeDataSourceListener(self: *const DataSource, pDSL: ?*DataSourceListener) HRESULT {
...
pub const OLEDBSimpleProviderListener = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn aboutToChangeCell(self: *const OLEDBSimpleProviderListener, iRow: isize, iColumn: isize) HRESULT {
        return self.vtable.aboutToChangeCell(self, iRow, iColumn);
    }
    pub inline fn cellChanged(self: *const OLEDBSimpleProviderListener, iRow: isize, iColumn: isize) HRESULT {
        return self.vtable.cellChanged(self, iRow, iColumn);
    }
    pub inline fn aboutToDeleteRows(self: *const OLEDBSimpleProviderListener, iRow: isize, cRows: isize) HRESULT {
        return self.vtable.aboutToDeleteRows(self, iRow, cRows);
    }
    pub inline fn deletedRows(self: *const OLEDBSimpleProviderListener, iRow: isize, cRows: isize) HRESULT {
        return self.vtable.deletedRows(self, iRow, cRows);
    }
    pub inline fn aboutToInsertRows(self: *const OLEDBSimpleProviderListener, iRow: isize, cRows: isize) HRESULT {
        return self.vtable.aboutToInsertRows(self, iRow, cRows);
    }
    pub inline fn insertedRows(self: *const OLEDBSimpleProviderListener, iRow: isize, cRows: isize) HRESULT {
        return self.vtable.insertedRows(self, iRow, cRows);
    }
    pub inline fn rowsAvailable(self: *const OLEDBSimpleProviderListener, iRow: isize, cRows: isize) HRESULT {
        return self.vtable.rowsAvailable(self, iRow, cRows);
    }
    pub inline fn transferComplete(self: *const OLEDBSimpleProviderListener, xfer: OSPXFER) HRESULT {
...
pub const OLEDBSimpleProvider = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn getRowCount(self: *const OLEDBSimpleProvider, pcRows: ?*isize) HRESULT {
        return self.vtable.getRowCount(self, pcRows);
    }
    pub inline fn getColumnCount(self: *const OLEDBSimpleProvider, pcColumns: ?*isize) HRESULT {
        return self.vtable.getColumnCount(self, pcColumns);
    }
    pub inline fn getRWStatus(self: *const OLEDBSimpleProvider, iRow: isize, iColumn: isize, prwStatus: ?*OSPRW) HRESULT {
        return self.vtable.getRWStatus(self, iRow, iColumn, prwStatus);
    }
    pub inline fn getVariant(self: *const OLEDBSimpleProvider, iRow: isize, iColumn: isize, format: OSPFORMAT, pVar: ?*VARIANT) HRESULT {
        return self.vtable.getVariant(self, iRow, iColumn, format, pVar);
    }
    pub inline fn setVariant(self: *const OLEDBSimpleProvider, iRow: isize, iColumn: isize, format: OSPFORMAT, Var: VARIANT) HRESULT {
        return self.vtable.setVariant(self, iRow, iColumn, format, Var);
    }
    pub inline fn getLocale(self: *const OLEDBSimpleProvider, pbstrLocale: ?*?BSTR) HRESULT {
        return self.vtable.getLocale(self, pbstrLocale);
    }
    pub inline fn deleteRows(self: *const OLEDBSimpleProvider, iRow: isize, cRows: isize, pcRowsDeleted: ?*isize) HRESULT {
        return self.vtable.deleteRows(self, iRow, cRows, pcRowsDeleted);
    }
    pub inline fn insertRows(self: *const OLEDBSimpleProvider, iRow: isize, cRows: isize, pcRowsInserted: ?*isize) HRESULT {
        return self.vtable.insertRows(self, iRow, cRows, pcRowsInserted);
    }
    pub inline fn find(self: *const OLEDBSimpleProvider, iRowStart: isize, iColumn: isize, val: VARIANT, findFlags: OSPFIND, compType: OSPCOMP, piRowFound: ?*isize) HRESULT {
        return self.vtable.find(self, iRowStart, iColumn, val, findFlags, compType, piRowFound);
    }
    pub inline fn addOLEDBSimpleProviderListener(self: *const OLEDBSimpleProvider, pospIListener: ?*OLEDBSimpleProviderListener) HRESULT {
        return self.vtable.addOLEDBSimpleProviderListener(self, pospIListener);
    }
    pub inline fn removeOLEDBSimpleProviderListener(self: *const OLEDBSimpleProvider, pospIListener: ?*OLEDBSimpleProviderListener) HRESULT {
        return self.vtable.removeOLEDBSimpleProviderListener(self, pospIListener);
    }
    pub inline fn isAsync(self: *const OLEDBSimpleProvider, pbAsynch: ?*BOOL) HRESULT {
        return self.vtable.isAsync(self, pbAsynch);
    }
    pub inline fn getEstimatedRows(self: *const OLEDBSimpleProvider, piRows: ?*isize) HRESULT {
        return self.vtable.getEstimatedRows(self, piRows);
    }
    pub inline fn stopTransfer(self: *const OLEDBSimpleProvider) HRESULT {
...
pub const IService = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn InvokeService(self: *const IService, pUnkInner: ?*IUnknown) HRESULT {
...
pub const IDBPromptInitialize = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn PromptDataSource(self: *const IDBPromptInitialize, pUnkOuter: ?*IUnknown, hWndParent: ?HWND, dwPromptOptions: u32, cSourceTypeFilter: u32, rgSourceTypeFilter: ?[*]u32, pwszszzProviderFilter: ?[*:0]const u16, riid: ?*const Guid, ppDataSource: ?*?*IUnknown) HRESULT {
    ...
    pub inline fn PromptFileName(self: *const IDBPromptInitialize, hWndParent: ?HWND, dwPromptOptions: u32, pwszInitialDirectory: ?[*:0]const u16, pwszInitialFile: ?[*:0]const u16, ppwszSelectedFile: ?*?PWSTR) HRESULT {
...
pub const IDataInitialize = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetDataSource(self: *const IDataInitialize, pUnkOuter: ?*IUnknown, dwClsCtx: u32, pwszInitializationString: ?[*:0]const u16, riid: ?*const Guid, ppDataSource: ?*?*IUnknown) HRESULT {
        return self.vtable.GetDataSource(self, pUnkOuter, dwClsCtx, pwszInitializationString, riid, ppDataSource);
    }
    pub inline fn GetInitializationString(self: *const IDataInitialize, pDataSource: ?*IUnknown, fIncludePassword: u8, ppwszInitString: ?*?PWSTR) HRESULT {
        return self.vtable.GetInitializationString(self, pDataSource, fIncludePassword, ppwszInitString);
    }
    pub inline fn CreateDBInstance(self: *const IDataInitialize, clsidProvider: ?*const Guid, pUnkOuter: ?*IUnknown, dwClsCtx: u32, pwszReserved: ?PWSTR, riid: ?*const Guid, ppDataSource: ?*?*IUnknown) HRESULT {
        return self.vtable.CreateDBInstance(self, clsidProvider, pUnkOuter, dwClsCtx, pwszReserved, riid, ppDataSource);
    }
    pub inline fn CreateDBInstanceEx(self: *const IDataInitialize, clsidProvider: ?*const Guid, pUnkOuter: ?*IUnknown, dwClsCtx: u32, pwszReserved: ?PWSTR, pServerInfo: ?*COSERVERINFO, cmq: u32, rgmqResults: [*]MULTI_QI) HRESULT {
        return self.vtable.CreateDBInstanceEx(self, clsidProvider, pUnkOuter, dwClsCtx, pwszReserved, pServerInfo, cmq, rgmqResults);
    }
    pub inline fn LoadStringFromStorage(self: *const IDataInitialize, pwszFileName: ?[*:0]const u16, ppwszInitializationString: ?*?PWSTR) HRESULT {
        return self.vtable.LoadStringFromStorage(self, pwszFileName, ppwszInitializationString);
    }
    pub inline fn WriteStringToStorage(self: *const IDataInitialize, pwszFileName: ?[*:0]const u16, pwszInitializationString: ?[*:0]const u16, dwCreationDisposition: u32) HRESULT {
...
pub const IDataSourceLocator = extern union {
    ...
    IDispatch: IDispatch,
    IUnknown: IUnknown,
    pub inline fn get_hWnd(self: *const IDataSourceLocator, phwndParent: ?*i64) HRESULT {
        return self.vtable.get_hWnd(self, phwndParent);
    }
    pub inline fn put_hWnd(self: *const IDataSourceLocator, hwndParent: i64) HRESULT {
        return self.vtable.put_hWnd(self, hwndParent);
    }
    pub inline fn PromptNew(self: *const IDataSourceLocator, ppADOConnection: ?*?*IDispatch) HRESULT {
        return self.vtable.PromptNew(self, ppADOConnection);
    }
    pub inline fn PromptEdit(self: *const IDataSourceLocator, ppADOConnection: ?*?*IDispatch, pbSuccess: ?*i16) HRESULT {
...
pub const IRowsetChangeExtInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetOriginalRow(self: *const IRowsetChangeExtInfo, hReserved: usize, hRow: usize, phRowOriginal: ?*usize) HRESULT {
        return self.vtable.GetOriginalRow(self, hReserved, hRow, phRowOriginal);
    }
    pub inline fn GetPendingColumns(self: *const IRowsetChangeExtInfo, hReserved: usize, hRow: usize, cColumnOrdinals: u32, rgiOrdinals: ?*const u32, rgColumnStatus: ?*u32) HRESULT {
...
pub const ISQLRequestDiagFields = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RequestDiagFields(self: *const ISQLRequestDiagFields, cDiagFields: u32, rgDiagFields: [*]KAGREQDIAG) HRESULT {
...
pub const ISQLGetDiagField = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetDiagField(self: *const ISQLGetDiagField, pDiagInfo: ?*KAGGETDIAG) HRESULT {
...
pub const IRowsetNextRowset = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetNextRowset(self: *const IRowsetNextRowset, pUnkOuter: ?*IUnknown, riid: ?*const Guid, ppNextRowset: ?*?*IUnknown) HRESULT {
...
pub const IRowsetNewRowAfter = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn SetNewDataAfter(self: *const IRowsetNewRowAfter, hChapter: usize, cbbmPrevious: u32, pbmPrevious: ?*const u8, hAccessor: usize, pData: ?*u8, phRow: ?*usize) HRESULT {
...
pub const IRowsetWithParameters = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetParameterInfo(self: *const IRowsetWithParameters, pcParams: ?*usize, prgParamInfo: ?*?*DBPARAMINFO, ppNamesBuffer: ?*?*u16) HRESULT {
        return self.vtable.GetParameterInfo(self, pcParams, prgParamInfo, ppNamesBuffer);
    }
    pub inline fn Requery(self: *const IRowsetWithParameters, pParams: ?*DBPARAMS, pulErrorParam: ?*u32, phReserved: ?*usize) HRESULT {
...
pub const IRowsetAsynch = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RatioFinished(self: *const IRowsetAsynch, pulDenominator: ?*usize, pulNumerator: ?*usize, pcRows: ?*usize, pfNewRows: ?*BOOL) HRESULT {
        return self.vtable.RatioFinished(self, pulDenominator, pulNumerator, pcRows, pfNewRows);
    }
    pub inline fn Stop(self: *const IRowsetAsynch) HRESULT {
...
pub const IRowsetKeys = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ListKeys(self: *const IRowsetKeys, pcColumns: ?*usize, prgColumns: ?*?*usize) HRESULT {
...
pub const IRowsetWatchAll = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Acknowledge(self: *const IRowsetWatchAll) HRESULT {
        return self.vtable.Acknowledge(self);
    }
    pub inline fn Start(self: *const IRowsetWatchAll) HRESULT {
        return self.vtable.Start(self);
    }
    pub inline fn StopWatching(self: *const IRowsetWatchAll) HRESULT {
...
pub const IRowsetWatchNotify = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn OnChange(self: *const IRowsetWatchNotify, pRowset: ?*IRowset, eChangeReason: u32) HRESULT {
...
pub const IRowsetWatchRegion = extern union {
    ...
    IUnknown: IUnknown,
    pub inline fn CreateWatchRegion(self: *const IRowsetWatchRegion, dwWatchMode: u32, phRegion: ?*usize) HRESULT {
        return self.vtable.CreateWatchRegion(self, dwWatchMode, phRegion);
    }
    pub inline fn ChangeWatchMode(self: *const IRowsetWatchRegion, hRegion: usize, dwWatchMode: u32) HRESULT {
        return self.vtable.ChangeWatchMode(self, hRegion, dwWatchMode);
    }
    pub inline fn DeleteWatchRegion(self: *const IRowsetWatchRegion, hRegion: usize) HRESULT {
        return self.vtable.DeleteWatchRegion(self, hRegion);
    }
    pub inline fn GetWatchRegionInfo(self: *const IRowsetWatchRegion, hRegion: usize, pdwWatchMode: ?*u32, phChapter: ?*usize, pcbBookmark: ?*usize, ppBookmark: ?*?*u8, pcRows: ?*isize) HRESULT {
        return self.vtable.GetWatchRegionInfo(self, hRegion, pdwWatchMode, phChapter, pcbBookmark, ppBookmark, pcRows);
    }
    pub inline fn Refresh(self: *const IRowsetWatchRegion, pcChangesObtained: ?*usize, prgChanges: ?*?*tagDBROWWATCHRANGE) HRESULT {
        return self.vtable.Refresh(self, pcChangesObtained, prgChanges);
    }
    pub inline fn ShrinkWatchRegion(self: *const IRowsetWatchRegion, hRegion: usize, hChapter: usize, cbBookmark: usize, pBookmark: ?*u8, cRows: isize) HRESULT {
...
pub const IRowsetCopyRows = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn CloseSource(self: *const IRowsetCopyRows, hSourceID: u16) HRESULT {
        return self.vtable.CloseSource(self, hSourceID);
    }
    pub inline fn CopyByHROWS(self: *const IRowsetCopyRows, hSourceID: u16, hReserved: usize, cRows: isize, rghRows: ?*const usize, bFlags: u32) HRESULT {
        return self.vtable.CopyByHROWS(self, hSourceID, hReserved, cRows, rghRows, bFlags);
    }
    pub inline fn CopyRows(self: *const IRowsetCopyRows, hSourceID: u16, hReserved: usize, cRows: isize, bFlags: u32, pcRowsCopied: ?*usize) HRESULT {
        return self.vtable.CopyRows(self, hSourceID, hReserved, cRows, bFlags, pcRowsCopied);
    }
    pub inline fn DefineSource(self: *const IRowsetCopyRows, pRowsetSource: ?*IRowset, cColIds: usize, rgSourceColumns: ?*const isize, rgTargetColumns: ?*const isize, phSourceID: ?*u16) HRESULT {
...
pub const IReadData = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ReadData(self: *const IReadData, hChapter: usize, cbBookmark: usize, pBookmark: ?*const u8, lRowsOffset: isize, hAccessor: usize, cRows: isize, pcRowsObtained: ?*usize, ppFixedData: ?*?*u8, pcbVariableTotal: ?*usize, ppVariableData: ?*?*u8) HRESULT {
    ...
    pub inline fn ReleaseChapter(self: *const IReadData, hChapter: usize) HRESULT {
...
pub const ICommandCost = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetAccumulatedCost(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, pcCostLimits: ?*u32, prgCostLimits: ?*?*DBCOST) HRESULT {
        return self.vtable.GetAccumulatedCost(self, pwszRowsetName, pcCostLimits, prgCostLimits);
    }
    pub inline fn GetCostEstimate(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, pcCostEstimates: ?*u32, prgCostEstimates: ?*DBCOST) HRESULT {
        return self.vtable.GetCostEstimate(self, pwszRowsetName, pcCostEstimates, prgCostEstimates);
    }
    pub inline fn GetCostGoals(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, pcCostGoals: ?*u32, prgCostGoals: ?*DBCOST) HRESULT {
        return self.vtable.GetCostGoals(self, pwszRowsetName, pcCostGoals, prgCostGoals);
    }
    pub inline fn GetCostLimits(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, pcCostLimits: ?*u32, prgCostLimits: ?*DBCOST) HRESULT {
        return self.vtable.GetCostLimits(self, pwszRowsetName, pcCostLimits, prgCostLimits);
    }
    pub inline fn SetCostGoals(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, cCostGoals: u32, rgCostGoals: ?*const DBCOST) HRESULT {
        return self.vtable.SetCostGoals(self, pwszRowsetName, cCostGoals, rgCostGoals);
    }
    pub inline fn SetCostLimits(self: *const ICommandCost, pwszRowsetName: ?[*:0]const u16, cCostLimits: u32, prgCostLimits: ?*DBCOST, dwExecutionFlags: u32) HRESULT {
...
pub const ICommandValidate = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn ValidateCompletely(self: *const ICommandValidate) HRESULT {
        return self.vtable.ValidateCompletely(self);
    }
    pub inline fn ValidateSyntax(self: *const ICommandValidate) HRESULT {
...
pub const ITableRename = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn RenameColumn(self: *const ITableRename, pTableId: ?*DBID, pOldColumnId: ?*DBID, pNewColumnId: ?*DBID) HRESULT {
        return self.vtable.RenameColumn(self, pTableId, pOldColumnId, pNewColumnId);
    }
    pub inline fn RenameTable(self: *const ITableRename, pOldTableId: ?*DBID, pOldIndexId: ?*DBID, pNewTableId: ?*DBID, pNewIndexId: ?*DBID) HRESULT {
...
pub const IDBSchemaCommand = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetCommand(self: *const IDBSchemaCommand, pUnkOuter: ?*IUnknown, rguidSchema: ?*const Guid, ppCommand: ?*?*ICommand) HRESULT {
        return self.vtable.GetCommand(self, pUnkOuter, rguidSchema, ppCommand);
    }
    pub inline fn GetSchemas(self: *const IDBSchemaCommand, pcSchemas: ?*u32, prgSchemas: ?*?*Guid) HRESULT {
...
pub const IProvideMoniker = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetMoniker(self: *const IProvideMoniker, ppIMoniker: ?*?*IMoniker) HRESULT {
...
pub const ISearchQueryHits = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Init(self: *const ISearchQueryHits, pflt: ?*IFilter, ulFlags: u32) i32 {
        return self.vtable.Init(self, pflt, ulFlags);
    }
    pub inline fn NextHitMoniker(self: *const ISearchQueryHits, pcMnk: ?*u32, papMnk: ?*?*?*IMoniker) i32 {
        return self.vtable.NextHitMoniker(self, pcMnk, papMnk);
    }
    pub inline fn NextHitOffset(self: *const ISearchQueryHits, pcRegion: ?*u32, paRegion: ?*?*FILTERREGION) i32 {
...
pub const IRowsetQueryStatus = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetStatus(self: *const IRowsetQueryStatus, pdwStatus: ?*u32) HRESULT {
        return self.vtable.GetStatus(self, pdwStatus);
    }
    pub inline fn GetStatusEx(self: *const IRowsetQueryStatus, pdwStatus: ?*u32, pcFilteredDocuments: ?*u32, pcDocumentsToFilter: ?*u32, pdwRatioFinishedDenominator: ?*usize, pdwRatioFinishedNumerator: ?*usize, cbBmk: usize, pBmk: ?*const u8, piRowBmk: ?*usize, pcRowsTotal: ?*usize) HRESULT {
...
pub const IUMSInitialize = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn Initialize(self: *const IUMSInitialize, pUMS: ?*anyopaque) HRESULT {
...
pub const IUMS = extern union {
    ...
    vtable: *const VTable,
    pub inline fn SqlUmsSuspend(self: *const IUMS, ticks: u32) void {
        return self.vtable.SqlUmsSuspend(self, ticks);
    }
    pub inline fn SqlUmsYield(self: *const IUMS, ticks: u32) void {
        return self.vtable.SqlUmsYield(self, ticks);
    }
    pub inline fn SqlUmsSwitchPremptive(self: *const IUMS) void {
        return self.vtable.SqlUmsSwitchPremptive(self);
    }
    pub inline fn SqlUmsSwitchNonPremptive(self: *const IUMS) void {
        return self.vtable.SqlUmsSwitchNonPremptive(self);
    }
    pub inline fn SqlUmsFIsPremptive(self: *const IUMS) BOOL {
...
pub const ISQLServerErrorInfo = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetErrorInfo(self: *const ISQLServerErrorInfo, ppErrorInfo: ?*?*tagSSErrorInfo, ppStringsBuffer: ?*?*u16) HRESULT {
...
pub const IRowsetFastLoad = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn InsertRow(self: *const IRowsetFastLoad, hAccessor: usize, pData: ?*anyopaque) HRESULT {
        return self.vtable.InsertRow(self, hAccessor, pData);
    }
    pub inline fn Commit(self: *const IRowsetFastLoad, fDone: BOOL) HRESULT {
...
pub const ISchemaLock = extern union {
    ...
    vtable: *const VTable,
    IUnknown: IUnknown,
    pub inline fn GetSchemaLock(self: *const ISchemaLock, pTableID: ?*DBID, lmMode: u32, phLockHandle: ?*?HANDLE, pTableVersion: ?*u64) HRESULT {
        return self.vtable.GetSchemaLock(self, pTableID, lmMode, phLockHandle, pTableVersion);
    }
    pub inline fn ReleaseSchemaLock(self: *const ISchemaLock, hLockHandle: ?HANDLE) HRESULT {
...
pub extern "odbc32" fn ODBCGetTryWaitValue() callconv(.winapi) u32;
